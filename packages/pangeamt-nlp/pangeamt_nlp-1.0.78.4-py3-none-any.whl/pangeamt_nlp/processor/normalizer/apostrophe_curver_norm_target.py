...
class ApostropheCurverNormTarget(NormalizerBase):
    NAME = "apostrophe_curver_norm_target"
    ...
    DESCRIPTION_DECODING = """
        Replaces all uncurved apostrophes (') with curved apostrophes (’) in src and tgt.
    """
