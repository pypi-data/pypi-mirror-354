# MovieLens SDK - `moviessdk_Pricile`
...
```python
from moviessdk_Pricile import MovieClient, MovieConfig

# Configuration avec l’URL de votre API (Render ou locale)
config = MovieConfig(movie_base_url="https://movie-backend-fdte.onrender.com")
...
## Liens utiles
- API Render : [https://movie-backend-fdte.onrender.com/](https://movie-backend-fdte.onrender.com/)
- PyPI : [https://pypi.org/project/moviessdk-Pricile/0.0.2/](https://pypi.org/project/moviessdk-Pricile/0.0.2/)