...
weekdays: list[float] = occupancy_sgen.daily([0, 1, 2, 3, 4], {0: 0, 8: 3, 18: 0})  # 12: 0, 13: 3,
weekends: list[float] = occupancy_sgen.daily([5, 6], {0: 0})
...
ventilation_sgen = SignalGenerator(dp.series('datetime'))
ventilation_sgen.daily([0, 1, 2, 3, 4], {0: 0, 7: 1, 10: 0})
ventilation_sgen.daily([5, 6], {0: 0})
