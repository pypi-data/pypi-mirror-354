...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='health',
  syntax='proto3',
  serialized_options=b'\n\032org.opencord.voltha.healthZ.github.com/opencord/voltha-protos/v5/go/health',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\x1avoltha_protos/health.proto\x12\x06health\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\"v\n\x0cHealthStatus\x12/\n\x05state\x18\x01 \x01(\x0e\x32 .health.HealthStatus.HealthState\"5\n\x0bHealthState\x12\x0b\n\x07HEALTHY\x10\x00\x12\x0e\n\nOVERLOADED\x10\x01\x12\t\n\x05\x44YING\x10\x02\x32\x61\n\rHealthService\x12P\n\x0fGetHealthStatus\x12\x16.google.protobuf.Empty\x1a\x14.health.HealthStatus\"\x0f\x82\xd3\xe4\x93\x02\t\x12\x07/healthBL\n\x1aorg.opencord.voltha.healthZ.github.com/opencord/voltha-protos/v5/go/healthb\x06proto3'
  ,
...
_HEALTHSTATUS_HEALTHSTATE = _descriptor.EnumDescriptor(
  name='HealthState',
  full_name='health.HealthStatus.HealthState',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_HEALTHSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='state', full_name='health.HealthStatus.state', index=0,
...
HealthStatus = _reflection.GeneratedProtocolMessageType('HealthStatus', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:health.HealthStatus)
  })
...
_HEALTHSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='health.HealthService.GetHealthStatus',
    index=0,
