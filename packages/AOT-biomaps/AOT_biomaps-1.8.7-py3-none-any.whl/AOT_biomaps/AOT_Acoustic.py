        ...
        try:
            ...
            if extension != None:
                if extension == FormatSave.HDR_IMG.value:
                    formatSave = FormatSave.HDR_IMG.value
                elif extension == FormatSave.H5.value:
                    formatSave = FormatSave.H5.value
                elif extension == FormatSave.NPY.value:
                    formatSave = FormatSave.NPY.value
                elif extension == '':
                    pass
                else:
            ...
            if self.params['typeSim'] == TypeSim.FIELD2.value:
                ...
                if formatSave == FormatSave.HDR_IMG.value:
                    if self.params["dim"] == Dim.D2.value:
                        self._load_fieldKWAVE_XZ(filePath)
                        self.calculate_envelope_squared()
                    elif self.params["dim"] == Dim.D3.value:
                        raise NotImplementedError("3D KWAVE field loading is not implemented yet.")
                elif formatSave == FormatSave.H5.value:
                    if self.params["dim"] == Dim.D2.value:
                         self._load_field_h5(filePath)
                    elif self.params["dim"] == Dim.D3.value:
                        raise NotImplementedError("H5 KWAVE field loading is not implemented yet.")
                elif formatSave == FormatSave.NPY.value:
                    if self.params["dim"] == Dim.D2.value:
                        self.field = np.load(os.path.join(filePath,self.getName_field()+formatSave))
                    elif self.params["dim"] == Dim.D3.value:
                ...
                if formatSave == FormatSave.H5.value:
