...
const std::string& LoadgenVersion() {
  static const std::string str = "5.0.18";
  return str;
}

const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2025-06-11T19:36:53.858168";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2025-06-11T19:36:53.858183";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "93cebdac8d";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2025-06-11T20:36:29+01:00";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(93cebdac8d21efdfd8d3253ed65eb34291cfa10a Update mlperf.conf with final deepseek configuration (#2208))LGVG_RSLD";
  return str;
}
...
5bc08fc747a7dff72b64fb1f1e8776a549484b3a /VERSION.txt
...
c0334d677c5f05d19cc8e645a6e29d24a6dad5fd /mlperf.conf
7c9c73221cd5bc62c85adcffa9816edcfb389f8c /mlperf_conf.h
