...
class GreeumAdapter:
    ...
    def initialize(self):
        ...
        try:
            from greeum.memory_engine.block_manager import BlockManager
            from greeum.memory_engine.stm_manager import STMManager
            from greeum.memory_engine.cache_manager import CacheManager
            from greeum.memory_engine.prompt_wrapper import PromptWrapper
            from greeum.memory_engine.temporal_reasoner import TemporalReasoner
