...
@click.command(help="Process commit history, sync GitHub issues and refresh the RedStone registry. Generates intention and narrative YAML files under LoreWeave.")
@click.option('--verbose', is_flag=True, help='Enable verbose output for each processing step.')
@click.option('--issue-limit', default=30, show_default=True, help='Number of GitHub issues to fetch during sync.')
