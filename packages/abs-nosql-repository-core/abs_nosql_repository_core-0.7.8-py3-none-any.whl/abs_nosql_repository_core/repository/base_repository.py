...
class BaseRepository:
    ...
    def _coerce_document(self, data: Dict[str, Any],check_object_id:bool=False) -> Dict[str, Any]:
        """
        ...
        """
        return coerce_value(data,check_object_id)
        ...
        if all(k in filter_dict for k in ["field", "operator", "value"]):
            try:
                ...
                if filter_dict["field"] == "id" or filter_dict["field"] == "_id":
                    ...
                    value = coerce_value(filter_dict["value"],check_object_id=True)
