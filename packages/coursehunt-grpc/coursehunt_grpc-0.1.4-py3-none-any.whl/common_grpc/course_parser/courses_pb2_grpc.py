...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in course_parser/courses_pb2_grpc.py depends on'
...
class CourseServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetCourses = channel.unary_unary(
                '/course_router.CourseService/GetCourses',
...
def add_CourseServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'course_router.CourseService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('course_router.CourseService', rpc_method_handlers)
