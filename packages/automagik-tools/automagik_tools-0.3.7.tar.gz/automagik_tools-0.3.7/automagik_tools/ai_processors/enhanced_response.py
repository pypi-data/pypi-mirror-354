...
import logging
from .json_markdown_processor import JsonMarkdownProcessor, ProcessingResult, get_processor
            ...
            "attachments": [
                {
                    ...
                    "fields": [
                        {
                            "title": "Details",
                            "value": response.markdown[:1000] + ("..." if len(response.markdown) > 1000 else ""),
                            "short": False
                        }
                    ],
                    "footer": "Automagik Tools",
                    "ts": response.processing_result.timestamp if response.processing_result else None
                }
            ]
        }
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "Automagik Tools"
                    },
                    "timestamp": response.processing_result.timestamp if response.processing_result else None
                }
            ]
        }
