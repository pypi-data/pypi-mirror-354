...
class API():
    ...
    @staticmethod
    def open_wechat_official_account(name:str,load_delay:float=1,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True)->tuple[WindowSpecification,WindowSpecification|None]:
        '''
        该方法用于打开指定的微信公众号\n
        Args:
            name:\t微信公众号名称\n
        ...
        try:
            ...
            official_acount_window.minimize()
...
def find_friend_in_MessageList(friend:str,wechat_path:str=None,is_maximize:bool=True,search_pages:int=5)->tuple[WindowSpecification|None,WindowSpecification]:
    ...
    Args:
        ...
        search_pages:\t在会话列表中查询查找好友时滚动列表的次数,默认为5,一次可查询5-12人,当search_pages为0时,直接从顶部搜索栏搜索好友信息打开聊天界面\n
    Returns:
        (edit_area,main_window):若edit_area存在:返回值为 (edit_area,main_window) 同时返回好友聊天界面内的编辑区域与主界面\n
        否则:返回值为(None,main_window)\n
    '''
    def get_window(friend):
        '''
