...
def copy_backup_to_cloud(database_name: str, local_backup_folder:str) -> None:
    ...
    adls_upload_file(local_backup_folder + f"{database_name}_dump_latest.sql", f"database_backups/{database_name}_dump_latest.sql")
    dagster_logger.info(f"{database_name} migration to BLOB complete.")
def backup_databases(local_backup_folder:str, db: str ='postgres') -> None:
    """
