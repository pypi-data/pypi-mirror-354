...
from p2zyq.utils.file_utils import (
    ensure_dir,
    load_json,
    save_json,
    load_pickle,
...
from p2zyq.utils.data_utils import (
...
from p2zyq.utils.logging_utils import setup_logger, get_logger, log_function_call
...
def test_setup_logger():
    ...
    # 测试带文件的日志配置
    with patch("p2zyq.utils.logging_utils.logging.FileHandler") as mock_file_handler:
