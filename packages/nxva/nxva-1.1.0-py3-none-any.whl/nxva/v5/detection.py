...
class BaseDetector:
    ...
    """
    def __init__(self, model_path, device, size, conf_thres=0.25, iou_thres=0.7, classes=None, class_names=None, fp16=False, verbose=False):
        """
...
class TorchDetector(BaseDetector):
    ...
    def __init__(self, model_path, device, size, conf_thres=0.25, iou_thres=0.7, classes=None, class_names=None, fp16=False, verbose=False):
        ...
        Args:
            ...
            verbose (bool): Whether to output the timer.
        """
        super().__init__(model_path, device, size, conf_thres, iou_thres, classes, class_names, fp16, verbose)
