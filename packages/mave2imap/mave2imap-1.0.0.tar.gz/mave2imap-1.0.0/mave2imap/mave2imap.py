...
def main():
    ...
    for n, f in enumerate(fastq_files):
        ...
        parser_cmd = f"""time mpirun -np {ncpus} {exe_dir}/ReadParser.py -f {fastq} -o {direction}_{
        ...
        if even_odd != 0:
            ...
            assembly_cmd = f"""time mpirun -np {ncpus} {exe_dir}/ReadAssembler.py --mpi -f {
    ...
    combiner_cmd = f"""time mpirun -np {ncpus} {exe_dir}/CombineMultiExp.py -b assembly_{
