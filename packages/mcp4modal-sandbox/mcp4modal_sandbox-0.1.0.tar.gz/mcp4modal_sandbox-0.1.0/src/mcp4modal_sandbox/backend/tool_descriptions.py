...
class ToolDescriptions(str, Enum):
    LAUNCH_SANDBOX = """
            ...
            Parameters:
            - app_name: Name of the Modal app namespace (defines sandbox grouping)
            ...
            - inject_predefined_secrets: List of predefined secret names to inject from Modal dashboard
