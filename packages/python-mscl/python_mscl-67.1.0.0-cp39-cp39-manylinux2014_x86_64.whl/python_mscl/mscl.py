...
class WirelessModels(object):
    ...
    node_gLink_200_p = _mscl.WirelessModels_node_gLink_200_p
...
class WirelessNode(object):
    ...
    def updateEepromCacheFromNodeDiscovery(self, nodeDiscovery):
        return _mscl.WirelessNode_updateEepromCacheFromNodeDiscovery(self, nodeDiscovery)
