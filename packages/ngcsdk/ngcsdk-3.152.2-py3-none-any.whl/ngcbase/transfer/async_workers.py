...
from ngcbase.constants import CAS_TIMEOUT, STAGING_ENV, UMASK_GROUP_OTHERS_READ_EXECUTE
...
class UploadCompletionTable(BaseCompletionTable[UploadFileNode]):
    ...
    def __init__(self, table_file_path=None):
        ...
        self.storage_version: Literal["V1", "V2"] = "V1"
...
def upload_directory(
    ...
    with AsyncUploadWorkerManager(
        ...
        # Ths is the FEATURE FLAG
        upload_manager.c_table.storage_version = storage_version if (get_environ_tag() <= STAGING_ENV) else "V1"
