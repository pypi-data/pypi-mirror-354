import { g as ht, E as C, F as ge, G as xe, H as _e } from "./Index-CWT0oANI.js";
var ut = function(t) {
  return lt(t) && !ft(t);
};
function lt(e) {
...
function xt(e, t, r) {
  ...
  return r.isMergeableObject(e) && ye(e).forEach(function(i) {
    ...
    vt(e, i) || (Ge(e, i) && r.isMergeableObject(t[i]) ? n[i] = dt(i, r)(e[i], t[i], r) : n[i] = G(t[i], r));
  }), n;
}
function N(e, t, r) {
...
function jt(e) {
  for (var t = {}, r = 0, n = e; r < n.length; r++) {
    ...
    if (Te.test(i.stem)) {
      ...
      i.stem.replace(Te, function(u, l, h, c, f, d) {
...
function k(e, t, r, n, i, a, s) {
  ...
  for (var o = [], u = 0, l = e; u < l.length; u++) {
    ...
    if (je(h)) {
      var d = typeof h.style == "string" ? n.number[h.style] : Ze(h.style) ? h.style.parsedOptions : void 0;
...
const B = {}, dr = (e, t, r) => r && (t in B || (B[t] = {}), e in B[t] || (B[t][e] = r), r), tt = (e, t) => {
  if (t == null) return;
  if (t in B && e in B[t])
    return B[t][e];
  const r = Y(t);
