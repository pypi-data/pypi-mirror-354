...
class model: 
    ...
    def __init__(self,matrices_folder='./build'): 
        ...
        self.N_z = 10 
        self.N_store = 100000 
        self.params_list = ['S_base', 'g_1_2', 'b_1_2', 'bs_1_2', 'g_shunt_1', 'b_shunt_1', 'U_1_n', 'U_2_n', 'Omega_b_1', 'S_n_1', 'H_1', 'T1d0_1', 'T1q0_1', 'X_d_1', 'X_q_1', 'X1d_1', 'X1q_1', 'D_1', 'R_a_1', 'K_delta_1', 'K_sec_1', 'K_sat_1', 'K_a_1', 'K_ai_1', 'T_r_1', 'T_c_1', 'T_b_1', 'V_f_max_1', 'V_f_min_1', 'K_p_pll_1', 'K_i_pll_1', 'T_pll_1', 'K_theta_pll_1', 'T_wo1_pod_1', 'T_wo2_pod_1', 'T_1_pod_1', 'T_2_pod_1', 'T_3_pod_1', 'T_4_pod_1', 'T_5_pod_1', 'T_6_pod_1', 'K_stab_1', 'Limit_pod_1', 'K_p_agc', 'K_i_agc', 'K_xif'] 
        self.params_values_list  = [100000000, 0.7692307692307693, -3.846153846153846, 2e-07, 0.0, -1e-06, 20000, 20000, 314.1592653589793, 200000000, 5, 8, 0.4, 1.8, 1.7, 0.3, 0.55, 0, 0.01, 0, 0, 1.0, 200, 1e-06, 0.1, 1, 1, 100.0, -100.0, 180, 3200, 0.02, 1.0, 10, 10, 1, 1, 1, 1, 1, 1, 20, 0.1, 0, 0, 0.01] 
        ...
        self.x_list = ['delta_1', 'omega_1', 'e1q_1', 'e1d_1', 'v_r_1', 'x_cb_1', 'xi_v_1', 'v_f_1', 'V_dummy_2', 'theta_pll_1', 'xi_pll_1', 'omega_pll_f_1', 'x_wo1_pod_1', 'x_wo2_pod_1', 'x_12_pod_1', 'x_34_pod_1', 'x_56_pod_1', 'xi_freq'] 
        self.y_run_list = ['V_1', 'theta_1', 'V_2', 'theta_2', 'i_d_1', 'i_q_1', 'p_g_1', 'q_g_1', 'rocof_1', 'pod_out_1', 'omega_coi', 'p_agc'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['V_1', 'theta_1', 'V_2', 'theta_2', 'i_d_1', 'i_q_1', 'p_g_1', 'q_g_1', 'rocof_1', 'pod_out_1', 'omega_coi', 'p_agc'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 1, 28, 0, 1, 18, 19, 22, 23, 28, 2, 7, 22, 3, 23, 4, 18, 5, 6, 18, 18, 5, 6, 7, 18, 8, 9, 10, 18, 19, 28, 9, 18, 19, 9, 10, 11, 18, 19, 11, 12, 11, 12, 13, 11, 12, 13, 14, 11, 12, 13, 14, 15, 11, 12, 13, 14, 15, 16, 17, 28, 18, 19, 20, 21, 24, 18, 19, 20, 21, 25, 20, 21, 0, 2, 18, 19, 22, 23, 0, 3, 18, 19, 22, 23, 0, 18, 19, 22, 23, 24, 0, 18, 19, 22, 23, 25, 9, 10, 11, 18, 19, 26, 11, 12, 13, 14, 15, 16, 27, 1, 28, 17, 28, 29]
    sp_jac_ini_ja = [0, 3, 10, 13, 15, 17, 20, 21, 25, 26, 31, 34, 39, 41, 44, 48, 53, 59, 61, 66, 71, 72, 73, 79, 85, 91, 97, 103, 110, 112, 115]
    sp_jac_ini_nia = 30
    sp_jac_ini_nja = 30
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 1, 28, 0, 1, 18, 19, 22, 23, 28, 2, 7, 22, 3, 23, 4, 18, 5, 6, 18, 18, 5, 6, 7, 18, 8, 9, 10, 18, 19, 28, 9, 18, 19, 9, 10, 11, 18, 19, 11, 12, 11, 12, 13, 11, 12, 13, 14, 11, 12, 13, 14, 15, 11, 12, 13, 14, 15, 16, 17, 28, 18, 19, 20, 21, 24, 18, 19, 20, 21, 25, 20, 21, 0, 2, 18, 19, 22, 23, 0, 3, 18, 19, 22, 23, 0, 18, 19, 22, 23, 24, 0, 18, 19, 22, 23, 25, 9, 10, 11, 18, 19, 26, 11, 12, 13, 14, 15, 16, 27, 1, 28, 17, 28, 29]
    sp_jac_run_ja = [0, 3, 10, 13, 15, 17, 20, 21, 25, 26, 31, 34, 39, 41, 44, 48, 53, 59, 61, 66, 71, 72, 73, 79, 85, 91, 97, 103, 110, 112, 115]
    sp_jac_run_nia = 30
    sp_jac_run_nja = 30
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 28, 0, 1, 18, 19, 22, 23, 28, 2, 7, 22, 3, 23, 4, 18, 5, 6, 18, 6, 18, 5, 6, 7, 18, 8, 9, 10, 18, 19, 28, 9, 10, 18, 19, 9, 10, 11, 18, 19, 11, 12, 11, 12, 13, 11, 12, 13, 14, 11, 12, 13, 14, 15, 11, 12, 13, 14, 15, 16, 17, 28, 18, 19, 20, 21, 24, 18, 19, 20, 21, 25, 20, 21, 0, 2, 18, 19, 22, 23, 0, 3, 18, 19, 22, 23, 0, 18, 19, 22, 23, 24, 0, 18, 19, 22, 23, 25, 9, 10, 11, 18, 19, 26, 11, 12, 13, 14, 15, 16, 27, 1, 28, 17, 28, 29]
    sp_jac_trap_ja = [0, 3, 10, 13, 15, 17, 20, 22, 26, 27, 32, 36, 41, 43, 46, 50, 55, 61, 63, 68, 73, 74, 75, 81, 87, 93, 99, 105, 112, 114, 117]
    sp_jac_trap_nia = 30
    sp_jac_trap_nja = 30
