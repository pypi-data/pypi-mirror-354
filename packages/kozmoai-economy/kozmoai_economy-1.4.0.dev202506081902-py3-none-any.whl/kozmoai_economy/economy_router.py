...
from kozmoai_core.app.deprecation import KozmoAIDeprecationWarning
...
from kozmoai_economy.gdp.gdp_router import router as gdp_router
from kozmoai_economy.survey.survey_router import router as survey_router
...
@router.command(
    model="STIR",
    deprecated=True,
    deprecation=KozmoAIDeprecationWarning(
