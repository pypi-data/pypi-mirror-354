...
class EconomyViews:
    ...
    def economy_fred_series(
        **kwargs,
        ...
        from kozmoai_charting.charts.generic_charts import bar_chart
        from kozmoai_charting.charts.helpers import (
            z_score_standardization,
        )
        from kozmoai_charting.core.chart_style import ChartStyle
        from kozmoai_charting.core.kozmoai_figure import KozmoAIFigure
        from kozmoai_charting.styles.colors import LARGE_CYCLER
        from kozmoai_core.app.utils import basemodel_to_df
        ...
        fig = KozmoAIFigure().create_subplots(
    ...
    def economy_survey_bls_series(
        **kwargs,
        ...
        """
        # pylint: disable=import-outside-toplevel
        from kozmoai_charting.charts.generic_charts import bar_chart, line_chart
        from kozmoai_charting.charts.helpers import (
            z_score_standardization,
        )
        from kozmoai_core.app.utils import basemodel_to_df
