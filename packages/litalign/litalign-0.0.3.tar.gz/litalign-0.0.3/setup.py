...
def _load_py_module(fname, pkg="litalign"):
...
setup(
    ...
    download_url="https://github.com/deependujha/litalign",
    ...
    zip_safe=False,
    keywords=["deep learning", "pytorch", "AI", "streaming", "cloud", "rlhf", "alignment", "safety"],
    python_requires=">=3.8",
    setup_requires=["wheel"],
    install_requires=_load_requirements(),
    extras_require=_prepare_extras(),
    project_urls={
        "Bug Tracker": "https://github.com/deependujha/litalign/issues",
        "Documentation": "https://github.com/deependujha/litalign/blob/main/README.md",
        "Source Code": "https://github.com/deependujha/litalign",
    },
    classifiers=[
        "Environment :: Console",
