...
class Genoa:
    def __init__(self, layer_size, device='cpu', init_type='he', scale=2, msg=True):
        self.msg = msg
        self.device = device
        ...
        if self.msg:
            print('Thanks for using GENOA! Made by MrPsyghost. Visit https://mrpsyghost.netlify.app/genoa for more information.')
