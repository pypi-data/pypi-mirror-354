...
class QcSnapshotWidget(QtWidgets.QTreeWidget):
    ...
    def __init__(self, parent=None, data=None) -> None:  # noqa: ANN001, D107
        ...
        # https://doc.bccnsoft.com/docs/PyQt4/qabstractitemview.html#ScrollMode-enum
        if hasattr(QtWidgets.QAbstractItemView, "ScrollPerPixel"):
            scroll_mode = QtWidgets.QAbstractItemView.ScrollPerPixel  # pyright: ignore
        elif hasattr(QtWidgets.QAbstractItemView, "ScrollMode") and hasattr(
            QtWidgets.QAbstractItemView.ScrollMode, "ScrollPerPixel"
        ):
            scroll_mode = QtWidgets.QAbstractItemView.ScrollMode.ScrollPerPixel
        elif hasattr(QtWidgets.QAbstractItemView, "ScrollPerItem"):
            scroll_mode = QtWidgets.QAbstractItemView.ScrollPerItem  # pyright: ignore
        elif hasattr(QtWidgets.QAbstractItemView, "ScrollMode") and hasattr(
            QtWidgets.QAbstractItemView.ScrollMode, "ScrollPerItem"
        ):
            scroll_mode = QtWidgets.QAbstractItemView.ScrollMode.ScrollPerItem
        else:
            scroll_mode = 0
        self.setVerticalScrollMode(scroll_mode)  # pyright: ignore
    ...
    def _add_single_parameter(
        self,
        param_snap,  # noqa: ANN001
        param_name,  # noqa: ANN001
        node,  # noqa: ANN001
        node_key,  # noqa: ANN001
    ) -> None:
