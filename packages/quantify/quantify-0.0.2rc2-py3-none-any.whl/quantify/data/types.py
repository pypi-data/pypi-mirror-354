...
class TUID(str):
    ...
    def __new__(cls: type[TUID], value: str) -> TUID:  # noqa: D102
        ...
        return cast(TUID, value)  # noqa: TC006

    @classmethod
    def datetime(cls, tuid: str) -> datetime.datetime:  # noqa: ANN102
        """
        Returns
        -------
    ...
    @classmethod
    def datetime_seconds(cls, tuid: str) -> datetime.datetime:  # noqa: ANN102
        """
        Returns
        -------
        :class:`~python:datetime.datetime`
    ...
    @classmethod
    def uuid(cls, tuid: str) -> str:  # noqa: ANN102
        """
        Returns
        -------
        str
    ...
    @classmethod
    def is_valid(cls, tuid: str) -> bool:  # noqa: ANN102
        """
