...
from myVaillant.models import myVaillantDataClass
from myVaillant.utils import add_default_parser_args, recursive_compare
...
async def print_changes(func, object: myVaillantDataClass, *args, **kwargs):
    old = asdict(object)
    new: myVaillantDataClass = await func(object, *args, **kwargs)
