...
async def test_ventilation(myvaillant_aioresponses, mocked_api: MyVaillantAPI) -> None:
    data_list = [
...
async def test_mpc(myvaillant_aioresponses, mocked_api: MyVaillantAPI) -> None:
...
async def test_ambisense(myvaillant_aioresponses, mocked_api: MyVaillantAPI) -> None:
