...
if __name__ == "__main__":
    ...
    VaillantCloud = Path(__file__).resolve().parents[4] / "VaillantCloud"
...
"""
    ...
    # Docs
    if VaillantCloud.exists():
        docs = (
            Path(__file__).resolve().parents[4] / "VaillantCloud/docs/docs/3-library.md"
        )
