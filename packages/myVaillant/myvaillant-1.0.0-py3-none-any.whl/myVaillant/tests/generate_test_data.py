...
from myVaillant.api import get_api_base, get_system_api_base
from myVaillant.const import DEFAULT_CONTROL_IDENTIFIER
from myVaillant.utils import add_default_parser_args
...
async def main(user, password, brand, country=None, write_results=True):
    ...
    from myVaillant.utils import datetime_format
