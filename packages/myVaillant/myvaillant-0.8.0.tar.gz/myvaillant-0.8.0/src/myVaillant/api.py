...
class MyVaillantAPI:
    ...
    async def __aenter__(self) -> MyVaillantAPI:
        try:
            await self.login()
        except Exception:
    ...
    async def get_systems(
        ...
        Examples:
            >>> async for system in MyVaillantAPI(**kwargs).get_systems():
        ...
        async for home in homes:
            ...
            system = System.from_api(
                ...
                diagnostic_trouble_codes=(
                    await self.get_diagnostic_trouble_codes(home.system_id)
                ...
                energy_management=(
                    await self.get_energy_management(home.system_id)
