...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_labels", "name", "pulp_created", "base_path", "no_content_change_since", "pulp_href", "pulp_last_updated", "base_url", "content_guard", "hidden", "prn"]
