...
class TestUtils(unittest.TestCase):
	def test_app_utils(self):
		git_url = "https://github.com/frappecn/frappe"
		branch = "panda"
	...
	def test_is_valid_frappe_branch(self):
		with self.assertRaises(InvalidRemoteException):
			is_valid_frappe_branch(
				"https://github.com/frappecn/frappe.git", frappe_branch="random-branch"
			)
			is_valid_frappe_branch(
		...
		is_valid_frappe_branch(
			"https://github.com/frappecn/frappe.git", frappe_branch="panda"
		)
		# is_valid_frappe_branch(
		# 	"https://github.com/frappecn/frappe.git", frappe_branch="v13.29.0"
		# )
	...
	def test_app_states(self):
		...
		fake_bench.apps.states = {
			"frappe": {
				"resolution": {"branch": "panda", "commit_hash": "234rwefd"},
				"version": "14.0.0-dev",
			}
		}
	...
	def test_ssh_ports(self):
		app = App("git@github.com:22:frappecn/frappe")
		self.assertEqual(
			(app.use_ssh, app.org, app.repo, app.app_name), (True, "frappecn", "frappe", "frappe")
		)
