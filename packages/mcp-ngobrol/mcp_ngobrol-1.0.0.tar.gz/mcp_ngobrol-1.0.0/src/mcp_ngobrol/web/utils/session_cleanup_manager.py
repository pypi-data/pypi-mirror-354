...
class CleanupPolicy:
    """清理策略配置"""
    max_idle_time: int = 7200  # 最大空閒時間（2小時，lebih lama）
    max_session_age: int = 14400  # 最大會話年齡（4小時，lebih lama）
    max_sessions: int = 15  # 最大會話數量（lebih banyak）
    cleanup_interval: int = 600  # 清理間隔（10分鐘，lebih lama）
