...
# -*- coding: utf-8 -*-
"""
Manajemen Konfigurasi Testing
=============================

Mengelola parameter konfigurasi dan pengaturan framework testing MCP.
"""
...
class TestConfig:
    ...
    # Konfigurasi data testing
    test_project_dir: Optional[str] = None
    test_summary: str = "Framework Testing MCP - Simulasi Panggilan Cursor IDE"
    test_feedback_text: str = "Ini adalah umpan balik testing untuk memverifikasi fungsionalitas sistem MCP."
    
    @classmethod
    def from_env(cls) -> 'TestConfig':
        """Buat konfigurasi dari variabel lingkungan"""
        config = cls()
