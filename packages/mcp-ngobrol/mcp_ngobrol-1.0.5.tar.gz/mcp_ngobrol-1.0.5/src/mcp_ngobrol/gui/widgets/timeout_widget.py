...
class TimeoutWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.timeout_seconds = 1800  # 預設 30 分鐘 (lebih lama)
    ...
    def _setup_ui(self):
        ...
        self.time_spinbox.setRange(60, 14400)  # 1分鐘到4小時 (range lebih lama)
        self.time_spinbox.setValue(1800)  # 預設30分鐘 (lebih lama)
