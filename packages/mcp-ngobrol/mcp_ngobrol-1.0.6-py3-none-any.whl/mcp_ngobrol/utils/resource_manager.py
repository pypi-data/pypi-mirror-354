...
class ResourceManager:
    ...
    def __init__(self):
        ...
        self.cleanup_interval = 600  # 10分鐘 (lebih lama)
        self.temp_file_max_age = 7200  # 2小時 (lebih lama)
        ...
        debug_log("ResourceManager inisialisasi selesai")
    ...
    def _setup_memory_monitoring(self):
        ...
        try:
            ...
            if self.memory_monitor.start_monitoring():
                debug_log("Monitoring memori telah terintegrasi ke resource manager")
            else:
                debug_log("內存監控啟動失敗")
    ...
    def _memory_triggered_cleanup(self, force: bool = False):
        """內存監控觸發的清理操作"""
        debug_log(f"Monitoring memori memicu operasi pembersihan (force={force})")
    ...
    def _start_auto_cleanup(self) -> None:
        ...
        debug_log("Thread pembersihan otomatis telah dimulai")
