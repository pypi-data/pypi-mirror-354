...
# -*- coding: utf-8 -*-
"""
About Tab untuk MCP Ngobrol v1.0.0
===================================

Menampilkan informasi aplikasi MCP Ngobrol, riwayat pengembangan fork,
dan informasi development by MBPR.
"""
...
class AboutTab(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self.app_title_label = QLabel("MCP Ngobrol")
        ...
        # GitHub URL
        self.github_url_label = QLabel("https://github.com/mbprcc/mcp-ngobrol")
        ...
        # Discord URL 和說明
        self.discord_url_label = QLabel("https://social.mbpr.cc/mbprdiscord")
    ...
    def _open_github(self) -> None:
        """Buka link GitHub project"""
        QDesktopServices.openUrl(QUrl("https://github.com/mbprcc/mcp-ngobrol"))

    def _open_discord(self) -> None:
        """Buka link Discord community"""
        QDesktopServices.openUrl(QUrl("https://social.mbpr.cc/mbprdiscord"))
