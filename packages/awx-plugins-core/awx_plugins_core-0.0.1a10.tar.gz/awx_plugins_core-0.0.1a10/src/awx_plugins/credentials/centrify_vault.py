...
pas_inputs = {
    'fields': [
        ...
        },
        {
            ...
            'type': 'string',
            'help_text': _(
                'Centrify API User, having necessary permissions as mentioned '
                'in support doc',
            ),
        },
        {
        ...
        },
        {
            ...
            'type': 'string',
            'help_text': _(
                'Application ID of the configured OAuth2 Client (defaults to '
                "'awx')",
            ),
            'default': 'awx',
        },
    ...
    'metadata': [
        {
            ...
            'type': 'string',
            'help_text': _(
                'Local system account or Domain account name enrolled in '
                'Centrify Vault. eg. (root or DOMAIN/Administrator)',
            ),
        },
        {
            'id': 'system-name',
...
# generate bearer token to authenticate with PAS portal, Input : Client
# ID, Client Secret
