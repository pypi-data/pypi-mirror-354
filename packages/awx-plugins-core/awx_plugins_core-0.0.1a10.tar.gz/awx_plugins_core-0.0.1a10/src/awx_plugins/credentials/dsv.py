    ...
    'fields': [
        {
            ...
            'label': _('Tenant'),
            'help_text': _(
                'The tenant e.g. "ex" when the URL is '
                'https://ex.secretsvaultcloud.com',
            ),
            'type': 'string',
        },
        {
...
def dsv_backend(**kwargs):
    ...
    # providing a default value to remain backward compatible for secrets that
    # have not specified this option
