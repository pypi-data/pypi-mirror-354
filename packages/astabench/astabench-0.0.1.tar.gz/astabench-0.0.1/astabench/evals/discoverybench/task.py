...
from astabench.evals.discoverybench.task_utils import format_query
...
def extract_output(state: TaskState) -> DiscoveryBenchOutput:
        ...
        try:
            ...
            msg = (
                ...
                if isinstance(e, ValidationError)
                    ...
                    else "Error parsing agent output"
                )
            )
            return Score(
                value=0.0,
