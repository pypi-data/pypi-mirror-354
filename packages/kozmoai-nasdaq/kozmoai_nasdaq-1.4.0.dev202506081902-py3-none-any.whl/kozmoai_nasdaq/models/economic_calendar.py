...
from kozmoai_core.provider.standard_models.economic_calendar import (
...
class NasdaqEconomicCalendarData(EconomicCalendarData):
    ...
    def clean_html(cls, v: str):
        ...
        import html  # noqa
        from kozmoai_nasdaq.utils.helpers import remove_html_tags  # noqa
...
class NasdaqEconomicCalendarFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        # pylint: disable=import-outside-toplevel
        import asyncio  # noqa
        from kozmoai_core.provider.utils.helpers import amake_request  # noqa
        from kozmoai_nasdaq.utils.helpers import get_headers, date_range  # noqa
