...
class NasdaqEquityScreenerFetcher(
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        from kozmoai_core.provider.utils.helpers import get_querystring, make_request
        from kozmoai_nasdaq.utils.helpers import get_headers
        ...
        try:
            ...
            raise KozmoAIError(f"Failed to get data from Nasdaq -> {error}") from error
