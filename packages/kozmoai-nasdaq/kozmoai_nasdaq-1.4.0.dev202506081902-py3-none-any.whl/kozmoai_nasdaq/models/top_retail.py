...
from kozmoai_core.provider.standard_models.top_retail import (
    TopRetailData,
...
class NasdaqTopRetailFetcher(
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        from kozmoai_core.provider.utils.helpers import make_request
        ...
        if response.status_code != 200:
            ...
            raise KozmoAIError(f"Failed to get data from Nasdaq -> {reason}")
