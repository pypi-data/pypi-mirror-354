...
class ListWorkflowsRequest(_message.Message):
    __slots__ = ["page_size", "page_token", "partial_uniqueness_key", "type", "updated_within", "workflow_id"]
    PAGE_SIZE_FIELD_NUMBER: _ClassVar[int]
    PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, workflow_id: _Optional[_Union[_id__client_pb2.Id, _Mapping]] = ..., partial_uniqueness_key: _Optional[str] = ..., type: _Optional[_Union[_workflow__client_pb2.WorkflowType, str]] = ..., updated_within: _Optional[_Union[DateTimeRange, _Mapping]] = ..., page_size: _Optional[int] = ..., page_token: _Optional[str] = ...) -> None: ...
