...
class PolyModelWithBaseUniqueBase(models.Model):
    unique_field = CharField(unique=True)


class PolyModelWithBaseUniqueChild(PolyModelWithBaseUniqueBase):
    pass


class PolyModelWithChildUniqueBase(models.Model):
    pass


class PolyModelWithChildUniqueChild(PolyModelWithChildUniqueBase):
    unique_field = CharField(unique=True)


class PolyModelWithBaseUniqueTogetherBase(models.Model):
    a = CharField()
    b = CharField()
...
class PolyModelWithBaseUniqueTogetherChild(PolyModelWithBaseUniqueTogetherBase):
    pass


class UniqueAbstractParentBase(models.Model):
    unique_field = CharField(unique=True)
...
class UniqueAbstractParentChild(UniqueAbstractParentBase):
    pass


class PolyModelChildUniqueTogetherBase(models.Model):
    pass


class PolyModelChildUniqueTogetherChild(PolyModelChildUniqueTogetherBase):
    a = CharField()
    b = CharField()
