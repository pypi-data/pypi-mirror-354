...
class BillingCreateNewServiceOrderV1422Response(BaseModel):
    """
    ...
    errors: Optional[BillingCreateNewServiceOrderV1422ResponseErrors] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": BillingCreateNewServiceOrderV1422ResponseErrors.from_dict(obj["errors"]) if obj.get("errors") is not None else None,
