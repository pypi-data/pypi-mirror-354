...
class SpatialPlacementRotation(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["x_rotation", "y_rotation", "z_rotation", "rotation_units"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpatialPlacementRotation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpatialPlacementRotation from a dict"""
        if obj is None:
            return None
