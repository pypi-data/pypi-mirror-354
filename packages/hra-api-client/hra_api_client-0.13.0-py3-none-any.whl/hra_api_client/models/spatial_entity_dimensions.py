...
class SpatialEntityDimensions(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["x_dimension", "y_dimension", "z_dimension", "dimension_units"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpatialEntityDimensions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpatialEntityDimensions from a dict"""
        if obj is None:
            return None
