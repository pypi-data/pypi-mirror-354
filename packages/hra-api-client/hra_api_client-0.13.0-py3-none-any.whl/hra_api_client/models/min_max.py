...
class MinMax(BaseModel):
    """
    Represents a range of numbers using a minimum and maximum. Either end may be omitted to indicate an unlimited/infinite range in that direction. `min` should be less than or equal to `max` but this is not strictly enforced. 
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MinMax from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MinMax from a dict"""
        if obj is None:
            return None
