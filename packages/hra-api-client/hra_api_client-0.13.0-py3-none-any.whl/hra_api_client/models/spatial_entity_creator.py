...
class SpatialEntityCreator(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["creator", "creator_first_name", "creator_last_name", "creator_orcid", "creation_date"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpatialEntityCreator from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpatialEntityCreator from a dict"""
        if obj is None:
            return None
