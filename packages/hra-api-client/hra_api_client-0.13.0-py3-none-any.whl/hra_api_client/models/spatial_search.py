...
class SpatialSearch(BaseModel):
    ...
    target: StrictStr
    __properties: ClassVar[List[str]] = ["x", "y", "z", "radius", "target"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpatialSearch from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpatialSearch from a dict"""
        if obj is None:
            return None
