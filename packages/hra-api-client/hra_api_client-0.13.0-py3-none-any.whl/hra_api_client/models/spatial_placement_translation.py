...
class SpatialPlacementTranslation(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["x_translation", "y_translation", "z_translation", "translation_units"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpatialPlacementTranslation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpatialPlacementTranslation from a dict"""
        if obj is None:
            return None
