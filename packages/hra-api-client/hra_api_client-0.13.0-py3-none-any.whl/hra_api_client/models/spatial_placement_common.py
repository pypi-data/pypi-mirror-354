...
class SpatialPlacementCommon(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["x_translation", "y_translation", "z_translation", "translation_units", "x_rotation", "y_rotation", "z_rotation", "rotation_units", "x_scaling", "y_scaling", "z_scaling", "scaling_units"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpatialPlacementCommon from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpatialPlacementCommon from a dict"""
        if obj is None:
            return None
