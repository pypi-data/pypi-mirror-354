    ...
    def archive_policy(self, file_path, policy_name, xml_metadata=""):
        ...
        try:   
            ...
            if type == "TXT":
                ...
                body_parts.append("Content-Type: application/vnd.asg-mobius-archive-write-policy.v2+json")
                body_parts.append("")
                body_parts.append(metadata_str)
                body_parts.append(f"--{boundary_string}")
                body_parts.append("Content-Type: archive/file")
                body_parts.append("")
                ...
                if len(xml_metadata) > 0:
                    ...
                    xml_metadata_utf8 = xml_metadata.encode('utf-8')
                    body_parts.append(f"--{boundary_string}")
                    body_parts.append("Content-Type: application/vnd.asg-mobius-archive-write-aux-control.v2+xml")
                    body_parts.append("")
                    body_parts.append(xml_metadata_utf8)
                    body_parts.append("")
