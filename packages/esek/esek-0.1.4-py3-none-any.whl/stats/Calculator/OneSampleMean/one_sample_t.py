...
def one_sample_from_t_score(
    ...
    ) = calculate_central_ci_one_sample_t_test(cohens_d, sample_size, confidence_level)
    (
    ...
    ) = calculate_central_ci_one_sample_t_test(hedges_g, sample_size, confidence_level)
