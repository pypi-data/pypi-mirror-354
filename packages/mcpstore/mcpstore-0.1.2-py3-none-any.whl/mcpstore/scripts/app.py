...
from mcpstore.scripts.tool_execution import router as tool_router
from mcpstore.scripts.client_registration import router as client_router
...
async def log_requests(request: Request, call_next):
    ...
    try:
        ...
        # Re-raise to allow FastAPI's exception handling to process it
        raise
