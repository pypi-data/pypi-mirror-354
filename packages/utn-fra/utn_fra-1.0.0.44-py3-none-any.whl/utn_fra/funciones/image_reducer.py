...
class ImageReducer:
    ...
    def __redimensionar_imagen_pillow(self, ruta_entrada, nuevo_ancho=None, nuevo_alto=None, factor_escala=None, interpolacion=Image.LANCZOS):
        """
    ...
    def reduce_image_weight(self, nivel_compresion: int = 9):
        """
    ...
    def reduce_image_size(self, nuevo_ancho: int = None, nuevo_alto: int = None, factor_escala: float = None, interpolacion=Image.LANCZOS):
        self.__create_paths()
        for path in self.paths_list:
