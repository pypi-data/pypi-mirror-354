...
# plt.plot(values_no_trust[:,1])
# # plt.plot(values_normal[:,1])
# plt.plot(values_tr_josang[:,1])
# plt.plot(values_tr_ours[:,1])
# plt.plot(values_gt[:,1], 'r')

plt.plot((values_no_trust - values_gt)[:,1])
plt.plot((values_tr_josang - values_gt)[:,1])
plt.plot((values_tr_ours - values_gt)[:,1])
