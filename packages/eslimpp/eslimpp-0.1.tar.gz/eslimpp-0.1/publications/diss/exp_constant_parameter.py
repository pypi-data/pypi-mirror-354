...
reliabilities = [0.1, 0.3, 0.7, 0.9, 0.9]
...
print('median avg uncert:',np.median(uncertainties[:,-1]))
...
tikz_filename_trust = "52-opinion_definitions_const_rel.tex"
...
df.to_csv('52-exp_constant_parameter.csv', index=False)
