...
reliabilities_end = [0.6, 0.1, 0.9, 0.9, 0.9]

weighted_types_cs_avg = [
    (sl.TrustRevision.TrustRevisionType.REFERENCE_FUSION, sl.Conflict.ConflictType.BELIEF_AVERAGE, 0.1),
    (sl.TrustRevision.TrustRevisionType.HARMONY_REFERENCE_FUSION, sl.Conflict.ConflictType.BELIEF_AVERAGE, 0.06),
]
...
fig2.savefig("04-nonconstant_parameter_triangle.pdf", **export_args)
...
df.to_csv('04-exp_nonconstant_parameter.csv', index=False)
