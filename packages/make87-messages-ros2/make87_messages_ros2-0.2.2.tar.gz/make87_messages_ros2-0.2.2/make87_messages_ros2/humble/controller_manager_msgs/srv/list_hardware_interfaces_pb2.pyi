...
class ListHardwareInterfacesResponse(_message.Message):
    __slots__ = ["header", "command_interfaces", "state_interfaces"]
    HEADER_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., command_interfaces: _Optional[_Iterable[_Union[_hardware_interface_pb2.HardwareInterface, _Mapping]]] = ..., state_interfaces: _Optional[_Iterable[_Union[_hardware_interface_pb2.HardwareInterface, _Mapping]]] = ...) -> None: ...
