...
class ObstacleData(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., obstacle_id: _Optional[int] = ..., obstacle_pos_x: _Optional[float] = ..., obstacle_pos_y: _Optional[float] = ..., blinker_info: _Optional[int] = ..., cut_in_and_out: _Optional[int] = ..., obstacle_rel_vel_x: _Optional[float] = ..., obstacle_type: _Optional[int] = ..., obstacle_status: _Optional[int] = ..., obstacle_brake_lights: bool = ..., obstacle_valid: _Optional[int] = ..., obstacle_length: _Optional[float] = ..., obstacle_width: _Optional[float] = ..., obstacle_age: _Optional[int] = ..., obstacle_lane: _Optional[int] = ..., cipv_flag: bool = ..., radar_pos_x: _Optional[float] = ..., radar_vel_x: _Optional[float] = ..., radar_match_confidence: _Optional[int] = ..., matched_radar_id: _Optional[int] = ..., obstacle_angle_rate: _Optional[float] = ..., obstacle_scale_change: _Optional[float] = ..., object_accel_x: _Optional[float] = ..., obstacle_replaced: bool = ..., obstacle_angle: _Optional[float] = ...) -> None: ...
