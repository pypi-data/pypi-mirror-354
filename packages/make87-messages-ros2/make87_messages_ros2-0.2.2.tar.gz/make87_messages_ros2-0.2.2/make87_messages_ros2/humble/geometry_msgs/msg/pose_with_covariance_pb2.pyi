...
class PoseWithCovariance(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., pose: _Optional[_Union[_pose_pb2.Pose, _Mapping]] = ..., covariance: _Optional[_Iterable[float]] = ...) -> None: ...
