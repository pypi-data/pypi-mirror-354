...
class NovatelXYZ(_message.Message):
    __slots__ = ["header", "ros2_header", "novatel_msg_header", "solution_status", "position_type", "x", "y", "z", "x_sigma", "y_sigma", "z_sigma", "velocity_solution_status", "velocity_type", "x_vel", "y_vel", "z_vel", "x_vel_sigma", "y_vel_sigma", "z_vel_sigma", "base_station_id", "velocity_latency", "diff_age", "solution_age", "num_satellites_tracked", "num_satellites_used_in_solution", "num_gps_and_glonass_l1_used_in_solution", "num_gps_and_glonass_l1_and_l2_used_in_solution", "extended_solution_status", "signal_mask"]
