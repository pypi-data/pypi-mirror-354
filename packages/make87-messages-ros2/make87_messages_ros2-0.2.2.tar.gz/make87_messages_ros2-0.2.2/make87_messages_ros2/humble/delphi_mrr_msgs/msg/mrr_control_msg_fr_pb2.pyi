...
class MrrControlMsgFR(_message.Message):
    __slots__ = ["header", "ros2_header", "can_sensitivity_profile_select", "can_stop_frequency_frml", "can_stop_frequency_frll", "can_prp_factor_frml", "can_prp_factor_frll", "can_desired_sweep_bw_frml", "can_desired_sweep_bw_frll"]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., can_sensitivity_profile_select: _Optional[int] = ..., can_stop_frequency_frml: _Optional[int] = ..., can_stop_frequency_frll: _Optional[int] = ..., can_prp_factor_frml: _Optional[float] = ..., can_prp_factor_frll: _Optional[float] = ..., can_desired_sweep_bw_frml: _Optional[int] = ..., can_desired_sweep_bw_frll: _Optional[int] = ...) -> None: ...
