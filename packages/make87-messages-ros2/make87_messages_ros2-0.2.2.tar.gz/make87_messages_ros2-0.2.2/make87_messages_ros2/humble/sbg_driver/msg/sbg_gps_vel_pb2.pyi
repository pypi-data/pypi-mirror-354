...
from make87_messages_ros2.humble.sbg_driver.msg import sbg_gps_vel_status_pb2 as _sbg_gps_vel_status_pb2
...
class SbgGpsVel(_message.Message):
    __slots__ = ["header", "ros2_header", "time_stamp", "status", "gps_tow", "velocity", "velocity_accuracy", "course", "course_acc"]
    ...
    course: float
    course_acc: float
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., time_stamp: _Optional[int] = ..., status: _Optional[_Union[_sbg_gps_vel_status_pb2.SbgGpsVelStatus, _Mapping]] = ..., gps_tow: _Optional[int] = ..., velocity: _Optional[_Union[_vector3_pb2.Vector3, _Mapping]] = ..., velocity_accuracy: _Optional[_Union[_vector3_pb2.Vector3, _Mapping]] = ..., course: _Optional[float] = ..., course_acc: _Optional[float] = ...) -> None: ...
