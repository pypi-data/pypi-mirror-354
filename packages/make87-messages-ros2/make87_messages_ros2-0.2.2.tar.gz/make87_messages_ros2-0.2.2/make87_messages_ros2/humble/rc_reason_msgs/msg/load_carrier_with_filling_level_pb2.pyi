...
from make87_messages_ros2.humble.rc_reason_msgs.msg import cell_filling_level_pb2 as _cell_filling_level_pb2
...
class LoadCarrierWithFillingLevel(_message.Message):
    __slots__ = ["header", "id", "type", "outer_dimensions", "inner_dimensions", "rim_thickness", "rim_step_height", "rim_ledge", "height_open_side", "pose", "overfilled", "overall_filling_level", "cells_filling_levels", "filling_level_cell_count"]
