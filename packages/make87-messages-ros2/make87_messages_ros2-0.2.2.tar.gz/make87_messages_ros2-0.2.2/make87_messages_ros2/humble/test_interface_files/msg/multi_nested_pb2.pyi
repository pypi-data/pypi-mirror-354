...
from make87_messages_ros2.humble.test_interface_files.msg import arrays_pb2 as _arrays_pb2
from make87_messages_ros2.humble.test_interface_files.msg import bounded_sequences_pb2 as _bounded_sequences_pb2
from make87_messages_ros2.humble.test_interface_files.msg import unbounded_sequences_pb2 as _unbounded_sequences_pb2
...
class MultiNested(_message.Message):
    __slots__ = ["header", "array_of_arrays", "array_of_bounded_sequences", "array_of_unbounded_sequences", "bounded_sequence_of_arrays", "bounded_sequence_of_bounded_sequences", "bounded_sequence_of_unbounded_sequences", "unbounded_sequence_of_arrays", "unbounded_sequence_of_bounded_sequences", "unbounded_sequence_of_unbounded_sequences"]
