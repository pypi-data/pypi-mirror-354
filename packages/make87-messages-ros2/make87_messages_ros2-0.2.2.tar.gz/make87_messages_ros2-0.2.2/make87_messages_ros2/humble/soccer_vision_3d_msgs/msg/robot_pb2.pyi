...
class Robot(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., bb: _Optional[_Union[_bounding_box3_d_pb2.BoundingBox3D, _Mapping]] = ..., attributes: _Optional[_Union[_robot_pb2.Robot, _Mapping]] = ..., confidence: _Optional[_Union[_confidence_pb2.Confidence, _Mapping]] = ...) -> None: ...
