...
from make87_messages_ros2.humble.marine_acoustic_msgs.msg import ping_info_pb2 as _ping_info_pb2
from make87_messages_ros2.humble.marine_acoustic_msgs.msg import sonar_image_data_pb2 as _sonar_image_data_pb2
...
class RawSonarImage(_message.Message):
    __slots__ = ["header", "ros2_header", "ping_info", "sample_rate", "samples_per_beam", "sample0", "tx_delays", "tx_angles", "rx_angles", "image"]
