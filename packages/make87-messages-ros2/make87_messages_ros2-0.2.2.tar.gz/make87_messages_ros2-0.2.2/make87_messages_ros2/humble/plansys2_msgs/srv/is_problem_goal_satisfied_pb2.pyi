...
class IsProblemGoalSatisfiedResponse(_message.Message):
    __slots__ = ["header", "success", "satisfied", "error_info"]
    HEADER_FIELD_NUMBER: _ClassVar[int]
    ...
    satisfied: bool
    error_info: str
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., success: bool = ..., satisfied: bool = ..., error_info: _Optional[str] = ...) -> None: ...
