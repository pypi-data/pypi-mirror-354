...
class Information(_message.Message):
    __slots__ = ["header", "ros2_header", "sensor_type", "hw_temperature", "sensor_blind", "sw_fail", "hw_fail", "can_fail", "config_fail", "diag_mode", "dtc", "dtc_order_id", "sensor_not_safe", "reception_error"]
    ...
    RECEPTION_ERROR_FIELD_NUMBER: _ClassVar[int]
