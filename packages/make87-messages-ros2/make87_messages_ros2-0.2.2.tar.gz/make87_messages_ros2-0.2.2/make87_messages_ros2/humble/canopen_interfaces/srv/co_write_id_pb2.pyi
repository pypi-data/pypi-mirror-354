...
class COWriteIDRequest(_message.Message):
    __slots__ = ["header", "nodeid", "index", "subindex", "data", "canopen_datatype"]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., nodeid: _Optional[int] = ..., index: _Optional[int] = ..., subindex: _Optional[int] = ..., data: _Optional[int] = ..., canopen_datatype: _Optional[int] = ...) -> None: ...
