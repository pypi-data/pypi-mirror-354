...
class CommandTOLRequest(_message.Message):
    __slots__ = ["header", "min_pitch", "yaw", "latitude", "longitude", "altitude"]
    ...
    longitude: float
    altitude: float
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., min_pitch: _Optional[float] = ..., yaw: _Optional[float] = ..., latitude: _Optional[float] = ..., longitude: _Optional[float] = ..., altitude: _Optional[float] = ...) -> None: ...
