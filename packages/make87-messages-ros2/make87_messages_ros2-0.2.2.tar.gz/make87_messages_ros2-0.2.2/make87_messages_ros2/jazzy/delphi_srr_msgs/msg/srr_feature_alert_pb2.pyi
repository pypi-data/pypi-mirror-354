...
class SrrFeatureAlert(_message.Message):
    ...
    lcma_active: bool
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., lcma_blis_ignored_track_id: _Optional[int] = ..., lcma_blis_track_id: _Optional[int] = ..., lcma_cvw_ttc: _Optional[float] = ..., cta_ttc_alert: bool = ..., cta_selected_track_ttc: _Optional[float] = ..., cta_selected_track: _Optional[int] = ..., cta_alert: _Optional[int] = ..., cta_active: bool = ..., lcma_cvw_cipv: _Optional[int] = ..., lcma_cvw_alert_state: _Optional[int] = ..., lcma_blis_alert_state: _Optional[int] = ..., lcma_active: bool = ...) -> None: ...
