...
class RCGCRD4(_message.Message):
    __slots__ = ["player_num", "team_num", "fallen", "pose", "ball_age", "ball"]
    ...
    def __init__(self, player_num: _Optional[int] = ..., team_num: _Optional[int] = ..., fallen: _Optional[int] = ..., pose: _Optional[_Iterable[float]] = ..., ball_age: _Optional[float] = ..., ball: _Optional[_Iterable[float]] = ...) -> None: ...
