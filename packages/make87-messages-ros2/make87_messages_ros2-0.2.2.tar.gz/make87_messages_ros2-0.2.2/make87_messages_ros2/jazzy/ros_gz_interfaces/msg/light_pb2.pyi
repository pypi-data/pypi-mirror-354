...
class Light(_message.Message):
    __slots__ = ["header", "name", "type", "pose", "diffuse", "specular", "attenuation_constant", "attenuation_linear", "attenuation_quadratic", "direction", "range", "cast_shadows", "spot_inner_angle", "spot_outer_angle", "spot_falloff", "id", "parent_id", "intensity"]
    ...
    parent_id: int
    intensity: float
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., name: _Optional[str] = ..., type: _Optional[int] = ..., pose: _Optional[_Union[_pose_pb2.Pose, _Mapping]] = ..., diffuse: _Optional[_Union[_color_rgba_pb2.ColorRGBA, _Mapping]] = ..., specular: _Optional[_Union[_color_rgba_pb2.ColorRGBA, _Mapping]] = ..., attenuation_constant: _Optional[float] = ..., attenuation_linear: _Optional[float] = ..., attenuation_quadratic: _Optional[float] = ..., direction: _Optional[_Union[_vector3_pb2.Vector3, _Mapping]] = ..., range: _Optional[float] = ..., cast_shadows: bool = ..., spot_inner_angle: _Optional[float] = ..., spot_outer_angle: _Optional[float] = ..., spot_falloff: _Optional[float] = ..., id: _Optional[int] = ..., parent_id: _Optional[int] = ..., intensity: _Optional[float] = ...) -> None: ...
