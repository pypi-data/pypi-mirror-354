...
from make87_messages_ros2.rolling.ublox_ubx_msgs.msg import esf_sensor_status_pb2 as _esf_sensor_status_pb2
...
class UBXEsfStatus(_message.Message):
    __slots__ = ["header", "itow", "version", "wt_init_status", "mnt_alg_status", "ins_init_status", "imu_init_status", "fusion_mode", "num_sens", "sensor_statuses"]
