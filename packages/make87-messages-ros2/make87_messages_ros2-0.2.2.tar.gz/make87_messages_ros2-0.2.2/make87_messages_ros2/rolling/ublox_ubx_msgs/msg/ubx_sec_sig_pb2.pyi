...
from make87_messages_ros2.rolling.ublox_ubx_msgs.msg import jam_state_cent_freq_pb2 as _jam_state_cent_freq_pb2
...
class UBXSecSig(_message.Message):
    __slots__ = ["header", "version", "jam_det_enabled", "jamming_state", "spf_det_enabled", "spoofing_state", "jam_num_cent_freqs", "jam_state_cent_freqs"]
