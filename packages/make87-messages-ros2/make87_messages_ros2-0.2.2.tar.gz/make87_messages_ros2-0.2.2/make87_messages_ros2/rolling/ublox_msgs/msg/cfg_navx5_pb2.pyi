...
class CfgNAVX5(_message.Message):
    __slots__ = ["version", "mask1", "mask2", "reserved1", "min_svs", "max_svs", "min_cno", "reserved2", "ini_fix3d", "reserved3", "ack_aiding", "wkn_rollover", "sig_atten_comp_mode", "reserved4", "use_ppp", "aop_cfg", "reserved5", "aop_orb_max_err", "reserved6", "use_adr"]
