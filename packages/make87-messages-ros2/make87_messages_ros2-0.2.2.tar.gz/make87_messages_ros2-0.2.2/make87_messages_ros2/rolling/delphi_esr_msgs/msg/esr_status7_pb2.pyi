...
class EsrStatus7(_message.Message):
    __slots__ = ["header", "canmsg", "active_fault_0", "active_fault_1", "active_fault_2", "active_fault_3", "active_fault_4", "active_fault_5", "active_fault_6", "active_fault_7"]
    ...
    active_fault_6: int
    active_fault_7: int
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., canmsg: _Optional[str] = ..., active_fault_0: _Optional[int] = ..., active_fault_1: _Optional[int] = ..., active_fault_2: _Optional[int] = ..., active_fault_3: _Optional[int] = ..., active_fault_4: _Optional[int] = ..., active_fault_5: _Optional[int] = ..., active_fault_6: _Optional[int] = ..., active_fault_7: _Optional[int] = ...) -> None: ...
