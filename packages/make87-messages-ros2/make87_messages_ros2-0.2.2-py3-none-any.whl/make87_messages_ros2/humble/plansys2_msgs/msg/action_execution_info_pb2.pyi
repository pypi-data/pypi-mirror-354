...
class ActionExecutionInfo(_message.Message):
    __slots__ = ["header", "status", "start_stamp", "status_stamp", "action_full_name", "action", "arguments", "duration", "completion", "message_status"]
    ...
    completion: float
    message_status: str
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., status: _Optional[int] = ..., start_stamp: _Optional[_Union[_time_pb2.Time, _Mapping]] = ..., status_stamp: _Optional[_Union[_time_pb2.Time, _Mapping]] = ..., action_full_name: _Optional[str] = ..., action: _Optional[str] = ..., arguments: _Optional[_Iterable[str]] = ..., duration: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., completion: _Optional[float] = ..., message_status: _Optional[str] = ...) -> None: ...
