...
from make87_messages_ros2.humble.ibeo_msgs.msg import contour_point_sigma_pb2 as _contour_point_sigma_pb2
from make87_messages_ros2.humble.ibeo_msgs.msg import point2_di_pb2 as _point2_di_pb2
from make87_messages_ros2.humble.ibeo_msgs.msg import point2_dui_pb2 as _point2_dui_pb2
...
class UntrackedProperties(_message.Message):
    __slots__ = ["header", "relative_time_of_measurement", "position_closest_point", "object_box_size", "object_box_size_sigma", "object_box_orientation", "object_box_orientation_sigma", "tracking_point_coordinate", "tracking_point_coordinate_sigma", "number_of_contour_points", "contour_point_list"]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., relative_time_of_measurement: _Optional[int] = ..., position_closest_point: _Optional[_Union[_point2_di_pb2.Point2Di, _Mapping]] = ..., object_box_size: _Optional[_Union[_point2_di_pb2.Point2Di, _Mapping]] = ..., object_box_size_sigma: _Optional[_Union[_point2_dui_pb2.Point2Dui, _Mapping]] = ..., object_box_orientation: _Optional[int] = ..., object_box_orientation_sigma: _Optional[int] = ..., tracking_point_coordinate: _Optional[_Union[_point2_di_pb2.Point2Di, _Mapping]] = ..., tracking_point_coordinate_sigma: _Optional[_Union[_point2_dui_pb2.Point2Dui, _Mapping]] = ..., number_of_contour_points: _Optional[int] = ..., contour_point_list: _Optional[_Iterable[_Union[_contour_point_sigma_pb2.ContourPointSigma, _Mapping]]] = ...) -> None: ...
