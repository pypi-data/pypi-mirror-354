...
from make87_messages_ros2.humble.marine_acoustic_msgs.msg import detection_flag_pb2 as _detection_flag_pb2
...
class SonarDetections(_message.Message):
    __slots__ = ["header", "ros2_header", "ping_info", "flags", "two_way_travel_times", "tx_delays", "intensities", "tx_angles", "rx_angles"]
