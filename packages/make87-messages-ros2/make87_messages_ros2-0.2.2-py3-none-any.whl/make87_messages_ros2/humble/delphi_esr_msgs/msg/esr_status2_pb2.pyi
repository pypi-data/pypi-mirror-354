...
class EsrStatus2(_message.Message):
    __slots__ = ["header", "ros2_header", "canmsg", "maximum_tracks_ack", "rolling_count_2", "overheat_error", "range_perf_error", "internal_error", "xcvr_operational", "raw_data_mode", "steering_angle_ack", "temperature", "veh_spd_comp_factor", "grouping_mode", "yaw_rate_bias", "sw_version_dsp"]
    ...
    yaw_rate_bias: float
    sw_version_dsp: str
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., canmsg: _Optional[str] = ..., maximum_tracks_ack: _Optional[int] = ..., rolling_count_2: _Optional[int] = ..., overheat_error: bool = ..., range_perf_error: bool = ..., internal_error: bool = ..., xcvr_operational: bool = ..., raw_data_mode: bool = ..., steering_angle_ack: _Optional[int] = ..., temperature: _Optional[int] = ..., veh_spd_comp_factor: _Optional[float] = ..., grouping_mode: _Optional[int] = ..., yaw_rate_bias: _Optional[float] = ..., sw_version_dsp: _Optional[str] = ...) -> None: ...
