...
class EsrStatus9(_message.Message):
    __slots__ = ["header", "ros2_header", "canmsg", "avg_pwr_cwblkg", "sideslip_angle", "serial_num_3rd_byte", "water_spray_target_id", "filtered_xohp_acc_cipv", "path_id_acc_2", "path_id_acc_3"]
    ...
    path_id_acc_2: int
    path_id_acc_3: int
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., canmsg: _Optional[str] = ..., avg_pwr_cwblkg: _Optional[int] = ..., sideslip_angle: _Optional[float] = ..., serial_num_3rd_byte: _Optional[int] = ..., water_spray_target_id: _Optional[int] = ..., filtered_xohp_acc_cipv: _Optional[float] = ..., path_id_acc_2: _Optional[int] = ..., path_id_acc_3: _Optional[int] = ...) -> None: ...
