...
from make87_messages_ros2.humble.ublox_ubx_msgs.msg import esf_meas_data_item_pb2 as _esf_meas_data_item_pb2
...
class UBXEsfMeas(_message.Message):
    __slots__ = ["header", "ros2_header", "time_tag", "time_mark_sent", "time_mark_edge", "calib_ttag_valid", "num_meas", "id", "data", "calib_ttag"]
