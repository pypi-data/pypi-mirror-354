...
class PosCovGeodetic(_message.Message):
    __slots__ = ["header", "ros2_header", "block_header", "mode", "error", "cov_latlat", "cov_lonlon", "cov_hgthgt", "cov_bb", "cov_latlon", "cov_lathgt", "cov_latb", "cov_lonhgt", "cov_lonb", "cov_hb"]
