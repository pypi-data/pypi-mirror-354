...
class FeatureStringSetRequest(_message.Message):
    ...
    value: str
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., feature_name: _Optional[str] = ..., feature_module: _Optional[_Union[_feature_module_pb2.FeatureModule, _Mapping]] = ..., value: _Optional[str] = ...) -> None: ...

class FeatureStringSetResponse(_message.Message):
