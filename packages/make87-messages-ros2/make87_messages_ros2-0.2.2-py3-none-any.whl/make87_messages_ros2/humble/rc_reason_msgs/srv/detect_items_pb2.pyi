...
class DetectItemsRequest(_message.Message):
    __slots__ = ["header", "pose_frame", "region_of_interest_id", "load_carrier_id", "load_carrier_compartment", "item_models", "robot_pose"]
...
class DetectItemsResponse(_message.Message):
    __slots__ = ["header", "timestamp", "items", "load_carriers", "return_code"]
    HEADER_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., timestamp: _Optional[_Union[_time_pb2.Time, _Mapping]] = ..., items: _Optional[_Iterable[_Union[_item_pb2.Item, _Mapping]]] = ..., load_carriers: _Optional[_Iterable[_Union[_load_carrier_pb2.LoadCarrier, _Mapping]]] = ..., return_code: _Optional[_Union[_return_code_pb2.ReturnCode, _Mapping]] = ...) -> None: ...
