...
from make87_messages_ros2.humble.rc_reason_msgs.msg import grid_size_pb2 as _grid_size_pb2
from make87_messages_ros2.humble.rc_reason_msgs.msg import load_carrier_with_filling_level_pb2 as _load_carrier_with_filling_level_pb2
...
class DetectFillingLevelRequest(_message.Message):
    __slots__ = ["header", "pose_frame", "region_of_interest_id", "region_of_interest_2d_id", "load_carrier_ids", "robot_pose", "filling_level_cell_count"]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., pose_frame: _Optional[str] = ..., region_of_interest_id: _Optional[str] = ..., region_of_interest_2d_id: _Optional[str] = ..., load_carrier_ids: _Optional[_Iterable[str]] = ..., robot_pose: _Optional[_Union[_pose_pb2.Pose, _Mapping]] = ..., filling_level_cell_count: _Optional[_Union[_grid_size_pb2.GridSize, _Mapping]] = ...) -> None: ...
...
class DetectFillingLevelResponse(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., timestamp: _Optional[_Union[_time_pb2.Time, _Mapping]] = ..., load_carriers: _Optional[_Iterable[_Union[_load_carrier_with_filling_level_pb2.LoadCarrierWithFillingLevel, _Mapping]]] = ..., return_code: _Optional[_Union[_return_code_pb2.ReturnCode, _Mapping]] = ...) -> None: ...
