...
class ContactInformation(_message.Message):
    __slots__ = ["header", "ros2_header", "position", "normal", "depth", "contact_body_1", "body_type_1", "contact_body_2", "body_type_2"]
