...
class PlanningOptions(_message.Message):
    __slots__ = ["header", "planning_scene_diff", "plan_only", "look_around", "look_around_attempts", "max_safe_execution_cost", "replan", "replan_attempts", "replan_delay"]
    ...
    replan_attempts: int
    replan_delay: float
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., planning_scene_diff: _Optional[_Union[_planning_scene_pb2.PlanningScene, _Mapping]] = ..., plan_only: bool = ..., look_around: bool = ..., look_around_attempts: _Optional[int] = ..., max_safe_execution_cost: _Optional[float] = ..., replan: bool = ..., replan_attempts: _Optional[int] = ..., replan_delay: _Optional[float] = ...) -> None: ...
