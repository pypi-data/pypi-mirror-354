...
class UlcCmd(_message.Message):
    __slots__ = ["header", "ros2_header", "cmd", "limit_accel", "limit_decel", "limit_jerk_throttle", "limit_jerk_brake", "cmd_type", "enable", "clear", "enable_shift", "enable_shift_park", "coast_decel"]
    ...
    coast_decel: bool
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., cmd: _Optional[float] = ..., limit_accel: _Optional[float] = ..., limit_decel: _Optional[float] = ..., limit_jerk_throttle: _Optional[float] = ..., limit_jerk_brake: _Optional[float] = ..., cmd_type: _Optional[int] = ..., enable: bool = ..., clear: bool = ..., enable_shift: bool = ..., enable_shift_park: bool = ..., coast_decel: bool = ...) -> None: ...
