...
class ItineraryErase(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., participant: _Optional[int] = ..., routes: _Optional[_Iterable[int]] = ..., itinerary_version: _Optional[int] = ...) -> None: ...
