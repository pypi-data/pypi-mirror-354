...
class EsrVehicle5(_message.Message):
    __slots__ = ["header", "oversteer_understeer", "yaw_rate_bias_shift", "beamwidth_vert", "funnel_offset_left", "funnel_offset_right", "cw_blockage_threshold", "distance_rear_axle", "wheelbase", "steering_gear_ratio"]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., oversteer_understeer: _Optional[int] = ..., yaw_rate_bias_shift: bool = ..., beamwidth_vert: _Optional[float] = ..., funnel_offset_left: _Optional[float] = ..., funnel_offset_right: _Optional[float] = ..., cw_blockage_threshold: _Optional[float] = ..., distance_rear_axle: _Optional[int] = ..., wheelbase: _Optional[int] = ..., steering_gear_ratio: _Optional[float] = ...) -> None: ...
