...
from make87_messages_ros2.rolling.sensor_msgs.msg import region_of_interest_pb2 as _region_of_interest_pb2
...
class DisparityImage(_message.Message):
    ...
    max_disparity: float
    delta_d: float
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., image: _Optional[_Union[_image_pb2.Image, _Mapping]] = ..., f: _Optional[float] = ..., t: _Optional[float] = ..., valid_window: _Optional[_Union[_region_of_interest_pb2.RegionOfInterest, _Mapping]] = ..., min_disparity: _Optional[float] = ..., max_disparity: _Optional[float] = ..., delta_d: _Optional[float] = ...) -> None: ...
