...
class ActiveFaultLatched2(_message.Message):
    __slots__ = ["header", "ipma_pcan_data_range_check", "ipma_pcan_missing_msg", "vin_signal_compare_failure", "module_not_configured_error", "car_cfg_not_configured_error"]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ipma_pcan_data_range_check: bool = ..., ipma_pcan_missing_msg: bool = ..., vin_signal_compare_failure: bool = ..., module_not_configured_error: bool = ..., car_cfg_not_configured_error: bool = ...) -> None: ...
