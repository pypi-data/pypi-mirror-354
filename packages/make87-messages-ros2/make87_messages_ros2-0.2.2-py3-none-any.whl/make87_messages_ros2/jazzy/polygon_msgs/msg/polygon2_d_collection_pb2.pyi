from make87_messages_ros2.jazzy.polygon_msgs.msg import polygon2_d_pb2 as _polygon2_d_pb2
...
class Polygon2DCollection(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., polygons: _Optional[_Iterable[_Union[_polygon2_d_pb2.Polygon2D, _Mapping]]] = ..., colors: _Optional[_Iterable[_Union[_color_rgba_pb2.ColorRGBA, _Mapping]]] = ...) -> None: ...
