...
class NavSOL(_message.Message):
    __slots__ = ["i_tow", "f_tow", "week", "gps_fix", "flags", "ecef_x", "ecef_y", "ecef_z", "p_acc", "ecef_vx", "ecef_vy", "ecef_vz", "s_acc", "p_dop", "reserved1", "num_sv", "reserved2"]
