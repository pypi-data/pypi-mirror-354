...
class AccountingBillPaymentsDeleteGlobals(BaseModel):
...
class AccountingBillPaymentsDeleteRequestTypedDict(TypedDict):
    id: str
...
class AccountingBillPaymentsDeleteRequest(BaseModel):
    id: Annotated[
