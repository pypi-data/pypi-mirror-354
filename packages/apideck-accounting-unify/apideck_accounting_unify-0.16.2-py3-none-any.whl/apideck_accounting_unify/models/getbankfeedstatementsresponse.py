...
from .bankfeedstatement import BankFeedStatement, BankFeedStatementTypedDict
...
class GetBankFeedStatementsResponseTypedDict(TypedDict):
    ...
    data: List[BankFeedStatementTypedDict]
...
class GetBankFeedStatementsResponse(BaseModel):
    r"""Bank Feed Statements"""
