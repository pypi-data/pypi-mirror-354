...
from .bankfeedaccount import BankFeedAccount, BankFeedAccountTypedDict
...
class GetBankFeedAccountsResponseTypedDict(TypedDict):
    ...
    data: List[BankFeedAccountTypedDict]
...
class GetBankFeedAccountsResponse(BaseModel):
    r"""Bank Feed Accounts"""
