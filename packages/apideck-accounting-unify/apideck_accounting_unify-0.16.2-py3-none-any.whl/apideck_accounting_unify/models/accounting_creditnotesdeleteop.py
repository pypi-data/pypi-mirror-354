...
class AccountingCreditNotesDeleteGlobals(BaseModel):
...
class AccountingCreditNotesDeleteRequestTypedDict(TypedDict):
    id: str
...
class AccountingCreditNotesDeleteRequest(BaseModel):
    id: Annotated[
