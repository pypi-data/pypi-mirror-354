...
class AccountingBankFeedStatementsAllGlobalsTypedDict(TypedDict):
...
class AccountingBankFeedStatementsAllGlobals(BaseModel):
...
class AccountingBankFeedStatementsAllRequestTypedDict(TypedDict):
...
class AccountingBankFeedStatementsAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
...
class AccountingBankFeedStatementsAllResponseTypedDict(TypedDict):
    http_meta: HTTPMetadataTypedDict
    get_bank_feed_statements_response: NotRequired[
        GetBankFeedStatementsResponseTypedDict
    ]
...
class AccountingBankFeedStatementsAllResponse(BaseModel):
    next: Callable[[], Optional[AccountingBankFeedStatementsAllResponse]]

    http_meta: Annotated[Optional[HTTPMetadata], pydantic.Field(exclude=True)] = None

    get_bank_feed_statements_response: Optional[GetBankFeedStatementsResponse] = None
    r"""Bank Feed Statements"""
