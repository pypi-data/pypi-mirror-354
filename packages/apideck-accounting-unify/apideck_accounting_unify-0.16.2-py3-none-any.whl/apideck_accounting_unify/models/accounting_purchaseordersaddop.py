...
class AccountingPurchaseOrdersAddGlobals(BaseModel):
...
class AccountingPurchaseOrdersAddRequestTypedDict(TypedDict):
...
class AccountingPurchaseOrdersAddRequest(BaseModel):
