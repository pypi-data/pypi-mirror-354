...
class AccountingInvoicesDeleteGlobals(BaseModel):
...
class AccountingInvoicesDeleteRequestTypedDict(TypedDict):
    id: str
...
class AccountingInvoicesDeleteRequest(BaseModel):
    id: Annotated[
