...
class AccountingPurchaseOrdersOneGlobals(BaseModel):
...
class AccountingPurchaseOrdersOneRequestTypedDict(TypedDict):
    id: str
...
class AccountingPurchaseOrdersOneRequest(BaseModel):
    id: Annotated[
