...
class AccountingLedgerAccountsDeleteGlobals(BaseModel):
...
class AccountingLedgerAccountsDeleteRequestTypedDict(TypedDict):
    id: str
...
class AccountingLedgerAccountsDeleteRequest(BaseModel):
    id: Annotated[
