...
class AccountingInvoiceItemsAddGlobals(BaseModel):
...
class AccountingInvoiceItemsAddRequestTypedDict(TypedDict):
...
class AccountingInvoiceItemsAddRequest(BaseModel):
