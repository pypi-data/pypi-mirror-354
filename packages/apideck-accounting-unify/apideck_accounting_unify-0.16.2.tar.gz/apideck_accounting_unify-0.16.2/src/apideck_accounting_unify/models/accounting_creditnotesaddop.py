...
class AccountingCreditNotesAddGlobals(BaseModel):
...
class AccountingCreditNotesAddRequestTypedDict(TypedDict):
...
class AccountingCreditNotesAddRequest(BaseModel):
