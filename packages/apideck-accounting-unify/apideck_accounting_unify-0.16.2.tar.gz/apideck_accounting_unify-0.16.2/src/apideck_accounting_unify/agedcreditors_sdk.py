...
class AgedCreditorsSDK(BaseSDK):
    def get(
        self,
        *,
        ...
        request = models.AccountingAgedCreditorsOneRequest(
            raw=raw,
        ...
        req = self._build_request(
            ...
            _globals=models.AccountingAgedCreditorsOneGlobals(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="accounting.agedCreditorsOne",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.AccountingAgedCreditorsOneResponse(
                get_aged_creditors_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetAgedCreditorsResponse]
                ),
