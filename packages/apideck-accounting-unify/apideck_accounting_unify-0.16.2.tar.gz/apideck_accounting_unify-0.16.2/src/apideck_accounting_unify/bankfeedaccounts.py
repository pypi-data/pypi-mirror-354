        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.AccountingBankFeedAccountsAllResponse(
                get_bank_feed_accounts_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetBankFeedAccountsResponse]
                ),
        ...
        *,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return models.AccountingBankFeedAccountsAddResponse(
                create_bank_feed_account_response=utils.unmarshal_json(
                    http_res.text, Optional[models.CreateBankFeedAccountResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.AccountingBankFeedAccountsOneResponse(
                get_bank_feed_account_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetBankFeedAccountResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.AccountingBankFeedAccountsUpdateResponse(
                update_bank_feed_account_response=utils.unmarshal_json(
                    http_res.text, Optional[models.UpdateBankFeedAccountResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.AccountingBankFeedAccountsDeleteResponse(
                delete_bank_feed_account_response=utils.unmarshal_json(
                    http_res.text, Optional[models.DeleteBankFeedAccountResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
