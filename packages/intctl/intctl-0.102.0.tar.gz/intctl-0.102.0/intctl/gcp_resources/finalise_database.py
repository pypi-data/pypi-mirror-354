...
def execute_sql_job(cfg: dict, status: StatusManager):
    ...
    # FIXED: Add the --break-system-packages flag to the pip install command.
    entrypoint_script = dedent("""\
    #!/bin/sh
    set -e
    echo "Installing Python dependencies..."
    pip install --quiet --no-cache-dir --break-system-packages "asyncpg==0.29.0" "google-cloud-secretmanager==2.19.0" "google-auth==2.29.0"
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        try:
            ...
            os.chmod(entrypoint_path, 0o755) # Also good practice to set execute bit here
