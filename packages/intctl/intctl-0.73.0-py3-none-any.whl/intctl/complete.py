...
API_BASE_URL = os.getenv("INTELLITHING_API_BASE_URL", "http://34.89.82.5")
...
def post_completion_data():
    ...
    typer.secho(" finalizing setup with the IntelliThing API...", fg=typer.colors.CYAN)
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            typer.secho(f"   You can now access your deployment at: {domain}", fg=typer.colors.GREEN)
        else:
