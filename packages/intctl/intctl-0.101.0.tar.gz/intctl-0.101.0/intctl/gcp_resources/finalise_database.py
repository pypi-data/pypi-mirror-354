      ...
      template:
        spec:
          ...
          - name: sql-runner
            ...
            # FIXED: Change the command to execute the script with the shell interpreter,
            # which only requires read access, not execute access.
          ...
          - name: scripts-volume
            configMap:
              name: {configmap_name}
              # Explicitly set the file mode to be readable and executable.
              # This provides an alternative, more explicit fix.
              defaultMode: 0744
          - name: gcp-sa-key
            secret:
