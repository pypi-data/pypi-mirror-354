...
from .gcp_resources.finalise_database import finalise_database
...
from .gcp_resources.vpc import ensure_vpc_and_peering, create_temp_sql_firewall_rule, delete_temp_sql_firewall_rule
...
def setup_command() -> None:
    ...
    create_temp_sql_firewall_rule(cfg, status)
    finalise_database(cfg, status)
    delete_temp_sql_firewall_rule(cfg, status)
