...
class LFPRecording:
    ...
    def save_metadata_to_json(recording, json_path):
        ...
        metadata = {
            ...
            "number of channels": len(recording.channel_dict.keys()),
