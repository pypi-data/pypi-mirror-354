...
def trial_trajectory_EDA_plot(
    ...
    color_dict = dict(zip(unique_events, colors, strict=False))
...
def trial_trajectory_EDA_3D_plot(
    ...
    color_dict = dict(zip(unique_events, base_colors, strict=False))
    ...
    # Plot each trial
    event_trial_counters = dict.fromkeys(unique_events, 0)
