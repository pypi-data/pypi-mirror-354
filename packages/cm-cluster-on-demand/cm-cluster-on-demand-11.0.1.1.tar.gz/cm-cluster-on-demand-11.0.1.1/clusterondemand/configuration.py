...
from clusterondemand.inbound_traffic_rule import CLIENT_IP, InboundTrafficRule
...
clustercreate_ns.add_enumeration_parameter(
    ...
    help=("One or several inbound traffic rules for the cluster's head node in the following format: "
          ...
          f"parameter (e.g. all ports, all protocols, all IPs). Note: a special variable '{CLIENT_IP}' can be used to "
          "substitute src_cidr, in which case the COD client's public IP will be detected and used. "
          f"Examples: '80' '21:udp' '11.0.0.0/24,20-23:TCP' '12.0.0.0/32:6000-6500,443' '{CLIENT_IP},22:TCP' "),
