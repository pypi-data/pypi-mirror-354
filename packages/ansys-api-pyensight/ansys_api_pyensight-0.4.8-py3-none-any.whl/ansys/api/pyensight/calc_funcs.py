...
class ens_calculator:
    ...
    def casemapimage(self, part: int, variable: Union['ENS_VAR', str, int], vport: int, undefvalue: float, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def cmplx(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], scalar_or_vector: Union['ENS_VAR', str, int], frequency: float, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def dist2nodes(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], number: int, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def makevect(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], scalar: Union['float', 'ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def spameanweighted(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], variable: Union['ENS_VAR', str, int], component: str = '[X]', weight: Optional[Union['ENS_VAR', str, int]] = None, result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def tensormake(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], scalar: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def tensormakeasym(self, source_parts: Union[List['ENS_PART'], List[int], List[str], 'ENS_PART', int, str], scalar: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
