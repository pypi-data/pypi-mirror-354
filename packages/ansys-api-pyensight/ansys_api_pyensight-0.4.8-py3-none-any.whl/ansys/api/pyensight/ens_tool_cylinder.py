"""ens_tool_cylinder module

The ens_tool_cylinder module provides a proxy interface to EnSight ENS_TOOL_CYLINDER instances
...
class ENS_TOOL_CYLINDER(ENS_TOOL):
