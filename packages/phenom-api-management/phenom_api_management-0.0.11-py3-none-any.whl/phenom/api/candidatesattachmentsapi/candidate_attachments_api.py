...
class CandidateAttachmentsApi(object):
    ...
    def update_candidate_attachments_0(self, attachment, is_parsable, x_ph_userid, candidate_id, **kwargs):  # noqa: E501
        """Update Attachments  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_candidate_attachments_0(attachment, is_parsable, x_ph_userid, candidate_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_candidate_attachments_0_with_http_info(attachment, is_parsable, x_ph_userid, candidate_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_candidate_attachments_0_with_http_info(attachment, is_parsable, x_ph_userid, candidate_id, **kwargs)  # noqa: E501
            return data

    def update_candidate_attachments_0_with_http_info(self, attachment, is_parsable, x_ph_userid, candidate_id, **kwargs):  # noqa: E501
        """Update Attachments  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_candidate_attachments_0_with_http_info(attachment, is_parsable, x_ph_userid, candidate_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('is_parsable' not in params or
                params['is_parsable'] is None):
            raise ValueError("Missing the required parameter `is_parsable` when calling `update_candidate_attachments_0`")  # noqa: E501
        # verify the required parameter 'x_ph_userid' is set
        if ('x_ph_userid' not in params or
                params['x_ph_userid'] is None):
