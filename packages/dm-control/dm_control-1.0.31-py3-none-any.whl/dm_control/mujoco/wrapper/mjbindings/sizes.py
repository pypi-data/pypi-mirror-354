...
{'mjdata': {'B_colind': ('nB',),
 ...
 'mjmodel': {'actuator_acc0': ('nu',),
             ...
             'flex_edgeflap': ('nflexedge', 2),
             'flex_edgenum': ('nflex',),
             'flex_edgestiffness': ('nflex',),
             'flex_elem': ('nflexelemdata',),
             'flex_elemadr': ('nflex',),
             'flex_elemdataadr': ('nflex',),
             'flex_elemedge': ('nflexelemedge',),
             'flex_elemedgeadr': ('nflex',),
             'flex_elemlayer': ('nflexelem',),
             'flex_elemnum': ('nflex',),
             'flex_elemtexcoord': ('nflexelemdata',),
             ...
             'flex_margin': ('nflex',),
             'flex_matid': ('nflex',),
             'flex_node': ('nflexnode', 3),
             'flex_node0': ('nflexnode', 3),
             'flex_nodeadr': ('nflex',),
             'flex_nodebodyid': ('nflexnode',),
             'flex_nodenum': ('nflex',),
             'flex_priority': ('nflex',),
             'flex_radius': ('nflex',),
             'flex_rgba': ('nflex', 4),
             ...
             'mesh_pathadr': ('nmesh',),
             'mesh_polyadr': ('nmesh',),
             'mesh_polymap': ('nmeshpolymap',),
             'mesh_polymapadr': ('nmeshvert',),
             'mesh_polymapnum': ('nmeshvert',),
             'mesh_polynormal': ('nmeshpoly', 3),
             'mesh_polynum': ('nmesh',),
             'mesh_polyvert': ('nmeshpolyvert',),
             'mesh_polyvertadr': ('nmeshpoly',),
             'mesh_polyvertnum': ('nmeshpoly',),
             'mesh_pos': ('nmesh', 3),
             'mesh_quat': ('nmesh', 4),
             'mesh_scale': ('nmesh', 3),
             ...
             'skin_vertadr': ('nskin',),
             'skin_vertnum': ('nskin',),
             'tendon_actfrclimited': ('ntendon',),
             'tendon_actfrcrange': ('ntendon', 2),
             'tendon_adr': ('ntendon',),
             'tendon_armature': ('ntendon',),
