...
class BaseDiffusionModel(tf.keras.models.Model): # mlable.models.ContrastModel
    ...
    def train_step(self, data: tf.Tensor) -> dict:
        ...
        return super(BaseDiffusionModel, self).train_step(((__data, __noise_rates**2), __noises))
    ...
    def test_step(self, data: tf.Tensor) -> dict:
        ...
        __data = __signal_rates * __data + __noise_rates * __noises
        # train to predict the noise from scrambled data
        return super(BaseDiffusionModel, self).test_step(((__data, __noise_rates**2), __noises))
