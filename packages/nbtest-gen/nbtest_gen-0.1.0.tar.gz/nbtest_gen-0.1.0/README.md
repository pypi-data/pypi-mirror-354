...
* `assert_in(a, b, msg=None, type='', test_id='')`:
    * Checks membership of `a` in `b`
    * Example: `nbtest.assert_in('target', df.columns)`
...
* `assert_df_leakage(train, test, df_id='index', validation=None, err_msg='', test_id = ''):`
