...
class CreateTerminationInvoiceRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, policy_code, account_number, billing_interval_from, billing_interval_to, policy_number, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, policy_code, account_number, billing_interval_from, billing_interval_to, policy_number, *args, **kwargs):  # noqa: E501
        """CreateTerminationInvoiceRequestDto - a model defined in OpenAPI
