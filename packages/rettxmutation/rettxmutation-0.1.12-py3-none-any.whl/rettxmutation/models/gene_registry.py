...
GENES: List[Gene] = [
    ...
    Gene(
        ...
        chromosome="5",
        band="5q14.3",
        primary_transcript=RefSeqTranscript(mrna="NM_002397.5", protein="NP_002388.2"),
        secondary_transcript=RefSeqTranscript(mrna="NM_001131005.2", protein="NP_001124477.1"),
        ncbi_gene_id="https://www.ncbi.nlm.nih.gov/gene/4208",
        omim_id="https://omim.org/entry/600662",
        hgnc_id="https://www.genenames.org/data/gene-symbol-report/#!/hgnc_id/HGNC:6996"
    )
]
