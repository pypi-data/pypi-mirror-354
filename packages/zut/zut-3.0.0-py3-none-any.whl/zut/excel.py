...
class ExcelWorkbook:
    ...
    def __init__(self, path: str|os.PathLike, *, formula = NO_FORMULA, save_as: str|os.PathLike|bool|None = None):
        """
    ...
    @classmethod
    def get_instance(cls, path: str|os.PathLike, *, formula = NO_FORMULA, save_as: str|os.PathLike|bool|None = None) -> ExcelWorkbook:
    ...
    def get_table(self, name: str|None = None, default: str|None = '__raise__') -> ExcelTable:
    ...
    def __init__(self, pyxl_table: Table|str, pyxl_worksheet: Worksheet, workbook: ExcelWorkbook, no_headers: bool = None):
        ...
        if isinstance(pyxl_table, str):
            ...
            if len(self.columns) != col_count:
                raise ValueError(f'Invalid headers length ({len(self.columns)}, expected {col_count}): {self.columns}')
    ...
    def redefine(self):
        ...
        for i in range(0, self.col_count):
            if self.has_headers:
                ...
                name = self.columns[i] if i < len(self.columns) else None
