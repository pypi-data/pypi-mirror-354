...
from typing import Any, Callable, Literal, Sequence, IO, overload

from zut import Color, get_logger
...
def verify_run_process(cp: subprocess.CompletedProcess, *, strip: bool|Literal['strip','rstrip'] = False, check: int|Sequence[int]|bool = False, stdout: Literal['disable','raise','warning','error']|None = None, stderr: Literal['disable','raise','warning','error']|None = None, logger: logging.Logger|None = None) -> subprocess.CompletedProcess:
    if strip:
