...
@jsii.data_type(
    jsii_type="@wasend/core.MessageReactionRequest",
    jsii_struct_bases=[],
    name_mapping={
        "message_id": "messageId",
        "reaction": "reaction",
...
class MessageReactionRequest:
    def __init__(
        ...
        *,
        ...
        :param reaction: Emoji to react with. Send an empty string to remove the reaction.
        :param session: The session ID. Default: "default"
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2d4088a949509a17f7b954ab2b1250f23d7a508552280e12d82922c191d7571d)
            check_type(argname="argument message_id", value=message_id, expected_type=type_hints["message_id"])
            check_type(argname="argument reaction", value=reaction, expected_type=type_hints["reaction"])
            check_type(argname="argument session", value=session, expected_type=type_hints["session"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "message_id": message_id,
            "reaction": reaction,
    ...
    @builtins.property
    def reaction(self) -> builtins.str:
        '''Emoji to react with.
        ...
        Example::
            ...
            "👍"
        '''
        result = self._values.get("reaction")
        assert result is not None, "Required property 'reaction' is missing"
        return typing.cast(builtins.str, result)
    ...
    def __repr__(self) -> str:
        return "MessageReactionRequest(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class WasendClient(metaclass=jsii.JSIIMeta, jsii_type="@wasend/core.WasendClient"):
    ...
    def send_message(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9f3d92cfbbb5b460136976e221d8b96027f05c1508b3f15a8de4aa110a8dcfb4)
            check_type(argname="argument request", value=request, expected_type=type_hints["request"])
            check_type(argname="argument options", value=options, expected_type=type_hints["options"])
        return typing.cast(WAMessage, jsii.ainvoke(self, "sendMessage", [request, options]))

    @jsii.member(jsii_name="sendReaction")
    def send_reaction(
        self,
        *,
        message_id: builtins.str,
        ...
        request = MessageReactionRequest(
            message_id=message_id, reaction=reaction, session=session
        )

        return typing.cast(SdkResponse, jsii.ainvoke(self, "sendReaction", [request]))
...
def _typecheckingstub__2d4088a949509a17f7b954ab2b1250f23d7a508552280e12d82922c191d7571d(
    *,
    message_id: builtins.str,
    reaction: builtins.str,
    session: builtins.str,
...
def _typecheckingstub__9f3d92cfbbb5b460136976e221d8b96027f05c1508b3f15a8de4aa110a8dcfb4(
    request: typing.Union[SendRequest, typing.Dict[builtins.str, typing.Any]],
    options: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
) -> None:
    """Type checking stubs"""
