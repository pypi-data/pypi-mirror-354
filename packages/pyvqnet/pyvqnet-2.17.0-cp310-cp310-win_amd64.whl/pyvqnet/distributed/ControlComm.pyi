...
def init_group(rank_lists):
    """
    Initializes a set of communication groups and communicators for mpi.use CommController.ncclSplitGroup for nccl.
...
class CommController:
    ...
    def __init__(self, backend: str = 'mpi', rank: Incomplete | None = None, world_size: Incomplete | None = None) -> None: ...
    ...
    def barrier(self):
        ...
        Example::
            ...
            Comm_OP.barrier()
        '''
    def barrier_group(self, group: Incomplete | None = None):
        '''
    ...
    def recv(self, tensor_, source) -> None:
        ...
        Example::
            ...
            # mpirun -n 2 python test.py
        '''
    def all_reduce_group(self, tensor_, c_op: str = 'avg', group: Incomplete | None = None) -> None:
        '''
        ...
        Example::
            ...
            Comm_OP.all_reduce_group(complex_data, c_op="sum")
            print(f"all_reduce_group after rank {get_rank()}: {complex_data}")
            # mpirun -n 2 python test.py
        '''
    allreduce_group = all_reduce_group
    def reduce_group(self, tensor_, root: int = 0, c_op: str = 'avg', GroupComm: Incomplete | None = None) -> None:
        '''
        Reduce tensor data to process with local_rank of `root` in process group.

        :param tensor_: Input and output of the collective. The function
            operates in-place.
        :param root: local rank in GroupComm.
        :param c_op: calculation method.
        :param GroupComm: Comm.
        ...
        Example::
            ...
            # mpirun -n 2 python test.py
        '''
    def broadcast_group(self, tensor_, root: int = 0, GroupComm: Incomplete | None = None) -> None:
        '''
        ...
        Example::
            ...
            # mpirun -n 2 python test.py
        '''
    def all_gather_batch_first_group(self, tensor_, GroupComm: Incomplete | None = None):
        '''
        ...
        Example::
            ...
            complex_data = Comm_OP.all_gather_batch_first_group(complex_data)
            print(f"all_gather_batch_first_group after rank {get_rank()}: {complex_data}")
            # mpirun -n 2 python test.py
        '''
    def all_gather_group(self, tensor_, GroupComm: Incomplete | None = None):
        '''
    ...
    def grad_allreduce(self, optimizer) -> None:
        ...
        Example::
            ...
            for i in range(10):
                ...
                # print(Comm_OP.all_gather(model.parameters()[0]))
                if get_rank() == 0 :
