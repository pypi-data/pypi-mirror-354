...
class PQ_QCLOUD_UTILS:
    ...
    def insert_circuits_with_obs(self, machine, circuits: list[pq.QProg], shots: int = 1000, hamiltonian: Incomplete | None = None, sub_spilt_size: int = 1):
        """
        insert specific hamiltonian into circuits for expectation before submit to qcloud or qvm.
        """
    def submit_task_qvm(self, machine, circuits, shots: int = 1000, pauli_str_dict: Incomplete | None = None):
        """
...
def calc_exp_asyn_batched(outputs, qcir_offsets, coffs, pauli_str_dict, sub_circuits_split_size: int = 1):
    ...
    """
def get_one_expectation_component(machine, program, qubit_list, clists, shots: int = 1000, qtype=..., option: Incomplete | None = None):
    """
...
def get_cir_and_coffs_with_hami_obs(program, qubit_list, clists, pauli_str_dict):
    ...
    """
def get_expectation_realchip(machine, qubit_list, program, pauli_str_dict, clists, shots: int = 1000, qtype=..., option: Incomplete | None = None):
    """
