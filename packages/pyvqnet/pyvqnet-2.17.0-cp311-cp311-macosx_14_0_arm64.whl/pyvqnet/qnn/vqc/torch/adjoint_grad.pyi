...
from ..adjoint_grad import QuantumLayerAdjoint as NQuantumLayerAdjoint, adjoint_grad_calc as adjoint_grad_calc, apply_operation as apply_operation
from ..qcircuit import op_class_dict as op_class_dict
...
class QuantumLayerAdjoint(TorchModule, NQuantumLayerAdjoint):
    ...
    def __init__(self, general_module: nn.Module, use_qpanda: bool = False, name: str = '') -> None:
        ...
        Example::
            ...
            from pyvqnet.qnn.vqc.torch import QuantumLayerAdjoint,                 QMachine, RX, RY, CNOT, PauliX, qmatrix, PauliZ, T,                     MeasureAll, RZ, VQC_RotCircuit, VQC_HardwareEfficientAnsatz,                        QModule
