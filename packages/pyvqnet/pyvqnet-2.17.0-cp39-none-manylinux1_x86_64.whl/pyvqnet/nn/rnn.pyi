...
class RNN(Module):
    ...
    def forward(self, x, init_states: Incomplete | None = None) -> QTensor:
        """
...
class Dynamic_RNN(RNN):
    ...
    def forward(self, x: tensor.PackedSequence, init_states: Incomplete | None = None) -> tuple[tensor.PackedSequence, QTensor]:
        """
