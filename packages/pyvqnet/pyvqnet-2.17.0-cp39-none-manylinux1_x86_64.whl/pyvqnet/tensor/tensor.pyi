...
from ..native.backprop_utils import AutoGradNode as AutoGradNode, del_kv_in_global_cache_map as del_kv_in_global_cache_map
...
class QTensor:
    ...
    name: Incomplete
    def __init__(self, data, requires_grad: bool = False, nodes: list = None, device=..., dtype: Incomplete | None = None, name: str = '') -> None:
        """
    ...
    def grad(self): ...
    @grad.setter
    def grad(self, new_value: bool): ...
    def register_hook(self, f: Callable): ...
    def hook_function(self): ...
    def post_accumulate_grad_hook(self, handle): ...
    def register_post_accumulate_grad_hook(self, hook: Callable): ...
    @property
    ...
    def zero_grad(self):
        ...
        Example::
            ...
            print(t3.grad)
        """
    def backward(self, grad: Incomplete | None = None, save_grad: bool = False, save_intern_act: bool = True):
        """
    ...
    def numpy(self):
        """
        Copy self.data to a new np.array.QTensor must in CPU.
    ...
    def copy(self):
        """
        Create a new QTensor with same data value as self,while the grad and graph nodes are emtpy.
...
def to_tensor(x):
    ...
    """
def empty(shape: _size_type, device: int = 0, dtype: Incomplete | None = None):
    """
...
def empty_like(t, device: Incomplete | None = None, dtype: Incomplete | None = None):
    ...
    """
def ones(shape: _size_type, device: int = 0, dtype: Incomplete | None = None):
    """
    ...
    """
def ones_like(t, device: Incomplete | None = None, dtype: Incomplete | None = None):
    """
    ...
    """
def full(shape: _size_type, value: float | int, device: int = 0, dtype: Incomplete | None = None):
...
def norm(t, axis: _axis_type = None):
    ...
    get l2 norm value,this function is autograd.
    """
def full_like(t, value: float | int, device: Incomplete | None = None, dtype: Incomplete | None = None):
    """    Create a tensor of the specified shape and fill it with ``value``.
...
def zeros_like(t, device: Incomplete | None = None, dtype: Incomplete | None = None):
    ...
    """
def zeros(shape: _size_type, device=..., dtype: Incomplete | None = None):
    """
    ...
    """
def arange(start: float | int, end: float | int, step: float | int = 1, device: int = 0, dtype: Incomplete | None = None, requires_grad: bool = False):
    ...
    """
def linspace(start: float | int, end: float | int, nums: int, device: int = 0, dtype: Incomplete | None = None, requires_grad: bool = False):
    """    Create a 1D tensor with evenly spaced values within a given interval.
    Bool, Complex128, Complex64 type is not supported.
...
def logspace(start: float | int, end: float | int, nums: int, base: float | int, device: int = 0, dtype: Incomplete | None = None, requires_grad: bool = False):
    ...
    """
def eye(size: int, offset: int = 0, device: int = 0, dtype: Incomplete | None = None, requires_grad: bool = False):
...
def diag(t, k: int = 0):
    ...
    Examples::
        ...
        for k in range(-3, 4):
            ...
            print(u)
    """
def randu(shape: _size_type, min: float | int = 0.0, max: float | int = 1.0, device: int = 0, dtype: Incomplete | None = None, requires_grad: bool = False):
...
def randn(shape: _size_type, mean: float | int = 0.0, std: float | int = 1.0, device: int = 0, dtype: Incomplete | None = None, requires_grad: bool = False):
...
def mul(t1, t2):
    ...
    Example::
        ...
        x = mul(t1, t2)
    """
def mult_scalar(t1, val: _scalar_type): ...
def rdivide(t1, t2):
    """t2/t1"""
def divide(t1, t2):
    """
...
def pad(t, pad: _shape_type, value: _scalar_type = 0):
    ...
    """
def pad2d(t, pad_list: list[int] | tuple[int], value: int | float):
    """
