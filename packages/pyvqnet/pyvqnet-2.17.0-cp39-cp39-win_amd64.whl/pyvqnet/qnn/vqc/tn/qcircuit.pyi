...
class iSWAP(DiagonalOperation, NiSWAP, metaclass=ABCMeta):
...
class VQC_HardwareEfficientAnsatz(TorchModule, NQModule):
    ...
    Example::
        ...
        from pyvqnet.qnn.vqc.tn import Probability,QMachine
...
class VQC_QuantumEmbedding(TorchModule, NQModule):
    ...
    Example::
        ...
        from pyvqnet.qnn.vqc.tn import Probability, QMachine, MeasureAll
        from pyvqnet import tensor
        import pyvqnet
    ...
    dtype: Incomplete
    vqc: Incomplete
    def __init__(self, num_repetitions_input: int, depth_input: int, num_unitary_layers: int, num_repetitions: int, dtype: int | None = None, initial: Incomplete | None = None, name: str = '') -> None: ...
...
def vqc_quantumpooling_circuit(ignored_wires: _generic_wires_type, sinks_wires: _generic_wires_type, params, q_machine: NQMachine):
    """
...
def vqc_allsinglesdoubles(weights, q_machine: NQMachine, hf_state, wires, singles: _generic_wires_type | None = None, doubles: _generic_wires_type | None = None):
