...
class LoggerFactory:
    @staticmethod
    def create_logger(name: Incomplete | None = None, level=...):
        """create a logger
...
def log_dist(message, ranks: Incomplete | None = None, level=...) -> None:
    ...
    """
def print_json_dist(message, ranks: Incomplete | None = None, path: Incomplete | None = None) -> None:
