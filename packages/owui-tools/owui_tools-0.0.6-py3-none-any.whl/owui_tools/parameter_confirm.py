...
def parameter_confirm(filter_args=True):
    def inner(func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            arg_string = f"<center>**TOOL NAME: {tool_name}**</center><br><br>{arg_string}"
