...
class ApplyRegisteredPassOp(_ods_ir.OpView):
  ...
  def __init__(self, result, pass_name, dynamic_options, target, *, options=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if options is not None: attributes["options"] = (options if (
        ...
        not _ods_ir.AttrBuilder.contains('ArrayAttr')) else
          _ods_ir.AttrBuilder.get('ArrayAttr')(options, context=_ods_context))
...
def apply_registered_pass(result, pass_name, dynamic_options, target, *, options=None, loc=None, ip=None) -> _ods_ir.Value:
  return ApplyRegisteredPassOp(result=result, pass_name=pass_name, dynamic_options=dynamic_options, target=target, options=options, loc=loc, ip=ip).result
...
class NamedSequenceOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, function_type, *, sym_visibility=None, arg_attrs=None, res_attrs=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_492')) else
      _ods_ir.AttrBuilder.get('anonymous_492')(function_type, context=_ods_context))
