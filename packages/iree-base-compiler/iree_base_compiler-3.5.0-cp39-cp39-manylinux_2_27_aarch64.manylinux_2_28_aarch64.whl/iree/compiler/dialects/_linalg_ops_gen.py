...
def batch_reduce_matmul(result_tensors, inputs, outputs, *, indexing_maps=None, cast=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(BatchReduceMatmulOp(result_tensors=result_tensors, inputs=inputs, outputs=outputs, indexing_maps=indexing_maps, cast=cast, loc=loc, ip=ip))
...
class Conv1DNcwFcwOp(_ods_ir.OpView):
  ...
  def __init__(self, result_tensors, inputs, outputs, *, strides=None, dilations=None, loc=None, ip=None):
    ...
    if strides is not None: attributes["strides"] = (strides if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_772')) else
          _ods_ir.AttrBuilder.get('anonymous_772')(strides, context=_ods_context))
    if dilations is not None: attributes["dilations"] = (dilations if (
        isinstance(dilations, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_772')) else
          _ods_ir.AttrBuilder.get('anonymous_772')(dilations, context=_ods_context))
    results.extend(result_tensors)
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
  ...
  def __init__(self, result_tensors, inputs, outputs, *, strides=None, dilations=None, loc=None, ip=None):
    ...
    if strides is not None: attributes["strides"] = (strides if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_782')) else
          _ods_ir.AttrBuilder.get('anonymous_782')(strides, context=_ods_context))
    if dilations is not None: attributes["dilations"] = (dilations if (
        isinstance(dilations, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_782')) else
          _ods_ir.AttrBuilder.get('anonymous_782')(dilations, context=_ods_context))
    results.extend(result_tensors)
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
...
class Conv3DNcdhwFcdhwOp(_ods_ir.OpView):
  ...
  def __init__(self, result_tensors, inputs, outputs, *, strides=None, dilations=None, loc=None, ip=None):
    ...
    if strides is not None: attributes["strides"] = (strides if (
        isinstance(strides, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_819')) else
          _ods_ir.AttrBuilder.get('anonymous_819')(strides, context=_ods_context))
    if dilations is not None: attributes["dilations"] = (dilations if (
        isinstance(dilations, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_819')) else
          _ods_ir.AttrBuilder.get('anonymous_819')(dilations, context=_ods_context))
    results.extend(result_tensors)
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
