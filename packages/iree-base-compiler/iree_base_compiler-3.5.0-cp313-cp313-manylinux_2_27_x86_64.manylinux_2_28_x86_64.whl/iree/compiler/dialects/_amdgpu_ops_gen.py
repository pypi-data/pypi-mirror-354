...
class ScaledMFMAOp(_ods_ir.OpView):
  ...
  def __init__(self, m, n, k, sourceA, sourceB, destC, scalesA, scalesB, scalesIdxA, scalesIdxB, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def scaled_mfma(m, n, k, source_a, source_b, dest_c, scales_a, scales_b, scales_idx_a, scales_idx_b, *, loc=None, ip=None) -> _ods_ir.Value:
  return ScaledMFMAOp(m=m, n=n, k=k, sourceA=source_a, sourceB=source_b, destC=dest_c, scalesA=scales_a, scalesB=scales_b, scalesIdxA=scales_idx_a, scalesIdxB=scales_idx_b, loc=loc, ip=ip).result
