...
class SolverFunction(BaseModel):
    """
    SolverFunction
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["function_class", "title", "description", "input_schema", "output_schema", "default_inputs", "solver_key", "solver_version"]
