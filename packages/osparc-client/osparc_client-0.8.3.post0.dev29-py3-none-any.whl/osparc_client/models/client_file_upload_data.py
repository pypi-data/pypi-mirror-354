...
class ClientFileUploadData(BaseModel):
    ...
    """ # noqa: E501
    file_id: StrictStr = Field(description="The file resource id")
    upload_schema: FileUploadData = Field(description="Schema for uploading file")
    __properties: ClassVar[List[str]] = ["file_id", "upload_schema"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of upload_schema
        if self.upload_schema:
            _dict['upload_schema'] = self.upload_schema.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "upload_schema": FileUploadData.from_dict(obj["upload_schema"]) if obj.get("upload_schema") is not None else None
        })
        return _obj
