...
VALUESVALUE_ANY_OF_SCHEMAS = ["File", "List[object]", "bool", "float", "int", "str"]
...
class ValuesValue(BaseModel):
    ...
    anyof_schema_6_validator: Optional[List[Any]] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[File, List[object], bool, float, int, str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "File", "List[object]", "bool", "float", "int", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = ValuesValue.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ValuesValue with anyOf schemas: File, List[object], bool, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ValuesValue with anyOf schemas: File, List[object], bool, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], File, List[object], bool, float, int, str]]:
