...
class UploadLinks(BaseModel):
    ...
    UploadLinks
    """ # noqa: E501
    abort_upload: StrictStr
    complete_upload: StrictStr
    __properties: ClassVar[List[str]] = ["abort_upload", "complete_upload"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "abort_upload": obj.get("abort_upload"),
            "complete_upload": obj.get("complete_upload")
        })
        return _obj
