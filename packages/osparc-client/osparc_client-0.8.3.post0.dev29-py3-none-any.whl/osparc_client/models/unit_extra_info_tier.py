...
class UnitExtraInfoTier(BaseModel):
    ...
    """ # noqa: E501
    cpu: Annotated[int, Field(strict=True, ge=0)] = Field(alias="CPU")
    ram: Annotated[int, Field(strict=True, ge=0)] = Field(alias="RAM")
    vram: Annotated[int, Field(strict=True, ge=0)] = Field(alias="VRAM")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["CPU", "RAM", "VRAM"]
