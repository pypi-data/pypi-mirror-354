...
class Meta(BaseModel):
    ...
    released: Optional[Dict[str, Annotated[str, Field(strict=True)]]] = None
    docs_url: Annotated[str, Field(min_length=1, strict=True, max_length=2083)]
    docs_dev_url: Annotated[str, Field(min_length=1, strict=True, max_length=2083)]
    __properties: ClassVar[List[str]] = ["name", "version", "released", "docs_url", "docs_dev_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "docs_dev_url": obj.get("docs_dev_url")
        })
        return _obj
