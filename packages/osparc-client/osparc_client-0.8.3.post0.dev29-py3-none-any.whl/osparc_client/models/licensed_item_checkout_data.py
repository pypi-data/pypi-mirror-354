...
class LicensedItemCheckoutData(BaseModel):
    ...
    """ # noqa: E501
    number_of_seats: Annotated[int, Field(strict=True, ge=0)]
    service_run_id: StrictStr
    __properties: ClassVar[List[str]] = ["number_of_seats", "service_run_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "service_run_id": obj.get("service_run_id")
        })
        return _obj
