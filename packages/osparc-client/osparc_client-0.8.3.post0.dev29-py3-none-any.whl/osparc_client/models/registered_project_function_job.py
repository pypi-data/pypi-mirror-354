...
class RegisteredProjectFunctionJob(BaseModel):
    """
    ...
    uid: StrictStr
    project_job_id: StrictStr
    __properties: ClassVar[List[str]] = ["title", "description", "function_uid", "inputs", "outputs", "function_class", "uid", "project_job_id"]
