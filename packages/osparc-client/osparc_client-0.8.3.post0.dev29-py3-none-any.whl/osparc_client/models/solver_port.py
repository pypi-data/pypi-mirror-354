...
class SolverPort(BaseModel):
    ...
    SolverPort
    """ # noqa: E501
    key: Annotated[str, Field(strict=True)] = Field(description="port identifier name")
    kind: StrictStr
    content_schema: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["key", "kind", "content_schema"]

    @field_validator('key')
    def key_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^[^_\W0-9]\w*$", value):
            raise ValueError(r"must validate the regular expression /^[^_\W0-9]\w*$/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "kind": obj.get("kind"),
            "content_schema": obj.get("content_schema")
        })
        return _obj
