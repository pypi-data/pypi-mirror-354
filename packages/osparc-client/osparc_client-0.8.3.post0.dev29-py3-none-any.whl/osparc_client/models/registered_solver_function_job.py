...
class RegisteredSolverFunctionJob(BaseModel):
    """
    RegisteredSolverFunctionJob
    """ # noqa: E501
    title: Optional[StrictStr] = ''
    description: Optional[StrictStr] = ''
    function_uid: StrictStr
    inputs: Optional[Dict[str, Any]]
    outputs: Optional[Dict[str, Any]]
    function_class: Optional[StrictStr] = 'SOLVER'
    uid: StrictStr
    solver_job_id: StrictStr
    __properties: ClassVar[List[str]] = ["title", "description", "function_uid", "inputs", "outputs", "function_class", "uid", "solver_job_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "uid": obj.get("uid"),
            "solver_job_id": obj.get("solver_job_id")
        })
        return _obj
