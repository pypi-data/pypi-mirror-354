...
class LicensedResource(BaseModel):
    ...
    category_id: Annotated[str, Field(min_length=1, strict=True, max_length=100)]
    category_display: StrictStr
    terms_of_use_url: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2083)]]
    __properties: ClassVar[List[str]] = ["source", "category_id", "category_display", "terms_of_use_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "source": LicensedResourceSource.from_dict(obj["source"]) if obj.get("source") is not None else None,
            "category_id": obj.get("category_id"),
            "category_display": obj.get("category_display"),
