...
class JobMetadata(BaseModel):
    ...
    JobMetadata
    """ # noqa: E501
    job_id: StrictStr = Field(description="Parent Job")
    metadata: Dict[str, MetadataValue] = Field(description="Custom key-value map")
    url: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2083)]]
    __properties: ClassVar[List[str]] = ["job_id", "metadata", "url"]
