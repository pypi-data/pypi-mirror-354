...
class IIncomingApprovalCriteria(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["coinTransfers", "merkleChallenges", "predeterminedBalances", "approvalAmounts", "maxNumTransfers", "autoDeletionOptions", "requireFromEqualsInitiatedBy", "requireFromDoesNotEqualInitiatedBy"]
