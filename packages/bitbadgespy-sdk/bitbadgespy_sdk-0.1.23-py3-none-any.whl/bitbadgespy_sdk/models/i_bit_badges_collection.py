...
class IBitBadgesCollection(BaseModel):
    ...
    collection_permissions: ICollectionPermissions = Field(description="The collection permissions for this collection, with off-chain metadata populated.", alias="collectionPermissions")
    default_balances: IUserBalanceStore = Field(description="The default balances for users upon genesis, with off-chain metadata populated.", alias="defaultBalances")
    ...
    __properties: ClassVar[List[str]] = ["_docId", "_id", "collectionId", "collectionMetadataTimeline", "badgeMetadataTimeline", "balancesType", "offChainBalancesMetadataTimeline", "customDataTimeline", "managerTimeline", "collectionApprovals", "standardsTimeline", "isArchivedTimeline", "createdBy", "createdBlock", "createdTimestamp", "updateHistory", "validBadgeIds", "mintEscrowAddress", "collectionPermissions", "defaultBalances", "activity", "owners", "challengeTrackers", "approvalTrackers", "listings", "nsfw", "reported", "views", "claims", "stats", "badgeFloorPrices"]
