...
class IOutgoingApprovalCriteria(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["coinTransfers", "merkleChallenges", "predeterminedBalances", "approvalAmounts", "maxNumTransfers", "requireToEqualsInitiatedBy", "requireToDoesNotEqualInitiatedBy", "autoDeletionOptions"]
