...
class Classifier(BaseClassifer):
    ...
    def _get_one_sided_type(self, toks: list[Token], style_guide: str = "speaking") -> str:
        """
        Classify an edit with only one side of tokens.
        :param toks: A list of spacy tokens.
        :return: An error type string.
        """
        if self.is_repetition(toks) and style_guide == "speaking":
    ...
    def _get_two_sided_type(self, o_toks: list[Token], c_toks: list[Token], style_guide: str = "speaking") -> str:
        """
        ...
        if self.is_repetition(o_toks) and style_guide == "speaking":
            return ParentDisfluencyType.DISFLUENCY + SeparatorTypes.COLON + ChildrenFluencyType.REPETITION
        ...
        if len(o_toks) == len(c_toks) == 1:
            ...
            if set(o_pos + c_pos) == {'DET', 'PRON'} or set((o_toks[0].pos_, c_toks[0].pos_)).issubset({'DET', 'PRON', 'PROPN'}):
    ...
    def classify(self, edit: Edit, style_guide: str = "writing") -> Edit:
        """
        ...
        clone_edit = self._classify(clone_edit, style_guide)

        edit.edit_type = clone_edit.edit_type
        return edit

    def _classify(self, edit: Edit, style_guide: str = "writing") -> Edit:
        """
        ...
        # Missing
            ...
            op = Operator.MISSING
            cat = self._get_one_sided_type(edit.corrected.tokens, style_guide)
            edit.edit_type = op + SeparatorTypes.COLON + cat
        # Unnecessary
        elif edit.original.tokens and not edit.corrected.tokens:
            op = Operator.UNNECESSARY
            cat = self._get_one_sided_type(edit.original.tokens, style_guide)
            edit.edit_type = op + SeparatorTypes.COLON + cat
        ...
        # Replacement and special cases
            ...
            # Replacement
                ...
                cat = self._get_two_sided_type(
                    edit.original.tokens, edit.corrected.tokens, style_guide)
