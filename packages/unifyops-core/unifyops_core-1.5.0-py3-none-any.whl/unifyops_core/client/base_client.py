...
logger = get_logger(__name__, metadata={"component": "BaseHttpClient"})
...
class BaseHttpClient:
    ...
    def __init__(
        ...
        add_logging_metadata(
            function="BaseHttpClient.__init__",
            base_url=base_url,
            timeout=timeout,
        )
    ...
    async def request(
        ...
        *,
        ...
        add_logging_metadata(
            function="BaseHttpClient.request", method=method, endpoint=endpoint
        )
        logger.debug(
            "HTTP Request",
            metadata={
