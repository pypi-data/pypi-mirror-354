...
def brute_mysql_hydra_args(parser, get_protocol_group):
    ...
    add_argument_once(brute_group, "--mysql-userlist", nargs="+", help="User wordlist(s) for MySQL bruteforce (hydra)")
    add_argument_once(brute_group, "--mysql-passlist", nargs="+", help="Password wordlist(s) for MySQL bruteforce (hydra)")
