...
See also the corresponding user manual page for further information."""
    ...
    "material_type() -> str\n\nA string specifying the material model used for rendering object surfaces. \n\nValid values are ``'standard'`` and ``'metallic'``. \n\nThe `standard` material type is the *Phong* reflection model, which is suitable for most purposes. It supports specular highlights, which are controlled by the two parameters :py:attr:`material_shininess` and :py:attr:`material_specular_brightness`. \n\nThe `metallic` material type is a metallic material model that is suitable for rendering metals and mirror surfaces with reflective properties. The :py:attr:`material_roughness` parameter controls the roughness of the metallic material. \n\nDefault: ``'standard'``"
    ...
    material_roughness: float = 0.4
    "material_roughness() -> float\n\nA value in the range 0.0 to 1.0 that controls the roughness of the `metallic` material. A value of 0.0 gives a perfect mirror surface, while a value of 1.0 gives a completely diffuse surface. :py:attr:`material_type` must be set to ``'metallic'`` for this parameter to have an effect. \n\nDefault: ``0.4``"
