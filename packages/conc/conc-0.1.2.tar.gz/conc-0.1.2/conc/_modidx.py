...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'conc.collocates': { 'conc.collocates.Collocates': ('collocates.html#collocates', 'conc/collocates.py'),
                                 ...
                                 'conc.collocates.Collocates.collocates': ('collocates.html#collocates.collocates', 'conc/collocates.py')},
            'conc.conc': { 'conc.conc.Conc': ('conc.html#conc', 'conc/conc.py'),
                           'conc.conc.Conc.__init__': ('conc.html#conc.__init__', 'conc/conc.py'),
                           'conc.conc.Conc.collocates': ('conc.html#conc.collocates', 'conc/conc.py'),
                           'conc.conc.Conc.concordance': ('conc.html#conc.concordance', 'conc/conc.py'),
                           'conc.conc.Conc.concordance_plot': ('conc.html#conc.concordance_plot', 'conc/conc.py'),
                           'conc.conc.Conc.frequencies': ('conc.html#conc.frequencies', 'conc/conc.py'),
                           'conc.conc.Conc.keywords': ('conc.html#conc.keywords', 'conc/conc.py'),
                           'conc.conc.Conc.ngram_frequencies': ('conc.html#conc.ngram_frequencies', 'conc/conc.py'),
                           'conc.conc.Conc.ngrams': ('conc.html#conc.ngrams', 'conc/conc.py'),
                           'conc.conc.Conc.set_reference_corpus': ('conc.html#conc.set_reference_corpus', 'conc/conc.py')},
            'conc.concordance': { 'conc.concordance.Concordance': ('concordance.html#concordance', 'conc/concordance.py'),
                                  ...
                                  'conc.concordance.Concordance.concordance_plot': ( 'concordance.html#concordance.concordance_plot',
                                                                                     'conc/concordance.py'),
                                  'conc.concordance.Concordance.concordance_plot2': ( 'concordance.html#concordance.concordance_plot2',
                                                                                      'conc/concordance.py')},
            ...
            'conc.corpora': { 'conc.corpora.build_sample_corpora': ('corpora.html#build_sample_corpora', 'conc/corpora.py'),
                              'conc.corpora.create_large_dataset_sizes': ('corpora.html#create_large_dataset_sizes', 'conc/corpora.py'),
                              'conc.corpora.create_toy_corpus_sources': ('corpora.html#create_toy_corpus_sources', 'conc/corpora.py'),
                              'conc.corpora.get_garden_party': ('corpora.html#get_garden_party', 'conc/corpora.py'),
                              'conc.corpora.get_large_dataset': ('corpora.html#get_large_dataset', 'conc/corpora.py'),
                              'conc.corpora.get_nltk_corpus_sources': ('corpora.html#get_nltk_corpus_sources', 'conc/corpora.py'),
                              'conc.corpora.list_corpora': ('corpora.html#list_corpora', 'conc/corpora.py'),
                              'conc.corpora.show_toy_corpus': ('corpora.html#show_toy_corpus', 'conc/corpora.py')},
            'conc.corpus': { 'conc.corpus.Corpus': ('corpus.html#corpus', 'conc/corpus.py'),
                             ...
                             'conc.corpus.Corpus._process_space_positions': ( 'corpus.html#corpus._process_space_positions',
                                                                              'conc/corpus.py'),
                             'conc.corpus.Corpus._shift_zeroes_to_end': ('corpus.html#corpus._shift_zeroes_to_end', 'conc/corpus.py'),
                             'conc.corpus.Corpus._update_build_process': ('corpus.html#corpus._update_build_process', 'conc/corpus.py'),
                             'conc.corpus.Corpus._zero_after_value': ('corpus.html#corpus._zero_after_value', 'conc/corpus.py'),
                             ...
                             'conc.corpus.Corpus.get_token_count_text': ('corpus.html#corpus.get_token_count_text', 'conc/corpus.py'),
                             ...
                             'conc.corpus.Corpus.get_tokens_in_context': ('corpus.html#corpus.get_tokens_in_context', 'conc/corpus.py'),
                             ...
                             'conc.corpus.build_test_corpora': ('corpus.html#build_test_corpora', 'conc/corpus.py')},
            ...
            'conc.keyness': { 'conc.keyness.Keyness': ('keyness.html#keyness', 'conc/keyness.py'),
                              ...
                              'conc.keyness.Keyness.keywords': ('keyness.html#keyness.keywords', 'conc/keyness.py')},
