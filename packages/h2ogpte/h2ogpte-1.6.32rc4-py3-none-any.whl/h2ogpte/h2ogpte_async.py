...
class H2OGPTEAsync:
    ...
    def __init__(
        ...
        self._chat_api = None
        self._tag_api = None
        self._prompt_template_api = None
        self._ingestion_api = None
        self._job_api = None
        self._model_api = None
        self._system_api = None
        self._permission_api = None
        self._api_keys_api = None
        self._configuration_api = None
    ...
    async def answer_question(
        ...
        **kwargs: Any,
        ...
        response = await _rest_to_client_exceptions(
            self._model_api.answer_question(
    ...
    async def summarize_content(
        ...
        **kwargs: Any,
        ...
        model_name = await self.get_llm_name_for_rest(llm)
        response = await _rest_to_client_exceptions(
            self._model_api.summarize_content(
                model_name=model_name,
    ...
    async def cancel_job(self, job_id: str) -> Result:
        ...
        await _rest_to_client_exceptions(
            self._job_api.cancel_job(job_id=job_id, _headers=header)
        )
    ...
    async def cancel_user_job(self, job_id: str) -> Result:
        ...
        await _rest_to_client_exceptions(
            self._job_api.cancel_user_job(job_id=job_id, _headers=header)
        )
    ...
    async def count_chat_sessions(self) -> int:
        ...
        response = await _rest_to_client_exceptions(
            self._chat_api.get_chat_session_count(_headers=header)
        )
    ...
    async def count_chat_sessions_for_collection(self, collection_id: str) -> int:
        ...
        response = await _rest_to_client_exceptions(
            self._collection_api.get_chat_session_count_for_collection(
    ...
    async def count_collections(self) -> int:
        ...
        response = await _rest_to_client_exceptions(
            self._collection_api.get_collection_count(_headers=header)
        )
        return response.count
    ...
    async def count_documents(self) -> int:
        ...
        response = await _rest_to_client_exceptions(
            self._document_api.get_document_count(_headers=header)
        )
        return response.count
    ...
    async def count_documents_owned_by_me(self) -> int:
        ...
        response = await _rest_to_client_exceptions(
            self._document_api.get_document_count(owned=True, _headers=header)
        )
        return response.count
    ...
    async def count_documents_in_collection(self, collection_id: str) -> int:
        ...
        response = await _rest_to_client_exceptions(
            self._collection_api.get_document_count_for_collection(
                collection_id=collection_id, _headers=header
            )
        )
        return response.count
    ...
    async def create_chat_session(self, collection_id: Optional[str] = None) -> str:
        ...
        response = await _rest_to_client_exceptions(
            self._chat_api.create_chat_session(
                collection_id=collection_id, _headers=header
            )
        )
        return response.id
    ...
    async def create_chat_session_on_default_collection(self) -> str:
        ...
        response = await _rest_to_client_exceptions(
            self._chat_api.create_chat_session(collection_id="default", _headers=header)
        )
        return response.id
    ...
    async def list_embedding_models(self) -> List[str]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._model_api.list_embedding_models(_headers=header)
        )
    ...
    async def run_selftest(self, llm: str, mode: str) -> dict:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._model_api.run_model_self_test(
    ...
    async def get_guardrails_settings(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._model_api.create_guardrails_settings(
    ...
    async def get_agent_tools_dict(self) -> dict:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._agent_api.list_agent_tools(_headers=header)
        )
    ...
    async def create_collection(
        ...
        collection = await _rest_to_client_exceptions(
            self._collection_api.create_collection(request, _headers=headers)
        )
    ...
    async def set_collection_thumbnail(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._collection_api.create_update_collection_thumbnail_job(
    ...
    async def remove_collection_thumbnail(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._collection_api.create_delete_collection_thumbnail_job(
                collection_id=collection_id, _headers=header
            )
        )
        return await self._wait_for_completion(response.id, timeout=timeout)
    ...
    async def create_topic_model(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._model_api.create_topic_model_job(
    ...
    async def delete_chat_sessions(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._chat_api.create_delete_chat_session_job(
    ...
    async def delete_chat_messages(self, chat_message_ids: Iterable[str]) -> Result:
        ...
        result = await _get_result(
            _rest_to_client_exceptions(
                self._chat_api.delete_messages(
    ...
    async def delete_document_summaries(self, summaries_ids: Iterable[str]) -> Result:
        ...
        result = await _get_result(
            _rest_to_client_exceptions(
                self._document_api.delete_document_summaries(
    ...
    async def get_collection_questions(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._collection_api.list_questions_for_collection(
    ...
    async def get_chat_session_questions(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._chat_api.list_questions_for_chat_session(
    ...
    async def set_collection_expiry_date(
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._collection_api.update_collection_expiry_date(
                collection_id=collection_id,
    ...
    async def remove_collection_expiry_date(self, collection_id: str) -> str:
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._collection_api.delete_collection_expiry_date(
                collection_id=collection_id, _headers=header
            )
        )
        return collection_id
    ...
    async def set_collection_inactivity_interval(
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._collection_api.update_collection_inactivity_interval(
                collection_id=collection_id,
    ...
    async def remove_collection_inactivity_interval(self, collection_id: str) -> str:
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._collection_api.delete_collection_inactivity_interval(
                collection_id=collection_id, _headers=header
            )
        )
        return collection_id
    ...
    async def set_collection_size_limit(
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._collection_api.set_collection_size_limit(
                collection_id=collection_id,
    ...
    async def remove_collection_size_limit(self, collection_id: str) -> str:
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._collection_api.remove_collection_size_limit(
                collection_id=collection_id,
                _headers=header,
            )
        )
    ...
    async def unarchive_collection(self, collection_id: str) -> str:
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._collection_api.unarchive_collection(
                collection_id=collection_id, _headers=header
            )
        )
        return collection_id
    ...
    async def archive_collection(self, collection_id: str) -> str:
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._collection_api.archive_collection(
                collection_id=collection_id, _headers=header
            )
        )
        return collection_id
    ...
    async def delete_collections(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._collection_api.create_delete_collection_job(
    ...
    async def delete_documents(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._document_api.create_delete_document_job(
    ...
    async def delete_documents_from_collection(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._collection_api.create_delete_document_from_collection_job(
                collection_id=collection_id,
    ...
    async def import_collection_into_collection(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._collection_api.create_import_collection_to_collection_job(
                collection_id=collection_id,
    ...
    async def import_document_into_collection(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._collection_api.create_insert_document_to_collection_job(
                collection_id=collection_id,
    ...
    async def process_document(
        ...
        response = await _rest_to_client_exceptions(
            self._document_api.create_process_document_job(
        ...
        summary = await _rest_to_client_exceptions(
            self._document_api.get_document_summary(
    ...
    async def list_recent_document_summaries(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._document_api.list_document_summaries(
                document_id=document_id,
                offset=offset,
                limit=limit,
                _headers=header,
    ...
    async def encode_for_retrieval(
        ...
        if embedding_model is None:
            rest_embedding_model = await _rest_to_client_exceptions(
                self._model_api.get_default_embedding_model(_headers=header)
            )
            embedding_model = rest_embedding_model.id
        result = await _rest_to_client_exceptions(
            self._model_api.encode_chunks_for_retrieval(
    ...
    async def get_chunks(
        ...
        rest_chunks = await _rest_to_client_exceptions(
            self._collection_api.get_collection_chunks(
    ...
    async def get_collection(self, collection_id: str) -> Collection:
        ...
        rest_collection = await _rest_to_client_exceptions(
            self._collection_api.get_collection(
                collection_id=collection_id, _headers=header
            )
        )
        ...
        rest_settings = await _rest_to_client_exceptions(
            self._collection_api.get_collection_settings(
                collection_id=collection_id, _headers=header
            )
        )
        ...
        rest_chat_settings = await _rest_to_client_exceptions(
            self._collection_api.get_collection_chat_settings(
                collection_id=collection_id, _headers=header
            )
        )
        ...
        metadata = await _rest_to_client_exceptions(
            self._collection_api.get_collection_metadata(
                collection_id=collection_id, _headers=header
            )
        )
        if metadata != {}:
    ...
    async def get_collection_for_chat_session(self, chat_session_id: str) -> Collection:
        ...
        chat_session = await _rest_to_client_exceptions(
            self._chat_api.get_chat_session(chat_session_id, _headers=header)
        )
    ...
    async def get_job(self, job_id: str) -> Job:
        ...
        rest_job = await _rest_to_client_exceptions(
            self._job_api.get_job(job_id=job_id, _headers=header)
        )
    ...
    async def get_llm_usage_24h(self) -> float:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._model_api.get_usage_stats(interval="24 hours", _headers=header)
        )
    ...
    async def get_llm_usage_24h_by_llm(self) -> List[LLMUsage]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._model_api.get_usage_stats_by_model(
    ...
    async def get_llm_usage_6h(self) -> float:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._model_api.get_usage_stats(interval="6 hours", _headers=header)
        )
        return response.current
    ...
    async def get_llm_usage_with_limits(self, interval: str) -> LLMUsageLimit:
        ...
        header = await self._get_auth_header()
        usage = await _rest_to_client_exceptions(
            self._model_api.get_usage_stats(interval=interval, _headers=header)
        )
        return LLMUsageLimit(**usage.to_dict())
    ...
    async def get_llm_usage_by_llm(self, interval: str) -> List[LLMUsage]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._model_api.get_usage_stats_by_model(interval=interval, _headers=header)
        )
        return [LLMUsage(**d.to_dict()) for d in response]
    ...
    async def get_llm_usage_by_user(self, interval: str) -> List[UserWithLLMUsage]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._model_api.get_usage_stats_by_user(interval=interval, _headers=header)
        )
    ...
    async def get_llm_usage_by_llm_and_user(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._model_api.get_usage_stats_by_model_and_user(
    ...
    async def get_llm_performance_by_llm(self, interval: str) -> List[LLMPerformance]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._model_api.get_performance_stats_by_model(
                interval=interval, _headers=header
            )
        )
    ...
    async def get_scheduler_stats(self) -> SchedulerStats:
        ...
        rest_stats = await _rest_to_client_exceptions(
            self._job_api.count_pending_jobs(_headers=header)
        )
    ...
    async def ingest_from_file_system(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._ingestion_api.create_ingest_from_file_system_job(
                collection_id=collection_id,
    ...
    async def ingest_from_plain_text(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._ingestion_api.create_ingest_from_plain_text_job(
                collection_id=collection_id,
                body=plain_text,
                file_name=file_name,
                gen_doc_summaries=gen_doc_summaries,
    ...
    async def ingest_from_s3(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._ingestion_api.create_ingest_from_s3_job(
                collection_id=collection_id,
    ...
    async def ingest_from_gcs(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._ingestion_api.create_ingest_from_gcs_job(
                collection_id=collection_id,
    ...
    async def ingest_from_azure_blob_storage(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._ingestion_api.create_ingest_from_azure_blob_storage_job(
                collection_id=collection_id,
    ...
    async def ingest_uploads(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._ingestion_api.create_ingest_upload_job(
                collection_id=collection_id,
    ...
    async def ingest_website(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._ingestion_api.create_ingest_from_website_job(
                collection_id=collection_id,
    ...
    async def ingest_agent_only_to_standard(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._ingestion_api.create_ingest_agent_only_to_standard_job(
                collection_id=collection_id,
                document_id=document_id,
                gen_doc_summaries=gen_doc_summaries,
                gen_doc_questions=gen_doc_questions,
    ...
    async def list_chat_messages(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._chat_api.get_chat_session_messages(
                session_id=chat_session_id, offset=offset, limit=limit, _headers=header
            )
        )
    ...
    async def list_chat_message_references(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._chat_api.get_message_references(
    ...
    async def list_list_chat_message_meta(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._chat_api.get_message_meta(message_id=message_id, _headers=header)
        )
    ...
    async def list_chat_message_meta_part(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._chat_api.get_message_meta(
    ...
    async def list_chat_sessions_for_collection(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._collection_api.list_chat_sessions_for_collection(
                collection_id=collection_id, offset=offset, limit=limit, _headers=header
            )
        )
    ...
    async def list_chat_sessions_for_document(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._document_api.list_chat_sessions_for_document(
    ...
    async def rename_chat_session(self, chat_session_id: str, name: str):
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._chat_api.update_chat_session(
                session_id=chat_session_id,
                chat_session_update_request=rest.ChatSessionUpdateRequest(name=name),
                _headers=header,
            )
        )
    ...
    async def list_collections_for_document(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._document_api.list_collections_for_document(
                document_id=document_id, offset=offset, limit=limit, _headers=header
            )
        )
    ...
    async def list_documents_in_collection(
        ...
        response = await _rest_to_client_exceptions(
            self._collection_api.list_documents_for_collection(
                collection_id=collection_id,
                offset=offset,
                limit=limit,
    ...
    async def list_jobs(self) -> List[Job]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._job_api.list_jobs(_headers=header)
        )
    ...
    async def list_all_jobs(self) -> List[UserJobs]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._job_api.list_user_jobs(_headers=header)
        )
    ...
    async def list_recent_chat_sessions(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._chat_api.list_chat_sessions(
    ...
    async def list_question_reply_feedback_data(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._chat_api.list_question_answer_feedbacks(
                offset=offset, limit=limit, _headers=header
            )
        )
    ...
    async def update_question_reply_feedback(
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._chat_api.update_question_answer_feedback(
                answer_id=reply_id,
    ...
    async def count_question_reply_feedback(self) -> int:
        ...
        response = await _rest_to_client_exceptions(
            self._chat_api.get_question_answer_feedback_count(_headers=header)
        )
        return response.count
    ...
    async def list_recent_collections(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._collection_api.list_collections(
                offset=offset, limit=limit, _headers=header
            )
        )
    ...
    async def list_all_collections_sort(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._collection_api.list_all_collections(
                offset=offset,
                limit=limit,
                sort_column=sort_column,
                ascending=ascending,
    ...
    async def list_collection_permissions(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._collection_api.get_collection_permissions(
                collection_id=collection_id,
                _headers=header,
            )
        )
    ...
    async def list_users(self, offset: int, limit: int) -> List[User]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._permission_api.list_users(
                offset=offset,
                limit=limit,
                _headers=header,
            )
    ...
    async def share_collection(
        ...
        result = await _get_share_permission_status(
            _rest_to_client_exceptions(
                self._collection_api.share_collection(
                    collection_id=collection_id,
    ...
    async def unshare_collection(
        ...
        result = await _get_share_permission_status(
            _rest_to_client_exceptions(
                self._collection_api.unshare_collection(
                    collection_id=collection_id,
                    username=permission.username,
                    _headers=header,
                )
    ...
    async def unshare_collection_for_all(
        ...
        result = await _get_share_permission_status(
            _rest_to_client_exceptions(
                self._collection_api.unshare_collection_for_all(
                    collection_id=collection_id,
                    _headers=header,
                )
            )
    ...
    async def make_collection_public(self, collection_id: str):
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._collection_api.update_collection_privacy(
                collection_id=collection_id,
    ...
    async def share_collection_with_group(
        ...
        result = await _get_share_permission_status(
            _rest_to_client_exceptions(
                self._collection_api.share_collection_with_group(
                    collection_id=collection_id,
    ...
    async def unshare_collection_from_group(
        ...
        result = await _get_share_permission_status(
            _rest_to_client_exceptions(
                self._collection_api.unshare_collection_from_group(
                    collection_id=collection_id,
                    group_id=permission.group_id,
                    _headers=header,
                )
    ...
    async def list_recent_documents(
        ...
        if metadata_filter and len(metadata_filter) > 0:
            metadata_filter_json = json.dumps(metadata_filter)
        response = await _rest_to_client_exceptions(
            self._document_api.list_documents(
                offset=offset,
                limit=limit,
                metadata_filter=metadata_filter_json,
                _headers=header,
    ...
    async def match_chunks(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._collection_api.match_collection_chunks(
                collection_id=collection_id,
    ...
    async def search_chunks(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._collection_api.search_collection_chunks(
                collection_id=collection_id,
    ...
    async def list_document_chunks(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._document_api.list_document_chunks(
                collection_id=collection_id,
                document_id=document_id,
                _headers=header,
            )
    ...
    async def set_chat_message_votes(self, chat_message_id: str, votes: int) -> Result:
        ...
        result = await _get_result(
            _rest_to_client_exceptions(
                self._chat_api.set_message_votes(
    ...
    async def update_collection(
        ...
        collection = await _rest_to_client_exceptions(
            self._collection_api.update_collection(
                collection_id=collection_id,
    ...
    async def reset_collection_prompt_settings(self, collection_id: str) -> str:
        ...
        await _rest_to_client_exceptions(
            self._collection_api.reset_collection_prompt_settings(
                collection_id=collection_id,
                _headers=header,
            )
        )
    ...
    async def update_collection_settings(
        ...
        await _rest_to_client_exceptions(
            self._collection_api.update_collection_settings(
                collection_id=collection_id,
    ...
    async def update_collection_metadata(
        ...
        await _rest_to_client_exceptions(
            self._collection_api.update_collection_metadata(
                collection_id=collection_id,
    ...
    async def update_document_name(self, document_id: str, name: str) -> str:
        ...
        document = await _rest_to_client_exceptions(
            self._document_api.update_document(
                document_id=document_id,
                document_update_request=rest.DocumentUpdateRequest(name=name.strip()),
                _headers=header,
            )
        )
        return document.id
    ...
    async def update_document_metadata(
        ...
        await _rest_to_client_exceptions(
            self._document_api.update_document_metadata(
                document_id=document_id, request_body=document_metadata, _headers=header
            )
        )
        return document_id
    ...
    async def get_llms(self) -> List[Dict[str, Any]]:
        ...
        models = await _rest_to_client_exceptions(
            self._model_api.list_models(_headers=header)
        )
    ...
    async def get_vision_capable_llm_names(self) -> List[str]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._model_api.get_vision_capable_model_names(_headers=header)
        )
        return response
    ...
    async def get_llm_and_auto_vision_llm_names(self) -> Dict[str, str]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._model_api.get_model_to_vision_model_mapping(_headers=header)
        )
        return response
    ...
    async def get_reasoning_capable_llm_names(self) -> List[str]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._model_api.get_reasoning_capable_model_names(_headers=header)
        )
        return response
    ...
    async def get_llm_and_auto_reasoning_llm_names(self) -> Dict[str, str]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._model_api.get_model_to_reasoning_model_mapping(_headers=header)
        )
        return response
    ...
    async def list_recent_prompt_templates(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._prompt_template_api.list_prompt_templates(
                offset=offset,
                limit=limit,
                _headers=header,
            )
    ...
    async def get_prompt_template(self, id: Optional[str] = None) -> PromptTemplate:
        ...
        if id is None:
            response = await _rest_to_client_exceptions(
                self._prompt_template_api.get_default_prompt_template(_headers=header)
            )
        else:
            response = await _rest_to_client_exceptions(
                self._prompt_template_api.get_prompt_template(
    ...
    async def delete_prompt_templates(self, ids: Iterable[str]) -> Result:
        ...
        result = await _get_result(
            _rest_to_client_exceptions(
                self._prompt_template_api.delete_prompt_template(
    ...
    async def update_prompt_template(
        ...
        response = await _rest_to_client_exceptions(
            self._prompt_template_api.update_prompt_template(
    ...
    async def create_prompt_template(
        ...
        response = await _rest_to_client_exceptions(
            self._prompt_template_api.create_prompt_template(
    ...
    async def count_prompt_templates(self) -> int:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._prompt_template_api.get_prompt_template_count(_headers=header)
        )
        return response.count
    ...
    async def share_prompt(
        ...
        result = await _get_share_permission_status(
            _rest_to_client_exceptions(
                self._prompt_template_api.share_prompt_template(
    ...
    async def unshare_prompt(
        ...
        result = await _get_share_permission_status(
            _rest_to_client_exceptions(
                self._prompt_template_api.unshare_prompt_template(
                    prompt_template_id=prompt_id,
                    username=permission.username,
                    _headers=header,
                )
    ...
    async def unshare_prompt_for_all(self, prompt_id: str) -> ShareResponseStatus:
        ...
        result = await _get_share_permission_status(
            _rest_to_client_exceptions(
                self._prompt_template_api.unshare_prompt_template_for_all(
    ...
    async def reset_and_share_prompt_template(
        ...
        result = await _get_share_permission_status(
            _rest_to_client_exceptions(
                self._prompt_template_api.reset_and_share_prompt_template(
                    prompt_template_id=prompt_id,
    ...
    async def list_prompt_permissions(self, prompt_id: str) -> List[SharePermission]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._prompt_template_api.get_prompt_template_permissions(
                prompt_template_id=prompt_id, _headers=header
            )
        )
        return [SharePermission(**d.to_dict()) for d in response]
    ...
    async def set_collection_prompt_template(
        ...
        if prompt_template_id is None:
            response = await _rest_to_client_exceptions(
                self._collection_api.delete_collection_prompt_template(
                    collection_id=collection_id, _headers=header
                )
            )
        else:
            ...
            response = await _rest_to_client_exceptions(
                self._collection_api.update_collection_prompt_template(
                    collection_id=collection_id,
    ...
    async def set_chat_session_prompt_template(
        ...
        if prompt_template_id is None:
            response = await _rest_to_client_exceptions(
                self._chat_api.delete_chat_session_prompt_template(
                    session_id=chat_session_id,
                    _headers=header,
                )
            )
            ...
            response = await _rest_to_client_exceptions(
                self._chat_api.update_chat_session_prompt_template(
                    session_id=chat_session_id,
                    prompt_template_change_request=rest.PromptTemplateChangeRequest(
                        prompt_template_id=prompt_template_id,
                    ),
    ...
    async def get_chat_session_prompt_template(
        ...
        rest_session = await _rest_to_client_exceptions(
            self._chat_api.get_chat_session(
                session_id=chat_session_id,
                _headers=header,
            )
        )
    ...
    async def set_chat_session_collection(
        ...
        if collection_id is None:
            response = await _rest_to_client_exceptions(
                self._chat_api.delete_chat_session_collection(
                    session_id=chat_session_id, _headers=header
                )
            )
        else:
            response = await _rest_to_client_exceptions(
                self._chat_api.update_chat_session_collection(
                    session_id=chat_session_id,
    ...
    async def tag_document(self, document_id: str, tag_name: str) -> str:
        ...
        response = await _rest_to_client_exceptions(
            self._document_api.create_tag_on_document(
                document_id=document_id,
    ...
    async def untag_document(self, document_id: str, tag_name: str) -> str:
        ...
        response = await _rest_to_client_exceptions(
            self._document_api.delete_tag_from_document(
    ...
    async def get_tag(self, tag_name: str) -> Tag:
        ...
        response = await _rest_to_client_exceptions(
            self._tag_api.get_tag(tag_name=tag_name, _headers=header)
        )
    ...
    async def create_tag(self, tag_name: str) -> str:
        ...
        response = await _rest_to_client_exceptions(
            self._tag_api.create_tag(
                tag_create_request=rest.TagCreateRequest(name=tag_name), _headers=header
            )
        )
    ...
    async def list_all_tags(self) -> List[Tag]:
        ...
        response = await _rest_to_client_exceptions(
            self._tag_api.list_tags(_headers=header)
        )
    ...
    async def list_documents_from_tags(
        ...
        response = await _rest_to_client_exceptions(
            self._tag_api.list_documents_for_tags(
    ...
    async def add_user_document_permission(
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._permission_api.add_user_document_permission(
                document_id=document_id,
                user_id=user_id,
                _headers=header,
            )
    ...
    async def list_system_permissions(self) -> List[UserPermission]:
        ...
        rest_permissions = await _rest_to_client_exceptions(
            self._permission_api.list_permissions(_headers=header)
        )
    ...
    async def list_system_roles(self) -> List[UserRole]:
        ...
        rest_roles = await _rest_to_client_exceptions(
            self._permission_api.list_roles(_headers=header)
        )
    ...
    async def list_system_groups(self) -> List[UserGroup]:
        ...
        rest_groups = await _rest_to_client_exceptions(
            self._permission_api.list_groups(_headers=header)
        )
    ...
    async def list_user_roles(self, user_id: Optional[str] = None) -> List[UserRole]:
        ...
        if user_id:
            rest_roles = await _rest_to_client_exceptions(
                self._permission_api.get_user_roles(user_id=user_id, _headers=header)
            )
        else:
            rest_roles = await _rest_to_client_exceptions(
                self._permission_api.get_current_user_roles(_headers=header)
            )
        return [UserRole(**r.to_dict()) for r in rest_roles]
    ...
    async def list_group_roles(self, group_id: str) -> List[UserRole]:
        ...
        header = await self._get_auth_header()
        rest_roles = await _rest_to_client_exceptions(
            self._permission_api.get_group_roles(group_id=group_id, _headers=header)
        )
        return [UserRole(**r.to_dict()) for r in rest_roles]
    ...
    async def list_user_permissions(
        ...
        if user_id:
            rest_permissions = await _rest_to_client_exceptions(
                self._permission_api.get_user_permissions(
                    user_id=user_id, _headers=header
                )
            )
        else:
            rest_permissions = await _rest_to_client_exceptions(
                self._permission_api.get_current_user_permissions(_headers=header)
            )
        return [UserPermission(**p.to_dict()) for p in rest_permissions]
    ...
    async def list_group_permissions(self, group_id: str) -> List[UserPermission]:
        ...
        header = await self._get_auth_header()
        rest_permissions = await _rest_to_client_exceptions(
            self._permission_api.get_group_permissions(
    ...
    async def list_group_permissions_by_name(
        ...
        header = await self._get_auth_header()
        rest_permissions = await _rest_to_client_exceptions(
            self._permission_api.list_permissions(
    ...
    async def list_user_role_permissions(
        ...
        header = await self._get_auth_header()
        rest_permissions = await _rest_to_client_exceptions(
            self._permission_api.list_permissions(role_names=roles, _headers=header)
        )
        return [UserPermission(**p.to_dict()) for p in rest_permissions]
    ...
    async def add_role_to_user(self, user_id: str, roles: List[str]) -> List[UserRole]:
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._permission_api.assign_roles_to_user(
    ...
    async def reset_roles_for_user(
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._permission_api.reset_user_roles(
                user_id=user_id,
    ...
    async def remove_role_from_user(
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._permission_api.remove_roles_from_user(
                user_id=user_id, role_names=roles, _headers=header
            )
        )
        return await self.list_user_roles(user_id=user_id)
    ...
    async def add_role_to_group(
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._permission_api.assign_roles_to_group(
    ...
    async def reset_roles_for_group(
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._permission_api.reset_group_roles(
                group_id=group_id,
                roles_reset_request=rest.RolesResetRequest(new_roles=roles),
                _headers=header,
            )
    ...
    async def remove_role_from_group(
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._permission_api.remove_roles_from_group(
                group_id=group_id, role_names=roles, _headers=header
            )
        )
        return await self.list_group_roles(group_id=group_id)
    ...
    async def is_permission_granted(self, permission: str) -> bool:
        ...
        header = await self._get_auth_header()
        result = await _rest_to_client_exceptions(
            self._permission_api.is_permission_granted(
    ...
    async def is_collection_permission_granted(
        ...
        header = await self._get_auth_header()
        result = await _rest_to_client_exceptions(
            self._permission_api.is_collection_permission_granted(
                collection_id=collection_id,
                permission_check_request=rest.PermissionCheckRequest(
                    permission=permission
                ),
    ...
    async def create_user_role(self, name: str, description: str) -> UserRole:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._permission_api.create_role(
    ...
    async def create_user_group(self, name: str, description: str) -> UserGroup:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._permission_api.create_group(
    ...
    async def delete_user_roles_by_ids(self, roles_ids: Iterable[str]) -> Result:
        ...
        result = await _get_result(
            _rest_to_client_exceptions(
                self._permission_api.delete_roles(
                    role_ids=roles_ids,
                    _headers=header,
                )
            )
    ...
    async def delete_user_roles_by_names(self, roles_names: Iterable[str]) -> Result:
        ...
        result = await _get_result(
            _rest_to_client_exceptions(
                self._permission_api.delete_roles_by_names(
                    names=roles_names,
                    _headers=header,
                )
            )
    ...
    async def delete_user_groups_by_ids(self, groups_ids: Iterable[str]) -> Result:
        ...
        result = await _get_result(
            _rest_to_client_exceptions(
                self._permission_api.delete_groups(
    ...
    async def delete_user_groups_by_names(self, groups_names: Iterable[str]) -> Result:
        ...
        result = await _get_result(
            _rest_to_client_exceptions(
                self._permission_api.delete_groups_by_names(
                    names=groups_names,
                    _headers=header,
                )
            )
    ...
    async def assign_permissions_to_role(
        ...
        result = await _get_result(
            _rest_to_client_exceptions(
                self._permission_api.set_role_permissions(
                    role_id=role_name,
    ...
    async def set_global_configuration(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._configuration_api.set_global_configuration(
                key_name=key_name,
    ...
    async def get_global_configurations_by_admin(self) -> List[ConfigItem]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._configuration_api.list_global_configurations(
                as_admin=True,
                _headers=header,
            )
        )
    ...
    async def bulk_delete_global_configurations(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._configuration_api.delete_global_configurations(
                key_names=key_names,
                _headers=header,
            )
        )
    ...
    async def set_user_configuration_for_user(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._configuration_api.set_user_configuration(
                key_name=key_name,
                user_id=user_id,
    ...
    async def get_user_configurations_for_user(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._configuration_api.list_user_configurations(
                user_id=user_id,
                _headers=header,
            )
        )
    ...
    async def get_user_configurations(self) -> List[UserConfigItem]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._configuration_api.list_current_user_configurations(_headers=header)
        )
        return [UserConfigItem(**c.to_dict()) for c in response]
    ...
    async def bulk_delete_user_configurations_for_user(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._configuration_api.delete_user_configurations(
                user_id=user_id,
                key_names=key_names,
                _headers=header,
            )
    ...
    async def reset_user_configurations_for_user(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._configuration_api.reset_user_configuration(
                user_id=user_id,
                key_name=key_name,
                _headers=header,
            )
    ...
    async def delete_agent_directories(self, chat_session_id: str) -> bool:
        ...
        result = await _get_result(
            _rest_to_client_exceptions(
                self._chat_api.delete_agent_server_directories(
    ...
    async def get_all_directory_stats(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._chat_api.list_all_agent_server_directories_stats(
                session_id=chat_session_id,
    ...
    async def get_directory_stats(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._chat_api.get_agent_server_directory_stats(
                session_id=chat_session_id,
                detail_level=detail_level,
    ...
    async def get_h2ogpt_system_stats(self) -> dict:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._system_api.get_h2ogpt_system_info(_headers=header)
        )
        return response.to_dict()
    ...
    async def create_api_key_for_user(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._api_keys_api.create_api_key_for_user(
    ...
    async def deactivate_api_key(self, api_key_id: str) -> Result:
        ...
        result = await _get_result(
            _rest_to_client_exceptions(
                self._api_keys_api.deactivate_api_key(
                    key_id=api_key_id,
                    _headers=header,
                )
            )
    ...
    async def list_all_api_keys(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._api_keys_api.list_all_api_keys(
                offset=offset,
                limit=limit,
                filter=key_filter,
                _headers=header,
    ...
    async def set_api_key_expiration(
        ...
        result = await _get_result(
            _rest_to_client_exceptions(
                self._api_keys_api.update_api_key_expiry(
                    key_id=api_key_id,
    ...
    async def delete_api_keys(self, api_key_ids: List[str]) -> Result:
        ...
        for api_key_id in api_key_ids:
            await _rest_to_client_exceptions(
                self._api_keys_api.delete_api_key(
                    key_id=api_key_id,
                    _headers=header,
                )
            )
    ...
    async def get_agent_server_files(self, chat_session_id: str) -> List[dict]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._chat_api.list_agent_server_files(
                session_id=chat_session_id,
                _headers=header,
            )
        )
    ...
    async def delete_agent_server_files(self, chat_session_id: str) -> bool:
        ...
        result = await _get_result(
            _rest_to_client_exceptions(
                self._chat_api.delete_agent_server_files(
                    session_id=chat_session_id,
                    _headers=header,
                )
            )
    ...
    async def get_user_all_agent_directories(
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._agent_api.list_agent_directory_stats(
                offset=offset,
                limit=limit,
    ...
    async def get_agent_tool_preference(self) -> List[str]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._agent_api.list_agent_tool_preference(_headers=header)
        )
        return response
    ...
    async def update_agent_tool_preference(self, reference_value: List[str]) -> None:
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._agent_api.update_agent_tool_preference(
    ...
    async def delete_agent_tool_preference(self) -> None:
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._agent_api.delete_agent_tool_preference(_headers=header)
        )
        ...
        for agent_key in agent_keys:
            try:
                ...
                agent_key = await _rest_to_client_exceptions(
                    self._agent_api.create_agent_key(
    ...
    async def get_agent_keys(self) -> List[dict]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._agent_api.list_agent_keys(_headers=header)
        )
    ...
    async def update_agent_key(
        ...
        try:
            ...
            agent_key = await _rest_to_client_exceptions(
                self._agent_api.update_agent_key(
    ...
    async def delete_agent_keys(self, key_ids: List[str]) -> None:
        ...
        header = await self._get_auth_header()
        await _rest_to_client_exceptions(
            self._agent_api.delete_agent_keys(
                key_ids=key_ids,
                _headers=header,
            )
        )
    ...
    async def assign_agent_key_for_tool(
        ...
        for association in tool_dict_list:
            ...
            response = await _rest_to_client_exceptions(
                self._agent_api.create_agent_key_tool_associations(
            ...
            for key in response.keys:
                result.append(
                    (key.associate_id, response.tool, key.name, key.key_id, key.user_id)
                )
        return result
    ...
    async def get_agent_key_tool_associations(self) -> List[dict]:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._agent_api.list_agent_key_tool_associations(_headers=header)
        )
    ...
    async def delete_agent_tool_association(self, associate_ids: List[str]) -> int:
        ...
        header = await self._get_auth_header()
        response = await _rest_to_client_exceptions(
            self._agent_api.delete_agent_tool_association(
