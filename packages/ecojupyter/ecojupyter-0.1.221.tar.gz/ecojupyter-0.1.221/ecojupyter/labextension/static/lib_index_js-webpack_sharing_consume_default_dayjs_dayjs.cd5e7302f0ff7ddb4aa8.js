...
const plugin = {
    ...
    activate: async (app, palette, restorer, notebookTracker) => {
        ...
        const newWidget = async () => {
            const content = new _widget__WEBPACK_IMPORTED_MODULE_3__.MainWidget();
...
function WelcomePage({ handleRealTimeClick, handlePredictionClick, handleGrafanaClick }) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Grid2, { sx: styles.main },
        ...
        metrics && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Grid2, { sx: styles.topRibbon },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FetchMetricsComponents__WEBPACK_IMPORTED_MODULE_6__["default"], { fetchMetrics: handleSetMetrics, username: username, setUsername: setUsername, fetchInterval: fetchIntervalS, setFetchInterval: setFetchIntervalS, setIsFetchMetrics: setIsFetchMetrics })),
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_dayjs_dayjs.cd5e7302f0ff7ddb4aa8.js.map