...
class ELNStepFactory:
    ...
    def _create_dashboard_step_from_chart(chart, data_source_step, protocol, step_name, position) -> \
        ...
        eln_manager, new_entry = _get_entry_creation_criteria("",protocol, step_name, ElnEntryType.Dashboard, position)
        # noinspection PyTypeChecker
    ...
    def create_form_step(protocol: ElnExperimentProtocol, step_name: str, data_type_name: str,
        ...
        """
        eln_manager, new_entry = _get_entry_creation_criteria(data_type_name, protocol, step_name, ElnEntryType.Form, position)
    ...
    def create_table_step(protocol: ElnExperimentProtocol, step_name: str, data_type_name: str,
        ...
        """
        eln_manager, new_entry = _get_entry_creation_criteria(data_type_name, protocol, step_name, ElnEntryType.Table, position)
        if initial_attached_records:
    ...
    def create_plugin_entry(protocol: ElnExperimentProtocol, step_name: str, plugin_name: str,
        ...
        """
        eln_manager, new_entry = _get_entry_creation_criteria('Sample', protocol, step_name, ElnEntryType.Plugin, position)
