...
import base64
import requests
from .enums import EnumBanco, EnumStatus, EnumProcesso, EnumStatusSolicitacao, Enum, EnumTipoContrato
...
if __name__=="__main__":
    ...
    # putStatusRobo(EnumStatus.DESLIGADO, EnumProcesso.CONFIRMACAO_CREDITO, EnumBanco.C6)
