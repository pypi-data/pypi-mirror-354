...
class IPGPaymentRequest(BaseModel, BaseSdkModel):
    """
    IPGPaymentRequest
    """ # noqa: E501
    ...
    additional_info: IPGPaymentRequestAdditionalInfo = Field()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "additionalInfo": IPGPaymentRequestAdditionalInfo.from_dict(obj["additionalInfo"]) if obj.get("additionalInfo") is not None else None,
