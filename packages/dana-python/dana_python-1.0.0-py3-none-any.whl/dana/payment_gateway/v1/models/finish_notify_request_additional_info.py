...
class FinishNotifyRequestAdditionalInfo(BaseModel, BaseSdkModel):
    """
    FinishNotifyRequestAdditionalInfo
    """ # noqa: E501
    payment_info: Optional[FinishNotifyPaymentInfo] = Field(default=None, description="Additional information of payment")
    shop_info: Optional[ShopInfo] = Field(default=None, description="Additional information of shop")
