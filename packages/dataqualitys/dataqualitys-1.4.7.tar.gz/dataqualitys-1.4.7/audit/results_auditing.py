...
class ResultAuditor:
 ...
 def create_profiling_result_table(self):
     try:
         ...
         with self.connector.engine.begin() as conn:
            ...
            print(f"Failed to create audit result table: {e}")
 def create_check_result_table(self):
     try:
         ...
         with self.connector.engine.begin() as conn:
            ...
            print(f"Failed to create audit result table: {e}")
 def insert_profiling_results(self, results: dict):
 ...
 def insert_check_results(self, check_results: list):
    """
