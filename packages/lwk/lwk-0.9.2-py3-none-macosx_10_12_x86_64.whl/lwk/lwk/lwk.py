...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_lwk_checksum_method_testenv_electrum_url() != 37727:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_method_testenv_generate() != 4725:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_method_testenv_get_new_address() != 11090:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_method_testenv_height() != 18988:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_method_testenv_issue_asset() != 13400:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_method_testenv_send_to_address() != 8497:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_lwk_checksum_constructor_signer_random() != 54097:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_constructor_testenv_new() != 46965:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
class TestEnv:
    ...
    _pointer: ctypes.c_void_p
    def __init__(self, ):
        self._pointer = _uniffi_rust_call(_UniffiLib.uniffi_lwk_fn_constructor_testenv_new,)

    def __del__(self):
        # In case of partial initialization of instances.
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _uniffi_rust_call(_UniffiLib.uniffi_lwk_fn_free_testenv, pointer)

    def _uniffi_clone_pointer(self):
        return _uniffi_rust_call(_UniffiLib.uniffi_lwk_fn_clone_testenv, self._pointer)
    ...
    def electrum_url(self, ) -> "str":
        return _UniffiConverterString.lift(
            _uniffi_rust_call(_UniffiLib.uniffi_lwk_fn_method_testenv_electrum_url,self._uniffi_clone_pointer(),)
        )
    ...
    def generate(self, blocks: "int") -> None:
        ...
        _uniffi_rust_call(_UniffiLib.uniffi_lwk_fn_method_testenv_generate,self._uniffi_clone_pointer(),
    ...
    def get_new_address(self, ) -> "Address":
        return _UniffiConverterTypeAddress.lift(
            _uniffi_rust_call(_UniffiLib.uniffi_lwk_fn_method_testenv_get_new_address,self._uniffi_clone_pointer(),)
        )
    ...
    def height(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _uniffi_rust_call(_UniffiLib.uniffi_lwk_fn_method_testenv_height,self._uniffi_clone_pointer(),)
        )
    ...
    def issue_asset(self, satoshi: "int") -> "AssetId":
        ...
        return _UniffiConverterTypeAssetId.lift(
            _uniffi_rust_call(_UniffiLib.uniffi_lwk_fn_method_testenv_issue_asset,self._uniffi_clone_pointer(),
    ...
    def send_to_address(self, address: "Address",satoshi: "int",asset: "typing.Optional[AssetId]") -> "Txid":
        ...
        return _UniffiConverterTypeTxid.lift(
            _uniffi_rust_call(_UniffiLib.uniffi_lwk_fn_method_testenv_send_to_address,self._uniffi_clone_pointer(),
