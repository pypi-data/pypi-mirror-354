                        ...
                        if bool(line_almoxarifado_emsys):
                            ...
                            for second_info_distribuicao_obs in list_distribuicao_obs:
                                ...
                                if codigo_almoxarifado_obs == codigo_almoxarifado_emsys and not second_info_distribuicao_obs in list_tanques_distribuidos:
                                    ...
                                    win32clipboard.CloseClipboard()
                                    codigo_almoxarifado_emsys = line_almoxarifado_emsys.split('\n')[1].split('\t')[0].strip()
                                    log_msg= f"Código almoxarifado emsys: {codigo_almoxarifado_emsys} e codigo almoxarifado obs: {codigo_almoxarifado_obs} são divergentes, impossibilitando a distribuição."
...
if __name__ == "__main__":
    ...
    task = RpaProcessoEntradaDTO(datEntradaFila=datetime.now(),
                                 configEntrada={"nfe":"43250607857168000167550010002694361148325400","cfop":"5655","itens":[{"qtd":"10000.00","ocst":"061","ncmsh":"27101259","valorIpi":"0.00","valorIcms":"0.00","valorTotal":"51761.30","aliquotaIpi":"0.00","cfopProduto":"5655","aliquotaIcms":"0.00","bCalculoIcms":"0.00","codigoProduto":"000000000002000016","unidadeMedida":"L","valorUnitario":"5.18","descricaoProduto":"ONU 3475, MISTURA DE ETANOL E GASOLINA 3 GE II - GAS COMUM"}],"natureza":"9","valorNota":"51761.30","nomeFilial":"CACHOEIRINHA IMBUI","numeroNota":"269436","dataEmissao":"07/06/2025","observacoes":"20202 - TANQUE 02 - GASOLINA COMUM (5000)\n20205 - TANQUE 05 - DIESEL COMUM (5000)\n\nVcto: 09/06/2025","existeDespesa":"Não","cnpjFornecedor":"07857168000167","dataVencimento":"28/06/2025","nomeFornecedor":"SIM DISTRIBUIDORA DE COMBUSTÍVEIS L","recebimentoFisico":"07/06/2025 10:02","filialEmpresaOrigem":"202"},
                                 uuidFila="5d8a529e-b323-453f-82a3-980184a16b52", uuidProcesso="5d8a529e-b323-453f-82a3-980184a16b52",sistemas=[{
                "sistema": "EMSys",
                "timeout": "1.0"
            }],historico_id="5d8a529e-b323-453f-82a3-980184a16b52", nomProcesso="Entrada de Notas 9")

    asyncio.run(entrada_de_notas_9(task))