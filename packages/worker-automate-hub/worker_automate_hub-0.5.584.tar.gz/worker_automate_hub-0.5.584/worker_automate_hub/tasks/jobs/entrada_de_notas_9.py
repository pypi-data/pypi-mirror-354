                ...
                for info_distribuicao_obs in list_distribuicao_obs:
                    ...
                    while max_distribuicao <= 20:
                        ...
                        if bool(line_almoxarifado_emsys):
                            ...
                            codigo_presente = any(
                                obs.split('-')[0].strip() == codigo_almoxarifado_emsys
                                for obs in list_distribuicao_obs
                            )
                            if not codigo_presente:
                                log_msg= f"Divergência entre os tanques permitidos e a distruição informada na observação da nota. Verificar distribuição:({codigo_almoxarifado_obs})."
