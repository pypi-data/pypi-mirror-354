...
<body>
    <div class="container">
        ...
        <header class="main-header">
            ...
            <small>Powered by Fulgid v{self.scan_info.get('version', '2.0.2')}</small>
            <div class="scan-info">
                <p><strong>Scan Date:</strong> {self.scan_info.get('timestamp', 'Unknown')}</p>
                <p><strong>Tool Version:</strong> {self.scan_info.get('version', '2.0.2')}</p>
        ...
        <footer class="footer">
            <p>Generated by VigileGuard v{self.scan_info.get('version', '2.0.2')} | 
