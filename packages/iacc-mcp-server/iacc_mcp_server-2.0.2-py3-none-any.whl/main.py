...
class ExpertSelector:
    ...
    def _load_default_experts(self):
        ...
        default_experts = {
            "Java后台开发专家": {
                "type": ExpertType.JAVA_BACKEND,
                "keywords": ["java", "spring", "后端", "微服务", "api"],
                "skills": ["Spring Boot", "微服务架构", "数据库设计", "REST API"],
                "rules_content": "# Java后台开发专家\n专注于Java后端开发和微服务架构设计"
            },
            "React开发专家": {
                "type": ExpertType.REACT_FRONTEND,
                "keywords": ["react", "前端", "javascript", "typescript", "ui"],
                "skills": ["React", "TypeScript", "前端架构", "组件设计"],
                "rules_content": "# React开发专家\n专注于React前端开发和现代前端架构"
            },
            "Android开发专家": {
                "type": ExpertType.ANDROID_MOBILE,
                "keywords": ["android", "kotlin", "移动", "app"],
                "skills": ["Android开发", "Kotlin", "移动架构", "性能优化"],
                "rules_content": "# Android开发专家\n专注于Android移动应用开发"
            },
            "Web3区块链专家": {
                "type": ExpertType.WEB3_BLOCKCHAIN,
                "keywords": ["区块链", "web3", "智能合约", "defi"],
                "skills": ["区块链开发", "智能合约", "DeFi协议", "Web3"],
                "rules_content": "# Web3区块链专家\n专注于区块链和Web3应用开发"
            },
            "高级产品思维专家": {
                "type": ExpertType.PRODUCT_MANAGER,
                "keywords": ["产品", "需求", "用户", "策略", "设计"],
                "skills": ["产品设计", "需求分析", "用户体验", "产品策略"],
                "rules_content": "# 高级产品思维专家\n专注于产品需求分析和用户体验设计"
            }
        }
        
        for expert_name, config in default_experts.items():
            self.experts[expert_name] = ExpertRule(
                name=expert_name,
                type=config["type"],
        ...
        print(f"✅ 默认专家配置加载完成，共 {len(default_experts)} 个专家")
