...
from tbox_client.core.httpclient import HttpClientConfig
from tbox_client.tbox import TboxClient
...
response = tbox_client.chat_sync(appId="202504APhQ9F00382583", query="今天杭州天气怎么样？")
