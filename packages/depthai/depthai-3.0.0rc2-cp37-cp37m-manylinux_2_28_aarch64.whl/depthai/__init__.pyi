...
class Device(DeviceBase):
    ...
    @overload
    def __init__(self, deviceDesc: DeviceInfo, pathToCmd: Path) -> None: ...
    @overload
...
class NNArchive:
    @overload
    def __init__(self, archivePath: str, compression: NNArchiveEntry.Compression = ..., extractFolder: str = ...) -> None: ...
    @overload
    def __init__(self, archivePath: str, options: NNArchiveOptions = ...) -> None: ...
...
class NNArchiveVersionedConfig:
    @overload
    def __init__(self, path: Path, compression: NNArchiveEntry.Compression = ...) -> None: ...
    @overload
...
class NNModelDescription:
    ...
    def check(self) -> bool: ...
    @classmethod
    def fromYamlFile(cls, yamlPath: str, modelsPath: str = ...) -> NNModelDescription: ...
    def saveToYamlFile(self, yamlPath: str) -> None: ...
...
def downloadModelsFromZoo(path: str, cacheDirectory: str = ..., apiKey: str = ..., progressFormat: str = ...) -> bool: ...
def getModelFromZoo(modelDescription: NNModelDescription, useCached: bool = ..., cacheDirectory: str = ..., apiKey: str = ..., progressFormat: str = ...) -> str: ...
def isDatatypeSubclassOf(arg0: DatatypeEnum, arg1: DatatypeEnum) -> bool: ...
def platform2string(arg0: Platform) -> str: ...
def readModelType(modelPath: str) -> ModelType: ...
