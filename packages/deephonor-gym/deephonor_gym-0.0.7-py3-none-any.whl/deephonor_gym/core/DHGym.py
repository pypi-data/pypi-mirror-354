...
class DHgym(Free_Pal_st):
    ...
    def __init__(self, render_mode=None):
        ...
        self.reset_array : np.ndarray = np.full(self.num_envs,True,dtype=bool) # 待复位
    ...
    def upload(self, folder_path: str , folder_name: str):
        """上传模型文件到web端

        :param path: 资源文件夹路径，
        :param folder_name: 上传到web端的文件夹名
        """
        super().upload(folder_path,folder_name)
