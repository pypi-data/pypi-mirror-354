...
from ...models.slurm_v0042_get_nodes_flags import SlurmV0042GetNodesFlags
...
def _get_kwargs(
    *,
    ...
    flags: Union[Unset, SlurmV0042GetNodesFlags] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[V0042OpenapiNodesResp]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        flags (Union[Unset, SlurmV0042GetNodesFlags]):
