...
T = TypeVar("T", bound="V0042OpenapiUsersAddCondRespStr")


@_attrs_define
class V0042OpenapiUsersAddCondRespStr:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0042_openapi_users_add_cond_resp_str = cls(
            added_users=added_users,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0042_openapi_users_add_cond_resp_str.additional_properties = d
        return v0042_openapi_users_add_cond_resp_str
