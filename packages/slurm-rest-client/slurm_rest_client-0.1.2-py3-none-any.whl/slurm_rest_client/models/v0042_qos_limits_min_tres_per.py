...
T = TypeVar("T", bound="V0042QosLimitsMinTresPer")


@_attrs_define
class V0042QosLimitsMinTresPer:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0042_qos_limits_min_tres_per = cls(
            job=job,
        )

        v0042_qos_limits_min_tres_per.additional_properties = d
        return v0042_qos_limits_min_tres_per
