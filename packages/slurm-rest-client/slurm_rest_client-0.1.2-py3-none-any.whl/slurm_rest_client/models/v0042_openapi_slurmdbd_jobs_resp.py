...
if TYPE_CHECKING:
    from ..models.v0042_job import V0042Job
...
T = TypeVar("T", bound="V0042OpenapiSlurmdbdJobsResp")


@_attrs_define
class V0042OpenapiSlurmdbdJobsResp:
    """
    Attributes:
        jobs (list['V0042Job']):
    ...
    def to_dict(self) -> dict[str, Any]:
        jobs = []
        for componentsschemasv0_0_42_job_list_item_data in self.jobs:
            componentsschemasv0_0_42_job_list_item = componentsschemasv0_0_42_job_list_item_data.to_dict()
            jobs.append(componentsschemasv0_0_42_job_list_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jobs = []
        _jobs = d.pop("jobs")
        for componentsschemasv0_0_42_job_list_item_data in _jobs:
            componentsschemasv0_0_42_job_list_item = V0042Job.from_dict(componentsschemasv0_0_42_job_list_item_data)
        ...
        v0042_openapi_slurmdbd_jobs_resp = cls(
            jobs=jobs,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0042_openapi_slurmdbd_jobs_resp.additional_properties = d
        return v0042_openapi_slurmdbd_jobs_resp
