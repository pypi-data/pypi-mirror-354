...
T = TypeVar("T", bound="V0042OpenapiJobAllocResp")


@_attrs_define
class V0042OpenapiJobAllocResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0042_openapi_job_alloc_resp = cls(
            job_id=job_id,
        ...
        v0042_openapi_job_alloc_resp.additional_properties = d
        return v0042_openapi_job_alloc_resp
