...
T = TypeVar("T", bound="V0042OpenapiWckeyRemovedResp")


@_attrs_define
class V0042OpenapiWckeyRemovedResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0042_openapi_wckey_removed_resp = cls(
            deleted_wckeys=deleted_wckeys,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0042_openapi_wckey_removed_resp.additional_properties = d
        return v0042_openapi_wckey_removed_resp
