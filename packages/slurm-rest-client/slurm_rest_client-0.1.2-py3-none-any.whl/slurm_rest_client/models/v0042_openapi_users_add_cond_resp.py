...
if TYPE_CHECKING:
    ...
    from ..models.v0042_user_short import V0042UserShort
    from ..models.v0042_users_add_cond import V0042UsersAddCond


T = TypeVar("T", bound="V0042OpenapiUsersAddCondResp")


@_attrs_define
class V0042OpenapiUsersAddCondResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        association_condition = V0042UsersAddCond.from_dict(d.pop("association_condition"))

        user = V0042UserShort.from_dict(d.pop("user"))
        ...
        v0042_openapi_users_add_cond_resp = cls(
            association_condition=association_condition,
            user=user,
            meta=meta,
            errors=errors,
        ...
        v0042_openapi_users_add_cond_resp.additional_properties = d
        return v0042_openapi_users_add_cond_resp
