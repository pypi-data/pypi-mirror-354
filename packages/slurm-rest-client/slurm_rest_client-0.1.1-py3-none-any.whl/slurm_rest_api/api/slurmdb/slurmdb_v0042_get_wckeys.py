...
from ...models.v0042_openapi_wckey_resp import V0042OpenapiWckeyResp
...
) -> Optional[V0042OpenapiWckeyResp]:
    if response.status_code == 200:
        response_200 = V0042OpenapiWckeyResp.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[V0042OpenapiWckeyResp]:
    return Response(
