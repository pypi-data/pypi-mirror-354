...
from ...models.slurmdb_v0042_delete_cluster_classification import SlurmdbV0042DeleteClusterClassification
from ...models.slurmdb_v0042_delete_cluster_flags import SlurmdbV0042DeleteClusterFlags
from ...models.v0042_openapi_clusters_removed_resp import V0042OpenapiClustersRemovedResp
...
def _get_kwargs(
    cluster_name: str,
    *,
    classification: Union[Unset, SlurmdbV0042DeleteClusterClassification] = UNSET,
    cluster: Union[Unset, str] = UNSET,
    federation: Union[Unset, str] = UNSET,
    flags: Union[Unset, SlurmdbV0042DeleteClusterFlags] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/slurmdb/v0.0.42/cluster/{cluster_name}",
        "params": params,
    }
...
) -> Optional[V0042OpenapiClustersRemovedResp]:
    if response.status_code == 200:
        response_200 = V0042OpenapiClustersRemovedResp.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[V0042OpenapiClustersRemovedResp]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        cluster_name (str):
        classification (Union[Unset, SlurmdbV0042DeleteClusterClassification]):
        cluster (Union[Unset, str]):
        federation (Union[Unset, str]):
        flags (Union[Unset, SlurmdbV0042DeleteClusterFlags]):
