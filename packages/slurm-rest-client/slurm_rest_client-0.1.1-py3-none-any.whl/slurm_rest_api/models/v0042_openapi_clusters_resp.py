...
T = TypeVar("T", bound="V0042OpenapiClustersResp")


@_attrs_define
class V0042OpenapiClustersResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for componentsschemasv0_0_42_cluster_rec_list_item_data in _clusters:
        ...
        v0042_openapi_clusters_resp = cls(
            clusters=clusters,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0042_openapi_clusters_resp.additional_properties = d
        return v0042_openapi_clusters_resp
