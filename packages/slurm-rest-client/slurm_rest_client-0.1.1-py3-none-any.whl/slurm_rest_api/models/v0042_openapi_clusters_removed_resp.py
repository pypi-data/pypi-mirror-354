...
T = TypeVar("T", bound="V0042OpenapiClustersRemovedResp")


@_attrs_define
class V0042OpenapiClustersRemovedResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0042_openapi_clusters_removed_resp = cls(
            deleted_clusters=deleted_clusters,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0042_openapi_clusters_removed_resp.additional_properties = d
        return v0042_openapi_clusters_removed_resp
