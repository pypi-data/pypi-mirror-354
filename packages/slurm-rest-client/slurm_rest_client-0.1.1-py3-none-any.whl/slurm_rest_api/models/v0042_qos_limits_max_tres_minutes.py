...
if TYPE_CHECKING:
    from ..models.v0042_qos_limits_max_tres_minutes_per import V0042QosLimitsMaxTresMinutesPer
    from ..models.v0042_tres import V0042Tres


T = TypeVar("T", bound="V0042QosLimitsMaxTresMinutes")


@_attrs_define
class V0042QosLimitsMaxTresMinutes:
    """
    Attributes:
        total (Union[Unset, list['V0042Tres']]):
        per (Union[Unset, V0042QosLimitsMaxTresMinutesPer]):
    """

    total: Union[Unset, list["V0042Tres"]] = UNSET
    per: Union[Unset, "V0042QosLimitsMaxTresMinutesPer"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_per, Unset):
            ...
            per = V0042QosLimitsMaxTresMinutesPer.from_dict(_per)

        v0042_qos_limits_max_tres_minutes = cls(
            total=total,
            per=per,
        )

        v0042_qos_limits_max_tres_minutes.additional_properties = d
        return v0042_qos_limits_max_tres_minutes
