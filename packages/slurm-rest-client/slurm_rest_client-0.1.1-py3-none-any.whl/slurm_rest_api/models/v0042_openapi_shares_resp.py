...
if TYPE_CHECKING:
    ...
    from ..models.v0042_shares_resp_msg import V0042SharesRespMsg


T = TypeVar("T", bound="V0042OpenapiSharesResp")


@_attrs_define
class V0042OpenapiSharesResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        shares = V0042SharesRespMsg.from_dict(d.pop("shares"))
        ...
        v0042_openapi_shares_resp.additional_properties = d
        return v0042_openapi_shares_resp
