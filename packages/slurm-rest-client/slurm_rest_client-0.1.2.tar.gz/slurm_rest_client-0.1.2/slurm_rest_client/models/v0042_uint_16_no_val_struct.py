...
T = TypeVar("T", bound="V0042Uint16NoValStruct")


@_attrs_define
class V0042Uint16NoValStruct:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0042_uint_16_no_val_struct = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0042_uint_16_no_val_struct.additional_properties = d
        return v0042_uint_16_no_val_struct
