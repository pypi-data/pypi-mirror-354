...
if TYPE_CHECKING:
    ...
    from ..models.v0042_stats_rec import V0042StatsRec


T = TypeVar("T", bound="V0042OpenapiSlurmdbdStatsResp")


@_attrs_define
class V0042OpenapiSlurmdbdStatsResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        statistics = V0042StatsRec.from_dict(d.pop("statistics"))
        ...
        v0042_openapi_slurmdbd_stats_resp = cls(
            statistics=statistics,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0042_openapi_slurmdbd_stats_resp.additional_properties = d
        return v0042_openapi_slurmdbd_stats_resp
