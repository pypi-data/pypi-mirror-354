...
T = TypeVar("T", bound="V0042OpenapiSlurmdbdQosRemovedResp")


@_attrs_define
class V0042OpenapiSlurmdbdQosRemovedResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0042_openapi_slurmdbd_qos_removed_resp = cls(
            removed_qos=removed_qos,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0042_openapi_slurmdbd_qos_removed_resp.additional_properties = d
        return v0042_openapi_slurmdbd_qos_removed_resp
