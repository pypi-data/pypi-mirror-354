...
T = TypeVar("T", bound="V0042OpenapiSlurmdbdQosResp")


@_attrs_define
class V0042OpenapiSlurmdbdQosResp:
    """
    Attributes:
        qos (list['V0042Qos']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        qos = []
        _qos = d.pop("qos")
        for componentsschemasv0_0_42_qos_list_item_data in _qos:
        ...
        v0042_openapi_slurmdbd_qos_resp = cls(
            qos=qos,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0042_openapi_slurmdbd_qos_resp.additional_properties = d
        return v0042_openapi_slurmdbd_qos_resp
