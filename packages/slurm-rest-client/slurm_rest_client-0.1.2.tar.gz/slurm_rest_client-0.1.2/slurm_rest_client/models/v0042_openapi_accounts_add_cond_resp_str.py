...
T = TypeVar("T", bound="V0042OpenapiAccountsAddCondRespStr")


@_attrs_define
class V0042OpenapiAccountsAddCondRespStr:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0042_openapi_accounts_add_cond_resp_str = cls(
            added_accounts=added_accounts,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0042_openapi_accounts_add_cond_resp_str.additional_properties = d
        return v0042_openapi_accounts_add_cond_resp_str
