...
T = TypeVar("T", bound="V0042OpenapiAccountsResp")


@_attrs_define
class V0042OpenapiAccountsResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for componentsschemasv0_0_42_account_list_item_data in _accounts:
        ...
        v0042_openapi_accounts_resp = cls(
            accounts=accounts,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0042_openapi_accounts_resp.additional_properties = d
        return v0042_openapi_accounts_resp
