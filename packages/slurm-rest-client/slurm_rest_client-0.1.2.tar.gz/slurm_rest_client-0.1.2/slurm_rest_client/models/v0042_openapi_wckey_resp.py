...
T = TypeVar("T", bound="V0042OpenapiWckeyResp")


@_attrs_define
class V0042OpenapiWckeyResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0042_openapi_wckey_resp.additional_properties = d
        return v0042_openapi_wckey_resp
