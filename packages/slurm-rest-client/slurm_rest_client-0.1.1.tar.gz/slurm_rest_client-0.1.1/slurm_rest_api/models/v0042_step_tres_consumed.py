...
T = TypeVar("T", bound="V0042StepTresConsumed")


@_attrs_define
class V0042StepTresConsumed:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.max_, Unset):
            max_ = []
            for componentsschemasv0_0_42_step_tres_usage_max_item_data in self.max_:
                componentsschemasv0_0_42_step_tres_usage_max_item = (
                    componentsschemasv0_0_42_step_tres_usage_max_item_data.to_dict()
                )
                max_.append(componentsschemasv0_0_42_step_tres_usage_max_item)

        min_: Union[Unset, list[dict[str, Any]]] = UNSET
        if not isinstance(self.min_, Unset):
            min_ = []
            for componentsschemasv0_0_42_step_tres_usage_min_item_data in self.min_:
                componentsschemasv0_0_42_step_tres_usage_min_item = (
                    componentsschemasv0_0_42_step_tres_usage_min_item_data.to_dict()
                )
                min_.append(componentsschemasv0_0_42_step_tres_usage_min_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for componentsschemasv0_0_42_step_tres_usage_max_item_data in _max_ or []:
            componentsschemasv0_0_42_step_tres_usage_max_item = V0042Tres.from_dict(
                componentsschemasv0_0_42_step_tres_usage_max_item_data
            )
        ...
        for componentsschemasv0_0_42_step_tres_usage_min_item_data in _min_ or []:
            componentsschemasv0_0_42_step_tres_usage_min_item = V0042Tres.from_dict(
                componentsschemasv0_0_42_step_tres_usage_min_item_data
            )
        ...
        v0042_step_tres_consumed.additional_properties = d
        return v0042_step_tres_consumed
