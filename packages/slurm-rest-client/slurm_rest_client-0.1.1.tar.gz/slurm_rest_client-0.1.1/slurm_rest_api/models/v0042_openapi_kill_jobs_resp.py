...
if TYPE_CHECKING:
    from ..models.v0042_kill_jobs_resp_job import V0042KillJobsRespJob
...
T = TypeVar("T", bound="V0042OpenapiKillJobsResp")


@_attrs_define
class V0042OpenapiKillJobsResp:
    """
    Attributes:
    ...
    status: list["V0042KillJobsRespJob"]
    ...
    def to_dict(self) -> dict[str, Any]:
        status = []
        for componentsschemasv0_0_42_kill_jobs_resp_msg_item_data in self.status:
            componentsschemasv0_0_42_kill_jobs_resp_msg_item = (
                componentsschemasv0_0_42_kill_jobs_resp_msg_item_data.to_dict()
            )
            status.append(componentsschemasv0_0_42_kill_jobs_resp_msg_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for componentsschemasv0_0_42_kill_jobs_resp_msg_item_data in _status:
            componentsschemasv0_0_42_kill_jobs_resp_msg_item = V0042KillJobsRespJob.from_dict(
                componentsschemasv0_0_42_kill_jobs_resp_msg_item_data
            )
        ...
        v0042_openapi_kill_jobs_resp = cls(
            status=status,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0042_openapi_kill_jobs_resp.additional_properties = d
        return v0042_openapi_kill_jobs_resp
