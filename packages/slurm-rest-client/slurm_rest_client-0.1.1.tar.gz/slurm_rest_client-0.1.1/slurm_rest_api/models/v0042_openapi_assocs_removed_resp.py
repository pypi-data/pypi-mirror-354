...
T = TypeVar("T", bound="V0042OpenapiAssocsRemovedResp")


@_attrs_define
class V0042OpenapiAssocsRemovedResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0042_openapi_assocs_removed_resp = cls(
            removed_associations=removed_associations,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0042_openapi_assocs_removed_resp.additional_properties = d
        return v0042_openapi_assocs_removed_resp
