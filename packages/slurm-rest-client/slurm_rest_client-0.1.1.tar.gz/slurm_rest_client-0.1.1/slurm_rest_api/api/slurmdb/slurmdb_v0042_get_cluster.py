...
from ...models.slurmdb_v0042_get_cluster_classification import SlurmdbV0042GetClusterClassification
from ...models.slurmdb_v0042_get_cluster_flags import SlurmdbV0042GetClusterFlags
...
def _get_kwargs(
    cluster_name: str,
    *,
    classification: Union[Unset, SlurmdbV0042GetClusterClassification] = UNSET,
    cluster: Union[Unset, str] = UNSET,
    federation: Union[Unset, str] = UNSET,
    flags: Union[Unset, SlurmdbV0042GetClusterFlags] = UNSET,
...
) -> Optional[V0042OpenapiClustersResp]:
    if response.status_code == 200:
        response_200 = V0042OpenapiClustersResp.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[V0042OpenapiClustersResp]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        cluster_name (str):
        classification (Union[Unset, SlurmdbV0042GetClusterClassification]):
        cluster (Union[Unset, str]):
        federation (Union[Unset, str]):
        flags (Union[Unset, SlurmdbV0042GetClusterFlags]):
