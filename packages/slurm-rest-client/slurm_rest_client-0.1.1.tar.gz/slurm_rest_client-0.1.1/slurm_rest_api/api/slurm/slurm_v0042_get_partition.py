...
from ...models.slurm_v0042_get_partition_flags import SlurmV0042GetPartitionFlags
...
def _get_kwargs(
    ...
    *,
    ...
    flags: Union[Unset, SlurmV0042GetPartitionFlags] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/slurm/v0.0.42/partition/{partition_name}",
        "params": params,
    }
...
) -> Optional[V0042OpenapiPartitionResp]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        flags (Union[Unset, SlurmV0042GetPartitionFlags]):
