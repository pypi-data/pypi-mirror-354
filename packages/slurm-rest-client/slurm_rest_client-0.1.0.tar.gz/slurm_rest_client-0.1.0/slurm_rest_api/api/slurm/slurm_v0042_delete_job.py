...
from ...models.slurm_v0042_delete_job_flags import SlurmV0042DeleteJobFlags
...
def _get_kwargs(
    ...
    *,
    ...
    flags: Union[Unset, SlurmV0042DeleteJobFlags] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[V0042OpenapiKillJobResp]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        flags (Union[Unset, SlurmV0042DeleteJobFlags]):
