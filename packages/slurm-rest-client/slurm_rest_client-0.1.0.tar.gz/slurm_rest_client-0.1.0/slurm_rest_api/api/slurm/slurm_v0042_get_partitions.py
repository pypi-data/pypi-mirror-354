...
from ...models.slurm_v0042_get_partitions_flags import SlurmV0042GetPartitionsFlags
...
def _get_kwargs(
    *,
    ...
    flags: Union[Unset, SlurmV0042GetPartitionsFlags] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        flags (Union[Unset, SlurmV0042GetPartitionsFlags]):
