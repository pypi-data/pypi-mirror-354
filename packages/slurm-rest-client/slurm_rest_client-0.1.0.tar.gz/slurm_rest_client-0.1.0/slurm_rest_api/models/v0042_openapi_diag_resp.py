...
if TYPE_CHECKING:
    ...
    from ..models.v0042_stats_msg import V0042StatsMsg


T = TypeVar("T", bound="V0042OpenapiDiagResp")


@_attrs_define
class V0042OpenapiDiagResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        statistics = V0042StatsMsg.from_dict(d.pop("statistics"))
        ...
        v0042_openapi_diag_resp.additional_properties = d
        return v0042_openapi_diag_resp
