...
T = TypeVar("T", bound="V0042AssocMaxTresMinutesPer")


@_attrs_define
class V0042AssocMaxTresMinutesPer:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0042_assoc_max_tres_minutes_per = cls(
            job=job,
        )

        v0042_assoc_max_tres_minutes_per.additional_properties = d
        return v0042_assoc_max_tres_minutes_per
