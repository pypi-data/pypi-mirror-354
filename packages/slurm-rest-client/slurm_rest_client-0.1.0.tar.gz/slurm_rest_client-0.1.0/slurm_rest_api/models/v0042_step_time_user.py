...
T = TypeVar("T", bound="V0042StepTimeUser")


@_attrs_define
class V0042StepTimeUser:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0042_step_time_user = cls(
            seconds=seconds,
            microseconds=microseconds,
        )

        v0042_step_time_user.additional_properties = d
        return v0042_step_time_user
