...
T = TypeVar("T", bound="V0042OpenapiAssocsResp")


@_attrs_define
class V0042OpenapiAssocsResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for componentsschemasv0_0_42_assoc_list_item_data in _associations:
        ...
        v0042_openapi_assocs_resp.additional_properties = d
        return v0042_openapi_assocs_resp
