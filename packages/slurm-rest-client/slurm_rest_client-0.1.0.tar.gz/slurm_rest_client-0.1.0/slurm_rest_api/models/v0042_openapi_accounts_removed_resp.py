...
T = TypeVar("T", bound="V0042OpenapiAccountsRemovedResp")


@_attrs_define
class V0042OpenapiAccountsRemovedResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0042_openapi_accounts_removed_resp = cls(
            removed_accounts=removed_accounts,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0042_openapi_accounts_removed_resp.additional_properties = d
        return v0042_openapi_accounts_removed_resp
