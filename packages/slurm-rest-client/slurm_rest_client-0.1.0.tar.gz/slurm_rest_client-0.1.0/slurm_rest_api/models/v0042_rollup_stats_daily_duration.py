...
T = TypeVar("T", bound="V0042RollupStatsDailyDuration")


@_attrs_define
class V0042RollupStatsDailyDuration:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0042_rollup_stats_daily_duration = cls(
            last=last,
            max_=max_,
            time=time,
        )

        v0042_rollup_stats_daily_duration.additional_properties = d
        return v0042_rollup_stats_daily_duration
