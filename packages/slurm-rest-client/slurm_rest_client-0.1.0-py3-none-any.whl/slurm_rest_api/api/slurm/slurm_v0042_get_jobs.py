...
from ...models.slurm_v0042_get_jobs_flags import SlurmV0042GetJobsFlags
...
def _get_kwargs(
    *,
    ...
    flags: Union[Unset, SlurmV0042GetJobsFlags] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        flags (Union[Unset, SlurmV0042GetJobsFlags]):
