...
from ...models.slurm_v0042_get_jobs_state_flags import SlurmV0042GetJobsStateFlags
...
def _get_kwargs(
    *,
    ...
    flags: Union[Unset, SlurmV0042GetJobsStateFlags] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        flags (Union[Unset, SlurmV0042GetJobsStateFlags]):
