...
T = TypeVar("T", bound="V0042StatsRpcTime")


@_attrs_define
class V0042StatsRpcTime:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0042_stats_rpc_time = cls(
            average=average,
            total=total,
        )

        v0042_stats_rpc_time.additional_properties = d
        return v0042_stats_rpc_time
