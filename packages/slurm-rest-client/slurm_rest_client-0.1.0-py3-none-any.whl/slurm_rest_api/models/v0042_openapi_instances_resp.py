...
T = TypeVar("T", bound="V0042OpenapiInstancesResp")


@_attrs_define
class V0042OpenapiInstancesResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for componentsschemasv0_0_42_instance_list_item_data in _instances:
        ...
        v0042_openapi_instances_resp = cls(
            instances=instances,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0042_openapi_instances_resp.additional_properties = d
        return v0042_openapi_instances_resp
