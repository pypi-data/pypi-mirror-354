...
if TYPE_CHECKING:
    from ..models.v0042_job_info import V0042JobInfo
...
T = TypeVar("T", bound="V0042OpenapiJobInfoResp")


@_attrs_define
class V0042OpenapiJobInfoResp:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        jobs = []
        for componentsschemasv0_0_42_job_info_msg_item_data in self.jobs:
            componentsschemasv0_0_42_job_info_msg_item = componentsschemasv0_0_42_job_info_msg_item_data.to_dict()
            jobs.append(componentsschemasv0_0_42_job_info_msg_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jobs = []
        _jobs = d.pop("jobs")
        for componentsschemasv0_0_42_job_info_msg_item_data in _jobs:
            componentsschemasv0_0_42_job_info_msg_item = V0042JobInfo.from_dict(
                componentsschemasv0_0_42_job_info_msg_item_data
            )

            jobs.append(componentsschemasv0_0_42_job_info_msg_item)

        last_backfill = V0042Uint64NoValStruct.from_dict(d.pop("last_backfill"))
        ...
        v0042_openapi_job_info_resp = cls(
            jobs=jobs,
            last_backfill=last_backfill,
            last_update=last_update,
            meta=meta,
        ...
        v0042_openapi_job_info_resp.additional_properties = d
        return v0042_openapi_job_info_resp
