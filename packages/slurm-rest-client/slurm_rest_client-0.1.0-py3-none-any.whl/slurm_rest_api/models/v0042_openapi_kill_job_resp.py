...
T = TypeVar("T", bound="V0042OpenapiKillJobResp")


@_attrs_define
class V0042OpenapiKillJobResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0042_openapi_kill_job_resp = cls(
            status=status,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0042_openapi_kill_job_resp.additional_properties = d
        return v0042_openapi_kill_job_resp
