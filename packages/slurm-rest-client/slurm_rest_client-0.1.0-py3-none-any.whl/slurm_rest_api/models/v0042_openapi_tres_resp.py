...
T = TypeVar("T", bound="V0042OpenapiTresResp")


@_attrs_define
class V0042OpenapiTresResp:
    """
    Attributes:
        tres (list['V0042Tres']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tres = []
        _tres = d.pop("TRES")
        for componentsschemasv0_0_42_tres_list_item_data in _tres:
        ...
        v0042_openapi_tres_resp.additional_properties = d
        return v0042_openapi_tres_resp
