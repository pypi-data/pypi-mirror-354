...
class CameraImageCaptured(_message.Message):
    __slots__ = ("header", "ros2_header", "orientation", "geo", "relative_alt", "image_index", "capture_result", "file_url")
    ...
    capture_result: int
    file_url: str
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., orientation: _Optional[_Union[_quaternion_pb2.Quaternion, _Mapping]] = ..., geo: _Optional[_Union[_geo_point_pb2.GeoPoint, _Mapping]] = ..., relative_alt: _Optional[float] = ..., image_index: _Optional[int] = ..., capture_result: _Optional[int] = ..., file_url: _Optional[str] = ...) -> None: ...
