...
class ADSBVehicle(_message.Message):
    __slots__ = ("header", "ros2_header", "icao_address", "callsign", "latitude", "longitude", "altitude", "heading", "hor_velocity", "ver_velocity", "altitude_type", "emitter_type", "tslc", "flags", "squawk")
