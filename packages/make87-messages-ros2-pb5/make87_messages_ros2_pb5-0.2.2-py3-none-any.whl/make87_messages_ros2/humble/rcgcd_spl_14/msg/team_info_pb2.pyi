...
from make87_messages_ros2.humble.rcgcd_spl_14.msg import robot_info_pb2 as _robot_info_pb2
...
class TeamInfo(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., team_number: _Optional[int] = ..., team_colour: _Optional[int] = ..., score: _Optional[int] = ..., penalty_shot: _Optional[int] = ..., single_shots: _Optional[int] = ..., message_budget: _Optional[int] = ..., players: _Optional[_Iterable[_Union[_robot_info_pb2.RobotInfo, _Mapping]]] = ...) -> None: ...
