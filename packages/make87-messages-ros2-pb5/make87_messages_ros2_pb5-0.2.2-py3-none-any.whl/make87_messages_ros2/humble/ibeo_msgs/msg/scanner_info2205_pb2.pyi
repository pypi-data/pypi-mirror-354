...
from make87_messages_ros2.humble.ibeo_msgs.msg import mounting_position_f_pb2 as _mounting_position_f_pb2
from make87_messages_ros2.humble.ibeo_msgs.msg import resolution_info_pb2 as _resolution_info_pb2
...
class ScannerInfo2205(_message.Message):
    __slots__ = ("header", "device_id", "scanner_type", "scan_number", "start_angle", "end_angle", "scan_start_time", "scan_end_time", "scan_start_time_from_device", "scan_end_time_from_device", "scan_frequency", "beam_tilt", "scan_flags", "mounting_position", "resolutions")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., device_id: _Optional[int] = ..., scanner_type: _Optional[int] = ..., scan_number: _Optional[int] = ..., start_angle: _Optional[float] = ..., end_angle: _Optional[float] = ..., scan_start_time: _Optional[_Union[_time_pb2.Time, _Mapping]] = ..., scan_end_time: _Optional[_Union[_time_pb2.Time, _Mapping]] = ..., scan_start_time_from_device: _Optional[_Union[_time_pb2.Time, _Mapping]] = ..., scan_end_time_from_device: _Optional[_Union[_time_pb2.Time, _Mapping]] = ..., scan_frequency: _Optional[float] = ..., beam_tilt: _Optional[float] = ..., scan_flags: _Optional[int] = ..., mounting_position: _Optional[_Union[_mounting_position_f_pb2.MountingPositionF, _Mapping]] = ..., resolutions: _Optional[_Iterable[_Union[_resolution_info_pb2.ResolutionInfo, _Mapping]]] = ...) -> None: ...
