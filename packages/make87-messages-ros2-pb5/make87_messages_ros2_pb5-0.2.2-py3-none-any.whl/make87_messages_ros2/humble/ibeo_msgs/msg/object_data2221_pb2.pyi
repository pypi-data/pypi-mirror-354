...
from make87_messages_ros2.humble.ibeo_msgs.msg import object2221_pb2 as _object2221_pb2
...
class ObjectData2221(_message.Message):
    __slots__ = ("header", "ros2_header", "ibeo_header", "scan_start_timestamp", "number_of_objects", "object_list")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., ibeo_header: _Optional[_Union[_ibeo_data_header_pb2.IbeoDataHeader, _Mapping]] = ..., scan_start_timestamp: _Optional[_Union[_time_pb2.Time, _Mapping]] = ..., number_of_objects: _Optional[int] = ..., object_list: _Optional[_Iterable[_Union[_object2221_pb2.Object2221, _Mapping]]] = ...) -> None: ...
