...
from make87_messages_ros2.humble.ibeo_msgs.msg import point2_df_pb2 as _point2_df_pb2
...
class Object2225(_message.Message):
    __slots__ = ("header", "id", "age", "timestamp", "hidden_status_age", "classification", "classification_certainty", "classification_age", "bounding_box_center", "bounding_box_size", "object_box_center", "object_box_center_sigma", "object_box_size", "yaw_angle", "relative_velocity", "relative_velocity_sigma", "absolute_velocity", "absolute_velocity_sigma", "number_of_contour_points", "closest_point_index", "contour_point_list")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., id: _Optional[int] = ..., age: _Optional[int] = ..., timestamp: _Optional[_Union[_time_pb2.Time, _Mapping]] = ..., hidden_status_age: _Optional[int] = ..., classification: _Optional[int] = ..., classification_certainty: _Optional[int] = ..., classification_age: _Optional[int] = ..., bounding_box_center: _Optional[_Union[_point2_df_pb2.Point2Df, _Mapping]] = ..., bounding_box_size: _Optional[_Union[_point2_df_pb2.Point2Df, _Mapping]] = ..., object_box_center: _Optional[_Union[_point2_df_pb2.Point2Df, _Mapping]] = ..., object_box_center_sigma: _Optional[_Union[_point2_df_pb2.Point2Df, _Mapping]] = ..., object_box_size: _Optional[_Union[_point2_df_pb2.Point2Df, _Mapping]] = ..., yaw_angle: _Optional[float] = ..., relative_velocity: _Optional[_Union[_point2_df_pb2.Point2Df, _Mapping]] = ..., relative_velocity_sigma: _Optional[_Union[_point2_df_pb2.Point2Df, _Mapping]] = ..., absolute_velocity: _Optional[_Union[_point2_df_pb2.Point2Df, _Mapping]] = ..., absolute_velocity_sigma: _Optional[_Union[_point2_df_pb2.Point2Df, _Mapping]] = ..., number_of_contour_points: _Optional[int] = ..., closest_point_index: _Optional[int] = ..., contour_point_list: _Optional[_Iterable[_Union[_point2_df_pb2.Point2Df, _Mapping]]] = ...) -> None: ...
