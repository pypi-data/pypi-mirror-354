...
class Inspva(_message.Message):
    __slots__ = ("header", "ros2_header", "novatel_msg_header", "week", "seconds", "latitude", "longitude", "height", "north_velocity", "east_velocity", "up_velocity", "roll", "pitch", "azimuth", "status")
    ...
    azimuth: float
    status: str
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., novatel_msg_header: _Optional[_Union[_novatel_message_header_pb2.NovatelMessageHeader, _Mapping]] = ..., week: _Optional[int] = ..., seconds: _Optional[float] = ..., latitude: _Optional[float] = ..., longitude: _Optional[float] = ..., height: _Optional[float] = ..., north_velocity: _Optional[float] = ..., east_velocity: _Optional[float] = ..., up_velocity: _Optional[float] = ..., roll: _Optional[float] = ..., pitch: _Optional[float] = ..., azimuth: _Optional[float] = ..., status: _Optional[str] = ...) -> None: ...
