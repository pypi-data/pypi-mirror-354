...
class SetParametersAtomicallyResponse(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., result: _Optional[_Union[_set_parameters_result_pb2.SetParametersResult, _Mapping]] = ...) -> None: ...
