...
class MaterialColor(_message.Message):
    __slots__ = ("header", "ros2_header", "entity", "ambient", "diffuse", "specular", "emissive", "shininess", "entity_match")
