...
class EsrStatus4(_message.Message):
    __slots__ = ("header", "ros2_header", "canmsg", "truck_target_det", "lr_only_grating_lobe_det", "sidelobe_blockage", "partial_blockage", "mr_lr_mode", "rolling_count_3", "path_id_acc", "path_id_cmbb_move", "path_id_cmbb_stat", "path_id_fcw_move", "path_id_fcw_stat", "auto_align_angle", "path_id_acc_stat")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., canmsg: _Optional[str] = ..., truck_target_det: bool = ..., lr_only_grating_lobe_det: bool = ..., sidelobe_blockage: bool = ..., partial_blockage: bool = ..., mr_lr_mode: _Optional[int] = ..., rolling_count_3: _Optional[int] = ..., path_id_acc: _Optional[int] = ..., path_id_cmbb_move: _Optional[int] = ..., path_id_cmbb_stat: _Optional[int] = ..., path_id_fcw_move: _Optional[int] = ..., path_id_fcw_stat: _Optional[int] = ..., auto_align_angle: _Optional[float] = ..., path_id_acc_stat: _Optional[int] = ...) -> None: ...
