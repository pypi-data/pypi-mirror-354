...
class EsrVehicle4(_message.Message):
    __slots__ = ("header", "ros2_header", "fac_align_cmd_1", "fac_align_cmd_2", "fac_align_max_nt", "fac_align_samp_req", "fac_tgt_mtg_offset", "fac_tgt_mtg_space_hor", "fac_tgt_mtg_space_ver", "fac_tgt_range_1", "fac_tgt_range_r2m", "fac_tgt_range_m2t")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., fac_align_cmd_1: bool = ..., fac_align_cmd_2: bool = ..., fac_align_max_nt: _Optional[int] = ..., fac_align_samp_req: _Optional[int] = ..., fac_tgt_mtg_offset: _Optional[int] = ..., fac_tgt_mtg_space_hor: _Optional[int] = ..., fac_tgt_mtg_space_ver: _Optional[int] = ..., fac_tgt_range_1: _Optional[float] = ..., fac_tgt_range_r2m: _Optional[float] = ..., fac_tgt_range_m2t: _Optional[float] = ...) -> None: ...
