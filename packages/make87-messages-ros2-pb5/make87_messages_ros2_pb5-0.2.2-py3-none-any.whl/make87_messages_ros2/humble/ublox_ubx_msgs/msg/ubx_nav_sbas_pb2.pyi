...
from make87_messages_ros2.humble.ublox_ubx_msgs.msg import sbas_service_pb2 as _sbas_service_pb2
from make87_messages_ros2.humble.ublox_ubx_msgs.msg import sbas_status_flags_pb2 as _sbas_status_flags_pb2
from make87_messages_ros2.humble.ublox_ubx_msgs.msg import sbas_sv_data_pb2 as _sbas_sv_data_pb2
...
class UBXNavSBAS(_message.Message):
    __slots__ = ("header", "ros2_header", "itow", "geo", "mode", "sys", "service", "cnt", "status_flags", "reserved_0", "sv_data")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., itow: _Optional[int] = ..., geo: _Optional[int] = ..., mode: _Optional[int] = ..., sys: _Optional[int] = ..., service: _Optional[_Union[_sbas_service_pb2.SBASService, _Mapping]] = ..., cnt: _Optional[int] = ..., status_flags: _Optional[_Union[_sbas_status_flags_pb2.SBASStatusFlags, _Mapping]] = ..., reserved_0: _Optional[_Iterable[int]] = ..., sv_data: _Optional[_Iterable[_Union[_sbas_sv_data_pb2.SBASSvData, _Mapping]]] = ...) -> None: ...
