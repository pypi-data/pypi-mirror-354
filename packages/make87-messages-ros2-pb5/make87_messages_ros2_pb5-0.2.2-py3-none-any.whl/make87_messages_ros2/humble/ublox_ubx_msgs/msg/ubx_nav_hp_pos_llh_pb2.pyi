...
class UBXNavHPPosLLH(_message.Message):
    __slots__ = ("header", "ros2_header", "version", "invalid_lon", "invalid_lat", "invalid_height", "invalid_hmsl", "invalid_lon_hp", "invalid_lat_hp", "invalid_height_hp", "invalid_hmsl_hp", "itow", "lon", "lat", "height", "hmsl", "lon_hp", "lat_hp", "height_hp", "hmsl_hp", "h_acc", "v_acc")
