...
from make87_messages_ros2.humble.rc_reason_msgs.msg import range_value_pb2 as _range_value_pb2
...
class CellFillingLevel(_message.Message):
    __slots__ = ("header", "cell_size", "cell_position", "level_in_percent", "level_free_in_meters", "coverage")
