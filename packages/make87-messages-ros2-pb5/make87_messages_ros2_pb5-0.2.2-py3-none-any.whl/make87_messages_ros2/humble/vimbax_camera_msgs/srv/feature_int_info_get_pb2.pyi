...
class FeatureIntInfoGetRequest(_message.Message):
...
class FeatureIntInfoGetResponse(_message.Message):
    __slots__ = ("header", "min", "max", "inc", "error")
    HEADER_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., min: _Optional[int] = ..., max: _Optional[int] = ..., inc: _Optional[int] = ..., error: _Optional[_Union[_error_pb2.Error, _Mapping]] = ...) -> None: ...
