...
class Itinerary(_message.Message):
    __slots__ = ("header", "routes")
    HEADER_FIELD_NUMBER: _ClassVar[int]
    ROUTES_FIELD_NUMBER: _ClassVar[int]
    header: _header_pb2.Header
    routes: _containers.RepeatedCompositeFieldContainer[_route_pb2.Route]
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., routes: _Optional[_Iterable[_Union[_route_pb2.Route, _Mapping]]] = ...) -> None: ...
