...
from make87_messages_ros2.humble.rtabmap_msgs.msg import sensor_data_pb2 as _sensor_data_pb2
...
class Node(_message.Message):
    __slots__ = ("header", "id", "map_id", "weight", "stamp", "label", "pose", "word_id_keys", "word_id_values", "word_kpts", "word_pts", "word_descriptors", "data")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., id: _Optional[int] = ..., map_id: _Optional[int] = ..., weight: _Optional[int] = ..., stamp: _Optional[float] = ..., label: _Optional[str] = ..., pose: _Optional[_Union[_pose_pb2.Pose, _Mapping]] = ..., word_id_keys: _Optional[_Iterable[int]] = ..., word_id_values: _Optional[_Iterable[int]] = ..., word_kpts: _Optional[_Iterable[_Union[_key_point_pb2.KeyPoint, _Mapping]]] = ..., word_pts: _Optional[_Iterable[_Union[_point3f_pb2.Point3f, _Mapping]]] = ..., word_descriptors: _Optional[_Iterable[int]] = ..., data: _Optional[_Union[_sensor_data_pb2.SensorData, _Mapping]] = ...) -> None: ...
