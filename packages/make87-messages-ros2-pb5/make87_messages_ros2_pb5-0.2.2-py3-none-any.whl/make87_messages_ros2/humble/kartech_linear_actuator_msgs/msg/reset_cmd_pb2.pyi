...
class ResetCmd(_message.Message):
    __slots__ = ("header", "ros2_header", "confirm", "reset_type", "reset_user_rpt_id", "reset_user_cmd_id_1", "reset_user_cmd_id_2", "reset_user_cmd_id_3", "reset_user_cmd_id_4", "disable_user_rpt_id", "reenable_default_cmd_id")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., confirm: bool = ..., reset_type: _Optional[int] = ..., reset_user_rpt_id: bool = ..., reset_user_cmd_id_1: bool = ..., reset_user_cmd_id_2: bool = ..., reset_user_cmd_id_3: bool = ..., reset_user_cmd_id_4: bool = ..., disable_user_rpt_id: bool = ..., reenable_default_cmd_id: bool = ...) -> None: ...
