...
class DiffDriveCmdVWVec(_message.Message):
    __slots__ = ("header", "v", "w", "delta_t", "state0")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., v: _Optional[_Iterable[float]] = ..., w: _Optional[_Iterable[float]] = ..., delta_t: _Optional[_Iterable[float]] = ..., state0: _Optional[_Iterable[float]] = ...) -> None: ...
