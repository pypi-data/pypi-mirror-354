...
from make87_messages_ros2.rolling.ublox_ubx_msgs.msg import gps_fix_pb2 as _gps_fix_pb2
from make87_messages_ros2.rolling.ublox_ubx_msgs.msg import map_matching_pb2 as _map_matching_pb2
from make87_messages_ros2.rolling.ublox_ubx_msgs.msg import psm_status_pb2 as _psm_status_pb2
from make87_messages_ros2.rolling.ublox_ubx_msgs.msg import spoof_det_pb2 as _spoof_det_pb2
...
class UBXNavStatus(_message.Message):
    __slots__ = ("header", "itow", "gps_fix", "gps_fix_ok", "diff_soln", "wkn_set", "tow_set", "diff_corr", "carr_soln_valid", "map_matching", "psm", "spoof_det", "carr_soln", "ttff", "msss")
    ...
    ttff: int
    msss: int
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., itow: _Optional[int] = ..., gps_fix: _Optional[_Union[_gps_fix_pb2.GpsFix, _Mapping]] = ..., gps_fix_ok: bool = ..., diff_soln: bool = ..., wkn_set: bool = ..., tow_set: bool = ..., diff_corr: bool = ..., carr_soln_valid: bool = ..., map_matching: _Optional[_Union[_map_matching_pb2.MapMatching, _Mapping]] = ..., psm: _Optional[_Union[_psm_status_pb2.PSMStatus, _Mapping]] = ..., spoof_det: _Optional[_Union[_spoof_det_pb2.SpoofDet, _Mapping]] = ..., carr_soln: _Optional[_Union[_carr_soln_pb2.CarrSoln, _Mapping]] = ..., ttff: _Optional[int] = ..., msss: _Optional[int] = ...) -> None: ...
