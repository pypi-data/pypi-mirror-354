...
class HilGPS(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., fix_type: _Optional[int] = ..., geo: _Optional[_Union[_geo_point_pb2.GeoPoint, _Mapping]] = ..., eph: _Optional[int] = ..., epv: _Optional[int] = ..., vel: _Optional[int] = ..., vn: _Optional[int] = ..., ve: _Optional[int] = ..., vd: _Optional[int] = ..., cog: _Optional[int] = ..., satellites_visible: _Optional[int] = ...) -> None: ...
