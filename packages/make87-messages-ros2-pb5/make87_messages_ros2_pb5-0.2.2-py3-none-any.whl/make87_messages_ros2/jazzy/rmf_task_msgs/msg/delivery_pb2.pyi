from make87_messages_ros2.jazzy.rmf_dispenser_msgs.msg import dispenser_request_item_pb2 as _dispenser_request_item_pb2
from make87_messages_ros2.jazzy.rmf_task_msgs.msg import behavior_pb2 as _behavior_pb2
...
class Delivery(_message.Message):
    __slots__ = ("task_id", "items", "pickup_place_name", "pickup_dispenser", "pickup_behavior", "dropoff_place_name", "dropoff_ingestor", "dropoff_behavior")
