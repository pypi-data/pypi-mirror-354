...
class SrrStatus1(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., can_tx_look_type: bool = ..., can_tx_dsp_timestamp: _Optional[int] = ..., can_tx_yaw_rate_calc: _Optional[float] = ..., can_tx_vehicle_speed_calc: _Optional[float] = ..., can_tx_scan_index: _Optional[int] = ..., can_tx_curvature: _Optional[float] = ...) -> None: ...
