...
class HostVehicleState2806(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ibeo_header: _Optional[_Union[_ibeo_data_header_pb2.IbeoDataHeader, _Mapping]] = ..., timestamp: _Optional[_Union[_time_pb2.Time, _Mapping]] = ..., distance_x: _Optional[int] = ..., distance_y: _Optional[int] = ..., course_angle: _Optional[float] = ..., longitudinal_velocity: _Optional[float] = ..., yaw_rate: _Optional[float] = ..., steering_wheel_angle: _Optional[float] = ..., cross_acceleration: _Optional[float] = ..., front_wheel_angle: _Optional[float] = ..., vehicle_width: _Optional[float] = ..., vehicle_front_to_front_axle: _Optional[float] = ..., rear_axle_to_front_axle: _Optional[float] = ..., rear_axle_to_vehicle_rear: _Optional[float] = ..., steer_ratio_poly_0: _Optional[float] = ..., steer_ratio_poly_1: _Optional[float] = ..., steer_ratio_poly_2: _Optional[float] = ..., steer_ratio_poly_3: _Optional[float] = ...) -> None: ...
