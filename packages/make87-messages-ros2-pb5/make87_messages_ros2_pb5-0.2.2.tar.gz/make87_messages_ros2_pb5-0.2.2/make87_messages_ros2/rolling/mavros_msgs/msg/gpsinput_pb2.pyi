...
class GPSINPUT(_message.Message):
    ...
    yaw: int
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., fix_type: _Optional[int] = ..., gps_id: _Optional[int] = ..., ignore_flags: _Optional[int] = ..., time_week_ms: _Optional[int] = ..., time_week: _Optional[int] = ..., lat: _Optional[int] = ..., lon: _Optional[int] = ..., alt: _Optional[float] = ..., hdop: _Optional[float] = ..., vdop: _Optional[float] = ..., vn: _Optional[float] = ..., ve: _Optional[float] = ..., vd: _Optional[float] = ..., speed_accuracy: _Optional[float] = ..., horiz_accuracy: _Optional[float] = ..., vert_accuracy: _Optional[float] = ..., satellites_visible: _Optional[int] = ..., yaw: _Optional[int] = ...) -> None: ...
