...
class NegotiationProposal(_message.Message):
    __slots__ = ("conflict_version", "proposal_version", "for_participant", "to_accommodate", "plan_id", "itinerary")
    ...
    def __init__(self, conflict_version: _Optional[int] = ..., proposal_version: _Optional[int] = ..., for_participant: _Optional[int] = ..., to_accommodate: _Optional[_Iterable[_Union[_negotiation_key_pb2.NegotiationKey, _Mapping]]] = ..., plan_id: _Optional[int] = ..., itinerary: _Optional[_Iterable[_Union[_route_pb2.Route, _Mapping]]] = ...) -> None: ...
