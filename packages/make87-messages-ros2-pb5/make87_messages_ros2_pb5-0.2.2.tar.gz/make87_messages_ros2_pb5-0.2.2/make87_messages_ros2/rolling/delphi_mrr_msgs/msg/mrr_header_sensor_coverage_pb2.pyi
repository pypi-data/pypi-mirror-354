...
class MrrHeaderSensorCoverage(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., can_sensor_fov_hor: _Optional[int] = ..., can_doppler_coverage: _Optional[int] = ..., can_range_coverage: _Optional[int] = ...) -> None: ...
