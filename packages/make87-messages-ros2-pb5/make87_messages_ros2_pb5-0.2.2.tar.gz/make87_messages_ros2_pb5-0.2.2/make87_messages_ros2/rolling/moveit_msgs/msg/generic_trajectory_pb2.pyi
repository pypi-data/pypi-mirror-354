from make87_messages_ros2.rolling.moveit_msgs.msg import cartesian_trajectory_pb2 as _cartesian_trajectory_pb2
...
class GenericTrajectory(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., joint_trajectory: _Optional[_Iterable[_Union[_joint_trajectory_pb2.JointTrajectory, _Mapping]]] = ..., cartesian_trajectory: _Optional[_Iterable[_Union[_cartesian_trajectory_pb2.CartesianTrajectory, _Mapping]]] = ...) -> None: ...
