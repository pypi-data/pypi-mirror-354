...
class EsrStatus5(_message.Message):
    __slots__ = ("header", "canmsg", "swbatt_a2d", "ignp_a2d", "temp1_a2d", "temp2_a2d", "supply_5va_a2d", "supply_5vdx_a2d", "supply_3p3v_a2d", "supply_10v_a2d")
    ...
    supply_3p3v_a2d: int
    supply_10v_a2d: int
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., canmsg: _Optional[str] = ..., swbatt_a2d: _Optional[int] = ..., ignp_a2d: _Optional[int] = ..., temp1_a2d: _Optional[int] = ..., temp2_a2d: _Optional[int] = ..., supply_5va_a2d: _Optional[int] = ..., supply_5vdx_a2d: _Optional[int] = ..., supply_3p3v_a2d: _Optional[int] = ..., supply_10v_a2d: _Optional[int] = ...) -> None: ...
