...
class NovatelUtmPosition(_message.Message):
    __slots__ = ("header", "novatel_msg_header", "solution_status", "position_type", "lon_zone_number", "lat_zone_letter", "northing", "easting", "height", "undulation", "datum_id", "northing_sigma", "easting_sigma", "height_sigma", "base_station_id", "diff_age", "solution_age", "num_satellites_tracked", "num_satellites_used_in_solution", "num_gps_and_glonass_l1_used_in_solution", "num_gps_and_glonass_l1_and_l2_used_in_solution", "extended_solution_status", "signal_mask")
