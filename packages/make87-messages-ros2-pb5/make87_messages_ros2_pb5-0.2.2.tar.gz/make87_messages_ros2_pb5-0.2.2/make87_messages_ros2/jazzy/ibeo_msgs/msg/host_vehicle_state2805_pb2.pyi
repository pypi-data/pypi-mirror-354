...
class HostVehicleState2805(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ibeo_header: _Optional[_Union[_ibeo_data_header_pb2.IbeoDataHeader, _Mapping]] = ..., timestamp: _Optional[_Union[_time_pb2.Time, _Mapping]] = ..., scan_number: _Optional[int] = ..., error_flags: _Optional[int] = ..., longitudinal_velocity: _Optional[float] = ..., steering_wheel_angle: _Optional[float] = ..., front_wheel_angle: _Optional[float] = ..., x_position: _Optional[int] = ..., y_position: _Optional[int] = ..., course_angle: _Optional[int] = ..., time_difference: _Optional[int] = ..., x_difference: _Optional[int] = ..., y_difference: _Optional[int] = ..., heading_difference: _Optional[int] = ..., current_yaw_rate: _Optional[int] = ...) -> None: ...
