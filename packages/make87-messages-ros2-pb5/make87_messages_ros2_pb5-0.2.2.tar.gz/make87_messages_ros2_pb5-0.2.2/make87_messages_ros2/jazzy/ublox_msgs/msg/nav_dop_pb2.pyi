...
class NavDOP(_message.Message):
    __slots__ = ("i_tow", "g_dop", "p_dop", "t_dop", "v_dop", "h_dop", "n_dop", "e_dop")
    ...
    n_dop: int
    e_dop: int
    def __init__(self, i_tow: _Optional[int] = ..., g_dop: _Optional[int] = ..., p_dop: _Optional[int] = ..., t_dop: _Optional[int] = ..., v_dop: _Optional[int] = ..., h_dop: _Optional[int] = ..., n_dop: _Optional[int] = ..., e_dop: _Optional[int] = ...) -> None: ...
