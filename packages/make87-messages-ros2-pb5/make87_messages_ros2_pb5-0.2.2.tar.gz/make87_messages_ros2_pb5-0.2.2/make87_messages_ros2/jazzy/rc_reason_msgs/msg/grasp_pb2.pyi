...
class Grasp(_message.Message):
    __slots__ = ("id", "uuid", "match_uuid", "pose", "priority", "gripper_id", "collision_checked")
    ...
    def __init__(self, id: _Optional[str] = ..., uuid: _Optional[str] = ..., match_uuid: _Optional[str] = ..., pose: _Optional[_Union[_pose_stamped_pb2.PoseStamped, _Mapping]] = ..., priority: _Optional[int] = ..., gripper_id: _Optional[str] = ..., collision_checked: bool = ...) -> None: ...
