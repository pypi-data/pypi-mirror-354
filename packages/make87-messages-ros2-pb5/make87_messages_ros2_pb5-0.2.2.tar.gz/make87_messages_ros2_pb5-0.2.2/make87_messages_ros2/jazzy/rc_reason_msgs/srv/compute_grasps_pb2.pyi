...
from make87_messages_ros2.jazzy.rc_reason_msgs.msg import compartment_pb2 as _compartment_pb2
from make87_messages_ros2.jazzy.rc_reason_msgs.msg import item_pb2 as _item_pb2
from make87_messages_ros2.jazzy.rc_reason_msgs.msg import item_model_pb2 as _item_model_pb2
from make87_messages_ros2.jazzy.rc_reason_msgs.msg import load_carrier_pb2 as _load_carrier_pb2
from make87_messages_ros2.jazzy.rc_reason_msgs.msg import suction_grasp_pb2 as _suction_grasp_pb2
...
class ComputeGraspsRequest(_message.Message):
    __slots__ = ("pose_frame", "region_of_interest_id", "load_carrier_id", "load_carrier_compartment", "item_models", "suction_surface_length", "suction_surface_width", "robot_pose", "collision_detection")
...
class ComputeGraspsResponse(_message.Message):
    __slots__ = ("timestamp", "items", "load_carriers", "grasps", "return_code")
    ...
    def __init__(self, timestamp: _Optional[_Union[_time_pb2.Time, _Mapping]] = ..., items: _Optional[_Iterable[_Union[_item_pb2.Item, _Mapping]]] = ..., load_carriers: _Optional[_Iterable[_Union[_load_carrier_pb2.LoadCarrier, _Mapping]]] = ..., grasps: _Optional[_Iterable[_Union[_suction_grasp_pb2.SuctionGrasp, _Mapping]]] = ..., return_code: _Optional[_Union[_return_code_pb2.ReturnCode, _Mapping]] = ...) -> None: ...
