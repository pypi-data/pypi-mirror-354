...
class TrackVisual(_message.Message):
    __slots__ = ("header", "name", "id", "inherit_orientation", "min_dist", "max_dist", "is_static", "use_model_frame", "xyz", "inherit_yaw")
    ...
    inherit_yaw: bool
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., name: _Optional[str] = ..., id: _Optional[int] = ..., inherit_orientation: bool = ..., min_dist: _Optional[float] = ..., max_dist: _Optional[float] = ..., is_static: bool = ..., use_model_frame: bool = ..., xyz: _Optional[_Union[_vector3_pb2.Vector3, _Mapping]] = ..., inherit_yaw: bool = ...) -> None: ...
