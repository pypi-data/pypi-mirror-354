...
class ApplyBodyWrenchRequest(_message.Message):
    ...
    def __init__(self, body_name: _Optional[str] = ..., reference_frame: _Optional[str] = ..., reference_point: _Optional[_Union[_point_pb2.Point, _Mapping]] = ..., wrench: _Optional[_Union[_wrench_pb2.Wrench, _Mapping]] = ..., start_time: _Optional[_Union[_time_pb2.Time, _Mapping]] = ..., duration: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...) -> None: ...

class ApplyBodyWrenchResponse(_message.Message):
