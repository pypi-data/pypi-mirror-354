...
class CorStatusInfo(_message.Message):
    __slots__ = ("protocol", "err_status", "msg_used", "correction_id", "msg_type_valid", "msg_sub_type_valid", "msg_input_handle", "msg_encrypted", "msg_decrypted")
    ...
    msg_encrypted: int
    msg_decrypted: int
    def __init__(self, protocol: _Optional[int] = ..., err_status: _Optional[int] = ..., msg_used: _Optional[int] = ..., correction_id: _Optional[int] = ..., msg_type_valid: bool = ..., msg_sub_type_valid: bool = ..., msg_input_handle: bool = ..., msg_encrypted: _Optional[int] = ..., msg_decrypted: _Optional[int] = ...) -> None: ...
