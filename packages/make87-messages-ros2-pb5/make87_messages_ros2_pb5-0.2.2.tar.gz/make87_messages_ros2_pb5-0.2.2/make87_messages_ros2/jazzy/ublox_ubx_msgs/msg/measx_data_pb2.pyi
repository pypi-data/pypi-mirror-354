...
class MeasxData(_message.Message):
    __slots__ = ("gnss_id", "sv_id", "c_no", "mpath_indic", "doppler_ms", "doppler_hz", "whole_chips", "frac_chips", "code_phase", "int_code_phase", "pseu_range_rms_err")
    ...
    def __init__(self, gnss_id: _Optional[int] = ..., sv_id: _Optional[int] = ..., c_no: _Optional[int] = ..., mpath_indic: _Optional[int] = ..., doppler_ms: _Optional[int] = ..., doppler_hz: _Optional[int] = ..., whole_chips: _Optional[int] = ..., frac_chips: _Optional[int] = ..., code_phase: _Optional[int] = ..., int_code_phase: _Optional[int] = ..., pseu_range_rms_err: _Optional[int] = ...) -> None: ...
