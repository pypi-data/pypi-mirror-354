...
from make87_messages_ros2.humble.rmf_traffic_msgs.msg import itinerary_pb2 as _itinerary_pb2
...
class NegotiationRejection(_message.Message):
    __slots__ = ("header", "conflict_version", "table", "rejected_by", "alternatives")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., conflict_version: _Optional[int] = ..., table: _Optional[_Iterable[_Union[_negotiation_key_pb2.NegotiationKey, _Mapping]]] = ..., rejected_by: _Optional[int] = ..., alternatives: _Optional[_Iterable[_Union[_itinerary_pb2.Itinerary, _Mapping]]] = ...) -> None: ...
