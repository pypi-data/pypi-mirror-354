...
from make87_messages_ros2.humble.pendulum_msgs.msg import joint_command_pb2 as _joint_command_pb2
from make87_messages_ros2.humble.pendulum_msgs.msg import joint_state_pb2 as _joint_state_pb2
...
class RttestResults(_message.Message):
    __slots__ = ("header", "stamp", "command", "state", "cur_latency", "mean_latency", "min_latency", "max_latency", "minor_pagefaults", "major_pagefaults")
