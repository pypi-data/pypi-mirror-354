...
class GetPhysicsPropertiesResponse(_message.Message):
    __slots__ = ("header", "time_step", "pause", "max_update_rate", "gravity", "ode_config", "success", "status_message")
    HEADER_FIELD_NUMBER: _ClassVar[int]
    ...
    success: bool
    status_message: str
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., time_step: _Optional[float] = ..., pause: bool = ..., max_update_rate: _Optional[float] = ..., gravity: _Optional[_Union[_vector3_pb2.Vector3, _Mapping]] = ..., ode_config: _Optional[_Union[_ode_physics_pb2.ODEPhysics, _Mapping]] = ..., success: bool = ..., status_message: _Optional[str] = ...) -> None: ...
