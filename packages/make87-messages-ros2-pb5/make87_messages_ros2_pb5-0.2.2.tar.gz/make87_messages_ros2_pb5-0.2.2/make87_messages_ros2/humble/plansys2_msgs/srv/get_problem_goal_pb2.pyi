...
class GetProblemGoalResponse(_message.Message):
    __slots__ = ("header", "success", "tree", "error_info")
    HEADER_FIELD_NUMBER: _ClassVar[int]
    ...
    tree: _tree_pb2.Tree
    error_info: str
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., success: bool = ..., tree: _Optional[_Union[_tree_pb2.Tree, _Mapping]] = ..., error_info: _Optional[str] = ...) -> None: ...
