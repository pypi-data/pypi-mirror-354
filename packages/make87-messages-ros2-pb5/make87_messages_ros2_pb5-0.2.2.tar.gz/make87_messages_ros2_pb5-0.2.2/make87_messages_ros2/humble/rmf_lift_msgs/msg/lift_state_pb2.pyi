...
class LiftState(_message.Message):
    __slots__ = ("header", "lift_time", "lift_name", "available_floors", "current_floor", "destination_floor", "door_state", "motion_state", "available_modes", "current_mode", "session_id")
    ...
    current_mode: int
    session_id: str
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., lift_time: _Optional[_Union[_time_pb2.Time, _Mapping]] = ..., lift_name: _Optional[str] = ..., available_floors: _Optional[_Iterable[str]] = ..., current_floor: _Optional[str] = ..., destination_floor: _Optional[str] = ..., door_state: _Optional[int] = ..., motion_state: _Optional[int] = ..., available_modes: _Optional[_Iterable[int]] = ..., current_mode: _Optional[int] = ..., session_id: _Optional[str] = ...) -> None: ...
