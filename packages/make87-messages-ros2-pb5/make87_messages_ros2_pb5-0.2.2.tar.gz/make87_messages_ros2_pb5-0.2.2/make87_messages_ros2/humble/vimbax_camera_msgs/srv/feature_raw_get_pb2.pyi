...
class FeatureRawGetRequest(_message.Message):
...
class FeatureRawGetResponse(_message.Message):
    __slots__ = ("header", "buffer", "buffer_size", "error")
    HEADER_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., buffer: _Optional[_Iterable[int]] = ..., buffer_size: _Optional[int] = ..., error: _Optional[_Union[_error_pb2.Error, _Mapping]] = ...) -> None: ...
