...
class FeatureCommandIsDoneRequest(_message.Message):
...
class FeatureCommandIsDoneResponse(_message.Message):
    __slots__ = ("header", "is_done", "error")
    HEADER_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., is_done: bool = ..., error: _Optional[_Union[_error_pb2.Error, _Mapping]] = ...) -> None: ...
