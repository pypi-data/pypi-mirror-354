...
class GetPlanRequest(_message.Message):
    __slots__ = ("header", "start", "goal", "tolerance")
    ...
    tolerance: float
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., start: _Optional[_Union[_pose_stamped_pb2.PoseStamped, _Mapping]] = ..., goal: _Optional[_Union[_pose_stamped_pb2.PoseStamped, _Mapping]] = ..., tolerance: _Optional[float] = ...) -> None: ...
