...
class OverlayText(_message.Message):
    __slots__ = ("header", "action", "width", "height", "horizontal_distance", "vertical_distance", "horizontal_alignment", "vertical_alignment", "bg_color", "line_width", "text_size", "font", "fg_color", "text")
