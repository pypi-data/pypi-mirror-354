...
class ScanPoint2208(_message.Message):
    __slots__ = ("header", "echo", "layer", "transparent_point", "clutter_atmospheric", "ground", "dirt", "horizontal_angle", "radial_distance", "echo_pulse_width")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., echo: _Optional[int] = ..., layer: _Optional[int] = ..., transparent_point: bool = ..., clutter_atmospheric: bool = ..., ground: bool = ..., dirt: bool = ..., horizontal_angle: _Optional[int] = ..., radial_distance: _Optional[int] = ..., echo_pulse_width: _Optional[int] = ...) -> None: ...
