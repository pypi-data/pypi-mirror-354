...
class CameraImage(_message.Message):
    __slots__ = ("header", "ros2_header", "ibeo_header", "image_format", "us_since_power_on", "timestamp", "device_id", "mounting_position", "horizontal_opening_angle", "vertical_opening_angle", "image_width", "image_height", "compressed_size", "image_buffer")
