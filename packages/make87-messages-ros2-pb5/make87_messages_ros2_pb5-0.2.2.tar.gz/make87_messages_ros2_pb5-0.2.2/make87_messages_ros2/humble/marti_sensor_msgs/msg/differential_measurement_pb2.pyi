...
class DifferentialMeasurement(_message.Message):
    __slots__ = ("header", "ros2_header", "base_frame_id", "baseline_length", "baseline_length_variance", "heading", "heading_variance", "pitch", "pitch_variance", "roll", "roll_variance", "position", "position_covariance")
