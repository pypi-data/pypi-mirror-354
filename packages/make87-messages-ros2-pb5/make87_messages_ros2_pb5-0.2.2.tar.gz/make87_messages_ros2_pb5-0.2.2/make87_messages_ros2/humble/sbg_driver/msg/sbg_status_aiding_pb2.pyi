...
class SbgStatusAiding(_message.Message):
    __slots__ = ("header", "gps1_pos_recv", "gps1_vel_recv", "gps1_hdt_recv", "gps1_utc_recv", "gps2_pos_recv", "gps2_vel_recv", "gps2_hdt_recv", "gps2_utc_recv", "mag_recv", "odo_recv", "dvl_recv", "usbl_recv", "depth_recv", "air_data_recv", "user_pos_recv", "user_vel_recv", "user_heading_recv")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., gps1_pos_recv: bool = ..., gps1_vel_recv: bool = ..., gps1_hdt_recv: bool = ..., gps1_utc_recv: bool = ..., gps2_pos_recv: bool = ..., gps2_vel_recv: bool = ..., gps2_hdt_recv: bool = ..., gps2_utc_recv: bool = ..., mag_recv: bool = ..., odo_recv: bool = ..., dvl_recv: bool = ..., usbl_recv: bool = ..., depth_recv: bool = ..., air_data_recv: bool = ..., user_pos_recv: bool = ..., user_vel_recv: bool = ..., user_heading_recv: bool = ...) -> None: ...
