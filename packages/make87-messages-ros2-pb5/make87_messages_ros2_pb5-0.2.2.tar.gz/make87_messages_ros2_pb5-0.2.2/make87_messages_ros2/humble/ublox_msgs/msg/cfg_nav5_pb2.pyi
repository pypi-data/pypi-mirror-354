...
class CfgNAV5(_message.Message):
    __slots__ = ("header", "mask", "dyn_model", "fix_mode", "fixed_alt", "fixed_alt_var", "min_elev", "dr_limit", "p_dop", "t_dop", "p_acc", "t_acc", "static_hold_thresh", "dgnss_time_out", "cno_thresh_num_svs", "cno_thresh", "reserved1", "static_hold_max_dist", "utc_standard", "reserved2")
