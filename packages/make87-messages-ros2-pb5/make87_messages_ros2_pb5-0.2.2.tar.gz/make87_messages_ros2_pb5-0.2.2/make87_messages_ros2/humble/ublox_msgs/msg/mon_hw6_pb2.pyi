...
class MonHW6(_message.Message):
    __slots__ = ("header", "pin_sel", "pin_bank", "pin_dir", "pin_val", "noise_per_ms", "agc_cnt", "a_status", "a_power", "flags", "reserved0", "used_mask", "vp", "jam_ind", "reserved1", "pin_irq", "pull_h", "pull_l")
    ...
    pull_h: int
    pull_l: int
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., pin_sel: _Optional[int] = ..., pin_bank: _Optional[int] = ..., pin_dir: _Optional[int] = ..., pin_val: _Optional[int] = ..., noise_per_ms: _Optional[int] = ..., agc_cnt: _Optional[int] = ..., a_status: _Optional[int] = ..., a_power: _Optional[int] = ..., flags: _Optional[int] = ..., reserved0: _Optional[int] = ..., used_mask: _Optional[int] = ..., vp: _Optional[_Iterable[int]] = ..., jam_ind: _Optional[int] = ..., reserved1: _Optional[_Iterable[int]] = ..., pin_irq: _Optional[int] = ..., pull_h: _Optional[int] = ..., pull_l: _Optional[int] = ...) -> None: ...
