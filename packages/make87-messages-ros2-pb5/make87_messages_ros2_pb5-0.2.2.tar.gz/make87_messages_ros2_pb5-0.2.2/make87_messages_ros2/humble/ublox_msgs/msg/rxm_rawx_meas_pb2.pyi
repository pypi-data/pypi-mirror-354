...
class RxmRAWXMeas(_message.Message):
    __slots__ = ("header", "pr_mes", "cp_mes", "do_mes", "gnss_id", "sv_id", "reserved0", "freq_id", "locktime", "cno", "pr_stdev", "cp_stdev", "do_stdev", "trk_stat", "reserved1")
    ...
    trk_stat: int
    reserved1: int
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., pr_mes: _Optional[float] = ..., cp_mes: _Optional[float] = ..., do_mes: _Optional[float] = ..., gnss_id: _Optional[int] = ..., sv_id: _Optional[int] = ..., reserved0: _Optional[int] = ..., freq_id: _Optional[int] = ..., locktime: _Optional[int] = ..., cno: _Optional[int] = ..., pr_stdev: _Optional[int] = ..., cp_stdev: _Optional[int] = ..., do_stdev: _Optional[int] = ..., trk_stat: _Optional[int] = ..., reserved1: _Optional[int] = ...) -> None: ...
