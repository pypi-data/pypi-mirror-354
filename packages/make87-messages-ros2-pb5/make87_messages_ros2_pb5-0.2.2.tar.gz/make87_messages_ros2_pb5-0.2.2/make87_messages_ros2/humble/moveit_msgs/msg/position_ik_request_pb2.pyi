...
class PositionIKRequest(_message.Message):
    __slots__ = ("header", "group_name", "robot_state", "constraints", "avoid_collisions", "ik_link_name", "pose_stamped", "ik_link_names", "pose_stamped_vector", "timeout")
