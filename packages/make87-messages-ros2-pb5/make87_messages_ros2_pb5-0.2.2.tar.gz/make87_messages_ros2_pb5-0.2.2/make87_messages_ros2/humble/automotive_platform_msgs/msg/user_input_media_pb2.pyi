...
class UserInputMedia(_message.Message):
    __slots__ = ("header", "ros2_header", "btn_vol_up", "btn_vol_down", "btn_mute", "btn_next", "btn_prev", "btn_next_hang_up", "btn_prev_answer", "btn_hang_up", "btn_answer", "btn_play", "btn_pause", "btn_play_pause", "btn_mode")
    ...
    btn_play_pause: bool
    btn_mode: bool
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., btn_vol_up: bool = ..., btn_vol_down: bool = ..., btn_mute: bool = ..., btn_next: bool = ..., btn_prev: bool = ..., btn_next_hang_up: bool = ..., btn_prev_answer: bool = ..., btn_hang_up: bool = ..., btn_answer: bool = ..., btn_play: bool = ..., btn_pause: bool = ..., btn_play_pause: bool = ..., btn_mode: bool = ...) -> None: ...
