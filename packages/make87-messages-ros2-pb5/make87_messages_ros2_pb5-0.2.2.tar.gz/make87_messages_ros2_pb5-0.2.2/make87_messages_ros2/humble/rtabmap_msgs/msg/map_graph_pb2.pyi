...
class MapGraph(_message.Message):
    __slots__ = ("header", "ros2_header", "map_to_odom", "poses_id", "poses", "links")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., map_to_odom: _Optional[_Union[_transform_pb2.Transform, _Mapping]] = ..., poses_id: _Optional[_Iterable[int]] = ..., poses: _Optional[_Iterable[_Union[_pose_pb2.Pose, _Mapping]]] = ..., links: _Optional[_Iterable[_Union[_link_pb2.Link, _Mapping]]] = ...) -> None: ...
