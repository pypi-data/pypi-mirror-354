...
from make87_messages_ros2.humble.rc_common_msgs.msg import key_value_pb2 as _key_value_pb2
...
class CameraParam(_message.Message):
    __slots__ = ("header", "ros2_header", "is_color_camera", "exposure_time", "gain", "line_status_all", "line_source", "extra_data")
