...
class Inspvax(_message.Message):
    __slots__ = ("header", "ros2_header", "novatel_msg_header", "ins_status", "position_type", "latitude", "longitude", "altitude", "undulation", "north_velocity", "east_velocity", "up_velocity", "roll", "pitch", "azimuth", "latitude_std", "longitude_std", "altitude_std", "north_velocity_std", "east_velocity_std", "up_velocity_std", "roll_std", "pitch_std", "azimuth_std", "extended_status", "seconds_since_update")
