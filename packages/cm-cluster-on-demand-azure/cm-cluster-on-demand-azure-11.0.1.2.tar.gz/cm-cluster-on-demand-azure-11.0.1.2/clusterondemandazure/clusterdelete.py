...
class ClusterDelete(ClusterCommand):
    def delete_virtual_machines(self, resource_group_name, cluster_name=None):
    ...
    def delete_network_interfaces(self, resource_group_name, cluster_name=None):
        removal_ops = []
    ...
    def delete_private_endpoints(self, resource_group_name, cluster_name=None):
        removal_ops = []
    ...
    def delete_virtual_networks(self, resource_group_name, cluster_name=None):
        removal_ops = []
    ...
    def delete_public_ips(self, resource_group_name, cluster_name=None):
        removal_ops = []
    ...
    def delete_security_groups(self, resource_group_name, cluster_name=None):
        removal_ops = []
    ...
    def delete_availability_sets(self, resource_group_name, cluster_name=None):
    ...
    def delete_disks(self, resource_group_name, cluster_name=None):
        removal_ops = []
    ...
    def delete_snapshots(self, resource_group_name, cluster_name=None):
        removal_ops = []
    ...
    def delete_storage_accounts(self, resource_group_name, cluster_name=None):
    ...
    def delete_images(self, resource_group_name, cluster_name=None):
        removal_ops = []
    ...
    def delete_nat_gateways(self, resource_group_name, cluster_name=None):
        removal_ops = []
    ...
    def delete_storage_account_plink_privdns_zones(self, resource_group_name):
        ...
        for entity in entities:
            ...
            # resource group.
            if next(self.azure_api.privdns_management_client.virtual_network_links.list(
                resource_group_name, entity.name), None
            ):
    ...
    @classmethod
    def _match_bcm_tags(cls, entity, cluster_name):
    ...
    def delete_resources(self, resource_group, cluster_name=None):
        """
    ...
    def get_resource_group(self, rg_name):
        try:
            return self.azure_api.resource_client.resource_groups.get(rg_name)
