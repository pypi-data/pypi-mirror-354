...
class TemplateBuilder:
    ...
    def __init__(self, cluster_name, head_node_name, head_node_flavour, storage_account,
                 ...
                 image_name, image_creation_date, inbound_rules, vnet_name, nat_gateway_name,
                 nat_gateway_public_ip_name, configure_nat_gateway):
    ...
    def get_head_node_avset_resource(self):
    ...
    def get_nat_gateway_resource(self):
        return self.get_resource("nat-gateway")

    def get_nat_gateway_public_ip_resource(self):
