...
if __name__ == "__main__":
    ...
    system_prompt = utils.read_file_as_string("/Users/nieqi/Documents/workspace/python/image_article_comprehension/aiddit/agent/agent_prompt_backup/creation_persona_agent.md")
