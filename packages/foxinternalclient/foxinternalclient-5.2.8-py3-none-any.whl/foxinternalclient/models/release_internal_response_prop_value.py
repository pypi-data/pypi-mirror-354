...
RELEASEINTERNALRESPONSEPROPVALUE_ANY_OF_SCHEMAS = ["bool", "int", "str"]

class ReleaseInternalResponsePropValue(BaseModel):
    """
    ...
    any_of_schemas: Set[str] = { "bool", "int", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ReleaseInternalResponsePropValue.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ReleaseInternalResponsePropValue with anyOf schemas: bool, int, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ReleaseInternalResponsePropValue with anyOf schemas: bool, int, str. Details: " + ", ".join(error_messages))
        else:
            return instance
