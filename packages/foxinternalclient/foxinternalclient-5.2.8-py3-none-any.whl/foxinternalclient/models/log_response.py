...
class LogResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "user", "timestamp", "action", "ip", "device_id", "release_id", "user_id", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "user": MaintainerShortModel.from_dict(obj["user"]) if obj.get("user") is not None else None,
