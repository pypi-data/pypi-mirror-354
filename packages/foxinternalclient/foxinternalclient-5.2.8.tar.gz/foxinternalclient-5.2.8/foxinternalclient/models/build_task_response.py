...
class BuildTaskResponse(BaseModel):
    ...
    environment: Optional[Dict[str, StrictStr]] = None
    logs: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["id", "started_by_id", "device", "status", "version", "type", "variant", "started_at", "finished_at", "has_artifact", "environment", "logs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BuildTaskResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BuildTaskResponse from a dict"""
        if obj is None:
            return None
