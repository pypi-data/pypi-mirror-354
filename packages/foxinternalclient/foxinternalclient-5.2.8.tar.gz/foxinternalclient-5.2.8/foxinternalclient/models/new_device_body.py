...
class NewDeviceBody(BaseModel):
    ...
    maintainer: StrictStr
    __properties: ClassVar[List[str]] = ["oem_name", "codenames", "model_names", "maintainer"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NewDeviceBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewDeviceBody from a dict"""
        if obj is None:
            return None
