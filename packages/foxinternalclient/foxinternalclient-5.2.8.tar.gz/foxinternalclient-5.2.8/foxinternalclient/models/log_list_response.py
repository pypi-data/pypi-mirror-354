...
class LogListResponse(BaseModel):
    ...
    page: StrictInt
    per_page: StrictInt
    __properties: ClassVar[List[str]] = ["logs", "total", "page", "per_page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LogListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LogListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "logs": [LogResponse.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
