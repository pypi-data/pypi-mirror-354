...
class StatsApi:
    ...
    async def get_public_stats(
        ...
        _param = self._get_public_stats_serialize(
    ...
    @validate_call
    async def get_public_stats_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_public_stats_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_public_stats_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
