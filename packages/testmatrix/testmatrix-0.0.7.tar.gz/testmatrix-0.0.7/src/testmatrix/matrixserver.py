...
class MatrixServer:
    ...
    def __init__(self, servername: str,
        ...
        self._federation_baseurl: Optional[str] = None
        self._client_baseurl: Optional[str] = None
    ...
    @property
    def federation_baseurl(self) -> Optional[str]:
        """federation API endpoint base URL"""
        assert self._federation_baseurl, "federation base url not determined!"
        return self._federation_baseurl

    @federation_baseurl.setter
    def federation_baseurl(self, value: Optional[str]):
        self._federation_baseurl = value

    @property
    def client_baseurl(self) -> Optional[str]:
        """client API endpoint base URL"""
        assert self._client_baseurl, "federation base url not determined!"
        return self._client_baseurl

    @client_baseurl.setter
    def client_baseurl(self, value: Optional[str]):
        self._client_baseurl = value
    ...
    def get_client_baseurl(self) -> Optional[str]:
