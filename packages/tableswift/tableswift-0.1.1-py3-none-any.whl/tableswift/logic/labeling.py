...
def label_data_logic(instruction: str, task:str, demonstrations: List[dict],
    ...
    transformed_samples = llm_pr.pipeline_no_eval(instruction, demonstrations, samples_to_label)
