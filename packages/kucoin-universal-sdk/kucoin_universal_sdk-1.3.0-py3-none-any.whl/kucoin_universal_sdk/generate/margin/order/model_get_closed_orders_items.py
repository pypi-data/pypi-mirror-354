...
class GetClosedOrdersItems(BaseModel):
    ...
    Attributes:
        ...
        post_only (bool): Whether it’s a postOnly order.
        hidden (bool): Whether it’s a hidden order.
        iceberg (bool): Whether it’s a iceberg order.
        ...
        in_order_book (bool): Whether to enter the orderbook: True: enter the orderbook; False: do not enter the orderbook
        ...
        tax (str): Users in some regions have this field
        active (bool): Order status: true-The status of the order is active; false-The status of the order is done
    """
    ...
    iceberg: Optional[bool] = Field(
        default=None, description="Whether it’s a iceberg order.")
    ...
    tax: Optional[str] = Field(
        default=None, description="Users in some regions have this field")
