...
class MarketAPI(ABC):
    ...
    def get_call_auction_part_order_book(
            self, req: GetCallAuctionPartOrderBookReq,
            **kwargs: Any) -> GetCallAuctionPartOrderBookResp:
        """
        summary: Get Call Auction Part OrderBook
    ...
    @abstractmethod
    def get_client_ip_address(self, **kwargs: Any) -> GetClientIpAddressResp:
        """
...
class MarketAPIImpl(MarketAPI):
    ...
    def get_call_auction_part_order_book(
        ...
        return self.transport.call(
            ...
            GetCallAuctionPartOrderBookResp(), False, **kwargs)

    def get_call_auction_info(self, req: GetCallAuctionInfoReq,
                              **kwargs: Any) -> GetCallAuctionInfoResp:
        return self.transport.call("spot", False, "GET",
                                   "/api/v1/market/callauctionData", req,
                                   GetCallAuctionInfoResp(), False, **kwargs)
    ...
    def get_client_ip_address(self, **kwargs: Any) -> GetClientIpAddressResp:
        return self.transport.call("spot", False, "GET", "/api/v1/my-ip", None,
                                   GetClientIpAddressResp(), False, **kwargs)
