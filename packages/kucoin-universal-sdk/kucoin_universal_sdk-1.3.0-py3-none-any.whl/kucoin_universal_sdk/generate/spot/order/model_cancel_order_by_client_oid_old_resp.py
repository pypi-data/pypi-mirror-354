...
class CancelOrderByClientOidOldResp(BaseModel, Response):
    ...
    Attributes:
        ...
        cancelled_order_id (str): The unique order id generated by the trading system
        cancelled_oco_order_ids (list[str]): 
    """
    ...
    cancelled_oco_order_ids: Optional[List[str]] = Field(
