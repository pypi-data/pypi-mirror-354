...
class GetOpenOrdersByPageItems(BaseModel):
    """
    GetOpenOrdersByPageItems
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetOpenOrdersByPageItems]:
    ...
    def from_dict(
            ...
            obj: Optional[Dict[str,
                               Any]]) -> Optional[GetOpenOrdersByPageItems]:
        if obj is None:
            return None
