...
class NDBrokerAPITest(unittest.TestCase):
    ...
    def test_submit_kyc_req_model(self):
        """
       submit_kyc
       Submit KYC
       ...
       """
        ...
        req = SubmitKycReq.from_json(data)

    def test_submit_kyc_resp_model(self):
        """
        submit_kyc
        Submit KYC
        /api/kyc/ndBroker/proxyClient/submit
        ...
        resp = SubmitKycResp.from_dict(common_response.data)

    def test_get_kyc_status_req_model(self):
        """
       get_kyc_status
       Get KYC Status
       ...
       """
        ...
        req = GetKycStatusReq.from_json(data)

    def test_get_kyc_status_resp_model(self):
        """
        get_kyc_status
        Get KYC Status
        /api/kyc/ndBroker/proxyClient/status/list
        ...
        data = "{\n    \"code\": \"200000\",\n    \"data\": [\n        {\n            \"clientUid\": 226383154,\n            \"status\": \"PROCESS\",\n            \"rejectReason\": null\n        }\n    ]\n}"
        common_response = RestResponse.from_json(data)
        resp = GetKycStatusResp.from_dict(common_response.data)

    def test_get_kyc_status_list_req_model(self):
        """
       get_kyc_status_list
       Get KYC Status List
       ...
       """
        ...
        req = GetKycStatusListReq.from_json(data)

    def test_get_kyc_status_list_resp_model(self):
        """
        get_kyc_status_list
        Get KYC Status List
        /api/kyc/ndBroker/proxyClient/status/page
        ...
        common_response = RestResponse.from_json(data)
        resp = GetKycStatusListResp.from_dict(common_response.data)
