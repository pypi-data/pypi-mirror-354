...
def amortize(**kwargs):
    ...
    # Warn user if ARM/HELOC has no rate file or forward curve
...
def compare_apr_cmd(principal, rate, term, points, fees):
    """Calculate APR from rate, points, and fees."""
...
def breakeven_cmd(monthly_savings, closing_costs):
    """Estimate how long it takes for refinance to pay off."""
...
def plot_cmd(scenarios):
    """Visual comparison of amortization curves across loan scenarios."""
    loans = [
