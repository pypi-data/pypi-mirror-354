...
class Loan:
    ...
    def __init__(self, principal, term_months, rate, origination_date: date,
                 ...
                 arm_structure: Optional[Tuple[int, int]] = None,  # NEW
        ...
        self.arm_structure = (arm_structure if arm_structure is not None else (5, 1)) if self.loan_type == 'arm' else None
    ...
    def from_arm(cls, principal, term, arm_type, index, margin, origination_date,
        ...
        loan = cls(principal, term, start_rate, origination_date, loan_type='arm')
