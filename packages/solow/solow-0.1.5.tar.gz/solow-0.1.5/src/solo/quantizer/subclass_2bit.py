...
QMAP_SIGNED_LINEAR = QMAP_SIGNED_LINEAR + [QMAP_SIGNED_LINEAR[-1]] * 12
QMAP_UNSIGNED_LINEAR = torch.linspace(0, 1, 5)[1:].tolist()
QMAP_UNSIGNED_LINEAR = QMAP_UNSIGNED_LINEAR + [QMAP_UNSIGNED_LINEAR[-1]] * 12

QMAP_SIGNED_DE = create_dynamic_map(signed=True, max_exponent_bits=1, total_bits=2)
QMAP_SIGNED_DE = QMAP_SIGNED_DE + [QMAP_SIGNED_DE[-1]] * 12
QMAP_UNSIGNED_DE = create_dynamic_map(signed=False, max_exponent_bits=1, total_bits=2)
QMAP_UNSIGNED_DE = QMAP_UNSIGNED_DE + [QMAP_UNSIGNED_DE[-1]] * 12


class FixedLinearOptimState2bit(OptimState4bit):
...
class FixedDEOptimState2bit(OptimState4bit):
