...
class DelegateTokenResourceApi(object):
    ...
    def get_cg_delegate_tokens(self, account_identifier, **kwargs):  # noqa: E501
        """Retrieves Delegate Tokens by Account, Organization, Project and status.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_cg_delegate_tokens(account_identifier, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_cg_delegate_tokens_with_http_info(account_identifier, **kwargs)  # noqa: E501
        else:
            (data) = self.get_cg_delegate_tokens_with_http_info(account_identifier, **kwargs)  # noqa: E501
            return data

    def get_cg_delegate_tokens_with_http_info(self, account_identifier, **kwargs):  # noqa: E501
        """Retrieves Delegate Tokens by Account, Organization, Project and status.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_cg_delegate_tokens_with_http_info(account_identifier, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_cg_delegate_tokens" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'account_identifier' is set
        if ('account_identifier' not in params or
                params['account_identifier'] is None):
            raise ValueError("Missing the required parameter `account_identifier` when calling `get_cg_delegate_tokens`")  # noqa: E501
    ...
    def revoke_cg_delegate_token(self, account_identifier, token_name, **kwargs):  # noqa: E501
        """Revokes Delegate Token.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.revoke_cg_delegate_token(account_identifier, token_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.revoke_cg_delegate_token_with_http_info(account_identifier, token_name, **kwargs)  # noqa: E501
        else:
            (data) = self.revoke_cg_delegate_token_with_http_info(account_identifier, token_name, **kwargs)  # noqa: E501
            return data

    def revoke_cg_delegate_token_with_http_info(self, account_identifier, token_name, **kwargs):  # noqa: E501
        """Revokes Delegate Token.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.revoke_cg_delegate_token_with_http_info(account_identifier, token_name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method revoke_cg_delegate_token" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'account_identifier' is set
        if ('account_identifier' not in params or
                params['account_identifier'] is None):
            raise ValueError("Missing the required parameter `account_identifier` when calling `revoke_cg_delegate_token`")  # noqa: E501
        # verify the required parameter 'token_name' is set
        if ('token_name' not in params or
                params['token_name'] is None):
            raise ValueError("Missing the required parameter `token_name` when calling `revoke_cg_delegate_token`")  # noqa: E501
