...
class UpdateScanRequestBody(object):
    ...
    def __init__(self, artifact_fingerprint=None, code_coverage=None, execution_id=None, git_metadata=None, org_id=None, pipeline_id=None, product_id=None, project_id=None, refinement_version=None, stage_id=None, status=None, step_id=None, subproduct=None, target_variant_id=None):  # noqa: E501
