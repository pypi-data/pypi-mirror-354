...
class ArtifactDetail(object):
    ...
    discriminator_value_class_map = {
            ...
            'DockerArtifactDetailConfig'.lower(): 'DOCKER',
            'NpmArtifactDetailConfig'.lower(): 'NPM',
            'HelmArtifactDetailConfig'.lower(): 'HELM',
            'PythonArtifactDetailConfig'.lower(): 'PYTHON',
            'MavenArtifactDetailConfig'.lower(): 'MAVEN',
            'RpmArtifactDetailConfig'.lower(): 'RPM',
            'GenericArtifactDetailConfig'.lower(): 'GENERIC',
    }

    def __init__(self, created_at=None, created_by=None, download_count=None, modified_at=None, name=None, package_type=None, size=None, version=None):  # noqa: E501
