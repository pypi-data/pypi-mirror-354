...
class ProjectTemplateApi(object):
    ...
    def update_git_metadata_details_project(self, template, org, project, **kwargs):  # noqa: E501
        """Update Git details  # noqa: E501

        Update Git details for multiple version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_git_metadata_details_project(template, org, project, async_req=True)
        >>> result = thread.get()
        ...
        :param str org: Organization Identifier (required)
        :param str project: Project Identifier (required)
        :param list[TemplateUpdateGitMetadataRequest] body:
        :param str harness_account: Identifier field of the account the resource is scoped to.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_git_metadata_details_project_with_http_info(template, org, project, **kwargs)  # noqa: E501
        else:
            (data) = self.update_git_metadata_details_project_with_http_info(template, org, project, **kwargs)  # noqa: E501
            return data

    def update_git_metadata_details_project_with_http_info(self, template, org, project, **kwargs):  # noqa: E501
        """Update Git details  # noqa: E501

        Update Git details for multiple version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_git_metadata_details_project_with_http_info(template, org, project, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['template', 'org', 'project', 'body', 'harness_account']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_git_metadata_details_project" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'template' is set
        if ('template' not in params or
                params['template'] is None):
            raise ValueError("Missing the required parameter `template` when calling `update_git_metadata_details_project`")  # noqa: E501
        # verify the required parameter 'org' is set
        if ('org' not in params or
                params['org'] is None):
            raise ValueError("Missing the required parameter `org` when calling `update_git_metadata_details_project`")  # noqa: E501
        # verify the required parameter 'project' is set
        if ('project' not in params or
                params['project'] is None):
            raise ValueError("Missing the required parameter `project` when calling `update_git_metadata_details_project`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/orgs/{org}/projects/{project}/templates/git-metadata/{template}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
