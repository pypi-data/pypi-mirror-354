...
git config --global --add safe.directory /mnt/hgfs/SOURCE/python/ka_uts_dfr
git remote add ka_uts_dfr https://github.com/bs291048/ka_uts_dfr.git

# fatal: detected dubious ownership in repository at '/mnt/hgfs/SOURCE/python/ka_uts_uts'
# To add an exception for this directory, call:
git config --global --add safe.directory /mnt/hgfs/SOURCE/python/ka_uts_dic
