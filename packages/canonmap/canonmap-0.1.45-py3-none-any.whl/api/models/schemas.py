...
class MatchRequest(BaseModel):
    ...
    threshold: float = Field(0.0, description="Minimum score threshold for matches")
    field_filter: Optional[List[str]] = Field(None, description="List of field names to restrict matching to")
    user_semantic_search: bool = Field(False, description="Whether to enable semantic search")
