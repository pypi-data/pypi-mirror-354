...
class CanonMap:
    ...
    def match_entity(
        ...
        Args:
            ...
            canonical_entity_embeddings_path (Optional[str]): Path to the canonical_entity_embeddings.npz file (required if use_semantic_search=True)
            schema_path (Optional[str]): Path to the schema.pkl file (not used in matching)
        ...
        q_emb = None
        if use_semantic_search and canonical_entity_embeddings_path:
            try:
