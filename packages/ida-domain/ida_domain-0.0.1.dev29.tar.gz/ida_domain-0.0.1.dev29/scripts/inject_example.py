...
if os.path.exists('examples/traverse.py'):
    ...
    updated_content = readme_content.replace('<!-- TRAVERSE_EXAMPLE_PLACEHOLDER -->', traverse_content)
    print('Injected traverse.py content into README')
else:
    # Replace placeholder with error message
    updated_content = readme_content.replace('<!-- TRAVERSE_EXAMPLE_PLACEHOLDER -->', '# Example file not found')
