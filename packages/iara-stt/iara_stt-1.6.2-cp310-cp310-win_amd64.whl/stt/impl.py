...
class AcousticModelEmissions(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    num_symbols = property(_impl.AcousticModelEmissions_num_symbols_get, _impl.AcousticModelEmissions_num_symbols_set)
    symbols = property(_impl.AcousticModelEmissions_symbols_get, _impl.AcousticModelEmissions_symbols_set)
    num_timesteps = property(_impl.AcousticModelEmissions_num_timesteps_get, _impl.AcousticModelEmissions_num_timesteps_set)
    emissions = property(_impl.AcousticModelEmissions_emissions_get, _impl.AcousticModelEmissions_emissions_set)

    def __init__(self):
        _impl.AcousticModelEmissions_swiginit(self, _impl.new_AcousticModelEmissions())
    __swig_destroy__ = _impl.delete_AcousticModelEmissions

# Register AcousticModelEmissions in _impl:
_impl.AcousticModelEmissions_swigregister(AcousticModelEmissions)
...
class Metadata(object):
    ...
    emissions = property(_impl.Metadata_emissions_get)
...
def CreateModelFromBuffer(aModelBuffer, aBufferSize):
    return _impl.CreateModelFromBuffer(aModelBuffer, aBufferSize)
...
def EnableExternalScorerFromBuffer(aCtx, aScorerBuffer, aBufferSize):
    return _impl.EnableExternalScorerFromBuffer(aCtx, aScorerBuffer, aBufferSize)
...
def SpeechToTextWithEmissions(aCtx, aBuffer, aNumResults):
    return _impl.SpeechToTextWithEmissions(aCtx, aBuffer, aNumResults)
