...
from kozmoai_core.provider.standard_models.equity_screener import (
    EquityScreenerData,
...
from kozmoai_finviz.utils.screener_helper import (
    EXCHANGE_MAP,
    INDEX_MAP,
    INDUSTRY_MAP,
    MARKET_CAP_MAP,
...
class FinvizEquityScreenerQueryParams(EquityScreenerQueryParams):
    ...
    preset: Optional[str] = Field(
        ...
        + " Presets (.ini text files) can be created and modified in the '~/KozmoAIUserData/finviz/presets' directory."
    ...
    def validate_filters_dict(cls, v):
        ...
        if isinstance(v, str):
            ...
            try:
                ...
                raise KozmoAIError(f"Invalid JSON format for 'filters_dict': {e}") from e
