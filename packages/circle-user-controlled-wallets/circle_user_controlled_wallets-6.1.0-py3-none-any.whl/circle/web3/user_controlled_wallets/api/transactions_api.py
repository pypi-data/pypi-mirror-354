...
class TransactionsApi(object):
    ...
    @auto_fill
    @validate_arguments
    def create_user_transaction_cancel_challenge(self, x_user_token : Annotated[StrictStr, Field(..., description="Unique system generated JWT session token for specific user.")], id : Annotated[StrictStr, Field(..., description="The ID of the transaction to cancel.")], cancel_transaction_for_end_user_request : Annotated[CancelTransactionForEndUserRequest, Field(..., description="Cancel transaction for end user request")], **kwargs) -> CancelTransactionForEndUserResponse:  # noqa: E501
    ...
    @auto_fill
    @validate_arguments
    def create_user_transaction_cancel_challenge_with_http_info(self, x_user_token : Annotated[StrictStr, Field(..., description="Unique system generated JWT session token for specific user.")], id : Annotated[StrictStr, Field(..., description="The ID of the transaction to cancel.")], cancel_transaction_for_end_user_request : Annotated[CancelTransactionForEndUserRequest, Field(..., description="Cancel transaction for end user request")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create a challenge to cancel a transaction  # noqa: E501
