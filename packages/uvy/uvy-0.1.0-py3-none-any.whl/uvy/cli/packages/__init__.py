...
from uvy.cli.utils import CSVArgumentActionAction, enum_to_choices
...
def register_packages_command(subparsers: SubParsersType) -> None:
    ...
    parser.add_argument(
        ...
        "--format",
        type=OutputFormat,
        choices=enum_to_choices(OutputFormat),
    ...
    parser.add_argument(
        "--with-dependees",
        action="store_true",
        help="Include packages that are depended on by the listed packages.",
    )
