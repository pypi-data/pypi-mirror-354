...
class SemanticChunk(BaseModel):
    ...
    def to_flat_dict(self, for_redis: bool = False) -> dict:
        """
        Преобразует SemanticChunk в плоский словарь для записи в БД или Redis.
        Если for_redis=True — все значения сериализуются в строки, dict/list — в JSON, bool — 'true'/'false', None — '', Enum — str, datetime — ISO, created_at автозаполняется.
        """
