...
class ChunkMetadataBuilder:
    ...
    def flat_to_semantic(self, flat_chunk: Dict[str, Any]) -> SemanticChunk:
        ...
        block_meta = flat_dict_to_dict_prop(flat_chunk.get("block_meta", {}) or {}) if "block_meta" in flat_chunk else {}
        # Собираем все поля
    ...
    def semantic_to_flat(self, chunk: SemanticChunk) -> Dict[str, Any]:
        ...
        from chunk_metadata_adapter.utils import list_to_str, dict_prop_to_flat_dict
        d = chunk.model_dump()
        # tags: List[str] -> str
        ...
        if chunk.block_meta:
            d["block_meta"] = dict_prop_to_flat_dict(chunk.block_meta)
