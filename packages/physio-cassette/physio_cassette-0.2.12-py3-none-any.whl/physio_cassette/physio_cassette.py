...
from operator import add, sub, mul, truediv, lt, le, eq, ne, gt, ge
...
def parse_timestamp(timestamp:str, start_time:datetime) -> Union[datetime,None]:
    ...
    Returns:
        datetime: Parsed datetime, None if it cannot be parsed
    """
...
class XLSDictReader(object):
    ...
    """
    def __init__(self, filename:str, fieldnames:Union[list[str],None]=None, logfile:str=os.devnull) -> None:
...
class Signal:
    ...
    def sub(self, indexes:Union[slice,Iterable,None]=None, stop:Any=None, start:Any=None, step:Any=None, reset_start_time:bool=True):
        ...
        assert not np.issubdtype(type(indexes), np.integer), "Please refrain from calling sub on a single value, use your_signal[idx] instead"
    ...
    def sample_by_events(self, events:EventRecord, start_time:Union[datetime,None]=None, target_values:Any=None, window_length:Union[float, Tuple]=30, direction:str='both', ignore_first_event:bool=True) -> Iterator[Tuple[np.ndarray, Any, datetime, Tuple, Tuple]]:
    ...
    def __unary_op__(self:Signal, other:Union[int, float, np.ndarray, Signal], op:Callable, r:bool=False) -> Signal:
    ...
    def __get_overlap__(self:Signal, other:Signal) -> Tuple[Union[datetime,None], slice[int,int,Any], slice[int,int,Any]]:
...
class SignalFrame(DataHolder):
    ...
    @classmethod
    def from_edf_file(cls, record_filepath:str, signal_names:Union[str,list,None]=None):
    ...
    @classmethod
    def from_wfdb_record(cls, record_filepath:str, signal_names:Union[str,list,None]=None):
    ...
    @classmethod
    def from_mat_folder(cls, folder:str, signal_names:Union[str,list,None]=None, data_format:dict=MATLAB_DEFAULT_SIGNAL_FORMAT, time_format:str="%d/%m/%Y-%H:%M:%S"):
    ...
    def sample_by_events(self, labels:Union[str,list], events:EventRecord, start_time:Union[datetime,None]=None, target_values:Any=None, window_length:Union[float, Tuple]=30, direction:str='both', ignore_first_event:bool=True) -> Iterator[Tuple[MappingProxyType, Any, datetime, Tuple, Tuple]]:
...
class EventRecord:
    ...
    def __getitem__(self, indexes):
        ...
        if all([x is None for x in [indexes.start,indexes.stop,indexes.step]]):
            return self
    ...
    @classmethod
    def from_state_array(cls, label:str, t0:datetime, input_array:Iterable, ts_array:Union[Iterable,None]=None, ts_sampling:float=1.0, start_value:Any=None, compact:bool=False):
    ...
    @classmethod
    def from_ts_dur_array(cls, label:str, t0:datetime, ts_array:Union[list, np.ndarray], duration_array:Union[list, np.ndarray, None]=None, is_binary:bool=False, is_spikes:bool=False, start_value:Any=None):
    ...
    @classmethod
    def from_csv(cls, record_filepath:str, label:str, event_column:str, t0:datetime, start_value:Any=None, ts_column:Union[str,None]=None, ts_is_datetime:bool=True, ts_sampling:float=0,  delimiter:str=',', skiprows:int=0, **kwargs):
    ...
    def from_flat_file(cls, record_filepath:str, label:str, parser:Callable, t0:datetime, start_value:Any=None, default_value:Any=None, ts_is_datetime:bool=True, ts_sampling:float=1.0, skiprows:int=0,):
        ...
        is_spikes = is_binary and (not has_duration) and len(unique_states)==1

        return cls(label=label, start_time=t0, data=data, is_binary=is_binary, is_spikes=is_spikes, start_value=start_value)

    @classmethod
    def _get_xml_value(cls, element:dict, event_key:str, default_value:Union[int,None]=None, value_function:Union[Callable,None]=None):
        value = None
    ...
    @classmethod
    def from_xml(cls, record_filepath:str, label:str, event_key:str, target_values:Union[str,list], ts_key:str, t0:datetime, start_value:Any=None, value_function:Union[Callable,None]=None, duration_key:Union[str,None]=None, events_path:list=[], ts_is_datetime:bool=True, ts_sampling:float=1.0):
    ...
    @classmethod
    def from_wfdb_annotation(cls, record_filepath:str, label:str, target_values:Union[str,list], t0:datetime, start_value:Any=None, extension:str='ann', openclose:Union[Tuple,None]=None):
    ...
    def state_frequency(self, sampling_period:Union[float,None]=None) -> Union[Any,Signal]:
...
class EventFrame(DataHolder):
    ...
    @classmethod
    def from_csv(cls, record_filepath:str, labels: Iterable, event_column: str, ts_column:str, duration_column:Union[str,None]=None, start_time:datetime=datetime.fromtimestamp(0), ts_is_datetime:bool=False, duration_modifier:Callable=None, delimiter:str=',', skiprows:int=0, **kwargs):
    ...
    @classmethod
    def from_xml(cls, record_filepath:str, event_key:str, target_values:dict, ts_key:str, t0:datetime, start_value:Any=None, value_function:Union[Callable,None]=None, duration_key:Union[str,None]=None, events_path:list=[], ts_is_datetime:bool=True, ts_sampling:float=1.0):
    ...
    @classmethod
    def from_wfdb_annotation(cls, record_filepath:str, target_values:dict, t0:datetime, start_value:Any=None, extension:str='ann', openclose:Union[Tuple,None]=None):
    ...
    def merged_data(self, label:str='merged events', labels:Union[List[str],None]=None, as_signal:bool=False, sampling_period:float=1.0) -> Union[EventRecord, Signal]:
...
def autocache(func:Callable, cache_folder:str, filename:str, cache_format:str='pickle', force:bool=False, ignore_kwargs:Union[List[str],None]=None) -> Any:
    ...
    # Code hasher
    def hash(source:str, vars_data:dict, args_data:Any, kwargs_data:Any, ignore_kwargs:Union[List[str],None]=None) -> str:
