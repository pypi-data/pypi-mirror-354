def paylix_test_sdk(self, components=[]):
    if not components:
        return
    try:
        ...
        if "payments" in components:
            ...
            payment_no_white_label = self.create_payment(title="Paylix Payment",
                                                         value=1.5,
                                                         currency="EUR",
                                                         quantity=5,
            ...
            payment_white_label = self.create_payment(title="Paylix Payment",
                                                      value=1.5,
                                                      currency="EUR",
                                                      quantity=5,
                                                      email="no-reply@paylix.gg",
    ...
    except self.PaylixException as e:
        print(e)
