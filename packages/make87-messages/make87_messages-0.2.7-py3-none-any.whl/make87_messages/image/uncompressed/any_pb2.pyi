...
class ImageYUVAny(_message.Message):
    __slots__ = ["header", "yuv420", "yuv422", "yuv444"]
    HEADER_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., yuv420: _Optional[_Union[_image_yuv420_pb2.ImageYUV420, _Mapping]] = ..., yuv422: _Optional[_Union[_image_yuv422_pb2.ImageYUV422, _Mapping]] = ..., yuv444: _Optional[_Union[_image_yuv444_pb2.ImageYUV444, _Mapping]] = ...) -> None: ...

class ImageRawAny(_message.Message):
    __slots__ = ["header", "rgb888", "rgba8888", "yuv420", "yuv422", "yuv444"]
    HEADER_FIELD_NUMBER: _ClassVar[int]
    RGB888_FIELD_NUMBER: _ClassVar[int]
    RGBA8888_FIELD_NUMBER: _ClassVar[int]
    YUV420_FIELD_NUMBER: _ClassVar[int]
    ...
    yuv422: _image_yuv422_pb2.ImageYUV422
    yuv444: _image_yuv444_pb2.ImageYUV444
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., rgb888: _Optional[_Union[_image_rgb888_pb2.ImageRGB888, _Mapping]] = ..., rgba8888: _Optional[_Union[_image_rgba8888_pb2.ImageRGBA8888, _Mapping]] = ..., yuv420: _Optional[_Union[_image_yuv420_pb2.ImageYUV420, _Mapping]] = ..., yuv422: _Optional[_Union[_image_yuv422_pb2.ImageYUV422, _Mapping]] = ..., yuv444: _Optional[_Union[_image_yuv444_pb2.ImageYUV444, _Mapping]] = ...) -> None: ...
