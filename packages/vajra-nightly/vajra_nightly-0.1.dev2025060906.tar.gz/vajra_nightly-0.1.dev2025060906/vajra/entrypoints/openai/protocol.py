...
class ErrorResponse(OpenAIBaseModel):
    ...
    Represents an error that occurred during API request processing.
    This format ensures compatibility with OpenAI API clients.

    Attributes:
        object: Always "error" to identify this as an error response.
...
class UsageInfo(OpenAIBaseModel):
    ...
    Tracks the number of tokens consumed during request processing,
    compatible with OpenAI's usage reporting format.
