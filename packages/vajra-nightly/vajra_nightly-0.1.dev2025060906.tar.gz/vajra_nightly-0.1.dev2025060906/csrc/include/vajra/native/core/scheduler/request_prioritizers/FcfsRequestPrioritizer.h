...
class SequenceWithFcfsPriority : public BaseSequenceWithPriority {
 public:
  explicit SequenceWithFcfsPriority(MutableSequencePtr seq)
...
//==============================================================================
class FcfsRequestPrioritizer : public BaseRequestPrioritizer {
 public:
  [[nodiscard]] MutableBaseSequenceWithPriorityPtr GetSeqWithPriority(
      MutableSequencePtr seq) override {
    return std::make_shared<SequenceWithFcfsPriority>(seq);
  }
};
//==============================================================================
}  // namespace vajra
