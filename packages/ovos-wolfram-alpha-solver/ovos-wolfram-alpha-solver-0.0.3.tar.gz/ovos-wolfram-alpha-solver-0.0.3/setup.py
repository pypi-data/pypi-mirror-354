...
URL="https://github.com/OpenVoiceOS/ovos-wolfram-alpha-solver"
PKG_NAME = URL.split("/")[-1]
IMPORT_NAME = PKG_NAME.replace("-", "_")

PERSONA_ENTRY_POINT = f'Wolfram Alpha={IMPORT_NAME}:WOLFRAMALPHA_PERSONA'
SOLVER_ENTRY_POINT = f'ovos-solver-plugin-wolfram-alpha={IMPORT_NAME}:WolframAlphaSolver'
