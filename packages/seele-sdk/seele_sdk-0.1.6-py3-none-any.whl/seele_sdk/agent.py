...
class AgentSDK:
    ...
    def call_mcp_server(
        self, server_name: str, method: str, args: Dict[str, Any]
    ) -> Any:
        ...
        try:
            ...
            self.logger.error(f"Call mcp server failed: {e}")
            raise
...
class AgentContext:
    ...
    def __enter__(self):
        ...
        if "id" not in self.agent_info:
            ...
            print(f"create_memory_agent: {ins}")
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        """Exit context."""
        if "id" not in self.agent_info:
            print(f"destroy_memory_agent: {self.sdk.agent_id}")
