...
class NGFFMetadataHandler:
    ...
    def add_channel(self,
        ...
        channel = {
            ...
            'window': window or {'min': 0.0, 'max': 65535.0, 'start': 0.0, 'end': 65535.0},
            'family': 'linear',
            'inverted': False
        }
    ...
    # def get_scale(self, path: Union[str, int]) -> Optional[List[float]]:
    #     """Get scale for a specific dataset."""
    #     dataset = self._get_dataset(str(path))
    #     if dataset:
    #         for transform in dataset['coordinateTransformations']:
    ...
    # def get_translation(self, path: Union[str, int]) -> Optional[List[float]]:
    #     """Get translation for a specific dataset."""
    #     dataset = self._get_dataset(str(path))
    #     if dataset:
    #         for transform in dataset['coordinateTransformations']:
