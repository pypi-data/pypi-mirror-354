...
def write_with_zarrpy(arr: da.Array,
    ...
    # if isinstance(shard_to_chunk_ratio, int):
    #     shard_to_chunk_ratio = [shard_to_chunk_ratio] * arr.ndim
    #
    # assert len(shard_to_chunk_ratio) == len(chunks)
    ...
    # print("Converting to dask array")
    # res = res.map_blocks(da.asarray)
    return res
...
def store_arrays(arrays: Dict[str, Dict[str, da.Array]], # flatarrays
    ...
    # pprint.pprint(f"store_arrays{kwargs}")
