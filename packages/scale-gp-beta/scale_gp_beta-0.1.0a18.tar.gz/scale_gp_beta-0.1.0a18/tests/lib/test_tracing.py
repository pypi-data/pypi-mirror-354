...
class TestCreateTrace:
    ...
    def test_create_trace_when_disabled(
        ...
        mock_noop_trace_init.assert_called_once_with(name=trace_name_arg, trace_id=trace_id_arg, root_span_id=None, metadata=None)
    ...
    def test_create_trace_when_enabled(
        ...
        mock_trace_init.assert_called_once_with(
            name=trace_name_arg, trace_id=trace_id_arg, queue_manager=mock_queue_manager_instance, metadata=None
        )
...
class TestCreateSpan:
    ...
    def test_create_span_when_disabled(
        ...
        span = create_span(name=span_name, span_id=span_id_arg, trace=mock_parent_trace)
    ...
    def test_create_span_no_parent_no_active_trace(
        ...
        with caplog.at_level(logging.DEBUG):
            span = create_span(name=span_name, span_id=span_id_arg)
    ...
    def test_create_span_with_explicit_span_parent(
        ...
        create_span(name=span_name, parent_span=mock_parent_s)
