...
class TestBaseTrace:
    def test_initialization_defaults(self, mock_queue_manager: Mock, patched_trace_utils: Dict[str, Mock]) -> None:
        trace = BaseTrace(queue_manager=mock_queue_manager)
    ...
    def test_initialization_with_custom_trace_id(self, mock_queue_manager: Mock) -> None:
        ...
        trace = BaseTrace(queue_manager=mock_queue_manager, trace_id=custom_id)
...
class TestTrace:
    def test_initialization(self, mock_queue_manager: Mock, patched_trace_utils: Dict[str, Mock]) -> None:
        trace = Trace(queue_manager=mock_queue_manager, trace_id="op-trace-id", name="op-trace-name", root_span_id="root-span-id")
    ...
    def test_start(
        ...
        trace = Trace(queue_manager=mock_queue_manager, trace_id="start-test-trace", name="start-test-trace", root_span_id="root-span-id")
        trace.start()
    ...
    def test_start_idempotency(
        ...
        trace = Trace(queue_manager=mock_queue_manager, trace_id="idem-start-trace", name="idem-start-trace", root_span_id="root-span-id")
        trace.start()
    ...
    def test_end_normal_flow(
        ...
        trace = Trace(queue_manager=mock_queue_manager, trace_id="end-test-trace", name="end-test-trace", root_span_id="root-span-id")
        trace.start()
    ...
    def test_end_when_not_in_progress(
        ...
        trace = Trace(queue_manager=mock_queue_manager, trace_id="not-active-trace", name="not-active-trace", root_span_id="root-span-id")
    ...
    def test_end_when_token_is_none(
        ...
        trace = Trace(queue_manager=mock_queue_manager, trace_id="no-token-trace", name="no-token-trace", root_span_id="root-span-id")
    ...
    def test_context_manager_operational_trace(
        ...
        trace = Trace(queue_manager=mock_queue_manager, trace_id="ctx-op-trace", name="ctx-op-trace", root_span_id="root-span-id")
        expected_token = mock_scope_set_current_trace.return_value
        expected_span_token = mock_scope_set_current_span.return_value
