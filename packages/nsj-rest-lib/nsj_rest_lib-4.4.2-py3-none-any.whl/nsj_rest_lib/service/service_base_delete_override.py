...
#         only_pk: bool = False,
#     ) -> DTOBase:
#         # Check if DTO has override data config
#         override_data = (
...
#         else:
#             aux_fields = [self._dto_class.pk_field]
#             if override_data:
#                 aux_fields.extend(self._dto_class.data_override_group)
#                 aux_fields.extend(self._dto_class.data_override_fields)

#             fields = self._resolving_fields({"root": set(aux_fields)})
...
#         # RETORNO
#         ## Retornando só a PK, se for o desejado
#         if only_pk:
#             if not override_data:
#                 pk = getattr(entity, self._entity_class.pk_field)
#             else:
#                 list_dicts = self._group_by_override_data(entity)
...
#                 pk = getattr(list_dicts[0], self._entity_class.pk_field)
...
#         if override_data:
#             id = self.get(id, additional_filters, None, only_pk=True)
