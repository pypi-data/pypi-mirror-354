 ...
 */
#ifndef MINDSPORE_CORE_OPS_VIEW_SLICE_STRIDES_EXT_CALC_H
#define MINDSPORE_CORE_OPS_VIEW_SLICE_STRIDES_EXT_CALC_H
...
#endif  // MINDSPORE_CORE_OPS_VIEW_SLICE_STRIDES_EXT_CALC_H
