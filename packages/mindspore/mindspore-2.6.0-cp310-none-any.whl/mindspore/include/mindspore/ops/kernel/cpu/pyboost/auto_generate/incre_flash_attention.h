...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_INCREFLASHATTENTION_CPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_INCREFLASHATTENTION_CPU_H_
...
namespace kernel {
namespace pyboost {
class IncreFlashAttentionCPU : public pyboost::IncreFlashAttention {
 public:
  IncreFlashAttentionCPU(PrimitivePtr primitive, const DeviceContext *device_context)
    : IncreFlashAttention(std::move(primitive), device_context) {}
  ~IncreFlashAttentionCPU() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_INCREFLASHATTENTION_CPU_H_
