...
class OPS_ASCEND_API RandpermExtAscend : public pyboost::RandpermExt {
 public:
  ...
  mindspore::tensor::BaseTensorPtr Call(const mindspore::Int64ImmPtr &n, const mindspore::tensor::BaseTensorPtr &seed_tensor, const mindspore::tensor::BaseTensorPtr &offset_tensor, const mindspore::Int64ImmPtr &dtype) override;
};
}  // namespace pyboost
}  // namespace kernel
}  // namespace mindspore
