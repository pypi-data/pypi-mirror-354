...
class PYBOOST_API NLLLossGrad : public pyboost::OpRunner {
 public:
  ...
  virtual mindspore::tensor::BaseTensorPtr Call(const mindspore::tensor::BaseTensorPtr &logits_tensor, const mindspore::tensor::BaseTensorPtr &loss_grad_tensor, const mindspore::tensor::BaseTensorPtr &labels_tensor, const mindspore::tensor::BaseTensorPtr &weight_tensor, const mindspore::tensor::BaseTensorPtr &total_weight_tensor, const mindspore::Int64ImmPtr &reduction, const mindspore::Int64ImmPtr &ignore_index) = 0;
