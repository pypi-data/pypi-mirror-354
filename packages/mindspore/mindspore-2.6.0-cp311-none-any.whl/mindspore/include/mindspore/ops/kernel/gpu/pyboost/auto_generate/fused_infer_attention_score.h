...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_FUSEDINFERATTENTIONSCORE_GPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_FUSEDINFERATTENTIONSCORE_GPU_H_
...
namespace kernel {
namespace pyboost {
class FusedInferAttentionScoreGPU : public pyboost::FusedInferAttentionScore {
 public:
  FusedInferAttentionScoreGPU(PrimitivePtr primitive, const DeviceContext *device_context)
    : FusedInferAttentionScore(std::move(primitive), device_context) {}
  ~FusedInferAttentionScoreGPU() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_FUSEDINFERATTENTIONSCORE_GPU_H_
