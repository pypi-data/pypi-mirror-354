...
class PYBOOST_API BatchNormElemtGrad : public pyboost::OpRunner {
 public:
  ...
  virtual mindspore::tensor::BaseTensorPtr Call(const mindspore::tensor::BaseTensorPtr &dout_tensor, const mindspore::tensor::BaseTensorPtr &input_tensor, const mindspore::tensor::BaseTensorPtr &mean_tensor, const mindspore::tensor::BaseTensorPtr &invstd_tensor, const mindspore::tensor::BaseTensorPtr &weight_tensor, const mindspore::tensor::BaseTensorPtr &sumd_dy_tensor, const mindspore::tensor::BaseTensorPtr &sum_dy_xmu_tensor, const mindspore::tensor::BaseTensorPtr &count_tensor) = 0;
