...
#include "plugin/res_manager/ascend/op_adapter/custom_op_proto/cust_other_ops.h"
#include "plugin/res_manager/ascend/op_adapter/custom_op_proto/flash_attention.h"
