...
namespace mindspore {
namespace opt {
class MatMulAllReduceAddRmsNormBaseFusionForGe : public PatternProcessPass {
 public:
  explicit MatMulAllReduceAddRmsNormBaseFusionForGe(const string &name, bool multigraph = true)
  ...
  ~MatMulAllReduceAddRmsNormBaseFusionForGe() override = default;
...
class MatMulAllReduceAddRmsNormFusionForGe : public MatMulAllReduceAddRmsNormBaseFusionForGe {
 public:
  MatMulAllReduceAddRmsNormFusionForGe()
      : MatMulAllReduceAddRmsNormBaseFusionForGe("MatMulAllReduceAddRmsNormForGe", true) {}
  ~MatMulAllReduceAddRmsNormFusionForGe() override = default;
