...
#include "mindspore/ccsrc/pyboost/auto_generate/matmul_reduce_scatter.h"
#include "ir/tensor.h"
#include "ir/scalar.h"
...
class OPS_ASCEND_API MatmulReduceScatterAscend : public pyboost::MatmulReduceScatter {
 public:
  ...
  mindspore::tensor::BaseTensorPtr Call(const mindspore::tensor::BaseTensorPtr &input_tensor, const mindspore::tensor::BaseTensorPtr &x2_tensor, const mindspore::StringImmPtr &group, const mindspore::Int64ImmPtr &world_size, const mindspore::Int64ImmPtr &reduce_op, const std::optional<mindspore::tensor::BaseTensorPtr> &bias_tensor, const mindspore::Int64ImmPtr &comm_turn, const mindspore::BoolImmPtr &trans_input, const mindspore::BoolImmPtr &trans_x2) override;
};
}  // namespace pyboost
}  // namespace kernel
}  // namespace mindspore
