 ...
 */
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CONVOLUTION_STR_ACLNN_KERNEL_MOD_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CONVOLUTION_STR_ACLNN_KERNEL_MOD_H_
#include <vector>
#include <utility>
#include <memory>
...
class ConvolutionStrAscend : public AclnnKernelMod {
 public:
  ConvolutionStrAscend() : AclnnKernelMod(std::move("aclnnConvolution")) {}
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CONVOLUTION_STR_ACLNN_KERNEL_MOD_H_
