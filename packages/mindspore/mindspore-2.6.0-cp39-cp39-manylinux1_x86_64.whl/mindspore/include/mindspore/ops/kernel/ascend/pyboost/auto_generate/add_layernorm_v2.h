...
class OPS_ASCEND_API AddLayerNormV2Ascend : public pyboost::AddLayerNormV2 {
 public:
  ...
  std::tuple<mindspore::tensor::BaseTensorPtr,mindspore::tensor::BaseTensorPtr,mindspore::tensor::BaseTensorPtr,mindspore::tensor::BaseTensorPtr> Call(const mindspore::tensor::BaseTensorPtr &x1_tensor, const mindspore::tensor::BaseTensorPtr &x2_tensor, const mindspore::tensor::BaseTensorPtr &gamma_tensor, const mindspore::tensor::BaseTensorPtr &beta_tensor, const mindspore::FP32ImmPtr &epsilon, const mindspore::BoolImmPtr &additionalOut) override;
};
}  // namespace pyboost
}  // namespace kernel
}  // namespace mindspore
