...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_GROUPEDMATMULV4_ASCEND_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_GROUPEDMATMULV4_ASCEND_H_
...
namespace kernel {
namespace pyboost {
class OPS_ASCEND_API GroupedMatmulV4Ascend : public pyboost::GroupedMatmulV4 {
 public:
  GroupedMatmulV4Ascend(PrimitivePtr primitive, const DeviceContext *device_context)
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_GROUPEDMATMULV4_ASCEND_H_
