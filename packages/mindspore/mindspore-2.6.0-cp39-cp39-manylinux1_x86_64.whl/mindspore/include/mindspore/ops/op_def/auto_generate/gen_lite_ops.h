...
class OPS_API EmbeddingApplyRmsprop : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(EmbeddingApplyRmsprop);
...
class OPS_API PromptKVCache : public BaseOperator {
 public:
...
class OPS_API EmbeddingFeatureMappingExport : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(EmbeddingFeatureMappingExport);
...
class OPS_API EmbeddingTableEvict : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(EmbeddingTableEvict);
  EmbeddingTableEvict();
...
class OPS_API EmbeddingFeatureMappingFileSize : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(EmbeddingFeatureMappingFileSize);
...
class OPS_API EmbeddingFeatureMappingImport : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(EmbeddingFeatureMappingImport);
...
class OPS_API EmbeddingApplySgd : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(EmbeddingApplySgd);
  EmbeddingApplySgd();
...
class OPS_API DecoderKVCache : public BaseOperator {
 public:
...
class OPS_API EmbeddingFeatureMappingFind : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(EmbeddingFeatureMappingFind);
...
class OPS_API EmbeddingFeatureMappingV2 : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(EmbeddingFeatureMappingV2);
...
class OPS_API EmbeddingFeatureMappingTableSize : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(EmbeddingFeatureMappingTableSize);
  EmbeddingFeatureMappingTableSize();

};

class OPS_API EmbeddingFeatureMappingInsert : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(EmbeddingFeatureMappingInsert);
