 ...
 */
#ifndef MINDSPORE_CORE_OP_NAME_P_H_
#define MINDSPORE_CORE_OP_NAME_P_H_
...
constexpr auto kNamePowTensorScalar = "PowTensorScalar";
constexpr auto kNamePow = "Pow";
constexpr auto kNamePowScalarTensor = "PowScalarTensor";
constexpr auto kNamePixelShuffle = "PixelShuffle";
}  // namespace mindspore::ops

#endif  // MINDSPORE_CORE_OP_NAME_P_H_
