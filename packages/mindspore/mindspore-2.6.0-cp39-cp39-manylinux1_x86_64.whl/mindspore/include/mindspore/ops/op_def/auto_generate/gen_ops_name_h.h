 ...
 */
#ifndef MINDSPORE_CORE_OP_NAME_H_H_
#define MINDSPORE_CORE_OP_NAME_H_H_

namespace mindspore::ops {
constexpr auto kNameHardtanh = "Hardtanh";
constexpr auto kNameHSwishGrad = "HSwishGrad";
constexpr auto kNameHardtanhGrad = "HardtanhGrad";
