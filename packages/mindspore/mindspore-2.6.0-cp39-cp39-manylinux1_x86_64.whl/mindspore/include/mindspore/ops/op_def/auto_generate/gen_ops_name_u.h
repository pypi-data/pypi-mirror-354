 ...
 */
#ifndef MINDSPORE_CORE_OP_NAME_U_H_
#define MINDSPORE_CORE_OP_NAME_U_H_

namespace mindspore::ops {
constexpr auto kNameUpsampleBicubic2D = "UpsampleBicubic2D";
...
constexpr auto kNameUniqueDim = "UniqueDim";
...
constexpr auto kNameUnique2 = "Unique2";
constexpr auto kNameUnstackExtView = "UnstackExtView";
constexpr auto kNameUniformExt = "UniformExt";
constexpr auto kNameUpsampleNearest2D = "UpsampleNearest2D";
constexpr auto kNameUpsampleBicubic2DGrad = "UpsampleBicubic2DGrad";
...
#endif  // MINDSPORE_CORE_OP_NAME_U_H_
