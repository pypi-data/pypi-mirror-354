...
#include "plugin/res_manager/ascend/op_adapter/custom_op_proto/cust_array_ops.h"
...
DECLARE_CUST_OP_ADAPTER(TopKRouter)
DECLARE_CUST_OP_USE_OUTPUT(TopKRouter)
...
DECLARE_CUST_OP_ADAPTER(GenerateEodMaskV2)
DECLARE_CUST_OP_USE_OUTPUT(GenerateEodMaskV2)
