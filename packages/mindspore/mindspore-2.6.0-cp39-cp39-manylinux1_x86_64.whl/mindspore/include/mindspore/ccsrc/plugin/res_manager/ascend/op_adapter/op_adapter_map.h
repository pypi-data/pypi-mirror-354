...
constexpr const char kNameAlltoAllVGE[] = "AlltoAllVGE";
...
constexpr const char kNamePowScalarTensor[] = "PowScalarTensor";
constexpr const char kNamePowTensorScalar[] = "PowTensorScalar";
...
constexpr const char kNameLogicalXor[] = "LogicalXor";
...
constexpr const char kNameDropout3D[] = "Dropout3D";
constexpr const char kNameChannelShuffle[] = "ChannelShuffle";
...
constexpr const char kNameGroupNormSilu[] = "GroupNormSilu";
constexpr const char kNameKVCacheMgr[] = "KVCacheMgr";
constexpr const char kNamePromptKVCache[] = "PromptKVCache";
constexpr const char kNameDecoderKVCache[] = "DecoderKVCache";
...
constexpr const char kNameSparseTensorDenseMatmul[] = "SparseTensorDenseMatmul";
...
constexpr const char kNameTransQuantParamV2[] = "TransQuantParamV2";
...
constexpr const char kNameSearchSorted[] = "SearchSorted";
...
constexpr const char kNameGridSampler2DGrad[] = "GridSampler2DGrad";
...
constexpr const char kNameApplyCamePart1[] = "ApplyCamePart1";
constexpr const char kNameApplyCamePart2[] = "ApplyCamePart2";
