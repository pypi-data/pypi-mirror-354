...
constexpr size_t SLICE_DIM_INDEX = 1;
constexpr size_t SLICE_START_INDEX = 2;
constexpr size_t SLICE_END_INDEX = 3;
constexpr size_t SLICE_STEP_INDEX = 4;
constexpr size_t SLICE_EXT_INPUTS_SIZE = 5;
...
constexpr size_t SIZE_THIRTY_TWO = 32;
...
constexpr int64_t INT64_ZERO = 0;
constexpr int64_t INT64_THREE = 3;
constexpr int64_t INT64_EIGHT = 8;
constexpr int64_t INT64_TEN = 10;
constexpr double FACTOR_TWO = 2.0;
constexpr float COST_MODEL_DEFAULT_STRATEGY = 1.0f;
constexpr double COST_MODEL_NO_COST = 0.0;
constexpr int64_t REC_NODE_DIMS_SIZE = 4;
constexpr size_t MAX_NUM_DEVICES = 1024;
...
constexpr char INPUT_TENSOR_MAP[] = "input_tensor_map";
...
constexpr char STEP_ADDATTR_END[] = "step_addattr_end";
...
constexpr char SPLIT_OUTPUT_INDEX[] = "SPLIT_OUTPUT_INDEX";
constexpr char SPLIT_INSERT_LATER[] = "SPLIT_INSERT_LATER";
...
constexpr char DTYPETOENUM[] = "_dtype_to_enum";
...
constexpr char PAD_UPPER[] = "PAD";
constexpr char SAME_UPPER[] = "SAME";
constexpr char VALID_UPPER[] = "VALID";
constexpr char CALCULATED_UPPER[] = "CALCULATED";  // means pad mode for maxpool3d
...
constexpr char RING_ATTENTION_UPDATE_MUL[] = "RING_ATTENTION_UPDATE_MUL";
constexpr char RING_ATTENTION_UPDATE_MAX[] = "RING_ATTENTION_UPDATE_MAX";
constexpr char RING_ATTENTION_UPDATE_SUM[] = "RING_ATTENTION_UPDATE_SUM";
...
constexpr char MAXPOOL_3D[] = "MaxPool3D";
constexpr char AVGPOOL_3D[] = "AvgPool3D";
...
constexpr char SCALAR_MAX[] = "ScalarMax";
constexpr char SCALAR_MIN[] = "ScalarMin";
...
constexpr char LAYER_NORM_V3[] = "LayerNormV3";
...
constexpr char SLICE_EXT[] = "SliceExt";
constexpr char UNIFORM_REAL[] = "UniformReal";
constexpr char STANDARD_NORMAL[] = "StandardNormal";
...
constexpr char INDEX_SELECT[] = "IndexSelect";
constexpr char CLAMP_SCALAR[] = "ClampScalar";
...
constexpr char SEGMENT[] = "segment";
constexpr char SEGMENT_MAX[] = "segment_max";
constexpr char BACKWARD_MICRO_END[] = "backward_micro_end";
