...
class PYBOOST_API RmsNorm : public pyboost::OpRunner {
 public:
  ...
  virtual std::tuple<mindspore::tensor::BaseTensorPtr,mindspore::tensor::BaseTensorPtr> Call(const mindspore::tensor::BaseTensorPtr &x_tensor, const mindspore::tensor::BaseTensorPtr &gamma_tensor, const mindspore::FP32ImmPtr &epsilon) = 0;
