...
class PYBOOST_API MultiScaleDeformableAttnGrad : public pyboost::OpRunner {
 public:
  ...
  virtual std::tuple<mindspore::tensor::BaseTensorPtr,mindspore::tensor::BaseTensorPtr,mindspore::tensor::BaseTensorPtr> Call(const mindspore::tensor::BaseTensorPtr &value_tensor, const mindspore::tensor::BaseTensorPtr &shape_tensor, const mindspore::tensor::BaseTensorPtr &offset_tensor, const mindspore::tensor::BaseTensorPtr &locations_trans_tensor, const mindspore::tensor::BaseTensorPtr &weight_tensor, const mindspore::tensor::BaseTensorPtr &grad_output_tensor) = 0;
