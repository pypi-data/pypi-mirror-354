...
class PYBOOST_API LogSoftmaxExt : public pyboost::OpRunner {
 public:
  ...
  virtual mindspore::tensor::BaseTensorPtr Call(const mindspore::tensor::BaseTensorPtr &input_tensor, const std::optional<mindspore::Int64ImmPtr> &dim, const std::optional<mindspore::Int64ImmPtr> &dtype) = 0;
