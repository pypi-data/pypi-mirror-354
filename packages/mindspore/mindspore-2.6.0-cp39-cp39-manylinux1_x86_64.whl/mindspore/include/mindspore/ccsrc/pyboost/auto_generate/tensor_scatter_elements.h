...
class PYBOOST_API TensorScatterElements : public pyboost::OpRunner {
 public:
  ...
  virtual mindspore::tensor::BaseTensorPtr Call(const mindspore::tensor::BaseTensorPtr &data_tensor, const mindspore::tensor::BaseTensorPtr &indices_tensor, const mindspore::tensor::BaseTensorPtr &updates_tensor, const mindspore::Int64ImmPtr &axis, const mindspore::Int64ImmPtr &reduce) = 0;
