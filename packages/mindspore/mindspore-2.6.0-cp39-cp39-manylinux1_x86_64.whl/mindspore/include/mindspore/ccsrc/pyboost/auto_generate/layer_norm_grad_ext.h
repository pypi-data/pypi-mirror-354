...
class PYBOOST_API LayerNormGradExt : public pyboost::OpRunner {
 public:
  ...
  virtual std::tuple<mindspore::tensor::BaseTensorPtr,mindspore::tensor::BaseTensorPtr,mindspore::tensor::BaseTensorPtr> Call(const mindspore::tensor::BaseTensorPtr &dy_tensor, const mindspore::tensor::BaseTensorPtr &x_tensor, const mindspore::ValueTuplePtr &normalized_shape, const mindspore::tensor::BaseTensorPtr &mean_tensor, const mindspore::tensor::BaseTensorPtr &variance_tensor, const mindspore::tensor::BaseTensorPtr &gamma_tensor, const mindspore::tensor::BaseTensorPtr &beta_tensor, const mindspore::ValueTuplePtr &output_mask) = 0;
