...
class PYBOOST_API MatmulAllReduceAddRmsNorm : public pyboost::OpRunner {
 public:
  ...
  virtual std::tuple<mindspore::tensor::BaseTensorPtr,mindspore::tensor::BaseTensorPtr> Call(const mindspore::tensor::BaseTensorPtr &x1_tensor, const mindspore::tensor::BaseTensorPtr &x2_tensor, const mindspore::tensor::BaseTensorPtr &bias_tensor, const mindspore::tensor::BaseTensorPtr &residual_tensor, const mindspore::tensor::BaseTensorPtr &gamma_tensor, const mindspore::FP32ImmPtr &epsilon, const mindspore::StringImmPtr &group, const mindspore::Int64ImmPtr &reduce_op, const mindspore::Int64ImmPtr &comm_turn, const mindspore::Int64ImmPtr &stream_mode) = 0;
