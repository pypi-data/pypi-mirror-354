...
#ifndef MINDSPORE_CCSRC_PIPELINE_JIT_PS_PASS_CONFIG_H_
#define MINDSPORE_CCSRC_PIPELINE_JIT_PS_PASS_CONFIG_H_
...
#endif  // MINDSPORE_CCSRC_PIPELINE_JIT_PS_PASS_CONFIG_H_
