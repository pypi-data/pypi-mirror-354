...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_CUSTOMIZE_SOFTSHRINKGRAD_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_CUSTOMIZE_SOFTSHRINKGRAD_H_
#include <vector>
#include <memory>
#include "ir/tensor.h"
#include "ir/value.h"
