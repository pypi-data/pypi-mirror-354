 ...
 */
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CONV3D_PADDING_ACLNN_KERNEL_MOD_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CONV3D_PADDING_ACLNN_KERNEL_MOD_H_
#include <vector>
#include <utility>
#include <memory>
...
namespace mindspore {
namespace kernel {
namespace conv3d_padding {

class Conv3DPaddingAscend : public AclnnKernelMod {
 public:
  Conv3DPaddingAscend() : AclnnKernelMod(std::move("aclnnConvolution")) {}
 ...
 private:
  ...
  std::vector<int64_t> pad_vector_ = {0, 0, 0};
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CONV3D_PADDING_ACLNN_KERNEL_MOD_H_
