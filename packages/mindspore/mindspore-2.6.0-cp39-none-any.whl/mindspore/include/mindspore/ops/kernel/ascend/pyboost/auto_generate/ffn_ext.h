...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_FFNEXT_ASCEND_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_FFNEXT_ASCEND_H_
...
namespace kernel {
namespace pyboost {
class OPS_ASCEND_API FFNExtAscend : public pyboost::FFNExt {
 public:
  FFNExtAscend(PrimitivePtr primitive, const DeviceContext *device_context)
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_FFNEXT_ASCEND_H_
