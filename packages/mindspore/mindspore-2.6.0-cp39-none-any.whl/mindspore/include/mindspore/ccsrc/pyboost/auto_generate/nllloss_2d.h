...
class PYBOOST_API NLLLoss2d : public pyboost::OpRunner {
 public:
  ...
  virtual std::tuple<mindspore::tensor::BaseTensorPtr,mindspore::tensor::BaseTensorPtr> Call(const mindspore::tensor::BaseTensorPtr &input_tensor, const mindspore::tensor::BaseTensorPtr &target_tensor, const mindspore::tensor::BaseTensorPtr &weight_tensor, const mindspore::Int64ImmPtr &reduction, const mindspore::Int64ImmPtr &ignore_index) = 0;
