...
class PYBOOST_API Unique2 : public pyboost::OpRunner {
 public:
  ...
  virtual std::tuple<mindspore::tensor::BaseTensorPtr,mindspore::tensor::BaseTensorPtr,mindspore::tensor::BaseTensorPtr> Call(const mindspore::tensor::BaseTensorPtr &input_tensor, const mindspore::BoolImmPtr &sorted, const mindspore::BoolImmPtr &return_inverse, const mindspore::BoolImmPtr &return_counts) = 0;
