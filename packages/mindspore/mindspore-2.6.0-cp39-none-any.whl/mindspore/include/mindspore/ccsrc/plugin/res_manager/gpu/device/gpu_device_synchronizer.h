...
#ifndef MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_HAL_DEVICE_GPU_DEVICE_SYNCHRONIZER_H
#define MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_HAL_DEVICE_GPU_DEVICE_SYNCHRONIZER_H
...
namespace device {
namespace gpu {
class GPUDeviceSynchronizer : public DeviceSynchronizer {
 public:
  GPUDeviceSynchronizer() = default;
...
#endif  // MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_HAL_DEVICE_GPU_DEVICE_SYNCHRONIZER_H
