...
class OPS_ASCEND_API SilentCheckV2Ascend : public pyboost::SilentCheckV2 {
 public:
  ...
  std::tuple<mindspore::tensor::BaseTensorPtr,mindspore::tensor::BaseTensorPtr,mindspore::tensor::BaseTensorPtr,mindspore::tensor::BaseTensorPtr> Call(const mindspore::tensor::BaseTensorPtr &val_tensor, const mindspore::tensor::BaseTensorPtr &input_grad_tensor, const mindspore::tensor::BaseTensorPtr &sfda_tensor, const mindspore::tensor::BaseTensorPtr &step_tensor, const mindspore::Int64ImmPtr &c_min_steps, const mindspore::FP32ImmPtr &c_thresh_l1, const mindspore::FP32ImmPtr &c_coeff_l1, const mindspore::FP32ImmPtr &c_thresh_l2, const mindspore::FP32ImmPtr &c_coeff_l2, const mindspore::Int64ImmPtr &npu_asd_detect) override;
};
}  // namespace pyboost
}  // namespace kernel
}  // namespace mindspore
