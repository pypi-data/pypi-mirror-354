...
#ifndef MINDSPORE_CCSRC_RUNTIME_FRAMEWORK_PARAMETER_STORE_H_
#define MINDSPORE_CCSRC_RUNTIME_FRAMEWORK_PARAMETER_STORE_H_
...
#endif  // MINDSPORE_CCSRC_RUNTIME_FRAMEWORK_PARAMETER_STORE_H_
