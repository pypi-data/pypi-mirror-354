...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PIPELINE_PYNATIVE_FORWARD_PYBOOST_OP_SPEEDFUSIONATTENTIONGRAD_H_
#define MINDSPORE_MINDSPORE_CCSRC_PIPELINE_PYNATIVE_FORWARD_PYBOOST_OP_SPEEDFUSIONATTENTIONGRAD_H_
...
namespace kernel {
namespace pyboost {
class PYBOOST_API SpeedFusionAttentionGrad : public pyboost::OpRunner {
 public:
  SpeedFusionAttentionGrad(PrimitivePtr primitive, const DeviceContext *device_context)
      : OpRunner(std::move(primitive), device_context) {}
  ~SpeedFusionAttentionGrad() override = default;
 ...
 protected:
  ...
  inline static std::string op_name_ = "SpeedFusionAttentionGrad";
};

}  // namespace pyboost
}  // namespace kernel
}  // namespace mindspore
#endif  // MINDSPORE_MINDSPORE_CCSRC_PIPELINE_PYNATIVE_FORWARD_PYBOOST_OP_SPEEDFUSIONATTENTIONGRAD_H_
