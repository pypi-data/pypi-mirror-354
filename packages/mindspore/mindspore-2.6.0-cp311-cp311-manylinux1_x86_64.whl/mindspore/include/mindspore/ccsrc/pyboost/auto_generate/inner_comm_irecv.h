...
class PYBOOST_API InnerCommIrecv : public pyboost::OpRunner {
 public:
  ...
  virtual mindspore::tensor::BaseTensorPtr Call(const mindspore::Int64ImmPtr &tag, const mindspore::Int64ImmPtr &src, const mindspore::ValueTuplePtr &shape, const mindspore::StringImmPtr &group, const mindspore::Int64ImmPtr &dtype) = 0;
