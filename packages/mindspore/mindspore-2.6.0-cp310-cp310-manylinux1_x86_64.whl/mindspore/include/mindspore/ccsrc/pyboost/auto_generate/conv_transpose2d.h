...
class PYBOOST_API ConvTranspose2D : public pyboost::OpRunner {
 public:
  ...
  virtual mindspore::tensor::BaseTensorPtr Call(const mindspore::tensor::BaseTensorPtr &input_tensor, const mindspore::tensor::BaseTensorPtr &weight_tensor, const std::optional<mindspore::tensor::BaseTensorPtr> &bias_tensor, const mindspore::ValueTuplePtr &stride, const mindspore::ValueTuplePtr &padding, const mindspore::ValueTuplePtr &output_padding, const mindspore::Int64ImmPtr &groups, const mindspore::ValueTuplePtr &dilation) = 0;
