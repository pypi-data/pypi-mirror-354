...
class PYBOOST_API ConvolutionStrGrad : public pyboost::OpRunner {
 public:
  ...
  virtual std::tuple<mindspore::tensor::BaseTensorPtr,mindspore::tensor::BaseTensorPtr,mindspore::tensor::BaseTensorPtr> Call(const mindspore::tensor::BaseTensorPtr &dout_tensor, const mindspore::tensor::BaseTensorPtr &input_tensor, const mindspore::tensor::BaseTensorPtr &weight_tensor, const std::optional<mindspore::tensor::BaseTensorPtr> &bias_tensor, const mindspore::ValueTuplePtr &stride, const mindspore::Int64ImmPtr &padding, const mindspore::ValueTuplePtr &dilation, const mindspore::BoolImmPtr &transposed, const mindspore::ValueTuplePtr &output_padding, const mindspore::Int64ImmPtr &groups, const mindspore::ValueTuplePtr &output_mask) = 0;
