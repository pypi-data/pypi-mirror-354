 ...
 */
#ifndef MINDSPORE_CORE_OPS_VIEW_SPLIT_WITH_SIZE_STRIDES_CALC_H
#define MINDSPORE_CORE_OPS_VIEW_SPLIT_WITH_SIZE_STRIDES_CALC_H
...
#endif  // MINDSPORE_CORE_OPS_VIEW_SPLIT_WITH_SIZE_STRIDES_CALC_H
