...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_BITWISE_AND_SCALAR_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_BITWISE_AND_SCALAR_H_
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_BITWISE_AND_SCALAR_H_
