...
from network import _get_external_network
...
class TestNetworkCLI:
    ...
    @patch("network.get_openstack_connection")
    ...
    @patch("network.get_openstack_connection")
    @patch("network._get_external_network")
    def test_create_floating_ip_success(
        ...
        from network import create_floating_ip
