...
class THS:
    ...
    def tick_super_level1(self, ths_code: str) -> Response:
        """获取3秒超级盘口数据（包含委托档位）。
        ...
        return self.call(method="tick.super_level1", params=params)
    ...
    def indices_list(self) -> Response:
        """获取指数板块数据。
    ...
    def us_stock_market_data(self, ths_code: Any) -> Response:
        """us股票市场数据。
