...
from resinkit_api.services.agent.data_models import InvalidTaskError, TaskConflictError, TaskNotFoundError, UnprocessableTaskError, TaskResult
...
async def submit_task_yaml(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Internal Server Error: {str(e)}", exc_info=True)
