...
class V1beta1DeviceSubRequest:
    ...
    def __init__(self, *, allocation_mode: typing.Optional[str] = ..., count: typing.Optional[int] = ..., device_class_name: str, name: str, selectors: typing.Optional[list[kubernetes.client.V1beta1DeviceSelector]] = ..., tolerations: typing.Optional[list[kubernetes.client.V1beta1DeviceToleration]] = ...) -> None:
        ...
