...
class V1beta2AllocationResult:
    ...
    def __init__(self, *, devices: typing.Optional[kubernetes.client.V1beta2DeviceAllocationResult] = ..., node_selector: typing.Optional[kubernetes.client.V1NodeSelector] = ...) -> None:
        ...
