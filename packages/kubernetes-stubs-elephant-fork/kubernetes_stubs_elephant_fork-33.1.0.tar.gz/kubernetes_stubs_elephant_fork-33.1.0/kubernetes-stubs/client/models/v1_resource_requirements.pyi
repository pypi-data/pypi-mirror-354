...
class V1ResourceRequirements:
    ...
    def __init__(self, *, claims: typing.Optional[list[kubernetes.client.V1ResourceClaim]] = ..., limits: typing.Optional[dict[str, str]] = ..., requests: typing.Optional[dict[str, str]] = ...) -> None:
        ...
