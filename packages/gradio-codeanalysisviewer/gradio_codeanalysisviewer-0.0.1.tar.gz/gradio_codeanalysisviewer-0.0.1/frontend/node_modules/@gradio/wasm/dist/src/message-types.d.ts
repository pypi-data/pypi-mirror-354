...
export type InMessage = InMessageInitEnv | InMessageInitApp | InMessageRunPythonCode | InMessageRunPythonFile | InMessageAsgiRequest | InMessageFileWrite | InMessageFileRename | InMessageFileUnlink | InMessageInstall | InMessageCodeCompletion | InMessageEcho;
...
export type OutMessage = OutMessageProgressUpdate | OutMessageModulesAutoLoaded | OutMessageStdout | OutMessageStderr | OutMessagePythonError;
