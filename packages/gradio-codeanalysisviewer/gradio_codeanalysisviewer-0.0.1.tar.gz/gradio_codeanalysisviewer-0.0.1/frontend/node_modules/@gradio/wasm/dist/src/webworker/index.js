...
async function installPackages(pyodide, micropip, requirements, retries = 3) {
...
async function initializeApp(pyodide, micropip, appId, options, updateProgress, onModulesAutoLoaded) {
    ...
    receiver.onmessage = async function (event) {
        ...
        try {
            ...
            if (msg.type === "init-app") {
                appReadyPromise = initializeApp(pyodide, micropip, appId, msg.data, updateProgress, onModulesAutoLoaded);
                const replyMessage = {
                    type: "reply:success",
                    data: null
                };
