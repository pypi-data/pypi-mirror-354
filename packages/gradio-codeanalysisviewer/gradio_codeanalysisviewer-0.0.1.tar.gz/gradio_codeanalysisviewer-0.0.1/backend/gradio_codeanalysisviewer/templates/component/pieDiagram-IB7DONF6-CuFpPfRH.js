import { p as V } from "./chunk-4BMEZGHF-7TYPYvZp.js";
import { a3 as S, a6 as F, aF as U, _ as u, g as j, s as q, a as H, b as Z, q as J, p as K, l as z, c as Q, D as X, H as Y, N as tt, e as et, y as at, F as rt } from "./mermaid.core-lnEh3SuB.js";
import { p as nt } from "./radar-MK3ICKWK-Dz4iekcN.js";
import { d as P } from "./arc-BxP1LuwR.js";
...
function lt() {
  var t = ot, a = st, h = null, o = S(0), p = S(F), x = S(0);
  function i(e) {
    var r, l = (e = U(e)).length, g, A, m = 0, c = new Array(l), n = new Array(l), v = +o.apply(this, arguments), w = Math.min(F, Math.max(-F, p.apply(this, arguments) - v)), f, T = Math.min(Math.abs(w) / l, x.apply(this, arguments)), $ = T * (w < 0 ? -1 : 1), d;
    for (r = 0; r < l; ++r)
...
var ct = rt.pie, G = {
  ...
  b.has(t) || (b.set(t, a), z.debug(`added new section: ${t}, with value: ${a}`));
