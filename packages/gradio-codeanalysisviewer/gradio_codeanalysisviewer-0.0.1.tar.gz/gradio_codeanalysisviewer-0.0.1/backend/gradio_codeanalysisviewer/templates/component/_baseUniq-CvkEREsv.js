import { b9 as S, ba as Rn, aO as T, bb as w, bc as xn, bd as Mn, aN as sn, be as mn, bf as un, bg as x, aL as N, bh as Cn, bi as on, bj as Fn, bk as E, b7 as gn, bl as R, aJ as ln, bm as Dn, bn as D, bo as Gn, bp as Nn, bq as _, aR as Un, br as Bn, aM as Kn, bs as J, bt as jn, bu as Hn, aQ as qn, aP as cn, b5 as Yn, bv as m } from "./mermaid.core-lnEh3SuB.js";
...
var Q = w ? w.prototype : void 0, X = Q ? Q.toString : void 0;
function dn(n) {
  if (typeof n == "string")
    return n;
  if (T(n))
...
var nn = R && R.isMap, Jr = nn ? gn(nn) : Zr, Qr = "[object Set]";
function Xr(n) {
  return S(n) && E(n) == Qr;
}
var rn = R && R.isSet, Wr = rn ? gn(rn) : Xr, zr = 1, Vr = 2, kr = 4, $n = "[object Arguments]", ne = "[object Array]", re = "[object Boolean]", ee = "[object Date]", te = "[object Error]", _n = "[object Function]", ie = "[object GeneratorFunction]", fe = "[object Map]", ae = "[object Number]", Sn = "[object Object]", se = "[object RegExp]", ue = "[object Set]", oe = "[object String]", ge = "[object Symbol]", le = "[object WeakMap]", ce = "[object ArrayBuffer]", be = "[object DataView]", de = "[object Float32Array]", pe = "[object Float64Array]", Ae = "[object Int8Array]", ye = "[object Int16Array]", Te = "[object Int32Array]", he = "[object Uint8Array]", we = "[object Uint8ClampedArray]", Oe = "[object Uint16Array]", $e = "[object Uint32Array]", g = {};
...
var Qe = 1, tn = "[object Arguments]", fn = "[object Array]", L = "[object Object]", Xe = Object.prototype, an = Xe.hasOwnProperty;
