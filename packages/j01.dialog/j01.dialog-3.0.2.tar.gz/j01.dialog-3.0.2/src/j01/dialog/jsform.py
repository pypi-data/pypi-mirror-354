...
@implementer(interfaces.IDialogForm)
...
@implementer(interfaces.IDialogEditForm)
...
@implementer(interfaces.IDialogAddForm)
...
@implementer(interfaces.IDialogDeleteForm)
...
@implementer(interfaces.IDialogConfirmForm)
