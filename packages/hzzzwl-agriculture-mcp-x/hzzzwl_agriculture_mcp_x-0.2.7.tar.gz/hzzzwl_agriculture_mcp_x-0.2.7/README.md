...
## 概述
以农产品质量安全要素为核心，通过17个符合MCP协议标准的API接口，提供涵盖农药基础信息数据；农药、肥料进货销售数据；农产品质量安全监测数据；农产品承诺达标合格开具数据等全链条数据支撑服务。
...
### 农业百科全书 get_agricultural_encyclopedia
根据用户问题，获得农业方面的答案
### **输入**:
- `text` 问题
### **输出**:
...
### 获取KEY
通过KEY你才能够调用农产品质量安全全链数据服务MCP Server能力，请联系0571-88816415或访问:https://report.hzzzwl.com/zzai 获取。
