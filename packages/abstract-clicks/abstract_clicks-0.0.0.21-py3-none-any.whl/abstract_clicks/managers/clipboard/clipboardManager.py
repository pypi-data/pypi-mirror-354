...
class ClipboardManager:
    def __init__(self):
        ...
        self.running = False
        self.clip = pyperclip
        self.html_file_path = "/tmp/permanent_tab.html"  # Define HTML file path
            ...
            try:
                ...
                for wid in window_ids:
                    ...
                    if window_title.lower() in title.lower():
                        ...
                        print(f"Switched and moved window to monitor 1: {window_title}")
                        time.sleep(0.5)
                        return
    ...
    def open_browser_tab(self, url=None, title="My Permanent Tab"):
            ...
            try:
                ...
                raise
            try:
                success = webbrowser.open(f"file://{self.html_file_path}")
    ...
    def get_extracted_texts_and_coords(self,img, confidence_threshold=None,objectType=None):
        pytesseract.pytesseract.tesseract_cmd = '/home/computron/miniconda/share/tessdatapip/'
