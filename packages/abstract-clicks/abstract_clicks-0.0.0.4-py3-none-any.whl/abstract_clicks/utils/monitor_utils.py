    ...
    try:
        with mss.mss() as sct:
            ...
            for monitor_index,monitor in enumerate(sct.monitors):
                ...
                get_monitor_texts_with_highlight('html',screenshot_file,monitor_index)
    except Exception as e:
        print(f"Error capturing screenshot: {e}")
        return None

   
def highlight_text_on_screenshot(screenshot_path, bbox,
                                 highlight_color=(
                                     0,
                                     255,
                                     0
...
def get_monitor_texts_with_highlight(comp,screenshot_file,monitor):
