...
class screenshotManager:
    ...
    def get_target_items(
        ...
        get_target_items(
            ...
            target_text_lower = target_text_lower or self.target_text_lower,
            extracted_texts = extracted_texts or self.extracted_texts,
            extracted_texts_lower = extracted_texts_lower or self.extracted_texts_lower,
            top = top or self.top,
