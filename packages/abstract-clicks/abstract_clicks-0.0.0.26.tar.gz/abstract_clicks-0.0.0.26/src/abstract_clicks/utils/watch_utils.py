from ..imports import read_from_file,pyperclip,time,get_abs_dir
from ..managers import ChangeHandler
from watchdog.observers import Observer

query_file_path = get_query_path(path=path)
response_file_path = get_response_path(path=None)
