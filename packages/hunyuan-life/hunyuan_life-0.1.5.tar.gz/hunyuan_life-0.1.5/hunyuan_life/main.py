...
async def calendar( 
    ...
    calendar_url = domain+"/openapi/betav1/tools/paper"
    ...
    try:
        ...
        return TextContent(
            type="text",
            text=response_json.get("answer", "无返回结果")
        )
...
async def weather( 
    ...
    if env == "test":
        # domain = "http://120.241.140.192"
        domain = "http://11.145.140.98:8000"
    else:
        domain = "https://agent.hunyuan.tencent.com"
    ...
    weather_url = domain+"/openapi/betav1/tools/paper"
