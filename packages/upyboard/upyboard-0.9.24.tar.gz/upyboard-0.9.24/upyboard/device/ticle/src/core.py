...
class Din:
    ...
    def __init__(self, pins:tuple, pull:int|None=None, trigger:int|None=0, callback:function|None=None):
        ...
        """
        self.__din =[Din.__ReadOnly(pin, pull, trigger, callback) for pin in pins]
...
class Dout:
    ...
    class __Group:
        ...
        def __init__(self, pins:list):
            """
            Initialize the group of digital output pins.
            :param pins: List of Dout.__Pin objects to be managed as a group.
            """
            self.__pins = pins
    ...
    def __init__(self, pins:tuple[int, ...], pull:int|None=None):
        ...
        """
        self.__pins = [Dout.__Pin(pin, pull) for pin in pins]
        self.all = Dout.__Group(self.__pins)
...
class Button:
    ...
    def __cb_single_click(self, _t):
        ...
        """
        self.__click_waiting = False
        self.__safe_call(self.on_clicked)
    ...
    def __cb_long_press(self, _t):
        ...
        if self.__sw[0]:
            ...
            self.__safe_call(self.on_long_pressed)
    ...
    def __callback(self, _):
        ...
        if self.__click_waiting:
            ...
            self.__click_waiting = False
            self.__safe_call(self.on_double_clicked)
        else:
...
class I2c:
    ...
    def __init__(self, scl:int, sda:int, addr:int, freq:int=400_000):
        ...
        self.addr = addr
        self.i2c = machine.I2C(bus, scl=machine.Pin(scl), sda=machine.Pin(sda), freq=freq)
    ...
    def write_u16(self, reg: int, val: int, *, little_endian: bool = True) -> None:
        ...
        """
        order = 'little' if little_endian else 'big'
        self.i2c.writeto_mem(self.addr, reg, val.to_bytes(2, order))
    ...
    def readfrom(self, nbytes: int, *, stop: bool = True) -> bytes:
        ...
        """
        return self.i2c.readfrom(self.addr, nbytes, stop)
    ...
    def readinto(self, buf: bytearray, *, stop: bool = True) -> int:
        ...
        """
        return self.i2c.readinto(self.addr, buf, stop)
    ...
    def readfrom_mem(self, reg: int, nbytes: int, *, addrsize: int = 8) -> bytes:
        ...
        """
        return self.i2c.readfrom_mem(self.addr, reg, nbytes, addrsize=addrsize)
    ...
    def readfrom_mem_into(self, reg: int, buf: bytearray, *, addrsize: int = 8) -> int:
        ...
        :return: The number of bytes read into the buffer.
        """
        return self.i2c.readfrom_mem_into(self.addr, reg, buf, addrsize=addrsize)
    ...
    def writeto(self, buf: bytes, *, stop: bool = True) -> int:
        ...
        """
        return self.i2c.writeto(self.addr, buf, stop)
    ...
    def writeto_mem(self, reg: int, buf: bytes, *, addrsize: int = 8) -> int:
        ...
        """
        return self.i2c.writeto_mem(self.addr, reg, buf, addrsize=addrsize)
