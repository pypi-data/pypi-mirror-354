...
class SlipDecoder:
    ...
    def feed(self, chunk: bytes) -> list[bytes]:
        ...
        If the chunk contains incomplete frames, they will be buffered for the next call.
...
class RingBuffer:
    ...
    def __init__(self, size:int):
        ...
        :param size: The size of the ring buffer. (really size+1)
        """
    ...
    def put(self, data:bytes):
        ...
        :param data: The data to put into the buffer (must be bytes).
        """
        for b in data:
    ...
    def get(self, n:int=1) -> bytes:
        ...
        If `n` is None, it will return all available bytes.
        
        :param n: The number of bytes to get (default is 1).
    ...
    def peek(self, n:int = 1) -> bytes:
        ...
        :param n: The number of bytes to peek (default is 1).
