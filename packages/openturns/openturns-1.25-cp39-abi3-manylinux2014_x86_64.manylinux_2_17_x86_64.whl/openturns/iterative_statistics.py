...
class IterativeExtrema(IterativeAlgorithmImplementation):
    ...
    def __init__(self, dimension=1):
        _iterative_statistics.IterativeExtrema_swiginit(self, _iterative_statistics.new_IterativeExtrema(dimension))
...
class IterativeMoments(IterativeAlgorithmImplementation):
    ...
    def __init__(self, orderMax=2, dimension=1):
        _iterative_statistics.IterativeMoments_swiginit(self, _iterative_statistics.new_IterativeMoments(orderMax, dimension))
