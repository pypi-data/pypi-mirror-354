...
class DataType:
    ...
    def __init__(self, name: str, unit: str):
        ...
        Args:
            ...
            unit (str): The unit of the data type.
...
class WavelengthToEnergy(Transformation):
    """
    A class for transforming wavelength values to energy.
    """
    ...
    def wavelengthToEnergy(self, values, factor):
        """
        Converts wavelength values to energy.

        Args:
            values (numpy.ndarray): The wavelength values to convert.
            factor (float): The conversion factor.

        Returns:
            numpy.ndarray: The converted energy values.
        """
