...
from crawl_toolkit.prompts.keyword_analysis_prompt import KEYWORD_ANALYSIS_PROMPT
...
class CrawlToolkit:
    ...
    async def clean_markdown(self, markdown: str) -> str:
        """
        ...
        """
        try:
            return MarkdownCleaner(markdown).clean()
        except Exception as e:
    ...
    async def fetch_and_clean_urls(
        ...
        for url in urls:
            ...
            cleaner = cleaner_factory.create(fetch_type, content)
    ...
    async def make_keyword_analysis(
        ...
        """
        Wykonuje kompleksową analizę słowa kluczowego
