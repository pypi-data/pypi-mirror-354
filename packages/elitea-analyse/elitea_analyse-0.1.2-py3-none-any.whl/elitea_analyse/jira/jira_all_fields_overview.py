...
def jira_all_fields_overview(
    ...
    """
    jira = jira if jira else connect_to_jira(credentials=credentials)

    jira_basic = JiraBasic(jira, projects)

    all_fields_data = jira_basic.extract_all_fields(updated_after)
