...
def train_new_transformer_model(
    ...
    **kwargs
    ...
    """
    Train a transformer model from scratch (pretrained weights, new head), with early stopping and best model saving.
    ...
    Args:
        ...
        eval_split (float): Fraction for validation.
        ...
        **kwargs: Extra TrainingArguments.
...
def retrain_existing_model(
    ...
    **kwargs
    ...
    """
    Fine-tune an existing model on new data, with early stopping and best model saving.
