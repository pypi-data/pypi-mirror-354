...
class MockNXtomoWithElecCurrent(MockNXtomo):
    def __init__(
        ...
        electrical_current: numpy.array | None = None,
    ):
...
class BaseTestAddDarkAndFlats(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self._simple_nx = MockNXtomoWithElecCurrent(
            ...
            final_flats=None,
            dim=self.dim,
            electrical_current=numpy.zeros(self.nproj),
        ).scan
        with HDF5File(
