...
class TomoEDFConfig(ConfigBase, ConfigSourceSection):
    ...
    def pixel_size_unit(self, unit: MetricSystem | str) -> None:
    ...
    def distance_unit(self, unit: MetricSystem | str) -> None:
        if not isinstance(unit, (MetricSystem, str)):
            raise TypeError("unit is expected to be an instance of MetricSystem")
        if isinstance(unit, str):
            unit = MetricSystem.from_str(unit)
    ...
    @energy_unit.setter
    def energy_unit(self, unit: EnergySI | str) -> None:
    ...
    @x_trans_unit.setter
    def x_trans_unit(self, unit: MetricSystem | str) -> None:
        if not isinstance(unit, (MetricSystem, str)):
            raise TypeError("unit is expected to be an instance of MetricSystem")
        if isinstance(unit, str):
            unit = MetricSystem.from_str(unit)
    ...
    @y_trans_unit.setter
    def y_trans_unit(self, unit: MetricSystem | str) -> None:
        if not isinstance(unit, (MetricSystem, str)):
            raise TypeError("unit is expected to be an instance of MetricSystem")
        if isinstance(unit, str):
            unit = MetricSystem.from_str(unit)
    ...
    @z_trans_unit.setter
    def z_trans_unit(self, unit: MetricSystem | str) -> None:
        if not isinstance(unit, (MetricSystem, str)):
            raise TypeError("unit is expected to be an instance of MetricSystem")
        if isinstance(unit, str):
            unit = MetricSystem.from_str(unit)
