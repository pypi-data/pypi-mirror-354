...
class Command(ABC):
    ...
    def execute_azure_cli_command(
        ...
        ignore_pkg_resources: bool = False,
    ) -> bool:
        """
        ...
        success = self.execute_command(
            pwsh_command, working_dir, stderr_is_failure, fail_if_version_exists, log_error, ignore_blowfish, ignore_pkg_resources
        )
        return success
    ...
    def execute_command(
        ...
        if stderr:
            ...
            if ignore_pkg_resources and "pkg_resources" in stderr:
                log.info("Ignoring pkg_resources warnings")
                try:
                    log.debug(stderr)
                except:
                    log.debug("logging stderr failed, ignoring error")
                return True
            ...
            for line in stderr.splitlines():
                ...
                if ignore_pkg_resources:
                    # Ignore Warning messages from azure CLI using package in path to deprecation.
                    # This code should be ignoring the following 3 lines:
                    #     C:\Program Files\Common Files\AzureCliExtensionDirectory\azure-cli-ml\azureml\_cli\aml_cli.py:10: UserWarning: pkg_resources is deprecated as an API. See https://setuptools.pypa.io/en/latest/pkg_resources.html. The pkg_resources package is slated for removal as early as 2025-11-30. Refrain from using this package or pin to Setuptools<81.
                    #     import pkg_resources
                    #     importlib\__init__.py:131: UserWarning: pkg_resources is deprecated as an API. See https://setuptools.pypa.io/en/latest/pkg_resources.html. The pkg_resources package is slated for removal as early as 2025-11-30. Refrain from using this package or pin to Setuptools<81.
    ...
    def run(self) -> None:
        ...
        if config.number_of_cores_parallel <= 0 or (config.number_of_cores_parallel > max_nb_cores and not config.force_parallelism):
