...
def oxdna_simulations(origami: Origami,
                      oxdna_directory: str,
    ...
    origami.save_3d_model(directory + os.sep + 'start', 
                          config=True,
                          topology=False,
                          forces=True,
                          pk_forces=True,
    ...
    # save topology
    origami.save_3d_model(directory + os.sep + 'topology', 
                          config=False,
                          topology=True,
                          )
