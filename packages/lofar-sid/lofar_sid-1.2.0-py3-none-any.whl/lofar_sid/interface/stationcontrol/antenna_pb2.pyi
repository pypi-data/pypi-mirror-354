...
class AntennaReply(_message.Message):
    __slots__ = ("identifier", "antenna_use", "antenna_status", "power_status")
    IDENTIFIER_FIELD_NUMBER: _ClassVar[int]
    ANTENNA_USE_FIELD_NUMBER: _ClassVar[int]
    ANTENNA_STATUS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, identifier: _Optional[_Union[Identifier, _Mapping]] = ..., antenna_use: _Optional[_Union[Antenna_Use, str]] = ..., antenna_status: _Optional[_Union[Antenna_Status, str]] = ..., power_status: _Optional[_Union[Antenna_Power_Status, str]] = ...) -> None: ...
