...
class OpenAiExtension(IqlExtension):
    ...
    def executeimpl(self, sq: SubQuery) -> pd.DataFrame:
        openai_key: str = sq.options.get("openai_key", os.environ["OPENAI_KEY"])  # type: ignore
        assistant_id: str = sq.options.get("openai_assistant_id", os.environ["OPENAI_ASSISTANT_ID"])  # type: ignore
