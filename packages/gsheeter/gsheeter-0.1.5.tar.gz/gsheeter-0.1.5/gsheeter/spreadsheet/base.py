...
class SpreadsheetBase(Lego, GoogleAPI):
	...
	def batchUpdate(
		...
		endpoint_items = self.endpoints[object]['batchUpdate'].copy()
...
class SheetBase(SpreadsheetBase):
	...
	def get_matrix(self) -> np.ndarray:
		endpoint_items = self.endpoints['values']['get'].copy()
	...
	def send_packets(
		...
		endpoint_items = self.endpoints['values']['batchUpdate'].copy()
