...
class GetWebhookEventWebhookEventsResponseBody(Exception):
    r"""An error response object."""

    data: GetWebhookEventWebhookEventsResponseBodyData

    def __init__(self, data: GetWebhookEventWebhookEventsResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, GetWebhookEventWebhookEventsResponseBodyData
        )
