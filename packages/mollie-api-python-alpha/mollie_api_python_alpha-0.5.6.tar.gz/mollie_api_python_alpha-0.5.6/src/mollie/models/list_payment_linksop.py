...
class ListPaymentLinksPaymentLinksResponseBody(Exception):
    r"""An error response object."""

    data: ListPaymentLinksPaymentLinksResponseBodyData

    def __init__(self, data: ListPaymentLinksPaymentLinksResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, ListPaymentLinksPaymentLinksResponseBodyData
        )
...
class ListPaymentLinksAllowedMethods(str, Enum):
    APPLEPAY = "applepay"
...
class ListPaymentLinksPaymentLinks(BaseModel):
    ...
    allowed_methods: Annotated[
        OptionalNullable[List[ListPaymentLinksAllowedMethods]],
