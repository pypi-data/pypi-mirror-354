...
def ensure_user_config():
    if not USER_CONFIG_PATH.exists():
        ...
        default_config_path = importlib.resources.files("myApp").joinpath("license_config.json")
...
def load_agreement_status():
    ...
    try:
        ...
        config_file = importlib.resources.files("myApp").joinpath("license_config.json")
        if config_file.is_file():
            # Read content
            with importlib.resources.files("myApp").joinpath("license_config.json.json").open("r") as CONFIG_FILE:
