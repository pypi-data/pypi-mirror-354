...
from ..base import Interval, FixedValue, VolumeQuantity, IntensityQuantity
    ...
    def from_format(self, data: dict, variables: Optional[Dict[str, Any]] = None) -> Workout:
        ...
        try:
            ...
            for interval_data in intervals_data:
                ...
                volume = FixedValue(value=duration, quantity=VolumeQuantity.duration)
                intensity = FixedValue(fraction=intensity_pct / 100, quantity=IntensityQuantity.power)
