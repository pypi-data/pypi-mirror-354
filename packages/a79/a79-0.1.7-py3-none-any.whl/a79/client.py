...
from common_py.workflow.runnables.runnable import RunnableResult
from external.a79.src.a79.helpers.config import WorkflowConfig
from external.a79.src.models.tools.workflow_models import StreamId
...
class A79ClientExternal:
    ...
    def execute_tool(
        ...
        while number_of_attempts > 0:
            ...
            response.raise_for_status()
            if response.json()["status"] == enums.RunStatus.RUNNING.value:
        ...
        elif result.status == enums.RunStatus.FAILED:
