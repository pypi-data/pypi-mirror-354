...
def configure(
    ...
    if connection_mode == "1":
        ...
        while True:
            ...
            if "databricks.com" in history_server_url:
            ...
            if "databricks.com" in history_server_url and "sparkui" in history_server_url:
                try:
    ...
    if connection_mode == "2":
        is_databricks = "databricks.com" in history_server_url and "sparkui" in history_server_url
