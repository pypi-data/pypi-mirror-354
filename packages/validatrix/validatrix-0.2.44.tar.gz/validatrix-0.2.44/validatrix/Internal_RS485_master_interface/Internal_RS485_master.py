...
class Internal_RS485_master_class:
    ...
    def add_to_server(self):
        ...
        if self.server_obj:
            ...
            print(f"Added slave {self.device_name} with address {self.master_address} to server.")
                ...
                if(self.device_name == "LT_AC_EM"):
                    ...
                    for k in list(self.data_dict.keys()):                          
                            ...
                            try:
                                ...
                                size = register[1]
                                holding_registers_data_segment = self.server_obj.read_hold_register_data(address=self.master_address,
                                                                                        start_reg=int(start_address -1),reg_count=size)  
                                
                                # holding_registers_data_segment = holding_registers_data_segment[::-1]  # Reverse the order of registers
