...
def format_instance(
    ...
    return {
        ...
        "variability_configurations": [
            {
                "id": v.id,
                "variability_id": v.variability_id,
                "variability": bom_ontology["diversities"][v.variability_id]
                if bom_ontology
                else v.variability,
                "object_id": v.object_id,
                "object": bom_ontology["objects"][v.object_id] if bom_ontology else v.object,
            }
            for v in instance.variability_configurations
        ],
