...
class BomClient:
    ...
    def create_instance(self, **kwargs: Unpack[BomInstanceCreate]) -> BomInstance:
        ...
        if not object_type:
            raise ValueError("object_type is required to create a BOM instance")
    ...
    def get_object_reference(self, instance_id: str, diversity: str | None) -> Object | None:
    ...
    def get_object_attribute(
        self, instance_id: str, attribute_name: str, diversity: str | None
    ) -> str | int | float | bool | dict | list | None:
        ...
        if not object:
            raise ValueError(f"Object reference not found for instance ID {instance_id}")
