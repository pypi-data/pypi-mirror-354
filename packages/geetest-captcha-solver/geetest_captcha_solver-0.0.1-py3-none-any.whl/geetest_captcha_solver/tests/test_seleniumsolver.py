...
from geetest_captcha_solver.captchatype import CaptchaType
...
def test_solve_at_scroll(caplog) -> None:
    ...
    with open("src/geetest_captcha_solver/tests/puzzle_video_search.html", "w") as f:
...
#     driver = make_driver()
#     try:
#         driver.get("file:///home/gregb/ToughdataLLC/SadCaptcha/tiktok-captcha-solver/src/geetest_captcha_solver/tests/new_shapes.html")
#         sadcaptcha = SeleniumSolver(driver, os.environ["API_KEY"])
...
#     driver = make_driver()
#     try:
#         driver.get("file:///home/gregb/ToughdataLLC/SadCaptcha/tiktok-captcha-solver/src/geetest_captcha_solver/tests/new_rotate.html")
#         sadcaptcha = SeleniumSolver(driver, os.environ["API_KEY"])
...
#     driver = make_driver()
#     try:
#         driver.get("file:///home/gregb/ToughdataLLC/SadCaptcha/tiktok-captcha-solver/src/geetest_captcha_solver/tests/new_puzzle.html")
#         sadcaptcha = SeleniumSolver(driver, os.environ["API_KEY"])
