...
class ProviderRegistry:
    ...
    _transcript_providers: Dict[str, Type[TranscriptProvider]] = {
        ...
        "fallback-transcription": FallbackTranscriptProvider,
        "openai-transcription": OpenAITranscriptProvider
    }
    ...
    _caption_providers: Dict[str, Type[CaptionProvider]] = {
        ...
        "fallback-caption": FallbackCaptionProvider,
        "openai-caption": OpenAICaptionProvider
    }
    ...
    _embed_providers: Dict[str, Type[EmbedProvider]] = {
        ...
        "fallback-embedding": FallbackEmbedProvider,
        "openai-embedding": OpenAIEmbedProvider
    }
    ...
    _classifier_providers: Dict[str, Type[ClassifierProvider]] = {
        ...
        "fallback-classifier": FallbackClassifierProvider,
        "openai-classifier": OpenAIClassifierProvider
    }
