...
from mindbank_poc.core.queue.normalization_worker import NormalizationWorker
...
async def startup_event():
    ...
    # Регистрируем провайдеры нормализации
    from mindbank_poc.core.providers.openai import register_normalization_providers
    from mindbank_poc.core.providers.fallback import register_fallback_providers
    register_normalization_providers()
    ...
    # Запускаем воркер нормализации
    global normalization_worker
    normalization_worker = NormalizationWorker()
    await normalization_worker.start()
...
async def shutdown_event():
    ...
    # Останавливаем воркер нормализации
