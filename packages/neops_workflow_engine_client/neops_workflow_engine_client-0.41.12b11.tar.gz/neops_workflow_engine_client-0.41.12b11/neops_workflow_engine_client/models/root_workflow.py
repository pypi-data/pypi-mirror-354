...
class RootWorkflow(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "retryConfig", "condition", "continueOnError", "delay", "parameters", "runOn", "repeatConfig", "type", "config", "steps", "package", "majorVersion", "minorVersion", "patchVersion", "description", "cron", "hideForExecution", "parameterSchema"]
