...
class JobExecutionContextDto(BaseModel):
    ...
    """ # noqa: E501
    devices: Optional[List[DeviceTypeDto]] = Field(default=None, description="List of devices involved in the job execution")
    device_groups: Optional[List[DeviceGroupTypeDto]] = Field(default=None, description="List of device groups involved in the job execution", alias="deviceGroups")
