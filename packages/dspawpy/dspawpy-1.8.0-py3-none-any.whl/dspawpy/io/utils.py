...
def d_band(spin, dos_data):  # Define the function, with two variables given in parentheses
    ...
    >>> dos_data = get_dos_data("dspawpy_proj/dspawpy_tests/inputs/supplement/dos.h5")  # Reads data from dos.h5
...
def getTSads(
    ...
    for vi_THz in data_get_TS:
        ...
        m6 = math.log(m5, math.e)  # m6= ln(m5)   math.e in Python is e, logarithm with base on the right side
        m7 = R * m6
        m8 = m1 / m4 - m7  # S unit J/(mol*K)
        m9 = (T * m8 / 1000) / 96.49  # T*S, converting units to kJ/mol, 96.49 kJ/mol = 1 eV unit eV
        sum_S += m9
