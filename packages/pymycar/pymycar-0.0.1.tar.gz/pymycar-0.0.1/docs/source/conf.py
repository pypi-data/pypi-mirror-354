...
import os
import sys
sys.path.insert(0, os.path.abspath('../../src/pymycar'))
...
html_logo = '_static/logo_social.png'
...
html_theme_options = {
    ...
    "github_url": "https://github.com/CastillonMiguel/pymycar",
    "navbar_align": "left",
    'icon_links': [
        {
            'name': 'Contributing',
            'url': 'https://github.com/CastillonMiguel/pymycar/blob/main/CONTRIBUTING.rst',
