                ...
                try:
                    ...
                    for x in fields_for_total:
                        try:
                            ...
                            msg2+=f"""{Fore.orange_red_1}(Estimated/Inverted Shelf Qty) Shelf=ShelfCount - Qty {Fore.light_yellow}[{Fore.cyan}{dl.ShelfCount}{Fore.light_yellow} -{Fore.cyan}{dl.Shelf}{Fore.light_yellow}]={Fore.pale_green_1b}{dl.ShelfCount-dl.Shelf}{Style.reset}\n"""
                            print(msg2)
                            if export:
