...
from .qcon_lib import eagle, heron, flamingo, condor, qcon
...
def get_qpu_processor_type(backend_name: str) -> dict:
    ...
    try:
        ...
        if hasattr(processor_backend, 'processor_type') and processor_backend.processor_type:
            ...
            print(f"🦾 Processor status: 🟢 Online")
            ...
            # processor_lg = None
            # processor_lg = eagle if processor_family == 'Eagle' else \
            #     heron if processor_family == 'Heron' else \
            #     flamingo if processor_family == 'Flamingo' else \
            #     condor if processor_family == 'Condor' else None
