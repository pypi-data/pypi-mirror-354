import { c as create_ssr_component, a as createEventDispatcher, v as validate_component, e as escape } from './ssr-Cwm06D-i.js';
import { U as Upload } from './ModifyUpload-t9RAbhbU.js';
import { j as BlockLabel, as as Video$1, aa as SelectSource, B as Block, S as Static, U as UploadText } from './2-Ch-Upcn5.js';
import { Webcam as Webcam$1 } from './Index26-ObB_DdKI.js';
import { P as Player$1, p as prettyBytes, V as VideoPreview } from './VideoPreview-f1mUKPNT.js';
export { l as loaded, a as playable } from './VideoPreview-f1mUKPNT.js';
export { default as BaseExample } from './Example25-fCyBtzzh.js';
...
import './Example11-B8kwiKzG.js';
import './Video-BBWvfovT.js';
...
const InteractiveVideo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(BlockLabel, "BlockLabel").$$render(
      ...
      {},
      {}
    )}` : ``}`}</div>` : `${value?.url ? `${validate_component(Player$1, "Player").$$render(
      $$result,
      {
        upload,
        root,
...
export { Video as BaseInteractiveVideo, Player$1 as BasePlayer, VideoPreview as BaseStaticVideo, Index$1 as default, prettyBytes };
//# sourceMappingURL=index53-B64sC4Yl.js.map
