...
import { B as Block, S as Static, z as BlockTitle } from "./2.ChNy08-U.js";
...
function create_if_block(ctx) {
  ...
  return {
    ...
    h() {
      attr(button, "class", "reset-button svelte-1kajgn1");
...
function create_default_slot(ctx) {
  ...
  return {
    ...
    h() {
      ...
      attr(label_1, "class", "svelte-1kajgn1");
      ...
      ctx[19];
      attr(input0, "class", "svelte-1kajgn1");
      attr(div0, "class", "tab-like-container svelte-1kajgn1");
      attr(div1, "class", "head svelte-1kajgn1");
      attr(span0, "class", "min_value svelte-1kajgn1");
      ...
      ctx[5]}`);
      attr(input1, "class", "svelte-1kajgn1");
      attr(span1, "class", "max_value svelte-1kajgn1");
      attr(div2, "class", "slider_input_container svelte-1kajgn1");
      attr(div3, "class", "wrap svelte-1kajgn1");
    },
    m(target, anchor) {
