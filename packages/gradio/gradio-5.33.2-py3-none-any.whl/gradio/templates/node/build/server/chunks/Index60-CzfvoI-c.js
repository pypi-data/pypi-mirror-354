import { c as create_ssr_component, v as validate_component, a as createEventDispatcher, e as escape, n as null_to_empty, b as add_attribute, f as each, d as add_styles, o as onDestroy, m as missing_component } from './ssr-Cwm06D-i.js';
import { B as Block, S as Static, j as BlockLabel, C as Chat, o as IconButtonWrapper, q as IconButton, z as Community, A as Trash, G as Image, H as MarkdownCode, M as Music, J as File$1, K as Copy, N as Check, O as Clear, R as Retry, P as Undo, Q as Edit, V as DropdownCircularArrow } from './2-Ch-Upcn5.js';
...
const Message = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${[
    ...
    ].join(" ").trim()}">${in_edit_mode && message.type === "text" ? ` <textarea class="edit-textarea svelte-yaaj3" autofocus${add_styles({
...
//# sourceMappingURL=Index60-CzfvoI-c.js.map
