import { c as create_ssr_component, o as onDestroy, v as validate_component, e as escape, b as add_attribute } from './ssr-Cwm06D-i.js';
import { B as Block, W as BlockTitle, a0 as Calendar } from './2-Ch-Upcn5.js';
export { default as BaseExample } from './Example-BzP15dgx.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `<div class="label-content svelte-ywg1ch">${validate_component(BlockTitle, "BlockTitle").$$render($$result, { root, show_label, info }, {}, {
            default: () => {
              return `${escape(label)}`;
            }
...
//# sourceMappingURL=Index54-DVy0CMal.js.map
