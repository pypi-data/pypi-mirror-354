import { c as create_ssr_component, v as validate_component, b as add_attribute, m as missing_component, a as createEventDispatcher } from './ssr-Cwm06D-i.js';
import { B as Block, S as Static, j as BlockLabel, J as File$1, n as Empty, U as UploadText, o as IconButtonWrapper, q as IconButton, P as Undo, u as Download } from './2-Ch-Upcn5.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-t9RAbhbU.js';
export { default as BaseExample } from './Example19-BpMcGr5w.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-K4mi2p_u.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-BT43tXIQ.js');
  return module.default;
}
...
//# sourceMappingURL=Index56-DOgb1dpo.js.map
