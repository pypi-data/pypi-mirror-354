(self["webpackChunkjupyter_fs"] = self["webpackChunkjupyter_fs"] || []).push([["vendors-node_modules_pnpm_tree-finder_base_1_0_0_node_modules_tree-finder_base_dist_tree-finder_js"],{

/***/ "./node_modules/.pnpm/@tree-finder+base@1.0.0/node_modules/@tree-finder/base/dist/tree-finder.js":
/*!*******************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@tree-finder+base@1.0.0/node_modules/@tree-finder/base/dist/tree-finder.js ***!
  \*******************************************************************************************************/
/***/ ((module) => {

!function(t,e){if(true)module.exports=e();else { var r, i; }}(self,(()=>(()=>{var t={639:()=>{var t=new WeakMap,e=navigator.userAgent.toLowerCase().indexOf("firefox")>-1?5e6:1e7,i=0,r=0,s=performance.now();var o=(t,...e)=>t.map(((t,i)=>[t,e[i]])).flat().filter((t=>!!t)).join(""),n=new Map;async function l(t,e){if(n.has(t)&&(await n.get(t),n.has(t)))await n.get(t);else{n.set(t,(()=>{let t,e=new Promise((e=>{t=e}));return e.resolve=t,e})());try{return await e()}finally{let e=n.get(t);n.delete(t),e.resolve()}}}var a=class extends HTMLElement{create_shadow_dom(){this.attachShadow({mode:"open"});this.shadowRoot.innerHTML=o`
            <style>
    ...
    `,[this.breadcrumbs,this.filters,this.grid]=this.children}async init({root:t,options:e={},modelOptions:i={},gridOptions:r={}}){this.options=e,this.clear(),this._options.showFilter&&(i.needsWidths=!0),this._model=new ct(t,i),this.breadcrumbs.init(this._model),this.options.showFilter&&this.filters.init(this._model),this.grid.init(this._model,r),this._model.columnWidthsSub.subscribe((t=>{if(t.length){this.filters.getChild(0).style.marginLeft="12px";for(const[e,i]of t.entries()){const t=this.filters.getInput(e);t&&(t.style.width=i)}}})),await this.draw()}async draw(){await this.grid.draw()}create_shadow_dom(){this.attachShadow({mode:"open"});this.shadowRoot.innerHTML=o.html`
      <style>
        :host {
          display: flex;
          flex-flow: column;
    ...
    `,[this.shadowSheet,this.breadcrumbsContainer,this.filterContainer,this.gridContainer]=this.shadowRoot.children}get model(){return this._model}get options(){return{...this._options}}set options({showFilter:t=!1}){this._options={showFilter:t}}}document.createElement("tree-finder-panel").constructor===HTMLElement&&customElements.define("tree-finder-panel",ut)})(),r})()));


/***/ })

}]);
//# sourceMappingURL=vendors-node_modules_pnpm_tree-finder_base_1_0_0_node_modules_tree-finder_base_dist_tree-finder_js.c65b995ab401f2c37d5f.js.map