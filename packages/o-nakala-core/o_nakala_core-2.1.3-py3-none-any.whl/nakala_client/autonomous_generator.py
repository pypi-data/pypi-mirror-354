...
Note: This module contains semantic web vocabulary URIs using HTTP protocol.
These are legitimate identifiers from Dublin Core and COAR vocabularies that
must use HTTP as specified by W3C standards, not HTTPS.
"""
    ...
    def __init__(self):
        ...
        self.generation_templates = {
            "research_paper": {
                ...
                "type": "http://purl.org/coar/resource_type/c_6501",  # NOSONAR: Semantic web vocabulary URI
