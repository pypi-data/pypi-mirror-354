...
class Function(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "name", "version", "entrypoint", "function_schema", "run_command", "created_by_id", "status", "tool_name", "tool_versions", "operating_systems"]
