...
from relationalai.early_access.dsl.bindings.tabular import SnowflakeTable, CsvTable
...
class Model:
    def __init__(
        ...
        self.name = name
        self._qb_model = qb.Model(name, dry_run=dry_run, strict=strict, config=config)
