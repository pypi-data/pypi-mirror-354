...
class Client():
    ...
    def _query(self, code:str, task:m.Task|None, end_span, readonly=False, inputs={}, nowait_durable=None, headers={}, abort_on_error=True):
    ...
    def _query_format(self, code:str, task:m.Task, end_span, format, readonly=False, inputs={}):
    ...
    def query(self, task:m.Task, rentrant=False, read_only=False, raw_results=False, inputs={}, format="pandas", tag=None, nowait_durable=None, headers={}, internal=False, abort_on_error=True) -> DataFrame|Any:
