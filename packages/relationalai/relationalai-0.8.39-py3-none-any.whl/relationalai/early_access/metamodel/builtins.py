...
def aggregation(name: str, params: list[ir.Field], with_overloads: bool = False, overload_types: Optional[list[tuple[ir.Type, ...]]] = None):
    ...
    if with_overloads:
        ...
        if not overload_types:
            for num_type in [types.Int, types.Float, types.Decimal64, types.Decimal128]:
                type_params = []
                for param in params:
...
number_conversion_builtins = [decimal64, decimal128, int_to_float, int_to_decimal64, int_to_decimal128, float_to_int,
