...
async def create_lipsync_video_by_audio(
    avatar: Annotated[Optional[str], Field(description="Digital human avatar ID")] = None,
    avatar_video_url: Annotated[Optional[str], Field(description="URL of a video to create the avatar from")] = None,
    avatar_image_url: Annotated[Optional[str], Field(description="URL of an image to create the avatar from")] = None,
    avatar_video_file: Annotated[Optional[str], Field(description="Local path to a video file to create the avatar from")] = None,
    avatar_image_file: Annotated[Optional[str], Field(description="Local path to an image file to create the avatar from")] = None,
    audio_url: Annotated[Optional[str], Field(description="Remote URL of the audio file")] = None,
    audio_file: Annotated[Optional[str], Field(description="Local path to the audio file")] = None,
    title: Annotated[Optional[str], Field(description="Optional title for the created video")] = None,
    async_mode: Annotated[bool, Field(description="If true, returns task_id immediately")] = False,
    output_path: Annotated[str, Field(description="Where to save the downloaded video")] = DEFAULT_OUTPUT_PATH
):
    # API key validation
    if not api_key:
        return {"error": "API key not found. Please set FLYWORKS_API_TOKEN environment variable."}
...
async def create_lipsync_video_by_text(
    ...
    avatar_video_file: Annotated[Optional[str], Field(description="Local path to a video file to create the avatar from")] = None,
    avatar_image_file: Annotated[Optional[str], Field(description="Local path to an image file to create the avatar from")] = None,
    text: Annotated[str, Field(description="Text content to be spoken by the avatar", min_length=1, max_length=500)] = "",
    voice: Annotated[Optional[str], Field(description="Voice ID to use for text-to-speech")] = None,
    title: Annotated[Optional[str], Field(description="Optional title for the created video")] = None,
    async_mode: Annotated[bool, Field(description="If true, returns task_id immediately")] = False,
    output_path: Annotated[str, Field(description="Where to save the downloaded video")] = DEFAULT_OUTPUT_PATH
):
...
async def create_video_by_podcast(
    podcast_html_url: Annotated[Optional[str], Field(description="Remote URL of the podcast HTML file")] = None,
    async_mode: Annotated[bool, Field(description="If true, returns task_id immediately")] = False,
    output_path: Annotated[str, Field(description="Where to save the downloaded video")] = DEFAULT_OUTPUT_PATH
):
    # API key validation
