...
import os
#from mapps_io.common.fileName import fileName
from juice_simphony.CompositionEngine.SegmentationImporter.mapps_io.common.fileName import fileName
...
class fileHandle(fileName):
    ...
    def genFile(self):
        ...
        # Generate file name
        self.fileName = self.genBaseFileName().replace(" ", "") + "." + self.params["ext"]
