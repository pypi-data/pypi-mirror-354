...
class shtRestClient(object):
    def __init__(self, server):
        ...
        self.apikey  = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoyNCwidXNlcm5hbWUiOiJzaW1waG9ueSIsImV4cCI6MTYzNTI2MDYyMywiZW1haWwiOiIiLCJvcmlnX2lhdCI6MTYzNTI1NzAyM30.WphrNXo71oXYQ4CoVLa2-wqczh41cpU-Zd0UJXfc4iE'       
        self.reqHeader = dict()
        #return super().__init__(*args, **kwargs)

    def getApiKey(self):
        credentials = dict()
        credentials["username"] = "simphony"
        credentials["password"] = "changeme!"
        try:
           response = requests.post(self.httpServer + "/" + "api-token-auth" + "/", 
                                    json=credentials)
