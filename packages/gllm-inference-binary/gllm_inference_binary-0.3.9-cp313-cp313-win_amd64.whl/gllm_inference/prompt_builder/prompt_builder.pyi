...
class BasePromptBuilder(ABC, metaclass=abc.ABCMeta):
    ...
    def __init__(self, system_template: str = '', user_template: str = '') -> None:
        ...
        """
    def format_as_message_list(self, history: list[tuple[PromptRole, list[Any] | str]] | None = None, system_multimodal_contents: list[Any] | None = None, user_multimodal_contents: list[Any] | None = None, is_multimodal: bool = False, **kwargs: Any) -> list[tuple[PromptRole, list[Any] | str]]:
        ...
        Args:
            ...
            user_multimodal_contents (list[Any] | None, optional): The optional multimodal contents for the user
                prompt. Defaults to None.
            is_multimodal (bool, optional): Whether the prompt supports multimodal inputs. Defaults to False.
