...
from gencrafter.api.logger.result_set import SegmentedResultSet
...
from gencrafter.core.errors import UnsupportedError
from gencrafter.core.utils import deprecated_alias
...
class WhyLabsReferenceWriter(WhyLabsWriterBase):
    f"""
    A gencrafter writer to upload reference profiles onto the WhyLabs platform.
