...
from gencrafter.api.logger.experimental.logger.actor.list_util import type_batched_items
...
class Actor(ABC, Generic[MessageType]):
    ...
    This was created with thread and process based gencrafter logging in mind and it has
