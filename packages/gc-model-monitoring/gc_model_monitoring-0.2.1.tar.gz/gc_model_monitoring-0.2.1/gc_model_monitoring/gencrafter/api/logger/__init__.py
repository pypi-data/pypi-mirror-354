...
from gencrafter.api.logger.events import log_debug_event
from gencrafter.api.logger.logger import Logger
from gencrafter.api.logger.result_set import (
    ProfileResultSet,
    ResultSet,
    ResultSetReader,
    SegmentedResultSet,
)
from gencrafter.api.logger.rolling import TimedRollingLogger
from gencrafter.api.logger.segment_processing import (
    _get_segment_from_group_key,
    _grouped_dataframe,
    _log_segment,
)
from gencrafter.api.logger.transient import TransientLogger
from gencrafter.api.whylabs.session.notebook_logger import (
    notebook_session_log,
    notebook_session_log_comparison,
)
from gencrafter.core import DatasetProfile, DatasetSchema
from gencrafter.core.metadata import WHYLABS_TRACE_ID_KEY
from gencrafter.core.model_performance_metrics.model_performance_metrics import (
    ModelPerformanceMetrics,
)
from gencrafter.core.stubs import pd
from gencrafter.core.utils import deprecated_argument
...
def log_classification_metrics(
    ...
    schema : Optional[DatasetSchema], optional
        Defines the schema for tracking metrics in gencrafter, by default None
