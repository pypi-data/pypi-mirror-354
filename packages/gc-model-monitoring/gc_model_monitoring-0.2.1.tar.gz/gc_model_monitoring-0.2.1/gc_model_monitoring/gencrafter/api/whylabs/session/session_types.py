...
class InteractiveLogger:
    ...
    def __should_log(ignore_suppress: bool = False) -> bool:
        ...
        if ignore_suppress:
            ...
            return not os.environ.get("gencrafter_SUPPRESS_LOG_OUTPUT") and InteractiveLogger._is_notebook
    ...
    def message(message: str = "", log_fn: Optional[LogFunction] = None, ignore_suppress: bool = False) -> None:
        ...
        Args:
            ...
            ignore_suppress: If true, will log even if gencrafter_SUPPRESS_LOG_OUTPUT is set. It still needs
