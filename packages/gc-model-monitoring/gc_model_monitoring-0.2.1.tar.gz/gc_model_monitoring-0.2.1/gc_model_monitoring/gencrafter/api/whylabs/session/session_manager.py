...
from gencrafter.api.whylabs.session.config import InitConfig, SessionConfig
from gencrafter.api.whylabs.session.session import (
    ApiKeySession,
    GuestSession,
    LocalSession,
    Session,
...
from gencrafter.api.whylabs.session.session_types import SessionType
...
def init(
    ...
    **kwargs: bool,
    ...
    """
    Set up authentication for this gencrafter logging session. There are three modes that you can authentiate in.
    ...
    - If there is an api key in the gencrafter config file, then use it and authenticate session as WHYLABS.
    ...
    Args:
        ...
        upload_on_log: If True, and the session type is gencrafter or gencrafter_ANONYMOUS, automaticall upload the profile to WhyLabs
