...
from gencrafter.api.whylabs.session.notebook_check import is_interractive
from gencrafter.api.whylabs.session.prompts import (
    prompt_api_key,
...
from gencrafter.api.whylabs.session.session_types import ApiKeyV1, ApiKeyV2
from gencrafter.api.whylabs.session.session_types import InteractiveLogger as il
from gencrafter.api.whylabs.session.session_types import (
    SessionType,
    parse_api_key,
    parse_api_key_v2,
)
...
_CONFIG_APP_NAME = "gencrafter"
INIT_DOCS = "https://docs.whylabs.ai/docs/whylabs-gencrafter-init"
...
class EnvVariableName(Enum):
    ...
    gencrafter_CONFIG_PATH = "gencrafter_CONFIG_PATH"
...
class SessionConfig:
    ...
    def get_config_file_path(self) -> Path:
        config_dir_path = os.getenv(EnvVariableName.gencrafter_CONFIG_PATH.value)
