...
from gencrafter.context.version import gencrafter_version
from gencrafter.core.utils.timestamp_calculations import to_utc_milliseconds

diagnostic_logger = logging.getLogger(__name__)

WHYLABS_TRACE_ID_KEY = "whylabs.traceId"
CREATION_TIMESTAMP_KEY = "gencrafter.creationTimestamp"
DATASET_TIMESTAMP_KEY = "gencrafter.datasetTimestamp"
USER_TAGS_KEY = "gencrafter.user.tags"
NAME_KEY = "gencrafter.name"
gencrafter_VERSION_KEY = "gencrafter.version"
...
def _populate_common_profile_metadata(
    ...
    *,
    ...
    if gencrafter_VERSION_KEY not in metadata:
        metadata[gencrafter_VERSION_KEY] = gencrafter_version
