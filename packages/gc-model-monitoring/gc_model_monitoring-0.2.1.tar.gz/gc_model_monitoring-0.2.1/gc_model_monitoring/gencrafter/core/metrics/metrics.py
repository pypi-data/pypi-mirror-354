...
import gencrafter.core.configs as conf
from gencrafter.core.metrics.maths import (
    VarianceM2Result,
    ...
    def columnar_update(self, view: PreprocessedColumn) -> OperationResult:
        ...
        for arr in [view.numpy.floats, view.numpy.ints]:
            if arr is not None:
                ...
                successes += len(arr)
        # TODO: Include strings in above when we update gencrafter-sketching fi.update_np to take strings
