...
from gencrafter.core.proto import Segment as SegmentMessage
from gencrafter.core.segment import Segment
from gencrafter.core.segmentation_partition import SegmentationPartition
from gencrafter.core.utils import write_delimited_protobuf
...
from gencrafter.core.view.dataset_profile_view import (
    gencrafter_MAGIC_HEADER_BYTES,
    DatasetProfileView,
)
from gencrafter.migration.converters import (
...
class SegmentedDatasetProfileView(_Writable):
    ...
    def _copy_write(
        ...
        output_file.write(gencrafter_MAGIC_HEADER_BYTES)
        write_delimited_protobuf(output_file, dataset_segment_header)
        logger.debug(
            f"Writing segmented profile file: gencrafter file and segment headers wrote {output_file.tell()} bytes"
        )
