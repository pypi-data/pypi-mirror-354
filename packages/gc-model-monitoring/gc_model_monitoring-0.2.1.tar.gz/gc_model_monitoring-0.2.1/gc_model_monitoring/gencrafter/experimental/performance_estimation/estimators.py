...
from gencrafter.core import DatasetProfile, Segment
from gencrafter.core.model_performance_metrics.confusion_matrix import ConfusionMatrix
...
class AccuracyEstimator(PerformanceEstimator):
    ...
    .. code-block:: python
        ...
        from gencrafter.experimental.performance_estimation import AccuracyEstimator
        from gencrafter.api.logger.result_set import SegmentedResultSet
