...
import gencrafter.core.resolvers as res
from gencrafter.core.datatypes import StandardTypeMapper, TypeMapper
from gencrafter.core.metrics.metrics import Metric, MetricConfig
from gencrafter.core.resolvers import (
    DeclarativeResolver,
    MetricSpec,
    Resolver,
    ResolverSpec,
...
import pandas as pd
from gencrafter.core.validators.validator import Validator, deepcopy_validators
...
class DatasetSchema:
    """
    Defines the schema for tracking metrics in gencrafter.
    ...
    Attributes:
        ...
        default_configs: optional. Options to configure various behavior of gencrafter.

        type_mapper: Optional. a mapper that transates the Python type to standardized gencrafter :class:`DataType` object.

        resolvers: Optional. an object that defines how to map from a column name, a gencrafter :class:`DataType` and a
                   schema to metrics.
    ...
    >>> import pandas as pd
    >>> import numpy as np
    >>> from gencrafter.core import DatasetSchema, DatasetProfile
    >>> from gencrafter.core.resolvers import Resolver, StandardResolver
    >>>
...
class DeclarativeSchema(DatasetSchema):
    ...
    in gencrafter/python/gencrafter/core/resolvers.py
    """
