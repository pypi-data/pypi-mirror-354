...
from gencrafter.core.errors import DeserializationError, UnsupportedError
from gencrafter.core.metrics import StandardMetric
from gencrafter.core.metrics.metrics import _METRIC_DESERIALIZER_REGISTRY, Metric
from gencrafter.core.proto import ColumnMessage, MetricComponentMessage, MetricMessage
...
class ColumnProfileView(object):
    ...
    def from_protobuf(cls, msg: ColumnMessage) -> "ColumnProfileView":
        ...
        import gencrafter.experimental.core.metrics.udf_metric  # noqa

        # These require numpy & PIL, but we assume users will install
        # gencrafter with the optional dependencies and import the metric
        # modules if they want to use them. So it should be safe to
        # ignore the import failures.
        try:
            import gencrafter.experimental.extras.embedding_metric  # noqa
        except ModuleNotFoundError:
            pass
        try:
            import gencrafter.experimental.extras.nlp_metric  # noqa
        except ModuleNotFoundError:
            pass
        try:
            import gencrafter.extras.image_metric  # noqa
        except ModuleNotFoundError:
            pass
