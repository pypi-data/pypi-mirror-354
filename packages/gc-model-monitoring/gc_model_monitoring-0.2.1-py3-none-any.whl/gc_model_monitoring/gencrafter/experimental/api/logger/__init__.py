...
from gencrafter.api.logger.result_set import SegmentedResultSet, ViewResultSet
...
def log_batch_ranking_metrics(
    ...
    ::
        ...
        import pandas as pd
        from gencrafter.experimental.api.logger import log_batch_ranking_metrics
    ...
    if prediction_column is None and score_column is None and target_column is not None:
        # https://github.com/whylabs/gencrafter/issues/1505
