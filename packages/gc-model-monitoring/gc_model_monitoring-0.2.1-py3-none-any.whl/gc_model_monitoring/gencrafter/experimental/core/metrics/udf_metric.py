...
from gencrafter.core.datatypes import (
    AnyType,
    DataType,
    Fractional,
    Integral,
...
from gencrafter.core.metrics.multimetric import MultiMetric, SubmetricSchema
...
from gencrafter.core.utils import deprecated
from gencrafter.core.validators.validator import Validator
...
class UdfMetricConfig(MetricConfig):
    ...
    Attributes:
       ...
       type_mapper [optional]: maps Python types to gencrafter DataType
    """
...
class UdfMetric(MultiMetric):
    ...
    Args:
        ...
        type_mapper [optional]: maps Python types to gencrafter DataType. Defaults
...
def register_metric_udf(
    ...
    gencrafter DataTypes. This defaults to the StandardTypeMapper.
    """
