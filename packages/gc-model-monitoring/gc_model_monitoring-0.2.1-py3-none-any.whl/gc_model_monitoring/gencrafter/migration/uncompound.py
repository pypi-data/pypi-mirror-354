...
from gencrafter.core.metrics.compound_metric import CompoundMetric
from gencrafter.core.metrics.condition_count_metric import ConditionCountMetric
from gencrafter.core.metrics.metric_components import IntegralComponent
...
def _v0_compatible_image_feature_flag() -> bool:
    """
    v0 gencrafter only supported logging a single image in a profile.
