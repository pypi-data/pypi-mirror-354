...
from gencrafter.core import ColumnProfileView, DatasetProfileView
from gencrafter.core.errors import DeserializationError
from gencrafter.core.metrics import (
    ColumnCountsMetric,
    DistributionMetric,
    FrequentItemsMetric,
    IntsMetric,
...
from gencrafter.core.metrics.metric_components import (
    FractionalComponent,
...
from gencrafter.core.metrics.metrics import CardinalityMetric, Metric
from gencrafter.core.model_performance_metrics import ModelPerformanceMetrics
from gencrafter.core.proto import SegmentTag
from gencrafter.core.proto.v0 import (
    ColumnMessageV0,
    CountersV0,
...
from gencrafter.core.segment import Segment
from gencrafter.core.segmentation_partition import SegmentationPartition
from gencrafter.core.utils import read_delimited_protobuf
from gencrafter.core.utils.timestamp_calculations import to_utc_milliseconds
from gencrafter.core.view.dataset_profile_view import _TAG_PREFIX
...
def v1_to_dataset_profile_message_v0(
    ...
    properties_v0 = DatasetPropertiesV0(
        schema_major_version=1,  # https://github.com/whylabs/gencrafter/blob/maintenance/0.7.x/src/gencrafter/core/datasetprofile.py#L37-L38
