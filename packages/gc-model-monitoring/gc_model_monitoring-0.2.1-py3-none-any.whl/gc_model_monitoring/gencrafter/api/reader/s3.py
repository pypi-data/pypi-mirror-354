...
class S3Reader(Reader):
    """
    A gencrafter reader to fetch written profiles from an Amazon S3 bucket.
    ...
    profile = gen.reader("s3").option(bucket_name="my_bucket", object_name="my/object.bin").read()
    ```
    """
