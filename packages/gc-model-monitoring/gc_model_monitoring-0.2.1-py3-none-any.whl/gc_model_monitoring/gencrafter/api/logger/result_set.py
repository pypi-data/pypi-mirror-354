...
from gencrafter.api.reader import Reader, Readers
from gencrafter.api.writer.writer import WriterWrapper, _Writable
from gencrafter.core import DatasetProfile, DatasetProfileView, Segment
...
from gencrafter.core.utils import ensure_timezone
from gencrafter.core.view.dataset_profile_view import _MODEL_PERFORMANCE
from gencrafter.core.view.segmented_dataset_profile_view import SegmentedDatasetProfileView
from gencrafter.migration.converters import _generate_segment_tags_metadata
...
class ResultSet(_Writable, ABC):
    ...
    A gencrafter.log call can result in more than one profile. This wrapper class
    ...
    def get_whylabs_tags(self) -> List[SegmentTag]:
        ...
        for view in views:
            ...
            for segment_tag in segment_tags:
                tag_key = segment_tag.key.replace("gencrafter.tag.", "")
