...
from gencrafter.api.logger.result_set import ProfileResultSet, ResultSet, ViewResultSet
from gencrafter.api.writer.whylabs_client import WhyLabsClient
from gencrafter.api.writer.writer import Writer, _Writable
from gencrafter.core import DatasetProfileView
from gencrafter.core.dataset_profile import DatasetProfile
from gencrafter.core.errors import BadConfigError
from gencrafter.core.view.segmented_dataset_profile_view import SegmentedDatasetProfileView
from gencrafter.migration.uncompound import (
    FeatureFlags,
...
def _check_whylabs_condition_count_uncompound() -> bool:
    ...
    if _WHYLABS_SKIP_CONFIG_READ:
        return True
    whylabs_config_url = (
        "https://whylabs-public.s3.us-west-2.amazonaws.com/gencrafter_config/whylabs_condition_count_disabled"
    )
