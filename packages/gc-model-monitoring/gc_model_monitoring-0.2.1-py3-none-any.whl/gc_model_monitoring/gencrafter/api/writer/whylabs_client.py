...
from gencrafter.api.whylabs.session.whylabs_client_cache import (
    ClientCacheConfig,
    EnvironmentKeyRefresher,
    KeyRefresher,
    WhylabsClientCache,
)
from gencrafter.context.environ import read_bool_env_var
from gencrafter.core import DatasetProfile, DatasetProfileView
from gencrafter.core.feature_weights import FeatureWeights
from gencrafter.core.utils.utils import get_auth_headers
...
gencrafter_PREFER_SYNC_KEY = "gencrafter_PREFER_SYNC"
...
class WhyLabsClient:
    ...
    def __init__(
        ...
        self._prefer_sync = read_bool_env_var(gencrafter_PREFER_SYNC_KEY, False)
