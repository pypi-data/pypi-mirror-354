...
from gencrafter.core.view.column_profile_view import ColumnProfileView  # type: ignore
from gencrafter.core.view.dataset_profile_view import DatasetProfileView  # type: ignore
from gencrafter.migration.uncompound import _uncompound_dataset_profile
from gencrafter.viz.drift.configs import (
    ChiSquareConfig,
    DriftThresholds,
    HellingerConfig,
    KSTestConfig,
)
from gencrafter.viz.utils import _calculate_bins
...
def calculate_drift_scores(
    ...
    --------
    .. code-block:: python
        from gencrafter.viz.drift.column_drift_algorithms import Hellinger
        from gencrafter.viz.drift.configs import HellingerConfig
