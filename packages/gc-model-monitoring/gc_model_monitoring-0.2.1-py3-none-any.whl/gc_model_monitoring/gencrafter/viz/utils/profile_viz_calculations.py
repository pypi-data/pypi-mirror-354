...
from gencrafter.core.metrics import CardinalityMetric
from gencrafter.core.utils import deprecated, get_distribution_metrics
...
from gencrafter.extras.image_metric import ImageMetric
from gencrafter.viz.utils import (
    DescriptiveStatistics,
    QuantileStats,
    _calculate_descriptive_statistics,
    _calculate_quantile_statistics,
)
from gencrafter.viz.utils.descriptive_stats import _get_count_metrics_from_column_view
from gencrafter.viz.utils.drift_calculations import calculate_drift_values
from gencrafter.viz.utils.frequent_items_calculations import (
    FrequentItemEstimate,
    frequent_items_from_view,
)
from gencrafter.viz.utils.histogram_calculations import (
    HistogramSummary,
    histogram_from_view,
)
...
def generate_profile_summary(
    ...
    summaries = {
        "profile_from_gencrafter": json.dumps(target_summary),
    }
    return summaries
...
def generate_summaries_with_drift_score(
    ...
    summaries = {
        "profile_from_gencrafter": json.dumps(target_summary),
        "reference_profile_from_gencrafter": json.dumps(ref_summary),
    }
    return summaries
