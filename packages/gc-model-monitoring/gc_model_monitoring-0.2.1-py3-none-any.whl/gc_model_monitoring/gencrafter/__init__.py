"""
gencrafter is an open source library for logging any kind of data. With gencrafter, users are able to generate summaries
of their datasets (called gencrafter profiles) which they can use to:
