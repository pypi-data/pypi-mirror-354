...
# Import the advanced jailbreak templates module
try:
    ...
    print("Error: Could not import advanced_jailbreak_templates module.")
    print("Make sure the benchmarks/templates directory exists and contains advanced_jailbreak_templates.py")
    sys.exit(1)
