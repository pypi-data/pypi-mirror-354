...
class ResultsViewer:
    ...
    def delete_benchmark_results(self):
        ...
        if success:
            ...
            self.console.print("[red]Error deleting benchmark result from triksha.database.[/]")
...
def test_db_results(db_handler, console=None):
    ...
    if results:
        console.print(f"[green]✓ Successfully retrieved {len(results)} benchmark results from triksha.database.[/]")
    else:
