...
from triksha.cli.commands.dataset import DatasetCommands
from triksha.cli.commands.benchmark.command import BenchmarkCommands
from triksha.cli.commands.fix_red_teaming import RedTeamingFixCommands
from triksha.cli.core import TrikshaCLI
...
def main():
    ...
    if args.command == "dataset":
        ...
        try:
            from triksha.cli.scheduler_service import start_service, stop_service, check_status, run_as_daemon, is_running
            ...
            if args.action == "start":
                ...
                if system == "Linux":
                    from triksha.cli.scheduler_service import install_systemd_service
                    install_systemd_service()
                elif system == "Darwin":
                    from triksha.cli.scheduler_service import install_macos_service
