...
from triksha.system_monitor import setup_system_monitor  # Optional import for system monitoring
...
class TrikshaCLI:
    ...
    def main_loop(self):
        ...
        # Import silently
        try:
            from triksha.cli.logging.user_activity import log_command, log_session_start, log_session_end
        ...
        try:
            while True:
                ...
                try:
                    from triksha.cli.logging.user_activity import log_command
            ...
            try:
                from triksha.cli.logging.user_activity import log_session_end
    ...
    def user_activity_monitor(self):
        ...
        try:
            ...
            try:
                from triksha.cli.commands.monitoring.command import MonitoringCommands
                from triksha.cli.logging.user_activity import log_session_start
