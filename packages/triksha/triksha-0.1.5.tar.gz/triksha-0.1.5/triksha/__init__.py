...
A comprehensive framework for testing and evaluating the security of Large Language Models (LLMs).
Provides tools for red-teaming, benchmarking, and adversarial testing.
"""
