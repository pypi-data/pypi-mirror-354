...
from triksha.benchmarks.utils.backup_manager import BackupManager
from triksha.system_monitor import setup_system_monitor
from triksha.cli.notification.email_service import EmailNotificationService
        ...
        try:
            ...
            if benchmark_type == "custom_hf_dataset":
                ...
                try:
                    ...
                    from triksha.benchmarks.api.openai_handler import OpenAIHandler
                    from triksha.benchmarks.api.gemini_handler import GeminiHandler
                    from triksha.benchmarks.models.handlers.ollama_handler import OllamaHandler
    ...
    def _run_api_benchmark(self, config: Optional[Dict[str, Any]] = None, dataset: Optional[Dict[str, Any]] = None, resume_session: Optional[str] = None, provided_models: Optional[List[str]] = None):
        ...
        try:
            ...
            if benchmark_config and 'models' in benchmark_config:
                ...
                from triksha.benchmarks.models.model_loader import ModelLoader
            ...
            if dataset:
                ...
                if dataset_type == "static":
                    ...
                    try:
                        from triksha.benchmarks.templates.advanced_jailbreak_templates import (
                        ...
                        from triksha.benchmarks.templates.markov_jailbreak_generator import (
                        ...
                        try:
                            ...
                            from triksha.benchmarks.templates.advanced_jailbreak_templates import generate_adversarial_prompts
                    ...
                    from triksha.benchmarks.api.bypass_tester import BypassTester
            ...
            try:
                from triksha.cli.notification import EmailNotificationService
...
Status: {status}[/]
        ...
        if approach_question == "curl":
            ...
            if inquirer.confirm("Would you like to test this configuration with a sample prompt?", default=True):
                ...
                try:
                    ...
                    from triksha.benchmarks.models.handlers.custom_api_handler import CustomAPIHandler
    ...
    def _get_available_benchmark_results(self):
        ...
        try:
            self.console.print("[dim]Fetching benchmark results from triksha.database...[/]")
    ...
    def run_scheduled_benchmark_command(self, params_file=None, task_id=None):
        ...
        try:
            ...
            try:
                ...
                from triksha.benchmarks.templates.markov_jailbreak_generator import generate_diverse_adversarial_prompts
    ...
    def configure_scheduled_benchmark(self):
        ...
        try:
            import inquirer
            from datetime import datetime, timedelta
            from triksha.cli.scheduler import get_scheduler
            ...
            # Get techniques
            from triksha.benchmarks.templates.advanced_jailbreak_templates import get_template_categories
            ...
            for tech in all_individual_techniques:
                from triksha.benchmarks.templates.advanced_jailbreak_templates import get_technique_description
