...
import threading
import time
from typing import Any, AsyncGenerator, Optional, Union, Callable
...
class IOChannelHandler:
    ...
    def __init__(self, user_interrupted: Optional[Callable[[], bool]] = None) -> None:
...
class Kernel:
    ...
    async def execute_code_streaming(
        self, code: str, user_interrupted: Optional[Callable[[], bool]] = None
    ) -> AsyncGenerator[Union[StreamedOutputPiece, PythonExecutionResult], None]:
...
async def execute_python_streaming(
    code: str, kernel: Kernel, user_interrupted: Optional[Callable[[], bool]] = None
) -> AsyncGenerator[Union[StreamedOutputPiece, PythonExecutionResult], None]:
