...
def UnslothSFT(
    ...
    image: str = "public.ecr.aws/d8i6n0n1/orign/unsloth-trainer:latest",  # "ghcr.io/agentsea/orign/unsloth-train:5c28777", # "us-docker.pkg.dev/agentsea-dev/orign/unsloth-train:latest"
    scale: V1Scale = scale,
