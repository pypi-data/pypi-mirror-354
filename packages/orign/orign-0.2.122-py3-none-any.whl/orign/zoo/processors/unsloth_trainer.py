...
def passthrough_formatting_func(example: Dict[str, Any]) -> Dict[str, Any]:
    """
    The dataset is already formatted by oai_to_unsloth.
    This function just passes the example through to satisfy the SFTTrainer's
    requirement for a formatting_func for vision models.
    """
    return example
...
def add_or_load_adapter_for_model(
    ...
    )  # e.g., /nebu/cache/adapters/customer_A_adapter
    ...
    )  # e.g., /nebu/cache/adapters/customer_A_adapter/customer_A_adapter
