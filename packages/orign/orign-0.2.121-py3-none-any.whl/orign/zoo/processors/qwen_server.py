...
def QwenVLServer(
    ...
    image: str = "public.ecr.aws/d8i6n0n1/orign/unsloth-server:latest",  # "us-docker.pkg.dev/agentsea-dev/orign/unsloth-infer:latest" # "ghcr.io/agentsea/orign/unsloth-infer:5c28777",
