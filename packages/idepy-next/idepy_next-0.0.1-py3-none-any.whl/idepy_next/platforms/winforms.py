...
from idepy_next.util import inject_base_uri, parse_file_type
...
if is_cef:
    ...
    logger.warning(
        'MSHTML is deprecated. See https://idepy.flowrl.com/guide/web_engine.html on details how to use Edge Chromium'
    )
...
def create_window(window):
    ...
    def create():
        cache_dir = init_storage(window.storage_path)
