...
class BottleServer:
    ...
    def start_server(
        ...
        if keyfile and certfile:
            ...
            setattr(server_adapter, 'idepy_keyfile', keyfile)
            setattr(server_adapter, 'idepy_certfile', certfile)
        else:
...
class SSLWSGIRefServer(bottle.ServerAdapter):
    def run(self, handler: WSGIApplication) -> None:  # pragma: no cover
        ...
        ssl_context.load_cert_chain(self.idepy_certfile, self.idepy_keyfile)
