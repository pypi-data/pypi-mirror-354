...
from idepy_next.util import DEFAULT_HTML, create_cookie, interop_dll_path, js_bridge_call, inject_idepy
...
class EdgeChrome:
    def __init__(self, form, window, cache_dir):
        ...
        props.set_IsInPrivateModeEnabled(window.private_mode or _state['private_mode'])
    ...
    def clear_user_data(self):
        if not _state['private_mode'] or (self.idepy_window.private_mode is not None and not self.idepy_window.private_mode) :
            return
    ...
    def on_webview_ready(self, sender, args):
        ...
        if _state['private_mode'] or self.idepy_window.private_mode:
