...
class AzureAIInferencePlusEmbeddings(Embeddings):
    ...
    def __init__(
        ...
        **kwargs: Unpack[AzureEmbeddingsClientKwargs],
        ...
        Args:
            ...
            **kwargs: Additional Azure Embeddings Client parameters with full typing support
        """
        super().__init__()
    ...
    def embed_documents(
        self, texts: List[str], **kwargs: Unpack[AzureEmbeddingsClientKwargs]
    ) -> List[List[float]]:
        """Generate embeddings for a list of documents.

        Args:
            texts: List of texts to embed
            **kwargs: Additional parameters for the embeddings client
    ...
    def embed_query(
        self, text: str, **kwargs: Unpack[AzureEmbeddingsClientKwargs]
    ) -> List[float]:
...
def create_azure_chat_model(
    ...
    **kwargs: Unpack[AzureChatCompletionsClientKwargs],
    ...
    Args:
        ...
        connection_timeout: Connection timeout in seconds
        **kwargs: Additional Azure Chat Completions Client parameters with full typing support
...
def create_azure_llm(
    ...
    **kwargs: Unpack[AzureChatCompletionsClientKwargs],
    ...
    """Create an Azure AI Inference Plus LLM with enhanced features.
    ...
    Returns:
        Configured AzureAIInferencePlusLLM instance
    """
...
__all__ = [
    ...
    "AzureKeyCredential",
    "JsonSchemaFormat",
    # TypedDict classes for better kwargs typing
    "AzureChatCompletionsClientKwargs",
    "AzureEmbeddingsClientKwargs",
