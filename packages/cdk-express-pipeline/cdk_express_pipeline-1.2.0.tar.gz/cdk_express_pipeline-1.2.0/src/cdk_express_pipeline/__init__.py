...
class CdkExpressPipeline(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        :param separator: Separator between the wave, stage and stack ids that are concatenated to form the stack id. Default: __
    ...
    def add_wave(self, id: builtins.str) -> "ExpressWave":
        ...
        return typing.cast("ExpressWave", jsii.invoke(self, "addWave", [id]))

    @jsii.member(jsii_name="printWaves")
    def print_waves(self, waves: typing.Sequence["ExpressWave"]) -> None:
    ...
    def synth(
        ...
        return typing.cast(None, jsii.invoke(self, "synth", [waves, print]))

    @builtins.property
    @jsii.member(jsii_name="waves")
    def waves(self) -> typing.List["ExpressWave"]:
        return typing.cast(typing.List["ExpressWave"], jsii.get(self, "waves"))
...
class CdkExpressPipelineLegacy(
    ...
    @jsii.member(jsii_name="addWave")
    def add_wave(self, id: builtins.str) -> "ExpressWaveLegacy":
        '''Add a wave to the pipeline.
        ...
        if __debug__:
            ...
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        return typing.cast("ExpressWaveLegacy", jsii.invoke(self, "addWave", [id]))
...
class ExpressWave(
    ...
    def __init__(
        ...
        if __debug__:
            ...
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument separator", value=separator, expected_type=type_hints["separator"])
        jsii.create(self.__class__, self, [id, separator])
...
class ExpressWaveLegacy(
    ...
    def __init__(
        self,
        id: builtins.str,
        stages: typing.Optional[typing.Sequence[IExpressStageLegacy]] = None,
    ) -> None:
        '''
        :param id: -
        :param stages: -
        ...
        jsii.create(self.__class__, self, [id, stages])
...
def _typecheckingstub__e18d77fb9496cb5fdeabb0fe5a14c3dcd08b7a4747694ac0a799b01dfa105a34(
    waves: typing.Sequence[ExpressWave],
) -> None:
    """Type checking stubs"""
    pass
