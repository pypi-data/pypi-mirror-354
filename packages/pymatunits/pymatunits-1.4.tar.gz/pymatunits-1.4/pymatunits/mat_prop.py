...
class Composite(object):
    ...
    def __init__(self, name: str, ply_materials: list,
        ...
        self.layup_thickness_ = convert(unit_system, layup_thickness, 'length',
                                        True)
...
class Material(object):
    ...
    def __init__(self, name: str, unit_system: UnitSystem, rho: Quantity,
        ...
        self._unit_system = unit_system
        self.rho = rho
        self.rho_ = convert(unit_system, rho, 'density', True)
        if tref is None:
            tref = ROOM_TEMP
        self.tref = tref
        self.tref_ = convert(unit_system, tref, 'temperature', True)
        self._mat = None
...
class EngineeringConstants(Material):
    ...
    def __init__(self, name: str, unit_system: UnitSystem, rho: Quantity,
        ...
        self.E1 = E1
        self.E1_ = convert(unit_system, E1, 'pressure', True)
        self.E2 = E2
        self.E2_ = convert(unit_system, E2, 'pressure', True)
        self.E3 = E3
        self.E3_ = convert(unit_system, E3, 'pressure', True)
        self.nu12 = float(nu12)
        self.nu13 = float(nu13)
        self.nu23 = float(nu23)
        self.G12 = G12
        self.G12_ = convert(unit_system, G12, 'pressure', True)
        self.G13 = G13
        self.G13_ = convert(unit_system, G13, 'pressure', True)
        self.G23 = G23
        self.G23_ = convert(unit_system, G23, 'pressure', True)
        self.Xt = Xt
        self.Xt_ = convert(unit_system, Xt, 'pressure', True)
        self.Xc = Xc
        self.Xc_ = convert(unit_system, Xc, 'pressure', True)
        self.Yt = Yt
        self.Yt_ = convert(unit_system, Yt, 'pressure', True)
        self.Yc = Yc
        self.Yc_ = convert(unit_system, Yc, 'pressure', True)
        self.S = S
        self.S_ = convert(unit_system, S, 'pressure', True)
...
class Fluid(Material):
    ...
    def __init__(self, name: str, unit_system: UnitSystem, rho: Quantity,
        ...
        if pref is None:
            pref = Q_(1.0, 'atm')
        self.pref = pref
        self.pref_ = convert(unit_system, pref, 'pressure', True)
        self.bulk_modulus = bulk_modulus
        self.bulk_modulus_ = convert(unit_system, bulk_modulus, 'pressure',
                                     True)
        self.c = c
        self.c_ = convert(unit_system, c, 'speed', True)
        self.ge = float(ge)
...
class Isotropic(Material):
    ...
    def __init__(self, name: str, unit_system: UnitSystem, rho: Quantity,
        ...
        self.E = E
        self.E_ = convert(unit_system, E, 'pressure', True)
        self.G = G
        self.G_ = convert(unit_system, G, 'pressure', True)
        if nu is not None:
            nu = float(nu)
        ...
        self.Xc_ = convert(unit_system, Xc, 'pressure', True)
        self.Xs = Xs
        self.Xs_ = convert(unit_system, Xs, 'pressure', True)
...
class Lamina(Material):
    ...
    def __init__(self, name: str, unit_system: UnitSystem, rho: Quantity,
        ...
        self.Yc_ = convert(unit_system, Yc, 'pressure', True)
        self.SL = SL
        self.SL_ = convert(unit_system, SL, 'pressure', True)
        self.St = St
        self.St_ = convert(unit_system, St, 'pressure', True)
        self.Gft = Gft
        self.Gft_ = convert(unit_system, Gft, 'energy', True)
        self.Gfc = Gfc
        self.Gfc_ = convert(unit_system, Gfc, 'energy', True)
        self.Gmf = Gmf
        self.Gmf_ = convert(unit_system, Gmf, 'energy', True)
        self.Gmc = Gmc
        self.Gmc_ = convert(unit_system, Gmc, 'energy', True)
...
class Traction(Material):
    ...
    def __init__(self, name: str, unit_system: UnitSystem, rho: Quantity,
        ...
        self.Enn = Enn
        self.Enn_ = convert(unit_system, Enn, 'pressure', True)
        self.Ess = Ess
        self.Ess_ = convert(unit_system, Ess, 'pressure', True)
        self.Ett = Ett
        self.Ett_ = convert(unit_system, Ett, 'pressure', True)
        self.tn = tn
        self.tn_ = convert(unit_system, tn, 'pressure', True)
        self.ts = ts
        self.ts_ = convert(unit_system, ts, 'pressure', True)
        self.tt = tt
        self.tt_ = convert(unit_system, tt, 'pressure', True)
        self.Gn = Gn
        self.Gn_ = convert(unit_system, Gn, 'energy', True)
        self.Gs = Gs
        self.Gs_ = convert(unit_system, Gs, 'energy', True)
        self.Gt = Gt
        self.Gt_ = convert(unit_system, Gt, 'energy', True)
        self.bk = float(bk)
