...
def convert(unit_system, value, unit_str, magnitude=False):
    ...
    value : Union[float, Quantity, None]
    ...
    if value is not None:
        ...
        try:
            ...
            corrections, _ = unit_system.check_consistency(True)
            try:
...
class UnitSystem(object):
    ...
    def check_consistency(self, _return_log=False):
        """
