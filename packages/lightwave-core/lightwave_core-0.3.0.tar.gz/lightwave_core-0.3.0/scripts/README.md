...
2. **CLI Commands**  
   ...
   sprint-manager [command] [options]
   ...
   Run `sprint-manager --help` or `node scripts/dev.js --help` to see detailed usage information.
...
sprint-manager list --status=pending

# List tasks and include their subtasks
sprint-manager list --with-subtasks

# List tasks with a specific status and include their subtasks
sprint-manager list --status=pending --with-subtasks
```
...
sprint-manager update --from=4 --prompt="Refactor tasks from ID 4 onward to use Express instead of Fastify"

# Update all tasks (default from=1)
sprint-manager update --prompt="Add authentication to all relevant tasks"

# Specify a different tasks file
sprint-manager update --file=custom-tasks.json --from=5 --prompt="Change database from MongoDB to PostgreSQL"
```
...
```bash
# Mark a task as done
sprint-manager set-status --id=3 --status=done

# Mark a task as pending
sprint-manager set-status --id=4 --status=pending

# Mark a specific subtask as done
sprint-manager set-status --id=3.1 --status=done

# Mark multiple tasks at once
sprint-manager set-status --id=1,2,3 --status=done
```
...
sprint-manager clear-subtasks --id=3

# Clear subtasks from multiple tasks
sprint-manager clear-subtasks --id=1,2,3

# Clear subtasks from all tasks
sprint-manager clear-subtasks --all
```
...
sprint-manager add-dependency --id=<id> --depends-on=<id>

# Remove a dependency from a task
sprint-manager remove-dependency --id=<id> --depends-on=<id>
```
...
sprint-manager validate-dependencies

# Specify a different tasks file
sprint-manager validate-dependencies --file=custom-tasks.json
```
...
sprint-manager fix-dependencies

# Specify a different tasks file
sprint-manager fix-dependencies --file=custom-tasks.json
```
...
sprint-manager analyze-complexity

# Specify a custom output file
sprint-manager analyze-complexity --output=custom-report.json

# Override the model used for analysis
sprint-manager analyze-complexity --model=claude-3-opus-20240229

# Set a custom complexity threshold (1-10)
sprint-manager analyze-complexity --threshold=6

# Use Perplexity AI for research-backed complexity analysis
sprint-manager analyze-complexity --research
```
  ...
  "complexityAnalysis": [
    {
      ...
      "expansionCommand": "sprint-manager expand --id=8 --num=6 --prompt=\"Create subtasks...\" --research"
    },
...
# Specify a different tasks file
sprint-manager next --file=custom-tasks.json
```
...
sprint-manager show 1

# Alternative syntax with --id option
sprint-manager show --id=1

# Show details for a subtask
sprint-manager show --id=1.2

# Specify a different tasks file
sprint-manager show 3 --file=custom-tasks.json
```
