'''
pyAsciiEngine, (c) Arizel79
https://github.com/Arizel79/asciiMultiplayerSnakeGame
        ...
        if isFill:
            ...
            for y in range(y1, y2):
                if y in [y1, y2 - 1]:
                    ...
                    self.setStr(x1, y, symbol.symbol, symbol.style)
                    self.setStr(x2 - 1, y, symbol.symbol, symbol.style)
            # self.setStr(x1, y2, symbol.symbol * (x2 - x1), symbol.style)
...
def main():
    ...
    while running:
        ...
        scr.setText(w // 2, h // 2, """Hello, world!\nПривет, мир!\n1234567890\n-----\n""" * 3,
                    TextStyle("black", "red"), anchor_x=Anchors.CENTER_X_ANCHOR, anchor_y=Anchors.CENTER_Y_ANCHOR)
