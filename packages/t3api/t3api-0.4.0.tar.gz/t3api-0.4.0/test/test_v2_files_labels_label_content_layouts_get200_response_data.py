...
class TestV2FilesLabelsLabelContentLayoutsGet200ResponseData(unittest.TestCase):
    """V2FilesLabelsLabelContentLayoutsGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2FilesLabelsLabelContentLayoutsGet200ResponseData:
        """Test V2FilesLabelsLabelContentLayoutsGet200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2FilesLabelsLabelContentLayoutsGet200ResponseData`
        """
        model = V2FilesLabelsLabelContentLayoutsGet200ResponseData()
        if include_optional:
            return V2FilesLabelsLabelContentLayoutsGet200ResponseData(
                data = [
    ...
    def testV2FilesLabelsLabelContentLayoutsGet200ResponseData(self):
        """Test V2FilesLabelsLabelContentLayoutsGet200ResponseData"""
