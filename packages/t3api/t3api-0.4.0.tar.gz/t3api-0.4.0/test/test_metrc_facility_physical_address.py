...
class TestMetrcFacilityPhysicalAddress(unittest.TestCase):
    """MetrcFacilityPhysicalAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcFacilityPhysicalAddress:
        """Test MetrcFacilityPhysicalAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcFacilityPhysicalAddress`
        """
        model = MetrcFacilityPhysicalAddress()
        if include_optional:
            return MetrcFacilityPhysicalAddress(
                id = 53213,
                license_id = 0,
    ...
    def testMetrcFacilityPhysicalAddress(self):
        """Test MetrcFacilityPhysicalAddress"""
