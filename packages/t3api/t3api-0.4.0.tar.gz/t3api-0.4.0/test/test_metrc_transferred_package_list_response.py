...
class TestMetrcTransferredPackageListResponse(unittest.TestCase):
    """MetrcTransferredPackageListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcTransferredPackageListResponse:
        """Test MetrcTransferredPackageListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcTransferredPackageListResponse`
        """
        model = MetrcTransferredPackageListResponse()
        if include_optional:
            return MetrcTransferredPackageListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcTransferredPackageListResponse(self):
        """Test MetrcTransferredPackageListResponse"""
