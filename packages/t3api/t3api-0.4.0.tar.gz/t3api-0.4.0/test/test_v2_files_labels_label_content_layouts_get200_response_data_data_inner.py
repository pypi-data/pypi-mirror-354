...
class TestV2FilesLabelsLabelContentLayoutsGet200ResponseDataDataInner(unittest.TestCase):
    """V2FilesLabelsLabelContentLayoutsGet200ResponseDataDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2FilesLabelsLabelContentLayoutsGet200ResponseDataDataInner:
        """Test V2FilesLabelsLabelContentLayoutsGet200ResponseDataDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2FilesLabelsLabelContentLayoutsGet200ResponseDataDataInner`
        """
        model = V2FilesLabelsLabelContentLayoutsGet200ResponseDataDataInner()
        if include_optional:
            return V2FilesLabelsLabelContentLayoutsGet200ResponseDataDataInner(
                id = 'COL_CODE128_TEXT',
    ...
    def testV2FilesLabelsLabelContentLayoutsGet200ResponseDataDataInner(self):
        """Test V2FilesLabelsLabelContentLayoutsGet200ResponseDataDataInner"""
