...
class TestV2AuthSecretkeyPostRequest(unittest.TestCase):
    """V2AuthSecretkeyPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2AuthSecretkeyPostRequest:
        """Test V2AuthSecretkeyPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2AuthSecretkeyPostRequest`
        """
        model = V2AuthSecretkeyPostRequest()
        if include_optional:
            return V2AuthSecretkeyPostRequest(
                username = 'johndoe',
                password = 'secretpassword',
                hostname = 'ca.metrc.com',
                otp_seed = 'J3G5KD9W8ZT2LV6X'
            )
        else:
            return V2AuthSecretkeyPostRequest(
        )
    ...
    def testV2AuthSecretkeyPostRequest(self):
        """Test V2AuthSecretkeyPostRequest"""
