...
class TestV2ItemsDiscontinuePost400Response(unittest.TestCase):
    """V2ItemsDiscontinuePost400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2ItemsDiscontinuePost400Response:
        """Test V2ItemsDiscontinuePost400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2ItemsDiscontinuePost400Response`
        """
        model = V2ItemsDiscontinuePost400Response()
        if include_optional:
            return V2ItemsDiscontinuePost400Response(
                error = t3api.models._v2_items_discontinue_post_400_response_error._v2_items_discontinue_post_400_response_error(
                    type = 'BadRequest', 
                    message = '400 Bad Request: Invalid request body: 'note' is a required property', 
                    timestamp = '2024-08-09T12:34:56.789Z', 
                    url = 'https://api.trackandtrace.tools/some-endpoint', 
                    status_code = 400, )
            )
        else:
            return V2ItemsDiscontinuePost400Response(
    ...
    def testV2ItemsDiscontinuePost400Response(self):
        """Test V2ItemsDiscontinuePost400Response"""
