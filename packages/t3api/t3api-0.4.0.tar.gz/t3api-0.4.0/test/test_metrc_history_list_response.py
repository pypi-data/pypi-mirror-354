...
class TestMetrcHistoryListResponse(unittest.TestCase):
    """MetrcHistoryListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcHistoryListResponse:
        """Test MetrcHistoryListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcHistoryListResponse`
        """
        model = MetrcHistoryListResponse()
        if include_optional:
            return MetrcHistoryListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcHistoryListResponse(self):
        """Test MetrcHistoryListResponse"""
