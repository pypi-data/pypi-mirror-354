...
class TestMetrcTransferTransporterDetails(unittest.TestCase):
    """MetrcTransferTransporterDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcTransferTransporterDetails:
        """Test MetrcTransferTransporterDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcTransferTransporterDetails`
        """
        model = MetrcTransferTransporterDetails()
        if include_optional:
            return MetrcTransferTransporterDetails(
    ...
    def testMetrcTransferTransporterDetails(self):
        """Test MetrcTransferTransporterDetails"""
