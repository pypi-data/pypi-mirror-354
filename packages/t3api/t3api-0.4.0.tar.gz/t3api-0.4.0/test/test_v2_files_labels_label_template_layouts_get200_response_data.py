...
class TestV2FilesLabelsLabelTemplateLayoutsGet200ResponseData(unittest.TestCase):
    """V2FilesLabelsLabelTemplateLayoutsGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2FilesLabelsLabelTemplateLayoutsGet200ResponseData:
        """Test V2FilesLabelsLabelTemplateLayoutsGet200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2FilesLabelsLabelTemplateLayoutsGet200ResponseData`
        """
        model = V2FilesLabelsLabelTemplateLayoutsGet200ResponseData()
        if include_optional:
            return V2FilesLabelsLabelTemplateLayoutsGet200ResponseData(
                data = [
    ...
    def testV2FilesLabelsLabelTemplateLayoutsGet200ResponseData(self):
        """Test V2FilesLabelsLabelTemplateLayoutsGet200ResponseData"""
