...
class TestMetrcSalesReceipt(unittest.TestCase):
    """MetrcSalesReceipt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcSalesReceipt:
        """Test MetrcSalesReceipt
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcSalesReceipt`
        """
        model = MetrcSalesReceipt()
        if include_optional:
            return MetrcSalesReceipt(
                id = 1234567,
    ...
    def testMetrcSalesReceipt(self):
        """Test MetrcSalesReceipt"""
