...
class TestPlantBatchesApi(unittest.TestCase):
    """PlantBatchesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PlantBatchesApi()

    def tearDown(self) -> None:
        pass

    def test_v2_plantbatches_active_get(self) -> None:
        """Test case for v2_plantbatches_active_get
    ...
    def test_v2_plantbatches_history_get(self) -> None:
        """Test case for v2_plantbatches_history_get

        List of history objects for a single plant batch
        """
        pass

    def test_v2_plantbatches_inactive_get(self) -> None:
        """Test case for v2_plantbatches_inactive_get

        List of inactive plantbatches
        """
        pass

    def test_v2_plantbatches_onhold_get(self) -> None:
        """Test case for v2_plantbatches_onhold_get
