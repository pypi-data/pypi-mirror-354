...
class TestV2TransfersOutgoingManifestReportGet200Response(unittest.TestCase):
    """V2TransfersOutgoingManifestReportGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2TransfersOutgoingManifestReportGet200Response:
        """Test V2TransfersOutgoingManifestReportGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2TransfersOutgoingManifestReportGet200Response`
        """
        model = V2TransfersOutgoingManifestReportGet200Response()
        if include_optional:
            return V2TransfersOutgoingManifestReportGet200Response(
                generated_at = '2024-07-25T00:00Z',
                filters = ["manifestNumber__endswith:0003","productName__contains:kush"],
                filter_logic = 'and',
                sort = 'label:asc',
                license_number = 'LIC-00001',
                data = [
                    t3api.models.t3_outgoing_transfer_manifest.T3OutgoingTransferManifest(
                        transfer/data_model = 'MetrcPackage', 
                        transfer/retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        transfer/license_number = '', 
                        transfer/index = 'ACTIVE_OUTGOING_TRANSFER', 
                        transfer/id = 1234567, 
                        transfer/manifest_number = '0001234567', 
                        transfer/shipment_license_type_name = 'Licensed', 
                        transfer/shipper_facility_license_number = 'LIC-00002', 
                        transfer/shipper_facility_name = 'Fire Manufacturing, Inc.', 
                        transfer/name = '', 
                        transfer/transporter_facility_license_number = '', 
                        transfer/transporter_facility_name = '', 
                        transfer/driver_name = '', 
                        transfer/driver_occupational_license_number = '', 
                        transfer/driver_vehicle_license_number = '', 
                        transfer/vehicle_make = '', 
                        transfer/vehicle_model = '', 
                        transfer/vehicle_license_plate_number = '', 
                        transfer/delivery_facilities = 'LIC-00001 (Dank Dispensary LLC)', 
                        transfer/delivery_count = 1, 
                        transfer/received_delivery_count = 0, 
                        transfer/package_count = 8, 
                        transfer/received_package_count = 0, 
                        transfer/contains_plant_package = False, 
                        transfer/contains_product_package = True, 
                        transfer/contains_trade_sample = False, 
                        transfer/contains_donation = False, 
                        transfer/contains_testing_sample = False, 
                        transfer/contains_product_requires_remediation = False, 
                        transfer/contains_remediated_product_package = False, 
                        transfer/edit_count = 1, 
                        transfer/can_edit = True, 
                        transfer/can_edit_outgoing_inactive = False, 
                        transfer/is_voided = False, 
                        transfer/created_date_time = '2024-07-25T13:00Z', 
                        transfer/created_by_user_name = 'Mike Smith', 
                        transfer/last_modified = '2024-07-25T00:00Z', 
                        transfer/delivery_id = 1234566, 
                        transfer/recipient_facility_id = 456, 
                        transfer/recipient_facility_license_number = 'LIC-00001', 
                        transfer/recipient_facility_name = 'Dank Dispensary LLC', 
                        transfer/shipment_type_name = 'Unaffiliated Transfer', 
                        transfer/shipment_transaction_type_name = 'Wholesale', 
                        transfer/estimated_departure_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        transfer/actual_departure_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        transfer/estimated_arrival_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        transfer/actual_arrival_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        transfer/delivery_package_count = 8, 
                        transfer/delivery_received_package_count = 0, 
                        transfer/received_by_name = '', 
                        transfer/received_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        transfer/estimated_return_departure_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        transfer/actual_return_departure_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        transfer/estimated_return_arrival_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        transfer/actual_return_arrival_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        transfer/rejected_packages_returned = False, 
                        transfer/transporter_all_approval_date = '2024-07-25T13:00Z', 
                        transfer/destinations_all_approval_date = '2024-07-25T13:00Z', 
                        transfer/transporters_automatically_approved = True, 
                        transfer/destinations_automatically_approved = True, 
                        transfer/approval_reject_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        transfer/approval_rejected_by_user = 'Mike Smith', 
                        transfer/approval_rejected_facility_license_number = '', 
                        transfer/approval_reject_reason_id = '', 
                        transfer/tolling_agreement_file_system_id = 0, 
                        transfer/invoice_number = '', 
                        transporter/data_model = 'MetrcPackage', 
                        transporter/retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        transporter/license_number = '', 
                        transporter/transporter_facility_license_number = 'LIC-00001', 
                        transporter/transporter_facility_name = 'Dank Dispensary LLC', 
                        transporter/transporter_direction_name = 'Outbound', 
                        transporter/transporter_approval_date = '2024-07-26T13:00Z', 
                        transporter/transporter_auto_approval = True, 
                        transporter/driver_name = 'John Doe', 
                        transporter/driver_occupational_license_number = 'DL123456789', 
                        transporter/driver_vehicle_license_number = 'ABC1234', 
                        transporter/driver_layover_leg = '', 
                        transporter/vehicle_make = 'Ford', 
                        transporter/vehicle_model = 'F-150', 
                        transporter/vehicle_license_plate_number = 'XYZ7890', 
                        transporter/accepted_date_time = '2024-07-26T13:00-05:00', 
                        transporter/is_layover = False, 
                        transporter/estimated_departure_date_time = '2024-07-26T14:00Z', 
                        transporter/actual_departure_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        transporter/estimated_arrival_date_time = '2024-07-26T15:00Z', 
                        transporter/actual_arrival_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        transporter_details/data_model = 'MetrcPackage', 
                        transporter_details/retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        transporter_details/license_number = '', 
                        transporter_details/shipment_plan_id = 12345, 
                        transporter_details/shipment_delivery_id = 67890, 
                        transporter_details/transporter_direction = 'Outbound', 
                        transporter_details/transporter_facility_id = 54321, 
                        transporter_details/line_number = 1, 
                        transporter_details/driver_name = 'John Doe', 
                        transporter_details/driver_occupational_license_number = 'AB1234567', 
                        transporter_details/driver_vehicle_license_number = 'XYZ987654', 
                        transporter_details/driver_layover_leg = 'Leg1', 
                        transporter_details/vehicle_make = 'Ford', 
                        transporter_details/vehicle_model = 'Transit', 
                        transporter_details/vehicle_license_plate_number = 'XYZ-1234', 
                        transporter_details/actual_driver_start_date_time = '2024-07-26T08:30Z', 
                        transporter_details/is_voided = False, 
                        transporter_details/received_date_time = '2024-07-25T18:47:20Z', 
                        transporter_details/received_delivery_count = 1, 
                        delivery/id = 12345, 
                        delivery/data_model = 'MetrcPackage', 
                        delivery/retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        delivery/license_number = '', 
                        delivery/actual_arrival_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        delivery/actual_departure_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        delivery/actual_return_arrival_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        delivery/actual_return_departure_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        delivery/delivery_package_count = 5, 
                        delivery/delivery_received_package_count = 4, 
                        delivery/estimated_arrival_date_time = '2024-07-25T15:30Z', 
                        delivery/estimated_departure_date_time = '2024-07-25T13:30Z', 
                        delivery/estimated_return_arrival_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        delivery/estimated_return_departure_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        delivery/gross_unit_of_weight_abbreviation = 'kg', 
                        delivery/gross_unit_of_weight_id = 1, 
                        delivery/gross_weight = 100.5, 
                        delivery/planned_route = 'Route A', 
                        delivery/received_by_name = '', 
                        delivery/received_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        delivery/recipient_facility_id = 456, 
                        delivery/recipient_facility_license_number = 'AB12345', 
                        delivery/recipient_facility_name = 'Facility A', 
                        delivery/rejected_packages_returned = False, 
                        delivery/shipment_transaction_type_name = 'Regular', 
                        delivery/shipment_type_name = 'Transfer', 
                        delivery/recipient_approval_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        delivery/recipient_auto_approval = False, 
                        delivery/tolling_agreement_file_system_id = 0, 
                        delivery/invoice_number = '', 
                        package/id = 1234567, 
                        package/data_model = 'MetrcPackage', 
                        package/retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        package/license_number = '', 
                        package/index = 'TRANSFERRED_PACKAGE', 
                        package/package_id = 9876543, 
                        package/recipient_facility_license_number = 'LIC-00001', 
                        package/recipient_facility_name = 'Dank Dispensary LLC', 
                        package/manifest_number = '0001234567', 
                        package/package_label = '1A4000000000000000006310', 
                        package/source_harvest_names = 'Sunset Sherbet', 
                        package/source_package_labels = '1A4000000000000000005267', 
                        package/product_name = 'Sunset Sherbet | 3.5g', 
                        package/product_category_name = 'Bud/Flower (Final Packaging)', 
                        package/item_strain_name = 'Sunset Sherbet', 
                        package/lab_testing_state_name = 'TestPassed', 
                        package/shipped_quantity = 1224.0, 
                        package/shipped_unit_of_measure_abbreviation = 'g', 
                        package/gross_weight = 224.0, 
                        package/gross_unit_of_weight_abbreviation = 'g', 
                        package/shipper_wholesale_price = 1.337, 
                        package/received_quantity = 1224.0, 
                        package/received_unit_of_measure_abbreviation = 'g', 
                        package/receiver_wholesale_price = 1.337, 
                        package/shipment_package_state_name = 'Accepted', 
                        package/actual_departure_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        package/received_date_time = '2024-07-26T00:00-05:00', 
                        package/processing_job_type_name = '', )
                    ]
            )
        else:
            return V2TransfersOutgoingManifestReportGet200Response(
    ...
    def testV2TransfersOutgoingManifestReportGet200Response(self):
        """Test V2TransfersOutgoingManifestReportGet200Response"""
