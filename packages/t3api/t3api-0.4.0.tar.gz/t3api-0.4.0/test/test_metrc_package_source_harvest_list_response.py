...
class TestMetrcPackageSourceHarvestListResponse(unittest.TestCase):
    """MetrcPackageSourceHarvestListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcPackageSourceHarvestListResponse:
        """Test MetrcPackageSourceHarvestListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcPackageSourceHarvestListResponse`
        """
        model = MetrcPackageSourceHarvestListResponse()
        if include_optional:
            return MetrcPackageSourceHarvestListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcPackageSourceHarvestListResponse(self):
        """Test MetrcPackageSourceHarvestListResponse"""
