...
class TestV2FilesLabelsGeneratePostRequestRenderingOptions(unittest.TestCase):
    """V2FilesLabelsGeneratePostRequestRenderingOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2FilesLabelsGeneratePostRequestRenderingOptions:
        """Test V2FilesLabelsGeneratePostRequestRenderingOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2FilesLabelsGeneratePostRequestRenderingOptions`
        """
        model = V2FilesLabelsGeneratePostRequestRenderingOptions()
        if include_optional:
            return V2FilesLabelsGeneratePostRequestRenderingOptions(
                debug = True,
                enable_promo = True,
    ...
    def testV2FilesLabelsGeneratePostRequestRenderingOptions(self):
        """Test V2FilesLabelsGeneratePostRequestRenderingOptions"""
