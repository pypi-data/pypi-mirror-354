...
class TestV2PackagesNotesPostRequestInner(unittest.TestCase):
    """V2PackagesNotesPostRequestInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2PackagesNotesPostRequestInner:
        """Test V2PackagesNotesPostRequestInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2PackagesNotesPostRequestInner`
        """
        model = V2PackagesNotesPostRequestInner()
        if include_optional:
            return V2PackagesNotesPostRequestInner(
                id = 12345,
    ...
    def testV2PackagesNotesPostRequestInner(self):
        """Test V2PackagesNotesPostRequestInner"""
