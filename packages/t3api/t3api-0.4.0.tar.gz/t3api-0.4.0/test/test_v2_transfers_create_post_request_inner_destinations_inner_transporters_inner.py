...
class TestV2TransfersCreatePostRequestInnerDestinationsInnerTransportersInner(unittest.TestCase):
    """V2TransfersCreatePostRequestInnerDestinationsInnerTransportersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2TransfersCreatePostRequestInnerDestinationsInnerTransportersInner:
        """Test V2TransfersCreatePostRequestInnerDestinationsInnerTransportersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2TransfersCreatePostRequestInnerDestinationsInnerTransportersInner`
        """
        model = V2TransfersCreatePostRequestInnerDestinationsInnerTransportersInner()
        if include_optional:
            return V2TransfersCreatePostRequestInnerDestinationsInnerTransportersInner(
    ...
    def testV2TransfersCreatePostRequestInnerDestinationsInnerTransportersInner(self):
        """Test V2TransfersCreatePostRequestInnerDestinationsInnerTransportersInner"""
