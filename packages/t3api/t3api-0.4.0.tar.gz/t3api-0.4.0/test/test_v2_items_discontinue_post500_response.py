...
class TestV2ItemsDiscontinuePost500Response(unittest.TestCase):
    """V2ItemsDiscontinuePost500Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2ItemsDiscontinuePost500Response:
        """Test V2ItemsDiscontinuePost500Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2ItemsDiscontinuePost500Response`
        """
        model = V2ItemsDiscontinuePost500Response()
        if include_optional:
            return V2ItemsDiscontinuePost500Response(
                error = t3api.models._v2_items_discontinue_post_500_response_error._v2_items_discontinue_post_500_response_error(
    ...
    def testV2ItemsDiscontinuePost500Response(self):
        """Test V2ItemsDiscontinuePost500Response"""
