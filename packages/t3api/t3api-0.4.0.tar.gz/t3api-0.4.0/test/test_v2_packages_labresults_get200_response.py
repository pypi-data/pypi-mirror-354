...
class TestV2PackagesLabresultsGet200Response(unittest.TestCase):
    """V2PackagesLabresultsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2PackagesLabresultsGet200Response:
        """Test V2PackagesLabresultsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2PackagesLabresultsGet200Response`
        """
        model = V2PackagesLabresultsGet200Response()
        if include_optional:
            return V2PackagesLabresultsGet200Response(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testV2PackagesLabresultsGet200Response(self):
        """Test V2PackagesLabresultsGet200Response"""
