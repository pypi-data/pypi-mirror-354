...
class TestV2ItemsDiscontinuePost400ResponseError(unittest.TestCase):
    """V2ItemsDiscontinuePost400ResponseError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2ItemsDiscontinuePost400ResponseError:
        """Test V2ItemsDiscontinuePost400ResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2ItemsDiscontinuePost400ResponseError`
        """
        model = V2ItemsDiscontinuePost400ResponseError()
        if include_optional:
            return V2ItemsDiscontinuePost400ResponseError(
                type = 'BadRequest',
    ...
    def testV2ItemsDiscontinuePost400ResponseError(self):
        """Test V2ItemsDiscontinuePost400ResponseError"""
