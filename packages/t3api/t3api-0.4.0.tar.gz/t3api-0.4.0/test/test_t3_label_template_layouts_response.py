...
class TestT3LabelTemplateLayoutsResponse(unittest.TestCase):
    """T3LabelTemplateLayoutsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> T3LabelTemplateLayoutsResponse:
        """Test T3LabelTemplateLayoutsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `T3LabelTemplateLayoutsResponse`
        """
        model = T3LabelTemplateLayoutsResponse()
        if include_optional:
            return T3LabelTemplateLayoutsResponse(
    ...
    def testT3LabelTemplateLayoutsResponse(self):
        """Test T3LabelTemplateLayoutsResponse"""
