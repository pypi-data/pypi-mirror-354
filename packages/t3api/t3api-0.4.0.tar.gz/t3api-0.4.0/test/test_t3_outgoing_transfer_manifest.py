...
class TestT3OutgoingTransferManifest(unittest.TestCase):
    """T3OutgoingTransferManifest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> T3OutgoingTransferManifest:
        """Test T3OutgoingTransferManifest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `T3OutgoingTransferManifest`
        """
        model = T3OutgoingTransferManifest()
        if include_optional:
            return T3OutgoingTransferManifest(
                ...
                transfer_index = 'ACTIVE_OUTGOING_TRANSFER',
                transfer_id = 1234567,
                ...
                transporter_details_data_model = 'MetrcPackage',
                transporter_details_retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                transporter_details_license_number = '',
                transporter_details_shipment_plan_id = 12345,
                transporter_details_shipment_delivery_id = 67890,
                transporter_details_transporter_direction = 'Outbound',
                transporter_details_transporter_facility_id = 54321,
                transporter_details_line_number = 1,
                transporter_details_driver_name = 'John Doe',
                transporter_details_driver_occupational_license_number = 'AB1234567',
                transporter_details_driver_vehicle_license_number = 'XYZ987654',
                transporter_details_driver_layover_leg = 'Leg1',
                transporter_details_vehicle_make = 'Ford',
                transporter_details_vehicle_model = 'Transit',
                transporter_details_vehicle_license_plate_number = 'XYZ-1234',
                transporter_details_actual_driver_start_date_time = '2024-07-26T08:30Z',
                transporter_details_is_voided = False,
                transporter_details_received_date_time = '2024-07-25T18:47:20Z',
                transporter_details_received_delivery_count = 1,
                delivery_id = 12345,
                delivery_data_model = 'MetrcPackage',
                delivery_retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                delivery_license_number = '',
                delivery_actual_arrival_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                delivery_actual_departure_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                delivery_actual_return_arrival_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                delivery_actual_return_departure_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                delivery_delivery_package_count = 5,
                delivery_delivery_received_package_count = 4,
                delivery_estimated_arrival_date_time = '2024-07-25T15:30Z',
                delivery_estimated_departure_date_time = '2024-07-25T13:30Z',
                delivery_estimated_return_arrival_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                delivery_estimated_return_departure_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                delivery_gross_unit_of_weight_abbreviation = 'kg',
                delivery_gross_unit_of_weight_id = 1,
                delivery_gross_weight = 100.5,
                delivery_planned_route = 'Route A',
                delivery_received_by_name = '',
                delivery_received_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                delivery_recipient_facility_id = 456,
                delivery_recipient_facility_license_number = 'AB12345',
                delivery_recipient_facility_name = 'Facility A',
                delivery_rejected_packages_returned = False,
                delivery_shipment_transaction_type_name = 'Regular',
                delivery_shipment_type_name = 'Transfer',
                delivery_recipient_approval_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                delivery_recipient_auto_approval = False,
                delivery_tolling_agreement_file_system_id = 0,
    ...
    def testT3OutgoingTransferManifest(self):
        """Test T3OutgoingTransferManifest"""
