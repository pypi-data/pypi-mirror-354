...
class TestV2SalesActiveReportGet200Response(unittest.TestCase):
    """V2SalesActiveReportGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2SalesActiveReportGet200Response:
        """Test V2SalesActiveReportGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2SalesActiveReportGet200Response`
        """
        model = V2SalesActiveReportGet200Response()
        if include_optional:
            return V2SalesActiveReportGet200Response(
                generated_at = '2024-07-25T00:00Z',
                filters = ["receiptNumber__endswith:0003"],
                filter_logic = 'and',
                sort = 'receiptNumber:asc',
                license_number = 'LIC-00001',
                data = [
                    t3api.models.metrc_sales_receipt.MetrcSalesReceipt(
                        id = 1234567, 
                        hostname = 'ca.metrc.com', 
                        data_model = 'MetrcPackage', 
                        retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        license_number = '', 
                        index = 'ACTIVE_SALES_RECEIPT', 
                        receipt_number = '001234567', 
                        sales_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        sales_customer_type = 'Consumer', 
                        sales_customer_type_name = 'Consumer', 
                        patient_license_number = '', 
                        caregiver_license_number = '', 
                        identification_method = '', 
                        patient_registration_location_id = 56, 
                        total_packages = 4, 
                        total_price = 113.0, 
                        transactions = [], 
                        is_final = False, 
                        ...
                        recorded_date_time = '2024-09-05T21:00Z', 
                        recorded_by_user_name = 'Randy Mcfadden', 
                        last_modified = '2024-09-05T21:00Z', )
                    ]
            )
        else:
            return V2SalesActiveReportGet200Response(
    ...
    def testV2SalesActiveReportGet200Response(self):
        """Test V2SalesActiveReportGet200Response"""
