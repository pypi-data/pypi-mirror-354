...
class TestV2FilesLabelsGeneratePostRequestLabelContentDataInner(unittest.TestCase):
    """V2FilesLabelsGeneratePostRequestLabelContentDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2FilesLabelsGeneratePostRequestLabelContentDataInner:
        """Test V2FilesLabelsGeneratePostRequestLabelContentDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2FilesLabelsGeneratePostRequestLabelContentDataInner`
        """
        model = V2FilesLabelsGeneratePostRequestLabelContentDataInner()
        if include_optional:
            return V2FilesLabelsGeneratePostRequestLabelContentDataInner(
                text1 = 'text1',
                text2 = 'text2',
                text3 = 'text3',
                text4 = 'text4',
    ...
    def testV2FilesLabelsGeneratePostRequestLabelContentDataInner(self):
        """Test V2FilesLabelsGeneratePostRequestLabelContentDataInner"""
