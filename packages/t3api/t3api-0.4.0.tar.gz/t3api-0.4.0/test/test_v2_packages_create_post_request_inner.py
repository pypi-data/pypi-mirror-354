...
class TestV2PackagesCreatePostRequestInner(unittest.TestCase):
    """V2PackagesCreatePostRequestInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2PackagesCreatePostRequestInner:
        """Test V2PackagesCreatePostRequestInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2PackagesCreatePostRequestInner`
        """
        model = V2PackagesCreatePostRequestInner()
        if include_optional:
            return V2PackagesCreatePostRequestInner(
                actual_date = 'Wed Aug 07 19:00:00 CDT 2024',
                ingredients = [
                    t3api.models._v2_packages_create_post_request_inner_ingredients_inner._v2_packages_create_post_request_inner_ingredients_inner(
                        finish_date = 'Wed Aug 07 19:00:00 CDT 2024', 
                        package_id = 5077333, 
                        quantity = 56.3, 
                ...
                item_id = 1160223,
                location_id = 50901,
                note = 'This is a package note',
                production_batch_number = 'BATCH 1234',
                quantity = 123.45,
                tag_id = 1527333,
                ...
                sell_by_date = 'Wed Aug 07 19:00:00 CDT 2024'
            )
        else:
            return V2PackagesCreatePostRequestInner(
                actual_date = 'Wed Aug 07 19:00:00 CDT 2024',
    ...
    def testV2PackagesCreatePostRequestInner(self):
        """Test V2PackagesCreatePostRequestInner"""
