...
class TestMetrcSalesReceiptListResponse(unittest.TestCase):
    """MetrcSalesReceiptListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcSalesReceiptListResponse:
        """Test MetrcSalesReceiptListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcSalesReceiptListResponse`
        """
        model = MetrcSalesReceiptListResponse()
        if include_optional:
            return MetrcSalesReceiptListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcSalesReceiptListResponse(self):
        """Test MetrcSalesReceiptListResponse"""
