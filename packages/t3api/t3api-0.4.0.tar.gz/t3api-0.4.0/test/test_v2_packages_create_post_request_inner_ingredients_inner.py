...
class TestV2PackagesCreatePostRequestInnerIngredientsInner(unittest.TestCase):
    """V2PackagesCreatePostRequestInnerIngredientsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2PackagesCreatePostRequestInnerIngredientsInner:
        """Test V2PackagesCreatePostRequestInnerIngredientsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2PackagesCreatePostRequestInnerIngredientsInner`
        """
        model = V2PackagesCreatePostRequestInnerIngredientsInner()
        if include_optional:
            return V2PackagesCreatePostRequestInnerIngredientsInner(
    ...
    def testV2PackagesCreatePostRequestInnerIngredientsInner(self):
        """Test V2PackagesCreatePostRequestInnerIngredientsInner"""
