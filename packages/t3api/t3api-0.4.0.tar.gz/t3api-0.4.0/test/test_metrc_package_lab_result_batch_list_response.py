...
class TestMetrcPackageLabResultBatchListResponse(unittest.TestCase):
    """MetrcPackageLabResultBatchListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcPackageLabResultBatchListResponse:
        """Test MetrcPackageLabResultBatchListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcPackageLabResultBatchListResponse`
        """
        model = MetrcPackageLabResultBatchListResponse()
        if include_optional:
            return MetrcPackageLabResultBatchListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcPackageLabResultBatchListResponse(self):
        """Test MetrcPackageLabResultBatchListResponse"""
