...
class TestMetrcPackageLabResultListResponse(unittest.TestCase):
    """MetrcPackageLabResultListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcPackageLabResultListResponse:
        """Test MetrcPackageLabResultListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcPackageLabResultListResponse`
        """
        model = MetrcPackageLabResultListResponse()
        if include_optional:
            return MetrcPackageLabResultListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcPackageLabResultListResponse(self):
        """Test MetrcPackageLabResultListResponse"""
