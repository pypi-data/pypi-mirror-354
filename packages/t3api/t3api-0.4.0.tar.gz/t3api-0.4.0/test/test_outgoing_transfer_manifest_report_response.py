...
class TestOutgoingTransferManifestReportResponse(unittest.TestCase):
    """OutgoingTransferManifestReportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutgoingTransferManifestReportResponse:
        """Test OutgoingTransferManifestReportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutgoingTransferManifestReportResponse`
        """
        model = OutgoingTransferManifestReportResponse()
        if include_optional:
            return OutgoingTransferManifestReportResponse(
    ...
    def testOutgoingTransferManifestReportResponse(self):
        """Test OutgoingTransferManifestReportResponse"""
