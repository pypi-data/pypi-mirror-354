...
class TestV2FilesLabelsLabelTemplateLayoutsGet200Response(unittest.TestCase):
    """V2FilesLabelsLabelTemplateLayoutsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2FilesLabelsLabelTemplateLayoutsGet200Response:
        """Test V2FilesLabelsLabelTemplateLayoutsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2FilesLabelsLabelTemplateLayoutsGet200Response`
        """
        model = V2FilesLabelsLabelTemplateLayoutsGet200Response()
        if include_optional:
            return V2FilesLabelsLabelTemplateLayoutsGet200Response(
                data = t3api.models._v2_files_labels_label_template_layouts_get_200_response_data._v2_files_labels_label_template_layouts_get_200_response_data(
                    data = [
                        t3api.models._v2_files_labels_label_template_layouts_get_200_response_data_data_inner._v2_files_labels_label_template_layouts_get_200_response_data_data_inner(
                            id = 10, 
                            label_template_layout_id = 'AVERY_8160__2_625Wx1_0H', 
                            description = '8.5"x11" sheet of Avery 8160 labels (2.625"x1")', 
                            requires_t3plus = False, 
                            enabled = True, 
                            visible = True, 
                            printer_types = ["LASER","INKJET"], 
                            label_template_layout_config = t3api.models._v2_files_labels_label_template_layouts_get_200_response_data_data_inner_label_template_layout_config._v2_files_labels_label_template_layouts_get_200_response_data_data_inner_labelTemplateLayoutConfig(
                                num_rows = 10, 
                                x_gap_in = 0.125, 
                                y_gap_in = 0.0, 
                                num_columns = 3, 
                                ...
                                label_height_in = 1.0, 
                                label_padding_xin = 0.0625, 
                                label_padding_yin = 0.0625, 
                                page_margin_top_in = 0.5, 
                                page_margin_left_in = 0.1875, ), )
                        ], )
            )
        else:
            return V2FilesLabelsLabelTemplateLayoutsGet200Response(
    ...
    def testV2FilesLabelsLabelTemplateLayoutsGet200Response(self):
        """Test V2FilesLabelsLabelTemplateLayoutsGet200Response"""
