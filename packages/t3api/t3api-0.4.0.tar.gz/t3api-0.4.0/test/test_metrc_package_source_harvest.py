...
class TestMetrcPackageSourceHarvest(unittest.TestCase):
    """MetrcPackageSourceHarvest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcPackageSourceHarvest:
        """Test MetrcPackageSourceHarvest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcPackageSourceHarvest`
        """
        model = MetrcPackageSourceHarvest()
        if include_optional:
            return MetrcPackageSourceHarvest(
    ...
    def testMetrcPackageSourceHarvest(self):
        """Test MetrcPackageSourceHarvest"""
