...
class TestT3LabelContentLayoutsResponse(unittest.TestCase):
    """T3LabelContentLayoutsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> T3LabelContentLayoutsResponse:
        """Test T3LabelContentLayoutsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `T3LabelContentLayoutsResponse`
        """
        model = T3LabelContentLayoutsResponse()
        if include_optional:
            return T3LabelContentLayoutsResponse(
    ...
    def testT3LabelContentLayoutsResponse(self):
        """Test T3LabelContentLayoutsResponse"""
