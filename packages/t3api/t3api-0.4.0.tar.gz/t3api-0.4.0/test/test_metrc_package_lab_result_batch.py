...
class TestMetrcPackageLabResultBatch(unittest.TestCase):
    """MetrcPackageLabResultBatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcPackageLabResultBatch:
        """Test MetrcPackageLabResultBatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcPackageLabResultBatch`
        """
        model = MetrcPackageLabResultBatch()
        if include_optional:
            return MetrcPackageLabResultBatch(
    ...
    def testMetrcPackageLabResultBatch(self):
        """Test MetrcPackageLabResultBatch"""
