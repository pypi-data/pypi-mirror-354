...
class TestMetrcSalesReceiptReportResponse(unittest.TestCase):
    """MetrcSalesReceiptReportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcSalesReceiptReportResponse:
        """Test MetrcSalesReceiptReportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcSalesReceiptReportResponse`
        """
        model = MetrcSalesReceiptReportResponse()
        if include_optional:
            return MetrcSalesReceiptReportResponse(
    ...
    def testMetrcSalesReceiptReportResponse(self):
        """Test MetrcSalesReceiptReportResponse"""
