...
class TestT3LabelContentDataListResponse(unittest.TestCase):
    """T3LabelContentDataListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> T3LabelContentDataListResponse:
        """Test T3LabelContentDataListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `T3LabelContentDataListResponse`
        """
        model = T3LabelContentDataListResponse()
        if include_optional:
            return T3LabelContentDataListResponse(
                data = [
    ...
    def testT3LabelContentDataListResponse(self):
        """Test T3LabelContentDataListResponse"""
