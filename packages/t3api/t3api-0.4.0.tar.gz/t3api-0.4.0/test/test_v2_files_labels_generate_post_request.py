...
class TestV2FilesLabelsGeneratePostRequest(unittest.TestCase):
    """V2FilesLabelsGeneratePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2FilesLabelsGeneratePostRequest:
        """Test V2FilesLabelsGeneratePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2FilesLabelsGeneratePostRequest`
        """
        model = V2FilesLabelsGeneratePostRequest()
        if include_optional:
            return V2FilesLabelsGeneratePostRequest(
    ...
    def testV2FilesLabelsGeneratePostRequest(self):
        """Test V2FilesLabelsGeneratePostRequest"""
