...
class TestMetrcTransferTransporterListResponse(unittest.TestCase):
    """MetrcTransferTransporterListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcTransferTransporterListResponse:
        """Test MetrcTransferTransporterListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcTransferTransporterListResponse`
        """
        model = MetrcTransferTransporterListResponse()
        if include_optional:
            return MetrcTransferTransporterListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcTransferTransporterListResponse(self):
        """Test MetrcTransferTransporterListResponse"""
