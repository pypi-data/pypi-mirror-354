...
class MetrcFacilityPhysicalAddress(BaseModel):
    """
    Physical address of the facility.
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier of the address.")
    license_id: Optional[StrictInt] = Field(default=None, description="License identifier associated with the address.", alias="licenseId")
    address_type: Optional[StrictStr] = Field(default=None, description="Type of the address (e.g., Physical).", alias="addressType")
    recipient: Optional[StrictStr] = Field(default=None, description="Name of the recipient at the address.")
    contact_phone_number: Optional[StrictStr] = Field(default=None, description="Contact phone number for the address.", alias="contactPhoneNumber")
    street1: Optional[StrictStr] = Field(default=None, description="First line of the street address.")
    street2: Optional[StrictStr] = Field(default=None, description="Second line of the street address (optional).")
    street3: Optional[StrictStr] = Field(default=None, description="Third line of the street address (optional).")
    street4: Optional[StrictStr] = Field(default=None, description="Fourth line of the street address (optional).")
    city: Optional[StrictStr] = Field(default=None, description="City of the address.")
    county: Optional[StrictStr] = Field(default=None, description="County of the address.")
    state: Optional[StrictStr] = Field(default=None, description="State of the address.")
    postal_code: Optional[StrictStr] = Field(default=None, description="Postal code of the address.", alias="postalCode")
    country: Optional[StrictStr] = Field(default=None, description="Country of the address (optional).")
    assessor_parcel_number: Optional[StrictStr] = Field(default=None, description="Assessor parcel number for the address (optional).", alias="assessorParcelNumber")
    is_default_shipping_address: Optional[StrictBool] = Field(default=None, description="Indicates whether the address is the default shipping address.", alias="isDefaultShippingAddress")
    is_validated: Optional[StrictBool] = Field(default=None, description="Indicates whether the address has been validated.", alias="isValidated")
    is_archived: Optional[StrictBool] = Field(default=None, description="Indicates whether the address is archived.", alias="isArchived")
    __properties: ClassVar[List[str]] = ["id", "licenseId", "addressType", "recipient", "contactPhoneNumber", "street1", "street2", "street3", "street4", "city", "county", "state", "postalCode", "country", "assessorParcelNumber", "isDefaultShippingAddress", "isValidated", "isArchived"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assessorParcelNumber": obj.get("assessorParcelNumber"),
            "isDefaultShippingAddress": obj.get("isDefaultShippingAddress"),
