...
class MetrcTransferTransporter(BaseModel):
    """
    ...
    transporter_facility_license_number: Optional[StrictStr] = Field(default=None, description="The license number of the transporter's facility.", alias="transporterFacilityLicenseNumber")
    transporter_facility_name: Optional[StrictStr] = Field(default=None, description="The name of the transporter's facility.", alias="transporterFacilityName")
    transporter_direction_name: Optional[StrictStr] = Field(default=None, description="The direction of the transporter.", alias="transporterDirectionName")
    transporter_approval_date: Optional[datetime] = Field(default=None, description="The date and time when the transporter was approved.", alias="transporterApprovalDate")
    transporter_auto_approval: Optional[StrictBool] = Field(default=None, description="Indicates if the transporter was automatically approved.", alias="transporterAutoApproval")
    driver_name: Optional[StrictStr] = Field(default=None, description="The name of the driver.", alias="driverName")
    driver_occupational_license_number: Optional[StrictStr] = Field(default=None, description="The occupational license number of the driver.", alias="driverOccupationalLicenseNumber")
    driver_vehicle_license_number: Optional[StrictStr] = Field(default=None, description="The vehicle license number of the driver.", alias="driverVehicleLicenseNumber")
    driver_layover_leg: Optional[StrictStr] = Field(default=None, description="Information about the driver's layover leg.", alias="driverLayoverLeg")
    vehicle_make: Optional[StrictStr] = Field(default=None, description="The make of the vehicle.", alias="vehicleMake")
    vehicle_model: Optional[StrictStr] = Field(default=None, description="The model of the vehicle.", alias="vehicleModel")
    vehicle_license_plate_number: Optional[StrictStr] = Field(default=None, description="The license plate number of the vehicle.", alias="vehicleLicensePlateNumber")
    accepted_date_time: Optional[datetime] = Field(default=None, description="The date and time when the transporter was accepted.", alias="acceptedDateTime")
    is_layover: Optional[StrictBool] = Field(default=None, description="Indicates if the transport includes a layover.", alias="isLayover")
    estimated_departure_date_time: Optional[datetime] = Field(default=None, description="The estimated date and time of departure.", alias="estimatedDepartureDateTime")
    actual_departure_date_time: Optional[datetime] = Field(default=None, description="The actual date and time of departure.", alias="actualDepartureDateTime")
    estimated_arrival_date_time: Optional[datetime] = Field(default=None, description="The estimated date and time of arrival.", alias="estimatedArrivalDateTime")
    actual_arrival_date_time: Optional[datetime] = Field(default=None, description="The actual date and time of arrival.", alias="actualArrivalDateTime")
    __properties: ClassVar[List[str]] = ["hostname", "dataModel", "retrievedAt", "licenseNumber", "transporterFacilityLicenseNumber", "transporterFacilityName", "transporterDirectionName", "transporterApprovalDate", "transporterAutoApproval", "driverName", "driverOccupationalLicenseNumber", "driverVehicleLicenseNumber", "driverLayoverLeg", "vehicleMake", "vehicleModel", "vehicleLicensePlateNumber", "acceptedDateTime", "isLayover", "estimatedDepartureDateTime", "actualDepartureDateTime", "estimatedArrivalDateTime", "actualArrivalDateTime"]

    @field_validator('transporter_direction_name')
    def transporter_direction_name_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if driver_layover_leg (nullable) is None
        # and model_fields_set contains the field
        if self.driver_layover_leg is None and "driver_layover_leg" in self.model_fields_set:
            _dict['driverLayoverLeg'] = None

        # set to None if accepted_date_time (nullable) is None
        # and model_fields_set contains the field
        if self.accepted_date_time is None and "accepted_date_time" in self.model_fields_set:
            _dict['acceptedDateTime'] = None

        # set to None if estimated_departure_date_time (nullable) is None
        # and model_fields_set contains the field
        if self.estimated_departure_date_time is None and "estimated_departure_date_time" in self.model_fields_set:
            _dict['estimatedDepartureDateTime'] = None
        ...
        # set to None if estimated_arrival_date_time (nullable) is None
        # and model_fields_set contains the field
        if self.estimated_arrival_date_time is None and "estimated_arrival_date_time" in self.model_fields_set:
            _dict['estimatedArrivalDateTime'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transporterDirectionName": obj.get("transporterDirectionName"),
            "transporterApprovalDate": obj.get("transporterApprovalDate"),
            "transporterAutoApproval": obj.get("transporterAutoApproval"),
            ...
            "driverLayoverLeg": obj.get("driverLayoverLeg"),
            ...
            "acceptedDateTime": obj.get("acceptedDateTime"),
            "isLayover": obj.get("isLayover"),
