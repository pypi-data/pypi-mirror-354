...
class V2FilesLabelsLabelTemplateLayoutsGet200ResponseDataDataInner(BaseModel):
    """
    V2FilesLabelsLabelTemplateLayoutsGet200ResponseDataDataInner
    """ # noqa: E501
    id: Optional[StrictInt] = None
    label_template_layout_id: Optional[StrictStr] = Field(default=None, alias="labelTemplateLayoutId")
    description: Optional[StrictStr] = None
    requires_t3plus: Optional[StrictBool] = Field(default=None, alias="requiresT3plus")
    enabled: Optional[StrictBool] = None
    visible: Optional[StrictBool] = None
    printer_types: Optional[List[StrictStr]] = Field(default=None, alias="printerTypes")
    label_template_layout_config: Optional[V2FilesLabelsLabelTemplateLayoutsGet200ResponseDataDataInnerLabelTemplateLayoutConfig] = Field(default=None, alias="labelTemplateLayoutConfig")
    __properties: ClassVar[List[str]] = ["id", "labelTemplateLayoutId", "description", "requiresT3plus", "enabled", "visible", "printerTypes", "labelTemplateLayoutConfig"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requiresT3plus": obj.get("requiresT3plus"),
            "enabled": obj.get("enabled"),
            "visible": obj.get("visible"),
            "printerTypes": obj.get("printerTypes"),
            "labelTemplateLayoutConfig": V2FilesLabelsLabelTemplateLayoutsGet200ResponseDataDataInnerLabelTemplateLayoutConfig.from_dict(obj["labelTemplateLayoutConfig"]) if obj.get("labelTemplateLayoutConfig") is not None else None
        })
        return _obj
