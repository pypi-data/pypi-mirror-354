...
class V2FilesLabelsLabelTemplateLayoutsGet200ResponseData(BaseModel):
    """
    V2FilesLabelsLabelTemplateLayoutsGet200ResponseData
    """ # noqa: E501
    data: Optional[List[V2FilesLabelsLabelTemplateLayoutsGet200ResponseDataDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [V2FilesLabelsLabelTemplateLayoutsGet200ResponseDataDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
