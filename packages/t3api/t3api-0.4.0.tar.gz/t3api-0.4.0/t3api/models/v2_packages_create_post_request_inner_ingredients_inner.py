...
class V2PackagesCreatePostRequestInnerIngredientsInner(BaseModel):
    """
    V2PackagesCreatePostRequestInnerIngredientsInner
    """ # noqa: E501
    finish_date: Optional[date] = Field(default=None, description="If you are using the rest of an ingredient package and wish to finish it, pass a finish date. ", alias="finishDate")
    package_id: StrictInt = Field(description="Package ID of the source ingredient package To find source ingredient packages, use the [Source Packages](#/Create%20Package/get_v2_packages_create_source_packages) endpoint. ", alias="packageId")
    quantity: Union[StrictFloat, StrictInt] = Field(description="Quantity used from the ingredient package.")
    unit_of_measure_id: StrictInt = Field(description="Unit of measure for the quantity", alias="unitOfMeasureId")
    __properties: ClassVar[List[str]] = ["finishDate", "packageId", "quantity", "unitOfMeasureId"]
