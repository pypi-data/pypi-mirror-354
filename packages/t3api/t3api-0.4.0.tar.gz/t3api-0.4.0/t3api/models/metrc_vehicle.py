...
class MetrcVehicle(BaseModel):
    """
    MetrcVehicle
    """ # noqa: E501
    facility_id: Optional[StrictInt] = Field(default=None, description="Facility identifier.", alias="facilityId")
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the vehicle.")
    is_archived: Optional[StrictBool] = Field(default=None, description="Indicates if the vehicle is archived.", alias="isArchived")
    last_modified: Optional[datetime] = Field(default=None, description="Date and time the vehicle information was last modified.", alias="lastModified")
    ...
    __properties: ClassVar[List[str]] = ["facilityId", "id", "isArchived", "lastModified", "licensePlateNumber", "make", "model"]
