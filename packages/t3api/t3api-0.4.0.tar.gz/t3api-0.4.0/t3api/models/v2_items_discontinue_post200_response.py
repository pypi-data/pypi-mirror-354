...
class V2ItemsDiscontinuePost200Response(BaseModel):
    """
    V2ItemsDiscontinuePost200Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Describes the nature of this successful operation - \"Success\" indicates the request passed validation and was successfully passed to Metrc - \"Dry run\" indicates the request passed validation, but the request was not sent to Metrc ")
