...
class MetrcPackageLabResult(BaseModel):
    """
    ...
    lab_test_result_id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the lab test result.", alias="labTestResultId")
    lab_facility_license_number: Optional[StrictStr] = Field(default=None, description="License number of the lab facility.", alias="labFacilityLicenseNumber")
    lab_facility_name: Optional[StrictStr] = Field(default=None, description="Name of the lab facility.", alias="labFacilityName")
    source_package_label: Optional[StrictStr] = Field(default=None, description="Label of the source package.", alias="sourcePackageLabel")
    product_name: Optional[StrictStr] = Field(default=None, description="Name of the product.", alias="productName")
    product_category_name: Optional[StrictStr] = Field(default=None, description="Category name of the product.", alias="productCategoryName")
    test_performed_date: Optional[date] = Field(default=None, description="Date when the test was performed.", alias="testPerformedDate")
    overall_passed: Optional[StrictBool] = Field(default=None, description="Indicates if the overall test was passed.", alias="overallPassed")
    is_revoked: Optional[StrictBool] = Field(default=None, description="Indicates if the test result has been revoked.", alias="isRevoked")
    revoked_date: Optional[datetime] = Field(default=None, description="Date when the test result was revoked, if applicable.", alias="revokedDate")
    lab_test_result_document_file_id: Optional[StrictInt] = Field(default=None, description="Identifier for the document file of the lab test result.", alias="labTestResultDocumentFileId")
    result_released: Optional[StrictBool] = Field(default=None, description="Indicates if the test result has been released.", alias="resultReleased")
    result_release_date_time: Optional[datetime] = Field(default=None, description="Date and time when the test result was released.", alias="resultReleaseDateTime")
    expiration_date_time: Optional[datetime] = Field(default=None, description="Expiration date and time for the test result, if applicable.", alias="expirationDateTime")
    lab_test_detail_id: Optional[StrictInt] = Field(default=None, description="Identifier for the detailed lab test result.", alias="labTestDetailId")
    test_type_name: Optional[StrictStr] = Field(default=None, description="Name of the test type.", alias="testTypeName")
    test_passed: Optional[StrictBool] = Field(default=None, description="Indicates if the specific test was passed.", alias="testPassed")
    test_result_level: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Level of the test result.", alias="testResultLevel")
    test_comment: Optional[StrictStr] = Field(default=None, description="Comments on the test result.", alias="testComment")
    test_informational_only: Optional[StrictBool] = Field(default=None, description="Indicates if the test result is for informational purposes only.", alias="testInformationalOnly")
    lab_test_detail_is_revoked: Optional[StrictBool] = Field(default=None, description="Indicates if the detailed lab test result has been revoked.", alias="labTestDetailIsRevoked")
    lab_test_detail_revoked_date: Optional[datetime] = Field(default=None, description="Date when the detailed lab test result was revoked, if applicable.", alias="labTestDetailRevokedDate")
    lab_test_result_last_modified: Optional[datetime] = Field(default=None, description="Date and time when the lab test result was last modified.", alias="labTestResultLastModified")
    __properties: ClassVar[List[str]] = ["hostname", "dataModel", "retrievedAt", "licenseNumber", "packageId", "labTestResultId", "labFacilityLicenseNumber", "labFacilityName", "sourcePackageLabel", "productName", "productCategoryName", "testPerformedDate", "overallPassed", "isRevoked", "revokedDate", "labTestResultDocumentFileId", "resultReleased", "resultReleaseDateTime", "expirationDateTime", "labTestDetailId", "testTypeName", "testPassed", "testResultLevel", "testComment", "testInformationalOnly", "labTestDetailIsRevoked", "labTestDetailRevokedDate", "labTestResultLastModified"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if revoked_date (nullable) is None
        # and model_fields_set contains the field
        if self.revoked_date is None and "revoked_date" in self.model_fields_set:
            _dict['revokedDate'] = None
        ...
        # set to None if lab_test_detail_revoked_date (nullable) is None
        # and model_fields_set contains the field
        if self.lab_test_detail_revoked_date is None and "lab_test_detail_revoked_date" in self.model_fields_set:
            _dict['labTestDetailRevokedDate'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "labTestResultId": obj.get("labTestResultId"),
            "labFacilityLicenseNumber": obj.get("labFacilityLicenseNumber"),
            "labFacilityName": obj.get("labFacilityName"),
            "sourcePackageLabel": obj.get("sourcePackageLabel"),
            "productName": obj.get("productName"),
            "productCategoryName": obj.get("productCategoryName"),
            "testPerformedDate": obj.get("testPerformedDate"),
            "overallPassed": obj.get("overallPassed"),
            "isRevoked": obj.get("isRevoked"),
            "revokedDate": obj.get("revokedDate"),
            "labTestResultDocumentFileId": obj.get("labTestResultDocumentFileId"),
            "resultReleased": obj.get("resultReleased"),
            "resultReleaseDateTime": obj.get("resultReleaseDateTime"),
            "expirationDateTime": obj.get("expirationDateTime"),
            "labTestDetailId": obj.get("labTestDetailId"),
            "testTypeName": obj.get("testTypeName"),
            "testPassed": obj.get("testPassed"),
            "testResultLevel": obj.get("testResultLevel"),
            "testComment": obj.get("testComment"),
            "testInformationalOnly": obj.get("testInformationalOnly"),
            "labTestDetailIsRevoked": obj.get("labTestDetailIsRevoked"),
            "labTestDetailRevokedDate": obj.get("labTestDetailRevokedDate"),
            "labTestResultLastModified": obj.get("labTestResultLastModified")
        })
        return _obj
