...
class MetrcTransferTransporterDetails(BaseModel):
    """
    ...
    shipment_plan_id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the shipment plan.", alias="shipmentPlanId")
    shipment_delivery_id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the shipment delivery.", alias="shipmentDeliveryId")
    transporter_direction: Optional[StrictStr] = Field(default=None, description="Direction of the transporter.", alias="transporterDirection")
    transporter_facility_id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the transporter facility.", alias="transporterFacilityId")
    line_number: Optional[StrictInt] = Field(default=None, description="Line number in the shipment details.", alias="lineNumber")
    ...
    driver_vehicle_license_number: Optional[StrictStr] = Field(default=None, description="Vehicle license number of the driver.", alias="driverVehicleLicenseNumber")
    driver_layover_leg: Optional[StrictStr] = Field(default=None, description="Layover leg details for the driver, if applicable.", alias="driverLayoverLeg")
    vehicle_make: Optional[StrictStr] = Field(default=None, description="Make of the vehicle.", alias="vehicleMake")
    vehicle_model: Optional[StrictStr] = Field(default=None, description="Model of the vehicle.", alias="vehicleModel")
    ...
    actual_driver_start_date_time: Optional[datetime] = Field(default=None, description="Actual start date and time for the driver.", alias="actualDriverStartDateTime")
    is_voided: Optional[StrictBool] = Field(default=None, description="Indicates if the record is voided.", alias="isVoided")
    ...
    received_delivery_count: Optional[StrictInt] = Field(default=None, description="The number of deliveries received.", alias="receivedDeliveryCount")
    __properties: ClassVar[List[str]] = ["hostname", "dataModel", "retrievedAt", "licenseNumber", "shipmentPlanId", "shipmentDeliveryId", "transporterDirection", "transporterFacilityId", "lineNumber", "driverName", "driverOccupationalLicenseNumber", "driverVehicleLicenseNumber", "driverLayoverLeg", "vehicleMake", "vehicleModel", "vehicleLicensePlateNumber", "actualDriverStartDateTime", "isVoided", "receivedDateTime", "receivedDeliveryCount"]

    @field_validator('transporter_direction')
    def transporter_direction_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if actual_driver_start_date_time (nullable) is None
        # and model_fields_set contains the field
        if self.actual_driver_start_date_time is None and "actual_driver_start_date_time" in self.model_fields_set:
            _dict['actualDriverStartDateTime'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shipmentPlanId": obj.get("shipmentPlanId"),
            "shipmentDeliveryId": obj.get("shipmentDeliveryId"),
            "transporterDirection": obj.get("transporterDirection"),
            "transporterFacilityId": obj.get("transporterFacilityId"),
            ...
            "actualDriverStartDateTime": obj.get("actualDriverStartDateTime"),
