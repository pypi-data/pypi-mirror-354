...
class MetrcPackageSourceHarvest(BaseModel):
    """
    ...
    harvested_by_facility_license_number: Optional[StrictStr] = Field(default=None, alias="harvestedByFacilityLicenseNumber")
    harvested_by_facility_name: Optional[StrictStr] = Field(default=None, alias="harvestedByFacilityName")
    name: Optional[StrictStr] = None
    harvest_type_name: Optional[StrictStr] = Field(default=None, alias="harvestTypeName")
    lab_testing_state_name: Optional[StrictStr] = Field(default=None, alias="labTestingStateName")
    lab_testing_state_date: Optional[StrictStr] = Field(default=None, alias="labTestingStateDate")
    is_on_hold: Optional[StrictBool] = Field(default=None, alias="isOnHold")
    harvest_start_date: Optional[date] = Field(default=None, alias="harvestStartDate")
    __properties: ClassVar[List[str]] = ["hostname", "dataModel", "retrievedAt", "licenseNumber", "harvestedByFacilityLicenseNumber", "harvestedByFacilityName", "name", "harvestTypeName", "labTestingStateName", "labTestingStateDate", "isOnHold", "harvestStartDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "harvestedByFacilityLicenseNumber": obj.get("harvestedByFacilityLicenseNumber"),
            "harvestedByFacilityName": obj.get("harvestedByFacilityName"),
            "name": obj.get("name"),
