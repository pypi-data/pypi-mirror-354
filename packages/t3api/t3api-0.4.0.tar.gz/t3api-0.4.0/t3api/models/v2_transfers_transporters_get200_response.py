...
class V2TransfersTransportersGet200Response(BaseModel):
    """
    ...
    data: Optional[List[MetrcTransferTransporter]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "data": [MetrcTransferTransporter.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
