...
class PlantBatchesApi:
    ...
    @validate_call
    def v2_plantbatches_active_get(
        self,
        ...
        _param = self._v2_plantbatches_active_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "V2PlantbatchesActiveGet200Response",
        }
    ...
    @validate_call
    def v2_plantbatches_active_get_with_http_info(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of objects per page to be returned.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V2PlantbatchesActiveGet200Response]:
        """List of active plant batches
    ...
    @validate_call
    def v2_plantbatches_active_get_without_preload_content(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of objects per page to be returned.")] = None,
    ...
    def _v2_plantbatches_active_get_serialize(
        self,
        license_number,
        page,
        page_size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/plantbatches/active',
    ...
    @validate_call
    def v2_plantbatches_history_get(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        plant_batch_id: Annotated[Union[StrictFloat, StrictInt], Field(description="ID of the target plant batch")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of objects per page to be returned.")] = None,
        strict_pagination: Annotated[Optional[StrictBool], Field(description="Toggles strict pagination. Defaults to `false` (disabled)    - If enabled, requesting an out of bounds page will throw a 400.    - If disabled, requesting an out of bounds page will return a 200 and an empty page.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Defines the collection sort order.")] = None,
        ...
        :param license_number: The unique identifier for the license associated with this request. (required)
        :type license_number: str
        :param plant_batch_id: ID of the target plant batch (required)
        :type plant_batch_id: float
        :param page: The index of the page to be returned.
        :type page: int
        :param page_size: The number of objects per page to be returned.
        :type page_size: int
        ...
        _param = self._v2_plantbatches_history_get_serialize(
            license_number=license_number,
    ...
    @validate_call
    def v2_plantbatches_history_get_with_http_info(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        plant_batch_id: Annotated[Union[StrictFloat, StrictInt], Field(description="ID of the target plant batch")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
    ...
    @validate_call
    def v2_plantbatches_history_get_without_preload_content(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        plant_batch_id: Annotated[Union[StrictFloat, StrictInt], Field(description="ID of the target plant batch")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
    ...
    def _v2_plantbatches_history_get_serialize(
        self,
        license_number,
        plant_batch_id,
        page,
        ...
        if plant_batch_id is not None:
            
            _query_params.append(('plantBatchId', plant_batch_id))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/plantbatches/history',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def v2_plantbatches_inactive_get(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of objects per page to be returned.")] = None,
        ...
        _param = self._v2_plantbatches_inactive_get_serialize(
            license_number=license_number,
            page=page,
            page_size=page_size,
            strict_pagination=strict_pagination,
    ...
    @validate_call
    def v2_plantbatches_inactive_get_with_http_info(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of objects per page to be returned.")] = None,
    ...
    @validate_call
    def v2_plantbatches_inactive_get_without_preload_content(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of objects per page to be returned.")] = None,
    ...
    def _v2_plantbatches_inactive_get_serialize(
        self,
        license_number,
        page,
        page_size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/plantbatches/inactive',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def v2_plantbatches_onhold_get(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of objects per page to be returned.")] = None,
        ...
        _param = self._v2_plantbatches_onhold_get_serialize(
            license_number=license_number,
            page=page,
            page_size=page_size,
            strict_pagination=strict_pagination,
    ...
    @validate_call
    def v2_plantbatches_onhold_get_with_http_info(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of objects per page to be returned.")] = None,
    ...
    @validate_call
    def v2_plantbatches_onhold_get_without_preload_content(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of objects per page to be returned.")] = None,
    ...
    def _v2_plantbatches_onhold_get_serialize(
        self,
        license_number,
        page,
        page_size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/plantbatches/onhold',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
