...
class V2ItemsDiscontinuePost503Response(BaseModel):
    """
    V2ItemsDiscontinuePost503Response
    """ # noqa: E501
    error: Optional[V2ItemsDiscontinuePost503ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": V2ItemsDiscontinuePost503ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
