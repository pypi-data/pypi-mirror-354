...
class V2SearchGet200ResponseDataInner(BaseModel):
    """
    V2SearchGet200ResponseDataInner
    """ # noqa: E501
    endpoint_id: Optional[EndpointId] = Field(default=None, alias="endpointId")
    score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The search score for this result. A higher score means a better match.")
    matched_entry: Optional[Dict[str, Any]] = Field(default=None, description="The object that matched this query", alias="matchedEntry")
    __properties: ClassVar[List[str]] = ["endpointId", "score", "matchedEntry"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "score": obj.get("score"),
            "matchedEntry": obj.get("matchedEntry")
        })
        return _obj
