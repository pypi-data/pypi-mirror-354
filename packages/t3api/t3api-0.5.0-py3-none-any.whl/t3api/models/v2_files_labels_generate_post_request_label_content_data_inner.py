...
class V2FilesLabelsGeneratePostRequestLabelContentDataInner(BaseModel):
    """
    V2FilesLabelsGeneratePostRequestLabelContentDataInner
    """ # noqa: E501
    text1: Optional[StrictStr] = None
    text2: Optional[StrictStr] = None
    text3: Optional[StrictStr] = None
    text4: Optional[StrictStr] = None
    text5: Optional[StrictStr] = None
    text6: Optional[StrictStr] = None
    text7: Optional[StrictStr] = None
    text8: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["text1", "text2", "text3", "text4", "text5", "text6", "text7", "text8"]
