...
class V2TransfersCreateInputsGet200ResponseTransferTypesInner(BaseModel):
    """
    V2TransfersCreateInputsGet200ResponseTransferTypesInner
    """ # noqa: E501
    facility_types: Optional[List[V2TransfersCreateInputsGet200ResponseTransferTypesInnerFacilityTypesInner]] = Field(default=None, description="List of facility types.", alias="facilityTypes")
    for_external_incoming_shipments: Optional[StrictBool] = Field(default=None, description="Indicates if the transfer type is for external incoming shipments.", alias="forExternalIncomingShipments")
    for_external_outgoing_shipments: Optional[StrictBool] = Field(default=None, description="Indicates if the transfer type is for external outgoing shipments.", alias="forExternalOutgoingShipments")
    for_licensed_shipments: Optional[StrictBool] = Field(default=None, description="Indicates if the transfer type is for licensed shipments.", alias="forLicensedShipments")
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier of the transfer type.")
    max_discrepancy_percentage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Maximum allowable discrepancy percentage.", alias="maxDiscrepancyPercentage")
    maximum_wholesale_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Maximum wholesale price allowed.", alias="maximumWholesalePrice")
    minimum_wholesale_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Minimum wholesale price allowed.", alias="minimumWholesalePrice")
    name: Optional[StrictStr] = Field(default=None, description="Name of the transfer type.")
    recipient_address_fields_enabled: Optional[StrictBool] = Field(default=None, description="Indicates if recipient address fields are enabled.", alias="recipientAddressFieldsEnabled")
    recipient_license_name_field_enabled: Optional[StrictBool] = Field(default=None, description="Indicates if the recipient license name field is enabled.", alias="recipientLicenseNameFieldEnabled")
    recipient_license_number_field_enabled: Optional[StrictBool] = Field(default=None, description="Indicates if the recipient license number field is enabled.", alias="recipientLicenseNumberFieldEnabled")
    recipient_license_number_field_label: Optional[StrictStr] = Field(default=None, description="Label for the recipient license number field.", alias="recipientLicenseNumberFieldLabel")
    requires_destination_gross_weight: Optional[StrictBool] = Field(default=None, description="Indicates if the destination gross weight is required.", alias="requiresDestinationGrossWeight")
    requires_packages_gross_weight: Optional[StrictBool] = Field(default=None, description="Indicates if the package gross weight is required.", alias="requiresPackagesGrossWeight")
    shipper_address_fields_enabled: Optional[StrictBool] = Field(default=None, description="Indicates if the shipper address fields are enabled.", alias="shipperAddressFieldsEnabled")
    shipper_license_name_field_enabled: Optional[StrictBool] = Field(default=None, description="Indicates if the shipper license name field is enabled.", alias="shipperLicenseNameFieldEnabled")
    shipper_license_number_field_enabled: Optional[StrictBool] = Field(default=None, description="Indicates if the shipper license number field is enabled.", alias="shipperLicenseNumberFieldEnabled")
    shipper_license_number_field_label: Optional[StrictStr] = Field(default=None, description="Label for the shipper license number field.", alias="shipperLicenseNumberFieldLabel")
    transaction_type: Optional[StrictStr] = Field(default=None, description="Type of transaction.", alias="transactionType")
    transaction_type_name: Optional[StrictStr] = Field(default=None, description="Name of the transaction type.", alias="transactionTypeName")
    transporter_fields_enabled: Optional[StrictBool] = Field(default=None, description="Indicates if transporter fields are enabled.", alias="transporterFieldsEnabled")
    __properties: ClassVar[List[str]] = ["facilityTypes", "forExternalIncomingShipments", "forExternalOutgoingShipments", "forLicensedShipments", "id", "maxDiscrepancyPercentage", "maximumWholesalePrice", "minimumWholesalePrice", "name", "recipientAddressFieldsEnabled", "recipientLicenseNameFieldEnabled", "recipientLicenseNumberFieldEnabled", "recipientLicenseNumberFieldLabel", "requiresDestinationGrossWeight", "requiresPackagesGrossWeight", "shipperAddressFieldsEnabled", "shipperLicenseNameFieldEnabled", "shipperLicenseNumberFieldEnabled", "shipperLicenseNumberFieldLabel", "transactionType", "transactionTypeName", "transporterFieldsEnabled"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in facility_types (list)
        _items = []
        if self.facility_types:
            for _item_facility_types in self.facility_types:
                if _item_facility_types:
                    _items.append(_item_facility_types.to_dict())
            _dict['facilityTypes'] = _items
        # set to None if max_discrepancy_percentage (nullable) is None
        # and model_fields_set contains the field
        if self.max_discrepancy_percentage is None and "max_discrepancy_percentage" in self.model_fields_set:
            _dict['maxDiscrepancyPercentage'] = None

        # set to None if maximum_wholesale_price (nullable) is None
        # and model_fields_set contains the field
        if self.maximum_wholesale_price is None and "maximum_wholesale_price" in self.model_fields_set:
            _dict['maximumWholesalePrice'] = None

        # set to None if minimum_wholesale_price (nullable) is None
        # and model_fields_set contains the field
        if self.minimum_wholesale_price is None and "minimum_wholesale_price" in self.model_fields_set:
            _dict['minimumWholesalePrice'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "facilityTypes": [V2TransfersCreateInputsGet200ResponseTransferTypesInnerFacilityTypesInner.from_dict(_item) for _item in obj["facilityTypes"]] if obj.get("facilityTypes") is not None else None,
            "forExternalIncomingShipments": obj.get("forExternalIncomingShipments"),
            "forExternalOutgoingShipments": obj.get("forExternalOutgoingShipments"),
            "forLicensedShipments": obj.get("forLicensedShipments"),
            "id": obj.get("id"),
            "maxDiscrepancyPercentage": obj.get("maxDiscrepancyPercentage"),
            "maximumWholesalePrice": obj.get("maximumWholesalePrice"),
            "minimumWholesalePrice": obj.get("minimumWholesalePrice"),
            "name": obj.get("name"),
            "recipientAddressFieldsEnabled": obj.get("recipientAddressFieldsEnabled"),
            "recipientLicenseNameFieldEnabled": obj.get("recipientLicenseNameFieldEnabled"),
            "recipientLicenseNumberFieldEnabled": obj.get("recipientLicenseNumberFieldEnabled"),
            "recipientLicenseNumberFieldLabel": obj.get("recipientLicenseNumberFieldLabel"),
            "requiresDestinationGrossWeight": obj.get("requiresDestinationGrossWeight"),
            "requiresPackagesGrossWeight": obj.get("requiresPackagesGrossWeight"),
            "shipperAddressFieldsEnabled": obj.get("shipperAddressFieldsEnabled"),
            "shipperLicenseNameFieldEnabled": obj.get("shipperLicenseNameFieldEnabled"),
            "shipperLicenseNumberFieldEnabled": obj.get("shipperLicenseNumberFieldEnabled"),
            "shipperLicenseNumberFieldLabel": obj.get("shipperLicenseNumberFieldLabel"),
            "transactionType": obj.get("transactionType"),
            "transactionTypeName": obj.get("transactionTypeName"),
            "transporterFieldsEnabled": obj.get("transporterFieldsEnabled")
        })
        return _obj
