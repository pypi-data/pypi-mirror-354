...
class V2FilesLabelsGeneratePostRequestRenderingOptions(BaseModel):
    """
    Options for controlling how the barcode will render.
    """ # noqa: E501
    debug: Optional[StrictBool] = None
    enable_promo: Optional[StrictBool] = Field(default=None, alias="enablePromo")
    reverse_print_order: Optional[StrictBool] = Field(default=None, alias="reversePrintOrder")
    rotation_degrees: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="rotationDegrees")
    barcode_bar_thickness: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Controls how thick a barcode's bars will appear. Useful for low-DPI thermal printers. Tested values: - Zebra printers with a Code128 should use 0.94 - Dymo printers with a Code128 should use 0.8 - 1.0 is normal rendering.  - 0.9 is 10% thinner - 1.1 is 10% thicker", alias="barcodeBarThickness")
    label_margin_thickness: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Controls width of a label's margins. Useful for thermal printers with slighly skewed printing. - 1.0 is normal margin.  - 0.9 is 10% thinner - 1.1 is 10% thicker", alias="labelMarginThickness")
    __properties: ClassVar[List[str]] = ["debug", "enablePromo", "reversePrintOrder", "rotationDegrees", "barcodeBarThickness", "labelMarginThickness"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "debug": obj.get("debug"),
            "enablePromo": obj.get("enablePromo"),
            "reversePrintOrder": obj.get("reversePrintOrder"),
            "rotationDegrees": obj.get("rotationDegrees"),
            "barcodeBarThickness": obj.get("barcodeBarThickness"),
            "labelMarginThickness": obj.get("labelMarginThickness")
        })
        return _obj
