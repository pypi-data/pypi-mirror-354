...
class MetrcRemediationMethod(BaseModel):
    """
    MetrcRemediationMethod
    """ # noqa: E501
    id: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The unique identifier for the remediation method.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the remediation method.")
