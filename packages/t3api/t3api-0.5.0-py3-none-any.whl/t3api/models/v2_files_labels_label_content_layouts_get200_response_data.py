...
class V2FilesLabelsLabelContentLayoutsGet200ResponseData(BaseModel):
    """
    V2FilesLabelsLabelContentLayoutsGet200ResponseData
    """ # noqa: E501
    data: Optional[List[V2FilesLabelsLabelContentLayoutsGet200ResponseDataDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [V2FilesLabelsLabelContentLayoutsGet200ResponseDataDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
