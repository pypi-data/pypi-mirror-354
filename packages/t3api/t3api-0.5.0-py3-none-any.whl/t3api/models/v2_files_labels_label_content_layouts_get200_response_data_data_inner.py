...
class V2FilesLabelsLabelContentLayoutsGet200ResponseDataDataInner(BaseModel):
    """
    ...
    elements: Optional[List[V2FilesLabelsLabelContentLayoutsGet200ResponseDataDataInnerElementsInner]] = None
    __properties: ClassVar[List[str]] = ["id", "description", "requiresT3plus", "minAspectRatio", "maxAspectRatio", "elements"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "elements": [V2FilesLabelsLabelContentLayoutsGet200ResponseDataDataInnerElementsInner.from_dict(_item) for _item in obj["elements"]] if obj.get("elements") is not None else None
        })
        return _obj
