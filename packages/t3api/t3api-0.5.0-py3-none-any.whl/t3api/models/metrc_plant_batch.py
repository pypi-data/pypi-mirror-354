...
class MetrcPlantBatch(BaseModel):
    """
    MetrcPlantBatch
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the plant batch.")
    ...
    untracked_count: Optional[StrictInt] = Field(default=None, description="Count of untracked plants in the batch.", alias="untrackedCount")
    tracked_count: Optional[StrictInt] = Field(default=None, description="Count of tracked plants in the batch.", alias="trackedCount")
    packaged_count: Optional[StrictInt] = Field(default=None, description="Count of packaged plants in the batch.", alias="packagedCount")
    destroyed_count: Optional[StrictInt] = Field(default=None, description="Count of destroyed plants in the batch.", alias="destroyedCount")
    source_package_label: Optional[StrictStr] = Field(default=None, description="Label of the source package, if available.", alias="sourcePackageLabel")
    source_plant_label: Optional[StrictStr] = Field(default=None, description="Label of the source plant.", alias="sourcePlantLabel")
    ...
    def index_validate_enum(cls, value):
        ...
        if value not in set(['ACTIVE_PLANTBATCH', 'ONHOLD_PLANTBATCH', 'INACTIVE_PLANTBATCH']):
            raise ValueError("must be one of enum values ('ACTIVE_PLANTBATCH', 'ONHOLD_PLANTBATCH', 'INACTIVE_PLANTBATCH')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if source_package_label (nullable) is None
        # and model_fields_set contains the field
        if self.source_package_label is None and "source_package_label" in self.model_fields_set:
            _dict['sourcePackageLabel'] = None

        # set to None if source_plant_label (nullable) is None
        # and model_fields_set contains the field
        if self.source_plant_label is None and "source_plant_label" in self.model_fields_set:
            _dict['sourcePlantLabel'] = None

        # set to None if source_plant_batch_names (nullable) is None
        # and model_fields_set contains the field
        if self.source_plant_batch_names is None and "source_plant_batch_names" in self.model_fields_set:
            _dict['sourcePlantBatchNames'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "untrackedCount": obj.get("untrackedCount"),
            "trackedCount": obj.get("trackedCount"),
            "packagedCount": obj.get("packagedCount"),
            "destroyedCount": obj.get("destroyedCount"),
            "sourcePackageLabel": obj.get("sourcePackageLabel"),
            "sourcePlantLabel": obj.get("sourcePlantLabel"),
