...
class MetrcSalesReceipt(BaseModel):
    """
    MetrcSalesReceipt
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the sale")
    ...
    receipt_number: Optional[StrictStr] = Field(default=None, description="The receipt number associated with the sale", alias="receiptNumber")
    sales_date_time: Optional[datetime] = Field(default=None, description="Date and time when the sale occurred", alias="salesDateTime")
    sales_customer_type: Optional[StrictStr] = Field(default=None, description="Type of customer for the sale", alias="salesCustomerType")
    sales_customer_type_name: Optional[StrictStr] = Field(default=None, description="Name of the customer type", alias="salesCustomerTypeName")
    ...
    caregiver_license_number: Optional[StrictStr] = Field(default=None, description="License number of the caregiver (if applicable)", alias="caregiverLicenseNumber")
    identification_method: Optional[StrictStr] = Field(default=None, description="Method of identification for the customer", alias="identificationMethod")
    patient_registration_location_id: Optional[StrictInt] = Field(default=None, description="Location ID for the patient registration", alias="patientRegistrationLocationId")
    total_packages: Optional[StrictInt] = Field(default=None, description="Total number of packages sold", alias="totalPackages")
    total_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total price of the sale", alias="totalPrice")
    transactions: Optional[List[Dict[str, Any]]] = Field(default=None, description="List of transactions included in the sale")
    is_final: Optional[StrictBool] = Field(default=None, description="Whether the sale is finalized", alias="isFinal")
    is_archived: Optional[StrictBool] = Field(default=None, description="Whether the sale is archived", alias="isArchived")
    archived_date: Optional[datetime] = Field(default=None, description="Date when the sale was archived, if applicable", alias="archivedDate")
    ...
    recorded_by_user_name: Optional[StrictStr] = Field(default=None, description="The username of the person who recorded the sale", alias="recordedByUserName")
    last_modified: Optional[datetime] = Field(default=None, description="Date and time when the sale record was last modified", alias="lastModified")
    __properties: ClassVar[List[str]] = ["id", "hostname", "dataModel", "retrievedAt", "licenseNumber", "index", "receiptNumber", "salesDateTime", "salesCustomerType", "salesCustomerTypeName", "patientLicenseNumber", "caregiverLicenseNumber", "identificationMethod", "patientRegistrationLocationId", "totalPackages", "totalPrice", "transactions", "isFinal", "isArchived", "archivedDate", "recordedDateTime", "recordedByUserName", "lastModified"]
    ...
    def index_validate_enum(cls, value):
        ...
        if value not in set(['ACTIVE_SALES_RECEIPT', 'INACTIVE_SALES_RECEIPT']):
            raise ValueError("must be one of enum values ('ACTIVE_SALES_RECEIPT', 'INACTIVE_SALES_RECEIPT')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if caregiver_license_number (nullable) is None
        # and model_fields_set contains the field
        if self.caregiver_license_number is None and "caregiver_license_number" in self.model_fields_set:
            _dict['caregiverLicenseNumber'] = None

        # set to None if identification_method (nullable) is None
        # and model_fields_set contains the field
        if self.identification_method is None and "identification_method" in self.model_fields_set:
            _dict['identificationMethod'] = None

        # set to None if patient_registration_location_id (nullable) is None
        # and model_fields_set contains the field
        if self.patient_registration_location_id is None and "patient_registration_location_id" in self.model_fields_set:
            _dict['patientRegistrationLocationId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "salesDateTime": obj.get("salesDateTime"),
            "salesCustomerType": obj.get("salesCustomerType"),
            "salesCustomerTypeName": obj.get("salesCustomerTypeName"),
            "patientLicenseNumber": obj.get("patientLicenseNumber"),
            "caregiverLicenseNumber": obj.get("caregiverLicenseNumber"),
            "identificationMethod": obj.get("identificationMethod"),
            "patientRegistrationLocationId": obj.get("patientRegistrationLocationId"),
