...
class EndpointId(str, Enum):
    ...
    ONHOLD_HARVESTS = 'ONHOLD_HARVESTS'
    INACTIVE_HARVESTS = 'INACTIVE_HARVESTS'
    ACTIVE_ITEMS = 'ACTIVE_ITEMS'
    DISCONTINUE_ITEMS = 'DISCONTINUE_ITEMS'
    ACTIVE_STRAINS = 'ACTIVE_STRAINS'
    DISCONTINUE_STRAINS = 'DISCONTINUE_STRAINS'
    CREATE_STRAINS = 'CREATE_STRAINS'
    ACTIVE_PACKAGES = 'ACTIVE_PACKAGES'
    ONHOLD_PACKAGES = 'ONHOLD_PACKAGES'
    ...
    PACKAGE_LABRESULTS = 'PACKAGE_LABRESULTS'
    PACKAGE_SOURCE_HARVESTS = 'PACKAGE_SOURCE_HARVESTS'
    CREATE_PACKAGES_SOURCE_PACKAGES = 'CREATE_PACKAGES_SOURCE_PACKAGES'
    CREATE_PACKAGES_SOURCE_ITEMS = 'CREATE_PACKAGES_SOURCE_ITEMS'
    ACTIVE_PLANTBATCHES = 'ACTIVE_PLANTBATCHES'
    ONHOLD_PLANTBATCHES = 'ONHOLD_PLANTBATCHES'
    INACTIVE_PLANTBATCHES = 'INACTIVE_PLANTBATCHES'
    VEGETATIVE_PLANTS = 'VEGETATIVE_PLANTS'
    FLOWERING_PLANTS = 'FLOWERING_PLANTS'
    ONHOLD_PLANTS = 'ONHOLD_PLANTS'
    INACTIVE_PLANTS = 'INACTIVE_PLANTS'
    INCOMING_ACTIVE_TRANSFERS = 'INCOMING_ACTIVE_TRANSFERS'
    INCOMING_INACTIVE_TRANSFERS = 'INCOMING_INACTIVE_TRANSFERS'
    OUTGOING_ACTIVE_TRANSFERS = 'OUTGOING_ACTIVE_TRANSFERS'
    OUTGOING_INACTIVE_TRANSFERS = 'OUTGOING_INACTIVE_TRANSFERS'
    OUTGOING_REJECTED_TRANSFERS = 'OUTGOING_REJECTED_TRANSFERS'
    TRANSFER_DELIVERIES = 'TRANSFER_DELIVERIES'
    TRANSFER_TRANSPORTER_DETAILS = 'TRANSFER_TRANSPORTER_DETAILS'
    DELIVERY_TRANSPORTERS = 'DELIVERY_TRANSPORTERS'
    TRANSFER_PACKAGES = 'TRANSFER_PACKAGES'
    TRANSFER_HISTORY = 'TRANSFER_HISTORY'
    CREATE_TRANSFER_DESTINATIONS = 'CREATE_TRANSFER_DESTINATIONS'
    CREATE_DELIVERY_TRANSPORTERS = 'CREATE_DELIVERY_TRANSPORTERS'
    PACKAGE_LABRESULTS_DOCUMENT = 'PACKAGE_LABRESULTS_DOCUMENT'
    CREATE_PACKAGES_FROM_PACKAGES = 'CREATE_PACKAGES_FROM_PACKAGES'
    CREATE_PACKAGES_INPUTS = 'CREATE_PACKAGES_INPUTS'
    CREATE_TRANSFERS = 'CREATE_TRANSFERS'
    TRANSFER_MANIFEST = 'TRANSFER_MANIFEST'
    CREATE_TRANSFER_INPUTS = 'CREATE_TRANSFER_INPUTS'
    ADD_PACKAGE_NOTES = 'ADD_PACKAGE_NOTES'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EndpointId from a JSON string"""
