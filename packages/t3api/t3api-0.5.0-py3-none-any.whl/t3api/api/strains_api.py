...
class StrainsApi:
    ...
    def v2_strains_create_post(
        ...
        **Refer to the request body schema for details on formatting your request** 
        ...
        :param v2_strains_create_post_request_inner: (required)
        :type v2_strains_create_post_request_inner: List[V2StrainsCreatePostRequestInner]
        ...
        _param = self._v2_strains_create_post_serialize(
            license_number=license_number,
            v2_strains_create_post_request_inner=v2_strains_create_post_request_inner,
            submit=submit,
    ...
    @validate_call
    def v2_strains_create_post_with_http_info(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        v2_strains_create_post_request_inner: List[V2StrainsCreatePostRequestInner],
        submit: Annotated[Optional[StrictStr], Field(description="Controls whether this request should be forwarded to Metrc. - **If present and set to 'true'**: The request will be validated and forwarded to Metrc if validation passes. - **If omitted or set to any value other than 'true'**: The request will only be validated. Examples:   - \"true\": Forward the request to Metrc   - \"false\": Execute a dry run ")] = None,
    ...
    @validate_call
    def v2_strains_create_post_without_preload_content(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        v2_strains_create_post_request_inner: List[V2StrainsCreatePostRequestInner],
        submit: Annotated[Optional[StrictStr], Field(description="Controls whether this request should be forwarded to Metrc. - **If present and set to 'true'**: The request will be validated and forwarded to Metrc if validation passes. - **If omitted or set to any value other than 'true'**: The request will only be validated. Examples:   - \"true\": Forward the request to Metrc   - \"false\": Execute a dry run ")] = None,
    ...
    def _v2_strains_create_post_serialize(
        self,
        license_number,
        v2_strains_create_post_request_inner,
        submit,
        _request_auth,
        _content_type,
        _headers,
        ...
        if v2_strains_create_post_request_inner is not None:
            _body_params = v2_strains_create_post_request_inner
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/strains/create',
    ...
    @validate_call
    def v2_strains_discontinue_post(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        v2_strains_discontinue_post_request: V2StrainsDiscontinuePostRequest,
        submit: Annotated[Optional[StrictStr], Field(description="Controls whether this request should be forwarded to Metrc. - **If present and set to 'true'**: The request will be validated and forwarded to Metrc if validation passes. - **If omitted or set to any value other than 'true'**: The request will only be validated. Examples:   - \"true\": Forward the request to Metrc   - \"false\": Execute a dry run ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param license_number: The unique identifier for the license associated with this request. (required)
        :type license_number: str
        :param v2_strains_discontinue_post_request: (required)
        :type v2_strains_discontinue_post_request: V2StrainsDiscontinuePostRequest
        :param submit: Controls whether this request should be forwarded to Metrc. - **If present and set to 'true'**: The request will be validated and forwarded to Metrc if validation passes. - **If omitted or set to any value other than 'true'**: The request will only be validated. Examples:   - \"true\": Forward the request to Metrc   - \"false\": Execute a dry run 
        :type submit: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._v2_strains_discontinue_post_serialize(
            license_number=license_number,
            v2_strains_discontinue_post_request=v2_strains_discontinue_post_request,
            submit=submit,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def v2_strains_discontinue_post_with_http_info(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        v2_strains_discontinue_post_request: V2StrainsDiscontinuePostRequest,
        submit: Annotated[Optional[StrictStr], Field(description="Controls whether this request should be forwarded to Metrc. - **If present and set to 'true'**: The request will be validated and forwarded to Metrc if validation passes. - **If omitted or set to any value other than 'true'**: The request will only be validated. Examples:   - \"true\": Forward the request to Metrc   - \"false\": Execute a dry run ")] = None,
    ...
    @validate_call
    def v2_strains_discontinue_post_without_preload_content(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        v2_strains_discontinue_post_request: V2StrainsDiscontinuePostRequest,
        submit: Annotated[Optional[StrictStr], Field(description="Controls whether this request should be forwarded to Metrc. - **If present and set to 'true'**: The request will be validated and forwarded to Metrc if validation passes. - **If omitted or set to any value other than 'true'**: The request will only be validated. Examples:   - \"true\": Forward the request to Metrc   - \"false\": Execute a dry run ")] = None,
    ...
    def _v2_strains_discontinue_post_serialize(
        self,
        license_number,
        v2_strains_discontinue_post_request,
        submit,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if v2_strains_discontinue_post_request is not None:
            _body_params = v2_strains_discontinue_post_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/strains/discontinue',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def v2_strains_get(
        ...
        _param = self._v2_strains_get_serialize(
            license_number=license_number,
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def v2_strains_get_with_http_info(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of objects per page to be returned.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V2StrainsGet200Response]:
        """List of active strains
    ...
    @validate_call
    def v2_strains_get_without_preload_content(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of objects per page to be returned.")] = None,
