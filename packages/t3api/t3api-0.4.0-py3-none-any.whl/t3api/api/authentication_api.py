...
class AuthenticationApi:
    ...
    @validate_call
    def v2_auth_apikey_post(
        self,
        v2_auth_apikey_post_request: Annotated[V2AuthApikeyPostRequest, Field(description="JSON object containing your API key authentication details ")],
        ...
        **Note: This route is for clients that have been provided an API key.**  **If you are not a consulting client, you should not use this endpoint.** Use the `/auth/credentials` endpoint instead. 

        :param v2_auth_apikey_post_request: JSON object containing your API key authentication details  (required)
        :type v2_auth_apikey_post_request: V2AuthApikeyPostRequest
        ...
        _param = self._v2_auth_apikey_post_serialize(
            v2_auth_apikey_post_request=v2_auth_apikey_post_request,
    ...
    @validate_call
    def v2_auth_apikey_post_with_http_info(
        self,
        v2_auth_apikey_post_request: Annotated[V2AuthApikeyPostRequest, Field(description="JSON object containing your API key authentication details ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def v2_auth_apikey_post_without_preload_content(
        self,
        v2_auth_apikey_post_request: Annotated[V2AuthApikeyPostRequest, Field(description="JSON object containing your API key authentication details ")],
        _request_timeout: Union[
            None,
    ...
    def _v2_auth_apikey_post_serialize(
        self,
        v2_auth_apikey_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if v2_auth_apikey_post_request is not None:
            _body_params = v2_auth_apikey_post_request
