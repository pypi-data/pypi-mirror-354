...
class V2AuthApikeyPostRequest(BaseModel):
    """
    V2AuthApikeyPostRequest
    """ # noqa: E501
    api_key: Optional[StrictStr] = Field(default=None, description="Your T3 API key", alias="apiKey")
    state_code: Optional[StrictStr] = Field(default=None, description="The state code for the hostname you want to authenticate in", alias="stateCode")
    __properties: ClassVar[List[str]] = ["apiKey", "stateCode"]
