...
class UnitOfMeasure(BaseModel):
    ...
    from_base_factor: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="fromBaseFactor")
    id: Optional[StrictInt] = None
    is_archived: Optional[StrictBool] = Field(default=None, alias="isArchived")
    is_base_unit: Optional[StrictBool] = Field(default=None, alias="isBaseUnit")
    name: Optional[StrictStr] = None
    quantity_type: Optional[StrictStr] = Field(default=None, alias="quantityType")
    to_base_factor: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="toBaseFactor")
    __properties: ClassVar[List[str]] = ["abbreviation", "fromBaseFactor", "id", "isArchived", "isBaseUnit", "name", "quantityType", "toBaseFactor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fromBaseFactor": obj.get("fromBaseFactor"),
            "id": obj.get("id"),
            "isArchived": obj.get("isArchived"),
            "isBaseUnit": obj.get("isBaseUnit"),
            "name": obj.get("name"),
            "quantityType": obj.get("quantityType"),
            "toBaseFactor": obj.get("toBaseFactor")
        })
        return _obj
