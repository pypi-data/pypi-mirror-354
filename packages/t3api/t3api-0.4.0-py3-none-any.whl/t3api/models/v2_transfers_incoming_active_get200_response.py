...
class V2TransfersIncomingActiveGet200Response(BaseModel):
    """
    ...
    data: Optional[List[MetrcIncomingTransfer]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "data": [MetrcIncomingTransfer.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
