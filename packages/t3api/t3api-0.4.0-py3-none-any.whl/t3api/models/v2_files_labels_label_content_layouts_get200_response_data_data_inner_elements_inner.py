...
class V2FilesLabelsLabelContentLayoutsGet200ResponseDataDataInnerElementsInner(BaseModel):
    """
    V2FilesLabelsLabelContentLayoutsGet200ResponseDataDataInnerElementsInner
    """ # noqa: E501
    description: Optional[StrictStr] = None
    element_type: Optional[StrictStr] = None
    label_content_data_key: Optional[StrictStr] = Field(default=None, description="The value", alias="labelContentDataKey")
    __properties: ClassVar[List[str]] = ["description", "element_type", "labelContentDataKey"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "labelContentDataKey": obj.get("labelContentDataKey")
        })
        return _obj
