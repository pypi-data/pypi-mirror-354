...
class MetrcDriver(BaseModel):
    """
    MetrcDriver
    """ # noqa: E501
    drivers_license_number: Optional[StrictStr] = Field(default=None, description="Driver's license number.", alias="driversLicenseNumber")
    employee_id: Optional[StrictStr] = Field(default=None, description="Employee identifier.", alias="employeeId")
    facility_id: Optional[StrictInt] = Field(default=None, description="Facility identifier.", alias="facilityId")
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the driver.")
    is_archived: Optional[StrictBool] = Field(default=None, description="Indicates if the driver is archived.", alias="isArchived")
    last_modified: Optional[datetime] = Field(default=None, description="Date and time the driver information was last modified.", alias="lastModified")
    name: Optional[StrictStr] = Field(default=None, description="Name of the driver.")
    __properties: ClassVar[List[str]] = ["driversLicenseNumber", "employeeId", "facilityId", "id", "isArchived", "lastModified", "name"]
