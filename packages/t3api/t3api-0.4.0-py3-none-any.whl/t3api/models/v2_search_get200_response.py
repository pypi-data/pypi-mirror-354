...
class V2SearchGet200Response(BaseModel):
    """
    V2SearchGet200Response
    """ # noqa: E501
    data: Optional[List[V2SearchGet200ResponseDataInner]] = None
    queried_metrc_endpoint_ids: Optional[List[EndpointId]] = Field(default=None, description="Endpoints which were successfully queried.", alias="queriedMetrcEndpointIds")
    failed_metrc_endpoint_ids: Optional[List[EndpointId]] = Field(default=None, description="Endpoints which could not be queried, either due to Metrc error or lack of permissions.", alias="failedMetrcEndpointIds")
    __properties: ClassVar[List[str]] = ["data", "queriedMetrcEndpointIds", "failedMetrcEndpointIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [V2SearchGet200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "queriedMetrcEndpointIds": obj.get("queriedMetrcEndpointIds"),
            "failedMetrcEndpointIds": obj.get("failedMetrcEndpointIds")
        })
        return _obj
