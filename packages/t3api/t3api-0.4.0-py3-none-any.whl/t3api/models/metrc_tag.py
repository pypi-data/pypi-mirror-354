...
class MetrcTag(BaseModel):
    ...
    index: Optional[StrictStr] = Field(default=None, description="The current state of the tag, such as AVAILALBE.")
    commissioned_date_time: Optional[datetime] = Field(default=None, alias="commissionedDateTime")
    detached_date_time: Optional[datetime] = Field(default=None, alias="detachedDateTime")
    facility_id: Optional[StrictInt] = Field(default=None, alias="facilityId")
    group_tag_type_id: Optional[StrictStr] = Field(default=None, alias="groupTagTypeId")
    group_tag_type_name: Optional[StrictStr] = Field(default=None, alias="groupTagTypeName")
    ...
    max_group_size: Optional[StrictInt] = Field(default=None, alias="maxGroupSize")
    status_name: Optional[StrictStr] = Field(default=None, alias="statusName")
    tag_inventory_type_name: Optional[StrictStr] = Field(default=None, alias="tagInventoryTypeName")
    tag_type_id: Optional[StrictStr] = Field(default=None, alias="tagTypeId")
    tag_type_name: Optional[StrictStr] = Field(default=None, alias="tagTypeName")
    used_date_time: Optional[datetime] = Field(default=None, alias="usedDateTime")
    __properties: ClassVar[List[str]] = ["id", "hostname", "dataModel", "retrievedAt", "licenseNumber", "index", "commissionedDateTime", "detachedDateTime", "facilityId", "groupTagTypeId", "groupTagTypeName", "isArchived", "isUsed", "label", "lastModified", "maxGroupSize", "statusName", "tagInventoryTypeName", "tagTypeId", "tagTypeName", "usedDateTime"]
    ...
    def index_validate_enum(cls, value):
        ...
        if value not in set(['AVAILABLE_TAG', 'USED_TAG', 'VOID_TAG']):
            raise ValueError("must be one of enum values ('AVAILABLE_TAG', 'USED_TAG', 'VOID_TAG')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if detached_date_time (nullable) is None
        # and model_fields_set contains the field
        if self.detached_date_time is None and "detached_date_time" in self.model_fields_set:
            _dict['detachedDateTime'] = None

        # set to None if used_date_time (nullable) is None
        # and model_fields_set contains the field
        if self.used_date_time is None and "used_date_time" in self.model_fields_set:
            _dict['usedDateTime'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "index": obj.get("index"),
            "commissionedDateTime": obj.get("commissionedDateTime"),
            "detachedDateTime": obj.get("detachedDateTime"),
            "facilityId": obj.get("facilityId"),
            "groupTagTypeId": obj.get("groupTagTypeId"),
            "groupTagTypeName": obj.get("groupTagTypeName"),
            "isArchived": obj.get("isArchived"),
            "isUsed": obj.get("isUsed"),
            "label": obj.get("label"),
            "lastModified": obj.get("lastModified"),
            "maxGroupSize": obj.get("maxGroupSize"),
            "statusName": obj.get("statusName"),
            "tagInventoryTypeName": obj.get("tagInventoryTypeName"),
            "tagTypeId": obj.get("tagTypeId"),
            "tagTypeName": obj.get("tagTypeName"),
            "usedDateTime": obj.get("usedDateTime")
        })
        return _obj
