...
class V2TransfersCreateInputsGet200ResponseTransferTypesInnerFacilityTypesInner(BaseModel):
    """
    V2TransfersCreateInputsGet200ResponseTransferTypesInnerFacilityTypesInner
    """ # noqa: E501
    facility_type_id: Optional[StrictInt] = Field(default=None, description="Unique identifier of the facility type.", alias="facilityTypeId")
    facility_type_name: Optional[StrictStr] = Field(default=None, description="Name of the facility type.", alias="facilityTypeName")
    __properties: ClassVar[List[str]] = ["facilityTypeId", "facilityTypeName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "facilityTypeId": obj.get("facilityTypeId"),
