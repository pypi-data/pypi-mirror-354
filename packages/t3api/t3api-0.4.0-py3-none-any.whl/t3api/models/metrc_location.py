...
class MetrcLocation(BaseModel):
    """
    MetrcLocation
    """ # noqa: E501
    for_harvests: Optional[StrictBool] = Field(default=None, alias="forHarvests")
    for_packages: Optional[StrictBool] = Field(default=None, alias="forPackages")
    for_plant_batches: Optional[StrictBool] = Field(default=None, alias="forPlantBatches")
    for_plants: Optional[StrictBool] = Field(default=None, alias="forPlants")
    id: Optional[StrictInt] = None
    is_archived: Optional[StrictBool] = Field(default=None, alias="isArchived")
    location_type_id: Optional[StrictInt] = Field(default=None, alias="locationTypeId")
    location_type_name: Optional[StrictStr] = Field(default=None, alias="locationTypeName")
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["forHarvests", "forPackages", "forPlantBatches", "forPlants", "id", "isArchived", "locationTypeId", "locationTypeName", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "forHarvests": obj.get("forHarvests"),
            "forPackages": obj.get("forPackages"),
            "forPlantBatches": obj.get("forPlantBatches"),
            "forPlants": obj.get("forPlants"),
            "id": obj.get("id"),
