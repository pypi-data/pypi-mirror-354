...
class V2StatesGet200ResponseInner(BaseModel):
    """
    V2StatesGet200ResponseInner
    """ # noqa: E501
    abbreviation: Optional[StrictStr] = Field(default=None, description="The state abbreviation")
    name: Optional[StrictStr] = Field(default=None, description="The state name")
    hostname: Optional[StrictStr] = Field(default=None, description="The Metrc hostname for this state")
    __properties: ClassVar[List[str]] = ["abbreviation", "name", "hostname"]
