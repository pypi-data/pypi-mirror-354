...
class V2PackagesNotesPostRequestInner(BaseModel):
    """
    V2PackagesNotesPostRequestInner
    """ # noqa: E501
    id: StrictInt = Field(description="The package ID")
    note: StrictStr = Field(description="The note to add to this package")
