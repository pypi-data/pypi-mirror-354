...
class V2LicensesGet200ResponseInner(BaseModel):
    """
    V2LicensesGet200ResponseInner
    """ # noqa: E501
    license_name: Optional[StrictStr] = Field(default=None, description="The facility name for this license", alias="licenseName")
    license_number: Optional[StrictStr] = Field(default=None, description="The license number", alias="licenseNumber")
    __properties: ClassVar[List[str]] = ["licenseName", "licenseNumber"]
