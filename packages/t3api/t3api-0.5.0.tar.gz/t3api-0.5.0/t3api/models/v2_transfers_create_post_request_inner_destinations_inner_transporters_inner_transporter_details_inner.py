...
class V2TransfersCreatePostRequestInnerDestinationsInnerTransportersInnerTransporterDetailsInner(BaseModel):
    """
    V2TransfersCreatePostRequestInnerDestinationsInnerTransportersInnerTransporterDetailsInner
    """ # noqa: E501
    driver_name: StrictStr = Field(description="Name of the driver.", alias="driverName")
    driver_occupational_license_number: StrictStr = Field(description="Occupational license number of the driver.", alias="driverOccupationalLicenseNumber")
    driver_license_number: StrictStr = Field(description="Driver's license number.", alias="driverLicenseNumber")
    driver_layover_leg: Optional[StrictStr] = Field(default=None, description="Layover leg details (if any).", alias="driverLayoverLeg")
    vehicle_make: StrictStr = Field(description="Make of the vehicle.", alias="vehicleMake")
    vehicle_model: StrictStr = Field(description="Model of the vehicle.", alias="vehicleModel")
    vehicle_license_plate_number: StrictStr = Field(description="License plate number of the vehicle.", alias="vehicleLicensePlateNumber")
    __properties: ClassVar[List[str]] = ["driverName", "driverOccupationalLicenseNumber", "driverLicenseNumber", "driverLayoverLeg", "vehicleMake", "vehicleModel", "vehicleLicensePlateNumber"]
