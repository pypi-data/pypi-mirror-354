...
class V2AuthCredentialsPost200Response(BaseModel):
    """
    V2AuthCredentialsPost200Response
    """ # noqa: E501
    access_token: Optional[StrictStr] = Field(default=None, description="A JSON web token used to send authenticated API requests", alias="accessToken")
