...
class V2FilesLabelsLabelContentLayoutsGet200Response(BaseModel):
    """
    V2FilesLabelsLabelContentLayoutsGet200Response
    """ # noqa: E501
    data: Optional[V2FilesLabelsLabelContentLayoutsGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": V2FilesLabelsLabelContentLayoutsGet200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
