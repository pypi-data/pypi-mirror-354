...
class MetrcHistory(BaseModel):
    ...
    recorded_date_time: Optional[datetime] = Field(default=None, alias="recordedDateTime")
    input_sources_names: Optional[StrictStr] = Field(default=None, description="Name of the user responsible for this event", alias="inputSourcesNames")
    external_source_name: Optional[StrictStr] = Field(default=None, description="Name of the third party software source, if applicable", alias="externalSourceName")
    __properties: ClassVar[List[str]] = ["hostname", "dataModel", "retrievedAt", "licenseNumber", "descriptions", "userName", "actualDate", "recordedDateTime", "inputSourcesNames", "externalSourceName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inputSourcesNames": obj.get("inputSourcesNames"),
            "externalSourceName": obj.get("externalSourceName")
        })
        return _obj
