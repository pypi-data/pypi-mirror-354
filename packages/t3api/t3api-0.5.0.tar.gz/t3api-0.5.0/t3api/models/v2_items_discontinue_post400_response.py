...
class V2ItemsDiscontinuePost400Response(BaseModel):
    """
    V2ItemsDiscontinuePost400Response
    """ # noqa: E501
    error: Optional[V2ItemsDiscontinuePost400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": V2ItemsDiscontinuePost400ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
