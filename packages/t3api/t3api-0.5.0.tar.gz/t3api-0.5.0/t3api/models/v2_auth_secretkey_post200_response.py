...
class V2AuthSecretkeyPost200Response(BaseModel):
    """
    V2AuthSecretkeyPost200Response
    """ # noqa: E501
    secret_key: Optional[StrictStr] = Field(default=None, description="The generated secret key", alias="secretKey")
    __properties: ClassVar[List[str]] = ["secretKey"]
