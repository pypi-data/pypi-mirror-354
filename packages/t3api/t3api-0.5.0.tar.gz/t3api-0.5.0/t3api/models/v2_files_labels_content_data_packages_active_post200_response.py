...
class V2FilesLabelsContentDataPackagesActivePost200Response(BaseModel):
    """
    V2FilesLabelsContentDataPackagesActivePost200Response
    """ # noqa: E501
    data: Optional[List[T3LabelContentData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [T3LabelContentData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
