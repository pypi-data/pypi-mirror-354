...
class V2FilesLabelsLabelTemplateLayoutsGet200ResponseDataDataInnerLabelTemplateLayoutConfig(BaseModel):
    """
    ...
    page_size_xin: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="pageSizeXIn")
    page_size_yin: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="pageSizeYIn")
    ...
    __properties: ClassVar[List[str]] = ["numRows", "xGapIn", "yGapIn", "numColumns", "pageSizeXIn", "pageSizeYIn", "labelWidthIn", "labelHeightIn", "labelPaddingXIn", "labelPaddingYIn", "pageMarginTopIn", "pageMarginLeftIn"]
