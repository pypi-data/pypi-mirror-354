...
class MetrcPackageLabResultBatch(BaseModel):
    """
    ...
    data_model: Optional[StrictStr] = Field(default=None, description="The name of the object's data model.", alias="dataModel")
    retrieved_at: Optional[datetime] = Field(default=None, description="The timestamp of when this object was pulled from Metrc.", alias="retrievedAt")
    license_number: Optional[StrictStr] = Field(default=None, description="The license number used to access this object.", alias="licenseNumber")
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier of the test result.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the test panel or category.")
    test_types_required: Optional[StrictInt] = Field(default=None, description="The number of test types required for this item.", alias="testTypesRequired")
    test_types_performed: Optional[StrictInt] = Field(default=None, description="The number of test types actually performed.", alias="testTypesPerformed")
    tests_passed: Optional[StrictInt] = Field(default=None, description="The number of tests that passed.", alias="testsPassed")
    tests_failed: Optional[StrictInt] = Field(default=None, description="The number of tests that failed.", alias="testsFailed")
    is_fully_revoked: Optional[StrictBool] = Field(default=None, description="Whether the item is fully revoked; may be null.", alias="isFullyRevoked")
    tests: Optional[List[MetrcPackageLabResult]] = Field(default=None, description="A list of individual test result entries.")
    __properties: ClassVar[List[str]] = ["hostname", "dataModel", "retrievedAt", "licenseNumber", "id", "name", "testTypesRequired", "testTypesPerformed", "testsPassed", "testsFailed", "isFullyRevoked", "tests"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.tests:
            ...
            _dict['tests'] = _items
        # set to None if is_fully_revoked (nullable) is None
        # and model_fields_set contains the field
        if self.is_fully_revoked is None and "is_fully_revoked" in self.model_fields_set:
            _dict['isFullyRevoked'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "testTypesRequired": obj.get("testTypesRequired"),
            "testTypesPerformed": obj.get("testTypesPerformed"),
            "testsPassed": obj.get("testsPassed"),
            "testsFailed": obj.get("testsFailed"),
            "isFullyRevoked": obj.get("isFullyRevoked"),
            "tests": [MetrcPackageLabResult.from_dict(_item) for _item in obj["tests"]] if obj.get("tests") is not None else None
        })
        return _obj
