...
class V2FilesLabelsLabelTemplateLayoutsGet200Response(BaseModel):
    """
    V2FilesLabelsLabelTemplateLayoutsGet200Response
    """ # noqa: E501
    data: Optional[V2FilesLabelsLabelTemplateLayoutsGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": V2FilesLabelsLabelTemplateLayoutsGet200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
