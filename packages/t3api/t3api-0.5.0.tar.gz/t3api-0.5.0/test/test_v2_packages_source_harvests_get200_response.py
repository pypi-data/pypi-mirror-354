...
class TestV2PackagesSourceHarvestsGet200Response(unittest.TestCase):
    """V2PackagesSourceHarvestsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2PackagesSourceHarvestsGet200Response:
        """Test V2PackagesSourceHarvestsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2PackagesSourceHarvestsGet200Response`
        """
        model = V2PackagesSourceHarvestsGet200Response()
        if include_optional:
            return V2PackagesSourceHarvestsGet200Response(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testV2PackagesSourceHarvestsGet200Response(self):
        """Test V2PackagesSourceHarvestsGet200Response"""
