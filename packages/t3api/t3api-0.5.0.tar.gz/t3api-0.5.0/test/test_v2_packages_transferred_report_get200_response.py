...
class TestV2PackagesTransferredReportGet200Response(unittest.TestCase):
    """V2PackagesTransferredReportGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2PackagesTransferredReportGet200Response:
        """Test V2PackagesTransferredReportGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2PackagesTransferredReportGet200Response`
        """
        model = V2PackagesTransferredReportGet200Response()
        if include_optional:
            return V2PackagesTransferredReportGet200Response(
                generated_at = '2024-07-25T00:00Z',
                filters = ["packageLabel__endswith:0003","productName__contains:kush"],
                filter_logic = 'and',
                sort = 'label:asc',
                license_number = 'LIC-00001',
                data = [
                    t3api.models.metrc_transferred_package.MetrcTransferredPackage(
                        id = 1234567, 
    ...
    def testV2PackagesTransferredReportGet200Response(self):
        """Test V2PackagesTransferredReportGet200Response"""
