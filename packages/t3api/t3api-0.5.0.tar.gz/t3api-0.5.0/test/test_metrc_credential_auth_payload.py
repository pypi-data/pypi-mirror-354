...
class TestMetrcCredentialAuthPayload(unittest.TestCase):
    """MetrcCredentialAuthPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcCredentialAuthPayload:
        """Test MetrcCredentialAuthPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcCredentialAuthPayload`
        """
        model = MetrcCredentialAuthPayload()
        if include_optional:
            return MetrcCredentialAuthPayload(
                username = 'johndoe',
    ...
    def testMetrcCredentialAuthPayload(self):
        """Test MetrcCredentialAuthPayload"""
