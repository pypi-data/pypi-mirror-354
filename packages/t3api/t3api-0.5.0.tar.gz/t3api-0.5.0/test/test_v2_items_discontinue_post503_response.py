...
class TestV2ItemsDiscontinuePost503Response(unittest.TestCase):
    """V2ItemsDiscontinuePost503Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2ItemsDiscontinuePost503Response:
        """Test V2ItemsDiscontinuePost503Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2ItemsDiscontinuePost503Response`
        """
        model = V2ItemsDiscontinuePost503Response()
        if include_optional:
            return V2ItemsDiscontinuePost503Response(
                error = t3api.models._v2_items_discontinue_post_503_response_error._v2_items_discontinue_post_503_response_error(
                    type = 'ServiceUnavailable', 
                    message = '503 ServiceUnavailable', 
    ...
    def testV2ItemsDiscontinuePost503Response(self):
        """Test V2ItemsDiscontinuePost503Response"""
