...
class TestV2PackagesLabresultBatchesGet200Response(unittest.TestCase):
    """V2PackagesLabresultBatchesGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2PackagesLabresultBatchesGet200Response:
        """Test V2PackagesLabresultBatchesGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2PackagesLabresultBatchesGet200Response`
        """
        model = V2PackagesLabresultBatchesGet200Response()
        if include_optional:
            return V2PackagesLabresultBatchesGet200Response(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testV2PackagesLabresultBatchesGet200Response(self):
        """Test V2PackagesLabresultBatchesGet200Response"""
