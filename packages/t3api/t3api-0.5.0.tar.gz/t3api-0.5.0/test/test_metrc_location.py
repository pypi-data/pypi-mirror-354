...
class TestMetrcLocation(unittest.TestCase):
    """MetrcLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcLocation:
        """Test MetrcLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcLocation`
        """
        model = MetrcLocation()
        if include_optional:
            return MetrcLocation(
                for_harvests = True,
                for_packages = True,
