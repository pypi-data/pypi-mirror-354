...
class TestIncomingTransferManifestReportResponse(unittest.TestCase):
    """IncomingTransferManifestReportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncomingTransferManifestReportResponse:
        """Test IncomingTransferManifestReportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncomingTransferManifestReportResponse`
        """
        model = IncomingTransferManifestReportResponse()
        if include_optional:
            return IncomingTransferManifestReportResponse(
    ...
    def testIncomingTransferManifestReportResponse(self):
        """Test IncomingTransferManifestReportResponse"""
