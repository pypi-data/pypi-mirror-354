...
class TestV2TransfersCreatePostRequestInnerDestinationsInnerTransportersInnerTransporterDetailsInner(unittest.TestCase):
    """V2TransfersCreatePostRequestInnerDestinationsInnerTransportersInnerTransporterDetailsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2TransfersCreatePostRequestInnerDestinationsInnerTransportersInnerTransporterDetailsInner:
        """Test V2TransfersCreatePostRequestInnerDestinationsInnerTransportersInnerTransporterDetailsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2TransfersCreatePostRequestInnerDestinationsInnerTransportersInnerTransporterDetailsInner`
        """
        model = V2TransfersCreatePostRequestInnerDestinationsInnerTransportersInnerTransporterDetailsInner()
        if include_optional:
            return V2TransfersCreatePostRequestInnerDestinationsInnerTransportersInnerTransporterDetailsInner(
    ...
    def testV2TransfersCreatePostRequestInnerDestinationsInnerTransportersInnerTransporterDetailsInner(self):
        """Test V2TransfersCreatePostRequestInnerDestinationsInnerTransportersInnerTransporterDetailsInner"""
