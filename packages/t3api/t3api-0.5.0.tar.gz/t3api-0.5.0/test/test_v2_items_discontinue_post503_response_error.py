...
class TestV2ItemsDiscontinuePost503ResponseError(unittest.TestCase):
    """V2ItemsDiscontinuePost503ResponseError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2ItemsDiscontinuePost503ResponseError:
        """Test V2ItemsDiscontinuePost503ResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2ItemsDiscontinuePost503ResponseError`
        """
        model = V2ItemsDiscontinuePost503ResponseError()
        if include_optional:
            return V2ItemsDiscontinuePost503ResponseError(
    ...
    def testV2ItemsDiscontinuePost503ResponseError(self):
        """Test V2ItemsDiscontinuePost503ResponseError"""
