...
class TestV2TransfersCreateInputsGet200ResponseTransferTypesInner(unittest.TestCase):
    """V2TransfersCreateInputsGet200ResponseTransferTypesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2TransfersCreateInputsGet200ResponseTransferTypesInner:
        """Test V2TransfersCreateInputsGet200ResponseTransferTypesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2TransfersCreateInputsGet200ResponseTransferTypesInner`
        """
        model = V2TransfersCreateInputsGet200ResponseTransferTypesInner()
        if include_optional:
            return V2TransfersCreateInputsGet200ResponseTransferTypesInner(
                facility_types = [
    ...
    def testV2TransfersCreateInputsGet200ResponseTransferTypesInner(self):
        """Test V2TransfersCreateInputsGet200ResponseTransferTypesInner"""
