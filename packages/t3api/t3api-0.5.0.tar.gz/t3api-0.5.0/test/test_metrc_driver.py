...
class TestMetrcDriver(unittest.TestCase):
    """MetrcDriver unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcDriver:
        """Test MetrcDriver
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcDriver`
        """
        model = MetrcDriver()
        if include_optional:
            return MetrcDriver(
