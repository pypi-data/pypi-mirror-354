...
class TestV2AuthCredentialsPostRequest(unittest.TestCase):
    """V2AuthCredentialsPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2AuthCredentialsPostRequest:
        """Test V2AuthCredentialsPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2AuthCredentialsPostRequest`
        """
        model = V2AuthCredentialsPostRequest()
        if include_optional:
            return V2AuthCredentialsPostRequest(
                username = 'johndoe',
    ...
    def testV2AuthCredentialsPostRequest(self):
        """Test V2AuthCredentialsPostRequest"""
