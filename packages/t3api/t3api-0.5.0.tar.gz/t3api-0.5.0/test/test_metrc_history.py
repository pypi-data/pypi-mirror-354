...
class TestMetrcHistory(unittest.TestCase):
    """MetrcHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcHistory:
        """Test MetrcHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcHistory`
        """
        model = MetrcHistory()
        if include_optional:
            return MetrcHistory(
