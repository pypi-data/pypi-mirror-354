...
class TestV2FilesLabelsLabelContentLayoutsGet200Response(unittest.TestCase):
    """V2FilesLabelsLabelContentLayoutsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2FilesLabelsLabelContentLayoutsGet200Response:
        """Test V2FilesLabelsLabelContentLayoutsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2FilesLabelsLabelContentLayoutsGet200Response`
        """
        model = V2FilesLabelsLabelContentLayoutsGet200Response()
        if include_optional:
            return V2FilesLabelsLabelContentLayoutsGet200Response(
                data = t3api.models._v2_files_labels_label_content_layouts_get_200_response_data._v2_files_labels_label_content_layouts_get_200_response_data(
                    data = [
                        t3api.models._v2_files_labels_label_content_layouts_get_200_response_data_data_inner._v2_files_labels_label_content_layouts_get_200_response_data_data_inner(
                            id = 'COL_CODE128_TEXT', 
                            description = 'Code128 barcode, with text below', 
                            requires_t3plus = True, 
                            min_aspect_ratio = 2.5, 
                            max_aspect_ratio = 2.5, 
                            elements = [
                                t3api.models._v2_files_labels_label_content_layouts_get_200_response_data_data_inner_elements_inner._v2_files_labels_label_content_layouts_get_200_response_data_data_inner_elements_inner(
                                    description = 'Code 128 barcode scannable value', 
                                    element_type = 'CODE128_BARCODE', 
    ...
    def testV2FilesLabelsLabelContentLayoutsGet200Response(self):
        """Test V2FilesLabelsLabelContentLayoutsGet200Response"""
