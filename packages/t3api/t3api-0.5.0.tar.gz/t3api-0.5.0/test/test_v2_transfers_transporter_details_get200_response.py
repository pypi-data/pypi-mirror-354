...
class TestV2TransfersTransporterDetailsGet200Response(unittest.TestCase):
    """V2TransfersTransporterDetailsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2TransfersTransporterDetailsGet200Response:
        """Test V2TransfersTransporterDetailsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2TransfersTransporterDetailsGet200Response`
        """
        model = V2TransfersTransporterDetailsGet200Response()
        if include_optional:
            return V2TransfersTransporterDetailsGet200Response(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
                data = [
                    t3api.models.metrc_transfer_transporter_details.MetrcTransferTransporterDetails(
                        hostname = 'ca.metrc.com', 
                        data_model = 'MetrcPackage', 
                        retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        license_number = '', 
                        shipment_plan_id = 12345, 
                        shipment_delivery_id = 67890, 
                        transporter_direction = 'Outbound', 
                        transporter_facility_id = 54321, 
                        line_number = 1, 
                        driver_name = 'John Doe', 
                        driver_occupational_license_number = 'AB1234567', 
                        driver_vehicle_license_number = 'XYZ987654', 
                        driver_layover_leg = 'Leg1', 
                        vehicle_make = 'Ford', 
                        vehicle_model = 'Transit', 
                        vehicle_license_plate_number = 'XYZ-1234', 
                        actual_driver_start_date_time = '2024-07-26T08:30Z', 
                        is_voided = False, 
                        received_date_time = '2024-07-25T18:47:20Z', 
                        received_delivery_count = 1, )
                    ]
            )
        else:
            return V2TransfersTransporterDetailsGet200Response(
    ...
    def testV2TransfersTransporterDetailsGet200Response(self):
        """Test V2TransfersTransporterDetailsGet200Response"""
