...
class TestMetrcTransferTransporter(unittest.TestCase):
    """MetrcTransferTransporter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcTransferTransporter:
        """Test MetrcTransferTransporter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcTransferTransporter`
        """
        model = MetrcTransferTransporter()
        if include_optional:
            return MetrcTransferTransporter(
    ...
    def testMetrcTransferTransporter(self):
        """Test MetrcTransferTransporter"""
