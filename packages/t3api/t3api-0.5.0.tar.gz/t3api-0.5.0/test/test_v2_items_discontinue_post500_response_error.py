...
class TestV2ItemsDiscontinuePost500ResponseError(unittest.TestCase):
    """V2ItemsDiscontinuePost500ResponseError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2ItemsDiscontinuePost500ResponseError:
        """Test V2ItemsDiscontinuePost500ResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2ItemsDiscontinuePost500ResponseError`
        """
        model = V2ItemsDiscontinuePost500ResponseError()
        if include_optional:
            return V2ItemsDiscontinuePost500ResponseError(
    ...
    def testV2ItemsDiscontinuePost500ResponseError(self):
        """Test V2ItemsDiscontinuePost500ResponseError"""
