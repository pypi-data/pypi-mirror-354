...
class TestT3LabelContentData(unittest.TestCase):
    """T3LabelContentData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> T3LabelContentData:
        """Test T3LabelContentData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `T3LabelContentData`
        """
        model = T3LabelContentData()
        if include_optional:
            return T3LabelContentData(
                text1 = 'text1',
                text2 = 'text2',
                text3 = 'text3',
                text4 = 'text4',
    ...
    def testT3LabelContentData(self):
        """Test T3LabelContentData"""
