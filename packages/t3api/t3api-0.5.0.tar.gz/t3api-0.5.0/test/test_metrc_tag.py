...
class TestMetrcTag(unittest.TestCase):
    """MetrcTag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcTag:
        """Test MetrcTag
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcTag`
        """
        model = MetrcTag()
        if include_optional:
            return MetrcTag(
