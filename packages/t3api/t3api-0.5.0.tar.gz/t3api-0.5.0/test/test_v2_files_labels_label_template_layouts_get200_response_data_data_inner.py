...
class TestV2FilesLabelsLabelTemplateLayoutsGet200ResponseDataDataInner(unittest.TestCase):
    """V2FilesLabelsLabelTemplateLayoutsGet200ResponseDataDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2FilesLabelsLabelTemplateLayoutsGet200ResponseDataDataInner:
        """Test V2FilesLabelsLabelTemplateLayoutsGet200ResponseDataDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2FilesLabelsLabelTemplateLayoutsGet200ResponseDataDataInner`
        """
        model = V2FilesLabelsLabelTemplateLayoutsGet200ResponseDataDataInner()
        if include_optional:
            return V2FilesLabelsLabelTemplateLayoutsGet200ResponseDataDataInner(
                id = 10,
    ...
    def testV2FilesLabelsLabelTemplateLayoutsGet200ResponseDataDataInner(self):
        """Test V2FilesLabelsLabelTemplateLayoutsGet200ResponseDataDataInner"""
