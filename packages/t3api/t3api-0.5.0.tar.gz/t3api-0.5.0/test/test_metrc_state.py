...
class TestMetrcState(unittest.TestCase):
    """MetrcState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcState:
        """Test MetrcState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcState`
        """
        model = MetrcState()
        if include_optional:
            return MetrcState(
