...
class TestMetrcTransferTransporterDetailsListResponse(unittest.TestCase):
    """MetrcTransferTransporterDetailsListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcTransferTransporterDetailsListResponse:
        """Test MetrcTransferTransporterDetailsListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcTransferTransporterDetailsListResponse`
        """
        model = MetrcTransferTransporterDetailsListResponse()
        if include_optional:
            return MetrcTransferTransporterDetailsListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcTransferTransporterDetailsListResponse(self):
        """Test MetrcTransferTransporterDetailsListResponse"""
