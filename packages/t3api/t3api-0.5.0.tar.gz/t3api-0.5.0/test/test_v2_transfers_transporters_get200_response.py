...
class TestV2TransfersTransportersGet200Response(unittest.TestCase):
    """V2TransfersTransportersGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2TransfersTransportersGet200Response:
        """Test V2TransfersTransportersGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2TransfersTransportersGet200Response`
        """
        model = V2TransfersTransportersGet200Response()
        if include_optional:
            return V2TransfersTransportersGet200Response(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
                data = [
                    t3api.models.metrc_transfer_transporter.MetrcTransferTransporter(
                        hostname = 'ca.metrc.com', 
                        data_model = 'MetrcPackage', 
                        retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        license_number = '', 
                        transporter_facility_license_number = 'LIC-00001', 
                        transporter_facility_name = 'Dank Dispensary LLC', 
                        transporter_direction_name = 'Outbound', 
                        transporter_approval_date = '2024-07-26T13:00Z', 
                        transporter_auto_approval = True, 
                        driver_name = 'John Doe', 
                        driver_occupational_license_number = 'DL123456789', 
                        driver_vehicle_license_number = 'ABC1234', 
                        driver_layover_leg = '', 
                        vehicle_make = 'Ford', 
                        vehicle_model = 'F-150', 
                        vehicle_license_plate_number = 'XYZ7890', 
                        accepted_date_time = '2024-07-26T13:00-05:00', 
                        is_layover = False, 
                        estimated_departure_date_time = '2024-07-26T14:00Z', 
                        actual_departure_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        estimated_arrival_date_time = '2024-07-26T15:00Z', 
    ...
    def testV2TransfersTransportersGet200Response(self):
        """Test V2TransfersTransportersGet200Response"""
