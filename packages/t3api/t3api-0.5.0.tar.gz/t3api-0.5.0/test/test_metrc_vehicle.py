...
class TestMetrcVehicle(unittest.TestCase):
    """MetrcVehicle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcVehicle:
        """Test MetrcVehicle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcVehicle`
        """
        model = MetrcVehicle()
        if include_optional:
            return MetrcVehicle(
