...
class TestV2FilesLabelsContentDataPackagesActivePostRequest(unittest.TestCase):
    """V2FilesLabelsContentDataPackagesActivePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2FilesLabelsContentDataPackagesActivePostRequest:
        """Test V2FilesLabelsContentDataPackagesActivePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2FilesLabelsContentDataPackagesActivePostRequest`
        """
        model = V2FilesLabelsContentDataPackagesActivePostRequest()
        if include_optional:
            return V2FilesLabelsContentDataPackagesActivePostRequest(
    ...
    def testV2FilesLabelsContentDataPackagesActivePostRequest(self):
        """Test V2FilesLabelsContentDataPackagesActivePostRequest"""
