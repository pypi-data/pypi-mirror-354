...
class TestMetrcPackageLabResult(unittest.TestCase):
    """MetrcPackageLabResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcPackageLabResult:
        """Test MetrcPackageLabResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcPackageLabResult`
        """
        model = MetrcPackageLabResult()
        if include_optional:
            return MetrcPackageLabResult(
    ...
    def testMetrcPackageLabResult(self):
        """Test MetrcPackageLabResult"""
