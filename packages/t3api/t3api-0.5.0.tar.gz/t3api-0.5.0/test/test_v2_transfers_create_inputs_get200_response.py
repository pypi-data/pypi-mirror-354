...
class TestV2TransfersCreateInputsGet200Response(unittest.TestCase):
    """V2TransfersCreateInputsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2TransfersCreateInputsGet200Response:
        """Test V2TransfersCreateInputsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2TransfersCreateInputsGet200Response`
        """
        model = V2TransfersCreateInputsGet200Response()
        if include_optional:
            return V2TransfersCreateInputsGet200Response(
                adding = True,
    ...
    def testV2TransfersCreateInputsGet200Response(self):
        """Test V2TransfersCreateInputsGet200Response"""
