...
class TestV2TransfersIncomingManifestReportGet200Response(unittest.TestCase):
    """V2TransfersIncomingManifestReportGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2TransfersIncomingManifestReportGet200Response:
        """Test V2TransfersIncomingManifestReportGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2TransfersIncomingManifestReportGet200Response`
        """
        model = V2TransfersIncomingManifestReportGet200Response()
        if include_optional:
            return V2TransfersIncomingManifestReportGet200Response(
                ...
                data = [
                    t3api.models.t3_incoming_transfer_manifest.T3IncomingTransferManifest(
                        ...
                        transfer/index = 'ACTIVE_INCOMING_TRANSFER', 
                        transfer/id = 1234567, 
    ...
    def testV2TransfersIncomingManifestReportGet200Response(self):
        """Test V2TransfersIncomingManifestReportGet200Response"""
