...
class TestMetrcTransferredPackage(unittest.TestCase):
    """MetrcTransferredPackage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcTransferredPackage:
        """Test MetrcTransferredPackage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcTransferredPackage`
        """
        model = MetrcTransferredPackage()
        if include_optional:
            return MetrcTransferredPackage(
                id = 1234567,
    ...
    def testMetrcTransferredPackage(self):
        """Test MetrcTransferredPackage"""
