...
class TestSalesReceiptsApi(unittest.TestCase):
    """SalesReceiptsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SalesReceiptsApi()

    def tearDown(self) -> None:
        pass

    def test_v2_sales_active_get(self) -> None:
        """Test case for v2_sales_active_get
    ...
    def test_v2_sales_inactive_get(self) -> None:
        """Test case for v2_sales_inactive_get

        List of inactive sales
        """
        pass

    def test_v2_sales_transactions_get(self) -> None:
        """Test case for v2_sales_transactions_get

        List of transactions for a single sales receipt
        """
        pass

    def test_v2_sales_unfinalize_post(self) -> None:
        """Test case for v2_sales_unfinalize_post

        Unfinalize sales receipts
        """
        pass

    def test_v2_sales_void_post(self) -> None:
        """Test case for v2_sales_void_post
