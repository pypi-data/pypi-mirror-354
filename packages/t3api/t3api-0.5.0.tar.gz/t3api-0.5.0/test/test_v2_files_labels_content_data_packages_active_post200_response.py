...
class TestV2FilesLabelsContentDataPackagesActivePost200Response(unittest.TestCase):
    """V2FilesLabelsContentDataPackagesActivePost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2FilesLabelsContentDataPackagesActivePost200Response:
        """Test V2FilesLabelsContentDataPackagesActivePost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2FilesLabelsContentDataPackagesActivePost200Response`
        """
        model = V2FilesLabelsContentDataPackagesActivePost200Response()
        if include_optional:
            return V2FilesLabelsContentDataPackagesActivePost200Response(
                data = [
                    t3api.models.t3_label_content_data.T3LabelContentData(
                        text1 = 'text1', 
                        text2 = 'text2', 
                        text3 = 'text3', 
                        text4 = 'text4', 
    ...
    def testV2FilesLabelsContentDataPackagesActivePost200Response(self):
        """Test V2FilesLabelsContentDataPackagesActivePost200Response"""
