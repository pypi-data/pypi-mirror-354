...
from pyCFS.data.extras import cgns_io, ensight_io, nihu_io, psv_io, exodus_io, stl_io
...
@pytest.mark.skipif(shutil.which("adf2hdf"), reason="requires adf2hdf utility (included in 'cgns-convert' package)")
def debug_cgns_read_mesh_adf(working_directory="."):
