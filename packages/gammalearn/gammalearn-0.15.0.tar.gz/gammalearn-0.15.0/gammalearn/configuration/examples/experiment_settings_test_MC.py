...
targets = collections.OrderedDict(
    {
        ...
        "class": {
            ...
            "metrics": {
                ...
                "AUC_particle": AUROC(task="multiclass", num_classes=len(particle_dict)),
            },
            "mt_balancing": True,
        },
    }
...
optimizer_dic = {"network": optimizers.load_sgd, "loss_balancing": optimizers.load_adam}
