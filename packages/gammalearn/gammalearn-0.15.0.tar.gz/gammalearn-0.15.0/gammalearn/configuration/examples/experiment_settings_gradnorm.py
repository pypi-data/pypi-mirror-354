...
from gammalearn.criterion.loss_balancing.grad_norm import GradNorm
...
targets = collections.OrderedDict(
    {
        ...
        "class": {
            ...
            "loss_weight": 1,
            "metrics": {
                "Accuracy_particle": Accuracy(threshold=0.5, task="binary"),
            },
            "mt_balancing": True,
        },
        "domain_class": {
            ...
            "loss_weight": {
                "Accuracy_domain": Accuracy(threshold=0.5, task="binary"),
            },
...
the loss function and its weight
"""
loss_balancing = GradNorm(targets, **loss_balancing_options)
