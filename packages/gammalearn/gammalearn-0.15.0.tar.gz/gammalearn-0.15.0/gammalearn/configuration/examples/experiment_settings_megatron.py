...
from gammalearn.configuration.constants import (
    GAMMA_ID,
    PROTON_ID,
    SOURCE,
    TARGET,
...
from gammalearn.data.image_processing.normalization import ReducePixelValue
...
from gammalearn.nets.transformer import GammaPhysNetMegatron
...
training_step = training_steps.get_training_step_dann(
...
eval_step = training_steps.get_eval_step_dann(
    **{"add_pointing": net_parameters_dic["parameters"]["backbone"]["parameters"]["add_pointing"]}
)
...
lr_schedulers = {
    "network": {lr_scheduler.CosineAnnealingLR: {"T_max": max_epochs}},
}
