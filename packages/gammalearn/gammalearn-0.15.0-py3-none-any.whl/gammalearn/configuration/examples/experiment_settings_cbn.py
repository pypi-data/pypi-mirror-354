...
from gammalearn.configuration.constants import GAMMA_ID, PROTON_ID, SOURCE, TARGET
...
from gammalearn.nets.auto_encoder import LinearEncoder
from gammalearn.nets.conditional_batch_normalization import CBN
from gammalearn.nets.gammaphysnet import ConditionalGammaPhysNet, GammaPhysNet
...
targets = collections.OrderedDict(
    {
        ...
        "class": {
            ...
            "metrics": {
                ...
                "AUC_particle": AUROC(
                    pos_label=particle_dict[GAMMA_ID], num_classes=len(particle_dict), compute_on_step=True
                ),
            },
            "mt_balancing": True,
        },
            ...
            "parameters": {
                "backbone": {
                    ...
                    "parameters": {
                        ...
                        "normalization": (CBN, {"input_size": 8}),
