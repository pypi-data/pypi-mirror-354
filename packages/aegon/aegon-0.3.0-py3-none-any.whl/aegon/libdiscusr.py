...
#------------------------------------------------------------------------------------------
def disc_USR(listmol, threshold):
    num_molecules = len(listmol)
    atoms = listmol[0].get_chemical_symbols()
    especies = set(atoms)
    if len(especies)==1:
        n_features=8
...
#------------------------------------------------------------------------------------------
def comparator_usr_serial(atoms0, threshold):
    start = time.time()
    ni=len(atoms0)
...
def comparator_usr_parallel(poscarlist, threshold, nproc, base_name):
    ...
    return moleculeout
#------------------------------------------------------------------------------------------
def make_similarity_matrix_compare(moleculein, moleculeref, n_features):
    if n_features==8:
...
#------------------------------------------------------------------------------------------
def molin_sim_molref(moleculein, moleculeref, tol=0.95, n_features=16):
    matrixs=make_similarity_matrix_compare(moleculein, moleculeref, n_features)
    similares=[]
