...
def get_all_dataset_lineage():
    ...
    spark_model.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("DatasetID").saveAsTable("oct_model_v1")
    spark_relationships.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("DatasetID").saveAsTable("oct_relationships")
    spark_roles.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("DatasetID").saveAsTable("oct_roles_v1")
    spark_tables.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("Dataset_ID").saveAsTable("oct_tables")
    spark_columns.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("Dataset_ID").saveAsTable("oct_column")
    spark_measures.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("Dataset_ID").saveAsTable("oct_measures")
    spark_expressions.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("Dataset_ID").saveAsTable("oct_expression")
    spark_errors.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("Item_ID").saveAsTable("oct_errors")
...
def upsert_dataset_lineage(results,DatasetID):
    ...
    spark_model.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("DatasetID").option("replaceWhere", f"DatasetID = '{DatasetID}'").saveAsTable("oct_model_v1")
    spark_relationships.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("DatasetID").option("replaceWhere", f"DatasetID = '{DatasetID}'").saveAsTable("oct_relationships")
    spark_roles.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("DatasetID").option("replaceWhere", f"DatasetID = '{DatasetID}'").saveAsTable("oct_roles_v1")
    spark_tables.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("Dataset_ID").option("replaceWhere", f"Dataset_ID = '{DatasetID}'").saveAsTable("oct_tables")
    spark_columns.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("Dataset_ID").option("replaceWhere", f"Dataset_ID = '{DatasetID}'").saveAsTable("oct_column")
    spark_measures.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("Dataset_ID").option("replaceWhere", f"Dataset_ID = '{DatasetID}'").saveAsTable("oct_measures")
    spark_expressions.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("Dataset_ID").option("replaceWhere", f"Dataset_ID = '{DatasetID}'").saveAsTable("oct_expression")
    errors.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("Item_ID").option("replaceWhere", f"Item_ID = '{DatasetID}'").saveAsTable("oct_errors")
...
def encapsulate_parameters(WorkspaceID,DatasetID,LakehouseWorkspaceID,LakehouseID,Alias,ModifiedTime):
    ...
    datasetname.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("ID").option("replaceWhere", f"ID = '{DatasetID}'").saveAsTable("datasetlist")
    lakehousename.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("ID").option("replaceWhere", f"ID = '{LakehouseID}'").saveAsTable("lakehouselist")
   
    if LakehouseWorkspaceID == WorkspaceID:
        datasetworkspacename.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("ID").option("replaceWhere", f"ID = '{WorkspaceID}'").saveAsTable("workspacelist")
    else:
        datasetworkspacename.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("ID").option("replaceWhere", f"ID = '{WorkspaceID}'").saveAsTable("workspacelist")
        lakehouseworkspacename.write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("ID").option("replaceWhere", f"ID = '{LakehouseWorkspaceID}'").saveAsTable("workspacelist")

    oct_parameters = spark.sql(f"select '{WorkspaceID}' as WorkspaceID, '{DatasetID}' as DatasetID, '{LakehouseWorkspaceID}' as LakehouseWorkspaceID,'{LakehouseID}' as LakehouseID,'{Alias}' as Alias, cast('{ModifiedTime}' as TIMESTAMP) as ModifiedTime")
    oct_parameters.write.format("delta").write.format("delta").option("overwriteSchema", "true").mode("overwrite").partitionBy("ID").option("replaceWhere", f"DatasetID = '{DatasetID}'").saveAsTable("oct_parameters")
    return "Operations Completed"
