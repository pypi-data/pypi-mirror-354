...
class FingerprintSwapper:
    def __init__(self,driver,framework:Framework):
        ...
        self.driver=driver
    def _get(self,keyword:str=None):
        R=requests.get("https://dex.mba/fingerprint/fp.php?g",headers={"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.3"})
