...
if __name__ == "__main__":
    ...
    if client and current_user:
        ...
        agent, initial_response = test_agent_builder("Test Assistant 153", "Find me good pizza places in Mumbai. Do not use ScraperTool, Just refer Google Search results.")
