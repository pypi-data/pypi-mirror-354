...
class AdditionalS3StorageTypeRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["lab", "quota_bytes", "secret_key", "access_key", "name", "priority", "enabled", "bucket_name", "location", "region_name", "custom_domain", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["lab", "quota_bytes", "secret_key", "access_key", "name", "priority", "enabled", "bucket_name", "location", "region_name", "custom_domain", ], str]):
