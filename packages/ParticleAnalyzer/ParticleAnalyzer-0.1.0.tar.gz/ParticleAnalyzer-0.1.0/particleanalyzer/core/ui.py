            ...
            with gr.Tabs():
                with gr.Tab(i18n("Анализ")):
                    ...
                    with gr.Row() as in_image_example_row:   
                            gr.Examples(['particleanalyzer/assets/example/100 r-.jpg', 
                            'particleanalyzer/assets/example/Tv30_1.png', 
                            'particleanalyzer/assets/example/A02-1.bmp',
                            'particleanalyzer/assets/example/Rec-Cu-Ni-Powder_250x_5_SE_V1_png.jpg',
                            'particleanalyzer/assets/example/Resolution in SEM 1.jpg',
                            'particleanalyzer/assets/example/left_half.jpg'], in_image, label=i18n('Примеры'))
                    with gr.Row(visible=False) as im_example_row:   
                            gr.Examples(['particleanalyzer/assets/example/100 r-.jpg', 
                            'particleanalyzer/assets/example/Tv30_1.png', 
                            'particleanalyzer/assets/example/A02-1.bmp',
                            'particleanalyzer/assets/example/Rec-Cu-Ni-Powder_250x_5_SE_V1_png.jpg',
                            'particleanalyzer/assets/example/Resolution in SEM 1.jpg',], im, label=i18n('Примеры'))
                    with gr.Row(visible=False) as scale_input_row:
                        scale_input = gr.Number(label=i18n("Instrument scale in µm"), value=1.0)
                    with gr.Row():
                        process_button = gr.Button(value=i18n("Анализировать"), variant="primary", size="md", icon='particleanalyzer/assets/icon/icons8-химия-50.png')
                        clear_button = gr.Button(value=i18n("Очистить"), size="md", icon='particleanalyzer/assets/icon/icons8-метла-50.png')
                    ...
                    with gr.Row(visible=False) as buttons_row:
                        with gr.Column(scale=1):
                            yes_button = gr.Button(value=i18n("Да"), variant="secondary", size="sm", icon='particleanalyzer/assets/icon/like.png')
                        with gr.Column(scale=1):
                            no_button = gr.Button(value=i18n("Нет"), variant="stop", size="sm", icon='particleanalyzer/assets/icon/dislike.png')
                            
                with gr.Tab(i18n("Настройки")):
                    with gr.Row():    
                        toggle_dark = gr.Button(value=i18n("Тёмный режим"), size="sm", icon='particleanalyzer/assets/icon/icons8-темный-режим-50.png')
                    with gr.Row():
