...
class Detectron2Loader:
    def __init__(self, device=None):
        ...
        self.config_paths = {
            "R101": "particleanalyzer/model/faster_rcnn_R_101_FPN_3x.yaml",
            "X101": "particleanalyzer/model/faster_rcnn_X_101_32x8d_FPN_3x.yaml",
            "Cascade_R50": "particleanalyzer/model/cascade_mask_rcnn_R_50_FPN_3x.yaml",
            "Cascade_X152": "particleanalyzer/model/cascade_mask_rcnn_X_152_32x8d_FPN_IN5k_gn_dconv.yaml"
        }
        
        self.model_paths = {
            "R101": "particleanalyzer/model/faster_rcnn_R_101_FPN_3x.pth",
            "X101": "particleanalyzer/model/faster_rcnn_X_101_32x8d_FPN_3x.pth",
            "Cascade_R50": "particleanalyzer/model/cascade_mask_rcnn_R_50_FPN_3x.pth",
            "Cascade_X152": "particleanalyzer/model/cascade_mask_rcnn_X_152_32x8d_FPN_IN5k_gn_dconv.pth"
        }
    ...
    def _init_r101_config(self):
        ...
        cfg.OUTPUT_DIR = 'particleanalyzer/model'
