...
from examples.custom_snippet import create_app, Company, CustomEndpoint
...
def test_caching_behavior(monkeypatch):
    ...
    with TestClient(starlette_app) as client:
        ...
        assert cache_was_set, f"Cache should have been set. set_calls: {tracking_redis.set_calls}, setex_calls: {tracking_redis.setex_calls}"
