...
import os
from lightapi import LightApi, RestEndpoint, Middleware
...
if __name__ == '__main__':
    ...
    print("   python -c \"import jwt; import datetime; print(jwt.encode({'user_id': 1, 'exp': datetime.datetime.utcnow() + datetime.timedelta(hours=1)}, 'test-secret-key-123', algorithm='HS256'))\"")
