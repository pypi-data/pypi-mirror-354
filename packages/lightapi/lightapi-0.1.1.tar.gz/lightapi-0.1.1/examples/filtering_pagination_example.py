...
def init_database():
    ...
    if session.query(Product).count() == 0:
        ...
        products = [
            Product(name="Laptop", price=125000, category="Electronics", description="High-performance laptop"),
            Product(name="Smartphone", price=85000, category="Electronics", description="Latest smartphone model"),
            Product(name="Headphones", price=12500, category="Electronics", description="Noise-cancelling headphones"),
            Product(name="Coffee Maker", price=7500, category="Appliances", description="Automatic coffee maker"),
            Product(name="Blender", price=5000, category="Appliances", description="High-speed blender"),
            Product(name="T-shirt", price=2500, category="Clothing", description="Cotton t-shirt"),
            Product(name="Jeans", price=6000, category="Clothing", description="Denim jeans"),
            Product(name="Sneakers", price=8000, category="Footwear", description="Running sneakers"),
            Product(name="Boots", price=10000, category="Footwear", description="Leather boots"),
            Product(name="Watch", price=15000, category="Accessories", description="Analog watch"),
            Product(name="Backpack", price=7000, category="Accessories", description="Waterproof backpack"),
            Product(name="Book", price=2000, category="Books", description="Bestselling novel"),
            Product(name="Notebook", price=1500, category="Stationery", description="Spiral notebook"),
            Product(name="Pen Set", price=1200, category="Stationery", description="Premium pen set"),
            Product(name="Mouse", price=4000, category="Electronics", description="Wireless mouse"),
            Product(name="Keyboard", price=6000, category="Electronics", description="Mechanical keyboard"),
            Product(name="Monitor", price=20000, category="Electronics", description="4K monitor"),
            Product(name="Desk", price=30000, category="Furniture", description="Office desk"),
            Product(name="Chair", price=15000, category="Furniture", description="Ergonomic chair"),
            Product(name="Desk Lamp", price=5000, category="Lighting", description="LED desk lamp"),
        ]
