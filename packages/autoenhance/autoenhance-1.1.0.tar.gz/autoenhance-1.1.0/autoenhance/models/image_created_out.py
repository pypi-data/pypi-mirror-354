...
class ImageCreatedOut(BaseModel):
    ...
    upload_url: Optional[Any] = Field(default=None, description="The upload URL for the image to be uploaded to.")
    ...
    __properties: ClassVar[List[str]] = ["ai_version", "cloud_type", "date_added", "downloaded", "enhance", "enhance_type", "finetune_settings", "image_id", "image_name", "lens_correction", "metadata", "order_id", "privacy", "rating", "scene", "sky_replacement", "status", "status_reason", "upload_url", "upscale", "user_id", "vertical_correction", "window_pull"]
