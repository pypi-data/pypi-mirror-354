...
class OrderHDRProcessIn(BaseModel):
    """
    OrderHDRProcessIn
    """ # noqa: E501
    ...
    images: Optional[List[OrderImageIn]] = None
    ...
    __properties: ClassVar[List[str]] = ["ai_version", "cloud_type", "enhance", "enhance_type", "images", "lens_correction", "number_of_brackets_per_image", "privacy", "sky_replacement", "upscale", "vertical_correction", "window_pull"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderHDRProcessIn from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderHDRProcessIn from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "images": [OrderImageIn.from_dict(_item) for _item in obj["images"]] if obj.get("images") is not None else None,
