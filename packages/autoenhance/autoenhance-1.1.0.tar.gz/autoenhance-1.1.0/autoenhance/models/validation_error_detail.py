...
class ValidationErrorDetail(BaseModel):
    ...
    """ # noqa: E501
    location: Optional[ValidationErrorDetailLocation] = Field(default=None, alias="<location>")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<location>": ValidationErrorDetailLocation.from_dict(obj["<location>"]) if obj.get("<location>") is not None else None
        })
        return _obj
