...
class OrderBracketsOut(BaseModel):
    """
    OrderBracketsOut
    """ # noqa: E501
    brackets: Optional[List[BracketOut]] = None
    __properties: ClassVar[List[str]] = ["brackets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "brackets": [BracketOut.from_dict(_item) for _item in obj["brackets"]] if obj.get("brackets") is not None else None
        })
        return _obj
