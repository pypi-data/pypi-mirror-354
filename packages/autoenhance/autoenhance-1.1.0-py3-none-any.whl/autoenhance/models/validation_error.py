...
class ValidationError(BaseModel):
    ...
    ValidationError
    """ # noqa: E501
    detail: Optional[ValidationErrorDetail] = None
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["detail", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "detail": ValidationErrorDetail.from_dict(obj["detail"]) if obj.get("detail") is not None else None,
