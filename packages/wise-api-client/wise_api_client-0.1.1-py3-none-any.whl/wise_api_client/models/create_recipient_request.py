...
class CreateRecipientRequest(BaseModel):
    ...
    """ # noqa: E501
    currency: StrictStr = Field(description="3 character currency code for the recipient's account.")
    type: StrictStr = Field(description="The type of recipient account, determined from the account requirements.")
    profile: StrictInt = Field(description="The profile ID that the recipient will be created under.")
