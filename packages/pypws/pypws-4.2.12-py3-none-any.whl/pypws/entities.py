...
# Version:   4.2.12
# Date/time: 12 Jun 2025 15:24:22
...
class BESSRelease(ReleaseOverTime):
    ...
    ----------
	height : float
		The height from which the release occurs. 
	area : float
		The area over which the release occurs. 
	temperature : float
		The exit temperature of the release (from the BESS unit). 
	duration : float
