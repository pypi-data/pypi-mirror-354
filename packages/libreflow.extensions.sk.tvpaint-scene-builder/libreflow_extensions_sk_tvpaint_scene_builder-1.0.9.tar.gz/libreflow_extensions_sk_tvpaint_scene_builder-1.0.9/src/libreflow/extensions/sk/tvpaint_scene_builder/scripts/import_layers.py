...
def process_remaining_args(args):
    ...
    return (values.animatic_path, values.layoutbg_path, values.colorbg_path, values.width, values.height)


ANIMATIC_PATH, LAYOUTBG_PATH, COLORBG_PATH, PROJECT_WIDTH, PROJECT_HEIGHT = process_remaining_args(
    sys.argv
)
...
create_group(10, "Guides & References", [255,255,255])
