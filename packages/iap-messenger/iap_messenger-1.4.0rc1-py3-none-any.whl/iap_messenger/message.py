...
class Message:
    ...
    def decode(self, decoder:str|None = None) -> tuple[Any, Error]:
        ...
        return decode(self.Raw, decoder, self._inputs)
    
    def encode(self, encoder: str) -> tuple[Any, str, Error]:
        """Encode to Raw data."""
        return encode(self.Reply, encoder)
    ...
    async def _send_msg(self, out: str, timeout: float) -> Error:
        ...
        LOGGER.debug(f"Message sent to: {_out}")
        return None