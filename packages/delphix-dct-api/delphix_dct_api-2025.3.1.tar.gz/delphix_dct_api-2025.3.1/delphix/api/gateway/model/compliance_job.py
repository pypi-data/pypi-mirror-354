...
class ComplianceJob(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            max_memory (int): The maximum amount of memory, in MB, that the compliance job can consume during execution.. [optional]  # noqa: E501
            ...
            stream_row_limit (int): This value constrains the total number of rows that may enter the job for each masking stream.. [optional]  # noqa: E501
            num_input_streams (int): This field controls the amount of parallelism that the masking job uses to extract out the data to be masked.. [optional]  # noqa: E501
            ...
            fail_immediately (bool): Whether to fail immediately or delay failure until job completion when a masking algorithm fails to mask its data (Standard Job only).. [optional]  # noqa: E501
            batch_update (bool): Whether the database load phase to output the masked data will be performed in batches. The size of the batches is determined by the field 'commit_size'. (Standard Job only).. [optional]  # noqa: E501
            commit_size (int): The size of the database commits when performing batch updates (Standard Job only).. [optional]  # noqa: E501
            num_output_threads_per_stream (int): The amount of parallelism, per input stream, that the job uses to load back the masked data. For example, specifying 4 output threads per stream with 5 input streams results in a total of 20 output threads for the whole job. (Standard Job only).. [optional]  # noqa: E501
