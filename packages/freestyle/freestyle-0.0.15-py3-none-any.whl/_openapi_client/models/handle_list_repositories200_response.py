...
class HandleListRepositories200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["repositories", "total", "offset"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HandleListRepositories200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HandleListRepositories200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "repositories": [RepositoryInfo.from_dict(_item) for _item in obj["repositories"]] if obj.get("repositories") is not None else None,
            "total": obj.get("total"),
