...
class HandleCreateRepoRequest(BaseModel):
    """
    HandleCreateRepoRequest
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="This name is not visible to users, and is only accessible to you via API and in the dashboard. Mostly useful for observability.")
    ...
    __properties: ClassVar[List[str]] = ["name", "public", "source", "import"]
