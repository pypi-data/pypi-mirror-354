...
from ._mixin import CoresetTreeServiceSupervisedMixin
from ..common import CoresetParamsLR, DataTuningParams
from ...core.coreset import CoresetReg
from ...data import DataParams
from ...utils import telemetry
from dataheroes import data
...
class CoresetTreeServiceLR(CoresetTreeServiceSupervisedMixin, CoresetTreeService):
    ...
    Parameters:
        ...
        model_cls: A Scikit-learn compatible model class, optional.
            ...
            The default model class is sklearn's LinearRegression.
    """
    _coreset_cls = CoresetReg
    _coreset_params_cls = CoresetParamsLR
    ...
    def __init__(
        ...
        *,
        ...
        coreset_params: Union[CoresetParamsLR, dict] = None,
