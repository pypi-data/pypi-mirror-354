...
from dataheroes.core import estimator
from dataheroes.core.sklearn_extra.validation import _check_n_features
...
def _clone_parametrized(estimator, *, safe=True):
    ...
    try:
        new_object._metadata_request = copy.deepcopy(estimator._metadata_request)  # @IgnoreException
    ...
    def _validate_data(
        ...
        **check_params : kwargs
        ...
        if not no_val_X and check_params.get("ensure_2d", True):
            _check_n_features(estimator=self, X=X, reset=reset)
