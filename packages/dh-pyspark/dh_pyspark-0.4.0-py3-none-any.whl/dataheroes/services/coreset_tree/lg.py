...
from ..common import CoresetParams, CoresetParamsLG, CategoricalEncoding, DataTuningParamsClassification
from ...core.coreset import CoresetLG
...
class CoresetTreeServiceLG(EstimationMixin, CoresetTreeServiceClassifierMixin, CoresetTreeServiceSupervisedMixin, CoresetTreeService):
    """
    ...
    Parameters:
        ...
        model_cls: A Scikit-learn compatible model class, optional.
            ...
            The default model class is sklearn's LogisticRegression.
    """
    _coreset_cls = CoresetLG
    _coreset_params_cls = CoresetParamsLG
