...
def smoke_test():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        subprocess.check_call(["uv", "pip", "install", f"gai-sdk=={version}", "--python", py])
        ...
        # verify gai.chat import works
        print("🔍 Testing gai.chat import...")
        subprocess.check_call(
            [
                py,
                "-c",
                'import gai.chat; print("✅ gai.chat imported successfully")',
            ]
        )
