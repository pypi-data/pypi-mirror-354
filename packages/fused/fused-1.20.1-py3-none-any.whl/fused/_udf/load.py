...
def _detect_parameters(src: str) -> Tuple[Dict[str, Any], List[str], bool]:
    ...
    return dict(zip(params[-len(defaults) :], defaults)), params, has_kwargs
...
def _load_udfs_from_file(
    ...
    *,
    ...
    _parameters, _parameter_list, _parameter_has_kwargs = _detect_parameters(src)
    new_udf = Udf(
    ...
    new_udf._parameter_has_kwargs = _parameter_has_kwargs
    return new_udf
