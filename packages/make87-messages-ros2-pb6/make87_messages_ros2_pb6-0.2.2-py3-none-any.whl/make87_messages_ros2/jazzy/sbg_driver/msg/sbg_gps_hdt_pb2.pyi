...
class SbgGpsHdt(_message.Message):
    __slots__ = ("header", "time_stamp", "status", "tow", "true_heading", "true_heading_acc", "pitch", "pitch_acc", "baseline", "num_sv_tracked", "num_sv_used")
