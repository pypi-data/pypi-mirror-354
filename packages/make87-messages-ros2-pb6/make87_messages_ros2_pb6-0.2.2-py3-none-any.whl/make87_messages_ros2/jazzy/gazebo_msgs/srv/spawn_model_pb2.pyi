...
class SpawnModelRequest(_message.Message):
    ...
    reference_frame: str
    def __init__(self, model_name: _Optional[str] = ..., model_xml: _Optional[str] = ..., robot_namespace: _Optional[str] = ..., initial_pose: _Optional[_Union[_pose_pb2.Pose, _Mapping]] = ..., reference_frame: _Optional[str] = ...) -> None: ...
