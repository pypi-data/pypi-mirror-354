...
class EntityState(_message.Message):
    ...
    reference_frame: str
    def __init__(self, name: _Optional[str] = ..., pose: _Optional[_Union[_pose_pb2.Pose, _Mapping]] = ..., twist: _Optional[_Union[_twist_pb2.Twist, _Mapping]] = ..., reference_frame: _Optional[str] = ...) -> None: ...
