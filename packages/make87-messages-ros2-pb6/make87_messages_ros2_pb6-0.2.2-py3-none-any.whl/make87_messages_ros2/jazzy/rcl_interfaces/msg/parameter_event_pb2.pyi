...
class ParameterEvent(_message.Message):
    __slots__ = ("stamp", "node", "new_parameters", "changed_parameters", "deleted_parameters")
    ...
    def __init__(self, stamp: _Optional[_Union[_time_pb2.Time, _Mapping]] = ..., node: _Optional[str] = ..., new_parameters: _Optional[_Iterable[_Union[_parameter_pb2.Parameter, _Mapping]]] = ..., changed_parameters: _Optional[_Iterable[_Union[_parameter_pb2.Parameter, _Mapping]]] = ..., deleted_parameters: _Optional[_Iterable[_Union[_parameter_pb2.Parameter, _Mapping]]] = ...) -> None: ...
