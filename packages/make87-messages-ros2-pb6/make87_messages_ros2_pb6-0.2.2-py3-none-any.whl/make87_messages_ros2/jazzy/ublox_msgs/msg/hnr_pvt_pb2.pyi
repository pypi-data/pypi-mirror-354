...
class HnrPVT(_message.Message):
    __slots__ = ("i_tow", "year", "month", "day", "hour", "min", "sec", "valid", "nano", "gps_fix", "flags", "reserved0", "lon", "lat", "height", "h_msl", "g_speed", "speed", "head_mot", "head_veh", "h_acc", "v_acc", "s_acc", "head_acc", "reserved1")
