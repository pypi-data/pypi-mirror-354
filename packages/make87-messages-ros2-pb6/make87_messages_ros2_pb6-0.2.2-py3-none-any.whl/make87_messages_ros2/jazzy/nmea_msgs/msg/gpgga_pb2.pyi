...
class Gpgga(_message.Message):
    ...
    diff_age: int
    station_id: str
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., message_id: _Optional[str] = ..., utc_seconds: _Optional[float] = ..., lat: _Optional[float] = ..., lon: _Optional[float] = ..., lat_dir: _Optional[str] = ..., lon_dir: _Optional[str] = ..., gps_qual: _Optional[int] = ..., num_sats: _Optional[int] = ..., hdop: _Optional[float] = ..., alt: _Optional[float] = ..., altitude_units: _Optional[str] = ..., undulation: _Optional[float] = ..., undulation_units: _Optional[str] = ..., diff_age: _Optional[int] = ..., station_id: _Optional[str] = ...) -> None: ...
