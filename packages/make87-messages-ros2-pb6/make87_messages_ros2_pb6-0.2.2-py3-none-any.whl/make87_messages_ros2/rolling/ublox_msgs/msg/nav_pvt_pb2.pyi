...
class NavPVT(_message.Message):
    __slots__ = ("i_tow", "year", "month", "day", "hour", "min", "sec", "valid", "t_acc", "nano", "fix_type", "flags", "flags2", "num_sv", "lon", "lat", "height", "h_msl", "h_acc", "v_acc", "vel_n", "vel_e", "vel_d", "g_speed", "heading", "s_acc", "head_acc", "p_dop", "reserved1", "head_veh", "mag_dec", "mag_acc")
