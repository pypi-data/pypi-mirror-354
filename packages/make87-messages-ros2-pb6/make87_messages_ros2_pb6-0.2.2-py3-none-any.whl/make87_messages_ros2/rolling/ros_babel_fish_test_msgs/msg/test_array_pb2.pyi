...
from make87_messages_ros2.rolling.ros_babel_fish_test_msgs.msg import test_sub_array_pb2 as _test_sub_array_pb2
...
class TestArray(_message.Message):
    __slots__ = ("bools", "uint8s", "uint16s", "uint32s", "uint64s", "int8s", "int16s", "int32s", "int64s", "float32s", "float64s", "times", "durations", "strings", "subarrays_fixed", "subarrays")
