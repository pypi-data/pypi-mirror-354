...
class HilControls(_message.Message):
    ...
    mode: int
    nav_mode: int
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., roll_ailerons: _Optional[float] = ..., pitch_elevator: _Optional[float] = ..., yaw_rudder: _Optional[float] = ..., throttle: _Optional[float] = ..., aux1: _Optional[float] = ..., aux2: _Optional[float] = ..., aux3: _Optional[float] = ..., aux4: _Optional[float] = ..., mode: _Optional[int] = ..., nav_mode: _Optional[int] = ...) -> None: ...
