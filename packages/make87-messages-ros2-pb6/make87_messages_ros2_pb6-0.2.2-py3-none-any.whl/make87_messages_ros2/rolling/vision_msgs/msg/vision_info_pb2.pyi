...
class VisionInfo(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., method: _Optional[str] = ..., database_location: _Optional[str] = ..., database_version: _Optional[int] = ...) -> None: ...
