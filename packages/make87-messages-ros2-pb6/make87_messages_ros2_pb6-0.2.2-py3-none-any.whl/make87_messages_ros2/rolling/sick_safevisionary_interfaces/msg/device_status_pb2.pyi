from make87_messages_ros2.rolling.sick_safevisionary_interfaces.msg import active_monitoring_case_pb2 as _active_monitoring_case_pb2
from make87_messages_ros2.rolling.sick_safevisionary_interfaces.msg import general_status_pb2 as _general_status_pb2
...
class DeviceStatus(_message.Message):
    __slots__ = ("header", "status", "general_status", "cop_safety_related", "cop_non_safety_related", "cop_reset_required", "active_monitoring_case", "contamination_level")
