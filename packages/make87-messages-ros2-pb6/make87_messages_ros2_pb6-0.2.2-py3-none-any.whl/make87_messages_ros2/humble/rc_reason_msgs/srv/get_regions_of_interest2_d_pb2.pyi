...
class GetRegionsOfInterest2DResponse(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., regions_of_interest: _Optional[_Iterable[_Union[_region_of_interest2_d_pb2.RegionOfInterest2D, _Mapping]]] = ..., return_code: _Optional[_Union[_return_code_pb2.ReturnCode, _Mapping]] = ...) -> None: ...
