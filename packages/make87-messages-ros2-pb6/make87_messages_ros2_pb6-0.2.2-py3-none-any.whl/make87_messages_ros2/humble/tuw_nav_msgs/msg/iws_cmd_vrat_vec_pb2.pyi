...
class IwsCmdVRATVec(_message.Message):
    __slots__ = ("header", "ros2_header", "v", "rho", "phi", "delta_t", "state0")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., v: _Optional[_Iterable[float]] = ..., rho: _Optional[_Iterable[float]] = ..., phi: _Optional[_Iterable[float]] = ..., delta_t: _Optional[_Iterable[float]] = ..., state0: _Optional[_Iterable[float]] = ...) -> None: ...
