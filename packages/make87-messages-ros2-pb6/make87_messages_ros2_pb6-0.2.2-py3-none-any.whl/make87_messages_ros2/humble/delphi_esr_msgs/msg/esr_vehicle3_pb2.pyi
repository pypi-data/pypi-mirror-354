...
class EsrVehicle3(_message.Message):
    __slots__ = ("header", "ros2_header", "long_accel_validity", "lat_accel_validity", "lat_accel", "long_accel", "radar_fov_lr", "radar_fov_mr", "auto_align_disable", "radar_height", "serv_align_type", "serv_align_enable", "aalign_avg_ctr_total", "auto_align_converged", "wheel_slip", "serv_align_updates_need", "angle_mounting_offset")
