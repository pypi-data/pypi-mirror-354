...
class EsrEthTx(_message.Message):
    __slots__ = ("header", "ros2_header", "xcp_format_version", "scan_index", "tcp_size", "xcp_scan_type", "look_index", "mmr_scan_index", "target_report_host_speed", "target_report_host_yaw_rate", "xcp_timestamp", "release_revision", "promote_revision", "field_revision", "target_report_count", "target_report_range", "target_report_range_rate", "target_report_theta", "target_report_amplitude")
