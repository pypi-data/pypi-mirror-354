...
class GetDifferentialPointCloudMapRequest(_message.Message):
    __slots__ = ("header", "area", "cached_ids")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., area: _Optional[_Union[_area_info_pb2.AreaInfo, _Mapping]] = ..., cached_ids: _Optional[_Iterable[str]] = ...) -> None: ...

class GetDifferentialPointCloudMapResponse(_message.Message):
    __slots__ = ("header", "ros2_header", "new_pointcloud_with_ids", "ids_to_remove")
    HEADER_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., new_pointcloud_with_ids: _Optional[_Iterable[_Union[_point_cloud_map_cell_with_id_pb2.PointCloudMapCellWithID, _Mapping]]] = ..., ids_to_remove: _Optional[_Iterable[str]] = ...) -> None: ...
