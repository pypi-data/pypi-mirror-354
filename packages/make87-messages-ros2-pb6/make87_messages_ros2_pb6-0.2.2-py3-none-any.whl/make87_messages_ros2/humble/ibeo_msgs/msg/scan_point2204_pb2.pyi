...
class ScanPoint2204(_message.Message):
    __slots__ = ("header", "x_position", "y_position", "z_position", "echo_width", "device_id", "layer", "echo", "time_offset", "ground", "dirt", "precipitation")
