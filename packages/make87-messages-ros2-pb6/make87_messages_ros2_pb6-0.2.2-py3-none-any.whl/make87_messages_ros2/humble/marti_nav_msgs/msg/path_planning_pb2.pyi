...
class PathPlanning(_message.Message):
    __slots__ = ("header", "ros2_header", "segment_type", "length", "start_speed", "end_speed", "startx", "starty", "endx", "endy", "theta0", "a1", "a2", "k0", "c1", "c2", "behavior", "creep", "acc", "reverse", "vehicle_track", "transmitted", "aux_transmitted", "theta_end", "k_end", "seg_len", "speed_limit", "max_error", "max_smooth", "max_curv", "possible_points", "exit_segment")
