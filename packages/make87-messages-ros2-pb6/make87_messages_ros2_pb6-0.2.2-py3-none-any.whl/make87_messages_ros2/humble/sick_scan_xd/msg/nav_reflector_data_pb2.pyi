...
class NAVReflectorData(_message.Message):
    __slots__ = ("header", "cartesian_data_valid", "x", "y", "polar_data_valid", "dist", "phi", "opt_reflector_data_valid", "local_id", "global_id", "type", "sub_type", "quality", "timestamp", "size", "hit_count", "mean_echo", "start_index", "end_index", "pos_valid", "pos_x", "pos_y")
    ...
    pos_x: float
    pos_y: float
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., cartesian_data_valid: _Optional[int] = ..., x: _Optional[int] = ..., y: _Optional[int] = ..., polar_data_valid: _Optional[int] = ..., dist: _Optional[int] = ..., phi: _Optional[int] = ..., opt_reflector_data_valid: _Optional[int] = ..., local_id: _Optional[int] = ..., global_id: _Optional[int] = ..., type: _Optional[int] = ..., sub_type: _Optional[int] = ..., quality: _Optional[int] = ..., timestamp: _Optional[int] = ..., size: _Optional[int] = ..., hit_count: _Optional[int] = ..., mean_echo: _Optional[int] = ..., start_index: _Optional[int] = ..., end_index: _Optional[int] = ..., pos_valid: _Optional[int] = ..., pos_x: _Optional[float] = ..., pos_y: _Optional[float] = ...) -> None: ...
