...
from make87_messages_ros2.humble.septentrio_gnss_driver.msg import rf_band_pb2 as _rf_band_pb2
...
class RFStatus(_message.Message):
    __slots__ = ("header", "ros2_header", "block_header", "n", "sb_length", "flags", "rfband")
