...
class GetProblemResponse(_message.Message):
    __slots__ = ("header", "success", "problem", "error_info")
    HEADER_FIELD_NUMBER: _ClassVar[int]
    ...
    problem: str
    error_info: str
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., success: bool = ..., problem: _Optional[str] = ..., error_info: _Optional[str] = ...) -> None: ...
