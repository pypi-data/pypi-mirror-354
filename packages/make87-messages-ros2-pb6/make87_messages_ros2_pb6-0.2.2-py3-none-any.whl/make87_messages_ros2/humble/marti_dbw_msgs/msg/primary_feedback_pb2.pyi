...
class PrimaryFeedback(_message.Message):
    __slots__ = ("header", "ros2_header", "present", "robotic_mode", "steering_command", "steering_measure", "throttle_command", "throttle_measure", "brake_command", "brake_measure", "estop_command", "estop_measure", "error_steering", "error_throttle", "error_brake", "error_other")
    ...
    error_brake: bool
    error_other: bool
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., present: bool = ..., robotic_mode: bool = ..., steering_command: _Optional[float] = ..., steering_measure: _Optional[float] = ..., throttle_command: _Optional[float] = ..., throttle_measure: _Optional[float] = ..., brake_command: _Optional[float] = ..., brake_measure: _Optional[float] = ..., estop_command: bool = ..., estop_measure: bool = ..., error_steering: bool = ..., error_throttle: bool = ..., error_brake: bool = ..., error_other: bool = ...) -> None: ...
