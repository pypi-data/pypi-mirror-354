...
class ManualControl(_message.Message):
    __slots__ = ("header", "ros2_header", "x", "y", "z", "r", "buttons", "buttons2", "enabled_extensions", "s", "t", "aux1", "aux2", "aux3", "aux4", "aux5", "aux6")
    ...
    aux5: float
    aux6: float
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., x: _Optional[float] = ..., y: _Optional[float] = ..., z: _Optional[float] = ..., r: _Optional[float] = ..., buttons: _Optional[int] = ..., buttons2: _Optional[int] = ..., enabled_extensions: _Optional[int] = ..., s: _Optional[float] = ..., t: _Optional[float] = ..., aux1: _Optional[float] = ..., aux2: _Optional[float] = ..., aux3: _Optional[float] = ..., aux4: _Optional[float] = ..., aux5: _Optional[float] = ..., aux6: _Optional[float] = ...) -> None: ...
