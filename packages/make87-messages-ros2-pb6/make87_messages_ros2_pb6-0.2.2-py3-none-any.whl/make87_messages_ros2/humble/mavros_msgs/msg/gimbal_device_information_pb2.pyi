...
class GimbalDeviceInformation(_message.Message):
    __slots__ = ("header", "ros2_header", "vendor_name", "model_name", "custom_name", "firmware_version", "hardware_version", "uid", "cap_flags", "custom_cap_flags", "roll_min", "roll_max", "pitch_min", "pitch_max", "yaw_min", "yaw_max")
    ...
    yaw_min: float
    yaw_max: float
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., vendor_name: _Optional[str] = ..., model_name: _Optional[str] = ..., custom_name: _Optional[str] = ..., firmware_version: _Optional[int] = ..., hardware_version: _Optional[int] = ..., uid: _Optional[int] = ..., cap_flags: _Optional[int] = ..., custom_cap_flags: _Optional[int] = ..., roll_min: _Optional[float] = ..., roll_max: _Optional[float] = ..., pitch_min: _Optional[float] = ..., pitch_max: _Optional[float] = ..., yaw_min: _Optional[float] = ..., yaw_max: _Optional[float] = ...) -> None: ...
