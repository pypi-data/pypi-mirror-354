...
class VehicleInfo(_message.Message):
    __slots__ = ("header", "ros2_header", "available_info", "sysid", "compid", "autopilot", "type", "system_status", "base_mode", "custom_mode", "mode", "mode_id", "capabilities", "flight_sw_version", "middleware_sw_version", "os_sw_version", "board_version", "flight_custom_version", "vendor_id", "product_id", "uid")
    ...
    product_id: int
    uid: int
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., available_info: _Optional[int] = ..., sysid: _Optional[int] = ..., compid: _Optional[int] = ..., autopilot: _Optional[int] = ..., type: _Optional[int] = ..., system_status: _Optional[int] = ..., base_mode: _Optional[int] = ..., custom_mode: _Optional[int] = ..., mode: _Optional[str] = ..., mode_id: _Optional[int] = ..., capabilities: _Optional[int] = ..., flight_sw_version: _Optional[int] = ..., middleware_sw_version: _Optional[int] = ..., os_sw_version: _Optional[int] = ..., board_version: _Optional[int] = ..., flight_custom_version: _Optional[str] = ..., vendor_id: _Optional[int] = ..., product_id: _Optional[int] = ..., uid: _Optional[int] = ...) -> None: ...
