...
from make87_messages_ros2.humble.statistics_msgs.msg import statistic_data_point_pb2 as _statistic_data_point_pb2
...
class MetricsMessage(_message.Message):
    __slots__ = ("header", "measurement_source_name", "metrics_source", "unit", "window_start", "window_stop", "statistics")
