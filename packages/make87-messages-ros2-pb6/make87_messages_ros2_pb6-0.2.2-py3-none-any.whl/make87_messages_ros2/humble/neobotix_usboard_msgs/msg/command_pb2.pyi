...
class Command(_message.Message):
    __slots__ = ("header", "ros2_header", "command", "command_data", "set_num", "paraset_byte6", "paraset_byte5", "paraset_byte4", "paraset_byte3", "paraset_byte2", "paraset_byte1", "set_active_9to16", "set_active_1to8")
