...
from make87_messages_ros2.humble.autoware_perception_msgs.msg import detected_object_kinematics_pb2 as _detected_object_kinematics_pb2
...
class DetectedObject(_message.Message):
    __slots__ = ("header", "existence_probability", "classification", "kinematics", "shape")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., existence_probability: _Optional[float] = ..., classification: _Optional[_Iterable[_Union[_object_classification_pb2.ObjectClassification, _Mapping]]] = ..., kinematics: _Optional[_Union[_detected_object_kinematics_pb2.DetectedObjectKinematics, _Mapping]] = ..., shape: _Optional[_Union[_shape_pb2.Shape, _Mapping]] = ...) -> None: ...
