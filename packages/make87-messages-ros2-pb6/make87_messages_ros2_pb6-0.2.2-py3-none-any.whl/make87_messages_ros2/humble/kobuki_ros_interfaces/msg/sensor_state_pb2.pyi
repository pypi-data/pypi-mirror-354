...
class SensorState(_message.Message):
    __slots__ = ("header", "ros2_header", "time_stamp", "bumper", "wheel_drop", "cliff", "left_encoder", "right_encoder", "left_pwm", "right_pwm", "buttons", "charger", "battery", "bottom", "current", "over_current", "digital_input", "analog_input")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., time_stamp: _Optional[int] = ..., bumper: _Optional[int] = ..., wheel_drop: _Optional[int] = ..., cliff: _Optional[int] = ..., left_encoder: _Optional[int] = ..., right_encoder: _Optional[int] = ..., left_pwm: _Optional[int] = ..., right_pwm: _Optional[int] = ..., buttons: _Optional[int] = ..., charger: _Optional[int] = ..., battery: _Optional[int] = ..., bottom: _Optional[_Iterable[int]] = ..., current: _Optional[_Iterable[int]] = ..., over_current: _Optional[int] = ..., digital_input: _Optional[int] = ..., analog_input: _Optional[_Iterable[int]] = ...) -> None: ...
