...
class NovatelHeading2(_message.Message):
    __slots__ = ("header", "ros2_header", "novatel_msg_header", "solution_status", "position_type", "baseline_length", "heading", "pitch", "heading_sigma", "pitch_sigma", "rover_station_id", "master_station_id", "num_satellites_tracked", "num_satellites_used_in_solution", "num_satellites_above_elevation_mask_angle", "num_satellites_above_elevation_mask_angle_l2", "solution_source", "extended_solution_status", "signal_mask")
    ...
    ROVER_STATION_ID_FIELD_NUMBER: _ClassVar[int]
    MASTER_STATION_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., novatel_msg_header: _Optional[_Union[_novatel_message_header_pb2.NovatelMessageHeader, _Mapping]] = ..., solution_status: _Optional[str] = ..., position_type: _Optional[str] = ..., baseline_length: _Optional[float] = ..., heading: _Optional[float] = ..., pitch: _Optional[float] = ..., heading_sigma: _Optional[float] = ..., pitch_sigma: _Optional[float] = ..., rover_station_id: _Optional[str] = ..., master_station_id: _Optional[str] = ..., num_satellites_tracked: _Optional[int] = ..., num_satellites_used_in_solution: _Optional[int] = ..., num_satellites_above_elevation_mask_angle: _Optional[int] = ..., num_satellites_above_elevation_mask_angle_l2: _Optional[int] = ..., solution_source: _Optional[int] = ..., extended_solution_status: _Optional[_Union[_novatel_extended_solution_status_pb2.NovatelExtendedSolutionStatus, _Mapping]] = ..., signal_mask: _Optional[_Union[_novatel_signal_mask_pb2.NovatelSignalMask, _Mapping]] = ...) -> None: ...
