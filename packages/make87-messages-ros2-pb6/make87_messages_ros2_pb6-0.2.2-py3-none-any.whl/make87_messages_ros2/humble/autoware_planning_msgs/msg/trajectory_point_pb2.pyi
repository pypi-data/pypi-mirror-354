...
class TrajectoryPoint(_message.Message):
    __slots__ = ("header", "time_from_start", "pose", "longitudinal_velocity_mps", "lateral_velocity_mps", "acceleration_mps2", "heading_rate_rps", "front_wheel_angle_rad", "rear_wheel_angle_rad")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., time_from_start: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., pose: _Optional[_Union[_pose_pb2.Pose, _Mapping]] = ..., longitudinal_velocity_mps: _Optional[float] = ..., lateral_velocity_mps: _Optional[float] = ..., acceleration_mps2: _Optional[float] = ..., heading_rate_rps: _Optional[float] = ..., front_wheel_angle_rad: _Optional[float] = ..., rear_wheel_angle_rad: _Optional[float] = ...) -> None: ...
