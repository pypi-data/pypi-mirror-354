...
class ChronyTrackingStatus(_message.Message):
    __slots__ = ("header", "ros2_header", "reference", "stratum", "system_time_offset", "last_offset", "rms_offset", "frequency_offset", "residual_frequency", "skew", "root_delay", "root_dispersion", "update_interval", "leap_status")
