...
class ApplyBodyWrenchRequest(_message.Message):
    __slots__ = ("header", "body_name", "reference_frame", "reference_point", "wrench", "start_time", "duration")
