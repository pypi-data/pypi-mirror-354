...
class FeatureEnumAsStringGetRequest(_message.Message):
...
class FeatureEnumAsStringGetResponse(_message.Message):
    __slots__ = ("header", "option", "error")
    HEADER_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., option: _Optional[str] = ..., error: _Optional[_Union[_error_pb2.Error, _Mapping]] = ...) -> None: ...
