...
class FeatureBoolSetRequest(_message.Message):
    ...
    value: bool
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., feature_name: _Optional[str] = ..., feature_module: _Optional[_Union[_feature_module_pb2.FeatureModule, _Mapping]] = ..., value: bool = ...) -> None: ...

class FeatureBoolSetResponse(_message.Message):
