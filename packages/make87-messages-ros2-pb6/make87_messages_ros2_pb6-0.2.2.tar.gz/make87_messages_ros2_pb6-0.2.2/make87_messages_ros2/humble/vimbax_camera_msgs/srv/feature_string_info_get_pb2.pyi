...
class FeatureStringInfoGetRequest(_message.Message):
...
class FeatureStringInfoGetResponse(_message.Message):
    __slots__ = ("header", "max_length", "error")
    HEADER_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., max_length: _Optional[int] = ..., error: _Optional[_Union[_error_pb2.Error, _Mapping]] = ...) -> None: ...
