...
from make87_messages_ros2.humble.rmf_traffic_msgs.msg import schedule_change_add_pb2 as _schedule_change_add_pb2
from make87_messages_ros2.humble.rmf_traffic_msgs.msg import schedule_change_delay_pb2 as _schedule_change_delay_pb2
from make87_messages_ros2.humble.rmf_traffic_msgs.msg import schedule_change_progress_pb2 as _schedule_change_progress_pb2
...
class ScheduleParticipantPatch(_message.Message):
    __slots__ = ("header", "participant_id", "itinerary_version", "erasures", "delays", "additions", "progress")
