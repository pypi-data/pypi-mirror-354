...
class MrrDetection(_message.Message):
    __slots__ = ("header", "ros2_header", "detection_id", "confid_azimuth", "super_res_target", "nd_target", "host_veh_clutter", "valid_level", "azimuth", "range", "range_rate", "amplitude", "index_2lsb")
    ...
    amplitude: int
    index_2lsb: int
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., detection_id: _Optional[int] = ..., confid_azimuth: _Optional[int] = ..., super_res_target: bool = ..., nd_target: bool = ..., host_veh_clutter: bool = ..., valid_level: bool = ..., azimuth: _Optional[float] = ..., range: _Optional[float] = ..., range_rate: _Optional[float] = ..., amplitude: _Optional[int] = ..., index_2lsb: _Optional[int] = ...) -> None: ...
