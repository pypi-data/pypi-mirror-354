...
class RadarTrack(_message.Message):
    __slots__ = ("header", "uuid", "position", "velocity", "acceleration", "size", "classification", "position_covariance", "velocity_covariance", "acceleration_covariance", "size_covariance")
