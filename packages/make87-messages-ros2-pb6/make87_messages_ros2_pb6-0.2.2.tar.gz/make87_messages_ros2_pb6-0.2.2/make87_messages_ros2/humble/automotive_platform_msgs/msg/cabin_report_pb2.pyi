...
class CabinReport(_message.Message):
    __slots__ = ("header", "ros2_header", "door_open_front_right", "door_open_front_left", "door_open_rear_right", "door_open_rear_left", "hood_open", "trunk_open", "passenger_present", "passenger_airbag_enabled", "seatbelt_engaged_driver", "seatbelt_engaged_passenger")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., door_open_front_right: bool = ..., door_open_front_left: bool = ..., door_open_rear_right: bool = ..., door_open_rear_left: bool = ..., hood_open: bool = ..., trunk_open: bool = ..., passenger_present: bool = ..., passenger_airbag_enabled: bool = ..., seatbelt_engaged_driver: bool = ..., seatbelt_engaged_passenger: bool = ...) -> None: ...
