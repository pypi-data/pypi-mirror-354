...
class VectorInfoGeod(_message.Message):
    __slots__ = ("header", "nr_sv", "error", "mode", "misc", "delta_east", "delta_north", "delta_up", "delta_ve", "delta_vn", "delta_vu", "azimuth", "elevation", "reference_id", "corr_age", "signal_info")
