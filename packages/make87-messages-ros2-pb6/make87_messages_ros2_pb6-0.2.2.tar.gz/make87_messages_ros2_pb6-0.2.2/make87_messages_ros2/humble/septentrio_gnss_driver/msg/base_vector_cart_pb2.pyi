...
from make87_messages_ros2.humble.septentrio_gnss_driver.msg import vector_info_cart_pb2 as _vector_info_cart_pb2
...
class BaseVectorCart(_message.Message):
    __slots__ = ("header", "ros2_header", "block_header", "n", "sb_length", "vector_info_cart")
