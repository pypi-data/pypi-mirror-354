...
class MasterboardDataMsg(_message.Message):
    __slots__ = ("header", "digital_input_bits", "digital_output_bits", "analog_input_range0", "analog_input_range1", "analog_input0", "analog_input1", "analog_output_domain0", "analog_output_domain1", "analog_output0", "analog_output1", "masterboard_temperature", "robot_voltage_48v", "robot_current", "master_io_current", "master_safety_state", "master_onoff_state")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., digital_input_bits: _Optional[int] = ..., digital_output_bits: _Optional[int] = ..., analog_input_range0: _Optional[int] = ..., analog_input_range1: _Optional[int] = ..., analog_input0: _Optional[float] = ..., analog_input1: _Optional[float] = ..., analog_output_domain0: _Optional[int] = ..., analog_output_domain1: _Optional[int] = ..., analog_output0: _Optional[float] = ..., analog_output1: _Optional[float] = ..., masterboard_temperature: _Optional[float] = ..., robot_voltage_48v: _Optional[float] = ..., robot_current: _Optional[float] = ..., master_io_current: _Optional[float] = ..., master_safety_state: _Optional[int] = ..., master_onoff_state: _Optional[int] = ...) -> None: ...
