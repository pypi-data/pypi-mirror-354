...
class SbgEvent(_message.Message):
    __slots__ = ("header", "ros2_header", "time_stamp", "overflow", "offset_0_valid", "offset_1_valid", "offset_2_valid", "offset_3_valid", "time_offset_0", "time_offset_1", "time_offset_2", "time_offset_3")
    ...
    time_offset_2: int
    time_offset_3: int
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., time_stamp: _Optional[int] = ..., overflow: bool = ..., offset_0_valid: bool = ..., offset_1_valid: bool = ..., offset_2_valid: bool = ..., offset_3_valid: bool = ..., time_offset_0: _Optional[int] = ..., time_offset_1: _Optional[int] = ..., time_offset_2: _Optional[int] = ..., time_offset_3: _Optional[int] = ...) -> None: ...
