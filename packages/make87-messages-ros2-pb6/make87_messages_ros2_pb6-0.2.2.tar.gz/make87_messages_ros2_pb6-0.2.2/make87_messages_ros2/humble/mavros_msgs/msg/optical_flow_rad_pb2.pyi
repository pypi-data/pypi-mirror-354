...
class OpticalFlowRad(_message.Message):
    __slots__ = ("header", "ros2_header", "integration_time_us", "integrated_x", "integrated_y", "integrated_xgyro", "integrated_ygyro", "integrated_zgyro", "temperature", "quality", "time_delta_distance_us", "distance")
    ...
    distance: float
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., integration_time_us: _Optional[int] = ..., integrated_x: _Optional[float] = ..., integrated_y: _Optional[float] = ..., integrated_xgyro: _Optional[float] = ..., integrated_ygyro: _Optional[float] = ..., integrated_zgyro: _Optional[float] = ..., temperature: _Optional[int] = ..., quality: _Optional[int] = ..., time_delta_distance_us: _Optional[int] = ..., distance: _Optional[float] = ...) -> None: ...
