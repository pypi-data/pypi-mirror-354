from make87_messages_ros2.rolling.geometry_msgs.msg import point_stamped_pb2 as _point_stamped_pb2
from make87_messages_ros2.rolling.robot_calibration_msgs.msg import extended_camera_info_pb2 as _extended_camera_info_pb2
...
class Observation(_message.Message):
    ...
    def __init__(self, sensor_name: _Optional[str] = ..., features: _Optional[_Iterable[_Union[_point_stamped_pb2.PointStamped, _Mapping]]] = ..., ext_camera_info: _Optional[_Union[_extended_camera_info_pb2.ExtendedCameraInfo, _Mapping]] = ..., cloud: _Optional[_Union[_point_cloud2_pb2.PointCloud2, _Mapping]] = ..., image: _Optional[_Union[_image_pb2.Image, _Mapping]] = ...) -> None: ...
