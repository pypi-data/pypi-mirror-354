from make87_messages_ros2.rolling.sensor_msgs.msg import laser_echo_pb2 as _laser_echo_pb2
...
class MultiEchoLaserScan(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., angle_min: _Optional[float] = ..., angle_max: _Optional[float] = ..., angle_increment: _Optional[float] = ..., time_increment: _Optional[float] = ..., scan_time: _Optional[float] = ..., range_min: _Optional[float] = ..., range_max: _Optional[float] = ..., ranges: _Optional[_Iterable[_Union[_laser_echo_pb2.LaserEcho, _Mapping]]] = ..., intensities: _Optional[_Iterable[_Union[_laser_echo_pb2.LaserEcho, _Mapping]]] = ...) -> None: ...
