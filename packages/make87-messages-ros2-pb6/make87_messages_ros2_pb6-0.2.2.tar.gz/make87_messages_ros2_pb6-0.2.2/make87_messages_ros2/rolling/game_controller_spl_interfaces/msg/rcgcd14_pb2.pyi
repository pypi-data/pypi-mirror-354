from make87_messages_ros2.rolling.game_controller_spl_interfaces.msg import team_info14_pb2 as _team_info14_pb2
...
class RCGCD14(_message.Message):
    __slots__ = ("packet_number", "players_per_team", "competition_phase", "competition_type", "game_phase", "state", "set_play", "first_half", "kicking_team", "secs_remaining", "secondary_time", "teams")
