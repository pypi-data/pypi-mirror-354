...
class PoseWithUuidStamped(_message.Message):
    ...
    pose: _pose_pb2.Pose
    uuid: _uuid_pb2.UUID
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., pose: _Optional[_Union[_pose_pb2.Pose, _Mapping]] = ..., uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ...) -> None: ...
