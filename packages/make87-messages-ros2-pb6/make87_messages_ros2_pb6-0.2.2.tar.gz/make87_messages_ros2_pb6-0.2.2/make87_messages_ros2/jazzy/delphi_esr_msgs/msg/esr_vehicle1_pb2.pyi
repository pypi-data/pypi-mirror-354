...
class EsrVehicle1(_message.Message):
    __slots__ = ("header", "vehicle_speed", "vehicle_speed_direction", "yaw_rate", "yaw_rate_validity", "steering_angle_rate_sign", "radius_curvature", "steering_angle_validity", "steering_angle_sign", "steering_angle", "steering_angle_rate")
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., vehicle_speed: _Optional[float] = ..., vehicle_speed_direction: bool = ..., yaw_rate: _Optional[float] = ..., yaw_rate_validity: bool = ..., steering_angle_rate_sign: bool = ..., radius_curvature: _Optional[int] = ..., steering_angle_validity: bool = ..., steering_angle_sign: bool = ..., steering_angle: _Optional[int] = ..., steering_angle_rate: _Optional[int] = ...) -> None: ...
