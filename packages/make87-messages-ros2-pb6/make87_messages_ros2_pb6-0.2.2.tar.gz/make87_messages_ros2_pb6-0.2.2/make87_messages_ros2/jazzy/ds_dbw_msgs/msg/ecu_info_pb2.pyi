...
class EcuInfo(_message.Message):
    __slots__ = ("header", "name", "version", "mac_addr", "config_hash", "config_count_modified", "config_count_configured", "config_nvm_blank", "config_nvm_write_pending", "build_date", "license_date", "control_licensed", "log_filename", "log_filesystem_present", "log_fault")
