from make87_messages_ros2.jazzy.sbg_driver.msg import sbg_utc_time_status_pb2 as _sbg_utc_time_status_pb2
...
class SbgUtcTime(_message.Message):
    __slots__ = ("header", "time_stamp", "clock_status", "year", "month", "day", "hour", "min", "sec", "nanosec", "gps_tow", "clk_bias_std", "clk_sf_error_std", "clk_residual_error")
