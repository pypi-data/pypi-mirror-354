...
from make87_messages_ros2.jazzy.sbg_driver.msg import sbg_gps_pos_status_pb2 as _sbg_gps_pos_status_pb2
...
class SbgGpsPos(_message.Message):
    __slots__ = ("header", "time_stamp", "status", "gps_tow", "latitude", "longitude", "altitude", "undulation", "position_accuracy", "num_sv_tracked", "num_sv_used", "base_station_id", "diff_age")
