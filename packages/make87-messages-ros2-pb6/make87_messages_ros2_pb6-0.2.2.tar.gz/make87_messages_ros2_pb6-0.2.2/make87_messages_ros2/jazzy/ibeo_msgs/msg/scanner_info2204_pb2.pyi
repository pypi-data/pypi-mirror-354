...
class ScannerInfo2204(_message.Message):
    ...
    offset_y: float
    offset_z: float
    def __init__(self, device_id: _Optional[int] = ..., scanner_type: _Optional[int] = ..., scan_number: _Optional[int] = ..., start_angle: _Optional[float] = ..., end_angle: _Optional[float] = ..., yaw_angle: _Optional[float] = ..., pitch_angle: _Optional[float] = ..., roll_angle: _Optional[float] = ..., offset_x: _Optional[float] = ..., offset_y: _Optional[float] = ..., offset_z: _Optional[float] = ...) -> None: ...
