...
class RuntimePlatform(Boto3Model):
    ...
    """
    operatingSystemFamily: Literal["WINDOWS_SERVER_2019_FULL", "WINDOWS_SERVER_2019_CORE", "WINDOWS_SERVER_2016_FULL", "WINDOWS_SERVER_2004_CORE", "WINDOWS_SERVER_2022_CORE", "WINDOWS_SERVER_2022_FULL", "WINDOWS_SERVER_20H2_CORE", "LINUX"] | None = None
    """
...
class TaskDefinition(TagsDictMixin, TaskDefinitionModelMixin, PrimaryBoto3Model):
    ...
    *Amazon Elastic Container Service Developer Guide*.
    ...
    A platform family is specified only for tasks using the Fargate launch type.
    """
    requiresCompatibilities: List[Literal["EC2", "FARGATE", "EXTERNAL"]] | None = (
        None
    )
    """
