...
class QueueWriterFile:
    ...
    def write_from_file(
        ...
        try:
            ...
            #     "topic": f"{file_mqtt_dir}/file_properties/{filename}.json",
            #     "message_type": "json",
            ...
            properties_file_topic = (f"{file_mqtt_dir}/file_properties/{filename}.json",)
            headers = {
                "topic": properties_file_topic,
                "message_type": "json",
                "destination_ids": destination_ids,
                "data_source": data_source,
                # meta data
            ...
            if should_chunk:
                ...
                if merge_chunks:
                    s3_prop_key = properties_file_topic
                ...
                try:
                    ...
                    #     "message_type": "binary",
                    #     "topic": f"{file_mqtt_dir}/{filename}.{file_extension}",
                    #     "destination_ids": destination_ids,
                    #     "data_source": data_source,
                    #     # meta data
                    #     "buffer_key": buffer_key,
        ...
        for file_path in test_files:
            try:
                writer.write_from_file(
                    ...
                    properties=properties,
                    data_source="camera2",
                    file_mqtt_dir=f"1/{default_project_id}/2025-02-21/{machine_id}/23444/camera1/",
                    file_s3_dir=f"1/{default_project_id}/2025/02/21/{machine_id}/23444/camera1/",
