...
class MqttListener(AbcListener):
    ...
    def message_callback(self, topic: str, payload, **kwargs):
        ...
        try:
            ...
            # Sample out vyom-mqtt-msg/157/gcs/velocity_topic/1747301291667.json
            topic_parts = topic.split("/")
            self.logger.debug(f"incoming machine id: {topic_parts[1]}")

            if len(topic_parts) == 5:
                incoming_machine_id = int(topic_parts[1])
...
def main():
    ...
    try:
        ...
        vyom_listener.message_callback(
            "vyom-mqtt-msg/85/hq-1/velocity_topic/1746108515103.json", json.dumps(test_payload)
        )
