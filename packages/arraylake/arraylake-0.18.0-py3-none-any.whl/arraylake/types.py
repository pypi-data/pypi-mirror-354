...
class GCConfig(BaseModel):
    ...
    @classmethod
    def serialize_duration(self, value: GCAction) -> float | None:
...
class MaintenanceWindow(BaseModel):
    """The preferred time to run maintenance tasks on a repo"""
...
class Repo(ModelWithID):
    ...
    kind: RepoKind = RepoKind.V1
    prefix: Optional[str] = None
    maintenance_window: Optional[MaintenanceWindow] = None  # If None, uses the org default
