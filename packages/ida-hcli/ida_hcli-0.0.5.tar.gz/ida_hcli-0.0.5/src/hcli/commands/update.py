...
from hcli.lib.util.version import get_latest_pypi_version, compare_versions

console = Console()

@click.command()
@click.option('-f', '--force', is_flag=True, help='Force update.')
@click.option('--check-only', is_flag=True, help='Only check for updates, do not suggest installation.')
@async_command
