...
class MBBank:
    ...
    def logout(self):
        data_out = self._req("https://online.mbbank.com.vn/api/retail_web/common/doLogout")
        return data_out
    ...
    def inquiryAccountName(self, *, creditAccount: str, bankCode: str, 
                      debitAccount: str = None, creditAccountType: str = "ACCOUNT", 
                      transfer_type: str = "FAST", remark: str = ""):
        """
        Get account name inquiry for transfer

        Args:
            creditAccount (str): Recipient account number
            bankCode (str): Bank code of recipient bank
            debitAccount (str, optional): Sender account number. Defaults to main account.
            creditAccountType (str, optional): Credit account type. Defaults to "ACCOUNT".
            transfer_type (str, optional): Transfer type. Defaults to "FAST".
            remark (str, optional): Transfer remark. Defaults to "".

        Returns:
            success (dict): account name inquiry result
        ...
        json_data = {
            ...
            "bankCode": bankCode,
            "debitAccount": self._userid if debitAccount is None else debitAccount,
            "type": transfer_type,
            "remark": remark,
        }
