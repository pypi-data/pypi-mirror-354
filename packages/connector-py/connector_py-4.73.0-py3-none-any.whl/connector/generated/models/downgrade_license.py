...
class DowngradeLicense(BaseModel):
    ...
    account_id: StrictStr = Field(
        description="The unique identifier for the account in the third-party system that should be downgraded",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DowngradeLicense from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DowngradeLicense from a dict"""
        if obj is None:
            return None
