...
from project.sparta_8345d6a892.sparta_952c41e91e.qube_41685030f2 import process_dataframe_components
...
def sparta_d8865dd244(dispo) ->str:
    return pickle.loads(base64.b64decode(dispo.encode('utf-8')))


def sparta_7a629ed005(json_data, user_obj) ->dict:
    """
    Insert dataframe
    """
...
def sparta_01439542b8(json_data, user_obj) ->dict:
    """
    ...
    res_put_df_dict = sparta_7a629ed005(json_data, user_obj)
    return res_put_df_dict


def sparta_9235b6fd90(json_data, user_obj) ->dict:
    """
    Drop dataframe
    """
    table_name = json_data['table_name']
...
def sparta_691a6f0511(json_data, user_obj) ->dict:
    """
...
def sparta_d5ca62aae2(json_data, user_obj) ->dict:
    """
...
def sparta_9213552ac5(json_data, user_obj) ->dict:
    """
...
def sparta_56b6ba7925(json_data, user_obj) ->dict:
    """
    Get dataframe
    """
    ...
    if dataframe_user_shared_obj is not None:
        if dataframe_user_shared_obj.dataframe_model.is_dataframe_connector:
            ...
            data_preview_dict = qube_b61b0eabde.sparta_423d3e6af7(
...
def sparta_9642817a5b(json_data, user_obj):
    """
    ...
    if dispo is not None:
        dispo = sparta_d8865dd244(dispo)
    widget_access_dict = sparta_2901e6f78f(slug, user_obj, password)
...
def sparta_35a90c828b(slug, user_obj, dispo: None) ->list:
    """
...
def sparta_2dfc1bbc8c(dataframe_model, dispo: None) ->list:
    """
...
def sparta_0c9f61a7d7(json_data, user_obj) ->dict:
    """
    Update dataframe
    """
    ...
    if has_widget_password:
        ...
        widget_password_e = qube_9c73ae35fa.sparta_331d5499ac(
            widget_password)
...
def sparta_cf2be782ae(json_data, user_obj) ->dict:
    """
...
def sparta_5541c25c58(json_data, user_obj) ->dict:
    """
    Returns dataframe config
    """
    dataframe_model_obj = sparta_cf2be782ae(json_data, user_obj)
...
def sparta_b734dce1d2(json_data, user_obj) ->list:
    """
    Check if has dataframe slug
    """
    try:
        has_access_dict = sparta_376233968b(json_data['slug'], user_obj
            )
...
def sparta_041c813eaa(json_data, user_obj) ->dict:
    """
    ...
    if plot_db_config is not None:
        ...
        if str(json_data.get('plot_chart_id', '-1')) == '-1':
            b_return_model = True
            res_dict = qube_b61b0eabde.sparta_2b881f82a4(json_data, user_obj,
                b_return_model)
            ...
            res_dict = qube_b61b0eabde.sparta_73f7d5eb5b(json_data, user_obj)
            print('res_dict update plot')
            print(res_dict)
    return {'res': 1}


def sparta_e1ece029cd(json_data, user_obj) ->dict:
    """
...
def sparta_748bffb111(json_data, user_obj) ->dict:
    """
...
def sparta_796520b6db(json_data, user_obj) ->dict:
    """
...
def sparta_ec4f45cbd9(json_data, user_obj) ->dict:
    """
    ...
    if json_data.get('password', None) is not None:
        widget_access_dict = sparta_2901e6f78f(slug, user_obj, json_data[
            'password'])
        if widget_access_dict['res'] == 1:
            dataframe_model_obj = widget_access_dict['dataframe_model_obj']
            data_df_list = sparta_2dfc1bbc8c(dataframe_model_obj,
                dispo)
        else:
            return {'res': -1, 'password': 'Invalid password', 'errorMsg':
                'Invalid password'}
    else:
        data_df_list = sparta_35a90c828b(slug, user_obj, dispo)
    try:
...
def sparta_f2dff3a94d(json_data, user_obj) ->dict:
    """
...
def sparta_959af63763(data_df, json_data) ->pd.DataFrame:
    """
...
def sparta_edddaec0b1(json_data) ->pd.DataFrame:
    """
...
def sparta_0b1c3b3ec9(json_data, user_obj) ->dict:
    """
    Run columns statistics
    """
    from .qube_c177a21810 import analyze_columns
    data_df = sparta_edddaec0b1(json_data)
    selected_columns = list(data_df.columns)
    try:
        data_df = sparta_959af63763(data_df, json_data)
        res_dict = sparta_e24e88fdbc(data_df, selected_columns, B_DARK_THEME=
...
def sparta_d2f38bd9ea(json_data, user_obj) ->dict:
    """
    Run columns statistics
    """
    from .qube_c177a21810 import analyze_columns_corr
    data_df = sparta_edddaec0b1(json_data)
    selected_columns = list(data_df.columns)
    ...
    try:
        data_df = sparta_959af63763(data_df, json_data)
        res_dict = sparta_91f4afae0a(data_df, selected_columns,
...
def sparta_0eb6003515(json_data, user_obj) ->dict:
    """
    Time series analysis
    """
    from .qube_c177a21810 import time_series_analysis
    data_df = sparta_edddaec0b1(json_data)
    try:
        x_col = json_data['datesCol']
        y_cols = json_data['returnsCols']
        res_dict = sparta_25b0364a65(data_df, x_col, y_cols,
...
def sparta_2a282d6b34(json_data, user_obj) ->dict:
    """
    Run relationship explorer
    """
    from .qube_c177a21810 import relationship_explorer
    data_df = sparta_edddaec0b1(json_data)
    try:
        data_df = sparta_959af63763(data_df, json_data)
        res_dict = sparta_949dd74671(data_df, json_data['selectedY'],
...
def sparta_44673c0a1e(json_data, user_obj) ->dict:
    """
...
def sparta_1152c20491(json_data, user_obj) ->dict:
    """
    PCA Analysis: check if sklearn is installed
    """

    def sparta_57bb3031f7():
        try:
            import sklearn
            return True
        except ImportError:
            return False
    return {'res': 1, 'is_sklearn_installed': sparta_57bb3031f7()}
...
def sparta_7128d2d512(json_data, user_obj) ->dict:
    """
    Install sklearn
    """
    res_dict = sparta_8cad244f5b('scikit-learn')
    return res_dict


def sparta_9e67c00bd3(json_data, user_obj) ->dict:
    """
    RUN pca analysis
    """
    from .qube_c177a21810 import run_pca
    data_df = sparta_edddaec0b1(json_data)
    try:
        res_pca_dict = sparta_4a2b04cca4(data_df, y_cols=json_data['pcaDataset'],
...
def sparta_018aa714bf(json_data, user_obj) ->dict:
    """
    Run clustering analysis
    """
    from .qube_c177a21810 import run_clustering_kmeans, run_clustering_dbscan
    data_df = sparta_edddaec0b1(json_data)
    try:
        if json_data['clusteringModel'] == 'Kmean':
            res_clustering_dict = sparta_5344c0bf7e(data_df, y_cols=
                json_data['colDataset'], n_clusters=json_data[
                'nbComponents'], B_DARK_THEME=json_data.get('B_DARK_THEME',
                False))
        else:
            res_clustering_dict = sparta_f0b3a7f755(data_df, y_cols=
...
def sparta_4c2cb5bb14(json_data, user_obj) ->dict:
    """
    Run correlation network analysis
    """
    from .qube_c177a21810 import run_correlation_network
    data_df = sparta_edddaec0b1(json_data)
    try:
        res_clustering_dict = sparta_4c2cb5bb14(data_df, y_cols=
...
def sparta_6a5d637124(json_data, user_obj) ->dict:
    """
    Run tsne analysis
    """
    from .qube_c177a21810 import run_tsne
    data_df = sparta_edddaec0b1(json_data)
    try:
        res_clustering_dict = sparta_6a5d637124(data_df, y_cols=json_data['dataset'],
...
def sparta_7c8640cb86(json_data, user_obj) ->dict:
    """
    Run polynomial regression
    """
    from .qube_c177a21810 import run_polynomial_regression
    data_df = sparta_edddaec0b1(json_data)
    try:
        res_dict = sparta_7c8640cb86(data_df, y_target=json_data[
...
def sparta_489b543342(json_data, user_obj) ->dict:
    """
    Run decision tree regression
    """
    from .qube_c177a21810 import run_decision_tree_regression
    data_df = sparta_edddaec0b1(json_data)
    try:
        ...
        res_dict = sparta_489b543342(data_df, y_target=json_data
...
def sparta_c2bd1e1d38(json_data, user_obj) ->dict:
    """
    Run decision tree regression Grid Search CV
    """
    from .qube_c177a21810 import run_decision_tree_regression_grid_search
    data_df = sparta_edddaec0b1(json_data)
    try:
        max_depth = json_data['maxDepth']
        if str(max_depth) == '-1':
            ...
            max_depth = int(max_depth)
        res_dict = sparta_c2bd1e1d38(data_df,
...
def sparta_5355980d1d(json_data, user_obj) ->dict:
    """
    Run random forest regression
    """
    from .qube_c177a21810 import run_random_forest_regression
    data_df = sparta_edddaec0b1(json_data)
    try:
        res_dict = sparta_5355980d1d(data_df, y_target=json_data
...
def sparta_df765dc206(json_data, user_obj) ->dict:
    """
    Run random forest regression grid search
    """
    from .qube_c177a21810 import run_random_forest_regression_grid_search
    data_df = sparta_edddaec0b1(json_data)
    try:
        res_dict = sparta_df765dc206(data_df,
            y_target=json_data['target'], x_cols=json_data['selectedX'],
...
def sparta_35cc9e7361(json_data, user_obj) ->dict:
    """
    Run Quantile regression
    """
    from .qube_c177a21810 import run_quantile_regression
    data_df = sparta_edddaec0b1(json_data)
    try:
        res_dict = sparta_35cc9e7361(data_df, y_target=json_data[
...
def sparta_1e352fb3b4(json_data, user_obj) ->dict:
    """
    Run Rolling regression
    """
    print('RUN ROLLING REGRESSION NOW')
    from .qube_c177a21810 import run_rolling_regression
    data_df = sparta_edddaec0b1(json_data)
    try:
        res_dict = sparta_1e352fb3b4(data_df, y_target=json_data[
...
def sparta_c228568878(json_data, user_obj) ->dict:
    """
    Run Recursive regression
    """
    from .qube_c177a21810 import run_recursive_regression
    data_df = sparta_edddaec0b1(json_data)
    try:
        res_dict = sparta_c228568878(data_df, y_target=json_data[
...
def sparta_1f3b558266(json_data, user_obj) ->dict:
    """
    Run features importance analysis
    """
    from .qube_c177a21810 import run_features_importance_randomforest, run_features_importance_xgboost
    data_df = sparta_edddaec0b1(json_data)
    try:
        if json_data['model'] == 'Random Forest':
            res_dict = sparta_ac0156402a(data_df,
            ...
            res_dict = sparta_3cbd33fa70(data_df, y_cols=
...
def sparta_e75321f00e(json_data, user_obj) ->dict:
    """
    Run mutual information
    """
    from .qube_c177a21810 import run_mutual_information
    data_df = sparta_edddaec0b1(json_data)
    try:
        res_dict = sparta_e75321f00e(data_df, y_target=json_data[
...
def sparta_433cc52e60(json_data, user_obj) ->dict:
    """
...
def sparta_00446c7b03(json_data, user_obj) ->dict:
    """
    Install lib
    """
    lib = json_data['lib']
    if lib == 'arch':
        res_dict = sparta_8cad244f5b('arch')
    elif lib == 'wavelet':
        res_dict = sparta_8cad244f5b('PyWavelets')
    elif lib == 'ruptures':
        res_dict = sparta_8cad244f5b('ruptures')
    elif lib == 'sklearn':
        res_dict = sparta_8cad244f5b('scikit-learn')
    elif lib == 'prophet':
        res_dict = sparta_8cad244f5b('prophet')
    elif lib == 'keras':
        res_dict = sparta_8cad244f5b('scikit-learn')
        if res_dict['res'] == -1:
            return res_dict
        ...
        print(res_dict)
        res_dict = sparta_8cad244f5b('keras')
        if res_dict['res'] == -1:
            return res_dict
        print('res_dict KERAS')
        print(res_dict)
        res_dict = sparta_8cad244f5b('tensorflow')
        if res_dict['res'] == -1:
            return res_dict
        print('res_dict TF')
        print(res_dict)
...
def sparta_98dd624adb(json_data, user_obj) ->dict:
    """
    Run features importance analysis
    """
    import project.sparta_8345d6a892.sparta_950a603163.qube_14d0335fd8 as qube_14d0335fd8
    data_df = sparta_edddaec0b1(json_data)
    ...
    try:
        if tsa_model == 'adf':
            ...
            return qube_14d0335fd8.sparta_6b024d2e5e(data_df, json_data.get(
                'params', None))
        elif tsa_model == 'kpss':
            cols_dataset = json_data['colDataset']
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_de2eafd5ea(data_df, json_data.get(
                'params', None))
        elif tsa_model == 'perron':
            cols_dataset = json_data['colDataset']
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_7c27c48c5e(data_df, json_data.get(
                'params', None))
        elif tsa_model == 'za':
            cols_dataset = json_data['colDataset']
            ...
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_9519eea6d1(data_df, dates_series,
            ...
            if date_col is not None:
                if len(date_col) > 0:
                    try:
                        ...
                        dates_series = None
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_86d23b0ace(data_df, dates_series, json_data.get('params', None), B_DARK_THEME=json_data.get(
                'B_DARK_THEME', False))
            ...
            if date_col is not None:
                if len(date_col) > 0:
                    try:
                        ...
                        dates_series = None
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_d110be9040(data_df, dates_series,
                json_data.get('params', None), B_DARK_THEME=json_data.get(
                'B_DARK_THEME', False))
        elif tsa_model == 'hmm':
            cols_dataset = json_data['colDataset']
            ...
            if date_col is not None:
                if len(date_col) > 0:
                    try:
                        ...
                        dates_series = None
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_34e8ca5bf1(data_df, dates_series, json_data.get('params', None), B_DARK_THEME=json_data.get(
                'B_DARK_THEME', False))
            ...
            if date_col is not None:
                if len(date_col) > 0:
                    try:
                        ...
                        dates_series = None
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_a13d5adad4(data_df, dates_series,
                json_data.get('params', None), B_DARK_THEME=json_data.get(
                'B_DARK_THEME', False))
            ...
            if date_col is not None:
                if len(date_col) > 0:
                    try:
                        ...
                        dates_series = None
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_85d23ef7e4(data_df, dates_series,
                json_data.get('params', None), B_DARK_THEME=json_data.get(
                'B_DARK_THEME', False))
            ...
            if date_col is not None:
                if len(date_col) > 0:
                    try:
                        ...
                        dates_series = None
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_8abadcb359(data_df, dates_series,
                json_data.get('params', None), B_DARK_THEME=json_data.get(
                'B_DARK_THEME', False))
            ...
            if date_col is not None:
                if len(date_col) > 0:
                    try:
                        ...
                        dates_series = None
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_895418bd18(data_df,
            ...
            if date_col is not None:
                if len(date_col) > 0:
                    try:
                        ...
                        dates_series = None
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_0cca0ad0dc(data_df,
                dates_series, json_data.get('params', None), B_DARK_THEME=
                json_data.get('B_DARK_THEME', False))
            ...
            if date_col is not None:
                if len(date_col) > 0:
                    try:
                        ...
                        dates_series = None
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_3d1548248c(data_df,
                dates_series, json_data.get('params', None), B_DARK_THEME=
                json_data.get('B_DARK_THEME', False))
            ...
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_54aec20094(data_df, target_series,
                json_data.get('params', None), B_DARK_THEME=json_data.get(
                'B_DARK_THEME', False))
            ...
            target_series = data_df[target]
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_be805ec9ca(data_df,
            ...
            return qube_14d0335fd8.sparta_5bdfd766b5(data1_df,
            ...
            if date_col is not None:
                if len(date_col) > 0:
                    try:
                        ...
                        dates_series = None
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_03bc317229(data_df, dates_series,
                json_data.get('params', None), B_DARK_THEME=json_data.get(
                'B_DARK_THEME', False))
        elif tsa_model == 'ets':
            cols_dataset = json_data['colDataset']
            ...
            if date_col is not None:
                if len(date_col) > 0:
                    try:
                        ...
                        dates_series = None
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_464afe73fc(data_df, dates_series, json_data.get('params', None), B_DARK_THEME=json_data.get(
                'B_DARK_THEME', False))
            ...
            if date_col is not None:
                if len(date_col) > 0:
                    try:
                        ...
                        dates_series = None
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_d0b58a562f(data_df,
                dates_series, json_data.get('params', None), B_DARK_THEME=
                json_data.get('B_DARK_THEME', False))
        elif tsa_model == 'lstm':
            cols_dataset = json_data['colDataset']
            ...
            if date_col is not None:
                if len(date_col) > 0:
                    try:
                        ...
                        dates_series = None
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_7398d369ce(data_df, dates_series,
                json_data.get('params', None), B_DARK_THEME=json_data.get(
                'B_DARK_THEME', False))
        elif tsa_model == 'var':
            cols_dataset = json_data['colDataset']
            ...
            if date_col is not None:
                if len(date_col) > 0:
                    try:
                        ...
                        dates_series = None
            data_df = data_df[cols_dataset]
            return qube_14d0335fd8.sparta_1587f8ceee(data_df, dates_series, json_data.get('params', None), B_DARK_THEME=json_data.get(
                'B_DARK_THEME', False))
    except Exception as e:
        this_traceback = traceback.format_exc()
...
def sparta_9f46127e8e(token_permission) ->dict:
    """
    ...
    if dataframe_model_obj.is_expose_widget:
        if dataframe_model_obj.is_public_widget:
            if not has_widget_password:
                ...
                try:
                    if qube_9c73ae35fa.sparta_201801731a(
...
def sparta_2901e6f78f(slug, user_obj, password_widget=None) ->dict:
    """
...
def sparta_376233968b(slug, user_obj) ->dict:
    """
