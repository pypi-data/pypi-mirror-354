...
def sparta_23663b0838(json_data, userObj):
    """
    We manage two cases:
    ...
    try:
        folders, onlyfiles = sparta_0557fb3af1(currentPath,
            typeexplorer)
...
def sparta_57e1d039ae(json_data, userObj):
    """
    ...
    try:
        ...
        folders, onlyfiles = sparta_0557fb3af1(newPath, typeexplorer)
        res = {'res': 1, 'files': onlyfiles, 'folders': folders,
            'currentPath': newPath}
    except:
        res = {'res': -1, 'msg': 'Path not found...'}
...
def sparta_8c21465b4b(json_data, userObj):
    """
...
def sparta_0557fb3af1(currentPath, typeexplorer=None):
...
def sparta_6251794c58(currentPath):
    """
