...
def sparta_8634196413(user_obj) ->list:
    """
...
def sparta_f588ea9f66(json_data, user_obj) ->dict:
    """
    Load my palettes
    """
    palette_colors_set = PaletteColors.objects.filter(user=user_obj,
...
def sparta_b721e42085(json_data, user_obj) ->dict:
    """
...
def sparta_13b5c7b88c(json_data, user_obj) ->dict:
    """
...
def sparta_33746681b8(json_data, user_obj) ->dict:
    """
    Delete palette
    """
    palette_id = json_data['palette_id']
