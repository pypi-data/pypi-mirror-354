...
secrets_dict=sparta_6764065e39()
...
if IS_CYPRESS:IS_VITE=_A;IS_DEV=_A;IS_DEV_VIEW_ENABLED=_A;os.environ[_D]='0'
DEBUG=_A
DEFAULT_TIMEOUT=60
...
ALLOWED_HOSTS=['django',_E,'localhost:*','localhost:81','*']+allowed_domains
CSRF_TRUSTED_ORIGINS=['http://localhost:*','http://localhost:81/*']+allowed_domains
ports=range(1,65536)
protocols=['http','https']
hostnames=[_E,sparta_7fc94e0326()]
...
from spartaqube_app.db_path import sparta_2f207ab8e0
LOCAL_DB_PATH=sparta_2f207ab8e0()
