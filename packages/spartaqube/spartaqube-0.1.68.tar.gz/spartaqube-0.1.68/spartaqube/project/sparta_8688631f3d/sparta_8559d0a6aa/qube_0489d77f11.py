...
from project.sparta_ef90090f65.qube_c7e5464d5d import timeout
from project.sparta_8688631f3d.sparta_c77f2d3c37.qube_8f0cad92aa import convert_to_dataframe,sparta_226d9606de
from project.sparta_8688631f3d.sparta_c77f2d3c37.qube_f0d228f17a import sparta_ca71f9cc05
from project.logger_config import logger
B_DEBUG=_B
SEND_INTERVAL=.8
def sparta_0469302a0d():return conf_settings.DEFAULT_TIMEOUT
def sparta_30de57bf98(file_path=_A,text=_A,b_log=_C):
	B=b_log;A=file_path
...
class IPythonKernel:
	...
	async def initialize_kernel(B):
		...
		A+='django.setup()\n';D=sparta_bff35427ab()['project'];E=sparta_bff35427ab()['project/core/api'];A+=f'sys.path.insert(0, r"{str(D)}")\n';A+=f'sys.path.insert(0, r"{str(E)}")\n';A+=f'os.environ["api_key"] = "{B.api_key}"\n'
	...
	async def activate_venv(C,venv_name):
		def D():B=sparta_ca71f9cc05();A=os.path.join(B,'sq_venv');A=os.path.normpath(A);os.makedirs(A,exist_ok=_C);return A
