...
def sparta_e71ec7c89a(type=_M):B=_F;D={_G:_J,_H:_K,_I:_L};A=_N;C='{\n        "showTicks": True,\n        "renderTicks": {\n            "showTicks": True,\n            "divisions": 10,\n        },\n    }';return[{_A:f"{type.capitalize()}",_B:_E,_C:'',_D:f"""{B}
...
plot_example"""}]
def sparta_3ee8ba535a():return sparta_e71ec7c89a(type=_M)
def sparta_9a9ef70108():return sparta_e71ec7c89a(type='gauge2')
def sparta_020fe9e217():type='gauge3';B=_F;D={_G:_J,_H:_K,_I:_L};A={'min':0,'max':100,'value':34};C=_O;return[{_A:f"{type.capitalize()}",_B:_E,_C:'',_D:f"""{B}
spartaqube_obj = Spartaqube()
gauge_data_dict = {A}
# Plot example
plot_example = spartaqube_obj.plot(
...
plot_example"""}]
def sparta_bd4f127f3a():type='gauge4';B=_F;D={_G:_J,_H:_K,_I:_L};A=_N;C=_O;return[{_A:f"{type.capitalize()}",_B:_E,_C:'',_D:f"""{B}
spartaqube_obj = Spartaqube()
gauge_data_dict = {A}
# Plot example
plot_example = spartaqube_obj.plot(
