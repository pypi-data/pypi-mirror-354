...
class Reservation(models.Model):
    """Class representing a reservation for a delivery group."""
    ...
    def __str__(self):
        """Generate a string representation to be used in messages."""
        return (
    ...
    @property
    def t_range(self):
        """Get the time range associated to the reservation.
    ...
    def running(cls, dg_name):
        """Get the currently active ("running") reservations for the given DG.
    ...
    def running_usernames(cls, dg_name):
        """Get the usernames having currently active ("running") reservations.
    ...
    def ending_in_less_than(cls, minutes: int, dg_name: str, username: str = ""):
        """Get running reservations ending in less than the given delta from now.
