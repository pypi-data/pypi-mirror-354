...
@LastEditTime: 2024-02-01 11:45:55
...
P_TARGET_APPKEY = "target_app_key"
...
class RestApi(object):
    ...
    def getResponse(self, authrize=None, timeout=30, **kwargs):
        #=======================================================================
        # 获取response结果
        #=======================================================================
        if (self.__port == 443):
        ...
        if kwargs.get("domain", "") == "qm" and kwargs.get("target_app_key", ""):
            sys_parameters[P_TARGET_APPKEY] = kwargs.get("target_app_key")
        ...
        rest = QM_REST if kwargs.get("domain", "") == "qm" else N_REST
        url = rest + "?" + urllib.parse.urlencode(sys_parameters)
