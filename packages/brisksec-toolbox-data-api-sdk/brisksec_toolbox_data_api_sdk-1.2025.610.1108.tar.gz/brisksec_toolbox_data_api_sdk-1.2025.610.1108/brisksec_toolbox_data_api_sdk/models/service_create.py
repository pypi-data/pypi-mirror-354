...
from ..models.service_create_business_criticality import ServiceCreateBusinessCriticality
from ..models.service_create_category import ServiceCreateCategory
from ..models.service_create_classification import ServiceCreateClassification
from ..models.service_create_environment import ServiceCreateEnvironment
from ..models.service_create_lifecycle_stage import ServiceCreateLifecycleStage
from ..models.service_create_protocol import ServiceCreateProtocol
from ..models.service_create_sensitivity import ServiceCreateSensitivity
from ..models.service_create_service_status import ServiceCreateServiceStatus
from ..models.service_create_status import ServiceCreateStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.service_create_geographic_location import ServiceCreateGeographicLocation
    from ..models.service_create_labels import ServiceCreateLabels
...
class ServiceCreate:
    ...
    Attributes:
        ...
        protocol (Union[Unset, ServiceCreateProtocol]): Network protocol used by the service Default:
            ServiceCreateProtocol.TCP.
        version (Union[None, Unset, str]): Version of the service software
        banner (Union[None, Unset, str]): Service banner information
        service_status (Union[Unset, ServiceCreateServiceStatus]): Current operational status of the service Default:
            ServiceCreateServiceStatus.ACTIVE.
        classification (Union[Unset, ServiceCreateClassification]): Classification level of the asset Default:
            ServiceCreateClassification.UNKNOWN.
        sensitivity (Union[Unset, ServiceCreateSensitivity]): Sensitivity level of the asset Default:
            ServiceCreateSensitivity.UNKNOWN.
        category (Union[Unset, ServiceCreateCategory]): Category of the asset Default: ServiceCreateCategory.UNKNOWN.
        tags (Union[Unset, list[str]]): List of tags for categorizing the asset
        labels (Union[Unset, ServiceCreateLabels]): Key-value pairs for additional metadata
        ...
        status (Union[Unset, ServiceCreateStatus]): Current status of the asset Default: ServiceCreateStatus.UNKNOWN.
        lifecycle_stage (Union[Unset, ServiceCreateLifecycleStage]): Current lifecycle stage of the asset Default:
            ServiceCreateLifecycleStage.UNKNOWN.
        ...
        environment (Union[Unset, ServiceCreateEnvironment]): Environment where the asset is deployed Default:
            ServiceCreateEnvironment.UNKNOWN.
        business_criticality (Union[Unset, ServiceCreateBusinessCriticality]): How critical the asset is to business
            operations Default: ServiceCreateBusinessCriticality.UNKNOWN.
        ...
        geographic_location (Union[Unset, ServiceCreateGeographicLocation]):
    ...
    port: int
    name: str
    protocol: Union[Unset, ServiceCreateProtocol] = ServiceCreateProtocol.TCP
    version: Union[None, Unset, str] = UNSET
    banner: Union[None, Unset, str] = UNSET
    service_status: Union[Unset, ServiceCreateServiceStatus] = ServiceCreateServiceStatus.ACTIVE
    classification: Union[Unset, ServiceCreateClassification] = ServiceCreateClassification.UNKNOWN
    sensitivity: Union[Unset, ServiceCreateSensitivity] = ServiceCreateSensitivity.UNKNOWN
    category: Union[Unset, ServiceCreateCategory] = ServiceCreateCategory.UNKNOWN
    tags: Union[Unset, list[str]] = UNSET
    labels: Union[Unset, "ServiceCreateLabels"] = UNSET
    ...
    status: Union[Unset, ServiceCreateStatus] = ServiceCreateStatus.UNKNOWN
    lifecycle_stage: Union[Unset, ServiceCreateLifecycleStage] = ServiceCreateLifecycleStage.UNKNOWN
    ...
    environment: Union[Unset, ServiceCreateEnvironment] = ServiceCreateEnvironment.UNKNOWN
    business_criticality: Union[Unset, ServiceCreateBusinessCriticality] = ServiceCreateBusinessCriticality.UNKNOWN
    ...
    geographic_location: Union[Unset, "ServiceCreateGeographicLocation"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        protocol: Union[Unset, ServiceCreateProtocol]
        if isinstance(_protocol, Unset):
            protocol = UNSET
        else:
            protocol = ServiceCreateProtocol(_protocol)
        ...
        service_status: Union[Unset, ServiceCreateServiceStatus]
        if isinstance(_service_status, Unset):
            service_status = UNSET
        else:
            service_status = ServiceCreateServiceStatus(_service_status)

        _classification = d.pop("classification", UNSET)
        classification: Union[Unset, ServiceCreateClassification]
        if isinstance(_classification, Unset):
            classification = UNSET
        else:
            classification = ServiceCreateClassification(_classification)

        _sensitivity = d.pop("sensitivity", UNSET)
        sensitivity: Union[Unset, ServiceCreateSensitivity]
        if isinstance(_sensitivity, Unset):
            sensitivity = UNSET
        else:
            sensitivity = ServiceCreateSensitivity(_sensitivity)

        _category = d.pop("category", UNSET)
        category: Union[Unset, ServiceCreateCategory]
        if isinstance(_category, Unset):
            category = UNSET
        else:
            category = ServiceCreateCategory(_category)

        tags = cast(list[str], d.pop("tags", UNSET))

        _labels = d.pop("labels", UNSET)
        labels: Union[Unset, ServiceCreateLabels]
        if isinstance(_labels, Unset):
            labels = UNSET
        else:
            labels = ServiceCreateLabels.from_dict(_labels)
        ...
        status: Union[Unset, ServiceCreateStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = ServiceCreateStatus(_status)

        _lifecycle_stage = d.pop("lifecycle_stage", UNSET)
        lifecycle_stage: Union[Unset, ServiceCreateLifecycleStage]
        if isinstance(_lifecycle_stage, Unset):
            lifecycle_stage = UNSET
        else:
            lifecycle_stage = ServiceCreateLifecycleStage(_lifecycle_stage)
        ...
        environment: Union[Unset, ServiceCreateEnvironment]
        if isinstance(_environment, Unset):
            environment = UNSET
        else:
            environment = ServiceCreateEnvironment(_environment)

        _business_criticality = d.pop("business_criticality", UNSET)
        business_criticality: Union[Unset, ServiceCreateBusinessCriticality]
        if isinstance(_business_criticality, Unset):
            business_criticality = UNSET
        else:
            business_criticality = ServiceCreateBusinessCriticality(_business_criticality)
        ...
        if isinstance(_geographic_location, Unset):
            ...
            geographic_location = ServiceCreateGeographicLocation.from_dict(_geographic_location)
