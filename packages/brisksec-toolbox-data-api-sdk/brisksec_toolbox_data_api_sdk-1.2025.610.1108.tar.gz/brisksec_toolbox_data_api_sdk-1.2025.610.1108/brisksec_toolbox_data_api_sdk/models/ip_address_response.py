...
from ..models.ip_address_response_business_criticality import IPAddressResponseBusinessCriticality
from ..models.ip_address_response_category import IPAddressResponseCategory
from ..models.ip_address_response_classification import IPAddressResponseClassification
from ..models.ip_address_response_environment import IPAddressResponseEnvironment
from ..models.ip_address_response_ip_type import IPAddressResponseIpType
from ..models.ip_address_response_lifecycle_stage import IPAddressResponseLifecycleStage
from ..models.ip_address_response_sensitivity import IPAddressResponseSensitivity
from ..models.ip_address_response_status import IPAddressResponseStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.ip_address_response_geographic_location import IPAddressResponseGeographicLocation
    from ..models.ip_address_response_labels import IPAddressResponseLabels
...
class IPAddressResponse:
    ...
    Attributes:
        ...
        ip_type (Union[Unset, IPAddressResponseIpType]): Type of IP address (IPv4 or IPv6) Default:
            IPAddressResponseIpType.IPV4.
        ...
        classification (Union[Unset, IPAddressResponseClassification]): Classification level of the asset Default:
            IPAddressResponseClassification.UNKNOWN.
        sensitivity (Union[Unset, IPAddressResponseSensitivity]): Sensitivity level of the asset Default:
            IPAddressResponseSensitivity.UNKNOWN.
        category (Union[Unset, IPAddressResponseCategory]): Category of the asset Default:
            IPAddressResponseCategory.UNKNOWN.
        tags (Union[Unset, list[str]]): List of tags for categorizing the asset
        labels (Union[Unset, IPAddressResponseLabels]): Key-value pairs for additional metadata
        ...
        status (Union[Unset, IPAddressResponseStatus]): Current status of the asset Default:
            IPAddressResponseStatus.UNKNOWN.
        lifecycle_stage (Union[Unset, IPAddressResponseLifecycleStage]): Current lifecycle stage of the asset Default:
            IPAddressResponseLifecycleStage.UNKNOWN.
        ...
        environment (Union[Unset, IPAddressResponseEnvironment]): Environment where the asset is deployed Default:
            IPAddressResponseEnvironment.UNKNOWN.
        business_criticality (Union[Unset, IPAddressResponseBusinessCriticality]): How critical the asset is to business
            operations Default: IPAddressResponseBusinessCriticality.UNKNOWN.
        ...
        geographic_location (Union[Unset, IPAddressResponseGeographicLocation]):
        ...
        organization (Union[None, Unset, str]): Organization that owns this IP address
    """
    ...
    ip_type: Union[Unset, IPAddressResponseIpType] = IPAddressResponseIpType.IPV4
    ...
    classification: Union[Unset, IPAddressResponseClassification] = IPAddressResponseClassification.UNKNOWN
    sensitivity: Union[Unset, IPAddressResponseSensitivity] = IPAddressResponseSensitivity.UNKNOWN
    category: Union[Unset, IPAddressResponseCategory] = IPAddressResponseCategory.UNKNOWN
    tags: Union[Unset, list[str]] = UNSET
    labels: Union[Unset, "IPAddressResponseLabels"] = UNSET
    ...
    status: Union[Unset, IPAddressResponseStatus] = IPAddressResponseStatus.UNKNOWN
    lifecycle_stage: Union[Unset, IPAddressResponseLifecycleStage] = IPAddressResponseLifecycleStage.UNKNOWN
    ...
    environment: Union[Unset, IPAddressResponseEnvironment] = IPAddressResponseEnvironment.UNKNOWN
    business_criticality: Union[Unset, IPAddressResponseBusinessCriticality] = (
        IPAddressResponseBusinessCriticality.UNKNOWN
    )
    ...
    geographic_location: Union[Unset, "IPAddressResponseGeographicLocation"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ip_type: Union[Unset, IPAddressResponseIpType]
        if isinstance(_ip_type, Unset):
            ip_type = UNSET
        else:
            ip_type = IPAddressResponseIpType(_ip_type)
        ...
        classification: Union[Unset, IPAddressResponseClassification]
        if isinstance(_classification, Unset):
            classification = UNSET
        else:
            classification = IPAddressResponseClassification(_classification)

        _sensitivity = d.pop("sensitivity", UNSET)
        sensitivity: Union[Unset, IPAddressResponseSensitivity]
        if isinstance(_sensitivity, Unset):
            sensitivity = UNSET
        else:
            sensitivity = IPAddressResponseSensitivity(_sensitivity)

        _category = d.pop("category", UNSET)
        category: Union[Unset, IPAddressResponseCategory]
        if isinstance(_category, Unset):
            category = UNSET
        else:
            category = IPAddressResponseCategory(_category)

        tags = cast(list[str], d.pop("tags", UNSET))

        _labels = d.pop("labels", UNSET)
        labels: Union[Unset, IPAddressResponseLabels]
        if isinstance(_labels, Unset):
            labels = UNSET
        else:
            labels = IPAddressResponseLabels.from_dict(_labels)
        ...
        status: Union[Unset, IPAddressResponseStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = IPAddressResponseStatus(_status)

        _lifecycle_stage = d.pop("lifecycle_stage", UNSET)
        lifecycle_stage: Union[Unset, IPAddressResponseLifecycleStage]
        if isinstance(_lifecycle_stage, Unset):
            lifecycle_stage = UNSET
        else:
            lifecycle_stage = IPAddressResponseLifecycleStage(_lifecycle_stage)
        ...
        environment: Union[Unset, IPAddressResponseEnvironment]
        if isinstance(_environment, Unset):
            environment = UNSET
        else:
            environment = IPAddressResponseEnvironment(_environment)
        ...
        if isinstance(_business_criticality, Unset):
            ...
            business_criticality = IPAddressResponseBusinessCriticality(_business_criticality)
        ...
        if isinstance(_geographic_location, Unset):
            ...
            geographic_location = IPAddressResponseGeographicLocation.from_dict(_geographic_location)
