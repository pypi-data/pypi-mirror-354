...
from ..models.domain_create_business_criticality import DomainCreateBusinessCriticality
from ..models.domain_create_category import DomainCreateCategory
from ..models.domain_create_classification import DomainCreateClassification
from ..models.domain_create_domain_status import DomainCreateDomainStatus
from ..models.domain_create_environment import DomainCreateEnvironment
from ..models.domain_create_lifecycle_stage import DomainCreateLifecycleStage
from ..models.domain_create_sensitivity import DomainCreateSensitivity
from ..models.domain_create_status import DomainCreateStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.domain_create_geographic_location import DomainCreateGeographicLocation
    from ..models.domain_create_labels import DomainCreateLabels


T = TypeVar("T", bound="DomainCreate")
...
class DomainCreate:
    ...
    Attributes:
        ...
        domain_status (Union[Unset, DomainCreateDomainStatus]): Current status of the domain Default:
            DomainCreateDomainStatus.ACTIVE.
        nameservers (Union[Unset, list[str]]): List of nameservers for this domain
        classification (Union[Unset, DomainCreateClassification]): Classification level of the asset Default:
            DomainCreateClassification.UNKNOWN.
        sensitivity (Union[Unset, DomainCreateSensitivity]): Sensitivity level of the asset Default:
            DomainCreateSensitivity.UNKNOWN.
        category (Union[Unset, DomainCreateCategory]): Category of the asset Default: DomainCreateCategory.UNKNOWN.
        tags (Union[Unset, list[str]]): List of tags for categorizing the asset
        labels (Union[Unset, DomainCreateLabels]): Key-value pairs for additional metadata
        ...
        status (Union[Unset, DomainCreateStatus]): Current status of the asset Default: DomainCreateStatus.UNKNOWN.
        lifecycle_stage (Union[Unset, DomainCreateLifecycleStage]): Current lifecycle stage of the asset Default:
            DomainCreateLifecycleStage.UNKNOWN.
        ...
        environment (Union[Unset, DomainCreateEnvironment]): Environment where the asset is deployed Default:
            DomainCreateEnvironment.UNKNOWN.
        business_criticality (Union[Unset, DomainCreateBusinessCriticality]): How critical the asset is to business
            operations Default: DomainCreateBusinessCriticality.UNKNOWN.
        ...
        geographic_location (Union[Unset, DomainCreateGeographicLocation]):
    ...
    domain_status: Union[Unset, DomainCreateDomainStatus] = DomainCreateDomainStatus.ACTIVE
    nameservers: Union[Unset, list[str]] = UNSET
    classification: Union[Unset, DomainCreateClassification] = DomainCreateClassification.UNKNOWN
    sensitivity: Union[Unset, DomainCreateSensitivity] = DomainCreateSensitivity.UNKNOWN
    category: Union[Unset, DomainCreateCategory] = DomainCreateCategory.UNKNOWN
    tags: Union[Unset, list[str]] = UNSET
    labels: Union[Unset, "DomainCreateLabels"] = UNSET
    ...
    status: Union[Unset, DomainCreateStatus] = DomainCreateStatus.UNKNOWN
    lifecycle_stage: Union[Unset, DomainCreateLifecycleStage] = DomainCreateLifecycleStage.UNKNOWN
    ...
    environment: Union[Unset, DomainCreateEnvironment] = DomainCreateEnvironment.UNKNOWN
    business_criticality: Union[Unset, DomainCreateBusinessCriticality] = DomainCreateBusinessCriticality.UNKNOWN
    ...
    geographic_location: Union[Unset, "DomainCreateGeographicLocation"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domain_status: Union[Unset, DomainCreateDomainStatus]
        if isinstance(_domain_status, Unset):
            domain_status = UNSET
        else:
            domain_status = DomainCreateDomainStatus(_domain_status)

        nameservers = cast(list[str], d.pop("nameservers", UNSET))

        _classification = d.pop("classification", UNSET)
        classification: Union[Unset, DomainCreateClassification]
        if isinstance(_classification, Unset):
            classification = UNSET
        else:
            classification = DomainCreateClassification(_classification)

        _sensitivity = d.pop("sensitivity", UNSET)
        sensitivity: Union[Unset, DomainCreateSensitivity]
        if isinstance(_sensitivity, Unset):
            sensitivity = UNSET
        else:
            sensitivity = DomainCreateSensitivity(_sensitivity)

        _category = d.pop("category", UNSET)
        category: Union[Unset, DomainCreateCategory]
        if isinstance(_category, Unset):
            category = UNSET
        else:
            category = DomainCreateCategory(_category)

        tags = cast(list[str], d.pop("tags", UNSET))

        _labels = d.pop("labels", UNSET)
        labels: Union[Unset, DomainCreateLabels]
        if isinstance(_labels, Unset):
            labels = UNSET
        else:
            labels = DomainCreateLabels.from_dict(_labels)
        ...
        status: Union[Unset, DomainCreateStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = DomainCreateStatus(_status)

        _lifecycle_stage = d.pop("lifecycle_stage", UNSET)
        lifecycle_stage: Union[Unset, DomainCreateLifecycleStage]
        if isinstance(_lifecycle_stage, Unset):
            lifecycle_stage = UNSET
        else:
            lifecycle_stage = DomainCreateLifecycleStage(_lifecycle_stage)
        ...
        environment: Union[Unset, DomainCreateEnvironment]
        if isinstance(_environment, Unset):
            environment = UNSET
        else:
            environment = DomainCreateEnvironment(_environment)

        _business_criticality = d.pop("business_criticality", UNSET)
        business_criticality: Union[Unset, DomainCreateBusinessCriticality]
        if isinstance(_business_criticality, Unset):
            business_criticality = UNSET
        else:
            business_criticality = DomainCreateBusinessCriticality(_business_criticality)
        ...
        if isinstance(_geographic_location, Unset):
            ...
            geographic_location = DomainCreateGeographicLocation.from_dict(_geographic_location)
        ...
        domain_create.additional_properties = d
