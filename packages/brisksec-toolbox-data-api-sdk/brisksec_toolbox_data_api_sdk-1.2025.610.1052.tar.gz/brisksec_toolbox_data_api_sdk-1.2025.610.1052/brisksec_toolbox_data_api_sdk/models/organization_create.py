...
from ..models.organization_create_business_criticality import OrganizationCreateBusinessCriticality
from ..models.organization_create_category import OrganizationCreateCategory
from ..models.organization_create_classification import OrganizationCreateClassification
from ..models.organization_create_environment import OrganizationCreateEnvironment
from ..models.organization_create_lifecycle_stage import OrganizationCreateLifecycleStage
from ..models.organization_create_sensitivity import OrganizationCreateSensitivity
from ..models.organization_create_status import OrganizationCreateStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.organization_create_geographic_location import OrganizationCreateGeographicLocation
    from ..models.organization_create_labels import OrganizationCreateLabels
...
class OrganizationCreate:
    ...
    Attributes:
        ...
        classification (Union[Unset, OrganizationCreateClassification]): Classification level of the asset Default:
            OrganizationCreateClassification.UNKNOWN.
        sensitivity (Union[Unset, OrganizationCreateSensitivity]): Sensitivity level of the asset Default:
            OrganizationCreateSensitivity.UNKNOWN.
        category (Union[Unset, OrganizationCreateCategory]): Category of the asset Default:
            OrganizationCreateCategory.UNKNOWN.
        tags (Union[Unset, list[str]]): List of tags for categorizing the asset
        labels (Union[Unset, OrganizationCreateLabels]): Key-value pairs for additional metadata
        ...
        status (Union[Unset, OrganizationCreateStatus]): Current status of the asset Default:
            OrganizationCreateStatus.UNKNOWN.
        lifecycle_stage (Union[Unset, OrganizationCreateLifecycleStage]): Current lifecycle stage of the asset Default:
            OrganizationCreateLifecycleStage.UNKNOWN.
        ...
        environment (Union[Unset, OrganizationCreateEnvironment]): Environment where the asset is deployed Default:
            OrganizationCreateEnvironment.UNKNOWN.
        business_criticality (Union[Unset, OrganizationCreateBusinessCriticality]): How critical the asset is to
            business operations Default: OrganizationCreateBusinessCriticality.UNKNOWN.
        ...
        geographic_location (Union[Unset, OrganizationCreateGeographicLocation]):
    ...
    classification: Union[Unset, OrganizationCreateClassification] = OrganizationCreateClassification.UNKNOWN
    sensitivity: Union[Unset, OrganizationCreateSensitivity] = OrganizationCreateSensitivity.UNKNOWN
    category: Union[Unset, OrganizationCreateCategory] = OrganizationCreateCategory.UNKNOWN
    tags: Union[Unset, list[str]] = UNSET
    labels: Union[Unset, "OrganizationCreateLabels"] = UNSET
    ...
    status: Union[Unset, OrganizationCreateStatus] = OrganizationCreateStatus.UNKNOWN
    lifecycle_stage: Union[Unset, OrganizationCreateLifecycleStage] = OrganizationCreateLifecycleStage.UNKNOWN
    ...
    environment: Union[Unset, OrganizationCreateEnvironment] = OrganizationCreateEnvironment.UNKNOWN
    business_criticality: Union[Unset, OrganizationCreateBusinessCriticality] = (
        OrganizationCreateBusinessCriticality.UNKNOWN
    )
    ...
    geographic_location: Union[Unset, "OrganizationCreateGeographicLocation"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        classification: Union[Unset, OrganizationCreateClassification]
        if isinstance(_classification, Unset):
            classification = UNSET
        else:
            classification = OrganizationCreateClassification(_classification)

        _sensitivity = d.pop("sensitivity", UNSET)
        sensitivity: Union[Unset, OrganizationCreateSensitivity]
        if isinstance(_sensitivity, Unset):
            sensitivity = UNSET
        else:
            sensitivity = OrganizationCreateSensitivity(_sensitivity)

        _category = d.pop("category", UNSET)
        category: Union[Unset, OrganizationCreateCategory]
        if isinstance(_category, Unset):
            category = UNSET
        else:
            category = OrganizationCreateCategory(_category)

        tags = cast(list[str], d.pop("tags", UNSET))

        _labels = d.pop("labels", UNSET)
        labels: Union[Unset, OrganizationCreateLabels]
        if isinstance(_labels, Unset):
            labels = UNSET
        else:
            labels = OrganizationCreateLabels.from_dict(_labels)
        ...
        status: Union[Unset, OrganizationCreateStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = OrganizationCreateStatus(_status)

        _lifecycle_stage = d.pop("lifecycle_stage", UNSET)
        lifecycle_stage: Union[Unset, OrganizationCreateLifecycleStage]
        if isinstance(_lifecycle_stage, Unset):
            lifecycle_stage = UNSET
        else:
            lifecycle_stage = OrganizationCreateLifecycleStage(_lifecycle_stage)
        ...
        environment: Union[Unset, OrganizationCreateEnvironment]
        if isinstance(_environment, Unset):
            environment = UNSET
        else:
            environment = OrganizationCreateEnvironment(_environment)
        ...
        if isinstance(_business_criticality, Unset):
            ...
            business_criticality = OrganizationCreateBusinessCriticality(_business_criticality)
        ...
        if isinstance(_geographic_location, Unset):
            ...
            geographic_location = OrganizationCreateGeographicLocation.from_dict(_geographic_location)
