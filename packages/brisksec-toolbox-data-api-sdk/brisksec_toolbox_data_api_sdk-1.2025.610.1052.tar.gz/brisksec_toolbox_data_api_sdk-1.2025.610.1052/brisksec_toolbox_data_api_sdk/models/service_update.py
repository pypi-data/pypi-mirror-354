...
from ..models.service_update_business_criticality import ServiceUpdateBusinessCriticality
from ..models.service_update_category import ServiceUpdateCategory
from ..models.service_update_classification import ServiceUpdateClassification
from ..models.service_update_environment import ServiceUpdateEnvironment
from ..models.service_update_lifecycle_stage import ServiceUpdateLifecycleStage
from ..models.service_update_protocol import ServiceUpdateProtocol
from ..models.service_update_sensitivity import ServiceUpdateSensitivity
from ..models.service_update_service_status import ServiceUpdateServiceStatus
from ..models.service_update_status import ServiceUpdateStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.service_update_geographic_location import ServiceUpdateGeographicLocation
    from ..models.service_update_labels import ServiceUpdateLabels
...
@_attrs_define
class ServiceUpdate:
    """Schema for updating service fields (all optional for partial updates)

    Attributes:
        port (Union[None, Unset, int]): Port number for the service
        protocol (Union[Unset, ServiceUpdateProtocol]): Network protocol used by the service Default:
            ServiceUpdateProtocol.TCP.
        version (Union[None, Unset, str]): Version of the service software
        banner (Union[None, Unset, str]): Service banner information
        service_status (Union[Unset, ServiceUpdateServiceStatus]): Current operational status of the service Default:
            ServiceUpdateServiceStatus.ACTIVE.
        classification (Union[Unset, ServiceUpdateClassification]): Classification level of the asset Default:
            ServiceUpdateClassification.UNKNOWN.
        sensitivity (Union[Unset, ServiceUpdateSensitivity]): Sensitivity level of the asset Default:
            ServiceUpdateSensitivity.UNKNOWN.
        category (Union[Unset, ServiceUpdateCategory]): Category of the asset Default: ServiceUpdateCategory.UNKNOWN.
        tags (Union[Unset, list[str]]): List of tags for categorizing the asset
        labels (Union[Unset, ServiceUpdateLabels]): Key-value pairs for additional metadata
        ...
        status (Union[Unset, ServiceUpdateStatus]): Current status of the asset Default: ServiceUpdateStatus.UNKNOWN.
        lifecycle_stage (Union[Unset, ServiceUpdateLifecycleStage]): Current lifecycle stage of the asset Default:
            ServiceUpdateLifecycleStage.UNKNOWN.
        ...
        environment (Union[Unset, ServiceUpdateEnvironment]): Environment where the asset is deployed Default:
            ServiceUpdateEnvironment.UNKNOWN.
        business_criticality (Union[Unset, ServiceUpdateBusinessCriticality]): How critical the asset is to business
            operations Default: ServiceUpdateBusinessCriticality.UNKNOWN.
        ...
        geographic_location (Union[Unset, ServiceUpdateGeographicLocation]):
    ...
    protocol: Union[Unset, ServiceUpdateProtocol] = ServiceUpdateProtocol.TCP
    version: Union[None, Unset, str] = UNSET
    banner: Union[None, Unset, str] = UNSET
    service_status: Union[Unset, ServiceUpdateServiceStatus] = ServiceUpdateServiceStatus.ACTIVE
    classification: Union[Unset, ServiceUpdateClassification] = ServiceUpdateClassification.UNKNOWN
    sensitivity: Union[Unset, ServiceUpdateSensitivity] = ServiceUpdateSensitivity.UNKNOWN
    category: Union[Unset, ServiceUpdateCategory] = ServiceUpdateCategory.UNKNOWN
    tags: Union[Unset, list[str]] = UNSET
    labels: Union[Unset, "ServiceUpdateLabels"] = UNSET
    ...
    status: Union[Unset, ServiceUpdateStatus] = ServiceUpdateStatus.UNKNOWN
    lifecycle_stage: Union[Unset, ServiceUpdateLifecycleStage] = ServiceUpdateLifecycleStage.UNKNOWN
    ...
    environment: Union[Unset, ServiceUpdateEnvironment] = ServiceUpdateEnvironment.UNKNOWN
    business_criticality: Union[Unset, ServiceUpdateBusinessCriticality] = ServiceUpdateBusinessCriticality.UNKNOWN
    ...
    geographic_location: Union[Unset, "ServiceUpdateGeographicLocation"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        protocol: Union[Unset, ServiceUpdateProtocol]
        if isinstance(_protocol, Unset):
            protocol = UNSET
        else:
            protocol = ServiceUpdateProtocol(_protocol)
        ...
        service_status: Union[Unset, ServiceUpdateServiceStatus]
        if isinstance(_service_status, Unset):
            service_status = UNSET
        else:
            service_status = ServiceUpdateServiceStatus(_service_status)

        _classification = d.pop("classification", UNSET)
        classification: Union[Unset, ServiceUpdateClassification]
        if isinstance(_classification, Unset):
            classification = UNSET
        else:
            classification = ServiceUpdateClassification(_classification)

        _sensitivity = d.pop("sensitivity", UNSET)
        sensitivity: Union[Unset, ServiceUpdateSensitivity]
        if isinstance(_sensitivity, Unset):
            sensitivity = UNSET
        else:
            sensitivity = ServiceUpdateSensitivity(_sensitivity)

        _category = d.pop("category", UNSET)
        category: Union[Unset, ServiceUpdateCategory]
        if isinstance(_category, Unset):
            category = UNSET
        else:
            category = ServiceUpdateCategory(_category)

        tags = cast(list[str], d.pop("tags", UNSET))

        _labels = d.pop("labels", UNSET)
        labels: Union[Unset, ServiceUpdateLabels]
        if isinstance(_labels, Unset):
            labels = UNSET
        else:
            labels = ServiceUpdateLabels.from_dict(_labels)
        ...
        status: Union[Unset, ServiceUpdateStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = ServiceUpdateStatus(_status)

        _lifecycle_stage = d.pop("lifecycle_stage", UNSET)
        lifecycle_stage: Union[Unset, ServiceUpdateLifecycleStage]
        if isinstance(_lifecycle_stage, Unset):
            lifecycle_stage = UNSET
        else:
            lifecycle_stage = ServiceUpdateLifecycleStage(_lifecycle_stage)
        ...
        environment: Union[Unset, ServiceUpdateEnvironment]
        if isinstance(_environment, Unset):
            environment = UNSET
        else:
            environment = ServiceUpdateEnvironment(_environment)

        _business_criticality = d.pop("business_criticality", UNSET)
        business_criticality: Union[Unset, ServiceUpdateBusinessCriticality]
        if isinstance(_business_criticality, Unset):
            business_criticality = UNSET
        else:
            business_criticality = ServiceUpdateBusinessCriticality(_business_criticality)
        ...
        if isinstance(_geographic_location, Unset):
            ...
            geographic_location = ServiceUpdateGeographicLocation.from_dict(_geographic_location)
