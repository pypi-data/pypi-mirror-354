...
from ..models.organization_update_business_criticality import OrganizationUpdateBusinessCriticality
from ..models.organization_update_category import OrganizationUpdateCategory
from ..models.organization_update_classification import OrganizationUpdateClassification
from ..models.organization_update_environment import OrganizationUpdateEnvironment
from ..models.organization_update_lifecycle_stage import OrganizationUpdateLifecycleStage
from ..models.organization_update_sensitivity import OrganizationUpdateSensitivity
from ..models.organization_update_status import OrganizationUpdateStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.organization_update_geographic_location import OrganizationUpdateGeographicLocation
    from ..models.organization_update_labels import OrganizationUpdateLabels
...
class OrganizationUpdate:
    """Schema for updating organization fields (all optional for partial updates)
    ...
    Attributes:
        ...
        classification (Union[Unset, OrganizationUpdateClassification]): Classification level of the asset Default:
            OrganizationUpdateClassification.UNKNOWN.
        sensitivity (Union[Unset, OrganizationUpdateSensitivity]): Sensitivity level of the asset Default:
            OrganizationUpdateSensitivity.UNKNOWN.
        category (Union[Unset, OrganizationUpdateCategory]): Category of the asset Default:
            OrganizationUpdateCategory.UNKNOWN.
        tags (Union[Unset, list[str]]): List of tags for categorizing the asset
        labels (Union[Unset, OrganizationUpdateLabels]): Key-value pairs for additional metadata
        ...
        status (Union[Unset, OrganizationUpdateStatus]): Current status of the asset Default:
            OrganizationUpdateStatus.UNKNOWN.
        lifecycle_stage (Union[Unset, OrganizationUpdateLifecycleStage]): Current lifecycle stage of the asset Default:
            OrganizationUpdateLifecycleStage.UNKNOWN.
        ...
        environment (Union[Unset, OrganizationUpdateEnvironment]): Environment where the asset is deployed Default:
            OrganizationUpdateEnvironment.UNKNOWN.
        business_criticality (Union[Unset, OrganizationUpdateBusinessCriticality]): How critical the asset is to
            business operations Default: OrganizationUpdateBusinessCriticality.UNKNOWN.
        ...
        geographic_location (Union[Unset, OrganizationUpdateGeographicLocation]):
    ...
    classification: Union[Unset, OrganizationUpdateClassification] = OrganizationUpdateClassification.UNKNOWN
    sensitivity: Union[Unset, OrganizationUpdateSensitivity] = OrganizationUpdateSensitivity.UNKNOWN
    category: Union[Unset, OrganizationUpdateCategory] = OrganizationUpdateCategory.UNKNOWN
    tags: Union[Unset, list[str]] = UNSET
    labels: Union[Unset, "OrganizationUpdateLabels"] = UNSET
    ...
    status: Union[Unset, OrganizationUpdateStatus] = OrganizationUpdateStatus.UNKNOWN
    lifecycle_stage: Union[Unset, OrganizationUpdateLifecycleStage] = OrganizationUpdateLifecycleStage.UNKNOWN
    ...
    environment: Union[Unset, OrganizationUpdateEnvironment] = OrganizationUpdateEnvironment.UNKNOWN
    business_criticality: Union[Unset, OrganizationUpdateBusinessCriticality] = (
        OrganizationUpdateBusinessCriticality.UNKNOWN
    )
    ...
    geographic_location: Union[Unset, "OrganizationUpdateGeographicLocation"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        classification: Union[Unset, OrganizationUpdateClassification]
        if isinstance(_classification, Unset):
            classification = UNSET
        else:
            classification = OrganizationUpdateClassification(_classification)

        _sensitivity = d.pop("sensitivity", UNSET)
        sensitivity: Union[Unset, OrganizationUpdateSensitivity]
        if isinstance(_sensitivity, Unset):
            sensitivity = UNSET
        else:
            sensitivity = OrganizationUpdateSensitivity(_sensitivity)

        _category = d.pop("category", UNSET)
        category: Union[Unset, OrganizationUpdateCategory]
        if isinstance(_category, Unset):
            category = UNSET
        else:
            category = OrganizationUpdateCategory(_category)

        tags = cast(list[str], d.pop("tags", UNSET))

        _labels = d.pop("labels", UNSET)
        labels: Union[Unset, OrganizationUpdateLabels]
        if isinstance(_labels, Unset):
            labels = UNSET
        else:
            labels = OrganizationUpdateLabels.from_dict(_labels)
        ...
        status: Union[Unset, OrganizationUpdateStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = OrganizationUpdateStatus(_status)

        _lifecycle_stage = d.pop("lifecycle_stage", UNSET)
        lifecycle_stage: Union[Unset, OrganizationUpdateLifecycleStage]
        if isinstance(_lifecycle_stage, Unset):
            lifecycle_stage = UNSET
        else:
            lifecycle_stage = OrganizationUpdateLifecycleStage(_lifecycle_stage)
        ...
        environment: Union[Unset, OrganizationUpdateEnvironment]
        if isinstance(_environment, Unset):
            environment = UNSET
        else:
            environment = OrganizationUpdateEnvironment(_environment)
        ...
        if isinstance(_business_criticality, Unset):
            ...
            business_criticality = OrganizationUpdateBusinessCriticality(_business_criticality)
        ...
        if isinstance(_geographic_location, Unset):
            ...
            geographic_location = OrganizationUpdateGeographicLocation.from_dict(_geographic_location)
