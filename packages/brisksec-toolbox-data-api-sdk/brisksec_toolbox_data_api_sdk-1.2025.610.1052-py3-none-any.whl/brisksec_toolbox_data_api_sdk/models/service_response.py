...
from ..models.service_response_business_criticality import ServiceResponseBusinessCriticality
from ..models.service_response_category import ServiceResponseCategory
from ..models.service_response_classification import ServiceResponseClassification
from ..models.service_response_environment import ServiceResponseEnvironment
from ..models.service_response_lifecycle_stage import ServiceResponseLifecycleStage
from ..models.service_response_protocol import ServiceResponseProtocol
from ..models.service_response_sensitivity import ServiceResponseSensitivity
from ..models.service_response_service_status import ServiceResponseServiceStatus
from ..models.service_response_status import ServiceResponseStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.service_response_geographic_location import ServiceResponseGeographicLocation
    from ..models.service_response_labels import ServiceResponseLabels
...
class ServiceResponse:
    ...
    Attributes:
        ...
        port (Union[None, Unset, int]): Port number for the service
        protocol (Union[Unset, ServiceResponseProtocol]): Network protocol used by the service Default:
            ServiceResponseProtocol.TCP.
        version (Union[None, Unset, str]): Version of the service software
        banner (Union[None, Unset, str]): Service banner information
        service_status (Union[Unset, ServiceResponseServiceStatus]): Current operational status of the service Default:
            ServiceResponseServiceStatus.ACTIVE.
        classification (Union[Unset, ServiceResponseClassification]): Classification level of the asset Default:
            ServiceResponseClassification.UNKNOWN.
        sensitivity (Union[Unset, ServiceResponseSensitivity]): Sensitivity level of the asset Default:
            ServiceResponseSensitivity.UNKNOWN.
        category (Union[Unset, ServiceResponseCategory]): Category of the asset Default:
            ServiceResponseCategory.UNKNOWN.
        tags (Union[Unset, list[str]]): List of tags for categorizing the asset
        labels (Union[Unset, ServiceResponseLabels]): Key-value pairs for additional metadata
        ...
        status (Union[Unset, ServiceResponseStatus]): Current status of the asset Default:
            ServiceResponseStatus.UNKNOWN.
        lifecycle_stage (Union[Unset, ServiceResponseLifecycleStage]): Current lifecycle stage of the asset Default:
            ServiceResponseLifecycleStage.UNKNOWN.
        ...
        environment (Union[Unset, ServiceResponseEnvironment]): Environment where the asset is deployed Default:
            ServiceResponseEnvironment.UNKNOWN.
        business_criticality (Union[Unset, ServiceResponseBusinessCriticality]): How critical the asset is to business
            operations Default: ServiceResponseBusinessCriticality.UNKNOWN.
        ...
        geographic_location (Union[Unset, ServiceResponseGeographicLocation]):
    ...
    protocol: Union[Unset, ServiceResponseProtocol] = ServiceResponseProtocol.TCP
    version: Union[None, Unset, str] = UNSET
    banner: Union[None, Unset, str] = UNSET
    service_status: Union[Unset, ServiceResponseServiceStatus] = ServiceResponseServiceStatus.ACTIVE
    classification: Union[Unset, ServiceResponseClassification] = ServiceResponseClassification.UNKNOWN
    sensitivity: Union[Unset, ServiceResponseSensitivity] = ServiceResponseSensitivity.UNKNOWN
    category: Union[Unset, ServiceResponseCategory] = ServiceResponseCategory.UNKNOWN
    tags: Union[Unset, list[str]] = UNSET
    labels: Union[Unset, "ServiceResponseLabels"] = UNSET
    ...
    status: Union[Unset, ServiceResponseStatus] = ServiceResponseStatus.UNKNOWN
    lifecycle_stage: Union[Unset, ServiceResponseLifecycleStage] = ServiceResponseLifecycleStage.UNKNOWN
    ...
    environment: Union[Unset, ServiceResponseEnvironment] = ServiceResponseEnvironment.UNKNOWN
    business_criticality: Union[Unset, ServiceResponseBusinessCriticality] = ServiceResponseBusinessCriticality.UNKNOWN
    ...
    geographic_location: Union[Unset, "ServiceResponseGeographicLocation"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        banner: Union[None, Unset, str]
        if isinstance(self.banner, Unset):
            banner = UNSET
        else:
            banner = self.banner

        service_status: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        protocol: Union[Unset, ServiceResponseProtocol]
        if isinstance(_protocol, Unset):
            protocol = UNSET
        else:
            protocol = ServiceResponseProtocol(_protocol)
        ...
        def _parse_banner(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        banner = _parse_banner(d.pop("banner", UNSET))

        _service_status = d.pop("service_status", UNSET)
        service_status: Union[Unset, ServiceResponseServiceStatus]
        if isinstance(_service_status, Unset):
            service_status = UNSET
        else:
            service_status = ServiceResponseServiceStatus(_service_status)

        _classification = d.pop("classification", UNSET)
        classification: Union[Unset, ServiceResponseClassification]
        if isinstance(_classification, Unset):
            classification = UNSET
        else:
            classification = ServiceResponseClassification(_classification)

        _sensitivity = d.pop("sensitivity", UNSET)
        sensitivity: Union[Unset, ServiceResponseSensitivity]
        if isinstance(_sensitivity, Unset):
            sensitivity = UNSET
        else:
            sensitivity = ServiceResponseSensitivity(_sensitivity)

        _category = d.pop("category", UNSET)
        category: Union[Unset, ServiceResponseCategory]
        if isinstance(_category, Unset):
            category = UNSET
        else:
            category = ServiceResponseCategory(_category)

        tags = cast(list[str], d.pop("tags", UNSET))

        _labels = d.pop("labels", UNSET)
        labels: Union[Unset, ServiceResponseLabels]
        if isinstance(_labels, Unset):
            labels = UNSET
        else:
            labels = ServiceResponseLabels.from_dict(_labels)
        ...
        status: Union[Unset, ServiceResponseStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = ServiceResponseStatus(_status)

        _lifecycle_stage = d.pop("lifecycle_stage", UNSET)
        lifecycle_stage: Union[Unset, ServiceResponseLifecycleStage]
        if isinstance(_lifecycle_stage, Unset):
            lifecycle_stage = UNSET
        else:
            lifecycle_stage = ServiceResponseLifecycleStage(_lifecycle_stage)
        ...
        environment: Union[Unset, ServiceResponseEnvironment]
        if isinstance(_environment, Unset):
            environment = UNSET
        else:
            environment = ServiceResponseEnvironment(_environment)

        _business_criticality = d.pop("business_criticality", UNSET)
        business_criticality: Union[Unset, ServiceResponseBusinessCriticality]
        if isinstance(_business_criticality, Unset):
            business_criticality = UNSET
        else:
            business_criticality = ServiceResponseBusinessCriticality(_business_criticality)
        ...
        if isinstance(_geographic_location, Unset):
            ...
            geographic_location = ServiceResponseGeographicLocation.from_dict(_geographic_location)
