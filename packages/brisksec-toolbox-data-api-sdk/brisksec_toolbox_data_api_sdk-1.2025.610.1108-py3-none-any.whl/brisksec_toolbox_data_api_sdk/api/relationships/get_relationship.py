...
def _get_kwargs(
    *,
    body: RelationshipIdentifier,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/relationships/get",
    }
...
def sync_detailed(
    *,
    ...
    """Get Relationship
     ...
     Get a relationship by its source, target, and type.

    Args:
        body (RelationshipIdentifier): Schema for identifying a relationship
