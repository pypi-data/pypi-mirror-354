...
from ..models.domain_response_business_criticality import DomainResponseBusinessCriticality
from ..models.domain_response_category import DomainResponseCategory
from ..models.domain_response_classification import DomainResponseClassification
from ..models.domain_response_domain_status import DomainResponseDomainStatus
from ..models.domain_response_environment import DomainResponseEnvironment
from ..models.domain_response_lifecycle_stage import DomainResponseLifecycleStage
from ..models.domain_response_sensitivity import DomainResponseSensitivity
from ..models.domain_response_status import DomainResponseStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.domain_response_geographic_location import DomainResponseGeographicLocation
    from ..models.domain_response_labels import DomainResponseLabels
...
class DomainResponse:
    ...
    Attributes:
        ...
        domain_status (Union[Unset, DomainResponseDomainStatus]): Current status of the domain Default:
            DomainResponseDomainStatus.ACTIVE.
        nameservers (Union[Unset, list[str]]): List of nameservers for this domain
        classification (Union[Unset, DomainResponseClassification]): Classification level of the asset Default:
            DomainResponseClassification.UNKNOWN.
        sensitivity (Union[Unset, DomainResponseSensitivity]): Sensitivity level of the asset Default:
            DomainResponseSensitivity.UNKNOWN.
        category (Union[Unset, DomainResponseCategory]): Category of the asset Default: DomainResponseCategory.UNKNOWN.
        tags (Union[Unset, list[str]]): List of tags for categorizing the asset
        labels (Union[Unset, DomainResponseLabels]): Key-value pairs for additional metadata
        ...
        status (Union[Unset, DomainResponseStatus]): Current status of the asset Default: DomainResponseStatus.UNKNOWN.
        lifecycle_stage (Union[Unset, DomainResponseLifecycleStage]): Current lifecycle stage of the asset Default:
            DomainResponseLifecycleStage.UNKNOWN.
        ...
        environment (Union[Unset, DomainResponseEnvironment]): Environment where the asset is deployed Default:
            DomainResponseEnvironment.UNKNOWN.
        business_criticality (Union[Unset, DomainResponseBusinessCriticality]): How critical the asset is to business
            operations Default: DomainResponseBusinessCriticality.UNKNOWN.
        ...
        geographic_location (Union[Unset, DomainResponseGeographicLocation]):
    ...
    domain_status: Union[Unset, DomainResponseDomainStatus] = DomainResponseDomainStatus.ACTIVE
    nameservers: Union[Unset, list[str]] = UNSET
    classification: Union[Unset, DomainResponseClassification] = DomainResponseClassification.UNKNOWN
    sensitivity: Union[Unset, DomainResponseSensitivity] = DomainResponseSensitivity.UNKNOWN
    category: Union[Unset, DomainResponseCategory] = DomainResponseCategory.UNKNOWN
    tags: Union[Unset, list[str]] = UNSET
    labels: Union[Unset, "DomainResponseLabels"] = UNSET
    ...
    status: Union[Unset, DomainResponseStatus] = DomainResponseStatus.UNKNOWN
    lifecycle_stage: Union[Unset, DomainResponseLifecycleStage] = DomainResponseLifecycleStage.UNKNOWN
    ...
    environment: Union[Unset, DomainResponseEnvironment] = DomainResponseEnvironment.UNKNOWN
    business_criticality: Union[Unset, DomainResponseBusinessCriticality] = DomainResponseBusinessCriticality.UNKNOWN
    ...
    geographic_location: Union[Unset, "DomainResponseGeographicLocation"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domain_status: Union[Unset, DomainResponseDomainStatus]
        if isinstance(_domain_status, Unset):
            domain_status = UNSET
        else:
            domain_status = DomainResponseDomainStatus(_domain_status)

        nameservers = cast(list[str], d.pop("nameservers", UNSET))

        _classification = d.pop("classification", UNSET)
        classification: Union[Unset, DomainResponseClassification]
        if isinstance(_classification, Unset):
            classification = UNSET
        else:
            classification = DomainResponseClassification(_classification)

        _sensitivity = d.pop("sensitivity", UNSET)
        sensitivity: Union[Unset, DomainResponseSensitivity]
        if isinstance(_sensitivity, Unset):
            sensitivity = UNSET
        else:
            sensitivity = DomainResponseSensitivity(_sensitivity)

        _category = d.pop("category", UNSET)
        category: Union[Unset, DomainResponseCategory]
        if isinstance(_category, Unset):
            category = UNSET
        else:
            category = DomainResponseCategory(_category)

        tags = cast(list[str], d.pop("tags", UNSET))

        _labels = d.pop("labels", UNSET)
        labels: Union[Unset, DomainResponseLabels]
        if isinstance(_labels, Unset):
            labels = UNSET
        else:
            labels = DomainResponseLabels.from_dict(_labels)
        ...
        status: Union[Unset, DomainResponseStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = DomainResponseStatus(_status)

        _lifecycle_stage = d.pop("lifecycle_stage", UNSET)
        lifecycle_stage: Union[Unset, DomainResponseLifecycleStage]
        if isinstance(_lifecycle_stage, Unset):
            lifecycle_stage = UNSET
        else:
            lifecycle_stage = DomainResponseLifecycleStage(_lifecycle_stage)
        ...
        environment: Union[Unset, DomainResponseEnvironment]
        if isinstance(_environment, Unset):
            environment = UNSET
        else:
            environment = DomainResponseEnvironment(_environment)

        _business_criticality = d.pop("business_criticality", UNSET)
        business_criticality: Union[Unset, DomainResponseBusinessCriticality]
        if isinstance(_business_criticality, Unset):
            business_criticality = UNSET
        else:
            business_criticality = DomainResponseBusinessCriticality(_business_criticality)
        ...
        if isinstance(_geographic_location, Unset):
            ...
            geographic_location = DomainResponseGeographicLocation.from_dict(_geographic_location)
