...
from ..models.ip_address_create_business_criticality import IPAddressCreateBusinessCriticality
from ..models.ip_address_create_category import IPAddressCreateCategory
from ..models.ip_address_create_classification import IPAddressCreateClassification
from ..models.ip_address_create_environment import IPAddressCreateEnvironment
from ..models.ip_address_create_ip_type import IPAddressCreateIpType
from ..models.ip_address_create_lifecycle_stage import IPAddressCreateLifecycleStage
from ..models.ip_address_create_sensitivity import IPAddressCreateSensitivity
from ..models.ip_address_create_status import IPAddressCreateStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.ip_address_create_geographic_location import IPAddressCreateGeographicLocation
    from ..models.ip_address_create_labels import IPAddressCreateLabels


T = TypeVar("T", bound="IPAddressCreate")


@_attrs_define
class IPAddressCreate:
    """Schema for creating a new IP address

    Attributes:
        name (str): Name of the entity
        ip_type (Union[Unset, IPAddressCreateIpType]): Type of IP address (IPv4 or IPv6) Default:
            IPAddressCreateIpType.IPV4.
        ...
        classification (Union[Unset, IPAddressCreateClassification]): Classification level of the asset Default:
            IPAddressCreateClassification.UNKNOWN.
        sensitivity (Union[Unset, IPAddressCreateSensitivity]): Sensitivity level of the asset Default:
            IPAddressCreateSensitivity.UNKNOWN.
        category (Union[Unset, IPAddressCreateCategory]): Category of the asset Default:
            IPAddressCreateCategory.UNKNOWN.
        tags (Union[Unset, list[str]]): List of tags for categorizing the asset
        labels (Union[Unset, IPAddressCreateLabels]): Key-value pairs for additional metadata
        ...
        status (Union[Unset, IPAddressCreateStatus]): Current status of the asset Default:
            IPAddressCreateStatus.UNKNOWN.
        lifecycle_stage (Union[Unset, IPAddressCreateLifecycleStage]): Current lifecycle stage of the asset Default:
            IPAddressCreateLifecycleStage.UNKNOWN.
        ...
        environment (Union[Unset, IPAddressCreateEnvironment]): Environment where the asset is deployed Default:
            IPAddressCreateEnvironment.UNKNOWN.
        business_criticality (Union[Unset, IPAddressCreateBusinessCriticality]): How critical the asset is to business
            operations Default: IPAddressCreateBusinessCriticality.UNKNOWN.
        ...
        geographic_location (Union[Unset, IPAddressCreateGeographicLocation]):
    ...
    name: str
    ip_type: Union[Unset, IPAddressCreateIpType] = IPAddressCreateIpType.IPV4
    ...
    classification: Union[Unset, IPAddressCreateClassification] = IPAddressCreateClassification.UNKNOWN
    sensitivity: Union[Unset, IPAddressCreateSensitivity] = IPAddressCreateSensitivity.UNKNOWN
    category: Union[Unset, IPAddressCreateCategory] = IPAddressCreateCategory.UNKNOWN
    tags: Union[Unset, list[str]] = UNSET
    labels: Union[Unset, "IPAddressCreateLabels"] = UNSET
    ...
    status: Union[Unset, IPAddressCreateStatus] = IPAddressCreateStatus.UNKNOWN
    lifecycle_stage: Union[Unset, IPAddressCreateLifecycleStage] = IPAddressCreateLifecycleStage.UNKNOWN
    ...
    environment: Union[Unset, IPAddressCreateEnvironment] = IPAddressCreateEnvironment.UNKNOWN
    business_criticality: Union[Unset, IPAddressCreateBusinessCriticality] = IPAddressCreateBusinessCriticality.UNKNOWN
    ...
    geographic_location: Union[Unset, "IPAddressCreateGeographicLocation"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ip_type: Union[Unset, IPAddressCreateIpType]
        if isinstance(_ip_type, Unset):
            ip_type = UNSET
        else:
            ip_type = IPAddressCreateIpType(_ip_type)
        ...
        classification: Union[Unset, IPAddressCreateClassification]
        if isinstance(_classification, Unset):
            classification = UNSET
        else:
            classification = IPAddressCreateClassification(_classification)

        _sensitivity = d.pop("sensitivity", UNSET)
        sensitivity: Union[Unset, IPAddressCreateSensitivity]
        if isinstance(_sensitivity, Unset):
            sensitivity = UNSET
        else:
            sensitivity = IPAddressCreateSensitivity(_sensitivity)

        _category = d.pop("category", UNSET)
        category: Union[Unset, IPAddressCreateCategory]
        if isinstance(_category, Unset):
            category = UNSET
        else:
            category = IPAddressCreateCategory(_category)

        tags = cast(list[str], d.pop("tags", UNSET))

        _labels = d.pop("labels", UNSET)
        labels: Union[Unset, IPAddressCreateLabels]
        if isinstance(_labels, Unset):
            labels = UNSET
        else:
            labels = IPAddressCreateLabels.from_dict(_labels)
        ...
        status: Union[Unset, IPAddressCreateStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = IPAddressCreateStatus(_status)

        _lifecycle_stage = d.pop("lifecycle_stage", UNSET)
        lifecycle_stage: Union[Unset, IPAddressCreateLifecycleStage]
        if isinstance(_lifecycle_stage, Unset):
            lifecycle_stage = UNSET
        else:
            lifecycle_stage = IPAddressCreateLifecycleStage(_lifecycle_stage)
        ...
        environment: Union[Unset, IPAddressCreateEnvironment]
        if isinstance(_environment, Unset):
            environment = UNSET
        else:
            environment = IPAddressCreateEnvironment(_environment)

        _business_criticality = d.pop("business_criticality", UNSET)
        business_criticality: Union[Unset, IPAddressCreateBusinessCriticality]
        if isinstance(_business_criticality, Unset):
            business_criticality = UNSET
        else:
            business_criticality = IPAddressCreateBusinessCriticality(_business_criticality)
        ...
        if isinstance(_geographic_location, Unset):
            ...
            geographic_location = IPAddressCreateGeographicLocation.from_dict(_geographic_location)
        ...
        ip_address_create.additional_properties = d
        return ip_address_create
