...
def main():
    ...
    helper = argparse.ArgumentParser(prog="test_fate", description="The Gump Testing Application using randomly generated, large sparse matrices.")
