...
templates = (  ('FixedArray', 'itk::FixedArray', 'itkFixedArrayi2', False, 'int, 2'),
  ...
  ('FDKVarianceReconstructionFilter', 'rtk::FDKVarianceReconstructionFilter', 'rtkFDKVarianceReconstructionFilterIF3', False, 'itk::Image<float, 3>'),
  ('FDKVarianceReconstructionFilter', 'rtk::FDKVarianceReconstructionFilter', 'rtkFDKVarianceReconstructionFilterID3', False, 'itk::Image<double, 3>'),
  ...
  ('FFTHilbertImageFilter', 'rtk::FFTHilbertImageFilter', 'rtkFFTHilbertImageFilterIF3IF3D', False, 'itk::Image<float, 3>, itk::Image<float, 3>, double'),
  ('FFTHilbertImageFilter', 'rtk::FFTHilbertImageFilter', 'rtkFFTHilbertImageFilterID3ID3D', False, 'itk::Image<double, 3>, itk::Image<double, 3>, double'),
  ...
  ('FFTVarianceRampImageFilter', 'rtk::FFTVarianceRampImageFilter', 'rtkFFTVarianceRampImageFilterIF3IF3D', False, 'itk::Image<float, 3>, itk::Image<float, 3>, double'),
  ('FFTVarianceRampImageFilter', 'rtk::FFTVarianceRampImageFilter', 'rtkFFTVarianceRampImageFilterID3ID3D', False, 'itk::Image<double, 3>, itk::Image<double, 3>, double'),
  ...
  ('FourDROOSTERConeBeamReconstructionFilter', 'rtk::FourDROOSTERConeBeamReconstructionFilter', 'rtkFourDROOSTERConeBeamReconstructionFilterIF4IF3', False, 'itk::Image<float, 4>, itk::Image<float, 3>'),
  ('FourDROOSTERConeBeamReconstructionFilter', 'rtk::FourDROOSTERConeBeamReconstructionFilter', 'rtkFourDROOSTERConeBeamReconstructionFilterID4ID3', False, 'itk::Image<double, 4>, itk::Image<double, 3>'),
  ...
  ('SplatWeightMultiplicationAttenuated', 'rtk::Functor::SplatWeightMultiplicationAttenuated', 'rtkFunctorSplatWeightMultiplicationAttenuatedFDF', False, 'float, double, float'),
  ('SplatWeightMultiplicationAttenuated', 'rtk::Functor::SplatWeightMultiplicationAttenuated', 'rtkFunctorSplatWeightMultiplicationAttenuatedDDD', False, 'double, double, double'),
  ...
  ('InterpolationWeightMultiplicationAttenuated', 'rtk::Functor::InterpolationWeightMultiplicationAttenuated', 'rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionAttenuatedFFF', False, 'float, float, float'),
  ('InterpolationWeightMultiplicationAttenuated', 'rtk::Functor::InterpolationWeightMultiplicationAttenuated', 'rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionAttenuatedDDD', False, 'double, double, double'),
  ...
  ('MaskCollimationImageFilter', 'rtk::MaskCollimationImageFilter', 'rtkMaskCollimationImageFilterIF3IF3', False, 'itk::Image< float,3 >, itk::Image< float,3 >'),
  ('MaskCollimationImageFilter', 'rtk::MaskCollimationImageFilter', 'rtkMaskCollimationImageFilterID3ID3', False, 'itk::Image< double,3 >, itk::Image< double,3 >'),
  ('InterpolationWeightMultiplication', 'rtk::Functor::InterpolationWeightMultiplication', 'rtkInterpolationWeightMultiplicationFF', False, 'float, float'),
  ('InterpolationWeightMultiplication', 'rtk::Functor::InterpolationWeightMultiplication', 'rtkInterpolationWeightMultiplicationDD', False, 'double, double'),
  ('MaximumIntensityAlongRay', 'rtk::Functor::MaximumIntensityAlongRay', 'rtkMaximumIntensityAlongRayFF', False, 'float, float'),
  ('MaximumIntensityAlongRay', 'rtk::Functor::MaximumIntensityAlongRay', 'rtkMaximumIntensityAlongRayDD', False, 'double, double'),
  ('MaximumIntensityProjectedValueAccumulation', 'rtk::Functor::MaximumIntensityProjectedValueAccumulation', 'rtkMaximumIntensityProjectedValueAccumulationFF', False, 'float, float'),
  ('MaximumIntensityProjectedValueAccumulation', 'rtk::Functor::MaximumIntensityProjectedValueAccumulation', 'rtkMaximumIntensityProjectedValueAccumulationDD', False, 'double, double'),
  ('JosephForwardProjectionImageFilter', 'rtk::JosephForwardProjectionImageFilter', 'rtkJosephForwardProjectionImageFilterIF3IF3FWMIF3IF3FVAIF3IF3FIAIF3IF3', False, 'itk::Image<float, 3>, itk::Image< float, 3>, rtk::Functor::InterpolationWeightMultiplication<float, float>, rtk::Functor::MaximumIntensityProjectedValueAccumulation<float, float>, rtk::Functor::MaximumIntensityAlongRay<float, float>'),
  ('JosephForwardProjectionImageFilter', 'rtk::JosephForwardProjectionImageFilter', 'rtkJosephForwardProjectionImageFilterID3ID3FWMID3ID3FVAID3ID3FIAID3ID3', False, 'itk::Image<double, 3>, itk::Image< double, 3>, rtk::Functor::InterpolationWeightMultiplication<double, double>, rtk::Functor::MaximumIntensityProjectedValueAccumulation<double, double>, rtk::Functor::MaximumIntensityAlongRay<double, double>'),
  ('MaximumIntensityProjectionImageFilter', 'rtk::MaximumIntensityProjectionImageFilter', 'rtkMaximumIntensityProjectionImageFilterIF3IF3', False, 'itk::Image<float, 3>, itk::Image<float, 3>'),
  ('MaximumIntensityProjectionImageFilter', 'rtk::MaximumIntensityProjectionImageFilter', 'rtkMaximumIntensityProjectionImageFilterID3ID3', False, 'itk::Image<double, 3>, itk::Image<double, 3>'),
  ...
  ('ReorderProjectionsImageFilter', 'rtk::ReorderProjectionsImageFilter', 'rtkReorderProjectionsImageFilterIVF53IVF53', False, 'itk::Image<itk::Vector< float,5 >,3>, itk::Image<itk::Vector< float,5 >,3>'),
  ...
  ('SimplexSpectralProjectionsDecompositionImageFilter', 'rtk::SimplexSpectralProjectionsDecompositionImageFilter', 'rtkSimplexSpectralProjectionsDecompositionImageFilterVIF3VIF3IF3IF2IF2', False, 'itk::VectorImage<float, 3>, itk::VectorImage<float, 3>, itk::Image<float, 3>, itk::Image<float, 2>, itk::Image<float, 2>'),
  ('SimplexSpectralProjectionsDecompositionImageFilter', 'rtk::SimplexSpectralProjectionsDecompositionImageFilter', 'rtkSimplexSpectralProjectionsDecompositionImageFilterVID3VID3IF3IF2IF2', False, 'itk::VectorImage<double, 3>, itk::VectorImage<double, 3>, itk::Image<float, 3>, itk::Image<float, 2>, itk::Image<float, 2>'),
  ...
  ('SpectralForwardModelImageFilter', 'rtk::SpectralForwardModelImageFilter', 'rtkSpectralForwardModelImageFilterVIF3VIF3IF3IF2IF2', False, 'itk::VectorImage<float, 3>, itk::VectorImage<float, 3>, itk::Image<float, 3>, itk::Image<float, 2>, itk::Image<float, 2>'),
  ('SpectralForwardModelImageFilter', 'rtk::SpectralForwardModelImageFilter', 'rtkSpectralForwardModelImageFilterVID3VID3IF3IF2IF2', False, 'itk::VectorImage<double, 3>, itk::VectorImage<double, 3>, itk::Image<float, 3>, itk::Image<float, 2>, itk::Image<float, 2>'),
