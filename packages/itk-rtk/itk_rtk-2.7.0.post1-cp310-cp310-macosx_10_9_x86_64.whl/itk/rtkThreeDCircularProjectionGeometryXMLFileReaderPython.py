...
class itkXMLFile(itk.ITKCommonBasePython.itkLightProcessObject):
    ...
    def CharacterDataHandler(self, inData, inLength):
        r"""
        CharacterDataHandler(self, inData, inLength)
...
class itkXMLReader3DCPG(itkXMLFile):
    ...
    def SetOutputObject(self, obj):
        r"""
        SetOutputObject(self, obj)

        Parameters
        ----------
        obj: rtkThreeDCircularProjectionGeometry *
    ...
    def GetOutputObject(self):
        r"""GetOutputObject(self) -> rtkThreeDCircularProjectionGeometry"""
...
class rtkThreeDCircularProjectionGeometryXMLFileReader(itkXMLReader3DCPG):
    ...
    @staticmethod
    def __New_orig__():
        r"""__New_orig__() -> rtkThreeDCircularProjectionGeometryXMLFileReader_Pointer"""
    ...
    def Clone(self):
        r"""Clone(self) -> rtkThreeDCircularProjectionGeometryXMLFileReader_Pointer"""
    ...
    def cast(obj):
        r"""
        cast(obj) -> rtkThreeDCircularProjectionGeometryXMLFileReader
