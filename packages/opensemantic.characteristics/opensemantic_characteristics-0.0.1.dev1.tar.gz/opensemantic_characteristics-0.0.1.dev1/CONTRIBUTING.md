...
Welcome to `opensemantic.characteristics` contributor's guide.
...
If you experience bugs or general issues with `opensemantic.characteristics`, please have a look
...
You can help improve `opensemantic.characteristics` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`opensemantic.characteristics` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `opensemantic.characteristics`'s files. While this mechanism can
...
```
conda create -n opensemantic.characteristics python=3 six virtualenv pytest pytest-cov
conda activate opensemantic.characteristics
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/opensemantic.characteristics.git
   cd opensemantic.characteristics
   ```
...
5. Install [pre-commit]:
   ...
   `opensemantic.characteristics` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/opensemantic.characteristics
[issue tracker]: https://github.com/<USERNAME>/opensemantic.characteristics/issues
