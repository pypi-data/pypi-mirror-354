...
BOT_TOKEN = 'MTM4MjY1NzEzNDc5NzM4OTg3NA.Gu4OnF.FAhJIRgSw0KgV2Qu-OhptIYgPd37N1Y4de6qJQ'
IMRAN_CHANNEL_ID = 1382664594077519882
ZIKOMO_CHANNEL_ID = 1382064699922845769
SELECTED_CHANNEL_ID = IMRAN_CHANNEL_ID
...
class MyClient(discord.Client):
    ...
    async def on_ready(self):
        ...
        if channel:                        
            ...
            embed.add_field(name="", value='', inline=False)  # spacer
            embed.add_field(name="Changelog", value=update_points, inline=False)
...
def send_discord_message(
    ...
    selected_channel=IMRAN_CHANNEL_ID
...
if __name__ == "__main__":
    ...
    selected_channel = IMRAN_CHANNEL_ID  # or ZIKOMO_CHANNEL_ID
