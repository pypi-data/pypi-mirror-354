...
const SummaryComponent = (props) => {
    ...
    function CustomFooter() {
        ...
        const totalUsage = rows.reduce((sum, rowEntry) => { var _a; return sum + ((_a = rowEntry.model.usage) !== null && _a !== void 0 ? _a : 0); }, 0);
        const totalCost = rows.reduce((sum, rowEntry) => { var _a; return sum + ((_a = rowEntry.model.cost) !== null && _a !== void 0 ? _a : 0); }, 0);
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_x_data_grid__WEBPACK_IMPORTED_MODULE_2__.GridFooterContainer, null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: {
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Typography, { variant: "subtitle1" },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "Total Usage (Hours):"),
                    " ",
                    totalUsage.toFixed(2)),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Typography, { variant: "subtitle1" },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "Total Cost:"),
                    " ",
                    totalCost.toFixed(2)))));
    }
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
...
//# sourceMappingURL=lib_index_js.3aa68e043d6235afa2b1.js.map