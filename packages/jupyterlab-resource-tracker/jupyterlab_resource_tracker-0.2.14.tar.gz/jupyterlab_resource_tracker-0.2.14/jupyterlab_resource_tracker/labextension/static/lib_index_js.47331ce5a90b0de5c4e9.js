...
const SummaryComponent = (props) => {
    const apiRef = (0,_mui_x_data_grid__WEBPACK_IMPORTED_MODULE_2__.useGridApiRef)();
    const columns = [
    ...
    const filteredRows = (0,_mui_x_data_grid__WEBPACK_IMPORTED_MODULE_2__.useGridSelector)(apiRef, _mui_x_data_grid__WEBPACK_IMPORTED_MODULE_2__.gridFilteredSortedRowEntriesSelector);
    const totalUsage = filteredRows.reduce((acc, rowEntry) => { var _a; return acc + ((_a = rowEntry.model.usage) !== null && _a !== void 0 ? _a : 0); }, 0);
    const totalCost = filteredRows.reduce((acc, rowEntry) => { var _a; return acc + ((_a = rowEntry.model.cost) !== null && _a !== void 0 ? _a : 0); }, 0);
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Paper, { sx: { p: 2, boxShadow: 3, borderRadius: 2, mb: 2 } },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_x_data_grid__WEBPACK_IMPORTED_MODULE_2__.DataGrid, { apiRef: apiRef, autoHeight: true, rows: props.summary, columns: columns, loading: props.loading, initialState: {
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: {
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Typography, { variant: "subtitle1", sx: { mr: 2 } },
                    "Total Usage (Hours): ",
                    totalUsage.toFixed(2)),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Typography, { variant: "subtitle1" },
                    "Total Cost: ",
                    totalCost.toFixed(2))))));
};
...
//# sourceMappingURL=lib_index_js.47331ce5a90b0de5c4e9.js.map