...
class SectionsManager:
    ...
    def _auto_embed(self):
        """Automatically regenerate embeddings after content changes in background"""
        try:
            import threading
            from .embeddings import EmbeddingsManager
            
            def background_embed():
                try:
            ...
            thread = threading.Thread(target=background_embed, daemon=True)
            thread.start()
        except Exception:
            pass  # Silent failure
