...
class RxmRAWSV(_message.Message):
    __slots__ = ["cp_mes", "pr_mes", "do_mes", "sv", "mes_qi", "cno", "lli"]
    ...
    cno: int
    lli: int
    def __init__(self, cp_mes: _Optional[float] = ..., pr_mes: _Optional[float] = ..., do_mes: _Optional[float] = ..., sv: _Optional[int] = ..., mes_qi: _Optional[int] = ..., cno: _Optional[int] = ..., lli: _Optional[int] = ...) -> None: ...
