...
class EsrStatus6(_message.Message):
    __slots__ = ["header", "ros2_header", "canmsg", "supply_1p8v_a2d", "supply_n5v_a2d", "wave_diff_a2d", "sw_version_dsp_3rd_byte", "vertical_align_updated", "system_power_mode", "found_target", "recommend_unconverge", "factory_align_status_1", "factory_align_status_2", "factory_misalignment", "serv_align_updates_done", "vertical_misalignment"]
