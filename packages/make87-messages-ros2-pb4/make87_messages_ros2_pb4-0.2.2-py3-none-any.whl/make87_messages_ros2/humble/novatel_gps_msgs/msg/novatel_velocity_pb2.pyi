...
class NovatelVelocity(_message.Message):
    __slots__ = ["header", "ros2_header", "novatel_msg_header", "solution_status", "velocity_type", "latency", "age", "horizontal_speed", "track_ground", "vertical_speed"]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., novatel_msg_header: _Optional[_Union[_novatel_message_header_pb2.NovatelMessageHeader, _Mapping]] = ..., solution_status: _Optional[str] = ..., velocity_type: _Optional[str] = ..., latency: _Optional[float] = ..., age: _Optional[float] = ..., horizontal_speed: _Optional[float] = ..., track_ground: _Optional[float] = ..., vertical_speed: _Optional[float] = ...) -> None: ...
