...
class SysStatus(_message.Message):
    __slots__ = ["header", "ros2_header", "sensors_present", "sensors_enabled", "sensors_health", "load", "voltage_battery", "current_battery", "battery_remaining", "drop_rate_comm", "errors_comm", "errors_count1", "errors_count2", "errors_count3", "errors_count4"]
