...
class GridMap(_message.Message):
    __slots__ = ["header", "ros2_header", "top_left", "top_right", "bottom_right", "bottom_left", "map_names", "map_data"]
