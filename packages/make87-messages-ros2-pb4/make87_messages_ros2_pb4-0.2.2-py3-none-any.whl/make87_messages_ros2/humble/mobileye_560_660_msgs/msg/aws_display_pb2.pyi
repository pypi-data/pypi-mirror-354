...
class AwsDisplay(_message.Message):
    __slots__ = ["header", "ros2_header", "suppress_sound", "night_time", "dusk_time", "sound_type", "headway_valid", "headway_measurement", "lanes_on", "left_ldw_on", "right_ldw_on", "fcw_on", "left_crossing", "right_crossing", "maintenance", "failsafe", "ped_fcw", "ped_in_dz", "headway_warning_level"]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., suppress_sound: bool = ..., night_time: bool = ..., dusk_time: bool = ..., sound_type: _Optional[int] = ..., headway_valid: bool = ..., headway_measurement: _Optional[float] = ..., lanes_on: bool = ..., left_ldw_on: bool = ..., right_ldw_on: bool = ..., fcw_on: bool = ..., left_crossing: bool = ..., right_crossing: bool = ..., maintenance: bool = ..., failsafe: bool = ..., ped_fcw: bool = ..., ped_in_dz: bool = ..., headway_warning_level: _Optional[int] = ...) -> None: ...
