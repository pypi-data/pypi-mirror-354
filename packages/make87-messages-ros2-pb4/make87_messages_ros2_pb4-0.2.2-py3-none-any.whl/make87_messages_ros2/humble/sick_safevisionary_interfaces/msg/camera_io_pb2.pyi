...
from make87_messages_ros2.humble.sick_safevisionary_interfaces.msg import io_configured_pb2 as _io_configured_pb2
from make87_messages_ros2.humble.sick_safevisionary_interfaces.msg import io_direction_pb2 as _io_direction_pb2
from make87_messages_ros2.humble.sick_safevisionary_interfaces.msg import io_input_values_pb2 as _io_input_values_pb2
from make87_messages_ros2.humble.sick_safevisionary_interfaces.msg import io_output_values_pb2 as _io_output_values_pb2
from make87_messages_ros2.humble.sick_safevisionary_interfaces.msg import ioossds_state_pb2 as _ioossds_state_pb2
...
class CameraIO(_message.Message):
    __slots__ = ["header", "ros2_header", "configured", "direction", "input_values", "output_values", "ossds_state", "ossds_dyn_count", "ossds_crc", "ossds_io_status", "dynamic_speed_a", "dynamic_speed_b", "dynamic_valid_flags"]
