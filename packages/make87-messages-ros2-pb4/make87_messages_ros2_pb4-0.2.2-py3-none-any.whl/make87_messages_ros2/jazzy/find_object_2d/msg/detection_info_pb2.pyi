...
from make87_messages_ros2.jazzy.std_msgs.msg import int32_pb2 as _int32_pb2
...
class DetectionInfo(_message.Message):
    __slots__ = ["header", "ids", "widths", "heights", "file_paths", "inliers", "outliers", "homographies"]
