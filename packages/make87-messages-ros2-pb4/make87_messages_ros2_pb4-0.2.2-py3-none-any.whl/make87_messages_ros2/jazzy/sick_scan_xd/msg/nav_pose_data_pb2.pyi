...
class NAVPoseData(_message.Message):
    __slots__ = ["header", "x", "y", "phi", "opt_pose_data_valid", "output_mode", "timestamp", "mean_dev", "nav_mode", "info_state", "quant_used_reflectors", "pose_valid", "pose_x", "pose_y", "pose_yaw"]
    ...
    pose_y: float
    pose_yaw: float
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., x: _Optional[int] = ..., y: _Optional[int] = ..., phi: _Optional[int] = ..., opt_pose_data_valid: _Optional[int] = ..., output_mode: _Optional[int] = ..., timestamp: _Optional[int] = ..., mean_dev: _Optional[int] = ..., nav_mode: _Optional[int] = ..., info_state: _Optional[int] = ..., quant_used_reflectors: _Optional[int] = ..., pose_valid: _Optional[int] = ..., pose_x: _Optional[float] = ..., pose_y: _Optional[float] = ..., pose_yaw: _Optional[float] = ...) -> None: ...
