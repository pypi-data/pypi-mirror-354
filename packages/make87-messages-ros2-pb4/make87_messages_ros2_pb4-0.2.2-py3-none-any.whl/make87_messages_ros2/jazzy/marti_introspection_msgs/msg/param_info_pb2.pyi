...
class ParamInfo(_message.Message):
    __slots__ = ["name", "resolved_name", "description", "group", "type", "dynamic", "default_int", "default_float", "default_double", "default_string", "default_bool", "max_value", "min_value"]
