...
from make87_messages_ros2.humble.polygon_msgs.msg import complex_polygon2_d_pb2 as _complex_polygon2_d_pb2
...
class ComplexPolygon2DCollection(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., polygons: _Optional[_Iterable[_Union[_complex_polygon2_d_pb2.ComplexPolygon2D, _Mapping]]] = ..., colors: _Optional[_Iterable[_Union[_color_rgba_pb2.ColorRGBA, _Mapping]]] = ...) -> None: ...
