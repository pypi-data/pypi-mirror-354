...
from make87_messages_ros2.humble.smacc2_msgs.msg import smacc_event_generator_pb2 as _smacc_event_generator_pb2
from make87_messages_ros2.humble.smacc2_msgs.msg import smacc_orthogonal_pb2 as _smacc_orthogonal_pb2
from make87_messages_ros2.humble.smacc2_msgs.msg import smacc_state_reactor_pb2 as _smacc_state_reactor_pb2
...
class SmaccState(_message.Message):
    __slots__ = ["header", "index", "name", "children_states", "level", "transitions", "orthogonals", "state_reactors", "event_generators"]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., index: _Optional[int] = ..., name: _Optional[str] = ..., children_states: _Optional[_Iterable[str]] = ..., level: _Optional[int] = ..., transitions: _Optional[_Iterable[_Union[_smacc_transition_pb2.SmaccTransition, _Mapping]]] = ..., orthogonals: _Optional[_Iterable[_Union[_smacc_orthogonal_pb2.SmaccOrthogonal, _Mapping]]] = ..., state_reactors: _Optional[_Iterable[_Union[_smacc_state_reactor_pb2.SmaccStateReactor, _Mapping]]] = ..., event_generators: _Optional[_Iterable[_Union[_smacc_event_generator_pb2.SmaccEventGenerator, _Mapping]]] = ...) -> None: ...
