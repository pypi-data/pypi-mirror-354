...
class FeatureFloatSetRequest(_message.Message):
    ...
    value: float
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., feature_name: _Optional[str] = ..., feature_module: _Optional[_Union[_feature_module_pb2.FeatureModule, _Mapping]] = ..., value: _Optional[float] = ...) -> None: ...

class FeatureFloatSetResponse(_message.Message):
