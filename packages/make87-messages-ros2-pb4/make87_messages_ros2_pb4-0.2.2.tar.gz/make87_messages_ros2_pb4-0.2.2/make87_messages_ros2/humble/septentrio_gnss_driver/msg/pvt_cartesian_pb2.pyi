...
class PVTCartesian(_message.Message):
    __slots__ = ["header", "ros2_header", "block_header", "mode", "error", "x", "y", "z", "undulation", "vx", "vy", "vz", "cog", "rx_clk_bias", "rx_clk_drift", "time_system", "datum", "nr_sv", "wa_corr_info", "reference_id", "mean_corr_age", "signal_info", "alert_flag", "nr_bases", "ppp_info", "latency", "h_accuracy", "v_accuracy", "misc"]
