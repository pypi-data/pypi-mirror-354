...
from make87_messages_ros2.humble.septentrio_gnss_driver.msg import meas_epoch_channel_type1_pb2 as _meas_epoch_channel_type1_pb2
...
class MeasEpoch(_message.Message):
    __slots__ = ["header", "ros2_header", "block_header", "n", "sb1_length", "sb2_length", "common_flags", "cum_clk_jumps", "type1"]
