...
class GetStatesResponse(_message.Message):
    __slots__ = ["header", "success", "states", "error_info"]
    HEADER_FIELD_NUMBER: _ClassVar[int]
    ...
    error_info: str
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., success: bool = ..., states: _Optional[_Iterable[_Union[_node_pb2.Node, _Mapping]]] = ..., error_info: _Optional[str] = ...) -> None: ...
