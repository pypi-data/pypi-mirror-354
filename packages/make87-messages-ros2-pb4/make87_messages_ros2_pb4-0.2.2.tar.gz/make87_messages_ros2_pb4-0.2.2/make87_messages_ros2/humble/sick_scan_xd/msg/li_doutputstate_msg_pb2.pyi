...
class LIDoutputstateMsg(_message.Message):
    __slots__ = ["header", "ros2_header", "version_number", "system_counter", "output_state", "output_count", "time_state", "year", "month", "day", "hour", "minute", "second", "microsecond"]
    ...
    second: int
    microsecond: int
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., version_number: _Optional[int] = ..., system_counter: _Optional[int] = ..., output_state: _Optional[_Iterable[int]] = ..., output_count: _Optional[_Iterable[int]] = ..., time_state: _Optional[int] = ..., year: _Optional[int] = ..., month: _Optional[int] = ..., day: _Optional[int] = ..., hour: _Optional[int] = ..., minute: _Optional[int] = ..., second: _Optional[int] = ..., microsecond: _Optional[int] = ...) -> None: ...
