...
class CommsPortInfo(_message.Message):
    __slots__ = ["header", "port_id", "tx_pending", "tx_bytes", "tx_usage", "tx_peak_usage", "rx_pending", "rx_bytes", "rx_usage", "rx_peak_usage", "overrun_errs", "msgs", "skipped"]
    ...
    skipped: int
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., port_id: _Optional[int] = ..., tx_pending: _Optional[int] = ..., tx_bytes: _Optional[int] = ..., tx_usage: _Optional[int] = ..., tx_peak_usage: _Optional[int] = ..., rx_pending: _Optional[int] = ..., rx_bytes: _Optional[int] = ..., rx_usage: _Optional[int] = ..., rx_peak_usage: _Optional[int] = ..., overrun_errs: _Optional[int] = ..., msgs: _Optional[_Iterable[int]] = ..., skipped: _Optional[int] = ...) -> None: ...
