...
from make87_messages_ros2.humble.ublox_ubx_msgs.msg import comms_port_info_pb2 as _comms_port_info_pb2
...
class UBXMonComms(_message.Message):
    __slots__ = ["header", "ros2_header", "version", "n_ports", "tx_errors", "reserved0", "prot_ids", "ports"]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., version: _Optional[int] = ..., n_ports: _Optional[int] = ..., tx_errors: _Optional[int] = ..., reserved0: _Optional[int] = ..., prot_ids: _Optional[_Iterable[int]] = ..., ports: _Optional[_Iterable[_Union[_comms_port_info_pb2.CommsPortInfo, _Mapping]]] = ...) -> None: ...
