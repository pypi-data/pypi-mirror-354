...
class GetCartesianPathRequest(_message.Message):
    __slots__ = ["header", "ros2_header", "start_state", "group_name", "link_name", "waypoints", "max_step", "jump_threshold", "prismatic_jump_threshold", "revolute_jump_threshold", "avoid_collisions", "path_constraints", "max_velocity_scaling_factor", "max_acceleration_scaling_factor", "cartesian_speed_limited_link", "max_cartesian_speed"]
...
class GetCartesianPathResponse(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., start_state: _Optional[_Union[_robot_state_pb2.RobotState, _Mapping]] = ..., solution: _Optional[_Union[_robot_trajectory_pb2.RobotTrajectory, _Mapping]] = ..., fraction: _Optional[float] = ..., error_code: _Optional[_Union[_move_it_error_codes_pb2.MoveItErrorCodes, _Mapping]] = ...) -> None: ...
