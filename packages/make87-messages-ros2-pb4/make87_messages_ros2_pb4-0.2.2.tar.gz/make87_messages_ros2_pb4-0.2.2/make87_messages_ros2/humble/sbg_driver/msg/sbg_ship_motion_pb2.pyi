...
from make87_messages_ros2.humble.sbg_driver.msg import sbg_ship_motion_status_pb2 as _sbg_ship_motion_status_pb2
...
class SbgShipMotion(_message.Message):
    __slots__ = ["header", "ros2_header", "time_stamp", "heave_period", "ship_motion", "acceleration", "velocity", "status"]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., ros2_header: _Optional[_Union[_header_pb2_1.Header, _Mapping]] = ..., time_stamp: _Optional[int] = ..., heave_period: _Optional[int] = ..., ship_motion: _Optional[_Union[_vector3_pb2.Vector3, _Mapping]] = ..., acceleration: _Optional[_Union[_vector3_pb2.Vector3, _Mapping]] = ..., velocity: _Optional[_Union[_vector3_pb2.Vector3, _Mapping]] = ..., status: _Optional[_Union[_sbg_ship_motion_status_pb2.SbgShipMotionStatus, _Mapping]] = ...) -> None: ...
