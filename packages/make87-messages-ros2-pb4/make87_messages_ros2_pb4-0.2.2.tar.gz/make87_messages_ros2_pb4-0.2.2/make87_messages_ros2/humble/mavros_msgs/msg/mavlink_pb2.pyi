...
class Mavlink(_message.Message):
    __slots__ = ["header", "ros2_header", "framing_status", "magic", "len", "incompat_flags", "compat_flags", "seq", "sysid", "compid", "msgid", "checksum", "payload64", "signature"]
