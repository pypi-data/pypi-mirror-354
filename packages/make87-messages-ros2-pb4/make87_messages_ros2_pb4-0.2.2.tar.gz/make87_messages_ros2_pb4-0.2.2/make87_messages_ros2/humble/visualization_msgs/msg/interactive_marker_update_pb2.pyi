...
from make87_messages_ros2.humble.visualization_msgs.msg import interactive_marker_pose_pb2 as _interactive_marker_pose_pb2
...
class InteractiveMarkerUpdate(_message.Message):
    __slots__ = ["header", "server_id", "seq_num", "type", "markers", "poses", "erases"]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., server_id: _Optional[str] = ..., seq_num: _Optional[int] = ..., type: _Optional[int] = ..., markers: _Optional[_Iterable[_Union[_interactive_marker_pb2.InteractiveMarker, _Mapping]]] = ..., poses: _Optional[_Iterable[_Union[_interactive_marker_pose_pb2.InteractiveMarkerPose, _Mapping]]] = ..., erases: _Optional[_Iterable[str]] = ...) -> None: ...
