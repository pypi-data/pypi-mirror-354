...
class GridMap(_message.Message):
    __slots__ = ["header", "info", "layers", "basic_layers", "data", "outer_start_index", "inner_start_index"]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., info: _Optional[_Union[_grid_map_info_pb2.GridMapInfo, _Mapping]] = ..., layers: _Optional[_Iterable[str]] = ..., basic_layers: _Optional[_Iterable[str]] = ..., data: _Optional[_Iterable[_Union[_float32_multi_array_pb2.Float32MultiArray, _Mapping]]] = ..., outer_start_index: _Optional[int] = ..., inner_start_index: _Optional[int] = ...) -> None: ...
