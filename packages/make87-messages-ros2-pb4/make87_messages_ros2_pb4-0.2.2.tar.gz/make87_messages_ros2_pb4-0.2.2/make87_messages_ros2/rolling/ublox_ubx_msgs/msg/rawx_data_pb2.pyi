from make87_messages_ros2.rolling.ublox_ubx_msgs.msg import trk_stat_pb2 as _trk_stat_pb2
...
class RawxData(_message.Message):
    __slots__ = ["pr_mes", "cp_mes", "do_mes", "gnss_id", "sv_id", "sig_id", "freq_id", "locktime", "c_no", "pr_stdev", "cp_stdev", "do_stdev", "trk_stat"]
