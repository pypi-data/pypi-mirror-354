...
class Actuators(_message.Message):
    __slots__ = ["header", "position", "velocity", "normalized"]
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., position: _Optional[_Iterable[float]] = ..., velocity: _Optional[_Iterable[float]] = ..., normalized: _Optional[_Iterable[float]] = ...) -> None: ...
