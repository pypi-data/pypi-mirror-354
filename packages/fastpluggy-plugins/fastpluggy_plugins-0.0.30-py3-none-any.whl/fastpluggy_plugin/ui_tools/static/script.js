document.addEventListener('DOMContentLoaded', () => {
  ...
  document.body.addEventListener('click', e => {
    ...
    const cell = e.target.closest('.json-cell');
    const pre  = cell.querySelector('.json-content');
  ...
  document.body.addEventListener('click', e => {
    ...
    const cell       = e.target.closest('.json-cell');
    const preWrapper = cell.querySelector('.pre-container');
  ...
  document.body.addEventListener('click', e => {
    ...
    const wrapper = e.target.closest('.pre-container');
