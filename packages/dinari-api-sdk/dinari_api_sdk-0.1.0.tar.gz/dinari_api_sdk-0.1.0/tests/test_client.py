...
def _get_open_connections(client: Dinari | AsyncDinari) -> int:
...
class TestDinari:
    ...
    def test_multipart_repeating_array(self, client: Dinari) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: Dinari) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Dinari) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Dinari) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
...
class TestAsyncDinari:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncDinari) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncDinari) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncDinari) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncDinari) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncDinari, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
