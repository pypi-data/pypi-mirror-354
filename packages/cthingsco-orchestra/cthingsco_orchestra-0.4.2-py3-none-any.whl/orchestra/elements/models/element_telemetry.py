...
class ElementTelemetryPartition(RWModel):
    ...
    def to_tuple(
        cls,
        proto_model: element_telemetry_pb2.MultipleElementPartitionTelemetry
...
class ElementPartition(RWModel):
    ...
    def to_tuple(
        cls,
        proto_model: element_telemetry_pb2.ElementPartition
...
class MultipleElementPartitionTelemetry(RWModel):
    ...
    @classmethod
    def from_protobuf_model(cls, proto_model: element_telemetry_pb2.MultipleElementPartitionTelemetry):
        return cls(
            element_partition=ElementPartition.from_protobuf_model(proto_model=proto_model.element_partition),
            telemetry=SingleElementTelemetry.from_protobuf_model(proto_model=proto_model.telemetry),
        )
