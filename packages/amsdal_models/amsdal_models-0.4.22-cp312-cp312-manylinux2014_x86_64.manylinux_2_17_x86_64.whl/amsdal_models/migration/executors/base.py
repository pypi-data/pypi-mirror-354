...
class BaseMigrationExecutor(ABC):
    ...
    def _resolve_base_class_name(class_name: str, meta_class: str) -> str:
        ...
        if _meta_class == MetaClasses.TYPE or class_name in (BaseClasses.CLASS_OBJECT, BaseClasses.CLASS_OBJECT_META):
...
class AsyncBaseMigrationExecutor(BaseMigrationExecutor):
