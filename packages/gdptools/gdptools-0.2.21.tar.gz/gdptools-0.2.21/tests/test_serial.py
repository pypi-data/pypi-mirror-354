...
gldas_vars = ["tair_f_inst", "rainf_f_tavg"]


# Adding catalog entry with toptobottom false
@pytest.fixture
def climr_dict_1(vars: list[str] = gldas_vars) -> dict[str, Any]:
...
# Adding catalog entry with toptobottom true
@pytest.fixture
...
def test_serial_climrcatdata(climr_dict, get_gdf, get_out_path) -> None:
...
# def test_serial_usercatdata_with_error(get_xarray, get_gdf, get_out_path):
#     """Test bad time formatting.

#     NOTE: pd.Timestamp("2021-01-01T00:00") returns "2021-01-01T00:00:00" when converted to isoformat() which
#     _process_period() returns.  When subsetting this dataset, it will fail.
#     """
#     def test_serial_usercatdata_with_error(get_xarray, get_gdf):
#         """Test Serial versions."""
#         sdate = pd.Timestamp("2021-01-01T00:00")
#         edate = pd.Timestamp("2021-01-01T02:00")
...
#         test_serial_usercatdata_with_error(get_xarray, get_gdf)
#         assert "The source data time coordinate is formatted as" in str(excinfo.value)


def test_serial_usercatdata_timestamp(get_xarray, get_gdf, get_out_path) -> None:
    """Test Serial versions."""
    sdate = pd.Timestamp("2020-12-31T00:00")
    edate = pd.Timestamp("2021-01-01T02:00")
    user_data = UserCatData(
        ds=get_xarray,
        proj_ds=data_crs,
...
def test_serial_usercatdata_datetime(get_xarray, get_gdf, get_out_path) -> None:
    """Test Serial versions."""
    sdate = datetime.datetime(2020, 12, 31, 0, 0)
    edate = datetime.datetime(2021, 1, 1, 2, 0)
    user_data = UserCatData(
        ds=get_xarray,
        proj_ds=data_crs,
        x_coord=x_coord,
...
def test_serial_usercatdata(get_xarray, get_gdf, get_out_path) -> None:
    """Test Serial versions."""
...
def test_serial_usercatdata_with_precision(get_xarray, get_gdf, get_out_path) -> None:
    """Test Serial versions."""
    sdate = "2021-01-01T00:00"
    edate = "2021-01-01T02:00"
    user_data = UserCatData(
...
def test_serial_usercatdata_out_netcdf(get_xarray, get_gdf, get_out_path) -> None:
    """Test Serial versions."""
    sdate = "2021-01-01T00:00"
    edate = "2021-01-01T02:00"
    user_data = UserCatData(
...
def test_serial_usercatdata_out_netcdf_with_precision(get_xarray, get_gdf, get_out_path) -> None:
    """Test Serial versions."""
    sdate = "2021-01-01T00:00"
    edate = "2021-01-01T02:00"
    user_data = UserCatData(
...
def test_serial_usercatdata_out_parquet(get_xarray, get_gdf, get_out_path) -> None:
    """Test Serial versions."""
    sdate = "2021-01-01T00:00"
    edate = "2021-01-01T02:00"
    user_data = UserCatData(
...
def test_serial_usercatdata_out_parquet_with_precision(get_xarray, get_gdf, get_out_path) -> None:
    """Test Serial versions."""
    sdate = "2021-01-01T00:00"
    edate = "2021-01-01T02:00"
    user_data = UserCatData(
...
def test_serial_usercatdata_out_json(get_xarray, get_gdf, get_out_path) -> None:
    """Test Serial versions."""
    sdate = "2021-01-01T00:00"
    edate = "2021-01-01T02:00"
    user_data = UserCatData(
...
def test_serial_usercatdata_out_json_with_precision(get_xarray, get_gdf, get_out_path) -> None:
    """Test Serial versions."""
    sdate = "2021-01-01T00:00"
    edate = "2021-01-01T02:00"
    user_data = UserCatData(
