...
class ScLang:
    ...
    def initSCDoc(self, helpSourceDir, helpTargetDir, extension):
        ...
        # HelpBrowser.defaultHomeUrl doesn't update automatically on helpTargetDir change
        # load SCDoc.findHelpFile explicitly (returns updated home url)
        self.evaluate('HelpBrowser.defaultHomeUrl = SCDoc.findHelpFile')
...
if (entry.notNil) {{
    ...
    def openHelp(self):
        ...
        self.evaluate("HelpBrowser.goHome")
