...
class AnsibleGalaxyParser(BaseParser):
    ...
    def _parse_requirements_file(self, file_path: Path, content: str = None) -> List[Dict[str, Any]]:
    ...
    def _parse_meta_file(self, file_path: Path, content: str = None) -> List[Dict[str, Any]]:
    ...
    def _parse_galaxy_file(self, file_path: Path, content: str = None) -> Dict[str, Any]:
