...
class MarkdownFormatter(BaseFormatter):
    ...
    def _format_path(self, path: Optional[str], base_path: Optional[Path] = None) -> str:
    ...
    def _format_command(self, cmd: Dict[str, Any], base_path: Optional[Path] = None) -> Dict[str, Any]:
    ...
    def format_report(self, data: Dict[str, Any], **kwargs: Any) -> str:
        ...
        # Format command data
        commands = [self._format_command(cmd, base_path) for cmd in data.get("commands", [])]
        successful_commands = [self._format_command(cmd, base_path) for cmd in data.get("successful_commands", [])]
        failed_commands = [self._format_command(cmd, base_path) for cmd in data.get("failed_commands", [])]
        ignored_commands = [self._format_command(cmd, base_path) for cmd in data.get("ignored_commands", [])]
...
class JsonFormatter(BaseFormatter):
    ...
    def format_report(self, data: Dict[str, Any], **kwargs: Any) -> str:
        ...
        command_sections = ["commands", "successful_commands", "failed_commands", "ignored_commands"]
