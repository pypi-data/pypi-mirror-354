...
def get_virtualenv_info(project_path: str) -> Dict[str, Any]:
    ...
    """
    # Import the function from project_detection.virtualenv to avoid duplication
    from domd.core.project_detection.virtualenv import get_virtualenv_info as get_venv_info
    ...
    venv_info.setdefault("exists", "path" in venv_info and venv_info["path"] is not None)
