...
class GenerateS3PresignedUrlsPostRequest(_message.Message):
    __slots__ = ("container", "object_paths", "expiration_in_seconds")
    ...
    def __init__(self, container: _Optional[str] = ..., object_paths: _Optional[_Iterable[str]] = ..., expiration_in_seconds: _Optional[float] = ...) -> None: ...
