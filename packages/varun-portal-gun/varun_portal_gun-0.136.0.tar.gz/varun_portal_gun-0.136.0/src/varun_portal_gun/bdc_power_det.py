...
def bdc_power_det(room_temp_file, gain_df):
    ...
    gain_df_sgt_attn_cmd_40 = gain_df.iloc[1, 9]
    gain_df_sgt_attn_cmd_55 = gain_df.iloc[2, 9]
    ...
    for i in range(13):
        ...
        sgt_attn_cmd = gain_df_sgt_attn_cmd_40
    ...
    for i in range(13):
        #sgt_attn_cmd - diff by temperature, check bdc_gain 40 df
        sgt_attn_cmd = gain_df_sgt_attn_cmd_55
