...
def bdc_autobias():
    ...
    if pol == 'lhcp':
        ...
        for index, row in final_df.iterrows():
            match final_df.iloc[:, 3]:
                case 0.0:
                    final_df.iloc[:, 3] = 'BDC_LNA2_VGG_L'
                case 1.0:
                    final_df.iloc[:, 3] = 'BDC_RFA2_VGG_L'
                case 2.0:
                    final_df.iloc[:, 3] = 'BDC_VGG_AMP_L1'
                case 3.0:
                    final_df.iloc[:, 3] = 'BDC_VGG_AMP_L2'
                case 4.0:
                    final_df.iloc[:, 3] = 'BDC_VGG_AMP_L3'
                case _ :
                    break
