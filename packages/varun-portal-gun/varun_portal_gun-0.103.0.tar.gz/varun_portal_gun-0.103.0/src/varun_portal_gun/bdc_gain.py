...
def bdc_gain(room_temp_file):
    ...
    pol = room_temp_df.iloc[0, 0]

    ### HERE
    eq_setting = room_temp_df.iloc[0, 3]

    p_out = 1

    ### HERE
    f_out = room_temp_df.iloc[0, 12]


    ###HERE
    TMP_BDC_LNA_COMBINED_SCALED = room_temp_df.iloc[0, 18]
