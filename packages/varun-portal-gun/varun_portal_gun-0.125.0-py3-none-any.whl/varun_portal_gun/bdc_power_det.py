...
def bdc_power_det():
    ...
    if pol == 'lhcp':
        ...
        final_df['TEMP_BDC_COMBINED_SCALED'] = final_df['TEMP_BDC_L_SCALED']
        final_df['BDC_IF_DETECT_COMB_RAW'] = final_df['BDC_IF_DETECT_L_RAW']
        final_df['TMP_BDC_LNA_COMB_SCALED'] = final_df['TMP_BDC_LNA_L_SCALED']
        ...
        for i in range(26):
            final_df.iloc[i, 5] = -80 + 4(i%13)
        
        final_df['f_out'] = 4320000000.0

        final_df['TEMP_BDC_COMBINED_SCALED'] = final_df['TEMP_BDC_R_SCALED']
        final_df['BDC_IF_DETECT_COMB_RAW'] = final_df['BDC_IF_DETECT_R_RAW']
        final_df['TMP_BDC_LNA_COMB_SCALED'] = final_df['TMP_BDC_LNA_R_SCALED']
    
    print(final_df.iloc[:, :15])