    ...
    def ensure_and_heartbeat(self, obj_to_revive, func, **kwargs):
        ...
        while True:
            try:
                ...
                logger.error("ensure_and_heartbeat failed", exc_info=True)
                time.sleep(1)
...
class Client(object):
    ...
    def __init__(self, amqp_url, cache_kwargs=None, connection_kwargs=None):
        ...
        self._producer = None
        self.ensure_and_heartbeat = self.ensured_connection.ensure_and_heartbeat
    ...
    def __create_exchange(self, exchange_name, exchange_type):
        ...
        self.ensure_and_heartbeat(exchange, exchange.declare)
        return exchange
    ...
    def send(self, data, routing_key, exchange=None, encoder=None, **properties):
        ...
        self.ensure_and_heartbeat(self.producer,
