...
from yms_class.models.KKAN import KKAN, CCNN
...
def main(args, run=None):
    ...
    transform = transforms.Compose([
        transforms.Resize((32, 32)),  # 将图像的大小调整为224x224像素
    ...
    for epoch in range(0, num_epochs):
        ...
        if metric['f1-score'] > best:
            ...
            # model.save(os.path.join(model_dir, 'best_cnn.pt'))
...
def parse_args(args=None):
    ...
    parser.add_argument('--data_dir', default=r'D:\Code\2-ZSL\0-data\data\CRWU\D0')
    parser.add_argument('--save_dir', default=r'kan')
