...
from mpl_toolkits.axes_grid1 import make_axes_locatable
def plotBorder(matrix,name='plotMat',saveDir="plotBorder",title='Matrix Plot', xlabel='X-axis', ylabel='Y-axis', color_label='Value', cmap='viridis'):
    # 地理范围 (lat_min, lat_max, lon_min, lon_max)
    lat_min, lat_max = 0, 57
    lon_min, lon_max = -132, -47
    # 创建地图
