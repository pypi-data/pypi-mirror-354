...
class Tags(BaseSDK):
    def autocomplete_tags(
        ...
        * Agents
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.TagsByObjectIDResponse)
    ...
    def count_tags(
        ...
        * Agents
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.TagCountResponse)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def list_resource_tags(
        ...
        * Agents
        ...
        request = models.ListResourceTagsRequest(
            ticket_id=ticket_id,
        )
    ...
    def set_tags_ticket(
        ...
        * Agents
        ...
        request = models.SetTagsTicketRequest(
            ticket_id=ticket_id,
        )
    ...
    async def set_tags_ticket_async(
        self,
        *,
        ticket_id: int,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def put_tags_ticket(
        ...
        * Agents
        ...
        request = models.PutTagsTicketRequest(
            ticket_id=ticket_id,
        )
    ...
    async def put_tags_ticket_async(
        self,
        *,
        ticket_id: int,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def delete_tags_ticket(
        ...
        * Agents
        ...
        request = models.DeleteTagsTicketRequest(
            ticket_id=ticket_id,
        )
    ...
    async def delete_tags_ticket_async(
        self,
        *,
        ticket_id: int,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
