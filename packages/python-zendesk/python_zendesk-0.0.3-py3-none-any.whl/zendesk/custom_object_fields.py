...
class CustomObjectFields(BaseSDK):
    ...
    ) -> models.CustomObjectFieldsResponse:
        ...
        * Offset pagination
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.CustomObjectFieldsResponse
            )
    ...
    def create_custom_object_field(
        ...
        * Admins
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(http_res.text, models.CustomObjectFieldResponse)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
