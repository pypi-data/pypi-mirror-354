...
class SetSafetyClassificationRequest(_message.Message):
    __slots__ = ("handle", "safety_classification")
    HANDLE_FIELD_NUMBER: _ClassVar[int]
    SAFETY_CLASSIFICATION_FIELD_NUMBER: _ClassVar[int]
    handle: str
    safety_classification: _types_pb2.SafetyClassification
    def __init__(self, handle: _Optional[str] = ..., safety_classification: _Optional[_Union[_types_pb2.SafetyClassification, str]] = ...) -> None: ...
