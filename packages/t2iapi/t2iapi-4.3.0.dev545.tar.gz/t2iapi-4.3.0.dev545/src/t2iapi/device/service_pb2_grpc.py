...
class DeviceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetSafetyClassification = channel.unary_unary(
                '/t2iapi.device.DeviceService/SetSafetyClassification',
                request_serializer=t2iapi_dot_device_dot_device__requests__pb2.SetSafetyClassificationRequest.SerializeToString,
                response_deserializer=t2iapi_dot_basic__responses__pb2.BasicResponse.FromString,
                )
...
class DeviceServiceServicer(object):
    ...
    def SetSafetyClassification(self, request, context):
        """
        Set the @SafetyClassification to the given value for the provided descriptor handle. The manipulated device state
        shall be persistent until a next manipulation call. If the device is not able to maintain the static state, it shall
...
def add_DeviceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SetSafetyClassification': grpc.unary_unary_rpc_method_handler(
                    servicer.SetSafetyClassification,
                    request_deserializer=t2iapi_dot_device_dot_device__requests__pb2.SetSafetyClassificationRequest.FromString,
                    response_serializer=t2iapi_dot_basic__responses__pb2.BasicResponse.SerializeToString,
            ),
    }
...
class DeviceService(object):
    ...
    @staticmethod
    def SetSafetyClassification(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/t2iapi.device.DeviceService/SetSafetyClassification',
            t2iapi_dot_device_dot_device__requests__pb2.SetSafetyClassificationRequest.SerializeToString,
            t2iapi_dot_basic__responses__pb2.BasicResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
