...
class SpotFindingSettings(BaseModel):
    ...
    quick_integration_high_res_a: Union[StrictFloat, StrictInt] = Field(description="Quick integration limit for high resolution [A] ", alias="quick_integration_high_res_A")
    __properties: ClassVar[List[str]] = ["enable", "indexing", "filter_powder_rings", "min_spot_count_powder_ring", "signal_to_noise_threshold", "photon_count_threshold", "min_pix_per_spot", "max_pix_per_spot", "high_resolution_limit", "low_resolution_limit", "resolution_estimate", "quick_integration", "quick_integration_high_res_A"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "quick_integration_high_res_A": obj.get("quick_integration_high_res_A") if obj.get("quick_integration_high_res_A") is not None else 1.5
        })
        return _obj
