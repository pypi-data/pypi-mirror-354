...
class MMApi:
    ...
    def _get(self, endpoint, params=None, raw=False, exc=True):
        ...
        """
        res = requests.get(self._url + endpoint, headers=self._headers, params=params, verify=self._ssl_verify)
        if raw:
            return res
    ...
    def _post(self, endpoint, params=None, data=None, multipart_formdata=None, exc=True):
        ...
        res = requests.post(self._url + endpoint, headers=self._headers, params=params, data=data,
                            files=multipart_formdata, verify=self._ssl_verify)
