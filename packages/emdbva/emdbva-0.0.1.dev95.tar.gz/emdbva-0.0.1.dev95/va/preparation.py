...
class PreParation:
    ...
    def __init__(self):
        ...
        if self.emdid:
            ...
            try:
                emcif_file = os.path.join(self.dir, f'emd-{self.emdid}.cif')
                ...
                if os.path.isfile(filepath):
                    if inputdict_cif:
                        ...
                        self.model = [inputdict_cif.get('PDB', '').lower() + '.cif']
                        ...
                        self.masks = inputdict_cif.get('mask', '') + 'map' if 'mask' in inputdict_cif else {}
                    else:
    ...
    def parse_emdb_cif(file_path):
        ...
        resolution = block.find_value('_em_3d_reconstruction.resolution') or None
