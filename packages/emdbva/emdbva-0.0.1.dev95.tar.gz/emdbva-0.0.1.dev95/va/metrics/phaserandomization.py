...
def relion_mask(raw_map, out_dir, relion_mask_executable, mapname=None, resolution=None):
...
def relion_fsc_calculation(mapone, maptwo, root, mapname=None, resolution=None):
    ...
    try:
        ...
        if fsc_dir and mask_dir and relion_mask_executable:
            ...
            relion_mask_name = relion_mask(filtered_raw_map, mask_dir, relion_mask_executable, mapname, resolution)
