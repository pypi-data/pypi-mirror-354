...
@time_it
def prvidp(infolder,  window_size=1, outType="tif", cog_flag=False, cog_overviews = [2, 4, 8, 16], write_flag=True, max_workers=None,block_size=(512, 512)):
    """
    ...
    if outType == "bin":
        output_filepaths.append(os.path.join(infolder, "prvidp.bin"))
    else:
