...
@click.pass_context
def model(ctx, model_name, ckpt_paths, dataset_paths, ckpt_list, dataset_list, tp, pp, ep, seq_len, batch_size, tokenizer_path, project_name, validation_batch_size):
    ...
    if (dataset_paths and dataset_list) or (not dataset_paths and not dataset_list):
