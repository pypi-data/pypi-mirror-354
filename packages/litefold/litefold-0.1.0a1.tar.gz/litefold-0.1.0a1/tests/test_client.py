...
def _get_open_connections(client: Litefold | AsyncLitefold) -> int:
...
class TestLitefold:
    client = Litefold(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "litefold/_legacy_response.py",
                        "litefold/_response.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(LitefoldError):
            with update_env(**{"LITEFOLD_API_KEY": Omit()}):
                client2 = Litefold(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Litefold) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Litefold(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(LITEFOLD_BASE_URL="http://localhost:5000/from/env"):
            client = Litefold(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            Litefold(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Litefold(
    ...
    def test_base_url_trailing_slash(self, client: Litefold) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Litefold) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Litefold) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Litefold(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Litefold(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Litefold(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/upload/fasta").mock(side_effect=retry_handler)

        response = client.upload.with_raw_response.create_fasta(files=[b"raw file contents"], job_name="job_name")
    ...
    def test_omit_retry_count_header(
        self, client: Litefold, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.upload.with_raw_response.create_fasta(
            files=[b"raw file contents"], job_name="job_name", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.upload.with_raw_response.create_fasta(
            files=[b"raw file contents"], job_name="job_name", extra_headers={"x-stainless-retry-count": "42"}
        )
...
class TestAsyncLitefold:
    client = AsyncLitefold(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(LitefoldError):
            with update_env(**{"LITEFOLD_API_KEY": Omit()}):
                client2 = AsyncLitefold(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncLitefold) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(LITEFOLD_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncLitefold(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncLitefold) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncLitefold) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncLitefold) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncLitefold(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncLitefold(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.upload.with_raw_response.create_fasta(files=[b"raw file contents"], job_name="job_name")
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncLitefold, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.upload.with_raw_response.create_fasta(
            files=[b"raw file contents"], job_name="job_name", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_get_platform(self) -> None:
        ...
        from litefold._utils import asyncify
        from litefold._base_client import get_platform
