...
# =======================================================================================
class Decoder:
    """Decoder for the data section of the CTI DB"""
    ...
    def __init__(
        ...
        """Created a Decoder for a CTI DB

        Arguments:
        database_buffer -- an mmap'd CTI DB file.
    ...
    def _verify_size(expected: int, actual: int) -> None:
        if expected != actual:
            raise InvalidDatabaseError(
                "The CTI DB file's data section contains bad data "
