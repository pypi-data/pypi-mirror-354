...
class AssistantModel:
    ...
    def chat_completions(
        ...
        if model is None:
            model = "gpt-4o"
        elif model not in ["gpt-4o", "gpt-4.1", "o4-mini", "claude-3-5-sonnet", "claude-3-7-sonnet", "gemini-2.5-pro"]:
            raise ValueError(
                "Invalid model. Valid options are `gpt-4o`, `gpt-4.1`, `o4-mini`, `claude-3-5-sonnet`, `claude-3-7-sonnet`, and `gemini-2.5-pro`."
            )
