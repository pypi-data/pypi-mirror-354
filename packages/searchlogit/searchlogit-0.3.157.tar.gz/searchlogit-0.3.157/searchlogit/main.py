...
def Mario():
    ...
    parameters = Parameters(criterions=criterions, df=df, choice_set=choice_set, choice_id=choice_id,
                            alt_var=alt_var, varnames=varnames, isvarnames=isvarnames, asvarnames=asvarnames,
                            choices=choices,
                            ind_id=ind_id, base_alt=base_alt, allow_random=True, allow_corvars=True, allow_bcvars=True,
                            latent_class=False, allow_latent_random=False, allow_latent_bcvars=False, n_draws=200)
    init_sol = None
