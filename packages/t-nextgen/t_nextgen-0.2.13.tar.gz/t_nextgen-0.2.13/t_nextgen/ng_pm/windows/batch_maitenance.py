...
class BatchMaintenanceWindow(NextGenWindow):
    ...
    def update_process_date(self, date_to_update: str) -> None:
        ...
        """
        self.desktop_app.set_text(
            self.window.child_window(auto_id="txtProcessDate").child_window(auto_id="mtxtDate", control_type="Edit"),
            date_to_update,
        )
    ...
    def update_total_adjustment(self, total_adjustment: str) -> None:
        ...
        """
        try:
            self.desktop_app.wait_until_element_visible(control_type="Window", auto_id="txtTotAdjusted", retries=1)
        except PywinTimeout:
        ...
        self.desktop_app.set_text(
            self.window.child_window(auto_id="txtTotAdjusted", control_type="Edit"), total_adjustment
        )
