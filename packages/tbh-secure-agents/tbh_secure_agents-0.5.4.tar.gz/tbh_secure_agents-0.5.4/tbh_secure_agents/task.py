...
class Operation:
    ...
    def _pre_execution_secure(self, guardrails: Optional[Dict[str, Any]] = None) -> bool:
        ...
        """
        if hasattr(self.expert, 'security_profile') and self.expert.security_profile == 'minimal':
            logger.info("🛡️ MINIMAL PROFILE: Bypassing all pre-execution security checks.")
            return True
