...
def main():
    ...
    try:
        ...
        researcher.remember(solar_fact_key, solar_fact_value)
        ...
        researcher.remember(wind_fact_key, wind_fact_value)
        ...
        recalled_wind_fact = researcher.recall(wind_fact_key)
        ...
        recalled_solar_fact_in_wind_session = researcher.recall(solar_fact_key)
        ...
        recalled_solar_fact = researcher.recall(solar_fact_key)
        ...
        recalled_wind_fact_in_solar_session = researcher.recall(wind_fact_key)
