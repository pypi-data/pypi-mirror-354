...
gopy build -no-make -dynamic-link=True -output build/lib.linux-x86_64-cpython-312/bbta -name bbta -vm /opt/python/cp312-cp312/bin/python github.com/banbox/banta/python/ta github.com/banbox/banta/python/tav
*/
