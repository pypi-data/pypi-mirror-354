...
gopy build -no-make -dynamic-link=True -output build/lib.linux-x86_64-cpython-39/bbta -name bbta -vm /opt/python/cp39-cp39/bin/python github.com/banbox/banta/python/ta github.com/banbox/banta/python/tav
*/
