...
gopy build -no-make -output build\lib.win-amd64-cpython-312\bbta -name bbta -vm C:\Users\runneradmin\AppData\Local\Temp\cibw-run-yomiejfe\cp312-win_amd64\build\venv\Scripts\python.exe github.com/banbox/banta/python/ta github.com/banbox/banta/python/tav
*/
...
#cgo CFLAGS: "-IC:/Users/runneradmin/AppData/Local/pypa/cibuildwheel/Cache/nuget-cpython/python.3.12.10/tools/Include" -Wno-error -Wno-implicit-function-declaration -Wno-int-conversion
#cgo LDFLAGS: "-LC:/Users/runneradmin/AppData/Local/pypa/cibuildwheel/Cache/nuget-cpython/python.3.12.10/tools/libs" "-lpython312"
...
func ptrFromHandle_Array_2_banta_Series(h CGoHandle) *[2]banta.Series {
...
func deptrFromHandle_Array_2_banta_Series(h CGoHandle) [2]banta.Series {
	p := ptrFromHandle_Array_2_banta_Series(h)
	return *p
}
func handleFromPtr_Array_2_banta_Series(p interface{}) CGoHandle {
	return CGoHandle(gopyh.Register("[2]banta.Series", p))
}

// --- wrapping slice: [2]banta.Series ---
//
//export Array_2_banta_Series_CTor
func Array_2_banta_Series_CTor() CGoHandle {
	return CGoHandle(handleFromPtr_Array_2_banta_Series(&[2]banta.Series{}))
}

//export Array_2_banta_Series_len
func Array_2_banta_Series_len(handle CGoHandle) int {
	return len(deptrFromHandle_Array_2_banta_Series(handle))
}

//export Array_2_banta_Series_elem
func Array_2_banta_Series_elem(handle CGoHandle, _idx int) CGoHandle {
	s := deptrFromHandle_Array_2_banta_Series(handle)
	return handleFromPtr_banta_Series(&(s[_idx]))
}

//export Array_2_banta_Series_set
func Array_2_banta_Series_set(handle CGoHandle, _idx int, _vl CGoHandle) {
	s := deptrFromHandle_Array_2_banta_Series(handle)
	s[_idx] = *ptrFromHandle_banta_Series(_vl)
}

// Converters for implicit pointer handles for type: [3]banta.Series
func ptrFromHandle_Array_3_banta_Series(h CGoHandle) *[3]banta.Series {
...
func deptrFromHandle_Array_3_banta_Series(h CGoHandle) [3]banta.Series {
	p := ptrFromHandle_Array_3_banta_Series(h)
	return *p
}
func handleFromPtr_Array_3_banta_Series(p interface{}) CGoHandle {
	return CGoHandle(gopyh.Register("[3]banta.Series", p))
}

// --- wrapping slice: [3]banta.Series ---
//
//export Array_3_banta_Series_CTor
func Array_3_banta_Series_CTor() CGoHandle {
	return CGoHandle(handleFromPtr_Array_3_banta_Series(&[3]banta.Series{}))
}

//export Array_3_banta_Series_len
func Array_3_banta_Series_len(handle CGoHandle) int {
	return len(deptrFromHandle_Array_3_banta_Series(handle))
}

//export Array_3_banta_Series_elem
func Array_3_banta_Series_elem(handle CGoHandle, _idx int) CGoHandle {
	s := deptrFromHandle_Array_3_banta_Series(handle)
	return handleFromPtr_banta_Series(&(s[_idx]))
}

//export Array_3_banta_Series_set
func Array_3_banta_Series_set(handle CGoHandle, _idx int, _vl CGoHandle) {
	s := deptrFromHandle_Array_3_banta_Series(handle)
	s[_idx] = *ptrFromHandle_banta_Series(_vl)
}

// Converters for implicit pointer handles for type: [4]banta.Series
func ptrFromHandle_Array_4_banta_Series(h CGoHandle) *[4]banta.Series {
...
func deptrFromHandle_Array_4_banta_Series(h CGoHandle) [4]banta.Series {
	p := ptrFromHandle_Array_4_banta_Series(h)
	return *p
}
func handleFromPtr_Array_4_banta_Series(p interface{}) CGoHandle {
	return CGoHandle(gopyh.Register("[4]banta.Series", p))
}

// --- wrapping slice: [4]banta.Series ---
//
//export Array_4_banta_Series_CTor
func Array_4_banta_Series_CTor() CGoHandle {
	return CGoHandle(handleFromPtr_Array_4_banta_Series(&[4]banta.Series{}))
}

//export Array_4_banta_Series_len
func Array_4_banta_Series_len(handle CGoHandle) int {
	return len(deptrFromHandle_Array_4_banta_Series(handle))
}

//export Array_4_banta_Series_elem
func Array_4_banta_Series_elem(handle CGoHandle, _idx int) CGoHandle {
	s := deptrFromHandle_Array_4_banta_Series(handle)
	return handleFromPtr_banta_Series(&(s[_idx]))
}

//export Array_4_banta_Series_set
func Array_4_banta_Series_set(handle CGoHandle, _idx int, _vl CGoHandle) {
	s := deptrFromHandle_Array_4_banta_Series(handle)
	s[_idx] = *ptrFromHandle_banta_Series(_vl)
}
...
//export banta_Series_Cross
func banta_Series_Cross(_handle CGoHandle, obj2 *C.char) C.longlong {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	vifc, __err := gopyh.VarFromHandleTry((gopyh.CGoHandle)(_handle), "*banta.Series")
	if __err != nil {
	...
	return C.longlong(gopyh.Embed(vifc, reflect.TypeOf(banta.Series{})).(*banta.Series).Cross(C.GoString(obj2)))
...
//
//export banta_CrossLog_CTor
func banta_CrossLog_CTor() CGoHandle {
	return CGoHandle(handleFromPtr_banta_CrossLog(&banta.CrossLog{}))
}

//export banta_CrossLog_Time_Get
func banta_CrossLog_Time_Get(handle CGoHandle) C.longlong {
	op := ptrFromHandle_banta_CrossLog(handle)
	return C.longlong(op.Time)
}

//export banta_CrossLog_Time_Set
func banta_CrossLog_Time_Set(handle CGoHandle, val C.longlong) {
	op := ptrFromHandle_banta_CrossLog(handle)
	op.Time = int64(val)
}

//export banta_CrossLog_PrevVal_Get
func banta_CrossLog_PrevVal_Get(handle CGoHandle) C.double {
	op := ptrFromHandle_banta_CrossLog(handle)
	return C.double(op.PrevVal)
}

//export banta_CrossLog_PrevVal_Set
func banta_CrossLog_PrevVal_Set(handle CGoHandle, val C.double) {
	op := ptrFromHandle_banta_CrossLog(handle)
	op.PrevVal = float64(val)
}

//export banta_CrossLog_Hist_Get
func banta_CrossLog_Hist_Get(handle CGoHandle) CGoHandle {
	op := ptrFromHandle_banta_CrossLog(handle)
	return handleFromPtr_Slice_Ptr_banta_XState(&op.Hist)
}

//export banta_CrossLog_Hist_Set
func banta_CrossLog_Hist_Set(handle CGoHandle, val CGoHandle) {
	op := ptrFromHandle_banta_CrossLog(handle)
	op.Hist = deptrFromHandle_Slice_Ptr_banta_XState(val)
}
...
func ta_HL2(h CGoHandle, l CGoHandle) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.HL2(ptrFromHandle_Ptr_banta_Series(h), ptrFromHandle_Ptr_banta_Series(l))

	return handleFromPtr_banta_Series(&cret)
}
...
func ta_UpDown(obj CGoHandle, vtype C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.UpDown(ptrFromHandle_Ptr_banta_Series(obj), int(vtype))
...
func ta_ADL(env CGoHandle) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.ADL(ptrFromHandle_Ptr_banta_BarEnv(env))
...
func ta_SMA(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.SMA(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_CTI(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.CTI(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_Stiffness(obj CGoHandle, maLen C.longlong, stiffLen C.longlong, stiffMa C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.Stiffness(ptrFromHandle_Ptr_banta_Series(obj), int(maLen), int(stiffLen), int(stiffMa))
...
func ta_RSI(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.RSI(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_ChaikinOsc(env CGoHandle, sml C.longlong, big C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.ChaikinOsc(ptrFromHandle_Ptr_banta_BarEnv(env), int(sml), int(big))
...
func ta_LinRegAdv(obj CGoHandle, period C.longlong, angle C.char, intercept C.char, degrees C.char, r C.char, slope C.char, tsf C.char) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.LinRegAdv(ptrFromHandle_Ptr_banta_Series(obj), int(period), boolPyToGo(angle), boolPyToGo(intercept), boolPyToGo(degrees), boolPyToGo(r), boolPyToGo(slope), boolPyToGo(tsf))
...
func ta_ROC(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.ROC(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_ADX(high CGoHandle, low CGoHandle, close CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.ADX(ptrFromHandle_Ptr_banta_Series(high), ptrFromHandle_Ptr_banta_Series(low), ptrFromHandle_Ptr_banta_Series(close), int(period))
...
func ta_RMABy(obj CGoHandle, period C.longlong, initType C.longlong, initVal C.double) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.RMABy(ptrFromHandle_Ptr_banta_Series(obj), int(period), int(initType), float64(initVal))
...
func ta_AvgPrice(e CGoHandle) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.AvgPrice(ptrFromHandle_Ptr_banta_BarEnv(e))
...
func ta_CCI(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.CCI(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_Highest(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.Highest(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_WMA(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.WMA(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_PercentRank(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.PercentRank(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_ADXBy(high CGoHandle, low CGoHandle, close CGoHandle, period C.longlong, smoothing C.longlong, method C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.ADXBy(ptrFromHandle_Ptr_banta_Series(high), ptrFromHandle_Ptr_banta_Series(low), ptrFromHandle_Ptr_banta_Series(close), int(period), int(smoothing), int(method))
...
func ta_LinReg(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.LinReg(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_EMA(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.EMA(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_LowestBar(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.LowestBar(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_RMI(obj CGoHandle, period C.longlong, montLen C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.RMI(ptrFromHandle_Ptr_banta_Series(obj), int(period), int(montLen))
...
func ta_ALMA(obj CGoHandle, period C.longlong, sigma C.double, distOff C.double) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.ALMA(ptrFromHandle_Ptr_banta_Series(obj), int(period), float64(sigma), float64(distOff))
...
func ta_CRSIBy(obj CGoHandle, period C.longlong, upDn C.longlong, roc C.longlong, vtype C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.CRSIBy(ptrFromHandle_Ptr_banta_Series(obj), int(period), int(upDn), int(roc), int(vtype))
...
func ta_DV2(h CGoHandle, l CGoHandle, c CGoHandle, period C.longlong, maLen C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.DV2(ptrFromHandle_Ptr_banta_Series(h), ptrFromHandle_Ptr_banta_Series(l), ptrFromHandle_Ptr_banta_Series(c), int(period), int(maLen))
...
func ta_StdDev(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.StdDev(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_UTBot(c CGoHandle, atr CGoHandle, rate C.double) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.UTBot(ptrFromHandle_Ptr_banta_Series(c), ptrFromHandle_Ptr_banta_Series(atr), float64(rate))
...
func ta_CMO(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.CMO(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_MFI(e CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.MFI(ptrFromHandle_Ptr_banta_BarEnv(e), int(period))
...
func ta_HighestBar(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.HighestBar(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_RMA(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.RMA(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_RSI50(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.RSI50(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_ATR(high CGoHandle, low CGoHandle, close CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.ATR(ptrFromHandle_Ptr_banta_Series(high), ptrFromHandle_Ptr_banta_Series(low), ptrFromHandle_Ptr_banta_Series(close), int(period))
...
func ta_CHOP(e CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.CHOP(ptrFromHandle_Ptr_banta_BarEnv(e), int(period))
...
func ta_CMF(env CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.CMF(ptrFromHandle_Ptr_banta_BarEnv(env), int(period))
...
func ta_HMA(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.HMA(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_AvgDev(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.AvgDev(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_CMOBy(obj CGoHandle, period C.longlong, maType C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.CMOBy(ptrFromHandle_Ptr_banta_Series(obj), int(period), int(maType))
...
func ta_EMABy(obj CGoHandle, period C.longlong, initType C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.EMABy(ptrFromHandle_Ptr_banta_Series(obj), int(period), int(initType))
...
func ta_Stoch(high CGoHandle, low CGoHandle, close CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.Stoch(ptrFromHandle_Ptr_banta_Series(high), ptrFromHandle_Ptr_banta_Series(low), ptrFromHandle_Ptr_banta_Series(close), int(period))
...
func ta_WillR(e CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.WillR(ptrFromHandle_Ptr_banta_BarEnv(e), int(period))
...
func ta_Sum(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.Sum(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_TD(obj CGoHandle) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.TD(ptrFromHandle_Ptr_banta_Series(obj))
...
func ta_TR(high CGoHandle, low CGoHandle, close CGoHandle) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.TR(ptrFromHandle_Ptr_banta_Series(high), ptrFromHandle_Ptr_banta_Series(low), ptrFromHandle_Ptr_banta_Series(close))
...
func ta_CRSI(obj CGoHandle, period C.longlong, upDn C.longlong, roc C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.CRSI(ptrFromHandle_Ptr_banta_Series(obj), int(period), int(upDn), int(roc))
...
func ta_HLC3(h CGoHandle, l CGoHandle, c CGoHandle) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.HLC3(ptrFromHandle_Ptr_banta_Series(h), ptrFromHandle_Ptr_banta_Series(l), ptrFromHandle_Ptr_banta_Series(c))
...
func ta_STC(obj CGoHandle, period C.longlong, fast C.longlong, slow C.longlong, alpha C.double) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.STC(ptrFromHandle_Ptr_banta_Series(obj), int(period), int(fast), int(slow), float64(alpha))
...
func ta_KAMABy(obj CGoHandle, period C.longlong, fast C.longlong, slow C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.KAMABy(ptrFromHandle_Ptr_banta_Series(obj), int(period), int(fast), int(slow))
...
func ta_Lowest(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.Lowest(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_VWMA(price CGoHandle, vol CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.VWMA(ptrFromHandle_Ptr_banta_Series(price), ptrFromHandle_Ptr_banta_Series(vol), int(period))
...
func ta_ER(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.ER(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_KAMA(obj CGoHandle, period C.longlong) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := ta.KAMA(ptrFromHandle_Ptr_banta_Series(obj), int(period))
...
func ta_KDJ(high CGoHandle, low CGoHandle, close CGoHandle, period C.longlong, sm1 C.longlong, sm2 C.longlong) CGoHandle {
	...
	return handleFromPtr_Array_3_banta_Series(&cret)
}
...
func ta_MACD(obj CGoHandle, fast C.longlong, slow C.longlong, smooth C.longlong) CGoHandle {
	...
	return handleFromPtr_Array_2_banta_Series(&cret)
}
...
func ta_HeikinAshi(e CGoHandle) CGoHandle {
	...
	return handleFromPtr_Array_4_banta_Series(&cret)
}
