...
gopy build -no-make -dynamic-link=True -output build/lib.linux-aarch64-cpython-310/bbta -name bbta -vm /opt/python/cp310-cp310/bin/python github.com/banbox/banta/python/ta github.com/banbox/banta/python/tav
*/
