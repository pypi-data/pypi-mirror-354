...
gopy build -no-make -dynamic-link=True -output build/lib.linux-x86_64-cpython-313/bbta -name bbta -vm /opt/python/cp313-cp313/bin/python github.com/banbox/banta/python/ta github.com/banbox/banta/python/tav
*/
