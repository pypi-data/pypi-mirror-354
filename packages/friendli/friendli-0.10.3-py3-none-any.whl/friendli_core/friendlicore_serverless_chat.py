...
class BaseFriendliCoreServerlessChat(BaseSDK):
    pass


class SyncFriendliCoreServerlessChat(BaseFriendliCoreServerlessChat, SyncSDK):
    def complete(
        self,
        *,
...
class AsyncFriendliCoreServerlessChat(BaseFriendliCoreServerlessChat, AsyncSDK):
    async def complete(
        self,
        *,
        messages: Union[List[models.Message], List[models.MessageTypedDict]],
