...
class DedicatedUpdateEndpointBetaRequestTypedDict(TypedDict):
    endpoint_id: str
    r"""The ID of the endpoint"""
    dedicated_endpoint_update_body: DedicatedEndpointUpdateBodyTypedDict
    x_friendli_team: NotRequired[Nullable[str]]
    r"""ID of team to run requests as (optional parameter)."""


class DedicatedUpdateEndpointBetaRequest(BaseModel):
    endpoint_id: Annotated[
        str, FieldMetadata(path=PathParamMetadata(style="simple", explode=False))
    ]
    r"""The ID of the endpoint"""

    dedicated_endpoint_update_body: Annotated[
        DedicatedEndpointUpdateBody,
