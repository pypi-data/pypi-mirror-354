...
class DedicatedCreateEndpointBetaRequestTypedDict(TypedDict):
    dedicated_endpoint_create_body: DedicatedEndpointCreateBodyTypedDict
    x_friendli_team: NotRequired[Nullable[str]]
    r"""ID of team to run requests as (optional parameter)."""


class DedicatedCreateEndpointBetaRequest(BaseModel):
    dedicated_endpoint_create_body: Annotated[
        DedicatedEndpointCreateBody,
