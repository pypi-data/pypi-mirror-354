...
from friendli_core.utils import FieldMetadata, HeaderMetadata, QueryParamMetadata


class DedicatedListEndpointsBetaRequestTypedDict(TypedDict):
    project_id: NotRequired[Nullable[str]]
    r"""The ID of the project. If omitted, query all endpoints under the team."""
...
class DedicatedListEndpointsBetaRequest(BaseModel):
