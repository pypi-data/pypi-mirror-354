...
### [dataset](https://github.com/friendliai/friendli-python/blob/master/docs/sdks/dataset/README.md)
...
* [create_beta](https://github.com/friendliai/friendli-python/blob/master/docs/sdks/endpoint/README.md#create_beta) - Create a new endpoint (Beta)
* [list_beta](https://github.com/friendliai/friendli-python/blob/master/docs/sdks/endpoint/README.md#list_beta) - List all endpoints (Beta)
* [get_spec_beta](https://github.com/friendliai/friendli-python/blob/master/docs/sdks/endpoint/README.md#get_spec_beta) - Get endpoint specification (Beta)
* [update_beta](https://github.com/friendliai/friendli-python/blob/master/docs/sdks/endpoint/README.md#update_beta) - Update endpoint spec (Beta)
* [get_status_beta](https://github.com/friendliai/friendli-python/blob/master/docs/sdks/endpoint/README.md#get_status_beta) - Get endpoint status (Beta)
* [terminate_beta](https://github.com/friendliai/friendli-python/blob/master/docs/sdks/endpoint/README.md#terminate_beta) - Terminate endpoint (Beta)
* [restart_beta](https://github.com/friendliai/friendli-python/blob/master/docs/sdks/endpoint/README.md#restart_beta) - Restart endpoint (Beta)
