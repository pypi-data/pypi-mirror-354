...
CompletionsDedicatedBodyWithTokensSeedTypedDict = TypeAliasType(
    "CompletionsDedicatedBodyWithTokensSeedTypedDict", Union[List[int], int]
)
...
CompletionsDedicatedBodyWithTokensSeed = TypeAliasType(
    "CompletionsDedicatedBodyWithTokensSeed", Union[List[int], int]
)
r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""


class CompletionsDedicatedBodyWithTokensTypedDict(TypedDict):
    model: str
    ...
    **This field is unsupported when `response_format` is specified.**
    ...
    seed: NotRequired[Nullable[CompletionsDedicatedBodyWithTokensSeedTypedDict]]
    r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""
...
class CompletionsDedicatedBodyWithTokens(BaseModel):
    model: str
    r"""ID of target endpoint. If you want to send request to specific adapter, use the format \"YOUR_ENDPOINT_ID:YOUR_ADAPTER_ROUTE\". Otherwise, you can just use \"YOUR_ENDPOINT_ID\" alone."""
    ...
    **This field is unsupported when `response_format` is specified.**
    ...
    seed: OptionalNullable[CompletionsDedicatedBodyWithTokensSeed] = UNSET
    r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""
