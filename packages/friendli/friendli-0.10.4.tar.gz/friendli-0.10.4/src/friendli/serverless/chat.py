...
class SyncChat:
    ...
    def complete(
        ...
        *,
        ...
        """
        return self._core.serverless.chat.complete(
            messages=messages,
            model=model,
    ...
    def stream(
        ...
        *,
        ...
        :param http_headers: Additional headers to set or replace on requests.
        """
        return self._core.serverless.chat.stream(
            messages=messages,
            model=model,
            x_friendli_team=x_friendli_team,
            eos_token=eos_token,
...
class AsyncChat:
    ...
    async def complete(
        ...
        *,
        ...
        :param http_headers: Additional headers to set or replace on requests.
        """
        return await self._core.serverless.chat.complete(
            messages=messages,
            model=model,
            x_friendli_team=x_friendli_team,
            eos_token=eos_token,
    ...
    async def stream(
        ...
        *,
        ...
        :param http_headers: Additional headers to set or replace on requests.
        """
        return await self._core.serverless.chat.stream(
            messages=messages,
            model=model,
            x_friendli_team=x_friendli_team,
            eos_token=eos_token,
