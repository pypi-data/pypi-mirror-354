...
CompletionsStreamServerlessBodyWithPromptPromptTypedDict = TypeAliasType(
    "CompletionsStreamServerlessBodyWithPromptPromptTypedDict", Union[str, List[str]]
)
r"""The prompt (i.e., input text) to generate completions for. Either `prompt` or `tokens` field is required."""


CompletionsStreamServerlessBodyWithPromptPrompt = TypeAliasType(
    "CompletionsStreamServerlessBodyWithPromptPrompt", Union[str, List[str]]
)
r"""The prompt (i.e., input text) to generate completions for. Either `prompt` or `tokens` field is required."""


CompletionsStreamServerlessBodyWithPromptSeedTypedDict = TypeAliasType(
    "CompletionsStreamServerlessBodyWithPromptSeedTypedDict", Union[List[int], int]
)
...
CompletionsStreamServerlessBodyWithPromptSeed = TypeAliasType(
    "CompletionsStreamServerlessBodyWithPromptSeed", Union[List[int], int]
)
r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""


class CompletionsStreamServerlessBodyWithPromptTypedDict(TypedDict):
    model: str
    ...
    prompt: CompletionsStreamServerlessBodyWithPromptPromptTypedDict
    r"""The prompt (i.e., input text) to generate completions for. Either `prompt` or `tokens` field is required."""
    ...
    **This field is unsupported when `response_format` is specified.**
    ...
    seed: NotRequired[Nullable[CompletionsStreamServerlessBodyWithPromptSeedTypedDict]]
    r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""
...
class CompletionsStreamServerlessBodyWithPrompt(BaseModel):
    model: str
    r"""Code of the model to use. See [available model list](https://friendli.ai/docs/guides/serverless_endpoints/pricing#text-generation-models)."""

    prompt: CompletionsStreamServerlessBodyWithPromptPrompt
    r"""The prompt (i.e., input text) to generate completions for. Either `prompt` or `tokens` field is required."""
    ...
    **This field is unsupported when `response_format` is specified.**
    ...
    seed: OptionalNullable[CompletionsStreamServerlessBodyWithPromptSeed] = UNSET
    r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""
