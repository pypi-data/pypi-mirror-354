...
class _MaterPreProcess:
    ...
    def input_formatting(self, input: pd.DataFrame):
        ...
        # # If duplicates but should not be
        # formatted_input = formatted_input[~formatted_input.index.duplicated(keep="first")]
        # Interpolation
        df2 = pd.DataFrame(
            data=np.nan,
    ...
    def infinite_geometric_series(self, A: np.ndarray):
        """
