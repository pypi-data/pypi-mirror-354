...
def launch(
    ...
    claude_command: str = typer.Option("claude chat", "--claude-command", help="Command to run Claude"),
...
def check_claude_installed(claude_command: str, verbose: bool = False) -> None:
    ...
    """
    # Extract the base command (e.g., "claude" from "claude chat")
...
Run in another terminal: [cyan]claude chat[/cyan]
"""
    else:
        message = f"""
