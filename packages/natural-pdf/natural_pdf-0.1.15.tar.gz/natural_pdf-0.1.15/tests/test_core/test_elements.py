...
def test_find_horizontal_lines(atlanta_pdf):
    ...
    for line in horizontal_lines:
        ...
        assert abs(line.bbox[1] - line.bbox[3]) < 1, "Horizontal line should have similar y coordinates"
        # Check that x coordinates differ (has width)
        assert abs(line.bbox[0] - line.bbox[2]) > 1, "Horizontal line should have different x coordinates"
...
def test_find_vertical_lines(atlanta_pdf):
    ...
    for line in vertical_lines:
        ...
        assert abs(line.bbox[0] - line.bbox[2]) < 1, "Vertical line should have similar x coordinates"
