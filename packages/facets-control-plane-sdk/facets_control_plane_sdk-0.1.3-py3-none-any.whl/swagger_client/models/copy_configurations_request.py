...
class CopyConfigurationsRequest(object):
    ...
    def selection_mode(self):
        """Gets the selection_mode of this CopyConfigurationsRequest.  # noqa: E501


        :return: The selection_mode of this CopyConfigurationsRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def selection_mode(self, selection_mode):
        """Sets the selection_mode of this CopyConfigurationsRequest.


        :param selection_mode: The selection_mode of this CopyConfigurationsRequest.  # noqa: E501
        :type: str
        """
        allowed_values = ["INCLUDE", "EXCLUDE"]  # noqa: E501
        if selection_mode not in allowed_values:
            raise ValueError(
                "Invalid value for `selection_mode` ({0}), must be one of {1}"  # noqa: E501
                .format(selection_mode, allowed_values)
            )
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CopyConfigurationsRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CopyConfigurationsRequest):
            return False
