...
class ChatStarterMetadata(object):
    ...
    @property
    def starter(self):
        """Gets the starter of this ChatStarterMetadata.  # noqa: E501


        :return: The starter of this ChatStarterMetadata.  # noqa: E501
        :rtype: str
        """
    ...
    def starter(self, starter):
        """Sets the starter of this ChatStarterMetadata.


        :param starter: The starter of this ChatStarterMetadata.  # noqa: E501
        :type: str
        """
        allowed_values = ["ALERTS"]  # noqa: E501
        if starter not in allowed_values:
            raise ValueError(
                "Invalid value for `starter` ({0}), must be one of {1}"  # noqa: E501
                .format(starter, allowed_values)
            )
    ...
    @property
    def title(self):
        """Gets the title of this ChatStarterMetadata.  # noqa: E501


        :return: The title of this ChatStarterMetadata.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this ChatStarterMetadata.


        :param title: The title of this ChatStarterMetadata.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ChatStarterMetadata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChatStarterMetadata):
            return False
