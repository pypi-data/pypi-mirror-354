...
class GroupedCountDto(object):
    ...
    @property
    def total(self):
        """Gets the total of this GroupedCountDto.  # noqa: E501


        :return: The total of this GroupedCountDto.  # noqa: E501
        :rtype: int
        """
        return self._total
    ...
    def total(self, total):
        """Sets the total of this GroupedCountDto.


        :param total: The total of this GroupedCountDto.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GroupedCountDto, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GroupedCountDto):
            return False
