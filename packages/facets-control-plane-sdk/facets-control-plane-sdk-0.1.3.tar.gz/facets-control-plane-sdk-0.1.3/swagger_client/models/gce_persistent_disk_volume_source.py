...
class GCEPersistentDiskVolumeSource(object):
    ...
    def __init__(self, fs_type=None, partition=None, pd_name=None, read_only=None):  # noqa: E501
        """GCEPersistentDiskVolumeSource - a model defined in Swagger"""  # noqa: E501
        self._fs_type = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GCEPersistentDiskVolumeSource, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GCEPersistentDiskVolumeSource):
            return False
