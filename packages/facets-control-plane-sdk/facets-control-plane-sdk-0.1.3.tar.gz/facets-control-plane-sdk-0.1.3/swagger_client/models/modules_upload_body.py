...
class ModulesUploadBody(object):
    ...
    def __init__(self, file=None, metadata=None):  # noqa: E501
        """ModulesUploadBody - a model defined in Swagger"""  # noqa: E501
        self._file = None
        self._metadata = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ModulesUploadBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModulesUploadBody):
            return False
