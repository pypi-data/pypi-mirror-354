...
class TokenPaginatedResponse(object):
    ...
    @property
    def next_token(self):
        """Gets the next_token of this TokenPaginatedResponse.  # noqa: E501


        :return: The next_token of this TokenPaginatedResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def next_token(self, next_token):
        """Sets the next_token of this TokenPaginatedResponse.


        :param next_token: The next_token of this TokenPaginatedResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TokenPaginatedResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TokenPaginatedResponse):
            return False
