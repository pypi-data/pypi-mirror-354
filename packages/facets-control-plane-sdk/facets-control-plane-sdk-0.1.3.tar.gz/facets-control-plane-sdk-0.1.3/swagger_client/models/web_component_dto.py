...
class WebComponentDTO(object):
    ...
    def __init__(self, contextual_attributes=None, enabled=None, icon_url=None, id=None, last_modified_by=None, last_modified_date=None, name=None, order=None, remote_url=None, tooltip=None, type=None):  # noqa: E501
