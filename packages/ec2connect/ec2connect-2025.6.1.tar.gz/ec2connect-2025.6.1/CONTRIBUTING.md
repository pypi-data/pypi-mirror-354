...
Welcome to `ec2connect` contributor's guide.
...
If you experience bugs or general issues with `ec2connect`, please have a look
...
You can help improve `ec2connect` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ec2connect` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `ec2connect`'s files. While this mechanism can
...
```
conda create -n ec2connect python=3 six virtualenv pytest pytest-cov
conda activate ec2connect
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ec2connect.git
   cd ec2connect
   ```
...
5. Install [pre-commit]:
   ...
   `ec2connect` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ec2connect
[issue tracker]: https://github.com/<USERNAME>/ec2connect/issues
