...
class DSWorkflowTransformationExpressionTypesToLowerExpression(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        """DSWorkflowTransformationExpressionTypesToLowerExpression - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DSWorkflowTransformationExpressionTypesToLowerExpression, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DSWorkflowTransformationExpressionTypesToLowerExpression):
            return False
