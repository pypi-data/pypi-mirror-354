                    ...
                    if self.neo4j_client:
                        try:
                            if node_dict["type"] == "Module":
                                ...
                                # to create the node using the Neo4j client
                                from aston.knowledge.schema.nodes import ImplementationNode
            ...
            for chunk in chunks:
                try:
                    ...
                    if chunk.chunk_id in chunk_node_map and chunk.parent_chunk_id in chunk_node_map:
                        ...
                        if self.neo4j_client:
                            try:
                                from aston.knowledge.schema.relationships import ContainsRelationship
                        ...
                        try:
                            ...
                            if dep_name in dependency_map:
                                ...
                                if self.neo4j_client:
                                    try:
                                        if rel_type == "CALLS":
                                            from aston.knowledge.schema.relationships import CallsRelationship
                                            ...
                                            from aston.knowledge.schema.relationships import InheritsFromRelationship
                    ...
                    for import_stmt in chunk.imports:
                        try:
                            ...
                            if module_name in module_map:
                                ...
                                if self.neo4j_client:
                                    try:
                                        from aston.knowledge.schema.relationships import ImportsRelationship
