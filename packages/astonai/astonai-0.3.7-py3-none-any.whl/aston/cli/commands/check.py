...
@click.option('--coverage', is_flag=True, help='Check dependencies for coverage command')
@click.option('--init', is_flag=True, help='Check dependencies for init command')
@common_options
def check_command(test, coverage, init, **kwargs):
