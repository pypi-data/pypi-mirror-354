...
without an editor widget:
  ...
  >>> import p01.editor
  >>> XSS = p01.editor.escape('<script>alert("evil");</script>')
  >>> evil = '<html>%s</html>' % XSS
  >>> bad = p01.editor.escape(evil)
  >>> print(bad)
  &lt;html&gt;&amp;lt;script&amp;gt;alert("evil");&amp;lt;/script&amp;gt;&lt;/html&gt;

As you can see, if we unescape our evil content, we don't unescape the double
escaped part:

  >>> from xml.sax import saxutils
  >>> print(saxutils.unescape(bad))
  <html>&lt;script&gt;alert("evil");&lt;/script&gt;</html>
