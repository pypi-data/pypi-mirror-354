...
def _create_valid_git_patch(hunks: List[Hunk], base_diff: str) -> str:
    ...
    # CRITICAL FIX: Validate patch format before returning
    if patch_content and not _validate_patch_format(patch_content):
        print("Warning: Generated patch appears to be malformed")
