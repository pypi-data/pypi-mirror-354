...
import pdftools_sdk.image.page
...
class PageList(_NativeObject, list):
    ...
    def __len__(self) -> int:
        ...
        ret_val = _lib.PdfToolsImage_PageList_GetCount(self._handle)
        if ret_val == -1:
    ...
    def extend(self, items: PageList) -> None:
        ...
        raise NotImplementedError("Extend method is not supported in PageList.")
    ...
    def copy(self) -> PageList:
        raise NotImplementedError("Copy method is not supported in PageList.")
    ...
    def __getitem__(self, index: Union[int, slice]) -> Union[Any, List[Any]]:
        ...
        ret_val = _lib.PdfToolsImage_PageList_Get(self._handle, index)
        if ret_val is None:
    ...
    def append(self, value: Page) -> None:
        raise NotImplementedError("Append method is not supported in PageList.")
