    ...
    def convert_document(self, in_doc: PdfDocument, out_stream: io.IOBase, profile: Profile) -> MultiPageDocument:
        ...
        Args:
            ...
            profile (Profile): 
                ...
                For other profiles, the method `pdftools_sdk.pdf2_image.converter.Converter.convert_page` should be used.
                 
                For details, see `pdftools_sdk.pdf2_image.profiles.profile.Profile`.
    ...
    def convert_page(self, in_doc: PdfDocument, out_stream: io.IOBase, profile: Profile, page_number: int) -> ImageDocument:
        ...
        Args:
            ...
            pageNumber (int): 
                ...
                The number must be in the range of `1` (first page) to `pdftools_sdk.pdf.document.Document.page_count` (last page).
