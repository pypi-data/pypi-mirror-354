...
class ContentOptions(_NativeObject):
    ...
    def annotations(self) -> AnnotationOptions:
        ...
        For details, see `pdftools_sdk.pdf2_image.annotation_options.AnnotationOptions`.
         
        Default: `pdftools_sdk.pdf2_image.annotation_options.AnnotationOptions.SHOWANNOTATIONS`
