...
class HttpClientHandler(_NativeObject):
    ...
    def __init__(self):
        """
        The default values of newly created objects are not copied from the default handler `pdftools_sdk.sdk.Sdk.http_client_handler`,
    ...
    def add_trusted_certificate(self, cert: io.IOBase) -> None:
        ...
        The certificates in the trust store are used to verify the certificate of the SSL/TLS server (see `pdftools_sdk.http_client_handler.HttpClientHandler`).
