...
class SignatureFieldOptions(_NativeObject):
    ...
    These options control the creation of unsigned signature fields in `pdftools_sdk.sign.signer.Signer.add_signature_field`.
    ...
    def bounding_box(self) -> Appearance:
        ...
        Use `pdftools_sdk.sign.appearance.Appearance.create_field_bounding_box` to create the bounding box object.
