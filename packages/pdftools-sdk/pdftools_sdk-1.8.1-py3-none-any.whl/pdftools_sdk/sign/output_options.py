...
class OutputOptions(pdftools_sdk.pdf.output_options.OutputOptions):
    ...
    These options are available for all signature operations of the `pdftools_sdk.sign.signer.Signer`.
    They can also be used without a signature operation with the method `pdftools_sdk.sign.signer.Signer.process`.
     
    Notes on document encryption when processing files with the `pdftools_sdk.sign.signer.Signer`:
        - PDF/A conformance is removed from input files.
    In this case, a `pdftools_sdk.sign.signer.Signer.Warning` with an `pdftools_sdk.sign.warning_category.WarningCategory.PDFAREMOVED` is generated.
        - Signed documents cannot be encrypted or decrypted.
    In this case, a `pdftools_sdk.sign.signer.Signer.Warning` with an `pdftools_sdk.sign.warning_category.WarningCategory.SIGNEDDOCENCRYPTIONUNCHANGED` is generated.
    ...
    def remove_signatures(self) -> SignatureRemoval:
        ...
        Default: `pdftools_sdk.sign.signature_removal.SignatureRemoval.NONE`
    ...
    def add_validation_information(self) -> AddValidationInformation:
        ...
        For more details on validation information, see also `pdftools_sdk.crypto.validation_information.ValidationInformation`.
         
        Validation information for embedded time-stamp tokens is added as well.
         
        If adding validation information fails, an `pdftools_sdk.sign.signer.Signer.Warning` with an
        `pdftools_sdk.sign.warning_category.WarningCategory.ADDVALIDATIONINFORMATIONFAILED` is generated.
        ...
        *Note:*
        ...
        Default: `pdftools_sdk.sign.add_validation_information.AddValidationInformation.NONE`
