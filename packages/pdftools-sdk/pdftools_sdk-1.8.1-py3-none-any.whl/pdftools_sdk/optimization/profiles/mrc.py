...
class Mrc(pdftools_sdk.optimization.profiles.profile.Profile):
    ...
    def layer_compression_quality(self) -> float:
        ...
        Default:
            - `pdftools_sdk.optimization.compression_algorithm_selection.CompressionAlgorithmSelection.PRESERVEQUALITY` algorithm: `1`.
            - `pdftools_sdk.optimization.compression_algorithm_selection.CompressionAlgorithmSelection.BALANCED` algorithm: `0.25`.
            - `pdftools_sdk.optimization.compression_algorithm_selection.CompressionAlgorithmSelection.SPEED` algorithm: `0.25`.
