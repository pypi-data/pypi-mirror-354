...
class RemovalOptions(_NativeObject):
    ...
    (see property `pdftools_sdk.optimization.removal_options.RemovalOptions.remove_signature_appearances`).
    ...
    def remove_alternate_images(self) -> bool:
        ...
        Default: `False` except in the profile `pdftools_sdk.optimization.profiles.print.Print`.
    ...
    def remove_article_threads(self) -> bool:
        ...
        Default: `True` except in the profile `pdftools_sdk.optimization.profiles.archive.Archive`.
    ...
    def remove_metadata(self) -> bool:
        ...
        Default:
            ...
            - `pdftools_sdk.optimization.profiles.print.Print` profile: `False`
            - `pdftools_sdk.optimization.profiles.archive.Archive` profile: `False`
    ...
    def remove_output_intents(self) -> bool:
        ...
        Default: `False` except in the profile `pdftools_sdk.optimization.profiles.minimal_file_size.MinimalFileSize`.
    ...
    def remove_signature_appearances(self) -> RemovalStrategy:
        ...
        (a) is broken and must be removed.
            ...
            - `pdftools_sdk.optimization.removal_strategy.RemovalStrategy.FLATTEN`: (a) is removed and (b) is drawn as non-editable graphic onto the page.
        Within the context of signatures this is called "flattening".
            - `pdftools_sdk.optimization.removal_strategy.RemovalStrategy.REMOVE`: (a) and (b) are removed.
         
        Default: `pdftools_sdk.optimization.removal_strategy.RemovalStrategy.FLATTEN` in all profiles.
    ...
    def annotations(self) -> ConversionStrategy:
        ...
        Note that this does not include form fields (see `pdftools_sdk.optimization.removal_options.RemovalOptions.form_fields`) and links (see `pdftools_sdk.optimization.removal_options.RemovalOptions.links`).
         
        Default: `pdftools_sdk.optimization.conversion_strategy.ConversionStrategy.COPY` in all profiles.
