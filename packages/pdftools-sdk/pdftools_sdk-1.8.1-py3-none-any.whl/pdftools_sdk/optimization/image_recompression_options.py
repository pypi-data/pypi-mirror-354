...
class ImageRecompressionOptions(_NativeObject):
    ...
    def algorithm_selection(self) -> CompressionAlgorithmSelection:
        ...
        type of the optimizer profile (e.g. `pdftools_sdk.optimization.profiles.web.Web`),
        the color space of the image, and `pdftools_sdk.optimization.image_recompression_options.ImageRecompressionOptions.compression_quality`.
        The image is recompressed using the algorithm resulting in the
        smallest output file.
         
        Refer to `pdftools_sdk.optimization.compression_algorithm_selection.CompressionAlgorithmSelection` for
        more information on strategies.
         
        Default:
            - `pdftools_sdk.optimization.profiles.web.Web` profile: `pdftools_sdk.optimization.compression_algorithm_selection.CompressionAlgorithmSelection.BALANCED`
            - `pdftools_sdk.optimization.profiles.print.Print` profile: `pdftools_sdk.optimization.compression_algorithm_selection.CompressionAlgorithmSelection.PRESERVEQUALITY`
            - `pdftools_sdk.optimization.profiles.archive.Archive` profile: `pdftools_sdk.optimization.compression_algorithm_selection.CompressionAlgorithmSelection.PRESERVEQUALITY`
            - `pdftools_sdk.optimization.profiles.minimal_file_size.MinimalFileSize` profile: `pdftools_sdk.optimization.compression_algorithm_selection.CompressionAlgorithmSelection.BALANCED`
            - `pdftools_sdk.optimization.profiles.mrc.Mrc` profile: `pdftools_sdk.optimization.compression_algorithm_selection.CompressionAlgorithmSelection.BALANCED`
    ...
    def algorithm_selection(self, val: CompressionAlgorithmSelection) -> None:
        ...
        Args:
            val (CompressionAlgorithmSelection):
                property value
    ...
    def compression_quality(self) -> float:
        ...
        Default:
            - `pdftools_sdk.optimization.profiles.web.Web` profile: 0.8
            - `pdftools_sdk.optimization.profiles.print.Print` profile: 0.9
            - `pdftools_sdk.optimization.profiles.archive.Archive` profile: 0.9
            - `pdftools_sdk.optimization.profiles.minimal_file_size.MinimalFileSize` profile: 0.75
            - `pdftools_sdk.optimization.profiles.mrc.Mrc` profile: 0.75
    ...
    def reduce_color_complexity(self) -> bool:
        ...
        Default:
            - `pdftools_sdk.optimization.profiles.web.Web` profile: `True`
            - `pdftools_sdk.optimization.profiles.print.Print` profile: `True`
            - `pdftools_sdk.optimization.profiles.archive.Archive` profile: `True`
            - `pdftools_sdk.optimization.profiles.minimal_file_size.MinimalFileSize` profile: `True`
            - `pdftools_sdk.optimization.profiles.mrc.Mrc` profile: `False`
