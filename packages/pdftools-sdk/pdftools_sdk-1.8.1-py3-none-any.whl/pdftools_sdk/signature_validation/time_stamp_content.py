...
class TimeStampContent(pdftools_sdk.signature_validation.signature_content.SignatureContent):
    """
    ...
    def validation_time(self) -> datetime:
        ...
        _lib.PdfToolsSignatureValidation_TimeStampContent_GetValidationTime.argtypes = [c_void_p, POINTER(_Date)]
        _lib.PdfToolsSignatureValidation_TimeStampContent_GetValidationTime.restype = c_bool
        ret_val = _Date()
        if not _lib.PdfToolsSignatureValidation_TimeStampContent_GetValidationTime(self._handle, byref(ret_val)):
    ...
    def validation_time_source(self) -> TimeSource:
        ...
        ret_val = _lib.PdfToolsSignatureValidation_TimeStampContent_GetValidationTimeSource(self._handle)
        if ret_val == 0:
    ...
    def hash_algorithm(self) -> HashAlgorithm:
        ...
        ret_val = _lib.PdfToolsSignatureValidation_TimeStampContent_GetHashAlgorithm(self._handle)
        if ret_val == 0:
            _NativeBase._throw_last_error()
    ...
    def date(self) -> datetime:
        ...
        _lib.PdfToolsSignatureValidation_TimeStampContent_GetDate.argtypes = [c_void_p, POINTER(_Date)]
        _lib.PdfToolsSignatureValidation_TimeStampContent_GetDate.restype = c_bool
        ret_val = _Date()
        if not _lib.PdfToolsSignatureValidation_TimeStampContent_GetDate(self._handle, byref(ret_val)):
            _NativeBase._throw_last_error(False)
        return ret_val._to_datetime()
    ...
    def signing_certificate(self) -> Optional[Certificate]:
        ...
        ret_val = _lib.PdfToolsSignatureValidation_TimeStampContent_GetSigningCertificate(self._handle)
        if ret_val is None:
            _NativeBase._throw_last_error()
            return None
    ...
    def certificate_chain(self) -> Optional[CertificateChain]:
        ...
        ret_val = _lib.PdfToolsSignatureValidation_TimeStampContent_GetCertificateChain(self._handle)
        if ret_val is None:
            _NativeBase._throw_last_error()
            return None
    ...
    def _from_handle(cls, handle):
        ...
        """
        instance = TimeStampContent.__new__(cls)  # Bypass __init__
