...
class CustomTrustList(_NativeObject):
    ...
    They define the certificates used for `pdftools_sdk.signature_validation.data_source.DataSource.CUSTOMTRUSTLIST` and can be set in the validation profile with `pdftools_sdk.signature_validation.profiles.profile.Profile.custom_trust_list`.
