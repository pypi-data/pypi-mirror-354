...
class SignaturePaddingType(IntEnum):
    ...
    Attributes:
        DEFAULT (int):
            ...
            Used for the `pdftools_sdk.crypto.signature_algorithm.SignatureAlgorithm.ECDSA` signature algorithm.

        RSA_RSA (int):
            Padding scheme for RSA keys that corresponds to the `pdftools_sdk.crypto.signature_algorithm.SignatureAlgorithm.RSARSA` signature algorithm.

        RSA_SSA_PSS (int):
            Padding scheme for RSA keys that corresponds to the `pdftools_sdk.crypto.signature_algorithm.SignatureAlgorithm.RSASSAPSS` signature algorithm.
