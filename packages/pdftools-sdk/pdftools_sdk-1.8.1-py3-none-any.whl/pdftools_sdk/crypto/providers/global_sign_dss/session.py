...
class Session(pdftools_sdk.crypto.providers.provider.Provider):
    ...
    When signing with this provider, these errors can occur:
        - `pdftools_sdk.permission_error.PermissionError`: If the account's quota is reached.
         
        - `pdftools_sdk.retry_error.RetryError`: If one of the account's rate limits is exceeded.
    ...
    def __init__(self, url: str, api_key: str, api_secret: str, http_client_handler: HttpClientHandler):
        ...
        Args:
            ...
            httpClientHandler (HttpClientHandler): 
                ...
                Use `pdftools_sdk.http_client_handler.HttpClientHandler.set_client_certificate_and_key` to set your SSL client certificate "clientcert.crt"
