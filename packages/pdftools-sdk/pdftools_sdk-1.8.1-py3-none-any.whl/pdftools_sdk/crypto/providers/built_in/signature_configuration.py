...
class SignatureConfiguration(pdftools_sdk.sign.signature_configuration.SignatureConfiguration):
    ...
    def hash_algorithm(self) -> HashAlgorithm:
        ...
        Default: `pdftools_sdk.crypto.hash_algorithm.HashAlgorithm.SHA256`
        ...
        ret_val = _lib.PdfToolsCryptoProvidersBuiltIn_SignatureConfiguration_GetHashAlgorithm(self._handle)
        if ret_val == 0:
    ...
    def hash_algorithm(self, val: HashAlgorithm) -> None:
        ...
        if not _lib.PdfToolsCryptoProvidersBuiltIn_SignatureConfiguration_SetHashAlgorithm(self._handle, c_int(val.value)):
    ...
    def signature_padding_type(self) -> SignaturePaddingType:
        ...
        Default: `pdftools_sdk.crypto.signature_padding_type.SignaturePaddingType.RSASSAPSS` for RSA and for `pdftools_sdk.crypto.signature_padding_type.SignaturePaddingType.DEFAULT` ECDSA certificates.
        ...
        ret_val = _lib.PdfToolsCryptoProvidersBuiltIn_SignatureConfiguration_GetSignaturePaddingType(self._handle)
        if ret_val == 0:
            _NativeBase._throw_last_error()
    ...
    def signature_padding_type(self, val: SignaturePaddingType) -> None:
        ...
        if not _lib.PdfToolsCryptoProvidersBuiltIn_SignatureConfiguration_SetSignaturePaddingType(self._handle, c_int(val.value)):
            _NativeBase._throw_last_error(False)
    ...
    def signature_format(self) -> SignatureFormat:
        ...
        Default: `pdftools_sdk.crypto.signature_format.SignatureFormat.ETSICADESDETACHED`
        ...
        ret_val = _lib.PdfToolsCryptoProvidersBuiltIn_SignatureConfiguration_GetSignatureFormat(self._handle)
        if ret_val == 0:
            _NativeBase._throw_last_error()
    ...
    def signature_format(self, val: SignatureFormat) -> None:
        ...
        if not _lib.PdfToolsCryptoProvidersBuiltIn_SignatureConfiguration_SetSignatureFormat(self._handle, c_int(val.value)):
            _NativeBase._throw_last_error(False)
    ...
    def add_timestamp(self) -> bool:
        ...
        ret_val = _lib.PdfToolsCryptoProvidersBuiltIn_SignatureConfiguration_GetAddTimestamp(self._handle)
        if not ret_val:
            _NativeBase._throw_last_error()
        return ret_val
    ...
    def add_timestamp(self, val: bool) -> None:
        ...
        if not _lib.PdfToolsCryptoProvidersBuiltIn_SignatureConfiguration_SetAddTimestamp(self._handle, val):
            _NativeBase._throw_last_error(False)
    ...
    def validation_information(self) -> ValidationInformation:
        ...
        If downloading validation information fails, an error `pdftools_sdk.not_found_error.NotFoundError` or `pdftools_sdk.http_error.HttpError` is generated.
        See `pdftools_sdk.sign.warning_category.WarningCategory.ADDVALIDATIONINFORMATIONFAILED` for a description of possible error causes
        and solutions.
         
        Default: `pdftools_sdk.crypto.validation_information.ValidationInformation.EMBEDINDOCUMENT` if the signing certificate offers validation information and `pdftools_sdk.crypto.validation_information.ValidationInformation.NONE` otherwise
        ...
        ret_val = _lib.PdfToolsCryptoProvidersBuiltIn_SignatureConfiguration_GetValidationInformation(self._handle)
        if ret_val == 0:
            _NativeBase._throw_last_error()
    ...
    def validation_information(self, val: ValidationInformation) -> None:
        ...
        if not _lib.PdfToolsCryptoProvidersBuiltIn_SignatureConfiguration_SetValidationInformation(self._handle, c_int(val.value)):
            _NativeBase._throw_last_error(False)
