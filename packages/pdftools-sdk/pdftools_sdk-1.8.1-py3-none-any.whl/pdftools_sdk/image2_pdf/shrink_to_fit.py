...
class ShrinkToFit(pdftools_sdk.image2_pdf.image_mapping.ImageMapping):
    ...
    to fit onto `pdftools_sdk.image2_pdf.shrink_to_fit.ShrinkToFit.page_size`.
    ...
    def force_fit(self) -> bool:
        ...
        If an image is smaller than the specified `pdftools_sdk.image2_pdf.shrink_to_fit.ShrinkToFit.page_size`, it will be scaled up respecting
