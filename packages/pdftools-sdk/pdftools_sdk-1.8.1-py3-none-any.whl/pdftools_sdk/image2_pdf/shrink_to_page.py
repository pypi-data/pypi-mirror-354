...
class ShrinkToPage(pdftools_sdk.image2_pdf.image_mapping.ImageMapping):
    """
    ...
    def __init__(self):
        ...
        ret_val = _lib.PdfToolsImage2Pdf_ShrinkToPage_New()
        if ret_val is None:
    ...
    def page_size(self) -> Size:
        ...
        _lib.PdfToolsImage2Pdf_ShrinkToPage_GetPageSize.argtypes = [c_void_p, POINTER(Size)]
        _lib.PdfToolsImage2Pdf_ShrinkToPage_GetPageSize.restype = c_bool
        ret_val = Size()
        if not _lib.PdfToolsImage2Pdf_ShrinkToPage_GetPageSize(self._handle, byref(ret_val)):
            _NativeBase._throw_last_error(False)
        return ret_val
    ...
    def page_size(self, val: Size) -> None:
        ...
        _lib.PdfToolsImage2Pdf_ShrinkToPage_SetPageSize.argtypes = [c_void_p, POINTER(Size)]
        _lib.PdfToolsImage2Pdf_ShrinkToPage_SetPageSize.restype = c_bool
        if not _lib.PdfToolsImage2Pdf_ShrinkToPage_SetPageSize(self._handle, val):
            _NativeBase._throw_last_error(False)
    ...
    def page_margin(self) -> Margin:
        ...
        _lib.PdfToolsImage2Pdf_ShrinkToPage_GetPageMargin.argtypes = [c_void_p, POINTER(Margin)]
        _lib.PdfToolsImage2Pdf_ShrinkToPage_GetPageMargin.restype = c_bool
        ret_val = Margin()
        if not _lib.PdfToolsImage2Pdf_ShrinkToPage_GetPageMargin(self._handle, byref(ret_val)):
            _NativeBase._throw_last_error(False)
        return ret_val
    ...
    def page_margin(self, val: Margin) -> None:
        ...
        _lib.PdfToolsImage2Pdf_ShrinkToPage_SetPageMargin.argtypes = [c_void_p, POINTER(Margin)]
        _lib.PdfToolsImage2Pdf_ShrinkToPage_SetPageMargin.restype = c_bool
        if not _lib.PdfToolsImage2Pdf_ShrinkToPage_SetPageMargin(self._handle, val):
            _NativeBase._throw_last_error(False)
    ...
    def _from_handle(cls, handle):
        ...
        """
        instance = ShrinkToPage.__new__(cls)  # Bypass __init__
