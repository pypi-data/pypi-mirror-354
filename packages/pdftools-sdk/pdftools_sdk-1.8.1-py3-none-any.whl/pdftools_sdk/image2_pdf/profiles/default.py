...
class Default(pdftools_sdk.image2_pdf.profiles.profile.Profile):
    ...
    def conformance(self) -> Conformance:
        ...
        For PDF/A the `pdftools_sdk.image2_pdf.profiles.archive.Archive` profile must be used.
    ...
    def conformance(self, val: Conformance) -> None:
        ...
        Raises:
            ValueError:
                ...
                Use the profile `pdftools_sdk.image2_pdf.profiles.archive.Archive` to create PDF/A documents.
