...
class Archive(pdftools_sdk.image2_pdf.profiles.profile.Profile):
    ...
    def conformance(self) -> Conformance:
        ...
        the properties `pdftools_sdk.image2_pdf.profiles.archive.Archive.alternate_text`
        and `pdftools_sdk.image2_pdf.profiles.archive.Archive.language` must be set.
    ...
    def conformance(self, val: Conformance) -> None:
        ...
        Raises:
            ValueError:
                ...
                Use the profile `pdftools_sdk.image2_pdf.profiles.default.Default` to create PDF documents.
    ...
    def alternate_text(self) -> StringList:
        ...
        For the conversion of `pdftools_sdk.image.single_page_document.SinglePageDocument`, a single description
        is sufficient. For `pdftools_sdk.image.multi_page_document.MultiPageDocument`, multiple descriptions may be
        required.
    ...
    def language(self) -> Optional[str]:
        ...
        its `pdftools_sdk.image2_pdf.profiles.archive.Archive.alternate_text` descriptions.
