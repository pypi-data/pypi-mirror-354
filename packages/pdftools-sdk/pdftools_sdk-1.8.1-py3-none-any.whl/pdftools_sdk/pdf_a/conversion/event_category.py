...
class EventCategory(IntEnum):
    ...
    Attributes:
        VISUAL_DIFFERENCES (int):
            ...
            Suggested severity: `pdftools_sdk.pdf_a.conversion.event_severity.EventSeverity.WARNING`
            ...
            If a manual review is not feasible, events of this category should be classified as an `pdftools_sdk.pdf_a.conversion.event_severity.EventSeverity.ERROR`.
        ...
        REPAIRED_CORRUPTION (int):
            ...
            For that reason, an event is generated such that the repaired document can be reviewed, similarly to `pdftools_sdk.pdf_a.conversion.event_category.EventCategory.VISUALDIFFERENCES`.
        ...
        MANAGED_COLORS (int):
            ...
            Suggested severity: `pdftools_sdk.pdf_a.conversion.event_severity.EventSeverity.INFORMATION`
        ...
        REMOVED_TRANSPARENCY (int):
            ...
            This conversion event should be handled similarly to `pdftools_sdk.pdf_a.conversion.event_category.EventCategory.VISUALDIFFERENCES`.
