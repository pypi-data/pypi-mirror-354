...
class EventCode(IntEnum):
    ...
    Attributes:
        ...
        REMOVED_XFA (int):
            see `pdftools_sdk.pdf_a.conversion.event_category.EventCategory.VISUALDIFFERENCES`
        ...
        RECOVERED_IMAGE_SIZE (int):
            see `pdftools_sdk.pdf_a.conversion.event_category.EventCategory.REPAIREDCORRUPTION`

        REPAIRED_FONT (int):
            see `pdftools_sdk.pdf_a.conversion.event_category.EventCategory.REPAIREDCORRUPTION`

        COPIED_OUTPUT_INTENT (int):
            see `pdftools_sdk.pdf_a.conversion.event_category.EventCategory.MANAGEDCOLORS`
        ...
        RENAMED_COLORANT (int):
            see `pdftools_sdk.pdf_a.conversion.event_category.EventCategory.CHANGEDCOLORANT`

        RESOLVED_COLORANT_COLLISION (int):
            see `pdftools_sdk.pdf_a.conversion.event_category.EventCategory.CHANGEDCOLORANT`

        EMBEDED_FONT (int):
            see `pdftools_sdk.pdf_a.conversion.event_category.EventCategory.CONVERTEDFONT`

        SUBSTITUTED_FONT (int):
            see `pdftools_sdk.pdf_a.conversion.event_category.EventCategory.SUBSTITUTEDFONT`

        SUBSTITUTED_MULTIPLE_MASTER (int):
            see `pdftools_sdk.pdf_a.conversion.event_category.EventCategory.SUBSTITUTEDFONT`

        CONVERTED_TO_STAMP (int):
            see `pdftools_sdk.pdf_a.conversion.event_category.EventCategory.REMOVEDANNOTATION`

        REMOVED_DOCUMENT_METADATA (int):
            see `pdftools_sdk.pdf_a.conversion.event_category.EventCategory.REMOVEDMETADATA`

        COPIED_EMBEDDED_FILE (int):
            see `pdftools_sdk.pdf_a.conversion.event_category.EventCategory.CONVERTEDEMBEDDEDFILE`
        ...
        CHANGED_TO_INITIAL_DOCUMENT (int):
            see `pdftools_sdk.pdf_a.conversion.event_category.EventCategory.REMOVEDEMBEDDEDFILE`
