...
class ConversionOptions(_NativeObject):
    ...
    The options for the conversion of documents using the converter's method `pdftools_sdk.pdf_a.conversion.converter.Converter.convert`
    ...
    def conformance(self) -> Optional[Conformance]:
        ...
        The PDF/A version of the conformance must match the PDF/A version of the analysisOptions of `pdftools_sdk.pdf_a.validation.validator.Validator.analyze`.
        If the conformance level cannot be achieved, the conversion will abort with the error `pdftools_sdk.conformance_error.ConformanceError`.
        ...
        (i.e. `pdftools_sdk.pdf_a.validation.analysis_result.AnalysisResult.recommended_conformance`) is used.
