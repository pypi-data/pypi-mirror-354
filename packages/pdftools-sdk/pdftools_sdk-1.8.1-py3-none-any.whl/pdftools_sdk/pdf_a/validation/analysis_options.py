...
class AnalysisOptions(_NativeObject):
    ...
    Options for the analysis of documents using the validator's method `pdftools_sdk.pdf_a.validation.validator.Validator.analyze` in preparation for the document's conversion to PDF/A.
    ...
    def conformance(self) -> Conformance:
        ...
        It is recommended to use:
            - The input document's claimed conformance `pdftools_sdk.pdf.document.Document.conformance`, if it is an acceptable conversion conformance.
        No conversion is needed, if the analysis result's property `pdftools_sdk.pdf_a.validation.analysis_result.AnalysisResult.is_conversion_recommended` is `False`.
    ...
    def strict_mode(self) -> bool:
        ...
        Also see the documentation of `pdftools_sdk.pdf_a.validation.analysis_result.AnalysisResult.is_conversion_recommended`.
