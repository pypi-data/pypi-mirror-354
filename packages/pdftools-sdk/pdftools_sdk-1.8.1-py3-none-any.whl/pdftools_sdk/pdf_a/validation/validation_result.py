...
class ValidationResult(_NativeObject):
    ...
    Result of the validator's method `pdftools_sdk.pdf_a.validation.validator.Validator.validate`.
    ...
    def is_conforming(self) -> bool:
        ...
        Whether the document conforms to all standards referenced to the `pdftools_sdk.pdf_a.validation.validation_result.ValidationResult.conformance`.
        Any issues found are reported as `pdftools_sdk.pdf_a.validation.validator.Validator.Error`.
