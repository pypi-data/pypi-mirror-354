...
class ConsumptionData(_NativeObject):
    ...
    def remaining_pages(self) -> int:
        ...
        When this value reaches zero, the SDK can still be used as long as `pdftools_sdk.consumption_data.ConsumptionData.overconsumption` is positive.
    ...
    def overconsumption(self) -> int:
        ...
        The over-consumption state begins after all `pdftools_sdk.consumption_data.ConsumptionData.remaining_pages` are consumed.
