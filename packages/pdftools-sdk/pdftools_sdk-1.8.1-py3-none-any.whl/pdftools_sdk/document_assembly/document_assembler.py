    ...
    def __init__(self, out_stream: io.IOBase, out_options: Optional[OutputOptions], conformance: Optional[Conformance]):
        ...
        Args:
            ...
            conformance (Optional[Conformance]): 
                ...
                based on the conformance of the input documents used in the `pdftools_sdk.document_assembly.document_assembler.DocumentAssembler.append` method
    ...
    def append(self, in_doc: Document, first_page: Optional[int] = None, last_page: Optional[int] = None, document_copy_options: Optional[DocumentCopyOptions] = None, page_copy_options: Optional[PageCopyOptions] = None) -> None:
        ...
        Args:
            ...
            firstPage (Optional[int]): 
                ...
                If set, the number must be in the range of `1` (first page) to `pdftools_sdk.pdf.document.Document.page_count` (last page).
            ...
            documentCopyOptions (Optional[DocumentCopyOptions]): 
            pageCopyOptions (Optional[PageCopyOptions]): 
        ...
        Raises:
            ...
            pdftools_sdk.conformance_error.ConformanceError:
                ...
                (`pdftools_sdk.pdf.conformance.Conformance.PDFA1A`, `pdftools_sdk.pdf.conformance.Conformance.PDFA2A`,
                or `pdftools_sdk.pdf.conformance.Conformance.PDFA3A`)
                and the copy option `pdftools_sdk.document_assembly.page_copy_options.PageCopyOptions.copy_logical_structure` is set to `False`.

            StateError:
                If `pdftools_sdk.document_assembly.document_assembler.DocumentAssembler.assemble` has already been called.
