...
class DocumentCopyOptions(_NativeObject):
    ...
    def copy_embedded_files(self) -> bool:
        ...
        within the given page range are copied. (PDF/A-3 only, `pdftools_sdk.document_assembly.page_copy_options.PageCopyOptions.copy_associated_files` must be set.)
