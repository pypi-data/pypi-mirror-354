...
class TrustConstraints(_NativeObject):
    ...
    def trust_sources(self) -> DataSource:
        ...
        Note that the trust sources are implicitly added to the profile's `pdftools_sdk.signature_validation.profiles.validation_options.ValidationOptions.certificate_sources`.
