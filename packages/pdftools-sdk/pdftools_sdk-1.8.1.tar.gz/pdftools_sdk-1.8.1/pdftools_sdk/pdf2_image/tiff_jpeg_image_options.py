...
class TiffJpegImageOptions(pdftools_sdk.pdf2_image.image_options.ImageOptions):
    """
    ...
    def __init__(self):
        ...
        ret_val = _lib.PdfToolsPdf2Image_TiffJpegImageOptions_New()
        if ret_val is None:
    ...
    def jpeg_quality(self) -> int:
        ...
        ret_val = _lib.PdfToolsPdf2Image_TiffJpegImageOptions_GetJpegQuality(self._handle)
        if ret_val == 0:
    ...
    def jpeg_quality(self, val: int) -> None:
        ...
        if not _lib.PdfToolsPdf2Image_TiffJpegImageOptions_SetJpegQuality(self._handle, val):
            _NativeBase._throw_last_error(False)
    ...
    def color_space(self) -> Optional[JpegColorSpace]:
        ...
        Default: `pdftools_sdk.pdf2_image.jpeg_color_space.JpegColorSpace.RGB`



        Returns:
            Optional[JpegColorSpace]
        ...
        ret_val = c_int()
        if not _lib.PdfToolsPdf2Image_TiffJpegImageOptions_GetColorSpace(self._handle, byref(ret_val)):
            _NativeBase._throw_last_error()
            return None
    ...
    def color_space(self, val: Optional[JpegColorSpace]) -> None:
        ...
        if not _lib.PdfToolsPdf2Image_TiffJpegImageOptions_SetColorSpace(self._handle, byref(c_int(val)) if val is not None else None):
            _NativeBase._throw_last_error(False)
    ...
    def _from_handle(cls, handle):
        ...
        """
        instance = TiffJpegImageOptions.__new__(cls)  # Bypass __init__
