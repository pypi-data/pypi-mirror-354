...
class FaxImageOptions(pdftools_sdk.pdf2_image.image_options.ImageOptions):
    ...
    def vertical_resolution(self) -> FaxVerticalResolution:
        ...
        resolution to use.
        For details, see `pdftools_sdk.pdf2_image.fax_vertical_resolution.FaxVerticalResolution`.
         
        Note that the horizontal resolution is fixed at 204 DPI by the
        Fax standard.
         
        Default: `pdftools_sdk.pdf2_image.fax_vertical_resolution.FaxVerticalResolution.STANDARD`
    ...
    def compression(self) -> TiffBitonalCompressionType:
        ...
        type to use.
        For details, see `pdftools_sdk.pdf2_image.tiff_bitonal_compression_type.TiffBitonalCompressionType`.
         
        Default: `pdftools_sdk.pdf2_image.tiff_bitonal_compression_type.TiffBitonalCompressionType.G3`
    ...
    def compression(self, val: TiffBitonalCompressionType) -> None:
        ...
        Args:
            val (TiffBitonalCompressionType):
                property value
