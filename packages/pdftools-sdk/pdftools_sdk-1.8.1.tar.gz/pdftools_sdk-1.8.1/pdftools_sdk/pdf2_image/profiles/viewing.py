...
class Viewing(pdftools_sdk.pdf2_image.profiles.profile.Profile):
    ...
    By default, `pdftools_sdk.pdf2_image.profiles.viewing.Viewing.image_options` is set to
    `pdftools_sdk.pdf2_image.png_image_options.PngImageOptions` which uses the output format
    PNG and lossless compression.
    If set to `pdftools_sdk.pdf2_image.jpeg_image_options.JpegImageOptions`, the output format
    is JPEG.
    ...
    def image_options(self) -> ImageOptions:
        ...
        Supported types are:
            - `pdftools_sdk.pdf2_image.png_image_options.PngImageOptions` to create PNG images
            - `pdftools_sdk.pdf2_image.jpeg_image_options.JpegImageOptions` to create JPEG images
         
        Default: `pdftools_sdk.pdf2_image.png_image_options.PngImageOptions`
    ...
    def image_section_mapping(self) -> ImageSectionMapping:
        ...
        Supported types are:
            - `pdftools_sdk.pdf2_image.render_page_at_resolution.RenderPageAtResolution` to define the resolution of the output images.
            - `pdftools_sdk.pdf2_image.render_page_to_max_image_size.RenderPageToMaxImageSize` to define the maximum image size of the output images.
         
        Default: `pdftools_sdk.pdf2_image.render_page_at_resolution.RenderPageAtResolution` with 150 DPI.
