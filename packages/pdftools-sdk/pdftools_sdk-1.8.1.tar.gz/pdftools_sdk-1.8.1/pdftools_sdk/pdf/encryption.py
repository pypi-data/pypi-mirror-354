...
class Encryption(_NativeObject):
    ...
    A user password (see `pdftools_sdk.pdf.encryption.Encryption.user_password`) and an owner password (see `pdftools_sdk.pdf.encryption.Encryption.owner_password`).
    ...
    def __init__(self, user_password: Optional[str], owner_password: Optional[str], permissions: Permission):
        ...
        Args:
            userPassword (Optional[str]): 
                Set the user password of the output document (see `pdftools_sdk.pdf.encryption.Encryption.user_password`).
                If `None` or empty, no user password is set.

            ownerPassword (Optional[str]): 
                Set the owner password and permissions of the output document (see `pdftools_sdk.pdf.encryption.Encryption.owner_password`).
    ...
    def set_permissions(self, owner_password: str, permissions: Permission) -> None:
        ...
        For this, the document must be opened by specifying the owner password (see `pdftools_sdk.pdf.encryption.Encryption.owner_password`).



        Args:
            ownerPassword (str): 
                The owner password to be set on the PDF document (see `pdftools_sdk.pdf.encryption.Encryption.owner_password`).
    ...
    def permissions(self) -> Permission:
        ...
        When opening an encrypted document, the access permissions for the document can be read using `pdftools_sdk.pdf.document.Document.permissions`.
