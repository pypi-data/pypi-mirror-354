...
class Document(_NativeObject):
    ...
    def xfa(self) -> XfaType:
        ...
        While XFA documents may seem like regular PDF documents they are not and cannot be processed by many components (error `pdftools_sdk.unsupported_feature_error.UnsupportedFeatureError`).
