...
class ValidationInformation(IntEnum):
    ...
    For these cases, a subsequent invocation of `pdftools_sdk.sign.signer.Signer.process` with
    ...
    Attributes:
        ...
        EMBED_IN_SIGNATURE (int):
            This is only possible for Legacy PAdES Basic signatures (signature format `pdftools_sdk.crypto.signature_format.SignatureFormat.ADBEPKCS7DETACHED`).
