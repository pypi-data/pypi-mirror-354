...
class SignatureConfiguration(pdftools_sdk.sign.signature_configuration.SignatureConfiguration):
    ...
    def add_certificate(self, certificate: io.IOBase) -> None:
        ...
        validation information is added (see `pdftools_sdk.crypto.providers.pkcs11.signature_configuration.SignatureConfiguration.validation_information`).
    ...
    def signature_padding_type(self) -> SignaturePaddingType:
        ...
        Default: `pdftools_sdk.crypto.signature_padding_type.SignaturePaddingType.RSASSAPSS` for RSA and `pdftools_sdk.crypto.signature_padding_type.SignaturePaddingType.DEFAULT` for ECDSA certificates
