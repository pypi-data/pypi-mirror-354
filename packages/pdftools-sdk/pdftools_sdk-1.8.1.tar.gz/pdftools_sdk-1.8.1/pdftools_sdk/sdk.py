...
class Sdk(_NativeObject):
    ...
    def initialize(license: str, producer_suffix: Optional[str] = None) -> None:
        ...
        For licensing questions, contact `pdfsales@pdftools.com <mailto:pdfsales@pdftools.com>`_.
        ...
        Args:
            ...
            producerSuffix (Optional[str]): 
                ...
                within metadata of PDF output documents (see `pdftools_sdk.sdk.Sdk.producer_full_name`).
    ...
    def set_producer_suffix(val: Optional[str]) -> None:
        ...
        Suffix that is appended to the producer string within metadata of PDF output documents (see `pdftools_sdk.sdk.Sdk.producer_full_name`).
    ...
    def get_producer_full_name() -> str:
        ...
        The producer string depends on the license key and producer suffix set in `pdftools_sdk.sdk.Sdk.initialize`.
    ...
    def get_license_info_snapshot() -> LicenseInfo:
        ...
        Note: `pdftools_sdk.sdk.Sdk.initialize` />*must* be called before accessing license information.
