...
class MinimalFileSize(pdftools_sdk.optimization.profiles.profile.Profile):
    ...
    (see `pdftools_sdk.optimization.profiles.profile.Profile.removal_options`).
    ...
    `pdftools_sdk.optimization.profiles.minimal_file_size.MinimalFileSize.resolution_d_p_i` has influence on both values.
    ...
    property `pdftools_sdk.optimization.profiles.profile.Profile.image_recompression_options`.
    ...
    def resolution_d_p_i(self) -> Optional[float]:
        ...
        Images with a resolution above `pdftools_sdk.optimization.profiles.minimal_file_size.MinimalFileSize.threshold_d_p_i` are down-sampled.
    ...
    def threshold_d_p_i(self) -> float:
        ...
        Valid values are in the range 1.0 to 10000.
        To deactivate down-sampling of images set `pdftools_sdk.optimization.profiles.minimal_file_size.MinimalFileSize.resolution_d_p_i` to `None`.
         
        Default: `1.4` times `pdftools_sdk.optimization.profiles.minimal_file_size.MinimalFileSize.resolution_d_p_i`.
