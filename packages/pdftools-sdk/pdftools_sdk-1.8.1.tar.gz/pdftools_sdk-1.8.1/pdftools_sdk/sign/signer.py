...
class Signer(_NativeObject):
    ...
    def sign(self, document: Document, configuration: SignatureConfiguration, stream: io.IOBase, output_options: Optional[OutputOptions] = None) -> Document:
        ...
        Non-critical processing errors raise a `pdftools_sdk.sign.signer.Signer.Warning`.
        It is recommended to review the `pdftools_sdk.sign.warning_category.WarningCategory` and handle them if necessary for the application.
        ...
        Args:
            ...
            outputOptions (Optional[OutputOptions]): 
        ...
        Raises:
            ...
            pdftools_sdk.unsupported_feature_error.UnsupportedFeatureError:
                ...
                See `pdftools_sdk.pdf.document.Document.xfa` for more information on how to detect and handle XFA documents.
            ...
            pdftools_sdk.not_found_error.NotFoundError:
                If the `pdftools_sdk.sign.signature_configuration.SignatureConfiguration.field_name` does not exist in `document`.
    ...
    def certify(self, document: Document, configuration: SignatureConfiguration, stream: io.IOBase, permissions: Optional[MdpPermissionOptions] = None, output_options: Optional[OutputOptions] = None) -> Document:
        ...
        The features and format of the signature are defined by the `pdftools_sdk.crypto.providers.provider.Provider` and the
        `configuration`.
        ...
        Args:
            ...
            permissions (Optional[MdpPermissionOptions]): 
                The permissions allowed. The default is `pdftools_sdk.pdf.mdp_permissions.MdpPermissions.NOCHANGES`.
    ...
    def add_signature_field(self, document: Document, options: SignatureFieldOptions, stream: io.IOBase, output_options: Optional[OutputOptions] = None) -> Document:
        ...
        Raises:
            ...
            pdftools_sdk.exists_error.ExistsError:
                The `pdftools_sdk.sign.signature_field_options.SignatureFieldOptions.field_name` exists already in the input document.
    ...
    def add_prepared_signature(self, document: Document, configuration: SignatureConfiguration, stream: io.IOBase, output_options: Optional[OutputOptions] = None) -> PreparedDocument:
        ...
        This method is the same as `pdftools_sdk.sign.signer.Signer.sign`, but without actually creating the cryptographic signature.
        The cryptographic signature can be inserted later using `pdftools_sdk.sign.signer.Signer.sign_prepared_signature`.
         
        While the `configuration` can be created by any `pdftools_sdk.crypto.providers.provider.Provider`,
        it is typically created by `pdftools_sdk.crypto.providers.built_in.provider.Provider.create_prepared_signature`.
    ...
    def sign_prepared_signature(self, document: Document, configuration: SignatureConfiguration, stream: io.IOBase) -> Document:
        ...
        Sign a document that contains a prepared signature created using `pdftools_sdk.sign.signer.Signer.add_prepared_signature`.
        ...
        Raises:
            ...
            ValueError:
                If the `document` does not contain a prepared signature created by `pdftools_sdk.sign.signer.Signer.add_prepared_signature`
    ...
    def process(self, document: Document, stream: io.IOBase, output_options: Optional[OutputOptions] = None, provider: Optional[Provider] = None) -> Document:
        ...
        For example:
            ...
            - To remove signatures and unsigned signature fields (see `pdftools_sdk.sign.output_options.OutputOptions.remove_signatures`).
            - To add validation information to existing signatures (see `pdftools_sdk.sign.output_options.OutputOptions.add_validation_information`).
        ...
        Args:
            ...
            provider (Optional[Provider]): 
                ...
                (see `pdftools_sdk.sign.output_options.OutputOptions.add_validation_information`).
