...
class PageCopyOptions(_NativeObject):
    ...
    def links(self) -> CopyStrategy:
        ...
        Default value: `pdftools_sdk.document_assembly.copy_strategy.CopyStrategy.COPY`
    ...
    def signed_signatures(self) -> RemovalStrategy:
        ...
        Default value: `pdftools_sdk.document_assembly.removal_strategy.RemovalStrategy.REMOVE`
    ...
    def form_field_conflict_resolution(self) -> NameConflictResolution:
        ...
        Default value: `pdftools_sdk.document_assembly.name_conflict_resolution.NameConflictResolution.MERGE`
    ...
    def named_destinations(self) -> NamedDestinationCopyStrategy:
        ...
        Default value: `pdftools_sdk.document_assembly.named_destination_copy_strategy.NamedDestinationCopyStrategy.COPY`
    ...
    def page_rotation(self) -> PageRotation:
        ...
        Default: `pdftools_sdk.document_assembly.page_rotation.PageRotation.NOROTATION`
