...
class Auto(pdftools_sdk.image2_pdf.image_mapping.ImageMapping):
    ...
    image size is preserved if it is smaller than `pdftools_sdk.image2_pdf.auto.Auto.max_page_size`.
    Otherwise, it is scaled down.
    For all images except scans, a margin `pdftools_sdk.image2_pdf.auto.Auto.default_page_margin` is used.
     
    Images with no meaningful resolution, e.g. photos are scaled, to fit onto
    `pdftools_sdk.image2_pdf.auto.Auto.max_page_size`.
