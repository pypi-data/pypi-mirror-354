...
class ValidationOptions(_NativeObject):
    ...
    Options to check the quality and standard conformance of documents using the validator's method `pdftools_sdk.pdf_a.validation.validator.Validator.validate`.
    ...
    def conformance(self) -> Optional[Conformance]:
        ...
        The required conformance or `None` to validate the document's claimed conformance, i.e. `pdftools_sdk.pdf.document.Document.conformance`.
