...
class Frame:
    ...
    def compute_commands(self, wait_semaphores: Sequence[tuple[Semaphore, PipelineStageFlags]] = [], wait_timeline_values: Sequence[int] = [], signal_semaphores: Sequence[Semaphore] = [], wait_timeline_values: Sequence[int] = []) -> CommandsManager: ...

    @property
    def compute_command_buffer(self) -> Optional[CommandBuffer]: ...

    def transfer_commands(self, wait_semaphores: Sequence[tuple[Semaphore, PipelineStageFlags]] = [], wait_timeline_values: Sequence[int] = [], signal_semaphores: Sequence[Semaphore] = [], wait_timeline_values: Sequence[int] = []) -> CommandsManager: ...
...
class QueryPool(GfxObject):
    def __init__(self, ctx: Context, type: QueryType, count: int) -> None: ...
...
class Buffer(GfxObject):
    ...
    @staticmethod
    def from_data(ctx: Context, data: object, usage_flags: BufferUsageFlags, alloc_type: AllocType) -> Buffer: ...
...
class ExternalBuffer(Buffer):
    def __init__(self, ctx: Context, size: int, usage_flags: BufferUsageFlags, alloc_type: AllocType) -> None: ...
...
class Image(GfxObject):
    ...
    @staticmethod
    def from_data(ctx: Context, data: object, usage: ImageUsage, width: int, height: int, format: Format, usage_flags: ImageUsageFlags, alloc_type: AllocType, samples: int = 1) -> Image: ...
...
class AccelerationStructure(GfxObject):
    def __init__(self, ctx: Context, meshes: Sequence[AccelerationStructureMesh], prefer_fast_build: bool = False) -> None: ...

    def destroy(self) -> None: ...

class Fence(GfxObject):
    def __init__(self, ctx: Context, signaled: bool = False) -> None: ...
...
class TimelineSemaphore(Semaphore):
    def __init__(self, ctx: Context, initial_value: int = 0) -> None: ...
...
class MemoryUsage(enum.Enum):
    ...
    VERTEX_SHADER_UNIFORM_READ = 4

    GEOMETRY_SHADER_UNIFORM_READ = 5

    FRAGMENT_SHADER_UNIFORM_READ = 6

    COMPUTE_SHADER_UNIFORM_READ = 7

    ANY_SHADER_UNIFORM_READ = 8
...
class ImageUsage(enum.Enum):
    ...
    COLOR_ATTACHMENT_WRITE_ONLY = 6

    DEPTH_STENCIL_ATTACHMENT = 7

    DEPTH_STENCIL_ATTACHMENT_READ_ONLY = 8

    DEPTH_STENCIL_ATTACHMENT_WRITE_ONLY = 9
...
class RenderingAttachment:
    def __init__(self, image: Image, load_op: LoadOp, store_op: StoreOp, clear: Sequence[float] = [0.0, 0.0, 0.0, 0.0], resolve_image: Optional[Image] = None, resolve_mode: ResolveMode = ResolveMode.NONE) -> None: ...
...
class CommandBuffer(GfxObject):
    def __init__(self, ctx: Context, queue_family_index: Optional[int] = None) -> None: ...
    ...
    def use_image(self, image: Image, usage: ImageUsage, src_queue_family_index: int = 4294967295, dst_queue_family_index: int = 4294967295) -> None: ...

    def begin_rendering(self, viewport: Sequence[int], color_attachments: Sequence[RenderingAttachment], depth: Optional[DepthAttachment] = None) -> None: ...

    def end_rendering(self) -> None: ...

    def rendering(self, viewport: Sequence[int], color_attachments: Sequence[RenderingAttachment], depth: Optional[DepthAttachment] = None) -> RenderingManager: ...

    def bind_graphics_pipeline(self, pipeline: GraphicsPipeline, descriptor_sets: Sequence[DescriptorSet] = [], push_constants: Optional[bytes] = None, vertex_buffers: Sequence[Buffer] = [], index_buffer: Optional[Buffer] = None, viewport: Sequence[int] = [0.0, 0.0, 0.0, 0.0], scissors: Sequence[int] = [0.0, 0.0, 0.0, 0.0]) -> None: ...

    def bind_compute_pipeline(self, pipeline: ComputePipeline, descriptor_sets: Sequence[DescriptorSet] = [], push_constants: Optional[bytes] = None) -> None: ...
...
class DescriptorSet:
    ...
    def write_buffer(self, buffer: Buffer, type: DescriptorType, binding: int, element: int = 0) -> None: ...

    def write_image(self, image: Image, usage: ImageUsage, type: DescriptorType, binding: int, element: int = 0) -> None: ...
...
class ComputePipeline(GfxObject):
    def __init__(self, ctx: Context, shader: Shader, entry: str = 'main', push_constants_ranges: Sequence[PushConstantsRange] = [], descriptor_sets: Sequence[DescriptorSet] = []) -> None: ...
