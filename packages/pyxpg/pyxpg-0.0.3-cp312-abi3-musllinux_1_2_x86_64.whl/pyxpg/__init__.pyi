...
class CommandBuffer(GfxObject):
    def __init__(self, ctx: Context, queue_family_index: int | None = None) -> None: ...
    ...
    def bind_graphics_pipeline(self, pipeline: GraphicsPipeline, descriptor_sets: Sequence[DescriptorSet] = [], push_constants: bytes | None = None, vertex_buffers: Sequence[Buffer] = [], index_buffer: Buffer | None = None, viewport: Sequence[int] = [0.0, 0.0, 0.0, 0.0], scissors: Sequence[int] = [0.0, 0.0, 0.0, 0.0]) -> None: ...

    def bind_compute_pipeline(self, pipeline: ComputePipeline, descriptor_sets: Sequence[DescriptorSet] = [], push_constants: bytes | None = None) -> None: ...
...
class DescriptorSet:
    def __init__(self, ctx: Context, entries: Sequence[DescriptorSetEntry], flags: DescriptorBindingFlags = 0) -> None: ...
