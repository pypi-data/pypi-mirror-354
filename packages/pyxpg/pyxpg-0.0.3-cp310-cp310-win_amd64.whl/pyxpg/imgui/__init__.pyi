...
class Vec4:
    ...
    @overload
    def __init__(self, x: float, y: float, w: float, w: float) -> None: ...
...
def calc_text_size(text: str, text_end: str | None = None, hide_text_after_double_hash: bool = False, wrap_width: float = -1.0) -> Vec2: ...
...
class DrawList:
    ...
    def add_text(self, pos: Vec2, col: int, text_begin: str, text_end: str | None = None) -> None: ...
