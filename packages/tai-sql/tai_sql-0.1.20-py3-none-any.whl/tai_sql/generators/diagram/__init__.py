...
class ERDiagramGenerator(BaseGenerator):
    ...
    def create_diagram(self):
        ...
        dot.attr(
            ...
            splines=self.themes[self.theme]['layout']['splines'],
            overlap='false',
            sep='+10',
            esep='+5'
        )
        ...
        # # ✅ Opcional: Conectar invisiblemente con la última entidad
        # # para mejorar el layout
        # if self._entities:
        #     last_entity = self._entities[-1].table_name
        #     dot.edge(
        #         last_entity,
        #         'legend',
        #         style='invis',  # Conexión invisible
        #         weight='0'      # Sin peso para el layout
        #     )
    ...
    def _create_entity_html_table(self, entity: EREntity) -> str:
        ...
        <TABLE BORDER="0" CELLBORDER="0" CELLSPACING="0" CELLPADDING="4">
            <!-- HEADER -->
            <TR>
                <TD COLSPAN="3" BGCOLOR="{header_color}" BORDER="1">
                    <FONT POINT-SIZE="{theme_config['fonts']['header_size']}" COLOR="white">{icon} {entity.name}</FONT>
                </TD>
            </TR>'''
