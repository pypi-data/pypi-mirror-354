...
def test_consultar_cobranca_pix(pix_client):
...
def test_cancelar_cobranca_pix(pix_client):
...
def test_obter_qrcode_pix(pix_client):
    ...
    assert "imagemQrcode" in result
    pix_client.session.get.assert_called_once()

def test_configurar_webhook_pix(pix_client):
...
def test_consultar_webhook_pix(pix_client):
    ...
    assert result == {"webhookUrl": "https://meusite.com/webhook"}
    pix_client.session.get.assert_called_once()
...
def test_criar_cobranca_pix_com_vencimento(pix_client):
...
def test_consultar_cobranca_pix_com_vencimento(pix_client):
...
def test_cancelar_cobranca_pix_com_vencimento(pix_client):
...
def test_obter_qrcode_pix_com_vencimento(pix_client):
...
def test_excluir_webhook_pix(pix_client):
...
def test_criar_lote_cobranca_pix_com_vencimento(pix_client):
...
def test_consultar_lote_cobranca_pix_com_vencimento(pix_client):
    ...
    assert id_lote in str(exc_info.value)
