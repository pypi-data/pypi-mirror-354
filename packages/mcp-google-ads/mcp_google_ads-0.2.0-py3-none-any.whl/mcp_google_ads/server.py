...
async def create_campaign(
    ...
    bidding_strategy: str = Field(default="MAXIMIZE_CLICKS", description="Bidding strategy type")
) -> str:
    """
    ...
    Args:
        ...
        bidding_strategy: Bidding strategy (MAXIMIZE_CLICKS, TARGET_CPA, etc.)
    ...
    try:
        ...
        if campaign_type == "SEARCH":
            campaign_operation["operations"][0]["create"]["dynamicSearchAdsSetting"] = {
                "domainName": "",
                "languageCode": "en"
            }
